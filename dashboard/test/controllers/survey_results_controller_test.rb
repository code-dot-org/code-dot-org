...
class SurveyResultsControllerTest < ActionController::TestCase
  ...
  test 'post diversity survey results' do
    assert_creates(SurveyResult) do
      post :create,
        params: {
          survey: {kind: 'Diversity2017', survey2017_ethnicity_asian: 22, survey2017_foodstamps: 3}
        },
        format: :json
    end
    ...
    assert_equal 22, survey_result["properties"]["survey2017_ethnicity_asian"].to_i
    assert_equal 3, survey_result["properties"]["survey2017_foodstamps"].to_i
  end
