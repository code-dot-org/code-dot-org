...
class JavabuilderSessionsControllerTest < ActionController::TestCase
  ...
  test_user_gets_response_for :get_access_token,
    ...
    response: :forbidden
  test_user_gets_response_for :get_access_token,
    params: {channelId: storage_encrypt_channel_id(1, 1), projectVersion: 123, project_url: "url"},
    user: :levelbuilder,
    response: :success
  ...
  test 'can decode jwt token' do
    ...
    get :get_access_token, params: {channelId: @fake_channel_id, projectVersion: 123, project_url: "url"}
  ...
  test 'param for channel id is required' do
    levelbuilder = create :levelbuilder
    sign_in(levelbuilder)
    get :get_access_token, params: {projectVersion: 123, project_url: "url"}
  ...
  test 'param for project version is required' do
    levelbuilder = create :levelbuilder
    sign_in(levelbuilder)
    get :get_access_token, params: {channelId: @fake_channel_id, project_url: "url"}
    assert_response :bad_request
  end
