  ...
  test "should get text_responses for section with script with text response" do
    ...
    expected_response = [
      ...
      },
      {
        ...
        'url' => "http://test.host/s/#{script.name}/lesson/2/puzzle/1?section_id=#{@section.id}&user_id=#{@student_1.id}"
      },
      {
        ...
        'url' => "http://test.host/s/#{script.name}/lesson/1/puzzle/1?section_id=#{@section.id}&user_id=#{@student_2.id}"
      }
    ]
