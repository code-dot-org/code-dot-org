...
class Plc::UserCourseEnrollmentsControllerTest < ActionController::TestCase
  setup do
    ...
    @plc_user_course_enrollment = create(:plc_user_course_enrollment, user: @user, plc_course: @plc_course)
  end

  test "should get index" do
    get :index
    assert_response :success
    assert_not_nil assigns(:plc_user_course_enrollments)
  end
  ...
  test "should create plc_user_course_enrollment" do
    ...
    assert_redirected_to plc_user_course_enrollment_path(assigns(:plc_user_course_enrollment))
  end

  test "should show plc_user_course_enrollment" do
    get :show, id: @plc_user_course_enrollment
    assert_response :success
  end

  test "should destroy plc_user_course_enrollment" do
    assert_difference('Plc::UserCourseEnrollment.count', -1) do
      delete :destroy, id: @plc_user_course_enrollment
    end
