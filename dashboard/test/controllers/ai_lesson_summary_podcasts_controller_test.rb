...
class AiLessonSummaryPodcastsControllerTest < ActionController::TestCase
  ...
  test 'show returns correct content type and headers for podcast from S3' do
    ...
    Cdo::AwsWrapper::S3.stubs(:exists_in_bucket).with(Cdo::AwsWrapper::S3.user_content_bucket, 'podcasts/lesson_123_podcast.mp3').returns(true)
    Cdo::AwsWrapper::S3.stubs(:download_from_bucket).with(Cdo::AwsWrapper::S3.user_content_bucket, 'podcasts/lesson_123_podcast.mp3').returns(@test_audio_data)
  ...
  test 'show returns audio data from S3 as response body' do
    ...
    Cdo::AwsWrapper::S3.stubs(:exists_in_bucket).with(Cdo::AwsWrapper::S3.user_content_bucket, 'podcasts/lesson_456_podcast.mp3').returns(true)
    Cdo::AwsWrapper::S3.stubs(:download_from_bucket).with(Cdo::AwsWrapper::S3.user_content_bucket, 'podcasts/lesson_456_podcast.mp3').returns(different_audio_data)
  ...
  test 'show returns not_found when podcast does not exist in S3' do
    ...
    Cdo::AwsWrapper::S3.stubs(:exists_in_bucket).with(Cdo::AwsWrapper::S3.user_content_bucket, 'podcasts/lesson_789_podcast.mp3').returns(false)
