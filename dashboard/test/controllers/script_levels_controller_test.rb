...
class ScriptLevelsControllerTest < ActionController::TestCase
  ...
  test "next redirects to next level for custom scripts" do
    ...
    assert_redirected_to "/s/laurel/stage/#{@custom_s1_l1.lesson.absolute_position}/puzzle/#{@custom_s1_l1.position}"
  end
  ...
  test "stage extras shows progress for current user if no section&user id" do
    sign_in @student
    script = create :script
    lesson_group = create(:lesson_group, script: script)
    lesson = create(:lesson, script: script, lesson_group: lesson_group)
  ...
  test "stage extras shows teacher no progress if no section&user id" do
    sign_in @teacher
    script = create :script
    lesson_group = create(:lesson_group, script: script)
    lesson = create(:lesson, script: script, lesson_group: lesson_group)
  ...
  test "stage extras shows teacher progress for student if section&user id" do
    sign_in @teacher
    script = create :script
    lesson_group = create(:lesson_group, script: script)
    lesson = create(:lesson, script: script, lesson_group: lesson_group)
