...
class ScriptLevelsControllerTest < ActionController::TestCase
  ...
  test "should return level_properties " do
    ...
    assert_equal({"id" => level.id, "levelData" => {"hello" => "there"}, "other" => "other", "preloadAssetList" => nil, "type" => "Maze", "appName" => "maze", "useRestrictedSongs" => false, "sharedBlocks" => [], "usesProjects" => false, "startSources" => nil, "exampleSolutions" => []}, body)
  end
