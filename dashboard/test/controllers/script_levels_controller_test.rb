...
class ScriptLevelsControllerTest < ActionController::TestCase
  ...
  setup_all do
    ...
    create(:single_unit_course, unit: @custom_script)
  ...
  test 'should show script level for csp1-2020 lockable lesson with lesson plan' do
    @unit = create(:single_unit_course, unit: create(:script, name: 'csp1-2020')).first_unit
  ...
  test 'should show script level for csp2-2020 lockable lesson with lesson plan' do
    @unit = create(:single_unit_course, unit: create(:script, name: 'csp2-2020')).first_unit
    @lesson_group = create :lesson_group, script: @unit
  ...
  test "show: redirect to latest stable script version in family for logged out user if one exists" do
    courseg_2017 = create :script, name: 'courseg-2017'
    ...
    courseg_2018 = create :script, name: 'courseg-2018'
    ...
    courseg_2019 = create :script, name: 'courseg-2019'
  ...
  test "show: redirect to latest assigned script version in family for participant if one exists" do
    ...
    pl_courseg_2017 = create :script, name: 'pl-courseg-2017'
    ...
    pl_courseg_2018 = create :script, name: 'pl-courseg-2018'
    ...
    pl_courseg_2019 = create :script, name: 'pl-courseg-2019'
  ...
  test "teacher can't hide lessons if script has hideable_lessons false" do
    script = create(:single_unit_course, unit: create(:script, hideable_lessons: false)).first_unit
  ...
  test "should redirect when script has a redirect_to property" do
    script = create(:single_unit_course).first_unit
    new_script = create(:single_unit_course).first_unit
    lesson_group = create(:lesson_group, script: script)
  ...
  test 'should redirect to 2017 version in script family' do
    cats1 = create :script, :with_levels, name: 'cats1'
    ...
    cats2 = create :script, :with_levels, name: 'cats2'
