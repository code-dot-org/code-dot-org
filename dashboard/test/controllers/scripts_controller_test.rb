...
class ScriptsControllerTest < ActionController::TestCase
  ...
  test_user_gets_response_for :vocab, response: :success, user: :facilitator, params: -> {{id: @migrated_pl_unit.name}}, name: 'instructor can view vocab page for pl course'
  ...
  test_user_gets_response_for :resources, response: :success, user: :facilitator, params: -> {{id: @migrated_pl_unit.name}}, name: 'instructor can view resources page for pl course'
  ...
  test_user_gets_response_for :standards, response: :success, user: :facilitator, params: -> {{id: @migrated_pl_unit.name}}, name: 'instructor can view standards page for pl course'
  ...
  test_user_gets_response_for :code, response: :success, user: :facilitator, params: -> {{id: @migrated_pl_unit.name}}, name: 'instructor can view code page for pl course'
