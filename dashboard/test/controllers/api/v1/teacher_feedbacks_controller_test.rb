...
class Api::V1::TeacherFeedbacksControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'retrieves feedback for correct student' do
    ...
    teacher_sign_in_and_give_feedback(@teacher, @student, @level, COMMENT1, PERFORMANCE1)
    teacher_sign_in_and_give_feedback(@teacher, student2, @level, COMMENT2, PERFORMANCE2)
    get "#{API}/get_feedback_from_teacher", params: {student_id: @student.id, level_id: @level.id, teacher_id: @teacher.id}
  ...
  test 'retrieves feedback from correct teacher' do
    ...
    teacher_sign_in_and_give_feedback(teacher2, @student, @level, COMMENT2, PERFORMANCE2)
    sign_out teacher2
  ...
  test 'retrieves comment on requested level when teacher has given student feedback on multiple levels' do
    ...
    teacher_sign_in_and_give_feedback(@teacher, @student, @level, COMMENT1, PERFORMANCE1)
    teacher_sign_in_and_give_feedback(@teacher, @student, level2, COMMENT2, PERFORMANCE2)
    teacher_sign_in_and_give_feedback(@teacher, @student, level3, COMMENT3, PERFORMANCE3)
  ...
  test 'retrieves the most recent feedback from a teacher' do
    ...
    teacher_sign_in_and_give_feedback(@teacher, @student, @level, COMMENT3, PERFORMANCE3)
    get "#{API}/get_feedback_from_teacher", params: {student_id: @student.id, level_id: @level.id, teacher_id: @teacher.id}
  ...
  test 'serializer returns teacher name' do
    ...
    teacher_sign_in_and_give_feedback(@teacher1, @student, @level, COMMENT1, PERFORMANCE1)
    sign_in @student
    get "#{API}/get_feedbacks", params: {student_id: @student.id, level_id: @level.id}
  ...
  def teacher_sign_in_and_give_feedback(teacher, student, level, comment, performance)
    sign_in teacher
    params = {
