...
class Api::V1::SectionsControllerTest < ActionController::TestCase
  ...
  test "require_captcha: returns object with recaptcha site key and number of section attempts" do
    user = create(:user)
    sign_in user
    get :require_captcha
    expected_response = {key: Recaptcha.configuration.site_key, sectionAttempts: 0}.as_json
    assert_equal(expected_response, json_response)
  end
