  ...
  class ApplicationsControllerTest < ::ActionController::TestCase
    ...
    test 'cohort csv download returns expected columns for teachers' do
      ...
      expected_headers = [
        ...
        "Administrator Approval Form URL",
        "Home street address",
        "Home city",
        "Home state",
        "Administrator/School Leader's title (provided by administrator)",
        "Administrator/School Leader's first name (provided by administrator)",
        "Administrator/School Leader's last name (provided by administrator)",
        "Administrator/School Leader's email address (provided by administrator)",
        "School name (provided by administrator)",
        "School district (provided by administrator)",
        "Do you approve of this teacher participating in Code.org's #{APPLICATION_CURRENT_YEAR} Professional Learning Program?",
        "Total student enrollment",
        "Percent of students who are eligible to receive free or reduced lunch (Administrator's response)",
        "Percent of students from underrepresented racial and ethnic groups (Administrator's response)",
        ...
        "Will this course replace an existing computer science course in the master schedule? (Administrator's response)",
        ...
        "Administrator authorizes college board to send AP Scores",
