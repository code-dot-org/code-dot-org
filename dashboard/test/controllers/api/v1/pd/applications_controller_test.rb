  ...
  class ApplicationsControllerTest < ::ActionController::TestCase
    ...
    test 'cohort csv download returns expected columns for teachers' do
      ...
      expected_headers = [
        ...
        "Which professional learning program would you like to join for the #{APPLICATION_CURRENT_YEAR_SHORT} school year?",
        "To which grades does your school plan to offer CS Principles in the #{APPLICATION_CURRENT_YEAR_SHORT} school year?",
        ...
        "Total course hours",
        "Do you plan to personally teach this course in the #{APPLICATION_CURRENT_YEAR_SHORT} school year?",
        ...
        "Do you approve of this teacher participating in Code.org's #{APPLICATION_CURRENT_YEAR_SHORT} Professional Learning Program?",
        ...
        "Are you committed to including this course on the master schedule in #{APPLICATION_CURRENT_YEAR_SHORT} if this teacher is accepted into the program?",
