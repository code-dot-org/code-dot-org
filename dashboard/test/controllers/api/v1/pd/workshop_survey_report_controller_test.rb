...
class Api::V1::Pd::WorkshopSurveyReportControllerTest < ::ActionController::TestCase
  ...
  test 'local workshop survey report' do
    ...
    sign_out(facilitator_1)
    sign_in(facilitator_2)
    ...
    assert_equal 3, response_hash['all_my_local_workshops']['how_much_learned']
    assert_equal 1, response_hash['this_workshop']['how_clearly_presented']
    assert_equal 1, response_hash['all_my_local_workshops']['how_clearly_presented']
