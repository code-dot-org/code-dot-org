...
class AidiffExitTicketsControllerTest < ActionController::TestCase
  ...
  test "index returns only user-owned exit_tickets" do
    ...
    create(:aidiff_exit_ticket, aidiff_thread: thread1, user: @teacher2)
    create(:aidiff_lesson_hook, aidiff_thread: thread2, user: @teacher2)
    ...
    create(:aidiff_exit_ticket, aidiff_thread: thread3, user: @teacher)
    create(:aidiff_lesson_hook, aidiff_thread: thread4, user: @teacher)
    ...
    assert_equal "AidiffExitTicket", json_response[0]["type"]
  end
  ...
  test "index returns only exit_tickets" do
    ...
    create(:aidiff_exit_ticket, aidiff_thread: thread1, user: @teacher)
    create(:aidiff_lesson_hook, aidiff_thread: thread2, user: @teacher)
    create(:aidiff_exit_ticket, aidiff_thread: thread3, user: @teacher)
    ...
    assert_equal "AidiffExitTicket", json_response[0]["type"]
    assert_equal "AidiffExitTicket", json_response[1]["type"]
  end
  ...
  test "index returns only exit_tickets matching unit_group params" do
    ...
    artifact1 = create(:aidiff_exit_ticket, aidiff_thread: thread1, user: @teacher, title: "blah artifact")
    create(:aidiff_lesson_hook, aidiff_thread: thread2, user: @teacher)
    artifact3 = create(:aidiff_exit_ticket, aidiff_thread: thread3, user: @teacher, title: "lol artifact")
  ...
  test "index returns only unique exit_tickets matching params" do
    ...
    artifact1 = create(:aidiff_exit_ticket, aidiff_thread: thread1, user: @teacher, title: "blah artifact")
    create(:aidiff_exit_ticket, aidiff_thread: thread2, user: @teacher, title: "omg artifact")
    artifact3 = create(:aidiff_exit_ticket, aidiff_thread: thread3, user: @teacher, title: "lol artifact")
  ...
  test "index returns only unique exit_tickets matching multiple params" do
    ...
    artifact1 = create(:aidiff_exit_ticket, aidiff_thread: thread1, user: @teacher, title: "blah artifact")
    artifact2 = create(:aidiff_exit_ticket, aidiff_thread: thread2, user: @teacher, title: "omg artifact")
    create(:aidiff_exit_ticket, aidiff_thread: thread3, user: @teacher, title: "lol artifact")
