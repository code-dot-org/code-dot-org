...
class ActivitiesControllerTest < ActionController::TestCase
  ...
  test "milestone updates assessment activities for multi assessments" do
    ...
    post :milestone, params: @milestone_params
    assert_nil Activity.find_by(user_id: @user, level_id: @script_level.id, script_id: @script_level.script.id)
    ...
    assert_nil Activity.find_by(user_id: @user, level_id: assessment_script_level.level.id, script_id: assessment_script_level.script.id)
    ...
    assert_nil Activity.find_by(user_id: @user, level_id: multi_sl.level.id, script_id: multi_sl.script.id)
    ...
    assert_nil Activity.find_by(user_id: @user, level_id: multi_sublevel.id)
  end
end
