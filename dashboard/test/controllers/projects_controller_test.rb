...
class ProjectsControllerTest < ActionController::TestCase
  ...
  test 'on lab2 levels navigating to /edit redirects to /view if user is project owner and project is frozen' do
    channel_id = '12345'
    Projects.any_instance.stubs(:get).returns({isFrozen: true, isOwner: true})
