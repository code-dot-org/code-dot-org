...
module Ops
  class DistrictsControllerTest < ::ActionController::TestCase
    ...
    test 'read district info' do
      assert_routing({ path: 'ops/districts/1', method: :get }, { controller: 'ops/districts', action: 'show', id: '1' })
    ...
    test 'update district info' do
      assert_routing({ path: 'ops/districts/1', method: :patch }, { controller: 'ops/districts', action: 'update', id: '1' })
