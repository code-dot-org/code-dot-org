...
module Ops
  class WorkshopsControllerTest < ::ActionController::TestCase
    ...
    test 'list all workshops' do
      assert_routing({ path: 'ops/workshops', method: :get }, { controller: 'workshops', action: 'index' })
    ...
    test 'create workshop' do
      assert_routing({ path: 'ops/workshops', method: :post }, { controller: 'workshops', action: 'create' })
    ...
    test 'read workshop info' do
      assert_routing({ path: 'ops/workshops/1', method: :get }, { controller: 'workshops', action: 'show', id: '1' })
    ...
    test 'update workshop info' do
      assert_routing({ path: 'ops/workshops/1', method: :patch }, { controller: 'workshops', action: 'update', id: '1' })
    ...
    test 'delete workshop' do
      assert_routing({ path: 'ops/workshops/1', method: :delete }, { controller: 'workshops', action: 'destroy', id: '1' })
