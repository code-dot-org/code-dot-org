...
class HomeControllerTest < ActionController::TestCase
  ...
  test "teacher visiting homepage gets expected cookies set" do
    ...
    assert_include(cookie_header, "teacher_account_age_in_years")
    assert_include(cookie_header, "teacher_within_us")
    assert_include(cookie_header, "teacher_has_attended_pd")
  end
