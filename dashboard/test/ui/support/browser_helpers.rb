module BrowserHelpers
  ...
  def elements_have_css(selector, property, expected_values)
    values = @browser.execute_script("return $(\"#{selector}\").map( function () { return $(this).css(\"#{property}\")});")
    values.join(', ').should eq expected_values
  end
