...
require_relative './test_runner/test_runner_options_parser'
...
#
test_runner_option_parser = TestRunnerOptionsParser.new(ARGV)
status = main(test_runner_option_parser)
exit status
