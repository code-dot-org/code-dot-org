...
Scenario: Failing at puzzle 6, refreshing puzzle 6, bubble should show up as attempted
  Given I am on "http://studio.code.org/ui-test-hoc/6?noautoplay=true"
  And I wait for the lab page to fully load
  And I press "runButton"
...
Scenario: Progress on the server that is not on the client
  Given I am on "http://studio.code.org/ui-test-hoc/20?noautoplay=true"
  And I wait for the lab page to fully load
  And I verify progress in the header of the current page is "not_tried" for level 20
  And I press "runButton"
  Then I am on "http://studio.code.org/ui-test-hoc/reset"
  Then I am on "http://studio.code.org/ui-test-hoc/20?noautoplay=true"
