...
Feature: Hour of Code 2015 tutorial is completable
  ...
  Scenario: Solving puzzle 1 in block mode
    Given I am on "http://studio.code.org/courses/ui-test-student-labs/units/1/reset"
    And execute JavaScript expression "window.localStorage.clear()"
    And I am on "http://studio.code.org/courses/ui-test-student-labs/units/1/lessons/24/levels/3?noautoplay=true"
    Then I wait until I am on "http://studio.code.org/courses/ui-test-student-labs/units/1/lessons/24/levels/3?noautoplay=true"
    ...
    Then I wait until I am on "http://studio.code.org/courses/ui-test-student-labs/units/1/lessons/24/levels/4"
    And I wait for the lab page to fully load
    And I verify progress in the header of the current page is "perfect" for level 3

  Scenario: Solving puzzle 1 in text mode
    Given I am on "http://studio.code.org/courses/ui-test-student-labs/units/1/lessons/24/levels/3?noautoplay=true"
    Then I wait until I am on "http://studio.code.org/courses/ui-test-student-labs/units/1/lessons/24/levels/3?noautoplay=true"
  ...
  Scenario: Solving puzzle 2 in text mode
    Given I am on "http://studio.code.org/courses/ui-test-student-labs/units/1/lessons/24/levels/4?noautoplay=true"
    Then I wait until I am on "http://studio.code.org/courses/ui-test-student-labs/units/1/lessons/24/levels/4?noautoplay=true"
    And I wait for the lab page to fully load
    When I ensure droplet is in text mode
    And I append text to droplet "moveRight();\n"
  ...
  Scenario: Solving puzzle 3 in text mode
    Given I am on "http://studio.code.org/courses/ui-test-student-labs/units/1/lessons/24/levels/5?noautoplay=true"
    Then I wait until I am on "http://studio.code.org/courses/ui-test-student-labs/units/1/lessons/24/levels/5?noautoplay=true"
    And I wait for the lab page to fully load
  ...
  Scenario: Solving puzzle 4 in text mode
    Given I am on "http://studio.code.org/courses/ui-test-student-labs/units/1/lessons/24/levels/6?noautoplay=true"
    Then I wait until I am on "http://studio.code.org/courses/ui-test-student-labs/units/1/lessons/24/levels/6?noautoplay=true"
    And I wait for the lab page to fully load
  ...
  Scenario: Solving puzzle 5 in text mode
    Given I am on "http://studio.code.org/courses/ui-test-student-labs/units/1/lessons/24/levels/7?noautoplay=true"
    Then I wait until I am on "http://studio.code.org/courses/ui-test-student-labs/units/1/lessons/24/levels/7?noautoplay=true"
    And I wait for the lab page to fully load
    And I append text to droplet "moveRight();\n"
    And I append text to droplet "moveDown();\n"
    And I append text to droplet "moveDown();\n"
  ...
  Scenario: Solving puzzle 6 in text mode
    Given I am on "http://studio.code.org/courses/ui-test-student-labs/units/1/lessons/24/levels/8?noautoplay=true"
    Then I wait until I am on "http://studio.code.org/courses/ui-test-student-labs/units/1/lessons/24/levels/8?noautoplay=true"
    And I wait for the lab page to fully load
    When I ensure droplet is in text mode
    And I append text to droplet "moveDown();\n"
    And I append text to droplet "moveUp();\n"
