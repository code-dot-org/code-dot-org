...
Scenario: Solving puzzle 1, proceeding to puzzle 2, verifying that puzzle 1 appears as solved
  ...
  Then check that I am on "http://studio.code.org/ui-test-hoc/1?noautoplay=true"
  Then I am on "http://studio.code.org/ui-test-hoc/2?noautoplay=true"
  And I wait for the lab page to fully load
  And I verify progress in the header of the current page is "perfect" for level 1
  # Course overview should also show progress
  Then I navigate to the unit page for unit number "1" in course "ui-test-hourofcode"
  And I verify progress for lesson 1 level 1 is "perfect"
  # Course overview in a different unit shouldn't show progress
  Then I am on "http://studio.code.org/courses/ui-test-csf/units/1/lessons/1/levels/2?noautoplay=true"
  Then I wait until I am on "http://studio.code.org/courses/ui-test-csf/units/1/lessons/1/levels/2?noautoplay=true"
  And I verify progress in the header of the current page is "not_tried" for level 1
  # Level source is saved
  Then I am on "http://studio.code.org/ui-test-hoc/1?noautoplay=true"
  Then I wait until I am on "http://studio.code.org/ui-test-hoc/1?noautoplay=true"
  And I wait for the lab page to fully load
...
Scenario: Failing at puzzle 1, refreshing puzzle 1, bubble should show up as attempted
  ...
  And I navigate to the unit page for unit number "1" in course "ui-test-hourofcode"
...
Scenario: Go to puzzle 10, see video, go somewhere else, return to puzzle 10, should not see video, comes back on link
  Given I am on "http://studio.code.org/ui-test-hoc/10"
  Then I wait until element ".video-modal" is visible
  Then I close the dialog
  Then I am on "http://studio.code.org/ui-test-hoc/11"
  Then I wait until I am on "http://studio.code.org/ui-test-hoc/11"
  And I wait for the lab page to fully load
  Then I am on "http://studio.code.org/ui-test-hoc/10"
  Then I wait until I am on "http://studio.code.org/ui-test-hoc/10"
  And I wait for the lab page to fully load
...
Scenario: Go to puzzle 9, see callouts, go somewhere else, return to puzzle 9, should not see callouts
  Given I am on "http://studio.code.org/ui-test-hoc/9?noautoplay=true"
  And I wait for the lab page to fully load
  Then element ".qtip-content:contains('Blocks that are grey')" is visible
  Then I am on "http://studio.code.org/ui-test-hoc/10?noautoplay=true"
  Then I wait until I am on "http://studio.code.org/ui-test-hoc/10?noautoplay=true"
  And I wait for the lab page to fully load
  Then I am on "http://studio.code.org/ui-test-hoc/9?noautoplay=true"
  Then I wait until I am on "http://studio.code.org/ui-test-hoc/9?noautoplay=true"
  And I wait for the lab page to fully load
