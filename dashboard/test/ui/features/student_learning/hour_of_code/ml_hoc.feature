...
Feature: Oceans ML HoC
  ...
  Scenario: Fish vs. Trash
    # Training Screen
    Given I am on "http://studio.code.org/courses/ui-test-all-the-levels/units/1/lessons/42/levels/2?guide=off"
  ...
  Scenario: Sea Creatures
    # Initial Screen
    Given I am on "http://studio.code.org/courses/ui-test-all-the-levels/units/1/lessons/42/levels/3?guide=off"
    Then I click selector "button:contains(Run)" once I see it
    And I wait until element "button:contains(Continue)" is visible
    And I wait for 2 seconds

    # Training Screen
    Given I am on "http://studio.code.org/courses/ui-test-all-the-levels/units/1/lessons/42/levels/4?guide=off"
  ...
  Scenario: Short Word List
    # Training Screen
    Given I am on "http://studio.code.org/courses/ui-test-all-the-levels/units/1/lessons/42/levels/5?guide=off"
  ...
  Scenario: Long Word List
    # Training Screen
    Given I am on "http://studio.code.org/courses/ui-test-all-the-levels/units/1/lessons/42/levels/6?guide=off"
