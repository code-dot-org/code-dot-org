...
Scenario:
  ...
  Given I am on "http://studio.code.org/courses/ui-test-all-the-levels/units/1/lessons/9/levels/1?noautoplay=true"
...
Scenario:
  ...
  Given I am on "http://studio.code.org/courses/ui-test-all-the-levels/units/1/lessons/11/levels/2?noautoplay=true"
  And The header is finished animating
  Then element ".submitButton" is visible
  And I see no difference for "level load"
  And I close my eyes
...
Scenario:
  ...
  Given I am on "http://studio.code.org/courses/ui-test-all-the-levels/units/1/lessons/16/levels/1?noautoplay=true"
  And The header is finished animating
  And I see no difference for "level load"
...
Scenario:
  ...
  Given I am on "http://studio.code.org/courses/ui-test-all-the-levels/units/1/lessons/17/levels/2?noautoplay=true"
  And The header is finished animating
  And I see no difference for "level load"
  And I close my eyes
...
Scenario:
  ...
  Then I am on "http://studio.code.org/courses/ui-test-all-the-levels/units/1/lessons/2/levels/1/lang/ar-sa"
  And I wait for the lab page to fully load
...
Scenario:
  ...
  Given I am on "http://studio.code.org/courses/ui-test-all-the-levels/units/1/lessons/24/levels/9/lang/ar-sa?noautoplay=true"
  And The header is finished animating
