...
Scenario: Frozen tutorial in Spanish
  Given I am on "http://studio.code.org/courses/ui-test-level-i18n/units/1/lessons/1/levels/1/lang/es-MX"
  And I wait for the lab page to fully load
...
Scenario: Minecraft:Agent tutorial in Spanish
  Given I am on "http://studio.code.org/courses/ui-test-level-i18n/units/1/lessons/1/levels/2/lang/es-MX"
  And I wait for the lab page to fully load
...
Scenario: Toolbox Categories in Spanish
  Given I am on "http://studio.code.org/courses/ui-test-all-the-levels/units/1/lessons/45/levels/4/lang/es-MX"
  And I wait for the lab page to fully load
...
Scenario: Translated function names in Spanish
  Given I am on "http://studio.code.org/courses/ui-test-level-i18n/units/1/lessons/1/levels/4/lang/es-MX"
  And I wait for the lab page to fully load
...
Scenario: Frozen tutorial in Portuguese
  Given I am on "http://studio.code.org/courses/ui-test-level-i18n/units/1/lessons/1/levels/1/lang/pt-br"
  And I wait for the lab page to fully load
...
Scenario: Minecraft:Agent tutorial in Portuguese
  Given I am on "http://studio.code.org/courses/ui-test-level-i18n/units/1/lessons/1/levels/2/lang/pt-br"
  And I wait for the lab page to fully load
  Then element "#toggleButton" is visible
  And I click selector "#toggleButton"
  And I wait until element ".csf-top-instructions p" is visible
...
Scenario: Toolbox Categories in Portuguese
  Given I am on "http://studio.code.org/courses/ui-test-all-the-levels/units/1/lessons/45/levels/4/lang/pt-br"
  And I wait for the lab page to fully load
...
Scenario: Translated function names in Portuguese
  Given I am on "http://studio.code.org/courses/ui-test-level-i18n/units/1/lessons/1/levels/4/lang/pt-BR"
  And I wait for the lab page to fully load
  # Toolbox call block is translated
...
Scenario: Frozen tutorial in Arabic (RTL)
  Given I am on "http://studio.code.org/courses/ui-test-level-i18n/units/1/lessons/1/levels/1/lang/ar-sa"
  And I wait for the lab page to fully load
...
Scenario: Minecraft:Agent tutorial in Arabic (RTL)
  Given I am on "http://studio.code.org/courses/ui-test-level-i18n/units/1/lessons/1/levels/2/lang/ar-sa"
  And I wait for the lab page to fully load
  Then element "#toggleButton" is visible
  And I click selector "#toggleButton"
  And I wait until element ".csf-top-instructions p" is visible
...
Scenario: Translated function names in Arabic
  Given I am on "http://studio.code.org/courses/ui-test-level-i18n/units/1/lessons/1/levels/4/lang/ar-SA"
  And I wait for the lab page to fully load
  # Toolbox call block is translated
...
Scenario: Toolbox Categories in Arabic (RTL)
  Given I am on "http://studio.code.org/courses/ui-test-all-the-levels/units/1/lessons/45/levels/4/lang/ar-sa"
  And I wait for the lab page to fully load
...
Scenario: Pixelation Widget long and short instructions in Spanish
  Given I am on "http://studio.code.org/courses/ui-test-level-i18n/units/1/lessons/1/levels/3/lang/es-MX"
