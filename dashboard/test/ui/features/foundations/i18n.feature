...
Scenario: Toolbox Categories in Spanish
  ...
  And I wait for the lab page to fully load
  Then element ".blocklyToolbox:visible > .blocklyToolboxCategoryGroup > .blocklyToolboxCategoryContainer:nth-child(1) > .blocklyToolboxCategory .blocklyToolboxCategoryLabel" has "es-MX" text from key "data.block_categories.Events"
  Then element ".blocklyToolbox:visible > .blocklyToolboxCategoryGroup > .blocklyToolboxCategoryContainer:nth-child(2) > .blocklyToolboxCategory .blocklyToolboxCategoryLabel" has "es-MX" text from key "data.block_categories.Text"
  Then element ".blocklyToolbox:visible > .blocklyToolboxCategoryGroup > .blocklyToolboxCategoryContainer:nth-child(3) > .blocklyToolboxCategory .blocklyToolboxCategoryLabel" has "es-MX" text from key "data.block_categories.Variables"
  Then element ".blocklyToolbox:visible > .blocklyToolboxCategoryGroup > .blocklyToolboxCategoryContainer:nth-child(4) > .blocklyToolboxCategory .blocklyToolboxCategoryLabel" has "es-MX" text from key "data.block_categories.Effects"
  Then element ".blocklyToolbox:visible > .blocklyToolboxCategoryGroup > .blocklyToolboxCategoryContainer:nth-child(5) > .blocklyToolboxCategory .blocklyToolboxCategoryLabel" has "es-MX" text from key "data.block_categories.Sprites"
  Then element ".blocklyToolbox:visible > .blocklyToolboxCategoryGroup > .blocklyToolboxCategoryContainer:nth-child(6) > .blocklyToolboxCategory .blocklyToolboxCategoryLabel" has "es-MX" text from key "data.block_categories.Functions"
  Then element ".blocklyToolbox:visible > .blocklyToolboxCategoryGroup > .blocklyToolboxCategoryContainer:nth-child(7) > .blocklyToolboxCategory .blocklyToolboxCategoryLabel" has "es-MX" text from key "data.block_categories.Variables"
...
Scenario: Toolbox Categories in Portuguese
  ...
  And I wait for the lab page to fully load
  Then element ".blocklyToolbox:visible > .blocklyToolboxCategoryGroup > .blocklyToolboxCategoryContainer:nth-child(1) > .blocklyToolboxCategory .blocklyToolboxCategoryLabel" has "pt-BR" text from key "data.block_categories.Events"
  Then element ".blocklyToolbox:visible > .blocklyToolboxCategoryGroup > .blocklyToolboxCategoryContainer:nth-child(2) > .blocklyToolboxCategory .blocklyToolboxCategoryLabel" has "pt-BR" text from key "data.block_categories.Text"
  Then element ".blocklyToolbox:visible > .blocklyToolboxCategoryGroup > .blocklyToolboxCategoryContainer:nth-child(3) > .blocklyToolboxCategory .blocklyToolboxCategoryLabel" has "pt-BR" text from key "data.block_categories.Variables"
  Then element ".blocklyToolbox:visible > .blocklyToolboxCategoryGroup > .blocklyToolboxCategoryContainer:nth-child(4) > .blocklyToolboxCategory .blocklyToolboxCategoryLabel" has "pt-BR" text from key "data.block_categories.Effects"
  Then element ".blocklyToolbox:visible > .blocklyToolboxCategoryGroup > .blocklyToolboxCategoryContainer:nth-child(5) > .blocklyToolboxCategory .blocklyToolboxCategoryLabel" has "pt-BR" text from key "data.block_categories.Sprites"
  Then element ".blocklyToolbox:visible > .blocklyToolboxCategoryGroup > .blocklyToolboxCategoryContainer:nth-child(6) > .blocklyToolboxCategory .blocklyToolboxCategoryLabel" has "pt-BR" text from key "data.block_categories.Functions"
  Then element ".blocklyToolbox:visible > .blocklyToolboxCategoryGroup > .blocklyToolboxCategoryContainer:nth-child(7) > .blocklyToolboxCategory .blocklyToolboxCategoryLabel" has "pt-BR" text from key "data.block_categories.Variables"
...
Scenario: Translated function names in Arabic
  Given I am on "http://studio.code.org/courses/allthethingscourse/units/1/lessons/4/levels/6/lang/ar-SA"
  And I wait for the lab page to fully load
  # Toolbox call block is translated
...
Scenario: Toolbox Categories in Arabic (RTL)
  ...
  And I wait for the lab page to fully load
  Then element ".blocklyToolbox:visible > .blocklyToolboxCategoryGroup > .blocklyToolboxCategoryContainer:nth-child(1) > .blocklyToolboxCategory .blocklyToolboxCategoryLabel" has "ar-SA" text from key "data.block_categories.Events"
  Then element ".blocklyToolbox:visible > .blocklyToolboxCategoryGroup > .blocklyToolboxCategoryContainer:nth-child(2) > .blocklyToolboxCategory .blocklyToolboxCategoryLabel" has "ar-SA" text from key "data.block_categories.Text"
  Then element ".blocklyToolbox:visible > .blocklyToolboxCategoryGroup > .blocklyToolboxCategoryContainer:nth-child(3) > .blocklyToolboxCategory .blocklyToolboxCategoryLabel" has "ar-SA" text from key "data.block_categories.Variables"
  Then element ".blocklyToolbox:visible > .blocklyToolboxCategoryGroup > .blocklyToolboxCategoryContainer:nth-child(4) > .blocklyToolboxCategory .blocklyToolboxCategoryLabel" has "ar-SA" text from key "data.block_categories.Effects"
  Then element ".blocklyToolbox:visible > .blocklyToolboxCategoryGroup > .blocklyToolboxCategoryContainer:nth-child(5) > .blocklyToolboxCategory .blocklyToolboxCategoryLabel" has "ar-SA" text from key "data.block_categories.Sprites"
  Then element ".blocklyToolbox:visible > .blocklyToolboxCategoryGroup > .blocklyToolboxCategoryContainer:nth-child(6) > .blocklyToolboxCategory .blocklyToolboxCategoryLabel" has "ar-SA" text from key "data.block_categories.Functions"
  Then element ".blocklyToolbox:visible > .blocklyToolboxCategoryGroup > .blocklyToolboxCategoryContainer:nth-child(7) > .blocklyToolboxCategory .blocklyToolboxCategoryLabel" has "ar-SA" text from key "data.block_categories.Variables"
