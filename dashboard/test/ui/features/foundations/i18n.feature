...
Scenario: Frozen tutorial in Spanish
  Given I am on "http://studio.code.org/s/frozen/lessons/1/puzzle/2/lang/es-MX"
  And I rotate to landscape
  And I wait for the page to fully load
...
Scenario: Minecraft:Agent tutorial in Spanish
  Given I am on "http://studio.code.org/s/hero/lessons/1/puzzle/1/lang/es-MX"
  And I rotate to landscape
  And I wait for the page to fully load
...
Scenario: Toolbox Categories in Spanish
  Given I am on "http://studio.code.org/s/allthethings/lessons/3/puzzle/7/lang/es-MX"
  And I rotate to landscape
  And I wait for the page to fully load
...
Scenario: Translated function names in Spanish
  Given I am on "http://studio.code.org/s/allthethings/lessons/3/puzzle/3/lang/es-MX"
  And I rotate to landscape
  And I wait for the page to fully load
...
Scenario: Frozen tutorial in Portuguese
  Given I am on "http://studio.code.org/s/frozen/lessons/1/puzzle/2/lang/pt-br"
  And I rotate to landscape
  And I wait for the page to fully load
...
Scenario: Minecraft:Agent tutorial in Portuguese
  Given I am on "http://studio.code.org/s/hero/lessons/1/puzzle/1/lang/pt-br"
  And I rotate to landscape
  And I wait for the page to fully load
  Then element "#toggleButton" is visible
  And I click selector "#toggleButton"
...
Scenario: Toolbox Categories in Portuguese
  Given I am on "http://studio.code.org/s/allthethings/lessons/3/puzzle/7/lang/pt-br"
  And I rotate to landscape
  And I wait for the page to fully load
...
Scenario: Translated function names in Portuguese
  Given I am on "http://studio.code.org/s/allthethings/lessons/3/puzzle/3/lang/pt-BR"
  And I rotate to landscape
  And I wait for the page to fully load
  # Toolbox call block is translated
...
Scenario: Frozen tutorial in Arabic (RTL)
  Given I am on "http://studio.code.org/s/frozen/lessons/1/puzzle/2/lang/ar-sa"
  And I rotate to landscape
  And I wait for the page to fully load
...
Scenario: Minecraft:Agent tutorial in Arabic (RTL)
  Given I am on "http://studio.code.org/s/hero/lessons/1/puzzle/1/lang/ar-sa"
  And I rotate to landscape
  And I wait for the page to fully load
  Then element "#toggleButton" is visible
  And I click selector "#toggleButton"
...
Scenario: Translated function names in Arabic
  Given I am on "http://studio.code.org/s/allthethings/lessons/3/puzzle/3/lang/ar-SA"
  And I rotate to landscape
  And I wait for the page to fully load
  # Toolbox call block is translated
...
Scenario: Toolbox Categories in Arabic (RTL)
  Given I am on "http://studio.code.org/s/allthethings/lessons/3/puzzle/7/lang/ar-sa"
  And I rotate to landscape
  And I wait for the page to fully load
