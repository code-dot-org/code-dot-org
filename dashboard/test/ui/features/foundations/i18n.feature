...
Scenario: Frozen tutorial in Spanish
  Given I am on "http://studio.code.org/courses/ui-test-student-labs/units/1/lessons/3/levels/10/lang/es-MX"
  And I wait for the lab page to fully load
...
Scenario: Minecraft:Agent tutorial in Spanish
  Given I am on "http://studio.code.org/courses/ui-test-student-labs/units/1/lessons/25/levels/7/lang/es-MX"
  And I wait for the lab page to fully load
...
Scenario: Translated function names in Spanish
  Given I am on "http://studio.code.org/courses/ui-test-student-labs/units/1/lessons/4/levels/6/lang/es-MX"
  And I wait for the lab page to fully load
...
Scenario: Frozen tutorial in Portuguese
  Given I am on "http://studio.code.org/courses/ui-test-student-labs/units/1/lessons/3/levels/10/lang/pt-br"
  And I wait for the lab page to fully load
...
Scenario: Minecraft:Agent tutorial in Portuguese
  Given I am on "http://studio.code.org/courses/ui-test-student-labs/units/1/lessons/25/levels/7/lang/pt-br"
  And I wait for the lab page to fully load
  Then element "#toggleButton" is visible
  And I click selector "#toggleButton"
  And I wait until element ".csf-top-instructions p" is visible
...
Scenario: Translated function names in Portuguese
  Given I am on "http://studio.code.org/courses/ui-test-student-labs/units/1/lessons/4/levels/6/lang/pt-BR"
  And I wait for the lab page to fully load
  # Toolbox call block is translated
...
Scenario: Frozen tutorial in Arabic (RTL)
  Given I am on "http://studio.code.org/courses/ui-test-student-labs/units/1/lessons/3/levels/10/lang/ar-sa"
  And I wait for the lab page to fully load
...
Scenario: Minecraft:Agent tutorial in Arabic (RTL)
  Given I am on "http://studio.code.org/courses/ui-test-student-labs/units/1/lessons/25/levels/7/lang/ar-sa"
  And I wait for the lab page to fully load
  Then element "#toggleButton" is visible
  And I click selector "#toggleButton"
  And I wait until element ".csf-top-instructions p" is visible
...
Scenario: Translated function names in Arabic
  Given I am on "http://studio.code.org/courses/ui-test-student-labs/units/1/lessons/4/levels/6/lang/ar-SA"
  And I wait for the lab page to fully load
  # Toolbox call block is translated
...
Scenario: Pixelation Widget long and short instructions in Spanish
  Given I am on "http://studio.code.org/courses/ui-test-student-labs/units/1/lessons/17/levels/2/lang/es-MX"
