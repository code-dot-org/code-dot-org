...
Scenario: Minecraft:Agent tutorial in Portuguese
  Given I am on "http://studio.code.org/s/hero/lesson/1/puzzle/1/lang/pt-br"
  And I rotate to landscape
  And I wait for the page to fully load
  Then element "#toggleButton" is visible
  And I click selector "#toggleButton"
...
Scenario: Toolbox Categories in Portuguese
  Given I am on "http://studio.code.org/s/allthethings/lesson/3/puzzle/7/lang/pt-br"
  And I rotate to landscape
  And I wait for the page to fully load
...
Scenario: Translated function names in Portuguese
  Given I am on "http://studio.code.org/s/allthethings/lesson/3/puzzle/3/lang/pt-BR"
  And I rotate to landscape
  And I wait for the page to fully load
  # Toolbox call block is translated
...
Scenario: Frozen tutorial in Arabic (RTL)
  Given I am on "http://studio.code.org/s/frozen/lesson/1/puzzle/2/lang/ar-sa"
  And I rotate to landscape
  And I wait for the page to fully load
...
Scenario: Minecraft:Agent tutorial in Arabic (RTL)
  Given I am on "http://studio.code.org/s/hero/lesson/1/puzzle/1/lang/ar-sa"
  And I rotate to landscape
  And I wait for the page to fully load
  Then element "#toggleButton" is visible
  And I click selector "#toggleButton"
...
Scenario: Translated function names in Arabic
  Given I am on "http://studio.code.org/s/allthethings/lesson/3/puzzle/3/lang/ar-SA"
  And I rotate to landscape
  And I wait for the page to fully load
  # Toolbox call block is translated
...
Scenario: Toolbox Categories in Arabic (RTL)
  Given I am on "http://studio.code.org/s/allthethings/lesson/3/puzzle/7/lang/ar-sa"
  And I rotate to landscape
  And I wait for the page to fully load
