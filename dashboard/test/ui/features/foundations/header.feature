...
Scenario: Student in English should see 2 header links
  ...
  And element "#header-student-catalog" contains text "Curriculum Catalog"
...
Scenario: Teacher in English should see 5 header links
  ...
  And element "#header-teacher-catalog" contains text "Curriculum Catalog"
...
Scenario: Signed out user in Spanish should see 3 header links
  ...
  And element "#header-non-en-catalog" has "es" text from key "nav.header.curriculum_catalog"
...
Scenario: Student in Spanish should see 3 header links
  ...
  And I wait to see ".headerlinks"
  And I see "#header-student-catalog"
  And element "#header-student-catalog" has "es" text from key "nav.header.curriculum_catalog"
  And I see "#header-student-projects"
...
Scenario: Teacher in Spanish should see 5 header links
  ...
  And I see "#header-teacher-catalog"
  And element "#header-teacher-catalog" has "es" text from key "nav.header.curriculum_catalog"
  And I see "#header-teacher-projects"
