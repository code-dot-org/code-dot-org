Feature: Checking the footer appearance
  ...
  Scenario: Desktop puzzle using light small footer
    ...
    Given I am on "http://studio.code.org/courses/ui-test-all-the-levels/units/1/lessons/2/levels/1?noautoplay=true"
  ...
  Scenario: Desktop Minecraft puzzle using dark small footer
    ...
    Given I am on "http://studio.code.org/courses/ui-test-all-the-levels/units/1/lessons/25/levels/1?noautoplay=true"
    And I wait for the lab page to fully load
  ...
  Scenario: Desktop Star Wars share small footer
    ...
    Given I am on "http://studio.code.org/courses/ui-test-all-the-levels/units/1/lessons/24/levels/9?noautoplay=true"
    And I wait for the lab page to fully load
