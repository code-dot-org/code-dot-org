Feature: Checking the footer appearance
  ...
  Scenario: Desktop Minecraft puzzle using dark small footer
    Given I am on "http://studio.code.org/s/mc/lessons/1/puzzle/14?noautoplay=true"
    And I wait for the page to fully load
  ...
  Scenario: Desktop Star Wars share small footer
    Given I am on "http://studio.code.org/s/starwars/lessons/1/puzzle/15?noautoplay=true"
    And I wait for the page to fully load
