...
Scenario: Can create a function
  Then element ".blocklyTreeRow:contains('Functions')" is visible
  And element "#modalFunctionEditor" is not visible
  And I click selector ".blocklyTreeRow:contains('Functions')"
  ...
  Then I click selector ".blocklyTreeRow:contains('Functions')"
...
Scenario: Can edit a function
  ...
  # Open Sprites flyout
  And I click selector "#modalFunctionEditor .blocklyTreeRow:contains('Sprites')"
