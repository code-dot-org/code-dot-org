...
Background:
  ...
  And I am on "http://studio.code.org/courses/ui-test-student-labs/units/1/lessons/50/levels/1?hideProductTours=true"
...
Scenario: Continue button and progress status shows up correctly
  ...
  And I am on "http://studio.code.org/courses/ui-test-student-labs/units/1/lessons/50/levels/2?hideProductTours=true"
