...
Scenario: Top Instructions
  ...
  And I am on "http://studio.code.org/s/course1/stage/4/puzzle/11?noautoplay=true&enableExperiments=topInstructionsCSF"
  Then I see no difference for "maze short instructions"

  And I am on "http://studio.code.org/s/course4/stage/3/puzzle/5?noautoplay=true&enableExperiments=topInstructionsCSF"
  ...
  Then I am on "http://studio.code.org/s/course1/stage/4/puzzle/5?noautoplay=true&enableExperiments=topInstructionsCSF"
  ...
  Then I am on "http://studio.code.org/s/allthethings/stage/6/puzzle/2?noautoplay=true&enableExperiments=topInstructionsCSF"
  ...
  Then I am on "http://studio.code.org/s/course4/stage/19/puzzle/3?noautoplay=true&enableExperiments=topInstructionsCSF"
  And I see no difference for "Bee with starting hints"

  Then I am on "http://studio.code.org/s/course1/stage/3/puzzle/1?noautoplay=true&enableExperiments=topInstructionsCSF"
  And I see no difference for "Jigsaw with anigif"

  Then I am on "http://studio.code.org/s/mc/stage/1/puzzle/4?noautoplay=true&enableExperiments=topInstructionsCSF"
  And I see no difference for "minecraft top instructions"

  Then I am on "http://studio.code.org/s/starwars/stage/1/puzzle/15?noautoplay=true&enableExperiments=topInstructionsCSF"
  And I see no difference for "starwars top instructions"

  Then I am on "http://studio.code.org/s/frozen/stage/1/puzzle/5?noautoplay=true&enableExperiments=topInstructionsCSF"
