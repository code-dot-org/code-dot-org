...
Scenario: Check that TTS player is displayed
  ...
  And I am on "http://studio.code.org/s/allthettsthings/lessons/1/puzzle/1"
...
Scenario: Listen to TTS Audio in CSF
  Given I am on "http://studio.code.org/s/allthethings/lessons/6/puzzle/3?noautoplay=true"
...
Scenario: Listen to TTS Audio in CSD
  Given I am a student
  And I am on "http://studio.code.org/s/allthettsthings/lessons/1/puzzle/2"
  And I wait for the page to fully load
...
Scenario: Listen to TTS Audio in CSP and CSP contained level
  Given I am a student
  And I am on "http://studio.code.org/s/allthettsthings/lessons/1/puzzle/4"
  And I wait for the page to fully load
  ...
  And I am on "http://studio.code.org/s/allthettsthings/lessons/1/puzzle/3"
  And I wait for the page to fully load
