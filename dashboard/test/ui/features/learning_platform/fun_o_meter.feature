...
Scenario: Rate a Puzzle
  Given I am on "http://studio.code.org/s/allthethings/lessons/4/puzzle/4?noautoplay=true"
  ...
  Then I wait until I am on "http://studio.code.org/s/allthethings/lessons/4/puzzle/5"
