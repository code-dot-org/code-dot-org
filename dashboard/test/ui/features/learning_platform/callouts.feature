...
Feature: Callouts
  ...
  Examples:
    ...
    | http://studio.code.org/s/20-hour/lessons/2/puzzle/1?noautoplay=true  | 1          | Hit "Run" to try your program                                            | #runButton        |
    ...
    | http://studio.code.org/s/20-hour/lessons/2/puzzle/9?noautoplay=true | 0          | Blocks that are grey can't be deleted. Can you solve the puzzle anyway?  | g                 |
    | http://studio.code.org/hoc/9?noautoplay=true        | 0          | Blocks that are grey can't be deleted. Can you solve the puzzle anyway?  | g                 |
    | http://studio.code.org/s/20-hour/lessons/2/puzzle/14?noautoplay=true | 0          | Click here to see the code for the program you're making                 | #show-code-header |
    | http://studio.code.org/hoc/14?noautoplay=true       | 0          | Click here to see the code for the program you're making                 | #show-code-header |
    | http://studio.code.org/s/20-hour/lessons/11/puzzle/1?noautoplay=true | 0          | You have all the same blocks but they've now been arranged in categories | .blocklyTreeLabel |
  ...
  Examples:
    | url                                                | callout_id | text                                                                             | close_target           |
    | http://studio.code.org/s/20-hour/lessons/2/puzzle/6?noautoplay=true  | 0          | Click here to watch the video again                                              | #thumbnail_mgooqyWMTxk |
  ...
  Scenario: Modal ordering
    Given I am on "http://studio.code.org/s/20-hour/lessons/2/puzzle/1?noautoplay=true"
    And I rotate to landscape
    And I wait for the page to fully load
