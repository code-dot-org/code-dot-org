...
Scenario:
  ...
  And I am on "http://studio.code.org/s/events/lessons/1/puzzle/1?noautoplay=true"
...
Scenario:
  ...
  And I am on "http://studio.code.org/s/course3/lessons/21/puzzle/15?noautoplay=true"
  When I rotate to landscape
  And I wait for the page to fully load
...
Scenario:
  ...
  And I am on "http://studio.code.org/s/playlab/lessons/1/puzzle/10?noautoplay=true"
  When I rotate to landscape
  And I wait for the page to fully load
  And I see no difference for "initial load"
  And I press "runButton"
