...
Scenario: Version warning announcement on course and script overview pages
  ...
  And I wait until current URL contains "/s/ui-test-script-in-course-2017/lesson/1/puzzle/1"
...
Scenario: Versions warning announcement on script overview page
  ...
  And I wait until current URL contains "/s/ui-test-versioned-script-2017/lesson/1/puzzle/1"
  ...
  When I am on "http://studio.code.org/s/course2/lesson/1/puzzle/1"
  And I click selector ".next-stage" once I see it
  And I wait until current URL contains "/s/course2/lesson/1/puzzle/2"
