...
Feature: Looking at curriculum reference levels Applitools Eyes
  ...
  Scenario Outline: Load iframe then take screenshot
    ...
    Examples:
      | url                                                                     | test_name                  |
      | http://studio.code.org/s/allthethings/lesson/35/puzzle/1?noautoplay=true | curriculum reference level |
      | http://studio.code.org/s/allthethings/lesson/35/puzzle/2?noautoplay=true | map level                  |
