...
Feature: BubbleChoice
  Scenario: Viewing BubbleChoice progress
    ...
    Given I am on "http://studio.code.org/s/allthethings/lesson/40/puzzle/1/sublevel/1"
    ...
    And check that the url contains "/s/allthethings/lesson/40/puzzle/1"
    And element ".uitest-bubble-choice:eq(0) .uitest-ProgressBubble:first" is visible
    ...
    Given I am on "http://studio.code.org/s/allthethings/lesson/40/puzzle/1"
    And I wait until element ".teacher-panel" is visible
