...
Scenario: Rendering in another language
  Given I am on "http://studio.code.org/s/course1/lessons/2/puzzle/2/lang/es-MX"
  Then I rotate to landscape
  And I wait to see ".submitButton"
  And element ".submitButton" is visible
...
Scenario: Does not scroll horizontally
  Given I am on "http://studio.code.org/s/allthethings/lessons/9/puzzle/2?noautoplay=true"
  When I rotate to landscape
  And element ".submitButton" is visible
  Then there is no horizontal scrollbar

Scenario: Can render without a question
  Given I am on "http://studio.code.org/s/allthethings/lessons/9/puzzle/4?noautoplay=true"
  When I rotate to landscape
  And element ".submitButton" is visible
