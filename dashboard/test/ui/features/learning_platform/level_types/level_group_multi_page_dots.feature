...
Scenario: Submit three pages as... 1. all, 2. none, 3. some questions answered.
  ...
  When I am on "http://studio.code.org/s/allthethings/lessons/23/puzzle/2/page/3?noautoplay=true"
  ...
  And I am on "http://studio.code.org/s/allthethings/lessons/23/puzzle/1?noautoplay=true"
  And I wait to see ".react_stage"
  And I wait until jQuery Ajax requests are finished
