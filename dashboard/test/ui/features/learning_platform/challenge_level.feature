...
Background:
  ...
  Given I am on "http://studio.code.org/s/allthethings/lessons/2/puzzle/6?noautoplay=true"
...
Scenario: Press the skip button
  ...
  Then I wait until I am on "http://studio.code.org/s/allthethings/lessons/2/puzzle/7"
