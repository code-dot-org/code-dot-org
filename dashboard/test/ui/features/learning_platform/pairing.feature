Feature: Student pairing
  Scenario: Pair Programming submits levels for both students
    ...
    And I join the section
    Given I am on "http://studio.code.org/s/allthethings/lessons/18/puzzle/7"
    ...
    And I wait until I am on "http://studio.code.org/s/allthethings/lessons/18/puzzle/8"
    And I wait for the page to fully load
  ...
  Scenario: Pair Programming attempts levels for both students
    ...
    Given I create a student named "Thing_Two"
    And I join the section
    Given I am on "http://studio.code.org/s/allthethings/lessons/2/puzzle/2"
    And I rotate to landscape
    And I wait for the page to fully load
    Then I initiate pairing
    # complete the level
