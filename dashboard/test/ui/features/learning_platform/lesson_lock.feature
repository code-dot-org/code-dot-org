...
Scenario: Stage Locking Dialog
  ...
  Scenario: Lock settings for students in test
  # initially locked for student in summary view
    ...
    Then element "td:contains(Example CSP Assessment) .fa-lock" is visible

    When I am on "http://studio.code.org/s/allthethings/lockable/3/levels/1/page/1"
