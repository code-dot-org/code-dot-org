Feature: Script overview page
  ...
  Scenario: Viewing student progress
    ...
    And I complete the level on "http://studio.code.org/s/allthethings/lesson/2/puzzle/1"
    ...
    And I complete the level on "http://studio.code.org/s/allthethings/lesson/29/puzzle/4?level_name=2-3 Artist 1 new"
    And I am on "http://studio.code.org/s/allthethings"
