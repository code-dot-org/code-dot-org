...
Scenario: CSF Top Instructions
  ...
  And I am on "http://studio.code.org/s/course1/lessons/4/puzzle/11?noautoplay=true"
  And I wait for the page to fully load
  Then I see no difference for "maze short instructions"

  And I am on "http://studio.code.org/s/course4/lessons/3/puzzle/5?noautoplay=true"
  And I wait for the page to fully load
  ...
  Then I am on "http://studio.code.org/s/allthethings/lessons/2/puzzle/7?noautoplay=true"
  And I wait for the page to fully load
  ...
  Then I am on "http://studio.code.org/s/allthethings/lessons/6/puzzle/2?noautoplay=true"
  And I wait for the page to fully load
  ...
  Then I am on "http://studio.code.org/s/course4/lessons/19/puzzle/3?noautoplay=true"
  And I wait for the page to fully load
  And I see no difference for "Bee with starting hints"

  Then I am on "http://studio.code.org/s/course1/lessons/3/puzzle/1?noautoplay=true"
  And I wait for the page to fully load
  And I see no difference for "Jigsaw with anigif"

  Then I am on "http://studio.code.org/s/mc/lessons/1/puzzle/4?noautoplay=true"
  And I wait for the page to fully load
  And I see no difference for "minecraft top instructions"

  Then I am on "http://studio.code.org/s/starwars/lessons/1/puzzle/15?noautoplay=true"
  And I wait for the page to fully load
  And I see no difference for "starwars top instructions"

  Then I am on "http://studio.code.org/s/frozen/lessons/1/puzzle/5?noautoplay=true"
  And I wait for the page to fully load
