...
Scenario: CSF Top Instructions
  ...
  And I am on "http://studio.code.org/s/course1/lesson/4/puzzle/11?noautoplay=true"
  And I wait for the page to fully load
  Then I see no difference for "maze short instructions"

  And I am on "http://studio.code.org/s/course4/lesson/3/puzzle/5?noautoplay=true"
  And I wait for the page to fully load
  ...
  Then I am on "http://studio.code.org/s/allthethings/lesson/2/puzzle/7?noautoplay=true"
  And I wait for the page to fully load
  ...
  Then I am on "http://studio.code.org/s/allthethings/lesson/6/puzzle/2?noautoplay=true"
  And I wait for the page to fully load
  ...
  Then I am on "http://studio.code.org/s/course4/lesson/19/puzzle/3?noautoplay=true"
  And I wait for the page to fully load
  And I see no difference for "Bee with starting hints"

  Then I am on "http://studio.code.org/s/course1/lesson/3/puzzle/1?noautoplay=true"
  And I wait for the page to fully load
  And I see no difference for "Jigsaw with anigif"

  Then I am on "http://studio.code.org/s/mc/lesson/1/puzzle/4?noautoplay=true"
  And I wait for the page to fully load
  And I see no difference for "minecraft top instructions"

  Then I am on "http://studio.code.org/s/starwars/lesson/1/puzzle/15?noautoplay=true"
  And I wait for the page to fully load
  And I see no difference for "starwars top instructions"

  Then I am on "http://studio.code.org/s/frozen/lesson/1/puzzle/5?noautoplay=true"
  And I wait for the page to fully load
