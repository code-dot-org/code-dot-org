...
Background:
  ...
  And I am on "http://studio.code.org/s/allthethings/lesson/38/puzzle/1?noautoplay=true"
...
Scenario: As student 'Feedback' tab is not visible if no feedback
  ...
  And I am on "http://studio.code.org/s/allthethings/lesson/38/puzzle/1"
...
Otherwise don't show feedback tab
  ...
  Then I am on "http://studio.code.org/s/allthethings/lesson/18/puzzle/7"
  And I wait for the page to fully load
  And element ".uitest-feedback" is not visible
