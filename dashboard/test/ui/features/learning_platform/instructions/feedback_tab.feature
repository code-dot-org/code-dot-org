...
Background:
  ...
  And I am on "http://studio.code.org/s/allthethings/lessons/38/puzzle/1?noautoplay=true"
...
Scenario: As student 'Feedback' tab is not visible if no feedback
  ...
  And I am on "http://studio.code.org/s/allthethings/lessons/38/puzzle/1"
...
Otherwise don't show feedback tab
  ...
  Then I am on "http://studio.code.org/s/allthethings/lessons/18/puzzle/15"
  And I wait for the page to fully load
  And element ".uitest-feedback" is not visible

  #Not automatically visible on un-contained levels with no mini rubric
  Then I am on "http://studio.code.org/s/allthethings/lessons/18/puzzle/7"
  And I wait for the page to fully load
  And element ".uitest-feedback" is not visible
