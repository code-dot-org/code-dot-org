...
Given 'I start a self-paced PL course' do
  steps <<~GHERKIN
    Given I am on "http://studio.code.org/courses/ui-test-instructor-in-training/units/1/lessons/1/levels/1"
    ...
    When I am on "http://studio.code.org/courses/ui-test-instructor-in-training/units/1/lessons/1/levels/3"
    Then I wait until element "button:contains(Submit)" is visible
    When I click selector "button:contains(Submit)"
    Then I wait until I am on "http://studio.code.org/courses/ui-test-instructor-in-training/units/1/lessons/1/levels/4"
