...
free_play_level_urls = {
  'blockly' => {
    ...
    'Artist' => 'http://studio.code.org/courses/allthethingscourse/units/1/lessons/3/levels/11?noautoplay=true&no_redirect=true',
  ...
  'droplet' => {
    'App Lab' => 'http://studio.code.org/courses/allthethingscourse/units/1/lessons/18/levels/3?noautoplay=true&no_redirect=true',
