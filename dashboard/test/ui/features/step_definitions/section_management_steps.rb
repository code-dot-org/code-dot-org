...
And(/^I create a (universal instructor|plc reviewer|facilitator) associated (facilitator|teacher) named "([^"]*)"$/) do |instructor_type, participant_type, name|
  ...
  steps "And I scroll the \"div.ui-test-join-section\" element into view"
  steps "And I enter the section code into \"input.ui-test-join-section\""
  steps "And I click selector \"div.ui-test-join-section\""
  steps "Then the professional learning joined sections table should have 1 row"
end
