...
# Which lesson of ui-test-all-the-levels contains the PKC levels; this way we
...
Given /^I am on the (\d+)(?:st|nd|rd|th)? Public Key Cryptography test level$/ do |level_index|
  steps <<-STEPS
    And I am on "http://studio.code.org/courses/ui-test-all-the-levels/units/1/lessons/#{PUBLIC_KEY_CRYPTOGRAPHY_STUDENT_LABS_LESSON}/levels/#{level_index}"
  STEPS
end
