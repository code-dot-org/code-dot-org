...
Feature: Policy Compliance and Parental Permission
  ...
  Scenario: BLAH New under 13 account should be able to send a parental request.
    Given I am on "http://studio.code.org"
    Given CPA all user lockout phase
  ...
  Scenario: BLAH New under 13 account should be able to provide state and see lockout page to send parental request.
    Given I am on "http://studio.code.org"
    Given CPA all user lockout phase
  ...
  Scenario: BLAH New under 13 account should be able to elect to sign out at the lockout.
    Given I am on "http://studio.code.org"
    Given CPA all user lockout phase
  ...
  Scenario: BLAH New under 13 account should be able to resend the email
    Given I am on "http://studio.code.org"
    Given CPA all user lockout phase
  ...
  Scenario: BLAH New under 13 account should be able to send a different email
    Given I am on "http://studio.code.org"
    Given CPA all user lockout phase
  ...
  Scenario: BLAH Student should not be able to enter their own email as their parent's email
    Given I am on "http://studio.code.org"
    Given CPA all user lockout phase
  ...
  Scenario: BLAH Student should be able to enter their parent's email if their parent created their account
    Given I am on "http://studio.code.org"
    Given CPA all user lockout phase
  ...
  Scenario: BLAH Existing under 13 account in Colorado should not be locked out.
    Given I am on "http://studio.code.org"
    Given CPA all user lockout phase
  ...
  Scenario: BLAH Teacher should be able to connect a third-party account even without a state specified
    Given I am on "http://studio.code.org"
    Given CPA all user lockout phase
    Given I create a teacher who has never signed in named "Amstrad Teacher" after CAP start and go home
  ...
  Scenario: BLAH Student should not be able to connect a third-party account until their account is unlocked
    Given I am on "http://studio.code.org"
    Given CPA all user lockout phase
    Given I create a young student in Colorado who has never signed in named "Coco Student" before CAP start and go home
  ...
  Scenario: BLAH Sponsored student should not be able to add a personal email on an account until providing a state
    Given I am on "http://studio.code.org"
    Given CPA all user lockout phase
    Given I create an authorized teacher-associated under-13 sponsored student named "Tandy" after CAP start
  ...
  Scenario: BLAH Sponsored student should not be able to add a personal email when they supply a policy state
    Given I am on "http://studio.code.org"
    Given CPA all user lockout phase
    Given I create an authorized teacher-associated under-13 sponsored student named "Tandy" after CAP start
  ...
  Scenario: BLAH Sponsored student is able to add a personal email on an unlocked account
    Given I am on "http://studio.code.org"
    Given CPA all user lockout phase
    Given I create an authorized teacher-associated under-13 sponsored student in Colorado named "Tandy" after CAP start
  ...
  Scenario: BLAH Student account Under-13 in Colorado created before CAP start cannot change age and state
    Given I am on "http://studio.code.org"
    Given CPA all user lockout phase
    Given I create a young student in Colorado named "Tandy" before CAP start
  ...
  Scenario: BLAH Student account Under-13 not in Colorado created after CAP start can change their age and state
    Given I am on "http://studio.code.org"
    Given CPA all user lockout phase
    Given I create a young student named "Tandy" after CAP start
  ...
  Scenario: BLAH Student account Under-13 not in Colorado created before CAP start can change their age and state
    Given I am on "http://studio.code.org"
    Given CPA all user lockout phase
    Given I create a young student named "Tandy" before CAP start
  ...
  Scenario: BLAH Student account Over-13 and in Colorado created after CAP start can change their age and state
    Given I am on "http://studio.code.org"
    Given CPA all user lockout phase
    Given I create a student in Colorado named "Tandy" after CAP start
  ...
  Scenario: BLAH Student account Over-13 and in Colorado created before CAP start can change their age and state
    Given I am on "http://studio.code.org"
    Given CPA all user lockout phase
    Given I create a student in Colorado named "Tandy" before CAP start
  ...
  Scenario: BLAH Student account under-13 and in Colorado created after CAP start using only clever cannot change their age and state
    Given I am on "http://studio.code.org"
    Given CPA all user lockout phase
    Given I create a young student using clever in Colorado named "Tandy" after CAP start
  ...
  Scenario: BLAH Student account under-13 and in Colorado created before CAP start using only clever cannot change their age and state
    Given I am on "http://studio.code.org"
    Given CPA all user lockout phase
    Given I create a young student using clever in Colorado named "Tandy" before CAP start
  ...
  Scenario: BLAH Student account under-13 and in Colorado created before CAP start using google cannot change their age and state
    Given I am on "http://studio.code.org"
    Given CPA all user lockout phase
    Given I create a young student using google in Colorado named "Tandy" before CAP start
  ...
  Scenario: BLAH Student account under-13 and in Colorado created before CAP start using google cannot change their age and state
   ...
   Scenario: BLAH Student account under-13 not in Colorado created after CAP start using clever cannot change their age and state
     Given I am on "http://studio.code.org"
     Given CPA all user lockout phase
    Given I create a young student using clever named "Tandy" after CAP start
  ...
  Scenario: BLAH Student account under-13 not in Colorado created before CAP start using clever cannot change their age and state
    Given I am on "http://studio.code.org"
    Given CPA all user lockout phase
    Given I create a young student using clever named "Tandy" before CAP start
  ...
  Scenario: BLAHH New under 13 account should be able to send a parental request.
    Given I am on "http://studio.code.org"
    Given CPA all user lockout phase
  ...
  Scenario: BLAHH New under 13 account should be able to provide state and see lockout page to send parental request.
    Given I am on "http://studio.code.org"
    Given CPA all user lockout phase
  ...
  Scenario: BLAHH New under 13 account should be able to elect to sign out at the lockout.
    Given I am on "http://studio.code.org"
    Given CPA all user lockout phase
  ...
  Scenario: BLAHH New under 13 account should be able to resend the email
    Given I am on "http://studio.code.org"
    Given CPA all user lockout phase
  ...
  Scenario: BLAHH New under 13 account should be able to send a different email
    Given I am on "http://studio.code.org"
    Given CPA all user lockout phase
  ...
  Scenario: BLAHH Student should not be able to enter their own email as their parent's email
    Given I am on "http://studio.code.org"
    Given CPA all user lockout phase
  ...
  Scenario: BLAHH Student should be able to enter their parent's email if their parent created their account
    Given I am on "http://studio.code.org"
    Given CPA all user lockout phase
  ...
  Scenario: BLAHH Existing under 13 account in Colorado should not be locked out.
    Given I am on "http://studio.code.org"
    Given CPA all user lockout phase
  ...
  Scenario: BLAHH Teacher should be able to connect a third-party account even without a state specified
    Given I am on "http://studio.code.org"
    Given CPA all user lockout phase
    Given I create a teacher who has never signed in named "Amstrad Teacher" after CAP start and go home
  ...
  Scenario: BLAHH Student should not be able to connect a third-party account until their account is unlocked
    Given I am on "http://studio.code.org"
    Given CPA all user lockout phase
    Given I create a young student in Colorado who has never signed in named "Coco Student" before CAP start and go home
  ...
  Scenario: BLAHH Sponsored student should not be able to add a personal email on an account until providing a state
    Given I am on "http://studio.code.org"
    Given CPA all user lockout phase
    Given I create an authorized teacher-associated under-13 sponsored student named "Tandy" after CAP start
  ...
  Scenario: BLAHH Sponsored student should not be able to add a personal email when they supply a policy state
    Given I am on "http://studio.code.org"
    Given CPA all user lockout phase
    Given I create an authorized teacher-associated under-13 sponsored student named "Tandy" after CAP start
  ...
  Scenario: BLAHH Sponsored student is able to add a personal email on an unlocked account
    Given I am on "http://studio.code.org"
    Given CPA all user lockout phase
    Given I create an authorized teacher-associated under-13 sponsored student in Colorado named "Tandy" after CAP start
  ...
  Scenario: BLAHH Student account Under-13 in Colorado created before CAP start cannot change age and state
    Given I am on "http://studio.code.org"
    Given CPA all user lockout phase
    Given I create a young student in Colorado named "Tandy" before CAP start
  ...
  Scenario: BLAHH Student account Under-13 not in Colorado created after CAP start can change their age and state
    Given I am on "http://studio.code.org"
    Given CPA all user lockout phase
    Given I create a young student named "Tandy" after CAP start
  ...
  Scenario: BLAHH Student account Under-13 not in Colorado created before CAP start can change their age and state
    Given I am on "http://studio.code.org"
    Given CPA all user lockout phase
    Given I create a young student named "Tandy" before CAP start
  ...
  Scenario: BLAHH Student account Over-13 and in Colorado created after CAP start can change their age and state
    Given I am on "http://studio.code.org"
    Given CPA all user lockout phase
    Given I create a student in Colorado named "Tandy" after CAP start
  ...
  Scenario: BLAHH Student account Over-13 and in Colorado created before CAP start can change their age and state
    Given I am on "http://studio.code.org"
    Given CPA all user lockout phase
    Given I create a student in Colorado named "Tandy" before CAP start
  ...
  Scenario: BLAHH Student account under-13 and in Colorado created after CAP start using only clever cannot change their age and state
    Given I am on "http://studio.code.org"
    Given CPA all user lockout phase
    Given I create a young student using clever in Colorado named "Tandy" after CAP start
  ...
  Scenario: BLAHH Student account under-13 and in Colorado created before CAP start using only clever cannot change their age and state
    Given I am on "http://studio.code.org"
    Given CPA all user lockout phase
    Given I create a young student using clever in Colorado named "Tandy" before CAP start
  ...
  Scenario: BLAHH Student account under-13 and in Colorado created before CAP start using google cannot change their age and state
    Given I am on "http://studio.code.org"
    Given CPA all user lockout phase
    Given I create a young student using google in Colorado named "Tandy" before CAP start
  ...
  Scenario: BLAHH Student account under-13 and in Colorado created before CAP start using google cannot change their age and state
   ...
   Scenario: BLAHH Student account under-13 not in Colorado created after CAP start using clever cannot change their age and state
     Given I am on "http://studio.code.org"
     Given CPA all user lockout phase
    Given I create a young student using clever named "Tandy" after CAP start
  ...
  Scenario: BLAHH Student account under-13 not in Colorado created before CAP start using clever cannot change their age and state
    Given I am on "http://studio.code.org"
    Given CPA all user lockout phase
    Given I create a young student using clever named "Tandy" before CAP start
  ...
  Scenario: BLAHHH New under 13 account should be able to send a parental request.
    Given I am on "http://studio.code.org"
    Given CPA all user lockout phase
  ...
  Scenario: BLAHHH New under 13 account should be able to provide state and see lockout page to send parental request.
    Given I am on "http://studio.code.org"
    Given CPA all user lockout phase
  ...
  Scenario: BLAHHH New under 13 account should be able to elect to sign out at the lockout.
    Given I am on "http://studio.code.org"
    Given CPA all user lockout phase
  ...
  Scenario: BLAHHH New under 13 account should be able to resend the email
    Given I am on "http://studio.code.org"
    Given CPA all user lockout phase
  ...
  Scenario: BLAHHH New under 13 account should be able to send a different email
    Given I am on "http://studio.code.org"
    Given CPA all user lockout phase
  ...
  Scenario: BLAHHH Student should not be able to enter their own email as their parent's email
    Given I am on "http://studio.code.org"
    Given CPA all user lockout phase
  ...
  Scenario: BLAHHH Student should be able to enter their parent's email if their parent created their account
    Given I am on "http://studio.code.org"
    Given CPA all user lockout phase
  ...
  Scenario: BLAHHH Existing under 13 account in Colorado should not be locked out.
    Given I am on "http://studio.code.org"
    Given CPA all user lockout phase
  ...
  Scenario: BLAHHH Teacher should be able to connect a third-party account even without a state specified
    Given I am on "http://studio.code.org"
    Given CPA all user lockout phase
    Given I create a teacher who has never signed in named "Amstrad Teacher" after CAP start and go home
  ...
  Scenario: BLAHHH Student should not be able to connect a third-party account until their account is unlocked
    Given I am on "http://studio.code.org"
    Given CPA all user lockout phase
    Given I create a young student in Colorado who has never signed in named "Coco Student" before CAP start and go home
  ...
  Scenario: BLAHHH Sponsored student should not be able to add a personal email on an account until providing a state
    Given I am on "http://studio.code.org"
    Given CPA all user lockout phase
    Given I create an authorized teacher-associated under-13 sponsored student named "Tandy" after CAP start
  ...
  Scenario: BLAHHH Sponsored student should not be able to add a personal email when they supply a policy state
    Given I am on "http://studio.code.org"
    Given CPA all user lockout phase
    Given I create an authorized teacher-associated under-13 sponsored student named "Tandy" after CAP start
  ...
  Scenario: BLAHHH Sponsored student is able to add a personal email on an unlocked account
    Given I am on "http://studio.code.org"
    Given CPA all user lockout phase
    Given I create an authorized teacher-associated under-13 sponsored student in Colorado named "Tandy" after CAP start
  ...
  Scenario: BLAHHH Student account Under-13 in Colorado created before CAP start cannot change age and state
    Given I am on "http://studio.code.org"
    Given CPA all user lockout phase
    Given I create a young student in Colorado named "Tandy" before CAP start
  ...
  Scenario: BLAHHH Student account Under-13 not in Colorado created after CAP start can change their age and state
    Given I am on "http://studio.code.org"
    Given CPA all user lockout phase
    Given I create a young student named "Tandy" after CAP start
  ...
  Scenario: BLAHHH Student account Under-13 not in Colorado created before CAP start can change their age and state
    Given I am on "http://studio.code.org"
    Given CPA all user lockout phase
    Given I create a young student named "Tandy" before CAP start
  ...
  Scenario: BLAHHH Student account Over-13 and in Colorado created after CAP start can change their age and state
    Given I am on "http://studio.code.org"
    Given CPA all user lockout phase
    Given I create a student in Colorado named "Tandy" after CAP start
  ...
  Scenario: BLAHHH Student account Over-13 and in Colorado created before CAP start can change their age and state
    Given I am on "http://studio.code.org"
    Given CPA all user lockout phase
    Given I create a student in Colorado named "Tandy" before CAP start
  ...
  Scenario: BLAHHH Student account under-13 and in Colorado created after CAP start using only clever cannot change their age and state
    Given I am on "http://studio.code.org"
    Given CPA all user lockout phase
    Given I create a young student using clever in Colorado named "Tandy" after CAP start
  ...
  Scenario: BLAHHH Student account under-13 and in Colorado created before CAP start using only clever cannot change their age and state
    Given I am on "http://studio.code.org"
    Given CPA all user lockout phase
    Given I create a young student using clever in Colorado named "Tandy" before CAP start
  ...
  Scenario: BLAHHH Student account under-13 and in Colorado created before CAP start using google cannot change their age and state
    Given I am on "http://studio.code.org"
    Given CPA all user lockout phase
    Given I create a young student using google in Colorado named "Tandy" before CAP start
  ...
  Scenario: BLAHHH Student account under-13 and in Colorado created before CAP start using google cannot change their age and state
   ...
   Scenario: BLAHHH Student account under-13 not in Colorado created after CAP start using clever cannot change their age and state
     Given I am on "http://studio.code.org"
     Given CPA all user lockout phase
    Given I create a young student using clever named "Tandy" after CAP start
  ...
  Scenario: BLAHHH Student account under-13 not in Colorado created before CAP start using clever cannot change their age and state
    Given I am on "http://studio.code.org"
    Given CPA all user lockout phase
    Given I create a young student using clever named "Tandy" before CAP start
