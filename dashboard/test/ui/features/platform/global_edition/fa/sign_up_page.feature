...
Feature: Global Edition - Farsi MVP - Sign Up page
  ...
  Scenario: I see the Farsi MVP Sign In page
    ...
    Given element ".src-templates-account-account-components-module__bannerContainer h1" contains text matching "حساب کاربری رایگان خود را ایجاد کنید"
    ...
    Given element ".src-signUpFlow-signUpFlowStyles-module__freeCurriculumWrapper h2" contains text matching "برنامه درسی رایگان. همیشه."
