...
Scenario: HoC tutorial in Spanish
  Given I am on "http://studio.code.org/s/20-hour/stage/2/puzzle/16/lang/es"
...
Scenario: HoC tutorial in Portuguese
  Given I am on "http://studio.code.org/s/20-hour/stage/2/puzzle/16/lang/pt-br"
  And I rotate to landscape
  And I wait for 2 seconds
...
Scenario: HoC tutorial in Arabic
  Given I am on "http://studio.code.org/s/20-hour/stage/2/puzzle/16/lang/ar"
  And I rotate to landscape
  And I wait for 2 seconds
