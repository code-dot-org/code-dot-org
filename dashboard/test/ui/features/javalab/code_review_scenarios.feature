...
Feature: Code review V2
  ...
  Scenario: Code review V2
    ...
    Then I see no difference for "student code reviewing peer"
    And I sign out using jquery
    ...
    And I load the review tab
    Then I see no difference for "teacher code reviewing student"
    And I sign out using jquery
    ...
    And I am on "http://studio.code.org/courses/allthethingscourse/units/1/lessons/44/levels/2?noautoplay=true"
    And I load the review tab
    Then I see no difference for "student viewing own code review"
