...
Feature: Prompter
  ...
  Scenario: Upload an image via the prompter
    ...
    And I am on "http://studio.code.org/courses/ui-test-all-the-levels/units/1/lessons/44/levels/10"
    ...
    And I see no difference for "prompter upload view"
    ...
    And I see no difference for "prompter end state"
