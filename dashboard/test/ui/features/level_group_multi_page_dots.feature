...
Scenario: Submit three pages as... 1. some, 2. none, 3. all questions answered.
  ...
  And element ".user-stats-block .game-group:nth(21) a:nth(1)" has class "level_link perfect"
  And element ".user-stats-block .game-group:nth(21) a:nth(2)" has class "level_link not_tried"
  And element ".user-stats-block .game-group:nth(21) a:nth(3)" has class "level_link attempted"
  ...
  And element ".user-stats-block .games:nth(21) a:nth(1)" has class "level_link perfect"
  And element ".user-stats-block .games:nth(21) a:nth(2)" has class "level_link not_tried"
  And element ".user-stats-block .games:nth(21) a:nth(3)" has class "level_link attempted"
