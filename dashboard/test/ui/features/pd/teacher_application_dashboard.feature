...
Feature: Teacher Application Dashboard view
  ...
  Scenario: Application dashboard, list view, detail view, cohort view
    ...
    # TODO: (suresh) Revert to "I see no difference" step when CircleCI diffs are resolved.
    And I see no difference in test environment for "Teacher List View"
    ...
    # TODO: (suresh) Revert to "I see no difference" step when CircleCI diffs are resolved.
    And I see no difference in test environment for "Teacher Detail View"
    ...
    # TODO: (suresh) Revert to "I see no difference" step when CircleCI diffs are resolved.
    And I see no difference in test environment for "Admin Edit View"
    ...
    # TODO: (suresh) Revert to "I see no difference" step when CircleCI diffs are resolved.
    And I see no difference in test environment for "Teacher Cohort View"
    And I close my eyes
