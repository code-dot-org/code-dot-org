...
Feature: Facilitator Application Dashboard view
  ...
  Scenario: Application dashboard, list view, detail view, cohort view
    ...
    And I open my eyes to test "Facilitator Application Dashboard" in test environment only
    And I see no difference for "Application Dashboard" in test environment only
    Then I press the first ".row .btn" element
    Then I wait until element "table" is visible
    And I see no difference for "Facilitator List View" in test environment only
    ...
    And I see no difference for "Facilitator Detail View" in test environment only
    ...
    Then I wait until element "table" is visible
    And I see no difference for "Facilitator Cohort View" in test environment only
    And I close my eyes in test environment only
