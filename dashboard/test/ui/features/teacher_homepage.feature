...
Feature: Using the teacher homepage sections feature
  ...
  Scenario: Update a section
    ...
    And I select the "CSD Unit 1 - Problem Solving" option in dropdown "uitest-secondary-assignment"
    And I press the first ".uitest-saveButton" element
    And I wait for the dialog to close
    ...
    And the section table row at index 0 has primary assignment path "/courses/csd-2018"
    And the section table row at index 0 has secondary assignment path "/s/csd1-2018"
