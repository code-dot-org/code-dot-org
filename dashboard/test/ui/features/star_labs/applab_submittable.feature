...
Background:
  ...
  And I am on "http://studio.code.org/s/allthethings/lessons/18/puzzle/7?noautoplay=true"
...
Scenario: Submit anything, unsubmit, be able to resubmit.
  ...
  Then I am on "http://studio.code.org/s/allthethings/lessons/18/puzzle/7?noautoplay=true"
