...
Background:
  ...
  And I am on "http://studio.code.org/courses/allthethingscourse/units/1/lessons/18/levels/7?noautoplay=true"
...
Scenario: Submit anything, unsubmit, be able to resubmit.
  ...
  Then I am on "http://studio.code.org/courses/allthethingscourse/units/1/lessons/18/levels/7?noautoplay=true"
