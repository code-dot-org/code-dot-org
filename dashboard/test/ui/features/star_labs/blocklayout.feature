...
Background:
  Given I am on "http://studio.code.org/courses/ui-test-student-labs/units/1/lessons/7/levels/2?noautoplay=true"
...
Scenario: Auto-placing blocks with XML positioning
  Given I am on "http://studio.code.org/courses/ui-test-student-labs/units/1/lessons/5/levels/4?noautoplay=true"
  And I wait for the lab page to fully load
