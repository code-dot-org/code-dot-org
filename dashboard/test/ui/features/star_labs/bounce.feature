...
Scenario: Complete Level 1
  Given I am on "http://studio.code.org/courses/ui-test-student-labs/units/1/lessons/8/levels/1?noautoplay=true"
...
Scenario: Complete Level 3
  Given I am on "http://studio.code.org/courses/ui-test-student-labs/units/1/lessons/8/levels/3?noautoplay=true"
  And I wait for the lab page to fully load
...
Scenario: Incomplete Level 5
  Given I am on "http://studio.code.org/courses/ui-test-student-labs/units/1/lessons/8/levels/4?noautoplay=true"
  And I wait for the lab page to fully load
  And I press "runButton"
...
Scenario: Complete Bounce freeplay level
  Given I am on "http://studio.code.org/courses/ui-test-student-labs/units/1/lessons/8/levels/2?noautoplay=true"
  And I wait for the lab page to fully load
