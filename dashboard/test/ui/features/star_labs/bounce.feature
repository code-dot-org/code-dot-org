...
Scenario: Complete Level 3
  Given I am on "http://studio.code.org/s/events/lesson/1/puzzle/3?noautoplay=true"
  When I rotate to landscape
  And I wait for the page to fully load
...
Scenario: Incomplete Level 5
  Given I am on "http://studio.code.org/s/events/lesson/1/puzzle/5?noautoplay=true"
  When I rotate to landscape
  And I wait for the page to fully load
  And I press "runButton"
