...
Scenario: Should see callout on 20-hour farmer lesson
  Given I am on "http://studio.code.org/s/20-hour/lessons/9/puzzle/1?noautoplay=true"
...
Scenario: Should not see callout on CSF coursea lesson if logged in
  Given I am on "http://studio.code.org/s/coursea-2020/lessons/4/puzzle/2?noautoplay=true"
  And I rotate to landscape
  And I wait for the page to fully load
  And element ".uitest-login-callout" is not visible
...
Scenario: See age callout, not signin callout on hour of code
  Given I am on "http://studio.code.org/s/allthethings/lessons/37/puzzle/2?noautoplay=true"
  And I rotate to landscape
  And I wait for the page to fully load
...
Scenario: Nested callouts should work as expected
  Given I am on "http://studio.code.org/s/coursea-2020/lessons/2/puzzle/2?noautoplay=true"
  And I rotate to landscape
  And I wait for the page to fully load
  And element ".uitest-login-callout" is visible
  And I dismiss the login reminder
