...
Background:
  ...
  And I create a new student section assigned to course "ui-test-all-the-levels" unit 1 with AI chat enabled and save the section

  Given I create a student named "Hermione"
  And I join the section

  # Student interacts with model to create chat history for teacher to view.
  Given I am on "http://studio.code.org/courses/ui-test-all-the-levels/units/1/lessons/47/levels/1"
...
Scenario: Teacher views student chat history and interacts with student model
  ...
  And I am on "http://studio.code.org/courses/ui-test-all-the-levels/units/1/lessons/47/levels/1"
