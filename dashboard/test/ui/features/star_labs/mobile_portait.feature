...
Feature: Look at mobile portait view
  ...
  Scenario Outline: Simple blockly level page view
    ...
    Examples:
      | url                                                                      | test_name     |
      | http://studio.code.org/courses/allthethingscourse/units/1/lessons/18/levels/5?noautoplay=true  | droplet level |
      | http://studio.code.org/courses/allthethingscourse/units/1/lessons/37/levels/1?noautoplay=true  | artist level  |
