...
Background:
  Given I am on "http://studio.code.org/courses/ui-test-all-the-levels/units/1/lessons/19/levels/1?noautoplay=true"
...
Scenario: Submit anything, unsubmit, be able to resubmit.
  ...
  Then I am on "http://studio.code.org/courses/ui-test-all-the-levels/units/1/lessons/19/levels/1?noautoplay=true"
