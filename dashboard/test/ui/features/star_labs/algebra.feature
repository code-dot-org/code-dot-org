...
Scenario:
  ...
  When I am on "http://studio.code.org/s/algebra/lessons/1/puzzle/2?noautoplay=true"
...
Scenario:
  ...
  When I am on "http://studio.code.org/s/algebra/lessons/2/puzzle/6?noautoplay=true"
  And I rotate to landscape
  And I wait for the page to fully load
...
Scenario:
  ...
  When I am on "http://studio.code.org/s/algebra/lessons/6/puzzle/4?noautoplay=true"
  And I rotate to landscape
  And I wait for the page to fully load
