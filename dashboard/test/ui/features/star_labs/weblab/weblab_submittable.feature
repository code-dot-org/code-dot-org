...
Background:
  Given I am on "http://studio.code.org/s/allthethings/lessons/32/puzzle/1?noautoplay=true"
...
Scenario: Submit anything, unsubmit, be able to resubmit.
  ...
  Then I am on "http://studio.code.org/s/allthethings/lessons/32/puzzle/1?noautoplay=true"
