...
Background:
  ...
  Given I am on "http://studio.code.org/s/20-hour/lessons/2/puzzle/15?noautoplay=true"
...
Scenario: Submit a valid solution
  ...
  Then I wait until I am on "http://studio.code.org/s/20-hour/lessons/2/puzzle/16"
  ...
  When I am on "http://studio.code.org/s/20-hour/lessons/2/puzzle/15?noautoplay=true"
  And I wait for the page to fully load
  Then I press "runButton"
  Then I wait until element ".congrats" is visible
  And element ".congrats" has text "Congratulations! You completed Puzzle 15."
