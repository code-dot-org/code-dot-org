...
Scenario: Step Only - Failure
  Given I am on "http://studio.code.org/courses/ui-test-student-labs/units/1/lessons/2/levels/8"
...
Scenario: Step and Run - Stepping
  Given I am on "http://studio.code.org/courses/ui-test-student-labs/units/1/lessons/2/levels/9"
    And I wait for the lab page to fully load
