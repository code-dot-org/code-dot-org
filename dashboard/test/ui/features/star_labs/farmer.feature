...
Background:
  Given I am on "http://studio.code.org/courses/ui-test-all-the-levels/units/1/lessons/6/levels/1?noautoplay=true"
...
Scenario: Winning the first level
  ...
  Then I wait until I am on "http://studio.code.org/courses/ui-test-all-the-levels/units/1/lessons/6/levels/2"
