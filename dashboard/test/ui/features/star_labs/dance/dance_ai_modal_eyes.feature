...
Feature: Dance Party AI Modal Eyes
  ...
  Scenario: Dance AI Modal
    # In LTR language
    Given I am on "http://studio.code.org/courses/ui-test-student-labs/units/1/lessons/37/levels/4"
    ...
    # In RTL language
    Then I am on "http://studio.code.org/courses/ui-test-student-labs/units/1/lessons/37/levels/4/lang/ar-sa"
    And I wait for the lab page to fully load
