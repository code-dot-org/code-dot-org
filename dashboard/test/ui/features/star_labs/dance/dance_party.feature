Feature: Dance Party
  ...
  Scenario: Restricted audio content is protected
    ...
    When I am on "http://studio.code.org/courses/ui-test-all-the-levels/units/1/lessons/37/levels/5"
  ...
  Scenario: Can toggle run/reset in Dance Party
    Given I am on "http://studio.code.org/courses/ui-test-all-the-levels/units/1/lessons/37/levels/2?noautoplay=true"
    And I wait for the lab page to fully load
  ...
  Scenario: Can get to level success in Dance Party
    Given I am on "http://studio.code.org/courses/ui-test-all-the-levels/units/1/lessons/37/levels/1?noautoplay=true"
    And I wait for the lab page to fully load
    And I wait for 3 seconds
    And I wait until I don't see selector "#p5_loading"
    And I select age 10 in the age dialog
  ...
  Scenario: Dance Party 12 loads
    Given I am on "http://studio.code.org/courses/ui-test-all-the-levels/units/1/lessons/37/levels/7?noautoplay=true"
    And I wait for the lab page to fully load

  Scenario: Dance Party 8 runs new set tint block
    Given I am on "http://studio.code.org/courses/ui-test-all-the-levels/units/1/lessons/37/levels/6?noautoplay=true"
    And I wait for the lab page to fully load
    And I select age 10 in the age dialog
    And I close the instructions overlay if it exists
  ...
  Scenario: Dance Party Share
    Given I am on "http://studio.code.org/courses/ui-test-all-the-levels/units/1/lessons/37/levels/8?noautoplay=true"
    And I wait for the lab page to fully load
