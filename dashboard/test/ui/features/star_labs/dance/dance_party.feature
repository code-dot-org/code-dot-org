Feature: Dance Party
  ...
  Scenario: Restricted audio content is protected
    ...
    When I am on "http://studio.code.org/courses/dance/units/1/lessons/1/levels/1"
  ...
  Scenario: Dance Party 12 loads
    Given I am on "http://studio.code.org/courses/dance/units/1/lessons/1/levels/12?noautoplay=true"
    And I wait for the lab page to fully load

  Scenario: Dance Party 8 runs new set tint block
    Given I am on "http://studio.code.org/courses/dance/units/1/lessons/1/levels/8?noautoplay=true"
    And I wait for the lab page to fully load
    And I select age 10 in the age dialog
    And I close the instructions overlay if it exists
  ...
  Scenario: Dance Party Share
    Given I am on "http://studio.code.org/courses/dance/units/1/lessons/1/levels/13?noautoplay=true"
    And I wait for the lab page to fully load
