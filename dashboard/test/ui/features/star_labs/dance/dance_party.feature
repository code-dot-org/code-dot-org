Feature: Dance Party
  ...
  Scenario: Restricted audio content is protected
    ...
    When I am on "http://studio.code.org/courses/ui-test-student-labs/units/1/lessons/37/levels/5"
  ...
  Scenario: Dance Party 12 loads
    Given I am on "http://studio.code.org/courses/ui-test-student-labs/units/1/lessons/37/levels/7?noautoplay=true"
    And I wait for the lab page to fully load

  Scenario: Dance Party 8 runs new set tint block
    Given I am on "http://studio.code.org/courses/ui-test-student-labs/units/1/lessons/37/levels/6?noautoplay=true"
    And I wait for the lab page to fully load
    And I select age 10 in the age dialog
    And I close the instructions overlay if it exists
  ...
  Scenario: Dance Party Share
    Given I am on "http://studio.code.org/courses/ui-test-student-labs/units/1/lessons/37/levels/8?noautoplay=true"
    And I wait for the lab page to fully load
