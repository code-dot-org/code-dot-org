Feature: Dance Lab Age Filter
  Scenario: Song selector is visible and doesn't display pg13 songs for age < 13
    ...
    And I am on "http://studio.code.org/courses/ui-test-all-the-levels/units/1/lessons/37/levels/1?noautoplay=true"
  ...
  Scenario: Song selector is visible and displays all songs for age > 13 and teacher flag turns filter on
    ...
    Then I am on "http://studio.code.org/courses/ui-test-all-the-levels/units/1/lessons/37/levels/1?noautoplay=true&songfilter=on"
