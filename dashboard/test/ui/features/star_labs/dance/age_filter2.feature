Feature: Dance Lab Age Filter 2
  Scenario: Selecting 13 in age dialog turns filter off
    ...
    Then I am on "http://studio.code.org/courses/ui-test-all-the-levels/units/1/lessons/37/levels/5"
    And I wait for the lab page to fully load
    And I wait for 3 seconds
    And I wait until I don't see selector "#p5_loading"
  ...
  Scenario: Song selector is hidden when initializing with teacher flag on and teacher flag stays on after level complete
    Given I am on "http://studio.code.org/courses/ui-test-all-the-levels/units/1/lessons/37/levels/1?noautoplay=true&songfilter=on"
    And I wait for the lab page to fully load
    And I wait for 3 seconds
    And I wait until I don't see selector "#p5_loading"
