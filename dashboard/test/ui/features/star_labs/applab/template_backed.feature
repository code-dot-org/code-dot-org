...
Feature: App Lab Scenarios
  ...
  Scenario: Template backed level
    ...
    Given I am on "http://studio.code.org/courses/ui-test-all-the-levels/units/1/lessons/18/levels/10?noautoplay=true"
    ...
    Given I am on "http://studio.code.org/courses/ui-test-all-the-levels/units/1/lessons/18/levels/11?noautoplay=true"
    And I wait for the lab page to fully load
    And I wait to see ".projectTemplateWorkspaceIcon"
    ...
    Then I am on "http://studio.code.org/courses/ui-test-all-the-levels/units/1/lessons/18/levels/10?noautoplay=true"
    And I wait to see "#runButton"
    And I wait to see ".projectTemplateWorkspaceIcon"
    And the droplet code is "turnRight(90);\nturnLeft(90);\nturnRight(10);\n"
