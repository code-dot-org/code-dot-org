...
Scenario: Applab embedded level
  ...
  And I am on "http://studio.code.org/courses/ui-test-student-labs/units/1/lessons/18/levels/12"
  And I see no difference for "embedded level"
  Then I close my eyes

Scenario: Applab widget mode
  When I open my eyes to test "Applab widget mode"
  And I am on "http://studio.code.org/courses/ui-test-student-labs/units/1/lessons/18/levels/22"
...
Scenario: Applab Instructions in Top Pane
  ...
  When I am on "http://studio.code.org/courses/ui-test-student-labs/units/1/lessons/18/levels/10"
  And I wait for the lab page to fully load
  And I see no difference for "top instructions enabled on instructionless level"

  When I am on "http://studio.code.org/courses/ui-test-student-labs/units/1/lessons/18/levels/12"
  And I wait for the lab page to fully load
