...
Scenario: Table data in level definition appears in data browser
  Given I am on "http://studio.code.org/s/allthethings/lessons/18/puzzle/16"
...
Scenario: Level defaults to design mode, students see design mode and teachers see code mode when viewing student work
  ...
  And I am on "http://studio.code.org/s/allthethings/lessons/18/puzzle/21"
  And I wait for the page to fully load
  ...
  Then I am on "http://studio.code.org/s/allthethings/lessons/18/puzzle/21"
  And I wait for the page to fully load
