...
Scenario: Table data in level definition appears in data browser
  Given I am on "http://studio.code.org/courses/ui-test-all-the-levels/units/1/lessons/18/levels/16"
...
Scenario: Level defaults to design mode, students see design mode and teachers see code mode when viewing student work
  ...
  And I am on "http://studio.code.org/courses/ui-test-all-the-levels/units/1/lessons/18/levels/21"
  And I wait for the lab page to fully load
  ...
  Then I am on "http://studio.code.org/courses/ui-test-all-the-levels/units/1/lessons/18/levels/21"
  And I wait for the lab page to fully load
