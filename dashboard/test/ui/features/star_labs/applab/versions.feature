...
Scenario: Script Level Versions
  Given I am on "http://studio.code.org/courses/ui-test-student-labs/units/1/lessons/18/levels/1?noautoplay=true"
  ...
  When I am on "http://studio.code.org/courses/ui-test-student-labs/units/1/lessons/18/levels/1?noautoplay=true"
  And I wait for the lab page to fully load
  Then ace editor code is equal to "// comment 2// comment 1"
