...
Scenario: Design elements are visible in local and shared projects
  ...
  Then I see no difference for "button should be visible" in the current viewport
  And I click selector ".project_share"
  And I wait to see a dialog titled "Share your project"
  Then I see no difference for "project share dialog" in the current viewport
  And I navigate to the share URL
  And I wait until element "#divApplab" is visible
  Then I see no difference for "app lab share" in the current viewport
  And I close my eyes
