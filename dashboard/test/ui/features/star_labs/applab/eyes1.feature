...
Scenario: App Lab UI elements from initial code and html
  ...
  And I am on "http://studio.code.org/s/allthethings/lessons/18/puzzle/9?noautoplay=true"
  And I wait for the page to fully load
...
Scenario: Applab Instructions Resize
  ...
  And I am on "http://studio.code.org/s/allthethings/lessons/18/puzzle/9"
  And I wait for the page to fully load
