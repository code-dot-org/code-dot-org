...
Scenario: App Lab UI elements from initial code and html
  ...
  And I am on "http://studio.code.org/courses/ui-test-student-labs/units/1/lessons/18/levels/9?noautoplay=true"
  And I wait for the lab page to fully load
...
Scenario: Applab Instructions Resize
  ...
  And I am on "http://studio.code.org/courses/ui-test-student-labs/units/1/lessons/18/levels/9"
  And I wait for the lab page to fully load
