...
Scenario: Solving puzzle 1
  Given I am on "http://studio.code.org/courses/ui-test-all-the-levels/units/1/lessons/7/levels/1?noautoplay=true"
  Then I wait until I am on "http://studio.code.org/courses/ui-test-all-the-levels/units/1/lessons/7/levels/1?noautoplay=true"
...
Scenario: Solving puzzle 2
  Given I am on "http://studio.code.org/courses/ui-test-all-the-levels/units/1/lessons/7/levels/3?noautoplay=true"
  Then I wait until I am on "http://studio.code.org/courses/ui-test-all-the-levels/units/1/lessons/7/levels/3?noautoplay=true"
  And I wait for the lab page to fully load
  And I've initialized the workspace with level 2 flappy blocks
  And I press "runButton"
  Then evaluate JavaScript expression "Flappy.onMouseDown(), true;"
  Then I wait to see ".modal"
  And element ".modal .congrats" contains text "Congratulations! You have completed the final puzzle."
