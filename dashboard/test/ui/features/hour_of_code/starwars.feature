...
Feature: Hour of Code 2015 tutorial is completable
  ...
  Scenario: Solving puzzle 1 in block mode
    ...
    Then I wait until I am on "http://studio.code.org/s/starwars/lesson/1/puzzle/2"
    And I wait for the page to fully load
    And I verify progress in the header of the current page is "perfect" for level 1

  Scenario: Solving puzzle 1 in text mode
    Given I am on "http://studio.code.org/s/starwars/lesson/1/puzzle/1?noautoplay=true"
    And I rotate to landscape
  ...
  Scenario: Solving puzzle 2 in text mode
    Given I am on "http://studio.code.org/s/starwars/lesson/1/puzzle/2?noautoplay=true"
    And I rotate to landscape
    And I wait for the page to fully load
    When I ensure droplet is in text mode
    And I append text to droplet "moveRight();\n"
  ...
  Scenario: Solving puzzle 3 in text mode
    Given I am on "http://studio.code.org/s/starwars/lesson/1/puzzle/3?noautoplay=true"
    And I rotate to landscape
    And I wait for the page to fully load
    When I ensure droplet is in text mode
  ...
  Scenario: Solving puzzle 4 in text mode
    Given I am on "http://studio.code.org/s/starwars/lesson/1/puzzle/4?noautoplay=true"
    And I rotate to landscape
    And I wait for the page to fully load
  ...
  Scenario: Solving puzzle 5 in text mode
    Given I am on "http://studio.code.org/s/starwars/lesson/1/puzzle/5?noautoplay=true"
    And I rotate to landscape
    And I wait for the page to fully load
    And I append text to droplet "moveRight();\n"
    And I append text to droplet "moveDown();\n"
  ...
  Scenario: Solving puzzle 6 in text mode
    Given I am on "http://studio.code.org/s/starwars/lesson/1/puzzle/6?noautoplay=true"
    And I rotate to landscape
    And I wait for the page to fully load
    When I ensure droplet is in text mode
    And I append text to droplet "moveDown();\n"
