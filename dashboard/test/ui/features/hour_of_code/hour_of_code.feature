...
Scenario: Solving puzzle 1, proceeding to puzzle 2, verifying that puzzle 1 appears as solved
  ...
  Then I am on "http://studio.code.org/s/20-hour/lessons/2/puzzle/2?noautoplay=true"
  Then I wait until I am on "http://studio.code.org/s/20-hour/lessons/2/puzzle/2?noautoplay=true"
