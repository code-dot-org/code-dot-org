Feature: Oceans ML HoC
  ...
  Scenario: Fish vs. Trash
    # Training Screen
    Given I am on "http://studio.code.org/s/oceans/lesson/1/puzzle/2?guide=off"
  ...
  Scenario: Sea Creatures
    # Initial Screen
    Given I am on "http://studio.code.org/s/oceans/lesson/1/puzzle/3?guide=off"
    Then I click selector "button:contains(Run)" once I see it
    And I wait until element "button:contains(Continue)" is visible
    And I wait for 2 seconds

    # Training Screen
    Given I am on "http://studio.code.org/s/oceans/lesson/1/puzzle/4?guide=off"
  ...
  Scenario: Short Word List
    # Training Screen
    Given I am on "http://studio.code.org/s/oceans/lesson/1/puzzle/6?guide=off"
  ...
  Scenario: Long Word List
    # Training Screen
    Given I am on "http://studio.code.org/s/oceans/lesson/1/puzzle/8?guide=off"
