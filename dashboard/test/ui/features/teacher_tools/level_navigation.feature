...
Scenario: External Markdown Level
  ...
  And I wait to see ".submitButton"
  Then I click ".submitButton" to load a new page
  And I wait until I am on "http://studio.code.org/courses/allthethingscourse/units/1/lessons/21/levels/2"

Scenario: Complete an auto-success level signed-out, continue, the auto-success level should show up as completed
  Given I am on "http://studio.code.org/courses/allthethingscourse/units/1/lessons/18/levels/14"
  And I wait to see ".submitButton"
  Then I click ".submitButton" to load a new page
  And I wait until I am on "http://studio.code.org/courses/allthethingscourse/units/1/lessons/18/levels/15"
