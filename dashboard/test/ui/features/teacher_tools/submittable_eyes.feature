...
Scenario: Submittable level
  ...
  Then I am on "http://studio.code.org/courses/ui-test-all-the-levels/units/1/lessons/9/levels/3?noautoplay=true"
...
Scenario: Lockable level
  ...
  Then I am on "http://studio.code.org/courses/ui-test-all-the-levels/units/1/lockable/1/levels/1/page/1"
  And I wait to see ".submitButton"
  And The header is finished animating
