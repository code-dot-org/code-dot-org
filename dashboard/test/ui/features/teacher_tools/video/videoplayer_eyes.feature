...
Scenario: Fallback player
  ...
  Given I am on "http://studio.code.org/courses/ui-test-all-the-levels/units/1/lessons/7/levels/1?force_youtube_fallback"
...
Scenario: Fallback player for unplugged
  ...
  Given I am on "http://studio.code.org/courses/ui-test-all-the-levels/units/1/lessons/55/levels/1?force_youtube_fallback"
...
Scenario: Fallback player for embedded
  ...
  Given I am on "http://studio.code.org/courses/ui-test-all-the-levels/units/1/lessons/34/levels/1?force_youtube_fallback=1"
  When I wait to see ".vjs-big-play-button"
...
Scenario: Normal player
  Given I am on "http://studio.code.org/courses/ui-test-all-the-levels/units/1/lessons/7/levels/1"
