Feature: After completing a CSF course, the student is directed to a congratulations page
  ...
  Scenario: Course A 2017 uncustomized dashboard certificate pages
    ...
    When I am on "http://studio.code.org/congrats/coursea-2017"
    And I wait until current URL contains "http://studio.code.org/congrats?s=Y291cnNlYS0yMDE3"
  ...
  Scenario: accelerated course certificates
    ...
    And I am on "http://studio.code.org/congrats/accelerated"
    And I wait until current URL contains "http://studio.code.org/congrats?s=YWNjZWxlcmF0ZWQ%3D"
    And I wait to see element with ID "uitest-certificate"
