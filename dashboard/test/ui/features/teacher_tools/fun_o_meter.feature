...
Scenario: Rate a Puzzle
  Given I am on "http://studio.code.org/courses/ui-test-all-the-levels/units/1/lessons/4/levels/4?noautoplay=true"
  ...
  Then I wait until I am on "http://studio.code.org/courses/ui-test-all-the-levels/units/1/lessons/4/levels/5"
