...
Feature: Using the join section page while not signed in
  ...
  Scenario: Attempt to join section while signed in
    ...
    And I create a new student section assigned to course "ui-test-all-the-levels" unit 1 and save the section

    # Have new user join section with valid form inputs
    Given I sign out
    Given I am a student
    And I join the section
    Then I wait until I am on "http://studio.code.org/courses/ui-test-all-the-levels/units/1"
