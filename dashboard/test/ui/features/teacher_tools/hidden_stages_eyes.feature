...
Scenario: Hidden Stages - lesson 2 hidden
  ...
  Then I am on "http://studio.code.org/courses/ui-test-all-the-levels/units/1"
  ...
  And I am on "http://studio.code.org/courses/ui-test-all-the-levels/units/1"
  And I see no difference for "student overview with hidden lesson 2"
  Then I am on "http://studio.code.org/courses/ui-test-all-the-levels/units/1/lessons/2/levels/2"
