...
Background:
  ...
  Given I am on "http://studio.code.org/courses/ui-test-all-the-levels/units/1/lessons/2/levels/6?noautoplay=true"
...
Scenario: Press the skip button
  ...
  Then I wait until I am on "http://studio.code.org/courses/ui-test-all-the-levels/units/1/lessons/2/levels/7"
