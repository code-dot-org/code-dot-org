...
Feature: Level Progress
  ...
  Scenario: Progress is saved for signed-in student
    ...
    When I complete the level on "http://studio.code.org/courses/allthethingscourse/units/1/lessons/2/levels/1"
    ...
    When I am on "http://studio.code.org/courses/allthethingscourse/units/1/lessons/2/levels/2"
