Feature: Student pairing
  Scenario: Pair Programming submits levels for both students
    ...
    And I join the section
    Given I am on "http://studio.code.org/courses/ui-test-student-labs/units/1/lessons/18/levels/7"
    ...
    And I wait for the lab page to fully load
    And check that the URL contains "/courses/ui-test-student-labs/units/1/lessons/18/levels/8"
  ...
  Scenario: Pair Programming attempts levels for both students
    ...
    Given I create a student named "Thing_Two"
    And I join the section
    Given I am on "http://studio.code.org/courses/ui-test-student-labs/units/1/lessons/2/levels/2"
    And I wait for the lab page to fully load
    Then I initiate pairing
    And I verify the user menu shows "Thing_One" and "Thing_Two" are in a pairing group
    # complete the level
  ...
  Scenario: Pairing group is correctly displayed in user menu on cached levels
    ...
    Given I create a student named "Thing_Two"
    And I join the section
    Given I am on "http://studio.code.org/courses/ui-test-student-labs/units/1/lessons/24/levels/7"
    And I wait for the lab page to fully load
    Then I initiate pairing
    And I verify the user menu shows "Thing_One" and "Thing_Two" are in a pairing group
