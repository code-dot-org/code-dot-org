...
Scenario: Submit three answers.
  Given I am on "http://studio.code.org/courses/ui-test-student-labs/units/1/lessons/33/levels/1?noautoplay=true"
  ...
  Then I am on "http://studio.code.org/courses/ui-test-student-labs/units/1/lessons/33/levels/1?noautoplay=true"
...
Scenario: Match levels within level group
  ...
  When I am on "http://studio.code.org/courses/ui-test-student-labs/units/1/lessons/33/levels/1?noautoplay=true"
  And I wait to see ".submitButton"
  ...
  And I am on "http://studio.code.org/courses/ui-test-student-labs/units/1/lessons/33/levels/1"
