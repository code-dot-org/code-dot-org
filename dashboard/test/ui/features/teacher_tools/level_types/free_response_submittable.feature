...
Background:
  Given I am on "http://studio.code.org/courses/ui-test-student-labs/units/1/lessons/27/levels/1"
...
Scenario: Level without multiple attempts allowed is locked after submit
  # First, submit something.
  Given I am on "http://studio.code.org/courses/ui-test-student-labs/units/1/lessons/27/levels/4"
  And I type "sample response" into ".free-response > textarea"
  And I press ".submitButton" using jQuery to load a new page

  # Reload the page to see that unsubmit is the option.
  Then I am on "http://studio.code.org/courses/ui-test-student-labs/units/1/lessons/27/levels/4"
