...
Feature: Playing multi levels 3
  ...
  Scenario: Does not scroll horizontally
    Given I am on "http://studio.code.org/courses/ui-test-all-the-levels/units/1/lessons/9/levels/2?noautoplay=true"
    When element ".submitButton" is visible
    Then there is no horizontal scrollbar

  Scenario: Can render without a question
    Given I am on "http://studio.code.org/courses/ui-test-all-the-levels/units/1/lessons/9/levels/4?noautoplay=true"
    When element ".submitButton" is visible
  ...
  Scenario: Standalone level without retries locks after answer is submitted
    ...
    Given I am on "http://studio.code.org/courses/ui-test-all-the-levels/units/1/lessons/9/levels/5/lang/en-US?noautoplay=true"
