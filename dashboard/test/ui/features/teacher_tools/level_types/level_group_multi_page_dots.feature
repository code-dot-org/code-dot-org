...
Scenario: Submit three pages as... 1. all, 2. none, 3. some questions answered.
  ...
  Then I navigate to the unit page for unit number "1" in course "ui-test-all-the-levels"
  ...
  When I am on "http://studio.code.org/courses/ui-test-all-the-levels/units/1/lessons/23/levels/2/page/3?noautoplay=true"
  ...
  And I am on "http://studio.code.org/courses/ui-test-all-the-levels/units/1/lessons/23/levels/1?noautoplay=true"
  And I wait to see ".react_stage"
