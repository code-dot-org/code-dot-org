...
Scenario: Progress is posted when continue is clicked
  Given I am on "http://studio.code.org/courses/allthethingscourse/units/1/lessons/34/levels/1"
  ...
  And I am on "http://studio.code.org/courses/allthethingscourse/units/1/lessons/34/levels/1"
  And I wait until element ".submitButton" is visible
