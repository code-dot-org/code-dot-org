Feature: BubbleChoice
  ...
  Scenario: Viewing BubbleChoice progress
    ...
    Given I am assigned to course "ui-test-all-the-levels" unit 1 with teacher "Teacher_Alice"

    # Go to BubbleChoice sublevel
    Given I am on "http://studio.code.org/courses/ui-test-all-the-levels/units/1/lessons/40/levels/1/sublevel/1"
    ...
    And check that the url contains "/courses/ui-test-all-the-levels/units/1/lessons/40/levels/1"
    ...
    Given I am on "http://studio.code.org/courses/ui-test-all-the-levels/units/1/lessons/40/levels/1"
  ...
  Scenario: Lab2 BubbleChoice progress
    ...
    Given I am on "http://studio.code.org/courses/ui-test-all-the-levels/units/1/lessons/52/levels/8/sublevel/1"
    ...
    And I wait until element ".uitest-bubble-choice:eq(0)" is visible
    And element ".uitest-bubble-choice:eq(0) .progress-bubble:first" is visible
    And check that the url contains "/courses/ui-test-all-the-levels/units/1/lessons/52/levels/8"
    Then I verify progress for the sublevel with selector ".uitest-bubble-choice:eq(0) .progress-bubble" is "perfect"
    ...
    # View progress from BubbleChoice activity page
    Given I am on "http://studio.code.org/courses/ui-test-all-the-levels/units/1/lessons/52/levels/8"
    And I wait until element ".teacher-panel" is visible
    And I wait for jquery to load
  ...
  Scenario: Navigating between a Lab2 sublevel and another Lab2 level
    ...
    And check that the url contains "/courses/ui-test-all-the-levels/units/1/lessons/52/levels/6"

    # Go back to the Lab2 BubbleChoice sublevel
    And I go back
    And I wait until element "#lab2-aichat" is visible
    And check that the url contains "/courses/ui-test-all-the-levels/units/1/lessons/52/levels/8/sublevel/1"
