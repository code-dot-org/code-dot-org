...
Background:
  ...
  Given I am on "http://studio.code.org/courses/UI%20Test%20PLC%20Things"
...
Scenario: Basic navigation and ribbon changing works as expected
  ...
  And I get redirected to "/s/ui-test-plc" via "dashboard"
  ...
  And I get redirected to "/courses/UI%20Test%20PLC%20Things" via "dashboard"
  And I wait to see ".course_unit_section"
  ...
  And I get redirected to "/s/ui-test-plc" via "dashboard"
  Given I am on "http://studio.code.org/s/ui-test-plc/lessons/11/levels/6"
  And I wait to see ".submitButton"
  Then I type "Test Answer" into "textarea"
  Then I click selector ".submitButton"
  And I get redirected to "/s/ui-test-plc/lessons/11/levels/7" via "dashboard"
  Given I am on "http://studio.code.org/courses/UI%20Test%20PLC%20Things"
  And I wait to see ".course_unit_section"
