...
Feature: Teacher Lesson Plan
  ...
  Scenario: Viewing Teacher Lesson Plan
    ...
    And I am on "http://studio.code.org/courses/ui-test-lesson-plans/units/1/lessons/1"
    ...
    Then I wait until I am on "http://studio.code.org/courses/ui-test-lesson-plans/units/1/lessons/2"
    And I wait until element "#show-container" is visible
  ...
  Scenario: Viewing Level Details Dialogs
    ...
    And I am on "http://studio.code.org/courses/ui-test-lesson-plans/units/1/lessons/5"
    And I wait until element "#show-container" is visible
