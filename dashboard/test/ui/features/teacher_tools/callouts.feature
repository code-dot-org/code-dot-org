...
Feature: Callouts
  ...
  Examples:
    ...
    | http://studio.code.org/courses/allthethingscourse/units/1/lessons/3/levels/7?noautoplay=true   | 0          | You have all the same blocks but they've now been arranged in categories                                | .blocklyToolboxCategoryGroup |
