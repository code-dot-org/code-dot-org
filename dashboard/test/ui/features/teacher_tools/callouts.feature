...
Feature: Callouts
  ...
  Examples:
    ...
    | http://studio.code.org/ui-test-hoc/1?noautoplay=true                                                          | 1          | Hit "Run" to try your program                                                                           | #runButton        |
    | http://studio.code.org/ui-test-hoc/1?noautoplay=true                                                          | 0          | Drag a "move" block and snap it below the other block                                                   | [data-id='moveForward']    |
    | http://studio.code.org/ui-test-hoc/9?noautoplay=true                                                          | 0          | Blocks that are grey can't be deleted. Can you solve the puzzle anyway?                                 | g                 |
    | http://studio.code.org/ui-test-hoc/14?noautoplay=true                                                         | 0          | Click here to see the code for the program you're making                                                | #show-code-header |
  ...
  Examples:
    | url                                                                                                           | callout_id | text                                                                             | close_target           |
    | http://studio.code.org/ui-test-hoc/6?noautoplay=true                                                          | 0          | Click here to watch the video again                                              | #thumbnail_mgooqyWMTxk |
