...
Scenario: Hidden Scripts
  ...
  Then I am on "http://studio.code.org/courses/ui-test-student-labs"
  ...
  And I am on "http://studio.code.org/courses/ui-test-student-labs"
  ...
  Then I am on "http://studio.code.org/courses/ui-test-student-labs/units/1/lessons/2/levels/1"
