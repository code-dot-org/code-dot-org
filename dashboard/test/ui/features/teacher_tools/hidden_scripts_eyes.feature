...
Scenario: Hidden Scripts
  ...
  Then I am on "http://studio.code.org/courses/ui-test-all-the-levels"
  ...
  And I am on "http://studio.code.org/courses/ui-test-all-the-levels"
  ...
  Then I am on "http://studio.code.org/courses/ui-test-all-the-levels/units/1/lessons/2/levels/1"
