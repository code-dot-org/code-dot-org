...
Scenario: Gamelab Flow
  ...
  Then I should see branded title includes "Code Ninja II: Uncaught Exception - Game Lab"
  ...
  And I should see branded title includes "Code Ninja II: Uncaught Exception - Game Lab"
...
Scenario: Remix project creates and redirects to new channel
  ...
  And I click selector ".project_save"
  And I wait until element ".project_edit" is visible
  Then I should see branded title includes "Code Ninja - Game Lab"
  And I save the URL

  Then I click selector ".project_remix" to load a new page
  And I wait for the lab page to fully load
  And I should see branded title includes "Remix: Code Ninja - Game Lab"
