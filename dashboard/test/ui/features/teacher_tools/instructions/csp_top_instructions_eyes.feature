...
Scenario: CSD and CSP Top Instructions
  ...
  And I am on "http://studio.code.org/courses/ui-test-student-labs/units/1/lessons/38/levels/1"
  ...
  And I am on "http://studio.code.org/courses/ui-test-student-labs/units/1/lessons/38/levels/2"
...
Scenario: Resizing CSD and CSP Top Instructions
  ...
  And I am on "http://studio.code.org/courses/ui-test-student-labs/units/1/lessons/18/levels/1"
  And I wait for the lab page to fully load
