...
Scenario: CSF Top Instructions
  ...
  And I am on "http://studio.code.org/courses/ui-test-all-the-levels/units/1/lessons/2/levels/3?noautoplay=true"
  And I wait for the lab page to fully load
  Then I see no difference for "maze short instructions"

  And I am on "http://studio.code.org/courses/ui-test-all-the-levels/units/1/lessons/5/levels/4?noautoplay=true"
  And I wait for the lab page to fully load
  And I see no difference for "artist long instructions"

  Then I am on "http://studio.code.org/courses/ui-test-all-the-levels/units/1/lessons/2/levels/7?noautoplay=true"
  And I wait for the lab page to fully load
  ...
  Then I am on "http://studio.code.org/courses/ui-test-all-the-levels/units/1/lessons/1/levels/1?noautoplay=true"
  And I wait for the lab page to fully load
...
Scenario: CSF hint top instructions
  ...
  Then I am on "http://studio.code.org/courses/ui-test-all-the-levels/units/1/lessons/6/levels/2?noautoplay=true"
  And I wait for the lab page to fully load
