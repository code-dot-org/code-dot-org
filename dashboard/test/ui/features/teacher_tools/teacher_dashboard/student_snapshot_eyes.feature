...
Feature: Student Snapshot page - Eyes
  ...
  Scenario: All widgets render with real progress and saved Python Lab code
    ...
    And I am assigned to course "ui-test-all-the-levels" unit 1 with teacher "Teacher_PySnapshotStudent"

    Given I am on "http://studio.code.org/courses/ui-test-all-the-levels/units/1/lessons/50/levels/1?hideProductTours=true"
    ...
    Given I am on "http://studio.code.org/courses/ui-test-all-the-levels/units/1/lessons/50/levels/14?hideProductTours=true"
    And I wait to see "#uitest-codebridge-run"
    And I wait until "#uitest-codebridge-run" is not disabled
    And I focus selector ".cm-content"
