...
Feature: Views the pages on the teacher dashboard that are untested elsewhere
  ...
  Scenario: Viewing teacher dashboard pages
    ...
    And I complete the free response on "http://studio.code.org/courses/ui-test-all-the-levels/units/1/lessons/27/levels/1"
    And I submit the assessment on "http://studio.code.org/courses/ui-test-all-the-levels/units/1/lessons/33/levels/1"
