@no_mobile
Feature: View all pages on the teacher dashboard
  Background:
  ...
  Scenario: Viewing dashboard pages
    ...
    # Stats tab
    And I click selector "#ui-test-teacher-sidebar a:contains(Stats)" once I see it
    ...
    # Text responses tab
    And I click selector "#ui-test-teacher-sidebar a:contains(Text Responses)" once I see it
    And I wait until element "#uitest-course-dropdown" is visible
    And I select the "All the Things! *" option in dropdown "uitest-course-dropdown"
