...
Feature: Using the assessments tab in the teacher dashboard
  ...
  Scenario: Assessments tab survey submissions
    ...
    And I submit the assessment on "http://studio.code.org/courses/ui-test-student-labs/units/1/lockable/3/levels/1/page/3"
    ...
    # Progress tab
    And I wait until element "#unit-selector-v2" contains text "All The Student Labs!"
