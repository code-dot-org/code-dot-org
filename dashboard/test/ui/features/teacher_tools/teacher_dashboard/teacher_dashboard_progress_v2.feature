...
Scenario: Teacher can open and close Icon Key and details
  ...
  Given I am assigned to course "ui-test-all-the-levels" with teacher "Teacher_Sally" in a section named "Test Section"
  And I complete the level on "http://studio.code.org/courses/ui-test-all-the-levels/units/1/lessons/2/levels/1"
...
Scenario: Viewing student metadata
  Given I create an authorized teacher-associated student named "Sally"
  Given I am assigned to course "ui-test-all-the-levels" with teacher "Teacher_Sally" in a section named "Test Section"
  And I am on "http://studio.code.org/courses/ui-test-all-the-levels/units/1/lessons/44/levels/9?noautoplay=true"
...
Scenario: Teacher can open and close lessons and see level data cells
  ...
  When I sign in as "Teacher_Sally" and go home
  And I assign my section in row 1 to course "ui-test-all-the-levels" unit 1
  And I get levelbuilder access
  ...
  And element "#ui-test-courses-ui-test-original-all-the-levels-units-1-lessons-2-levels-1-cell-data" is not visible
  And element "#ui-test-courses-ui-test-all-the-levels-units-1-lessons-2-levels-1-cell-data" is visible
  ...
  And element "#ui-test-courses-ui-test-all-the-levels-units-1-lessons-2-levels-1-cell-data" is not visible
...
Scenario: Teacher can navigate to student work by clicking level cell.
  ...
  And I wait until element "#ui-test-lesson-header-2" is visible
  And I click selector "#ui-test-lesson-header-2"
  And I click selector "#ui-test-courses-ui-test-all-the-levels-units-1-lessons-2-levels-1-cell-data" once I see it to load a new tab
  And check that the URL contains "&user_id="
  And check that the URL contains "courses/ui-test-all-the-levels/units/1/lessons/2/levels/1"

@skip
Scenario: Teacher can open lesson data, refresh the page, and lesson data will still be shown
  Given I create an authorized teacher-associated student named "Sally"
  Given I am assigned to course "ui-test-all-the-levels" unit 1
  ...
  And I wait until element "#ui-test-lesson-header-2" is visible
  And I click selector "#ui-test-lesson-header-2"
  And I wait until element "#ui-test-courses-ui-test-all-the-levels-units-1-lessons-2-levels-1-cell-data" is visible
...
Scenario: Teacher can view lesson progress for when students have completed a lesson and when they have started a lesson but not finished
  ...
  Given I am on "http://studio.code.org/courses/ui-test-all-the-levels/units/1/lessons/10/levels/1?noautoplay=true"
...
Scenario: Teacher can view student work, ask student to keep working, on rubric level
  ...
  Given I am on "http://studio.code.org/courses/ui-test-all-the-levels/units/1/lessons/38/levels/1?noautoplay=true"
  ...
  And I click selector "#ui-test-courses-ui-test-all-the-levels-units-1-lessons-38-levels-1-cell-data" once I see it to load a new tab
...
Scenario: Teacher can view choice levels
  ...
  Given I am on "http://studio.code.org/courses/ui-test-all-the-levels/units/1/lessons/40/levels/1/sublevel/2?noautoplay=true"
