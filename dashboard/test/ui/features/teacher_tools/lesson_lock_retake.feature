...
Scenario: Lock settings for retake not submit scenario
  ...
  When I am on "http://studio.code.org/courses/ui-test-all-the-levels/units/1"
  Then I verify the lesson named "Anonymous student survey 2" is locked

  When I am on "http://studio.code.org/courses/ui-test-all-the-levels/units/1/lockable/1/levels/1/page/1"
  ...
  And I am on "http://studio.code.org/courses/ui-test-all-the-levels/units/1"
  Then I verify the lesson named "Anonymous student survey 2" is unlocked
  When I am on "http://studio.code.org/courses/ui-test-all-the-levels/units/1/lockable/1/levels/1/page/4"
  ...
  And I wait until current URL contains "/courses/ui-test-all-the-levels/units/1/lessons/31/levels/1"
