...
Scenario: Free Response level 1
  ...
  And I am on "http://studio.code.org/courses/ui-test-student-labs/units/1/lessons/27/levels/1/summary"
...
Scenario: Free Response level 2
  ...
  Given I am a teacher
  And I create a new student section
  And I am on "http://studio.code.org/courses/ui-test-student-labs/units/1/lessons/27/levels/2/summary"
  And I wait until element "#summary-container" is visible
  And I wait to see ".uitest-sectionselect"
...
Scenario: Free Response level 3
  ...
  Given I am a teacher
  And I create a new student section
  And I am on "http://studio.code.org/courses/ui-test-student-labs/units/1/lessons/27/levels/3/summary"
  And I wait until element "#summary-container" is visible
  And I wait to see ".uitest-sectionselect"
...
Scenario: Multi level 1
  ...
  And I create a new student section
  And I am on "http://studio.code.org/courses/ui-test-student-labs/units/1/lessons/9/levels/1/summary"
  And I wait until element "#summary-container" is visible
  And I wait to see ".uitest-sectionselect"
...
Scenario: Multi level 2
  ...
  And I give user "Teacher_1" authorized teacher permission
  And I create a new student section
  And I am on "http://studio.code.org/courses/ui-test-student-labs/units/1/lessons/9/levels/4/summary"
  And I wait until element "#summary-container" is visible
  And I wait to see ".uitest-sectionselect"
...
Scenario: Check for Understanding summaries
  ...
  And I am on "http://studio.code.org/courses/ui-test-student-labs/units/1/lessons/27/levels/1/"
...
Scenario: Check free response AI
  ...
  Given I am on "http://studio.code.org/courses/ui-test-student-labs/units/1/lessons/27/levels/1/summary"
  ...
  Given I am on "http://studio.code.org/courses/ui-test-student-labs/units/1/lessons/27/levels/2/summary"
  And I wait until element "#summary-container" is visible
  And I dismiss the teacher panel
