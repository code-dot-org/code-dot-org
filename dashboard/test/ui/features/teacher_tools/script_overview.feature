...
Feature: Unit overview page
  ...
  Scenario: Viewing student progress
    ...
    Given I am assigned to course "ui-test-all-the-levels" unit 1 with teacher "Teacher_Sally"
    ...
    And I complete the level on "http://studio.code.org/courses/ui-test-all-the-levels/units/1/lessons/3/levels/2"
    And I am on "http://studio.code.org/courses/ui-test-all-the-levels/units/1"
