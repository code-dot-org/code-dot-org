...
Scenario: Toggle on Multi Level
  ...
  Then I am on "http://studio.code.org/courses/ui-test-all-the-levels/units/1/lessons/9/levels/1"
...
Scenario: Toggle on Hidden Maze Level
  ...
  Then I am on "http://studio.code.org/courses/ui-test-all-the-levels/units/1/lessons/2/levels/1?noautoplay=true"
...
Scenario: Toggle on Lockable Level
  ...
  Then I am on "http://studio.code.org/courses/ui-test-all-the-levels/units/1/lockable/1/levels/1/page/1?noautoplay=true"
  ...
  And I see no difference for "view as student while locked" in the current viewport
  Then I click selector ".uitest-viewAsTeacher"
  And element "#locked-lesson" is not visible
