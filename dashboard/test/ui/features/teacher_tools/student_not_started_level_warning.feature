...
Scenario: Game lab level where student has not started
  ...
  And I am on "http://studio.code.org/courses/ui-test-all-the-levels/units/1/lessons/38/levels/3"
...
Scenario: Maze level where student has not started
  ...
  And I am on "http://studio.code.org/courses/ui-test-all-the-levels/units/1/lessons/4/levels/2"
  And I wait for the lab page to fully load
  And I wait until element "#teacher-panel-container" is visible
  And I wait until element ".uitest-sectionselect:contains(Untitled Section)" is visible
  And I wait until element ".student-table" is visible
...
Scenario: Contained level
  ...
  And I am on "http://studio.code.org/courses/ui-test-all-the-levels/units/1/lessons/41/levels/1"
  And I wait for the lab page to fully load
  And I wait until element "#teacher-panel-container" is visible
  And I wait until element ".uitest-sectionselect:contains(Untitled Section)" is visible
  And I wait until element ".student-table" is visible
