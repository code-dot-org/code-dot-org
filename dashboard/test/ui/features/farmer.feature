...
Background:
  Given I am on "http://studio.code.org/s/20-hour/stage/9/puzzle/1?noautoplay=true&noprerender=true"
...
Scenario: Winning the first level
  ...
  Then check that I am on "http://studio.code.org/s/20-hour/stage/9/puzzle/2"
