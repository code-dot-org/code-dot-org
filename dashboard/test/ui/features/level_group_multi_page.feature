...
Scenario: Submit three pages.
  When element "#level_0 .multi-question" contains text "Which arrow gets"
  ...
  And I wait to see "#level_0"
  And check that the URL contains "/page/2"
  And element "#level_0 .multi-question" contains text "Which step should go"

  # Enter answers to all three multis on the second page.
  And I press "#level_0 .answerbutton[index=2]" using jQuery
  And I press "#level_1 .answerbutton[index=0]" using jQuery
  And I press "#level_2 .answerbutton[index=1]" using jQuery
  ...
  And element "#level_0 .multi-question" contains text "Which repeat block"
  ...
  And element "#level_0 #checked_2" is visible
  And element "#level_1 #checked_0" is visible
  And element "#level_2 #checked_1" is visible
