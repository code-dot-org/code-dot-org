...
FactoryGirl.define do
  ...
  factory :census2017v1, parent: :census_submission, class: Census2017v1 do
  ...
  factory :census2017v2, parent: :census2017v1, class: Census2017v2 do
  ...
  factory :census2017v3, parent: :census2017v2, class: Census2017v3 do
  end

  factory :hoc_census2017v1, parent: :census_submission, class: HocCensus2017v1 do
    submitter_email_address "hoc@email.address"
    submitter_name "Hoc Submitter"
  end

  factory :hoc_census2017v2, parent: :hoc_census2017v1, class: HocCensus2017v2 do
  end

  factory :hoc_census2017v3, parent: :hoc_census2017v2, class: HocCensus2017v3 do
  end
end
