...
module Pd::Application
  class Teacher1920ApplicationTest < ActiveSupport::TestCase
    ...
    test 'test allow_sending_application_reminder_email?' do
      # By default we can send.
      application = create :pd_teacher1920_application
      assert application.allow_sending_application_reminder_email?

      # If we created a teacher reminder email any time before, we can't send.
      application = create :pd_teacher1920_application
      create :pd_application_email, application: application, email_type: 'application_receipt_reminder', created_at: 14.days.ago
      refute application.allow_sending_application_reminder_email?
