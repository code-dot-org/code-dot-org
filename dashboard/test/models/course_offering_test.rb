...
class CourseOfferingTest < ActiveSupport::TestCase
  ...
  test 'assignable_published_for_students_course_offerings filters only for assignable, published, and for student course offerings' do
    ...
    refute_include(filtered_course_offerings, none_co)
    refute_include(filtered_course_offerings, assignable_co)
    refute_include(filtered_course_offerings, published_co)
    refute_include(filtered_course_offerings, for_student_co)
    refute_include(filtered_course_offerings, assignable_published_co)
    refute_include(filtered_course_offerings, assignable_for_student_co)
    refute_include(filtered_course_offerings, published_for_student_co)
    assert_include(filtered_course_offerings, all_co)
  end
  ...
  test 'in assignable course offerings summary display names of course offerings include star if they are not launched' do
    ...
    expected_course_offering_names.each {|name| assert_include(assignable_course_offering_names, name)}
  end
