...
class CourseOfferingTest < ActiveSupport::TestCase
  ...
  test "can serialize and seed course offerings" do
    course_offering = create :course_offering, key: 'course-offering-1', grade_levels: 'K,1,2', curriculum_type: 'Course', marketing_initiative: 'HOC', header: 'Popular Media', image: '/images/sample_image_ref', cs_topic: 'Artificial Intelligence,Cybersecurity', school_subject: 'Math,Science', device_compatibility: "{'Computer':'Ideal','Chromebook':'Not recommended','Tablet':'Incompatible','Mobile':'Incompatible','No Device':'Incompatible'}"
