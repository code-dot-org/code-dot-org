  ...
  test 'summarize: section with a course assigned' do
    ...
    Timecop.freeze(Time.zone.now) do
      ...
      expected = {
        ...
        name: section.name,
        teacherName: section.teacher.name,
        linkToProgress: subpath_teacher_dashboard_section_url(section, path: :progress),
        assignedTitle: 'somecourse',
        linkToAssigned: '/courses/somecourse',
        currentUnitTitle: '',
        linkToCurrentUnit: '',
        courseVersionName: 'somecourse',
        numberOfStudents: 0,
        linkToStudents: subpath_teacher_dashboard_section_url(section, path: :manage_students),
        code: section.code,
        lesson_extras: false,
        pairing_allowed: true,
        tts_autoplay_enabled: false,
  ...
  test 'summarize: section with a coteacher' do
    ...
    Timecop.freeze(Time.zone.now) do
      ...
      expected = {
        ...
        linkToProgress: subpath_teacher_dashboard_section_url(section, path: :progress),
        assignedTitle: '',
        linkToAssigned: teacher_dashboard_section_url(''),
        currentUnitTitle: '',
        linkToCurrentUnit: '',
        courseVersionName: nil,
        numberOfStudents: 0,
