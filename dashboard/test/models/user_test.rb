...
class UserTest < ActiveSupport::TestCase
  ...
  class HiddenIds < ActiveSupport::TestCase
    setup_all do
      ...
      @custom_stage_1 = create(:stage, script: @script, absolute_position: 1, relative_position: '1')
      @custom_stage_2 = create(:stage, script: @script, absolute_position: 2, relative_position: '2')
      @custom_stage_3 = create(:stage, script: @script, absolute_position: 3, relative_position: '3')
      @custom_s1_l1 = create(
        :script_level,
        script: @script,
