...
class UnitTest < ActiveSupport::TestCase
  ...
  test "unit_names_by_curriculum_umbrella returns the correct unit names" do
    ...
    assert_include(Unit.unit_names_by_curriculum_umbrella(Curriculum::SharedCourseConstants::CURRICULUM_UMBRELLA.CSP), @csp_unit.name)
    assert_equal(
      [@csa_unit.name],
    ...
    assert_include(Unit.unit_names_by_curriculum_umbrella(Curriculum::SharedCourseConstants::CURRICULUM_UMBRELLA.HOC), @hoc_unit.name)
  end
