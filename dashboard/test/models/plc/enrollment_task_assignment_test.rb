...
class Plc::EnrollmentTaskAssignmentTest < ActiveSupport::TestCase
  setup do
    ...
    @task1 = create(:plc_task, name: 'Task1', plc_learning_module: @learning_module)
    @task2 = create(:plc_task, name: 'Task2', plc_learning_module: @learning_module)
  ...
  test 'Completing tasks does not mark module / course complete until all are complete' do
    ...
    enrollment.enroll_user_in_course_with_learning_modules([@learning_module, @learning_module2])
