...
class ScriptTest < ActiveSupport::TestCase
  ...
  class AssignableForUser < ActiveSupport::TestCase
    ...
    test "assignable_for_user?: works for pilot courses taught by teachers for students" do
      pilot_course = create :unit, pilot_experiment: 'my-experiment', published_state: SharedCourseConstants::PUBLISHED_STATE.pilot
      pilot_teacher = create :teacher, pilot_experiment: 'my-experiment'
    ...
    test "assignable_for_user?: works for pilot courses taught by plc reviewer for facilitators" do
      pl_pilot_course = create :unit, pilot_experiment: 'my-experiment', published_state: SharedCourseConstants::PUBLISHED_STATE.pilot, participant_audience: SharedCourseConstants::PARTICIPANT_AUDIENCE.facilitator, instructor_audience: SharedCourseConstants::INSTRUCTOR_AUDIENCE.plc_reviewer
      pilot_teacher = create :teacher, pilot_experiment: 'my-experiment'
      pilot_facilitator = create :facilitator, pilot_experiment: 'my-experiment'
      pilot_plc_reviewer = create :plc_reviewer, pilot_experiment: 'my-experiment'
