...
class ScriptTest < ActiveSupport::TestCase
  ...
  test 'script with hidden false and is_stable true has stable published state' do
    ...
    assert_equal PUBLISHED_STATE.stable, script.get_published_state
  end
  ...
  test 'summarize includes show assign button' do
    ...
    assert_equal PUBLISHED_STATE.preview, script.summarize[:publishedState]
    ...
    assert_equal PUBLISHED_STATE.beta, hidden_script.summarize[:publishedState]
