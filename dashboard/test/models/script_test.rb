...
class ScriptTest < ActiveSupport::TestCase
  ...
  test 'all properties can be set and then removed on reseed' do
    ...
    assert_equal 19, script.properties.keys.length
  ...
  test 'self.latest_stable_version returns latest stable version for user locale' do
    create :script, name: 's-2017', family_name: 'fake-family', version_year: '2017', published_state: SharedConstants::PUBLISHED_STATE.stable, supported_locales: ["it-it"]
    script_2018 = create :script, name: 's-2018', family_name: 'fake-family', version_year: '2018', published_state: SharedConstants::PUBLISHED_STATE.stable, supported_locales: ["it-it"]
  ...
  test 'self.latest_stable_version returns latest stable version for English locales' do
    ...
    script_2018 = create :script, name: 's-2018', family_name: 'fake-family', version_year: '2018', published_state: SharedConstants::PUBLISHED_STATE.stable
  ...
  test 'self.latest_stable_version returns correct script version in family if version_year is supplied' do
    script_2017 = create :script, name: 's-2017', family_name: 'fake-family', version_year: '2017', published_state: SharedConstants::PUBLISHED_STATE.stable
  ...
  test 'summarize includes show assign button' do
    script = create(:script, name: 'script', published_state: SharedConstants::PUBLISHED_STATE.preview)
  ...
  test "assignable_info: correctly translates script info" do
    ...
    script = build(:script, name: 'csp1-2017', published_state: SharedConstants::PUBLISHED_STATE.preview)
    assignable_info = script.assignable_info
