...
class ScriptTest < ActiveSupport::TestCase
  ...
  test 'script with hidden false and is_stable true has stable published state' do
    ...
    assert_equal PUBLISHED_STATE.stable, script.published_state
  end
