...
class Census::CensusSummaryTest < ActiveSupport::TestCase
  ...
  test "Consistent yes teacher surveys override other surveys" do
    school_year = 2020
  ...
  test "Consistent no teacher surveys override other surveys" do
    school_year = 2020
    school = create :census_school,
  ...
  test "compute_teaches_cs with last year unknown gives correct results" do
    validate_compute_teaches_cs_with_last_years_value('UNKNOWN', nil, false)
  end

  test "compute_teaches_cs with last year excluded gives correct results" do
    validate_compute_teaches_cs_with_last_years_value('EXCLUDED', nil, false)
  end
  ...
  test "compute_teaches_cs with two years ago unknown gives correct results" do
    validate_compute_teaches_cs_with_two_years_ago_value('UNKNOWN', nil, false)
  end

  test "compute_teaches_cs with two years ago excluded gives correct results" do
    validate_compute_teaches_cs_with_two_years_ago_value('EXCLUDED', nil, false)
  end
  ...
  def validate_explanation(explanation)
    ...
    assert_equal 5, explanation.length, explanation
  end
