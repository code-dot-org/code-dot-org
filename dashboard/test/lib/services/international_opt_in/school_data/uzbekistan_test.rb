...
class Services::InternationalOptIn::SchoolData::UzbekistanTest < ActiveSupport::TestCase
  include Minitest::RSpecMocks

  let(:described_class) {Services::InternationalOptIn::SchoolData::Uzbekistan}
