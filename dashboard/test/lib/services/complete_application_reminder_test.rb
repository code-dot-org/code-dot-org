...
class Services::CompleteApplicationReminderTest < ActiveSupport::TestCase
  ...
  test 'both reminders omit applications without an email' do
    Timecop.freeze do
      ...
      assert_include(applications_needing_initial_reminder, application_with_email)
      refute_include(applications_needing_initial_reminder, teacher_without_email)
      ...
      assert_include(applications_needing_final_reminder, application_with_email)
      refute_include(applications_needing_final_reminder, teacher_without_email)
    end
  end
end
