...
class BrandTest < ActiveSupport::TestCase
  ...
  test 'unknown default-brand value falls back to BRAND_CODEAI_NEXT' do
    DCDO.stubs(:get).with('default-brand', Cdo::Brand::BRAND_CODEAI_NEXT).returns('not-a-real-brand')
    assert_equal Cdo::Brand::BRAND_CODEAI_NEXT, Cdo::Brand.current_brand_code
  end
  ...
  test 'codeai_next? is true by default' do
    assert_equal true, Cdo::Brand.codeai_next?
  end
  ...
  test 'codeai-audit can never become the default brand, even if DCDO is set to it' do
    DCDO.stubs(:get).with('default-brand', Cdo::Brand::BRAND_CODEAI_NEXT).returns(Cdo::Brand::BRAND_CODEAI_AUDIT)
    assert_equal Cdo::Brand::BRAND_CODEAI_NEXT, Cdo::Brand.current_brand_code
