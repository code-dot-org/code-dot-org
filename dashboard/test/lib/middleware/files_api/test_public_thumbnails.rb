require_relative '../../../../dashboard/test/lib/middleware/files_api_test_base' # Must be required first to establish load paths
require_relative '../../../../dashboard/test/lib/middleware/files_api_test_helper'
require 'cdo/aws/s3'
