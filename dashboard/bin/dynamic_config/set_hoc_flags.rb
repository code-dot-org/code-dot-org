...
# - yellow (non-essential hint and puzzle rating features disabled for HOC scripts)
...
Usage: #{$0}: red|yellow|green
 ...
 - red: No HOC sharing, no HOC hints, no HOC activity tracking, no HOC milestone posts, no HOC puzzle rating.
 - yellow: No HOC puzzle rating, no HOC hints.
