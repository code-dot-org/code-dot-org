...
BarGraph.prototype.updateSubstMap = function (substMap) {
  this.english_data = this.user_data.map(function(d){
    return {
      ...
      frequency: ENGLISH[substMap[d.letter]]/100,
    };
  });
  this.render();
};
...
BarGraph.prototype.reorder = function () {
  ...
  transition.each("end", function () {
    ...
    this.svg.selectAll(".letter")
      .sort(function(a, b) { return this.englishLetterScale(a.english.letter) - this.englishLetterScale(b.english.letter); }.bind(this));

    this.svg.selectAll(".dragletter")
      .sort(function(a, b) { return this.userLetterScale(a.user.letter) - this.userLetterScale(b.user.letter); }.bind(this));
...
BarGraph.prototype.init = function () {
  ...
  drag.on('drag', function(d, i) {
    ...
    this.svg.selectAll('.letter').selectAll("rect")
      .data(function(d) { return [d.english, d.user]; })
      .attr("height", function(d) { return this.getHeight() - this.yScale(d.frequency);  }.bind(this));
