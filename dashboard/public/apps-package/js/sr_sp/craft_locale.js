...
"houseSelectChooseFloorPlan":function(d){return "Одаберите план свог стана."},
...
"level11FailureMessage":function(d){return "Постави калдрму ако је лава испред. Ово ће ти омогућити да безбедно ископаш овај ред ресурса."},
...
"level1FailureMessage":function(d){return "Треба да користите команде како би дошли до овце."},
"level1TooFewBlocksMessage":function(d){return "Покушај да користиш више команди да дођеш до оваца."},
"level2FailureMessage":function(d){return "Да би посекли дрво, дошетајте то његовог дебла и искористите \"уништи блок\" команду."},
"level2TooFewBlocksMessage":function(d){return "Покушајте да искористите још команди како би исекли дрво. Дошетајте до његовог стабла и употребите \"уништи блок\" команду."},
"level3FailureMessage":function(d){return "Како би сакупили вуну од обе овце, дошетајте до сваке од њих и употребите \"шишај\" команду. Не заборавите да користите команде за окретање како би дошли до оваца."},
...
"level5FailureMessage":function(d){return "Постави своје блокове на земљу да саградиш зид. Роза \"понављај\" команда ће покренути команде стављене унутар ње, као на пример \"постави блок\" и \"помери се напред\"."},
...
"tooManyBlocksFail":function(d){return "Мозгалица "+craft_locale.v(d,"puzzleNumber")+" је завршена. Честитам! Такође је могуће завршити са "+craft_locale.p(d,"numBlocks",0,"sr",{"one":"1 block","other":craft_locale.n(d,"numBlocks")+" blocks"})+"."}};