...
"isWallTooltip":function(d){return "Враћа \"истинито\" ако је тамо зид"},
...
"setBallSpeedRandom":function(d){return "подеси брзину насумичне лопте"},
...
"setPaddleHardcourt":function(d){return "подеси одбијање од површине"},
"setPaddleRetro":function(d){return "подеси одбијање уназад"},
"setPaddleTooltip":function(d){return "Подеси слику рекета"},
"setPaddleSpeedRandom":function(d){return "подеси случајну брзину рекета"},
...
"setPaddleSpeedTooltip":function(d){return "Подеси брзину кретања рекета"},
