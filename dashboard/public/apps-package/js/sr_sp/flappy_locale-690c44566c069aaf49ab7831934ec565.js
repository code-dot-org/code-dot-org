...
"flapRandom":function(d){return "маши крилима насумичном снагом"},
...
"flapTooltip":function(d){return "Флопи-птица лети нагоре."},
...
"incrementPlayerScore":function(d){return "освојите поен"},
...
"playSoundWing":function(d){return "свирај звук крила"},
...
"playSoundSplash":function(d){return "свирај звук прскања воде"},
...
"setBackgroundRandom":function(d){return "Постави сцену Насумично"},
"setBackgroundFlappy":function(d){return "Постави сцену Град (дању)"},
"setBackgroundNight":function(d){return "Постави сцену Град (ноћу)"},
"setBackgroundSciFi":function(d){return "Постави сцену Научна фантастика"},
"setBackgroundUnderwater":function(d){return "Постави сцену Под водом"},
