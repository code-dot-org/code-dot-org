...
"bounceBallTooltip":function(d){return "Sprett en ball av et objekt."},
...
"setBallSpeedSlow":function(d){return "Angi langsom ball hastighet"},
"setBallSpeedNormal":function(d){return "Angi normal ball hastighet"},
"setBallSpeedFast":function(d){return "Angi rask ball hastighet"},
"setBallSpeedVeryFast":function(d){return "Angi svært rask ball hastighet"},
"setBallSpeedTooltip":function(d){return "Angir hastigheten på ballen"},
...
"setPaddleSpeedRandom":function(d){return "angi tilfeldig padle hastighet"},
...
"setPaddleSpeedTooltip":function(d){return "Velg rekkerthastighet"},
...
"whenBallMissesPaddle":function(d){return "når ball bommer på rekkerten"},
...
"whenWallCollidedTooltip":function(d){return "Utfør handlingene nedenfor når en ball kolliderer med en vegg."},
