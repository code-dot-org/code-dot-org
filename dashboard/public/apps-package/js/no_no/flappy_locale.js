...
"flappySpecificFail":function(d){return "Koden din ser bra ut - den vil flakse med hvert klikk. Men du må klikke mange ganger for å flakse til målet."},
...
"playSoundTooltip":function(d){return "Spill valgt lyd."},
...
"setBackgroundSciFi":function(d){return "angi scenen Sci-Fi"},
"setBackgroundUnderwater":function(d){return "angi scenen Under vann"},
"setBackgroundCave":function(d){return "angi scenen Hule"},
"setBackgroundSanta":function(d){return "angi scenen Julenissen"},
...
"speedNormal":function(d){return "angi fart normal"},
"speedFast":function(d){return "angi fart rask"},
"speedVeryFast":function(d){return "angi fart veldig rask"},
