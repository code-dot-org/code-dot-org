...
"alienInvasion":function(d){return "Romvesen-invasjon!"},
"backgroundBlack":function(d){return "svart"},
"backgroundCave":function(d){return "hule"},
"backgroundCloudy":function(d){return "skyet"},
...
"moveSpriteN":function(d){return "flytte skuespiller "+appLocale.v(d,"spriteIndex")},
...
"reinfFeedbackMsg":function(d){return "Du kan trykke \"Prøv igjen\"-knappen for å gå tilbake til å spille din historie."},
...
"saySpriteN":function(d){return "skuespiller "+appLocale.v(d,"spriteIndex")+" sier"},
...
"setSpriteEmotionAngry":function(d){return "til sint humør"},
...
"setSpriteAnna":function(d){return "til Anna utseende"},
"setSpriteElsa":function(d){return "til Elsa utseende"},
...
"setSpriteN":function(d){return "angi skuespiller "+appLocale.v(d,"spriteIndex")},
...
"stopSpriteN":function(d){return "stopp skuespiller "+appLocale.v(d,"spriteIndex")},
"stopTooltip":function(d){return "Stopper en skuespillers bevegelser."},
"throwSprite":function(d){return "kaste"},
"throwSpriteN":function(d){return "skuespiller kaster "+appLocale.v(d,"spriteIndex")},
"throwTooltip":function(d){return "Kaster et prosjektil fra angitte skuespiller."},
"vanish":function(d){return "fjern"},
"vanishActorN":function(d){return "fjern skuespiller "+appLocale.v(d,"spriteIndex")},
...
"whenSpriteClickedN":function(d){return "når skuespiller "+appLocale.v(d,"spriteIndex")+" blir klikket på"},
"whenSpriteClickedTooltip":function(d){return "Utfør handlingene under når en skuespiller blir klikket på."},
"whenSpriteCollidedN":function(d){return "når skuespiller "+appLocale.v(d,"spriteIndex")},
...
"whenSpriteCollidedWithN":function(d){return "berører skuespiller "+appLocale.v(d,"spriteIndex")},
