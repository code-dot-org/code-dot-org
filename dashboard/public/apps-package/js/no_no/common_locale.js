...
"dropletBlock_comment_description":function(d){return "Skriv en beskrivelse av noen kode"},
...
"dropletBlock_equalityOperator_description":function(d){return "Teste om to verdier er like. Returnerer 'true' hvis verdien på venstre side av uttrykket er lik verdien på høyre side, og 'false' ellers"},
...
"dropletBlock_randomNumber_description":function(d){return "Returnerer et tilfeldig tall i det lukkede området fra min til maks."},
...
"hintReviewTitle":function(d){return "Se Gjennom Dine Hint"},
"hintSelectInstructions":function(d){return "Instruksjoner og gamle tips"},
