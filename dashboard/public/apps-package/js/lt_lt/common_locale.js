...
"dropletBlock_appendItem_description":function(d){return "Pridėti elementą prie masyvo pabaigos"},
"dropletBlock_appendItem_param0":function(d){return "sąrašas"},
"dropletBlock_appendItem_param0_description":function(d){return "Masyvas, skirtas redagavimui."},
"dropletBlock_appendItem_param1":function(d){return "elementas"},
"dropletBlock_appendItem_param1_description":function(d){return "Pridėti paskutinį masyvo elementą."},
"dropletBlock_arcLeft_description":function(d){return "Judina vėžlį į priekį ir į kairę apskritimo lanku"},
"dropletBlock_arcLeft_param0":function(d){return "kampas"},
"dropletBlock_arcLeft_param0_description":function(d){return "The angle along the circle to move."},
"dropletBlock_arcLeft_param1":function(d){return "spindulys"},
...
"dropletBlock_arcRight_param0":function(d){return "kampas"},
"dropletBlock_arcRight_param0_description":function(d){return "The angle along the circle to move."},
"dropletBlock_arcRight_param1":function(d){return "spindulys"},
...
"dropletBlock_button_param0":function(d){return "mygtukoId"},
...
"dropletBlock_button_param1_description":function(d){return "Tekstas, rodomas ant mygtuko."},
...
"dropletBlock_checkbox_param1":function(d){return "pažymėta"},
...
"dropletBlock_circle_param2":function(d){return "spindulys"},
"dropletBlock_circle_param2_description":function(d){return "Apskritimo spindulys pikseliais."},
"dropletBlock_clearCanvas_description":function(d){return "Išvalyti visus duomenis, esančius darbo lauke"},
...
"dropletBlock_clearInterval_param0":function(d){return "intervalas"},
...
"dropletBlock_console.log_param0":function(d){return "žinutė"},
"dropletBlock_console.log_param0_description":function(d){return "Žinutė, kuri bus rodoma konsolėje."},
...
"dropletBlock_deleteRecord_param0_description":function(d){return "Lentelės pavadinimas, kurioje bus ieškomi ir perskaitomi įrašai."},
...
"dropletBlock_dot_description":function(d){return "Nupiešia nustatyto spindulio tašką ten, kur yra vėžliukas"},
"dropletBlock_dot_param0":function(d){return "spindulys"},
"dropletBlock_dot_param0_description":function(d){return "Taško (su kuriuo piešiama) spindulys"},
...
"dropletBlock_insertItem_param0":function(d){return "sąrašas"},
"dropletBlock_insertItem_param0_description":function(d){return "Masyvas, skirtas redagavimui."},
...
"dropletBlock_insertItem_param2":function(d){return "elementas"},
...
"dropletBlock_penRGB_param0":function(d){return "raudona spalva"},
...
"dropletBlock_penRGB_param1":function(d){return "žalia spalva"},
...
"dropletBlock_penRGB_param2":function(d){return "mėlyna"},
...
"dropletBlock_radioButton_param1":function(d){return "pažymėta"},
...
"dropletBlock_readRecords_param0_description":function(d){return "Lentelės pavadinimas, kurioje bus ieškomi ir perskaitomi įrašai."},
...
"dropletBlock_removeItem_param0":function(d){return "sąrašas"},
"dropletBlock_removeItem_param0_description":function(d){return "Masyvas, skirtas redagavimui."},
...
"dropletBlock_setChecked_param1":function(d){return "pažymėta"},
...
"dropletBlock_substring_param1":function(d){return "pabaiga"},
...
"dropletBlock_turnLeft_param0":function(d){return "kampas"},
...
"dropletBlock_turnRight_param0":function(d){return "kampas"},
...
"dropletBlock_turnTo_param0":function(d){return "kampas"},
...
"dropletBlock_updateRecord_param0_description":function(d){return "Lentelės pavadinimas, kurioje bus ieškomi ir perskaitomi įrašai."},
