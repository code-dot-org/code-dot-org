...
"calloutUseArrowButtonsAutoSteer":function(d){return "Mes paslėpėme kodą, kurį tu parašei, bet vis dar gali naudoti rodyklių mygtukus judėjimui"},
...
"calloutPlaceTwo":function(d){return "Ar gali padaryti taip, kad kai pagauni vieną Moude Droid, atsiranda dar du?"},
"calloutPlaceTwoWhenTauntaun":function(d){return "Ar gali padaryti taip, kad kai pagauni Tauntaun, atsiranda du Mynocks?"},
...
"dropletBlock_setBackground_param0_description":function(d){return "Fono temos pavadinimas (\"atsitiktinis\", \"endor\", \"hoth\" arba \"starship\")."},
...
"dropletBlock_whenGetCharacter_description":function(d){return "Ši funkcija veikia, kai droidas pagauna bet kokį veikėją."},
"dropletBlock_whenGetStormtrooper_description":function(d){return "Ši funkcija veikia, kai droidas pagauna Stormtrooper veikėją."},
"dropletBlock_whenGetRebelPilot_description":function(d){return "Ši funkcija veikia, kai droidas pagauna Rebel Pilot veikėją."},
"dropletBlock_whenGetPufferPig_description":function(d){return "Ši funkcija veikia, kai droidas pagauna Puffer Pig veikėją."},
"dropletBlock_whenGetMynock_description":function(d){return "Ši funkcija veikia, kai droidas pagauna Mynock veikėją."},
"dropletBlock_whenGetMouseDroid_description":function(d){return "Ši funkcija veikia, kai droidas pagauna Mouse Droid veikėją."},
"dropletBlock_whenGetTauntaun_description":function(d){return "Ši funkcija veikia, kai droidas pagauna Tauntaun veikėją."},
"dropletBlock_whenGetProbot_description":function(d){return "Ši funkcija veikia, kai droidas pagauna Probot veikėją."},
...
"dropletBlock_whenTouchStormtrooper_description":function(d){return "Ši funkcija veikia tada kai dronas paliečia Stormtrooper veikėją."},
...
"goSprite":function(d){return "eiti"},
...
"hoc2015_move_right_instructions":function(d){return "\"Mums reikia to metalo laužo [scrapmetal1]. BB-8, Ar gali gauti jį?\""},
"hoc2015_move_right_down_instructions":function(d){return "\"Mums reikia daugiau metalo laužo [scrapmetal2]. galite surinkti visa metalo laužą čia?\""},
...
"hoc2015_move_around_instructions":function(d){return "\"Viskas priklauso nuo taves, BB-8!\""},
"hoc2015_move_finale_instructions":function(d){return "\"Mums reikia dar 4 metalo gabalų [scrapmetal2]. Ar jūs galite rasti juos?\""},
"hoc2015_event_two_items_instructions":function(d){return "\"R2-D2, Mums reikia kad gautum kritišką žinute sukilėlių pilotams [rebelpilot].\""},
"hoc2015_event_two_items_instructions2":function(d){return "Padaryk kad R2-D2 judėti naudodamas rodyklių klavišus."},
