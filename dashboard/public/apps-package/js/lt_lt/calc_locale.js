...
"missingFunctionError":function(d){return "Jūs turite apibūdinti funkciją pavadinimu "+appLocale.v(d,"functionName")+"."},
"missingVariableX":function(d){return "Jūsų reiškinyje trūsta kintamojo "+appLocale.v(d,"var")+"."},
