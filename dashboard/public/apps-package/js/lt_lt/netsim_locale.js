...
"addPacket":function(d){return "Pridėti paketą"},
...
"binary":function(d){return "Dvejetainis"},
"bitCounter":function(d){return netsim_locale.v(d,"x")+"/"+netsim_locale.v(d,"y")+" bitai"},
"bits":function(d){return "Bitai"},
"buttonAccept":function(d){return "Accept"},
"buttonCancel":function(d){return "Atšaukti"},
"buttonJoin":function(d){return "Join"},
"clear":function(d){return "Išvalyti"},
"collapse":function(d){return "Collapse"},
"connect":function(d){return "Connect"},
"connected":function(d){return "Prisijungta"},
...
"decimal":function(d){return "Dešimtainis"},
"disconnected":function(d){return "Atsijungta"},
"dns":function(d){return "DNS"},
"dnsMode":function(d){return "DNS Mode"},
"dnsMode_AUTOMATIC":function(d){return "Automatinis"},
"dnsMode_MANUAL":function(d){return "Rankiniu būdu"},
"dnsMode_NONE":function(d){return "Nė vienas"},
"dropdownPickOne":function(d){return "-- PICK ONE --"},
"encoding":function(d){return "Kodavimas"},
"expand":function(d){return "Expand"},
"from":function(d){return "Nuo"},
"hex":function(d){return "Hex"},
"hexadecimal":function(d){return "Šešioliktainis"},
...
"logStatus_dropped":function(d){return "Sumažėjo"},
"logStatus_success":function(d){return "Atlikta"},
"markAsRead":function(d){return "Mark as read"},
"message":function(d){return "Pranešimas"},
"myDevice":function(d){return "Mano įrenginys"},
...
"numBitsPerPacket":function(d){return netsim_locale.v(d,"x")+" bitus pakete"},
...
"_of_":function(d){return " iš "},
"packet":function(d){return "Paketas"},
"packetInfo":function(d){return "Paketo informacija"},
...
"removePacket":function(d){return "Pašalinti paketą"},
"router":function(d){return "Maršrutizatorius"},
...
"routerTab_bandwidth":function(d){return "Pralaidumas"},
"routerTab_memory":function(d){return "Atmintis"},
"routerTab_stats":function(d){return "Statistika"},
"routerX":function(d){return "Maršrutizatorius "+netsim_locale.v(d,"x")},
"send":function(d){return "Siųsti"},
"sendAMessage":function(d){return "Siųsti žinutę"},
...
"status":function(d){return "Statusas/Būsena"},
"to":function(d){return "Į"},
"unknownNode":function(d){return "Unknown Node"},
"unlimited":function(d){return "Neribotas"},
"waitingForNodeToConnect":function(d){return "Waiting for "+netsim_locale.v(d,"node")+" to connect..."},
"workspaceHeader":function(d){return "Interneto simuliatorius"},
