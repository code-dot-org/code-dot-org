...
"flapSmall":function(d){return "ज़रा सा फ़ड़फ़ड़ाय"},
"flapNormal":function(d){return "सामान्य मात्रा में फडफ़ड़ाय"},
"flapLarge":function(d){return "बहुत फडफ़ड़ाय"},
"flapVeryLarge":function(d){return "बहुत सारा फडफ़ड़ाय"},
"flapTooltip":function(d){return "Flappy उप्पर उड़े"},
"flappySpecificFail":function(d){return "तुम्हारा कोड एक दम सही दिखता है - यह हर एक क्लिक के साथ अब उप्पर उड़ेगा. मगर आपको बहुत बार क्लिक करना पड़ेगा इसे लक्षय तक पहुंचने के लिये."},
"incrementPlayerScore":function(d){return "अंक बनाओ"},
...
"playSoundRandom":function(d){return "कोई सी भी ध्वनि चले."},
"playSoundBounce":function(d){return "उछलने की ध्वनि चले"},
"playSoundCrunch":function(d){return "चरमराने का ध्वनि बजाए"},
"playSoundDie":function(d){return "मंद ध्वनि चले"},
"playSoundHit":function(d){return "टकराने की ध्वनि चले"},
"playSoundPoint":function(d){return "point की ध्वनि चले"},
"playSoundSwoosh":function(d){return "सड़ाके से जाने की ध्वनि चले"},
