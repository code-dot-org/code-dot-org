...
"nextLevelTrophies":function(d){return "অভিনন্দন! আপনি চূড়ান্ত "+common_locale.v(d,"puzzleNumber")+" পর্যায়ে সম্পন্ন এবং জিতেছেন "+common_locale.p(d,"numTrophies",0,"bn",{"one":"a trophy","other":common_locale.n(d,"numTrophies")+" trophies"})+"।"},
