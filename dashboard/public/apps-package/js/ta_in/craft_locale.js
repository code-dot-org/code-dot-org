...
"blockIf":function(d){return "இருந்தால்"},
"blockIfLavaAhead":function(d){return "எரிமலைக்குழம்பு முன்னாடி இருந்தால்"},
"blockMoveForward":function(d){return "முன்னோக்கி நகர்த்த"},
...
"blockTurnLeft":function(d){return "இடதுபுறம் திரும்பவும்"},
"blockTurnRight":function(d){return "வலதுபுறம் திரும்பவும்"},
"blockTypeBedrock":function(d){return "bedrock"},
"blockTypeBricks":function(d){return "bricks"},
"blockTypeClay":function(d){return "களிமண்"},
"blockTypeClayHardened":function(d){return "இருகப்பட்ட களிமண்"},
...
"blockTypeEmpty":function(d){return "காலி"},
"blockTypeFarmlandWet":function(d){return "விளைநிலம்"},
"blockTypeGlass":function(d){return "கண்ணாடி"},
"blockTypeGrass":function(d){return "புல்"},
"blockTypeGravel":function(d){return "ஜல்லி"},
"blockTypeLava":function(d){return "எரிமலைக்குழம்பு"},
...
"blockTypeSand":function(d){return "மண்"},
"blockTypeSandstone":function(d){return "sandstone"},
"blockTypeStone":function(d){return "கல்"},
"blockTypeTnt":function(d){return "tnt"},
"blockTypeTree":function(d){return "மரம்"},
"blockTypeWater":function(d){return "நீர்"},
"blockTypeWool":function(d){return "கம்பளி"},
"blockWhileXAheadAhead":function(d){return "ahead"},
"blockWhileXAheadDo":function(d){return "செய்க"},
...
"tooManyBlocksFail":function(d){return "Puzzle "+craft_locale.v(d,"puzzleNumber")+" completed. Congratulations! It is also possible to complete it with "+craft_locale.p(d,"numBlocks",0,"ta",{"one":"1 block","other":craft_locale.n(d,"numBlocks")+" blocks"})+"."}};