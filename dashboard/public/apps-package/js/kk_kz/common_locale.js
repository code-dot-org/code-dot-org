...
"finalStageTrophies":function(d){return "Құттықтаймыз! Сіз соңғы кезңді аяқтадыңыз және "+common_locale.p(d,"numTrophies",0,"en",{"one":"a trophy","other":common_locale.n(d,"numTrophies")+" trophies"})+". ұтып алдыңыз."},
...
"resetProgram":function(d){return "Ысыру"},
...
"savedToGallery":function(d){return "Галереяда сақталы!"},
