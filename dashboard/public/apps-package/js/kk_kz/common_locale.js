...
"copy":function(d){return "Көшіру"},
"defaultTwitterText":function(d){return "Жазған кодымды тексеру"},
...
"dropletBlock_addOperator_description":function(d){return "екі санды қосыңыз"},
"dropletBlock_addOperator_signatureOverride":function(d){return "Операторды қосу"},
...
"finalStage":function(d){return "Құттықтаймыз! Сіз соңғы басқатырғышты шештіңіз."},
"finalStageTrophies":function(d){return "Құттықтаймыз! Сіз соңғы бас қатырғышты аяқтадыңыз және "+common_locale.p(d,"numTrophies",0,"en",{"one":"жүлде","other":common_locale.n(d,"numTrophies")+" жүлделер"})+" ұтып алдыңыз."},
...
"hintPrompt":function(d){return "Көмек керек пе?"},
"hintRequest":function(d){return "Кеңесті көру:"},
"hintReviewTitle":function(d){return "Кеңестеріңізді қараңыз"},
"hintSelectInstructions":function(d){return "Нұсқаулықтар және ескі кеңестер"},
"hintSelectNewHint":function(d){return "Жаңа кеңестерді алу"},
...
"saveToGallery":function(d){return "Сақтау"},
"savedToGallery":function(d){return "Сақталды"},
"score":function(d){return "ұпай"},
"sendToPhone":function(d){return "Телефонға жіберу"},
...
"unsubmit":function(d){return "Жібермеу"},
