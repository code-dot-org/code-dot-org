...
"dropletBlock_randomNumber_max_param0":function(d){return "최대"},
...
"dropletBlock_randomNumber_min_max_param0":function(d){return "최소"},
"dropletBlock_randomNumber_min_max_param0_description":function(d){return "The minimum number returned"},
"dropletBlock_randomNumber_min_max_param1":function(d){return "최대"},
...
"emptyTopLevelBlock":function(d){return "실행할 블록이 없습니다. 당신은 "+common_locale.v(d,"topLevelBlockName")+" 에 블록을 연결해야 합니다."},
...
"keepPlaying":function(d){return "계속 실행"},
...
"readonlyWorkspaceHeader":function(d){return "다음만 보기: "},
