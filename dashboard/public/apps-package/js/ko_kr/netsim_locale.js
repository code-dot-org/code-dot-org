...
"bitCounter":function(d){return appLocale.v(d,"x")+"/"+appLocale.v(d,"y")+" 비트"},
...
"numBitsPerPacket":function(d){return "패킷 당 "+appLocale.v(d,"x")+" 비트"},
"numBitsPerChunk":function(d){return "청크 당 "+appLocale.v(d,"numBits")+" 비트"},
...
"routerX":function(d){return "라우터 "+appLocale.v(d,"x")},
