...
"emptyExampleBlockErrorMsg":function(d){return common_locale.v(d,"functionName")+" 함수에 대해 적어도 한 가지 예시가 필요합니다. 각 예시마다 호출과 응답이 있어야 합니다."},
...
"exampleErrorMessage":function(d){return "함수 "+common_locale.v(d,"functionName")+" 에는 하나 혹은 그 이상의 수정이 필요한 예시가 있다. 그것들이 당신의 정의와 일치하는지 확인하고 질문에 답하세요."},
"examplesFailedOnClose":function(d){return "하나 혹은 더 많은 수의 당신의 예가 당신의 정의에 맞지 않습니다. 닫기 전에 당신의 예를 확인하세요."},
...
"unnamedFunction":function(d){return "이름이 없는 변수나 함수가 있습니다. 모든 것에 설명적인 이름을 주는 것을 잊지 마세요."},
