...
"nestedForSameVariable":function(d){return "이중 혹은 그 이상 중첩된 루프 안에서 같은 변수를 사용하고 있습니다. 무한 루프에 빠지지 않도록 각각 다른 변수 이름을 사용하세요."},
...
"submitYourProject":function(d){return "프로젝트를 제출하세요."},
"submitYourProjectConfirm":function(d){return "프로젝트를 제출한 후에는 편집할 수 없습니다. 정말 제출하시겠습니까?"},
