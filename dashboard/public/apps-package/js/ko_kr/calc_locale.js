...
"failedInput":function(d){return "함수가 모든 값에 대해서 올바른 결과를 리턴하지 않습니다."},
"goal":function(d){return "목표값:"},
"levelIncompleteError":function(d){return "네 계산식은 올바른 답이 아닙니다."},
...
"wrongInput":function(d){return "잘못된 값을 가지고 함수를 호출하였습니다."},
