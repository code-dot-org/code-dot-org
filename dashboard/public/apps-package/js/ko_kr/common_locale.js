...
"dropletBlock_appendItem_description":function(d){return "아이템을 배열의 마지막에 추가하세요."},
"dropletBlock_appendItem_param0":function(d){return "리스트"},
"dropletBlock_appendItem_param0_description":function(d){return "수정해야 할 배열입니다."},
"dropletBlock_appendItem_param1":function(d){return "item"},
"dropletBlock_appendItem_param1_description":function(d){return "배열의 마지막에 추가할 아이템입니다."},
...
"dropletBlock_button_description":function(d){return "클릭할 수 있는 버튼을 만드세요. 이 버튼은 텍스트가 표시되고, 아이디에 의해 참조될 수 있습니다."},
"dropletBlock_button_param0":function(d){return "buttonId"},
"dropletBlock_button_param0_description":function(d){return "버튼에 대한 고유 식별자. 아이디는 만든 버튼을 참조할 때 사용됩니다. 예를 들어, 이벤트 핸들러를 할당할 때."},
"dropletBlock_button_param1":function(d){return "문장"},
"dropletBlock_button_param1_description":function(d){return "버튼에 표시되는 텍스트."},
...
"dropletBlock_checkbox_param1":function(d){return "체크됨"},
...
"dropletBlock_circle_param0_description":function(d){return "픽셀 단위로 봤을 때 원의 중심의 x좌표."},
"dropletBlock_circle_param1":function(d){return "centerY"},
"dropletBlock_circle_param1_description":function(d){return "픽셀 단위로 봤을 때 원의 중심의 y좌표."},
...
"dropletBlock_clearInterval_param0":function(d){return "간격"},
...
"dropletBlock_console.log_param0":function(d){return "문자"},
...
"dropletBlock_insertItem_param0":function(d){return "리스트"},
"dropletBlock_insertItem_param0_description":function(d){return "수정해야 할 배열입니다."},
...
"dropletBlock_onEvent_param1":function(d){return "종류"},
...
"dropletBlock_penColor_param0":function(d){return "색깔"},
...
"dropletBlock_penColour_param0":function(d){return "색깔"},
...
"dropletBlock_penRGB_param0":function(d){return "빨강"},
...
"dropletBlock_penRGB_param1":function(d){return "초록"},
...
"dropletBlock_penRGB_param2":function(d){return "파랑"},
...
"dropletBlock_removeItem_param0":function(d){return "리스트"},
"dropletBlock_removeItem_param0_description":function(d){return "수정해야 할 배열입니다."},
...
"dropletBlock_setAlpha_param3":function(d){return "알파 값"},
...
"dropletBlock_setBlue_param3":function(d){return "파랑색 값"},
...
"dropletBlock_setChecked_param1":function(d){return "체크됨"},
"dropletBlock_setFillColor_description":function(d){return "Set the fill color for the active canvas"},
"dropletBlock_setFillColor_param0":function(d){return "색깔"},
...
"dropletBlock_setGreen_param3":function(d){return "초록색 값"},
...
"dropletBlock_setInterval_param0":function(d){return "함수"},
"dropletBlock_setInterval_param0_description":function(d){return "A function to execute."},
"dropletBlock_setInterval_param1":function(d){return "밀리초"},
...
"dropletBlock_setRGB_param6":function(d){return "알파"},
...
"dropletBlock_setRed_param3":function(d){return "빨간색 값"},
...
"dropletBlock_setStrokeColor_param0":function(d){return "색깔"},
...
"dropletBlock_setTimeout_param0":function(d){return "함수"},
"dropletBlock_setTimeout_param0_description":function(d){return "A function to execute."},
"dropletBlock_setTimeout_param1":function(d){return "밀리초"},
"dropletBlock_setTimeout_param1_description":function(d){return "함수를 실행하기 전에 쓰는 밀리초입니다."},
...
"dropletBlock_startWebRequest_param1":function(d){return "함수"},
...
"dropletBlock_substring_param0":function(d){return "시작"},
"dropletBlock_substring_param0_description":function(d){return "The position to start the extraction."},
"dropletBlock_substring_param1":function(d){return "끝"},
...
"dropletBlock_textLabel_param1_description":function(d){return "레이블의 표시 값입니다."},
