...
"dropletBlock_comment_description":function(d){return "일부 코드의 설명을 작성합니다"},
"dropletBlock_comment_signatureOverride":function(d){return "댓글"},
...
"dropletBlock_randomNumber_description":function(d){return "최소값과 최대값을 포함한 범위에서 임의의 수를 하나 리턴합니다."},
...
"levelIncompleteError":function(d){return "필요한 블록들을 모두 사용했지만, 정확한 방법은 아닙니다."},
...
"recommendedBlockContextualHintTitle":function(d){return "퍼즐을 풀기 위해서 이것 처럼 블록을 사용해보세요."},
...
"tooFewBlocksMsg":function(d){return "퍼즐을 해결하기 위해 필요한 블록 종류는 모두 사용했지만, 이런 종류의 블록들을 더 사용해 보세요."},
