...
"moveSpriteN":function(d){return "캐릭터 움직이기 "+appLocale.v(d,"spriteIndex")},
...
"projectileAnna":function(d){return "안나"},
"projectileElsa":function(d){return "엘사"},
"projectileHiro":function(d){return "히로"},
"projectileBaymax":function(d){return "베이맥스"},
"projectileRapunzel":function(d){return "라푼젤"},
...
"saySpriteN":function(d){return "케릭터 "+appLocale.v(d,"spriteIndex")+" 가 말 함"},
...
"setSpriteN":function(d){return "캐릭터 설정 "+appLocale.v(d,"spriteIndex")},
...
"throwSpriteN":function(d){return "케릭터 "+appLocale.v(d,"spriteIndex")+" 던지기"},
"throwTooltip":function(d){return "지정한 케릭터에서 물건을 던집니다."},
"vanish":function(d){return "삭제하기"},
"vanishActorN":function(d){return "케릭터 "+appLocale.v(d,"spriteIndex")+" 삭제하기"},
...
"whenSpriteClickedN":function(d){return "케릭터 "+appLocale.v(d,"spriteIndex")+" 가 클릭되면"},
"whenSpriteClickedTooltip":function(d){return "케릭터가 클릭되면 아래의 동작을 실행합니다."},
"whenSpriteCollidedN":function(d){return "캐릭터가 "+appLocale.v(d,"spriteIndex")+"에 닿으면"},
...
"whenSpriteCollidedWithN":function(d){return "케릭터가 "+appLocale.v(d,"spriteIndex")+"에 닿으면"},
