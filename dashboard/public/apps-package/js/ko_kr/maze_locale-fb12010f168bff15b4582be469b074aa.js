...
"insufficientHoney":function(d){return "정확한 블럭들을 모두 사용했지만, 필요한 양의 꿀을 만들지 못했습니다."},
"insufficientNectar":function(d){return "정확한 블럭들을 모두 사용했지만, 필요한 양의 꽃꿀을 모으지 못했습니다."},
"make":function(d){return "만들기"},
"moveBackward":function(d){return "뒤로 이동하기"},
