...
"launchBall":function(d){return "pilota berria jaurti"},
"launchBallTooltip":function(d){return "Jokuan pilota jaurti."},
...
"setBackgroundHardcourt":function(d){return "Ezarri zelai gogor eszenatokia"},
"setBackgroundRetro":function(d){return "Ezarri retro eszenatokia"},
"setBackgroundTooltip":function(d){return "Atzeko irudia ezartzen du"},
"setBallRandom":function(d){return "ezarri ausazko pilota"},
"setBallHardcourt":function(d){return "ezarri retro pilota"},
...
"setPaddleHardcourt":function(d){return "ezarri zelai gogorreko erraketa"},
...
"shareBounceTwitter":function(d){return "Nik sortutako errebote jokoa begiratu. Nik bakarrik idatzi dut @codeorg-ekin"},
...
"whenBallInGoalTooltip":function(d){return "Pilota atean sartzerakoan ondorengo argibideak burutu itzazu."},
"whenBallMissesPaddle":function(d){return "Pilotak erraketa galtzen duenean"},
"whenBallMissesPaddleTooltip":function(d){return "Exekutatu beheko ekintzak pilota batek erraketa galtzen duenean."},
...
"whenPaddleCollidedTooltip":function(d){return "Exekutatu hurrengo ekintzak pilotak putzu bat ukitzerakoan."},
...
"whenWallCollided":function(d){return "Pilotak pareta jotzen duenean"},
"whenWallCollidedTooltip":function(d){return "Exekutatu hurrengo ekintzak pilotak horma bat ukitzerakoan."},
