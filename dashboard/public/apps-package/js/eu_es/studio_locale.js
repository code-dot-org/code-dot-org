...
"itemMan":function(d){return "gizona"},
"itemPilot":function(d){return "pilotua"},
"itemPig":function(d){return "txerria"},
"itemBird":function(d){return "txoria"},
"itemMouse":function(d){return "sagua"},
"itemRoo":function(d){return "roo"},
"itemSpider":function(d){return "armiarma"},
...
"setBackgroundForest":function(d){return "ezarri basoaren atzekoplanoa"},
"setBackgroundSnow":function(d){return "ezarri elurraren atzeko planoa"},
"setBackgroundShip":function(d){return "ezarri itsaontziaren atzeko planoa"},
...
"setSpriteBot1":function(d){return "bot1era"},
"setSpriteBot2":function(d){return "bot2ra"},
...
"whenTouchItem":function(d){return "pertsonaia ikutzen denean"},
"whenTouchItemTooltip":function(d){return "Beheko keintzak exekutatu aktoreak pertsonai bat ikutzen duenean."},
"whenTouchWall":function(d){return "oztopoa ikutzean"},
"whenTouchWallTooltip":function(d){return "Beheko ekintzak exekutatu aktoreak oztopo bat ikutzen duenean."},
