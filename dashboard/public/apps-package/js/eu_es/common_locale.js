...
"nextLevelTrophies":function(d){return "Zorionak! "+common_locale.v(d,"puzzleNumber")+". ariketa osatu duzu eta "+common_locale.p(d,"numTrophies",0,"eu",{"one":"garaikur bat","other":common_locale.n(d,"numTrophies")+" garaikur"})+" irabazi dituzu."},
...
"runTooltip":function(d){return "Lan eremuko blokeek definitutako programa hasi."},
