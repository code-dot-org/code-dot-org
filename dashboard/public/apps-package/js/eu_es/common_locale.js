...
"clearPuzzleConfirm":function(d){return "Honek puzzlea berrezarriko du hasierako egoerara eta sortu edo kargatutako bloke guztiak ezabatuko ditu."},
...
"completedWithoutRecommendedBlock":function(d){return "Zorionak! "+common_locale.v(d,"puzzleNumber")+" puzlea osatu duzu. (Baina bloke ezberdin bat erabili zenezakeen kode indartsuago lortzeko.)"},
...
"dropletBlock_mathRandom_description":function(d){return "Ausazko zenbaki bat itzultzen du 0tik (barne) hasita baina 1 kanpoan utziz (exklusiboa)"},
...
"runtimeErrorMsg":function(d){return "Zure programak ez du behar bezala funtzionatu. Mesedez "+common_locale.v(d,"lineNumber")+" lerroa ezabatu eta saiatu berriro."},
...
"unsubmitYourProject":function(d){return "Zure proiektua kendu"},
"unsubmitYourProjectConfirm":function(d){return "Zure proiektua kenduz bidalitako data berrabiaraziko da. Ziur kendu behar duzula?"},
"subtitle":function(d){return "programazio ingurune bisuala"},
"syntaxErrorMsg":function(d){return "Zure programak tipografia errorea dauka. Mesedez ezabatu "+common_locale.v(d,"lineNumber")+" eta saiatu berriro ere."},
...
"tryBlocksBelowFeedback":function(d){return "Saiatu azpiko kodeetako bat erabiltzen:"},
