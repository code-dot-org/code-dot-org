...
"saySpriteN":function(d){return "aktor "+appLocale.v(d,"spriteIndex")+" sabihin"},
...
"scoreText":function(d){return "Puntos: "+appLocale.v(d,"playerScore")},
...
"stopSpriteN":function(d){return "itigil ang aktor  "+appLocale.v(d,"spriteIndex")},
"stopTooltip":function(d){return "Itigil ang ginagawa ng aktor."},
"throwSprite":function(d){return "itapon"},
"throwSpriteN":function(d){return "aktor  "+appLocale.v(d,"spriteIndex")+" hagis"},
"throwTooltip":function(d){return "Itatapon ang isang projectile mula sa tinukoy na aktor ."},
"vanish":function(d){return "mawala"},
"vanishActorN":function(d){return "mawala ang aktor  "+appLocale.v(d,"spriteIndex")},
...
"whenSpriteClickedN":function(d){return "kapag ang artista  "+appLocale.v(d,"spriteIndex")+" na click"},
"whenSpriteClickedTooltip":function(d){return "Ipatupad ang mga aksyon sa ibaba kapag ang isang artista ay na-click."},
"whenSpriteCollidedN":function(d){return "kapag ang artista  "+appLocale.v(d,"spriteIndex")},
...
"whenSpriteCollidedWithN":function(d){return "nahawakan ang aktor  "+appLocale.v(d,"spriteIndex")},
