...
"offsetBlockTitle":function(d){return "eltolás (x, y, kép)"},
"rectangleBlockTitle":function(d){return "téglalap (szélesség, magasság, stílus, szín)"},
"reinfFeedbackMsg":function(d){return "Az \"Újrapróbálom\" gombra kattintva a rajzod szerkeszthető."},
"rotateImageBlockTitle":function(d){return "forgatás (fok,kép)"},
"scaleImageBlockTitle":function(d){return "skála (mérték)"},
"squareBlockTitle":function(d){return "négyzet (méret, stílus, szín)"},
"starBlockTitle":function(d){return "csillag (sugár, stílus, szín)"},
"radialStarBlockTitle":function(d){return "radiális-csillag (pontok, belső, külső, stílus, szín)"},
"polygonBlockTitle":function(d){return "polygon (sides, length, style, color)"},
"stringAppendBlockTitle":function(d){return "szöveg-összefűzés (első, második)"},
"stringLengthBlockTitle":function(d){return "szöveg hossz (szöveg)"},
"textBlockTitle":function(d){return "szöveg (szöveg, méret, szín)"},
"triangleBlockTitle":function(d){return "háromszög (méret, stílus, szín)"},
"underlayBlockTitle":function(d){return "aljzat (alsó, felső)"},
"outline":function(d){return "körvonal"},
