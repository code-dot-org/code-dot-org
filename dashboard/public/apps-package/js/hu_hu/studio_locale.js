...
"stopSpriteN":function(d){return appLocale.v(d,"spriteIndex")+". szereplő álljon meg"},
...
"whenSpriteClickedN":function(d){return "ha "+appLocale.v(d,"spriteIndex")+". szereplőre kattint"},
"whenSpriteClickedTooltip":function(d){return "Hajtsd végre az alábbi műveleteket, ha egy szereplőre kattintanak."},
"whenSpriteCollidedN":function(d){return "ha "+appLocale.v(d,"spriteIndex")+". szereplő"},
...
"whenSpriteCollidedWithN":function(d){return "megérinti "+appLocale.v(d,"spriteIndex")+". szereplőt"},
