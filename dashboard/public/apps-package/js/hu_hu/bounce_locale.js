...
"makeYourOwn":function(d){return "Készíts saját labda pattogtató játékot"},
...
"scoreText":function(d){return "Pontszám: "+appLocale.v(d,"playerScore")+": "+appLocale.v(d,"opponentScore")},
...
"setPaddleSpeedRandom":function(d){return "Az ütő sebessége: random"},
...
"shareBounceTwitter":function(d){return "Próbáld ki milyen labda pattogtató játékot készítettem. Magam programoztam a code.org weboladon."},
...
"whenPaddleCollided":function(d){return "Ha a labda eltalálja az ásót"},
...
"whenUp":function(d){return "Ha a felfelé nyíl"},
"whenUpTooltip":function(d){return "Végrehajtja az alábbi parancsokat, ha a felfelé nyíl le van nyomva."},
"whenWallCollided":function(d){return "Amikor a labda nekimegy a falnak"},
