...
"playSoundPoint":function(d){return "játssz le mutató hangot"},
...
"setBackgroundUnderwater":function(d){return "Jelenet kiválasztása: Vízalatti"},
...
"setGapHeightTooltip":function(d){return "Az akadályban levő rés magasságának  beállítása"},
...
"setPlayerBatman":function(d){return "játékos típusa: Denevér ember"},
...
"shareFlappyTwitter":function(d){return "Nézd meg ezt a Flappy Bird játékot csináltam. Én magam írtam a @codeorg oldalon."},
...
"soundSplash":function(d){return "fröcskölés"},
"soundLaser":function(d){return "lézer"},
"speedRandom":function(d){return "Véletlenszerű sebesség beállítása"},
"speedVerySlow":function(d){return "Nagyon alacsony sebesség beállítása"},
"speedSlow":function(d){return "Alacsony sebesség beállítása"},
...
"whenClick":function(d){return "Klikkelésre"},
"whenClickTooltip":function(d){return "Kattintáskor a lenti műveleteteket hajtsd végre."},
"whenCollideGround":function(d){return "ha becsapódik a talajba"},
"whenCollideGroundTooltip":function(d){return "Hajtsd végre a lenti műveleteteket, ha Flappy becsapódik a talajba."},
"whenCollideObstacle":function(d){return "ha akadálynak ütközik"},
"whenCollideObstacleTooltip":function(d){return "Végrehajtja a lenti utasítást, ha Flappy beleütközik egy akadályba."},
"whenEnterObstacle":function(d){return "ha átjut egy akadályon"},
"whenEnterObstacleTooltip":function(d){return "Hajtsd végre a lenti műveleteket, ha Flappy átmegy egy akadályon."},
