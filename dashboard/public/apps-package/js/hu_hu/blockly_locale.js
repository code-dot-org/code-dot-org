...
Blockly.Msg.COLOUR_RGB_TITLE = "színezés ezzel:";
Blockly.Msg.COLOUR_RGB_TOOLTIP = "Szín létrehozása megadott mennyiségű piros, zöld és kék hozzáadásával.  Minden értéknek 0 és 100 között kell lennie.";
Blockly.Msg.CONFIRM_DELETE_FUNCTION_MESSAGE = "Figyelem! Biztosan törölni akarod ezt: %1?";
Blockly.Msg.CONTRACT_EDITOR_HEADER = "Terv";
...
Blockly.Msg.DEFINE_HEADER_DEFINITION = "Meghatározás";
Blockly.Msg.DEFINE_FUNCTION_DEFINE = "Meghatározás";
Blockly.Msg.DEFINE_FUNCTION_FOR_EXAMPLE = "Definiáld az alábbi funkciót és próbáld újra.";
Blockly.Msg.DELETE = "Törlés";
Blockly.Msg.DELETE_BLOCK = "Blokk törlése";
Blockly.Msg.DELETE_PARAMETER = "Paraméter eltávolítása...";
Blockly.Msg.DELETE_PARAMETER_TITLE = "Ezzel törlöd az összes '%1' paraméter előfordulást. Biztos vagy benne?";
...
Blockly.Msg.FUNCTION_NAME_LABEL = "A függvény neve:";
Blockly.Msg.FUNCTION_DESCRIPTION_LABEL = "Mit csinálna a függvény?";
Blockly.Msg.FUNCTION_PARAMETERS_LABEL = "Milyen paramétereket fogad a függvényed?";
Blockly.Msg.FUNCTION_HEADER = "Függvény";
Blockly.Msg.FUNCTIONAL_CREATE = "Új blokk";
Blockly.Msg.FUNCTIONAL_EDIT = "szerkeszt";
Blockly.Msg.FUNCTIONAL_NAME_LABEL = "Név";
Blockly.Msg.FUNCTIONAL_TYPE_LABEL = "Válassz típust...";
Blockly.Msg.FUNCTIONAL_DESCRIPTION_LABEL = "Leírás";
Blockly.Msg.FUNCTIONAL_DOMAIN_LABEL = "Tartomány";
Blockly.Msg.FUNCTIONAL_PROCEDURE_DEFINE_TOOLTIP = "Egy funkcionális metódus meghatározása";
Blockly.Msg.FUNCTIONAL_RANGE_LABEL = "Tartomány";
Blockly.Msg.FUNCTIONAL_VARIABLE_CREATE = "Változó létrehozása";
Blockly.Msg.FUNCTIONAL_VARIABLE_HEADER = "Változó";
Blockly.Msg.FUNCTIONAL_VARIABLE_TYPE = "Típus";
Blockly.Msg.HELP = "Segítség";
Blockly.Msg.INLINE_INPUTS = "Belső kapcsolatok";
Blockly.Msg.KEEP = "Megtart";
...
Blockly.Msg.LOGIC_TERNARY_IF_FALSE = "ha hamis";
Blockly.Msg.LOGIC_TERNARY_IF_TRUE = "ha igaz";
Blockly.Msg.LOGIC_TERNARY_TOOLTIP = "Kiértékeli a \"teszt\" kifejezést. Ha az eredmény igaz visszatér az \"érték, ha igaz\" értékkel, különben az \"érték, ha hamis\" értékkel.";
Blockly.Msg.MATH_ADDITION_SYMBOL = "+";
Blockly.Msg.MATH_ARITHMETIC_HELPURL = "http://en.wikipedia.org/wiki/Arithmetic";
Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_ADD = "A két szám összegét adja vissza.";
...
Blockly.Msg.MATH_CONSTANT_TOOLTIP = "Ismert matematikai állandó: π (3.141…), e (2.718…), φ (1.618…), gyök(2) (1.414…), gyök(½) (0.707…), vagy ∞ (végtelen).";
...
Blockly.Msg.PROCEDURES_DEFRETURN_TOOLTIP = "Egy egykimenetű függvényt hoz létre.";
...
Blockly.Msg.RENAME_PARAMETER = "Paraméter átnevezése...";
Blockly.Msg.RENAME_PARAMETER_TITLE = "Az összes '%1' paraméter átnevezése erre:";
