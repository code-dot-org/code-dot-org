...
"makeProjectileTooltip":function(d){return "Lad projektilet, der netop traf, forsvinde eller rikochetterer."},
...
"moveDistanceTooltip":function(d){return "Flyt en spiller til specificeret afstand og retning."},
...
"projectileDuck":function(d){return "duk"},
...
"saySpriteChoices_1":function(d){return "Hej!"},
"saySpriteChoices_2":function(d){return "Hvordan går det?"},
"saySpriteChoices_3":function(d){return "Det er sjovt..."},
...
"setSpriteEmotionAngry":function(d){return "til vred"},
...
"setSpriteRandom":function(d){return "til et vilkårlgt billede"},
...
"setSpriteSpeedTooltip":function(d){return "Sætter spillerhastigheden"},
...
"startSetValue":function(d){return "start (rakethøjde-funktion)"},
