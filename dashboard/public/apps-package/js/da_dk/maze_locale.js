...
"insufficientNectar":function(d){return "Du bruger alle de rigtige blokke, men du har brug at indsamle den rigtige mængde af nektar."},
"make":function(d){return "lav"},
"moveBackward":function(d){return "flyt bagud"},
"moveEastTooltip":function(d){return "Flyt mig én plads øst."},
"moveForward":function(d){return "flyt fremad"},
"moveForwardTooltip":function(d){return "Flyt mig en plads frem."},
"moveNorthTooltip":function(d){return "Flyt mig én plads nord."},
"moveSouthTooltip":function(d){return "Flyt mig én plads syd."},
"moveTooltip":function(d){return "Flyt mig én plads fremad/bagud"},
"moveWestTooltip":function(d){return "Flytte mig vest én plads."},
