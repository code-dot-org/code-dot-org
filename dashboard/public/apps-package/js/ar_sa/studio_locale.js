...
"hello":function(d){return "مرحبا"},
"helloWorld":function(d){return "مرحباً بالعالم!"},
"incrementPlayerScore":function(d){return "عدد النقاط"},
"makeProjectileDisappear":function(d){return "تختفي"},
"makeProjectileBounce":function(d){return "إرتداد"},
"makeProjectileBlueFireball":function(d){return "إصنع كرة ملتهلة زرقاء"},
"makeProjectilePurpleFireball":function(d){return "إصنع كرة ملتهلة أرجوانية"},
"makeProjectileRedFireball":function(d){return "إصنع كرة ملتهلة حمراء"},
"makeProjectileYellowHearts":function(d){return "إصنع قلوب صفراء"},
"makeProjectilePurpleHearts":function(d){return "إصنع قلوب أرجوانية"},
...
"projectileAnna":function(d){return "انا"},
"projectileElsa":function(d){return "إلزا"},
