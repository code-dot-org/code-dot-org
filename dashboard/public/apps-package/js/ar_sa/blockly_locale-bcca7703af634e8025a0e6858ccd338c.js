...
Blockly.Msg.ADD_PARAMETER = "أضف معامل";
Blockly.Msg.CHANGE_VALUE_TITLE = "تغيير قيمة:";
Blockly.Msg.CLOSE = "أغلق";
...
Blockly.Msg.COLOUR_BLEND_TOOLTIP = "قم بدمج لونين ببعضهما البعض بنسبة (0.0 - 1.0).";
...
Blockly.Msg.COLOUR_RANDOM_TOOLTIP = "اختر لونا بشكل عشوائي.";
...
Blockly.Msg.COLOUR_RGB_TOOLTIP = "أنشئ لون مع القيمة المحددة من اللون الأحمر والأخضر والأزرق.  يجب أن تكون كافة القيم بين 0 و 100.";
Blockly.Msg.CONTRACT_EDITOR_HEADER = "خطوات التصميم";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_HELPURL = "https://code.google.com/p/blockly/wiki/Loops#Loop_Termination_Blocks";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_OPERATOR_BREAK = "اخرج من التكرار";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_OPERATOR_CONTINUE = "استمر مع التكرار التالي من الحلقة";
...
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_WARNING = "تحذير: يمكن استخدام هذه القطعة فقط داخل الحلقة.";
...
Blockly.Msg.CONTROLS_FOREACH_TOOLTIP = "لكل عنصر في قائمة ما، عين المتغير '%1' لهذا العنصر، ومن ثم نفذ بعض الأوامر.";
...
Blockly.Msg.DELETE_PARAMETER_TITLE = "سيؤدي هذا إلى حذف كافة تواجدات العوامل '%1'. هل أنت متأكد؟";
...
Blockly.Msg.EXAMPLE_DESCRIPTION = "يعرف مثال بسلوك متوقع و سلوك فعلي";
...
Blockly.Msg.FUNCTION_CREATE = "أنشئ دالة";
Blockly.Msg.FUNCTION_EDIT = "تعديل";
Blockly.Msg.FUNCTION_NAME_LABEL = "سمي الدالة الخاصة بك:";
Blockly.Msg.FUNCTION_DESCRIPTION_LABEL = "ما الوظيفة المفترض أن تقوم بها الدالة الخاص بك؟";
Blockly.Msg.FUNCTION_PARAMETERS_LABEL = "ما العوامل المفترض أن تحصل عليها الدالة الخاص بك؟";
Blockly.Msg.FUNCTION_HEADER = "دالة";
Blockly.Msg.FUNCTIONAL_CREATE = "قطعة جديدة";
...
Blockly.Msg.FUNCTIONAL_VARIABLE_CREATE = "أنشئ متغير";
...
Blockly.Msg.LISTS_CREATE_EMPTY_TOOLTIP = "تقوم بإرجاع قائمة، طولها 0, لا تحتوي على سجلات بيانات";
Blockly.Msg.LISTS_CREATE_WITH_CONTAINER_TITLE_ADD = "قائمة";
Blockly.Msg.LISTS_CREATE_WITH_CONTAINER_TOOLTIP = "أضف, إزل, أو أعد ترتيب المقاطع لإعادة تكوين قطعة القائمة.";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_FIRST = "يزيل ويرجع العنصر الأول في القائمة.";
...
Blockly.Msg.LISTS_GET_SUBLIST_START_FIRST = "احصل على قائمة فرعية من البداية";
Blockly.Msg.LISTS_GET_SUBLIST_START_FROM_END = "احصل  على قائمة فرعية من # من النهاية";
...
Blockly.Msg.LISTS_INDEX_OF_FIRST = "ابحث  على التواجد الأول للعنصر";
Blockly.Msg.LISTS_INDEX_OF_HELPURL = "https://code.google.com/p/blockly/wiki/Lists#Getting_Items_from_a_List";
Blockly.Msg.LISTS_INDEX_OF_LAST = "ابحث عن التواجد الأخير للعنصر";
...
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_LAST = "أضف هذا العنصر بنهاية القائمة.";
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_RANDOM = "يقوم بأدراج العنصر عشوائياً في القائمة.";
...
Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_MULTIPLY = "يرجع حاصل ضرب رقمين.";
...
Blockly.Msg.MATH_CONSTRAIN_TITLE = "مقيد %1 منخفض %2 مرتفع %3";
...
Blockly.Msg.MATH_ONLIST_TOOLTIP_MIN = "يرجع أصغر عدد في القائمة.";
Blockly.Msg.MATH_ONLIST_TOOLTIP_MODE = "يرجع قائمة من العناصر الاكثر شيوعاً في القائمة.";
...
Blockly.Msg.MATH_RANDOM_FLOAT_TOOLTIP = "يرجع كسر عشوائي بين 0.0 (ضمنياً) و 1.0 (خارجيا).";
...
Blockly.Msg.MATH_SINGLE_TOOLTIP_EXP = "يرجع  e مرفوع  لأس الرقم.";
Blockly.Msg.MATH_SINGLE_TOOLTIP_LN = "يرجع اللوغاريتم الطبيعي لرقم.";
Blockly.Msg.MATH_SINGLE_TOOLTIP_LOG10 = "يرجع لوغاريتم الأساس 10  لعدد ";
Blockly.Msg.MATH_SINGLE_TOOLTIP_NEG = "يرجع معكوس العدد.";
...
Blockly.Msg.MATH_TRIG_TOOLTIP_COS = "يرجع جيب التمام لدرجة (ليس زواية نصف قطرية).";
Blockly.Msg.MATH_TRIG_TOOLTIP_SIN = "يرجع جيب التمام لدرجة (ليس زواية نصف قطرية).";
Blockly.Msg.MATH_TRIG_TOOLTIP_TAN = "يرجع الظل لدرجة (ليس دائرة نصف قطرية).";
...
Blockly.Msg.PROCEDURES_DEFRETURN_TOOLTIP = "انشئ دالة مع مخرجات.";
...
Blockly.Msg.PROCEDURES_IFRETURN_TOOLTIP = "إذا كانت القيمة صحيحة ، اذن قم بارجاع القيمة الثانية.";
...
Blockly.Msg.TEXT_APPEND_TOOLTIP = "اضف جزءا من النص إلى متغير '%1'.";
...
Blockly.Msg.TEXT_GET_SUBSTRING_START_FROM_END = "الحصول على سلسلة حروف فرعية من الحرف # من النهاية";
...
Blockly.Msg.TEXT_JOIN_TOOLTIP = "أنشئ جزء من النص بربط أي عدد من العناصر ببعضها البعض.";
...
Blockly.Msg.TEXT_TRIM_TOOLTIP = "يرجع نسخة من النص مع الفراغات المحذوفة من احد او كلا أطرافه.";
Blockly.Msg.VARIABLES_DEFAULT_NAME = "عنصر";
Blockly.Msg.VARIABLES_GET_CREATE_SET = "انشئ 'تعيين %1'";
