...
"blockDestroyBlock":function(d){return "تدمير كتلة"},
"blockIf":function(d){return "إذا كان"},
"blockIfLavaAhead":function(d){return "إذا الحمم البركانية امامك"},
"blockMoveForward":function(d){return "تحريك إلى الأمام"},
"blockPlaceTorch":function(d){return "ضع مشعل"},
...
"blockTillSoil":function(d){return "حتى التربة"},
...
"blockTypeClayHardened":function(d){return "تقوية الطين"},
...
"blockTypeTnt":function(d){return "تي أن تي"},
