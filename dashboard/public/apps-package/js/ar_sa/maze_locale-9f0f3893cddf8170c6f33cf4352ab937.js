...
"insufficientHoney":function(d){return "أنت تستخدم جميع المربعات البرمجية الصحيحة، لكنك بحاجة إلى إنتاج الكمية الصحيحة من العسل."},
"insufficientNectar":function(d){return "أنت تستخدم جميع المربعات البرمجية الصحيحة، لكنك بحاجة إلى جمع الكمية الصحيحة من الرحيق."},
