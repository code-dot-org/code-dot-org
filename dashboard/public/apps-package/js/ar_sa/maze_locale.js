...
"didNotCollectEverything":function(d){return "تأكد من أنك لا تترك أي الرحيق أو العسل وراء!"},
...
"insufficientHoney":function(d){return "انت بحاجة لصنع الكمية الصحيحة من العسل. ahtajo al nahl."},
"insufficientNectar":function(d){return "كنت بحاجة لجمع الحق في المبلغ من الرحيق."},
