...
"completedWithoutRecommendedBlock":function(d){return "تهانينا! لقد أكملت اللغز رقم"+common_locale.v(d,"puzzleNumber")+" (و لكن يمكنك استخدام مكعب اخر حتي يكون الكود الخاص بك أقوى)"},
"continue":function(d){return "الاستمرار"},
"copy":function(d){return "نسخة"},
