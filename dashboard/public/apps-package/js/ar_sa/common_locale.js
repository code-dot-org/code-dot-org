...
"dropletBlock_comment_description":function(d){return "اكتب وصفاً لكود برمجي"},
...
"dropletBlock_randomNumber_description":function(d){return "إرجاع رقم عشوائي في مجموعة مغلقة من الحد الأدنى إلى الحد الأقصى."},
...
"recommendedBlockContextualHintTitle":function(d){return "حاول استخدام كتلة مثل هذا لحل اللغز."},
...
"savedToGallery":function(d){return "تم حفظ"},
