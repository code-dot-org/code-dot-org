...
"syntaxErrorMsg":function(d){return "برنامجك حامل خطأ مطبعي. الرجاء إزالة خط "+common_locale.v(d,"lineNumber")+" والمحاولة مرة أخرى."},
...
"tooFewBlocksMsg":function(d){return "لقد استخدمت جميع أنواع المربعات البرمجية اللازمة ولكن حاول أن تستخدم مزيد منها لإكمال هذا اللغز."},
