...
Blockly.Msg.LISTS_LENGTH_TITLE = "lengden av %1";
...
Blockly.Msg.LISTS_SET_INDEX_INSERT = "sett inn på";
...
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_EQ = "Returnerer sann hvis de angitte verdiene er like hverandre.";
...
Blockly.Msg.MATH_CONSTANT_TOOLTIP = "Returner en av konstantene π (3.141…), e (2.718…), φ (1.618…), sqrt(2) (1.414…), sqrt(½) (0.707…), eller ∞ (uendelig).";
Blockly.Msg.MATH_CONSTRAIN_HELPURL = "http://en.wikipedia.org/wiki/Clamping_%28graphics%29";
Blockly.Msg.MATH_CONSTRAIN_TITLE = "tving %1 til å være minst %2 og max %3";
...
Blockly.Msg.MATH_ROUND_TOOLTIP = "Avrund et tall oppover eller nedover.";
...
Blockly.Msg.PROCEDURES_DEFNORETURN_TOOLTIP = "Oppretter en funksjon som ikke returnerer noe.";
...
Blockly.Msg.PROCEDURES_DEFRETURN_TOOLTIP = "Oppretter en funksjon som returnerer noe.";
...
Blockly.Msg.SAVE_AND_CLOSE = "Lagre og Lukk";
...
Blockly.Msg.TEXT_CREATE_JOIN_TITLE_JOIN = "Bli med";
...
Blockly.Msg.TEXT_INDEXOF_TOOLTIP = "Returnerer posisjonen for første/siste forekomsten av den første teksten i den andre teksten.  Returnerer 0 hvis teksten ikke blir funnet.";
