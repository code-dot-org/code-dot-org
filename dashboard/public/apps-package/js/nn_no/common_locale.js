...
"finalStageTrophies":function(d){return "Gratulerer! Du har fullført siste nivå og vunnet "+common_locale.p(d,"numTrophies",0,"en",{"one":"en pokal","other":common_locale.n(d,"numTrophies")+" pokaler"})+"."},
...
"nextLevelTrophies":function(d){return "Gratulerer! Du har fullført oppgave "+common_locale.v(d,"puzzleNumber")+" og vunnet "+common_locale.p(d,"numTrophies",0,"en",{"one":"en pokal","other":common_locale.n(d,"numTrophies")+" pokaler"})+"."},
"nextPuzzle":function(d){return "Next Puzzle"},
"nextStage":function(d){return "Gratulerer! Du fullførte "+common_locale.v(d,"stageName")+"."},
"nextStageTrophies":function(d){return "Gratulerer! Du har fullført "+common_locale.v(d,"stageName")+" og vunnet "+common_locale.p(d,"numTrophies",0,"en",{"one":"a trophy","other":common_locale.n(d,"numTrophies")+" trophies"})+"."},
"numBlocksNeeded":function(d){return "Gratulerer! Du har fullført oppgave "+common_locale.v(d,"puzzleNumber")+". (Men, du kunne ha brukt kun "+common_locale.p(d,"numBlocks",0,"en",{"one":"1 blokk","other":common_locale.n(d,"numBlocks")+" blokker"})+".)"},
"numLinesOfCodeWritten":function(d){return "Du har akkurat skrevet "+common_locale.p(d,"numLines",0,"en",{"one":"1 linje","other":common_locale.n(d,"numLines")+" linjer"})+" med kode!"},
...
"totalNumLinesOfCodeWritten":function(d){return "Totalt: "+common_locale.p(d,"numLines",0,"en",{"one":"1 linje","other":common_locale.n(d,"numLines")+" linjer"})+" med kode."},
