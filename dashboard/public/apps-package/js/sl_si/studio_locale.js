...
"calloutClickEvents":function(d){return "Klikni na glavo dogodka za ogled blokov funkcij dogodka."},
"calloutUseArrowButtons":function(d){return "Pritisnite te gumbe ali puščice na tipkovnici za zagon več dogodkov"},
"calloutUseArrowButtonsAutoSteer":function(d){return "Skrili smo kodo, ki ste jo napisali, za premikanje pa lahko še vedno uporabljate puščice"},
"calloutMoveRightRunButton":function(d){return "Dodajte dodatni ukaz premikDesno v svojo kodo. Nato kliknite tukaj za zagon"},
"calloutBlocklyMoveRightRunButton":function(d){return "Dodaj drugi ukaz \"premik desno\" v svojo kodo. Nato klikni tukaj za zagon"},
"calloutShowCodeToggle":function(d){return "Klikni tukaj za preklop med načinom blokov in načinom besedila"},
"calloutShowCodeCanToggle":function(d){return "Tukaj kliknite za preklop nazaj na besedilni način"},
"calloutShowPlaceGoUpHere":function(d){return "Tukaj nastavite ukaz pojdiGor za premik gor"},
"calloutShowPlaySound":function(d){return "To je tvoja igra, zato zdaj izberiše zvoke. Poskusi s padajočim menijem za izbor različnih zvokov."},
"calloutInstructions":function(d){return "Ne veš kaj narediti? Klikni na navodila za ponovni ogled"},
...
"catCommands":function(d){return "Ukazi"},
...
"tapOrClickToPlay":function(d){return "Pritisni ali klikni za začetek"},
"tapOrClickToReset":function(d){return "Hitro se dotakni (\"tapni\") ali klikni, če želite ponastaviti"},
...
"dropletBlock_addCharacter_param0":function(d){return "Vrsta"},
...
"dropletBlock_goRight_description":function(d){return "Premakne droida na desno."},
"dropletBlock_goUp_description":function(d){return "Premakne droida gor."},
...
"dropletBlock_moveSlow_param0":function(d){return "Vrsta"},
...
"dropletBlock_moveNormal_param0":function(d){return "Vrsta"},
...
"dropletBlock_moveFast_param0":function(d){return "Vrsta"},
...
"dropletBlock_playSound_param0":function(d){return "zvok"},
...
"dropletBlock_setDroidSpeed_description":function(d){return "Nastavi droidovo hitrost."},
"dropletBlock_setDroidSpeed_param0":function(d){return "hitrost"},
"dropletBlock_setDroidSpeed_param0_description":function(d){return "Vrednost hitrosti (\"naključno\", \"počasno\", \"normalno\" ali \"hitro)"},
...
"dropletBlock_setToChase_param0":function(d){return "Vrsta"},
...
"dropletBlock_setToFlee_param0":function(d){return "Vrsta"},
...
"dropletBlock_setToRoam_param0":function(d){return "Vrsta"},
...
"dropletBlock_setToStop_param0":function(d){return "Vrsta"},
...
"dropletBlock_endGame_description":function(d){return "Konec igre."},
"dropletBlock_endGame_param0":function(d){return "Vrsta"},
...
"playlab_lastLevel_continueText":function(d){return "Končano"},
...
"loseMessage":function(d){return "Izgubil si!"},
...
"makeProjectileBanana":function(d){return "Ustvari banano"},
"makeProjectileDodgeball":function(d){return "make dodgeball"},
"makeProjectileDonkey":function(d){return "Ustvari osla"},
...
"makeProjectileIAProjectile4":function(d){return "Ustvari snežinko"},
