...
"rectangleBlockTitle":function(d){return "pravokotnik (širina, višina, slog, barva)"},
"reinfFeedbackMsg":function(d){return "Lahko pritisnete gumb \"Znova\", če želite spremeniti risbo."},
"rotateImageBlockTitle":function(d){return "zasukaj (stopinj, slika)"},
"scaleImageBlockTitle":function(d){return "povečaj (faktor)"},
"squareBlockTitle":function(d){return "kvadrat (velikost, slog, barva)"},
"starBlockTitle":function(d){return "zvezda (polmer, slog, barva)"},
"radialStarBlockTitle":function(d){return "žarkovna-zvezda (točke, notranji, zunanji, slog, barva)"},
"polygonBlockTitle":function(d){return "polygon (sides, length, style, color)"},
"stringAppendBlockTitle":function(d){return "združi niza (prvi, drugi)"},
"stringLengthBlockTitle":function(d){return "dolžina niza (string)"},
"textBlockTitle":function(d){return "besedilo (string, velikost, barva)"},
"triangleBlockTitle":function(d){return "trikotnik (velikost, slog, barva)"},
