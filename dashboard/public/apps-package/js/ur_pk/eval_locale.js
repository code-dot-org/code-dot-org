...
"scaleImageBlockTitle":function(d){return "پیمانہ (عنصر)"},
"squareBlockTitle":function(d){return "مربع (سائز، سٹائل، رنگ)"},
"starBlockTitle":function(d){return "ستارہ (رداس، سٹائل، رنگ)"},
"radialStarBlockTitle":function(d){return "شعاعی ستارہ (نکات، داخلی، خارجی، سٹائل، رنگ)"},
"polygonBlockTitle":function(d){return "polygon (sides, length, style, color)"},
"stringAppendBlockTitle":function(d){return "سٹرنگ ملانا (پہلی، دوسری)"},
