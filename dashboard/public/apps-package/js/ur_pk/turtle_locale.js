...
"catMath":function(d){return "میتھ"},
"catProcedures":function(d){return "Functions"},
"catTurtle":function(d){return "ایکشنز"},
"catVariables":function(d){return "ویری-ایبلز"},
"catLogic":function(d){return "لاجک"},
...
"jumpWestTooltip":function(d){return "یہ کوئی بھی نشانات چھوڑے بغیر آرٹسٹ کو مغرب کی جانب موو کرتا ہے۔"},
