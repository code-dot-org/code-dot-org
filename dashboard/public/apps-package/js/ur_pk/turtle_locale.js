...
"createSnowflakeSquare":function(d){return "اسکوائر ٹائپ کا ایک سنوفلیک بنائیں"},
"createSnowflakeParallelogram":function(d){return "پیرالیلوگرام ٹائپ کا ایک سنوفلیک بنائیں"},
"createSnowflakeLine":function(d){return "لائن ٹائپ کا ایک سنوفلیک بنائیں"},
"createSnowflakeSpiral":function(d){return "سپائیرل ٹائپ کا ایک سنوفلیک بنائیں"},
"createSnowflakeFlower":function(d){return "فلاور ٹائپ کا ایک سنوفلیک بنائیں"},
"createSnowflakeFractal":function(d){return "فریکٹل ٹائپ کا ایک سنوفلیک بنائیں"},
"createSnowflakeRandom":function(d){return "رینڈم ٹائپ کا ایک سنوفلیک بنائیں"},
"createASnowflakeBranch":function(d){return "ایک سنوفلیک برانچ بنائیں"},
...
"moveForward":function(d){return "سامنے چلیں"},
"moveForwardTooltip":function(d){return "یہ آرٹسٹ کو سامنے کی طرف چلاتا ہے۔"},
