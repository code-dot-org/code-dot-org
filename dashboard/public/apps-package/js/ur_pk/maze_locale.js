...
"atFlower":function(d){return "پھول پر"},
"avoidCowAndRemove":function(d){return "گائے سے بچیں اور 1 ہٹائیں"},
"continue":function(d){return "جاری رکھیے"},
"dig":function(d){return "1 ہٹائیں"},
"digTooltip":function(d){return "مٹی کا 1 یونٹ ہٹائیں"},
...
"fill":function(d){return "1 بھریں"},
...
"get":function(d){return ".Hasil kerna"},
"heightParameter":function(d){return "height"},
"holePresent":function(d){return "there is a hole"},
"honey":function(d){return "شہد بنایں"},
"honeyAvailable":function(d){return "شہد"},
...
"ifPathAhead":function(d){return "اگر آگے راستہ ہے"},
...
"make":function(d){return "بنایں"},
"moveBackward":function(d){return "پیچھے چلیں"},
"moveEastTooltip":function(d){return "Move me east one space."},
"moveForward":function(d){return "آگے چلیں"},
