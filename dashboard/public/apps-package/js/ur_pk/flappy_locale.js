...
"endGame":function(d){return "کھیل ختم"},
"endGameTooltip":function(d){return "کھیل ختم کرتا ہے ۔"},
"finalLevel":function(d){return "مبارک ہو! آپ نے آخری مرحلہ مکمل کرلیا۔"},
"flap":function(d){return "پھڑپھڑایں"},
"flapRandom":function(d){return "flap a random amount"},
"flapVerySmall":function(d){return "بھت تھہڑا سھ پھڑپھڑایں"},
"flapSmall":function(d){return "تھوڑا سہ پھڑپھڑایں"},
"flapNormal":function(d){return "عام مقدار پھڑپھڑایں"},
"flapLarge":function(d){return "زیادہ پھڑپھڑایں"},
"flapVeryLarge":function(d){return "بھت زیادہ پھڑپھڑایں"},
"flapTooltip":function(d){return "فلیپی کو اوپر اڑایں۔"},
"flappySpecificFail":function(d){return "آپ کوڈ کو اچھا لگتا ہے--یہ ہر ایک کلک کے ساتھ پھڑپھڑاے گا ۔ لیکن آپ کو ہدف تک پنچنے کے لیے کئی بار کلک کرنا پڑے گا ۔"},
"incrementPlayerScore":function(d){return "ایک پوانٹ بنایں"},
...
"playSoundWing":function(d){return "پر کی آواز چلایں"},
...
"playSoundTooltip":function(d){return "منتخب آواز چلائیں."},
...
"soundRandom":function(d){return "بےترتیب"},
...
"soundWing":function(d){return "پر"},
...
"whenRunButtonClick":function(d){return "جب کھیل شروع ہو"},
