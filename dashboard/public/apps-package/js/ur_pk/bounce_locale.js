...
"playSoundLosePoint":function(d){return "ھارنے کی آاواز چلایں"},
"playSoundLosePoint2":function(d){return "ھارنے کی دوسری آواز چلایں"},
"playSoundRetro":function(d){return "ریترو آواز چلایں"},
"playSoundRubber":function(d){return "ربڑ کی آواز چلایں"},
"playSoundSlap":function(d){return "تھپڑ کی آواز چلایں"},
"playSoundTooltip":function(d){return "منتخب آواز چلائیں."},
"playSoundWinPoint":function(d){return "جیتنے کی آواز چلایں"},
...
"setPaddleSpeedVerySlow":function(d){return "پیڈل کی بھت آھستھ رفتار رکھیں"},
"setPaddleSpeedSlow":function(d){return "پعڈل کی رفتار آھستھ رکھیں"},
"setPaddleSpeedNormal":function(d){return "set normal paddle speed"},
"setPaddleSpeedFast":function(d){return "پیڈل کی رفتار تیز کریں"},
"setPaddleSpeedVeryFast":function(d){return "پیڈل کی رفتار بہت تیژ کریں"},
"setPaddleSpeedTooltip":function(d){return "پیڈل کی رفتار کا تعین کرتا ہے"},
"shareBounceTwitter":function(d){return "میری بنای ھوی Bounce گیم چیکھیے۔ میں نے اسے کھد لکھا ھے @codeorg کی مدد سے۔"},
...
"whenGameStarts":function(d){return "جب کھیل شروع ہو"},
