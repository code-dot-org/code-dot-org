...
Blockly.Msg.COLOUR_RGB_TOOLTIP = "Skapa en färg med angiven mängd rött, grönt och blått.  Alla värden måste vara mellan 0 och 100.";
Blockly.Msg.CONFIRM_DELETE_FUNCTION_MESSAGE = "Varning! Är du säker på att du vill ta bort %1?";
...
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_OPERATOR_CONTINUE = "fortsätt med nästa upprepning av loop";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_BREAK = "Bryt ut ur den omslutande loopen.";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_CONTINUE = "Hoppa över resten av den här loopen och fortsätt med nästa upprepning.";
...
Blockly.Msg.CONTROLS_IF_ELSEIF_TOOLTIP = "Lägg till ett villkor till \"om\"-blocket.";
Blockly.Msg.CONTROLS_IF_ELSE_TOOLTIP = "Lägg till ett sista villkor som täcker alla övriga alternativ för \"om\"-blocket.";
Blockly.Msg.CONTROLS_IF_HELPURL = "http://code.google.com/p/blockly/wiki/If_Then";
Blockly.Msg.CONTROLS_IF_IF_TOOLTIP = "Lägg till, ta bort eller ändra ordningen för sektioner för att ändra inställningar för blocket \"om\".";
...
Blockly.Msg.CONTROLS_IF_TOOLTIP_2 = "Om värdet är sant, utför det första blocket av kommandon. Annars utför det andra blocket av kommandon.";
...
Blockly.Msg.DEFINE_FUNCTION_FOR_EXAMPLE = "Definiera funktionen nedan och försök igen.";
Blockly.Msg.DELETE = "Ta bort";
Blockly.Msg.DELETE_BLOCK = "Radera block";
Blockly.Msg.DELETE_PARAMETER = "Ta bort parametern...";
Blockly.Msg.DELETE_PARAMETER_TITLE = "Detta kommer att radera alla '%1' parameterns förekomster. Är du säker?";
...
Blockly.Msg.FUNCTIONAL_PROCEDURE_DEFINE_TOOLTIP = "Definiera en funktionell metod";
...
Blockly.Msg.LISTS_CREATE_WITH_CONTAINER_TOOLTIP = "Lägg till, ta bort eller ändra ordningen på elementen för att göra om det här \"om\"-blocket.";
Blockly.Msg.LISTS_CREATE_WITH_INPUT_WITH = "skapa lista med";
Blockly.Msg.LISTS_CREATE_WITH_ITEM_TOOLTIP = "Lägg till ett element till listan.";
Blockly.Msg.LISTS_CREATE_WITH_TOOLTIP = "Skapa en lista med valfritt antal element.";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_FROM_START = "Ger tillbaka elementet på den efterfrågade positionen i en lista. #1 är det första elementet.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_LAST = "Ger tillbaka det sista elementet i en lista.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_RANDOM = "Ger tillbaka ett slumpat element i en lista.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_FIRST = "Tar bort och ger tillbaka det första elementet i en lista.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_FROM_END = "Tar bort och ger tillbaka elementet på den efterfrågade positionen i en lista. #1 är det sista elementet.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_FROM_START = "Tar bort och ger tillbaka elementet på den efterfrågade positionen i en lista. #1 är det första elementet.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_LAST = "Tar bort och ger tillbaka det sista elementet i en lista.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_RANDOM = "Tar bort och ger tillbaka ett slumpat element i en lista.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_REMOVE_FIRST = "Tar bort det första elementet i en lista.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_REMOVE_FROM_END = "Tar bort elementet på den efterfrågade positionen i en lista. #1 är det sista elementet.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_REMOVE_FROM_START = "Tar bort elementet på den efterfrågade positionen i en lista. #1 är det första elementet.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_REMOVE_LAST = "Tar bort det sista elementet i en lista.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_REMOVE_RANDOM = "Tar bort ett slumpat element i en lista.";
...
Blockly.Msg.LISTS_REPEAT_TOOLTIP = "Skapar en lista som innehåller ett valt värde upprepat ett bestämt antal gånger.";
...
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_FIRST = "Infogar objektet i början av en lista.";
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_FROM_END = "Infogar objektet vid en angiven position i en lista. #1 är det sista objektet.";
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_FROM_START = "Infogar elementet vid en angiven position i en lista. #1 är det första elementet.";
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_LAST = "Lägg till objektet i slutet av en lista.";
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_RANDOM = "Infoga objektet på en slumpmässig position i en lista.";
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_SET_FIRST = "Anger det första objektet i en lista.";
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_SET_FROM_END = "Infogar objektet vid en angiven position i en lista. #1 är det sista objektet.";
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_SET_FROM_START = "Infogar elementet vid en angiven position i en lista. #1 är det sista elementet.";
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_SET_LAST = "Anger det sista elementet i en lista.";
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_SET_RANDOM = "Sätter in ett slumpat element i en lista.";
...
Blockly.Msg.LOGIC_NEGATE_TOOLTIP = "Ger tillbaka sant om inmatningen är falsk. Ger tillbaka falskt om inmatningen är sann.";
...
Blockly.Msg.MATH_CONSTANT_TOOLTIP = "Ger tillbaka en av de vanliga konstanterna:  π (3.141…), e (2.718…), φ (1.618…), sqrt(2) (1.414…), sqrt(½) (0.707…) eller ∞ (oändligt).";
...
Blockly.Msg.MATH_CONSTRAIN_TOOLTIP = "Begränsa ett tal till att mellan de angivna gränsvärdena (inklusive).";
...
Blockly.Msg.MATH_SINGLE_TOOLTIP_ABS = "Ger tillbaka det absoluta värdet av ett tal.";
Blockly.Msg.MATH_SINGLE_TOOLTIP_EXP = "Ger tillbaka e upphöjt till specifikt tal.";
Blockly.Msg.MATH_SINGLE_TOOLTIP_LN = "Ger tillbaka den naturliga logaritmen av ett tal.";
Blockly.Msg.MATH_SINGLE_TOOLTIP_LOG10 = "Ger tillbaka 10-logaritmen av ett tal.";
Blockly.Msg.MATH_SINGLE_TOOLTIP_NEG = "Ger tillbaka negationen av ett tal.";
Blockly.Msg.MATH_SINGLE_TOOLTIP_POW10 = "Ger tillbaka 10 upphöjt till ett specifikt tal.";
...
Blockly.Msg.PROCEDURES_CALLNORETURN_TOOLTIP = "Kör den av användaren definierade funktionen \"%1\".";
Blockly.Msg.PROCEDURES_CALLRETURN_HELPURL = "http://sv.wikipedia.org/wiki/Funktion_%28programmering%29";
Blockly.Msg.PROCEDURES_CALLRETURN_TOOLTIP = "Kör den av användaren definierade funktionen \"%1\" och använd dess resultat.";
...
Blockly.Msg.PROCEDURES_DEFNORETURN_PROCEDURE = "gör något";
Blockly.Msg.PROCEDURES_DEFNORETURN_TITLE = "till";
Blockly.Msg.PROCEDURES_DEFNORETURN_TOOLTIP = "Skapar en funktion utan resultat.";
...
Blockly.Msg.TEXT_CREATE_JOIN_TOOLTIP = "Lägg till, ta bort eller ändra ordningen på sektionerna för att göra om det här textblocket.";
...
Blockly.Msg.TEXT_JOIN_TOOLTIP = "Skapa en text genom att sammanfoga ett valfritt antal element.";
