...
Blockly.Msg.CONTRACT_EDITOR_HEADER = "Designa recept";
...
Blockly.Msg.LISTS_INDEX_OF_FIRST = "hitta första förekomsten av element";
...
Blockly.Msg.LISTS_INDEX_OF_TOOLTIP = "Ger tillbaka den första/sista förekomsten av elementet i listan.  Ger tillbaka 0 om elementet inte hittas.";
...
Blockly.Msg.MATH_SINGLE_TOOLTIP_EXP = "Ger tillbaka e upphöjt till ett tal.";
...
Blockly.Msg.MATH_SINGLE_TOOLTIP_NEG = "Ger tillbaka det negativa talet.";
Blockly.Msg.MATH_SINGLE_TOOLTIP_POW10 = "Ger tillbaka 10 upphöjt till ett tal.";
...
Blockly.Msg.SAVE_AND_CLOSE = "Spara och stäng";
...
Blockly.Msg.TEXT_CREATE_JOIN_TOOLTIP = "Lägg till, ta bort eller ändra ordningen på sektionerna för att göra om det här \"lista\"-blocket.";
...
Blockly.Msg.TEXT_JOIN_TOOLTIP = "Skapa en textbit genom att sammanfoga ett valfritt antal element.";
