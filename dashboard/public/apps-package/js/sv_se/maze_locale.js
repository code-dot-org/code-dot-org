...
"digTooltip":function(d){return "ta bort 1 lera"},
...
"ifOnlyFlowerTooltip":function(d){return "Om det finns en blomma åt det angivna hållet så utför vissa åtgärder."},
...
"moveEastTooltip":function(d){return "Flytta mig österut ett steg."},
...
"moveWestTooltip":function(d){return "Flytta mig västerut ett steg."},
...
"repeatCarefullyError":function(d){return "För att lösa detta, tänka noga på mönstret av två flytt och en sväng  i blocket \"upprepa\".  Det är okej att ha en extra sväng i slutet."},
