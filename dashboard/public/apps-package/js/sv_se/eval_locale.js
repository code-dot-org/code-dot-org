...
"displayBlockTitle":function(d){return "utvärdera"},
"ellipseBlockTitle":function(d){return "ellips (bredd, höjd, stil, färg)"},
"extraTopBlocks":function(d){return "Du har okopplade block. Menade du att bifoga dessa till \"värdera\" blocket?"},
...
"stringAppendBlockTitle":function(d){return "sträng-lägg (första, andra)"},
"stringLengthBlockTitle":function(d){return "stränglängd (sträng)"},
"textBlockTitle":function(d){return "text (sträng, storlek, färg)"},
"triangleBlockTitle":function(d){return "triangel (storlek, stil, färg)"},
