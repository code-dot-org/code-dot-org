...
"addItems1":function(d){return "добавьте 1 элемент типа"},
"addItems2":function(d){return "добавьте 2 элемента типа"},
"addItems3":function(d){return "добавьте 3 элемента типа"},
"addItems5":function(d){return "добавьте 5 элементов типа"},
"addItems10":function(d){return "добавьте 10 элементов типа"},
"addItemsRandom":function(d){return "добавьте случайные элементы типа"},
"addItemsTooltip":function(d){return "Добавьте элементы к сцене."},
