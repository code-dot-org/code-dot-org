...
Blockly.Msg.COLOUR_RGB_TOOLTIP = "Создать цвет с заданным количеством красного, зеленого и синего. Все значения должны быть в диапазоне от 0 до 100.";
Blockly.Msg.CONFIRM_DELETE_FUNCTION_MESSAGE = "Warning! Are you sure you want to delete %1?";
Blockly.Msg.CONTRACT_EDITOR_HEADER = "Создание рецепта";
...
Blockly.Msg.FUNCTION_NAME_LABEL = "Имя функции:";
...
Blockly.Msg.MATH_RANDOM_INT_TOOLTIP = "Возвращает случайное целое число между двумя заданными пределами (включая и их).";
...
Blockly.Msg.PROCEDURES_DEFNORETURN_PROCEDURE = "Делать что-нибудь";
Blockly.Msg.PROCEDURES_DEFNORETURN_TITLE = "к";
...
Blockly.Msg.PROCEDURES_DEF_DUPLICATE_WARNING = "Предупреждение: эта процедура имеет повторяющиеся параметры.";
...
Blockly.Msg.PROCEDURES_IFRETURN_WARNING = "Предупреждение: Этот блок может использоваться только внутри определения процедуры.";
