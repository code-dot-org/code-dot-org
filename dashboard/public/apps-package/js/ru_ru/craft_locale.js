...
"blockTypeDirtCoarse":function(d){return "загрязнённая земля"},
...
"blockTypeLogSpruce":function(d){return "еловое бревно"},
"blockTypeOreCoal":function(d){return "уголь"},
...
"blockTypeOreLapis":function(d){return "лазуритовый блок"},
...
"blockTypePlanksSpruce":function(d){return "еловые доски"},
"blockTypeRail":function(d){return "рельса"},
...
"level12FailureMessage":function(d){return "Убедитесь, что добыли 3 \"redstone\" блока. Это будет значить, что вы научились из вашего дома использовать оператор «если», чтобы избежать падения в лаву."},
