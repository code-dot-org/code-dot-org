...
"dropletBlock_setBotSpeed_param0":function(d){return "скорость"},
...
"whenTouchItem":function(d){return "когда докоснулся до предмета"},
"whenTouchItemTooltip":function(d){return "Execute the actions below when the actor touches an item."},
"whenTouchWall":function(d){return "когда коснулись стены"},
