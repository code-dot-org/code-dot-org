...
"dig":function(d){return "раскидать 1"},
"digTooltip":function(d){return "раскидать 1 кучу земли"},
...
"didNotCollectEverything":function(d){return "Убедитесь, что Вы не оставляете нектар или мед позади!"},
...
"honeycombFullError":function(d){return "В этом улье нет больше места для меда."},
"ifCode":function(d){return "если"},
"ifInRepeatError":function(d){return "Вам нужен блок «если» внутри блока «повторять». Если не получается, попробуйте вернуться на предыдущий уровень , чтобы увидеть, как это работает."},
...
"moveBackward":function(d){return "двигаться назад"},
...
"moveTooltip":function(d){return "Перемести меня на одну клетку вперёд/назад"},
...
"notAtHoneycombError":function(d){return "Мед можно сохранить только в улье."},
...
"uncheckedCloudError":function(d){return "Не забудь проверить все облака, чтобы узнать, есть ли в них цветы или соты."},
