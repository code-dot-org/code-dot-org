...
"bounceBall":function(d){return "мяч отскакивает"},
...
"setBallTooltip":function(d){return "Задать образ шарика"},
...
"setBallSpeedTooltip":function(d){return "Задаёт скорость шарика"},
"setPaddleRandom":function(d){return "задать случайную ракетку"},
"setPaddleHardcourt":function(d){return "задать ракетку с твердым покрытием"},
"setPaddleRetro":function(d){return "задать ракетку с ретро покрытием"},
"setPaddleTooltip":function(d){return "Задаёт изображение ракетки"},
"setPaddleSpeedRandom":function(d){return "задать случайную скорость ракетки"},
"setPaddleSpeedVerySlow":function(d){return "задать очень медленную скорость ракетки"},
"setPaddleSpeedSlow":function(d){return "задать медленную скорость ракетки"},
"setPaddleSpeedNormal":function(d){return "задать нормальную скорость ракетки"},
"setPaddleSpeedFast":function(d){return "задать быструю скорость ракетки"},
"setPaddleSpeedVeryFast":function(d){return "задать очень быструю скорость ракетки"},
"setPaddleSpeedTooltip":function(d){return "Задаёт скорость ракетки"},
"shareBounceTwitter":function(d){return "Зацените созданную мной игру \"Шарики\"! Я написал её с помощью @codeorg"},
...
"whenBallMissesPaddle":function(d){return "когда мяч не попал на платформу"},
"whenBallMissesPaddleTooltip":function(d){return "Выполнить указанные ниже действия, если мяч не попал на платформу."},
