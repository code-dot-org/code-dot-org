...
"missingFunctionError":function(d){return "Вы должны определить функцию "+calc_locale.v(d,"functionName")+"."},
"missingVariableX":function(d){return "В вашем выражении не хватает переменной "+calc_locale.v(d,"var")+"."},
...
"wrongOtherValuesX":function(d){return "Ваше выражение возвращает неправильное значение, если мы поменяем "+calc_locale.v(d,"var")+"."},
