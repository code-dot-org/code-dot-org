...
"playSoundRandom":function(d){return "ixitiyari səsi çal"},
"playSoundBounce":function(d){return "sıçrayış səsini çal"},
"playSoundCrunch":function(d){return "xırçıltı səsini oynat"},
"playSoundDie":function(d){return "məyus səsini çal"},
"playSoundHit":function(d){return "smash səsini çal"},
"playSoundPoint":function(d){return "Point səsini çal"},
"playSoundSwoosh":function(d){return "swoosh səsini çal"},
"playSoundWing":function(d){return "qanad səsini çal"},
"playSoundJet":function(d){return "jet səsini çal"},
