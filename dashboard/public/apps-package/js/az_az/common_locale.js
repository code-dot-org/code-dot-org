...
"designMode":function(d){return "Dizayn elə"},
...
"dropletBlock_comment_description":function(d){return "Kodun təsvirini yaz"},
"dropletBlock_comment_signatureOverride":function(d){return "şərh"},
...
"dropletBlock_mathRandom_signatureOverride":function(d){return "Rəqəm.təsadüfi()"},
...
"dropletBlock_randomNumber_description":function(d){return "Müəyyən bir rəqəm aralığından təsadüfi bir rəqəm seçər və bu rəqəmi minimumdan maksimuma çevirər."},
...
"emptyExampleBlockErrorMsg":function(d){return "Ən azı 2 "+common_locale.v(d,"functionName")+" ehtiyacınız var. Hər nümunənin çalışması və gözlənilən nəticənin olması üçün əmin olun."},
"emptyFunctionBlocksErrorMsg":function(d){return "Funksiya blokunun işləməsi üçün başqa bloklar da qoymalısan."},
"emptyFunctionalBlock":function(d){return "Sizin doldurulamış girişiniz var."},
"emptyTopLevelBlock":function(d){return "Gediş üçün bloklar yoxdur. Sən "+common_locale.v(d,"topLevelBlockName")+" blokuna başqa bloklar əlavə etməlisən."},
"end":function(d){return "son"},
"errorEmptyFunctionBlockModal":function(d){return "Funksiya üçün bloklara ehtiyacın var. \"Keçir\" blokuna bas və blokları yaşıl blokun içinə sürüşdür."},
"errorIncompleteBlockInFunction":function(d){return "Funksiyanın içində əksik blokların qalıb-qalmadığından əmin olmaq üçün \"keçir\" düyməsinə bas."},
"errorParamInputUnattached":function(d){return "İş sahəsində tapılan funksiya blokundakı hər parametr girdisinə bir blok əlavə etməyi unutma."},
"errorQuestionMarksInNumberField":function(d){return "\"???\" əvəzinə bir qiymət yazmağı sınayın."},
"errorRequiredParamsMissing":function(d){return "\"Keçir\" düyməsinə basaraq və lazımi parametrləri əlavə edən funksiyan üçün bir parametr yarat. Yeni parametr blokunu funksiyanın içinə sürüşdür."},
"errorUnusedFunction":function(d){return "Funksiya yaratdın, lakin iş sahəsində işlətmədin! \"Funksiyalar\"-a bas və funksiyanı proqramında işlətdiyinə əmin ol."},
"errorUnusedParam":function(d){return "\"Parametr\" bloku əlavə etdin, lakin bunu işlətmədin. \"Keçir\" düyməsinə basmaqla və parametr blokunu yaşıl blokun içinə yerləşdirməklə parametri işlətdiyindən əmin ol."},
"exampleErrorMessage":function(d){return common_locale.v(d,"functionName")+" funksiyasında bir və ya daha çox nümunədə düzəlişə ehtiyac var. Funksiyanın uzlaşmasından əmin olunu və suala cavab verin."},
"examplesFailedOnClose":function(d){return "Bir və ya daha çox nümunəniz uzlaşmır. Nümunələrinizi bağlamamışdan əvvəl kontrol edin"},
...
"generatedCodeInfo":function(d){return "Dünyanın ən yaxşı universitetləri belə tapmaca ilə kodlaşdırma öyrədir."+common_locale.v(d,"berkeleyLink")+common_locale.v(d,"harvardLink")+"Həmçinin yaxşı incələsəniz, birləşdirdiyiniz bloklar dünyanın ən geniş yayılmış kodlaşdırma dili olan JavaScript dilində də görünür:"},
...
"hintReviewTitle":function(d){return "İpucuna yenidən bax"},
"hintSelectInstructions":function(d){return "Təlimatlar və keçmiş ipucuları"},
"hintSelectNewHint":function(d){return "Yeni ipucu al"},
...
"missingRecommendedBlocksErrorMsg":function(d){return "Yaxınlaşdın. Fərqli bloklardan da istifadə edin."},
"missingRequiredBlocksErrorMsg":function(d){return "Yaxınlaşdın. İşlətməli olduğun bloku hələ işlətməmisən."},
"nestedForSameVariable":function(d){return "2 Və daha çox iç-içə keçən təkrarların içindı eyni dəyişəndən istifadə edirsən. Fərqli dəyişən işlətməklə sonsuz təkrarın qarşısını alın."},
...
"recommendedBlockContextualHintTitle":function(d){return "Tapmacayı həll etmək üçün buna bənzər bloklardan istifadə et."},
...
"sendToPhone":function(d){return "Telefona göndər"},
...
"shareWarningsStoreData":function(d){return "\"CodeStudio\"-da hazırlanmış bu proqramda, bu paylaşım linki vasitəsilə hər-hansı bir insan tərəfindən göstərilə biləcək məlumatlar gizlənmişdir, yəni şəxsi məlumat verməyiniz istənilsə, diqqətli olun."},
...
"stringEquals":function(d){return "sıra=?"},
