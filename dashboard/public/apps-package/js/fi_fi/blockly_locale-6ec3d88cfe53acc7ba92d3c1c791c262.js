...
Blockly.Msg.COLOUR_PICKER_HELPURL = "http://fi.wikipedia.org/wiki/V%C3%A4ri";
...
Blockly.Msg.COLOUR_RGB_TOOLTIP = "Luo väri, jossa on annettu määrä punaista, vihreää ja sinistä. Kaikkien arvojen tulee olla välillä 0-100.";
Blockly.Msg.CONFIRM_DELETE_FUNCTION_MESSAGE = "Warning! Are you sure you want to delete %1?";
Blockly.Msg.CONTRACT_EDITOR_HEADER = "Suunnittele resepti";
...
Blockly.Msg.DEFINE_HEADER_DEFINITION = "Määritelmä";
...
Blockly.Msg.DELETE_PARAMETER_TITLE = "Tämä poistaa kaikki '%1' parametrit. Oletko varma?";
...
Blockly.Msg.EXPECTED = "tulos";
Blockly.Msg.EXTERNAL_INPUTS = "Ulkoiset syötteet";
Blockly.Msg.FUNCTION_CREATE = "Luo funktio";
Blockly.Msg.FUNCTION_EDIT = "muokkaa";
Blockly.Msg.FUNCTION_NAME_LABEL = "Nimeä funktio:";
Blockly.Msg.FUNCTION_DESCRIPTION_LABEL = "Mitä funktiosi on tarkoitus tehdä?";
Blockly.Msg.FUNCTION_PARAMETERS_LABEL = "Mitä parametrejä funktiosi käyttää?";
Blockly.Msg.FUNCTION_HEADER = "Funktio";
Blockly.Msg.FUNCTIONAL_CREATE = "Uusi lohko";
Blockly.Msg.FUNCTIONAL_EDIT = "muokkaa";
Blockly.Msg.FUNCTIONAL_NAME_LABEL = "Nimi";
Blockly.Msg.FUNCTIONAL_TYPE_LABEL = "Valitse laji...";
Blockly.Msg.FUNCTIONAL_DESCRIPTION_LABEL = "Kuvaus";
Blockly.Msg.FUNCTIONAL_DOMAIN_LABEL = "Toimialue";
Blockly.Msg.FUNCTIONAL_PROCEDURE_DEFINE_TOOLTIP = "Määrittele funktionaalinen metodi";
Blockly.Msg.FUNCTIONAL_RANGE_LABEL = "Alue";
Blockly.Msg.FUNCTIONAL_VARIABLE_CREATE = "Luo muuttuja";
Blockly.Msg.FUNCTIONAL_VARIABLE_HEADER = "Muuttuja";
Blockly.Msg.FUNCTIONAL_VARIABLE_TYPE = "Tyyppi";
...
Blockly.Msg.LISTS_LENGTH_INPUT_LENGTH = "Pituus";
...
Blockly.Msg.PROCEDURES_CALLRETURN_TOOLTIP = "Suorittaa käyttäjän määrittelemän funktion '%1' ja käyttää sen tulosta.";
...
Blockly.Msg.PROCEDURES_DEFNORETURN_TOOLTIP = "Luo funktion, jolla ei ole tulosta.";
...
Blockly.Msg.PROCEDURES_DEFRETURN_TITLE = "kun";
Blockly.Msg.PROCEDURES_DEFRETURN_RETURN = "palauta";
Blockly.Msg.PROCEDURES_DEFRETURN_TOOLTIP = "Luo funktion, joka palauttaa tuloksen.";
...
Blockly.Msg.RENAME_PARAMETER = "Uudelleennimeä parametri...";
Blockly.Msg.RENAME_PARAMETER_TITLE = "Uudelleennimeä kaikki '%1' parametrit:";
