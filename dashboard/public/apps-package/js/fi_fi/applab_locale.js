...
"createHtmlBlock":function(d){return "Luo html lohko"},
"createHtmlBlockTooltip":function(d){return "Luo HTML lohkon sovelluksessa."},
...
"reinfFeedbackMsg":function(d){return "Voit painaa \"Yritä uudelleen\"-painiketta jos haluat käynnistää sovelluksesi."},
...
"shareWebappTwitter":function(d){return "Katso tekemäni sovellus. Tein sen itse @codeorg:ssa"},
"shareGame":function(d){return "Jaa sovellus:"},
"stepIn":function(d){return "Astu sisään"},
"stepOver":function(d){return "Astu yli"},
"stepOut":function(d){return "Astu ulos"},
"turnBlack":function(d){return "muuta mustaksi"},
"turnBlackTooltip":function(d){return "Muuttaa näytön mustaksi."},
