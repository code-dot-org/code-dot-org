...
"addPacket":function(d){return "Pakket toevoegen"},
...
"autoDnsUsageMessage":function(d){return "Automatisch DNS-knooppunt\nGebruik: GET hostname [hostname [hostname ...]]"},
...
"buttonCancel":function(d){return "Annuleren"},
"buttonJoin":function(d){return "Join"},
"clear":function(d){return "Leegmaken"},
"collapse":function(d){return "Collapse"},
"connect":function(d){return "Connect"},
"connected":function(d){return "Verbonden"},
...
"logStatus_dropped":function(d){return "Niet bezorgd"},
"logStatus_success":function(d){return "Gelukt"},
"markAsRead":function(d){return "Mark as read"},
"message":function(d){return "Bericht"},
"myDevice":function(d){return "Mijn apparaat"},
"myName":function(d){return "Mijn naam"},
...
"numBitsPerPacket":function(d){return netsim_locale.v(d,"x")+" bits per pakket"},
"numBitsPerChunk":function(d){return netsim_locale.v(d,"numBits")+" bits per segment"},
...
"_of_":function(d){return " van "},
"packet":function(d){return "Pakket"},
"packetInfo":function(d){return "Pakketinformatie"},
...
"receivedMessageLog":function(d){return "Logboek van ontvangen berichten"},
"removePacket":function(d){return "Pakket verwijderen"},
...
"routerTab_bandwidth":function(d){return "Bandbreedte"},
"routerTab_memory":function(d){return "Geheugen"},
"routerTab_stats":function(d){return "Statistieken"},
"routerX":function(d){return "Router "+netsim_locale.v(d,"x")},
"send":function(d){return "Verzenden"},
"sendAMessage":function(d){return "Verzend een bericht"},
"sendBits":function(d){return "Send Bits"},
"sentBitsLog":function(d){return "Sent Bits Log"},
"sentMessageLog":function(d){return "Logboek van verzonden berichten"},
...
"unlimited":function(d){return "Onbeperkt"},
...
"xOfYPackets":function(d){return netsim_locale.v(d,"x")+" van "+netsim_locale.v(d,"y")},
