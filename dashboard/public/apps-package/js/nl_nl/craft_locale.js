...
"reinfFeedbackMsg":function(d){return "Je kunt drukken op \"Blijven spelen\" om terug te gaan naar uw spel."},
"replayButton":function(d){return "Replay"},
"selectChooseButton":function(d){return "Select"},
"tooManyBlocksFail":function(d){return "Puzzel "+craft_locale.v(d,"puzzleNumber")+" voltooid. Gefeliciteerd! Het is ook mogelijk om het te voltooien met "+craft_locale.p(d,"numBlocks",0,"nl",{"one":"1 block","other":craft_locale.n(d,"numBlocks")+" blocks"})+"."}};