...
"blockTypeLogAcacia":function(d){return "blok acaciahout"},
"blockTypeLogBirch":function(d){return "berkenhout"},
"blockTypeLogJungle":function(d){return "oerwoudhout"},
"blockTypeLogOak":function(d){return "blok eikenhout"},
"blockTypeLogSpruce":function(d){return "blok sparrenhout"},
...
"level3FailureMessage":function(d){return "Om wol van beide schapen te verzamelen, Loop naar ieder schaap en gebruik het commando \"scheren\". Vergeet niet om het \"draai\" commando te gebruiken om bij de schapen te komen."},
"level3TooFewBlocksMessage":function(d){return "Probeer meer commando's om wol te verzamelen van beide schapen boom om te hakken. Loop naar ieder schaap en gebruik het \"scheer\" commando."},
