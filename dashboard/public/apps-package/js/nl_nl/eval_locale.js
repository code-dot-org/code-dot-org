...
"badColorStringError":function(d){return "Je gebruikt een ongeldige kleuren tekenreeks: "+eval_locale.v(d,"val")},
"badStyleStringError":function(d){return "Je gebruikt een ongeldige stijl tekenreeks: "+eval_locale.v(d,"val")},
...
"starBlockTitle":function(d){return "ster (radius, stijl, kleur)"},
"radialStarBlockTitle":function(d){return "radiaal-ster (punten, binnen, buiten, stijl, kleur)"},
"polygonBlockTitle":function(d){return "veelhoek (zijden, lengte, stijl, kleur)"},
"stringAppendBlockTitle":function(d){return "tekenreeks-toevoegen (eerste, tweede)"},
"stringLengthBlockTitle":function(d){return "tekenreeks-lengte (tekenreeks)"},
"textBlockTitle":function(d){return "tekst (tekenreeks, grootte, kleur)"},
"triangleBlockTitle":function(d){return "driehoek (grootte, stijl, kleur)"},
"underlayBlockTitle":function(d){return "onderlaag (boven, onder)"},
