...
"endGame":function(d){return "beëinding spel"},
...
"flapNormal":function(d){return "flapper een normale hoeveelheid"},
"flapLarge":function(d){return "flapper een grote hoeveelheid"},
...
"playSoundRandom":function(d){return "willekeurige geluid afspelen"},
...
"scoreText":function(d){return "Punten: "+appLocale.v(d,"playerScore")},
...
"setBackgroundSciFi":function(d){return "science fiction als achtergrond instellen"},
...
"setGround":function(d){return "Kies grond"},
"setGroundRandom":function(d){return "Willekeurig achtergrond instellen"},
"setGroundFlappy":function(d){return "Grond achtergrond instellen"},
"setGroundSciFi":function(d){return "Science fiction achtergrond instellen"},
"setGroundUnderwater":function(d){return "Onderwater achtergrond instellen"},
"setGroundCave":function(d){return "Grot achtergrond instellen"},
"setGroundSanta":function(d){return "Kerstman achtergrond instellen"},
"setGroundLava":function(d){return "Lava achtergrond instellen"},
"setGroundTooltip":function(d){return "Hiermee stelt u de achtergrond afbeelding in"},
...
"setObstacleCave":function(d){return "Een grot als obstakel instellen"},
...
"whenCollideGroundTooltip":function(d){return "Voeren de onderstaande acties uit als Flappy de grond raakt."},
