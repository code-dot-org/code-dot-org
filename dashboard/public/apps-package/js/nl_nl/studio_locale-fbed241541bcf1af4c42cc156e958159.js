...
"addItems1":function(d){return "Voeg 1 item toe van het type"},
"addItems2":function(d){return "voeg 2 items toe van het type"},
"addItems3":function(d){return "voeg 3 items toe van het type"},
"addItems5":function(d){return "voeg 5 items toe van het type"},
"addItems10":function(d){return "voeg 10 items toe van het type"},
"addItemsRandom":function(d){return "Voeg een willekeurig item toe van het type"},
"addItemsTooltip":function(d){return "Voeg items toe aan de scene."},
...
"dropletBlock_setItemSpeed_param1":function(d){return "snelheid"},
...
"dropletBlock_setCharacterSpeed_param0":function(d){return "snelheid"},
