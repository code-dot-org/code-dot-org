...
Blockly.Msg.CONFIRM_DELETE_FUNCTION_MESSAGE = "Pas op! Weet je zeker dat je %1 wilt verwijderen?";
...
Blockly.Msg.DEFINE_FUNCTION_FOR_EXAMPLE = "Definieer de functie hieronder en probeer het opnieuw.";
...
Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_DIVIDE = "Geef het quotiënt van de twee getallen.";
Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_MINUS = "Geeft het verschil van de twee getallen.";
Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_MULTIPLY = "Geef het product van de 2 getallen.";
...
Blockly.Msg.MATH_IS_TOOLTIP = "Controleer of een getal even, oneven, een priemgetal, geheel, positief of negatief is, of deelbaar is door een bepaald getal. Het resultaat is waar of onwaar.";
...
Blockly.Msg.TEXT_CHANGECASE_TOOLTIP = "Geeft een kopie van de tekst met een andere tekstgrootte (hoofd- of kleine letter).";
...
Blockly.Msg.TEXT_PRINT_TOOLTIP = "Toont de opgegeven tekst, het getal of een andere waarde.";
...
Blockly.Msg.TEXT_PROMPT_TYPE_NUMBER = "vraagt de gebruiker om een getal met het bericht";
...
Blockly.Msg.TEXT_TRIM_OPERATOR_RIGHT = "verwijder spaties van de rechterkant";
Blockly.Msg.TEXT_TRIM_TOOLTIP = "Geeft een kopie van de tekst met spaties verwijderd aan 1 of beide kanten.";
