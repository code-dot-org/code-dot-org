...
"branches":function(d){return "afdeling"},
...
"createSnowflakeSquare":function(d){return "maak een sneeuwvlok van het type vierkant"},
"createSnowflakeParallelogram":function(d){return "maak een sneeuwvlok van het type parallelogram"},
"createSnowflakeLine":function(d){return "maak een sneeuwvlok van het type lijn"},
"createSnowflakeSpiral":function(d){return "maak een sneeuwvlok van het type spiraal"},
"createSnowflakeFlower":function(d){return "maak een sneeuwvlok van het type bloem"},
"createSnowflakeFractal":function(d){return "maak een sneeuwvlok van het type fractal"},
"createSnowflakeRandom":function(d){return "maak een willekeurig type sneeuwvlok"},
"createASnowflakeBranch":function(d){return "maak een tak van sneeuwvlokken"},
...
"jumpTooltip":function(d){return "Verplaatst de kunstenaar zonder sporen na te laten."},
"jumpEastTooltip":function(d){return "Beweegt de artiest oost zonder iets achter te laten."},
"jumpNorthTooltip":function(d){return "Beweegt de artiest noord zonder iets achter te laten."},
"jumpSouthTooltip":function(d){return "Beweegt de artiest zuid zonder iets achter te laten."},
"jumpWestTooltip":function(d){return "Beweegt de artiest west zonder iets achter te laten."},
"lengthFeedback":function(d){return "Het is goed behalve de bewegingslengtes."},
...
"moveEastTooltip":function(d){return "Verplaatst de artiest oost."},
"moveForward":function(d){return "beweeg vooruit met"},
"moveForwardTooltip":function(d){return "Beweegt de artiest voorwaarts"},
"moveNorthTooltip":function(d){return "Verplaatst de artiest noord."},
"moveSouthTooltip":function(d){return "Verplaatst de artiest zuid."},
"moveWestTooltip":function(d){return "Verplaatst de artiest west."},
