...
"honeyTooltip":function(d){return "maak honing van nektar"},
...
"ifelseFlowerTooltip":function(d){return "Als er een bloem/bijenkorf is in de gekozen richting staat, voer je het eerste actie blok uit. IOs dat niet het geval, voer dan het tweede blok met acties uit."},
...
"moveEastTooltip":function(d){return "Ga een plek oost."},
"moveForward":function(d){return "beweeg vooruit"},
"moveForwardTooltip":function(d){return "Ga een plek naar voren."},
"moveNorthTooltip":function(d){return "Ga een plek noord."},
"moveSouthTooltip":function(d){return "Ga een plek naar zuid."},
"moveTooltip":function(d){return "Ga een plek vooruit/achteruit"},
"moveWestTooltip":function(d){return "ga een plek west."},
"nectar":function(d){return "haal nektar"},
"nectarRemaining":function(d){return "nectar"},
"nectarTooltip":function(d){return "haal nektar van een bloem"},
...
"repeatCarefullyError":function(d){return "Denk zorgvuldig na over het patroon van twee zetten en één draai voor in het \"herhaal\" blok. Een extra draai aan het einde maakt niet uit."},
...
"uncheckedCloudError":function(d){return "Kijk bij alle wolken als ze bloemen zijn of honingraten."},
...
"word":function(d){return "Vind het woord"},
