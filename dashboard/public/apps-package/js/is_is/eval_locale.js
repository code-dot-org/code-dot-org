...
"badColorStringError":function(d){return "Þú notaðir ógildan streng fyrir lit: "+eval_locale.v(d,"val")},
"badStyleStringError":function(d){return "Þú notaðir ógildan streng fyrir gerð: "+eval_locale.v(d,"val")},
...
"starBlockTitle":function(d){return "stjarna (geisli, gerð, litur)"},
"radialStarBlockTitle":function(d){return "geislastjarna (armar, innri, ytri, gerð, litur)"},
"polygonBlockTitle":function(d){return "fjölhyrningur (hliðar, lengd, gerð, litur)"},
"stringAppendBlockTitle":function(d){return "skeyta-streng (strengur1, strengur2)"},
"stringLengthBlockTitle":function(d){return "lengd-strengs (strengur)"},
"textBlockTitle":function(d){return "texti (strengur, stærð, litur)"},
"triangleBlockTitle":function(d){return "þríhyrningur (stærð, gerð, litur)"},
"underlayBlockTitle":function(d){return "undirlögn (undir, yfir)"},
"outline":function(d){return "útlína"},
"solid":function(d){return "gegnheill"},
...
"wrongBooleanError":function(d){return "Við mat gefa kubbarnir þínir rangt Boole gildi."}};