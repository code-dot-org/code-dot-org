...
"setWireToValue":function(d){return "Stilla vír á "+appLocale.v(d,"value")},
...
"waitingForNodeToConnect":function(d){return "Bíð eftir að "+appLocale.v(d,"node")+" tengist..."},
"workspaceHeader":function(d){return "Internet hermir"},
"xOfYPackets":function(d){return appLocale.v(d,"x")+" af "+appLocale.v(d,"y")},
"xSecondPerPulse":function(d){return appLocale.v(d,"x")+" sekúnda á púls"},
"xSecondsPerPulse":function(d){return appLocale.v(d,"x")+" sekúndur á púls"},
