...
"completedWithoutRecommendedBlock":function(d){return "تبریک میگم! شما پازل "+common_locale.v(d,"puzzleNumber")+" را تمام کرده اید. (اما شما می تواند بلوک مختلف برای کد های قوی تر استفاده کنید.)"},
"continue":function(d){return "ادامه بده"},
"copy":function(d){return "رونوشت‌"},
...
"dropletBlock_randomNumber_param0":function(d){return "حداقل"},
"dropletBlock_randomNumber_param0_description":function(d){return "حداقل تعداد بازگشت"},
"dropletBlock_randomNumber_param1":function(d){return "حداکثر"},
...
"hintSelectNewHint":function(d){return "دریافت راهنمایی جدید"},
...
"saveToGallery":function(d){return "ذخيره"},
"savedToGallery":function(d){return "در گالری ذخیره شد!"},
"score":function(d){return "امتیاز"},
"sendToPhone":function(d){return "ارسال به تلفن"},
...
"unsubmit":function(d){return "ثبت نشده"},
