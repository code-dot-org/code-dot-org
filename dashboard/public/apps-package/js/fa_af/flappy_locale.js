...
"playSoundJingle":function(d){return "پخش صدای جرنگ جرنگ"},
...
"setBackgroundRandom":function(d){return "تعیین صحنه تصادفی"},
...
"setGapVerySmall":function(d){return "تنظیم یک فاصله خیلی کوچک"},
"setGapSmall":function(d){return "تنظیم یک فاصله کوچک"},
"setGapNormal":function(d){return "تنظیم یک فاصله متوسط"},
"setGapLarge":function(d){return "تنظیم یک فاصله بزرگ"},
"setGapVeryLarge":function(d){return "تنظیم یک فاصله خیلی بزرگ"},
"setGapHeightTooltip":function(d){return "فاصله عمودی را در یک مانع تعیین می‌کند"},
"setGravityRandom":function(d){return "تنظیم جاذبه تصادفی"},
"setGravityVeryLow":function(d){return " تنظیم جاذبه به خیلی کم"},
"setGravityLow":function(d){return " تنظیم جاذبه به کم"},
"setGravityNormal":function(d){return " تنظیم جاذبه به معمولی"},
"setGravityHigh":function(d){return " تنظیم جاذبه به زیاد"},
"setGravityVeryHigh":function(d){return " تنظیم جاذبه به خیلی زیاد"},
...
"setGroundFlappy":function(d){return "قراردادن زمینه معمولی"},
...
"setPlayerSuperman":function(d){return "قراردادن مرد شل و ول بعنوان بازیکن"},
...
"setScore":function(d){return "تنظیم امتیاز"},
...
"soundCrash":function(d){return "تصادف"},
...
"speedVerySlow":function(d){return "تعیین سرعت خیلی آهسته"},
"speedSlow":function(d){return "تعیین سرعت آهسته"},
"speedNormal":function(d){return "تنظیم سرعت نرمال"},
"speedFast":function(d){return "تنظیم سرعت سریع"},
