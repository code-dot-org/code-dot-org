...
"addPacket":function(d){return "اضافه کردن بسته"},
...
"ascii":function(d){return "زبان AXCII"},
"autoDnsUsageMessage":function(d){return "Automatic DNS Node\nUsage: GET hostname [hostname [hostname ...]]"},
"binary":function(d){return "دو دویی"},
"bitCounter":function(d){return "بیت های "+netsim_locale.v(d,"x")+"/"+netsim_locale.v(d,"y")},
"bits":function(d){return "بیت"},
"buttonAccept":function(d){return "Accept"},
"buttonCancel":function(d){return "لغو کن"},
"buttonJoin":function(d){return "Join"},
"clear":function(d){return "تمیز"},
"collapse":function(d){return "Collapse"},
"connect":function(d){return "Connect"},
"connected":function(d){return "متصل"},
...
"dnsMode_AUTOMATIC":function(d){return "اتوماتیک"},
"dnsMode_MANUAL":function(d){return "دستی"},
"dnsMode_NONE":function(d){return "هیچکدام"},
"dropdownPickOne":function(d){return "-- PICK ONE --"},
"encoding":function(d){return "کد کردن"},
"expand":function(d){return "Expand"},
"from":function(d){return "از"},
"hex":function(d){return "شانزده"},
"hexadecimal":function(d){return "شانزده شانزدهی"},
"incomingConnectionRequests":function(d){return "Incoming connection requests"},
"infinity":function(d){return "بی نهایت"},
"instructions":function(d){return "دستورالعمل ها"},
...
"message":function(d){return "پیام"},
"myDevice":function(d){return "دستگاه من"},
...
"numBitsPerPacket":function(d){return netsim_locale.v(d,"x")+" بیت در هر بسته"},
...
"_of_":function(d){return " از "},
"packet":function(d){return "بسته"},
"packetInfo":function(d){return "بسته اطلاعات"},
...
"receivedMessageLog":function(d){return "لیست پیام های دریافتی"},
"removePacket":function(d){return "حذف بسته"},
"router":function(d){return "روتر(مسیر یاب)"},
...
"routerX":function(d){return "روتر "+netsim_locale.v(d,"x")},
"send":function(d){return "بفرست"},
"sendAMessage":function(d){return "یک پیام بفرست"},
"sendBits":function(d){return "Send Bits"},
"sentBitsLog":function(d){return "Sent Bits Log"},
"sentMessageLog":function(d){return "لیست پیام های فرستاده شده"},
...
"unlimited":function(d){return "نامحدود"},
"waitingForNodeToConnect":function(d){return "Waiting for "+netsim_locale.v(d,"node")+" to connect..."},
"workspaceHeader":function(d){return "شبیه ساز اینترنت"},
"xOfYPackets":function(d){return netsim_locale.v(d,"x")+" از "+netsim_locale.v(d,"y")},
