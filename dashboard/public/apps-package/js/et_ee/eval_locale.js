...
"rectangleBlockTitle":function(d){return "ristkülik (laius, kõrgus, stiil, värv)"},
"reinfFeedbackMsg":function(d){return "Joonistuse muutmiseks vajuta \"Proovi uuesti\" nuppu."},
"rotateImageBlockTitle":function(d){return "rotate (degrees, image)"},
"scaleImageBlockTitle":function(d){return "scale (factor)"},
"squareBlockTitle":function(d){return "ruut (suurus, stiil, värv)"},
"starBlockTitle":function(d){return "täht (raadius, stiil, värv)"},
"radialStarBlockTitle":function(d){return "radial-star (points, inner, outer, style, color)"},
"polygonBlockTitle":function(d){return "hulknurk (küljed, pikkus, stiil, värv)"},
"stringAppendBlockTitle":function(d){return "string-append (first, second)"},
"stringLengthBlockTitle":function(d){return "stringi-pikkus (string)"},
"textBlockTitle":function(d){return "tekst (string, suurus, värv)"},
"triangleBlockTitle":function(d){return "kolmnurk (suurus, stiil, värv)"},
"underlayBlockTitle":function(d){return "aluskiht (põhi, ülaosa)"},
"outline":function(d){return "äärejoon"},
"solid":function(d){return "ühtlane"},
