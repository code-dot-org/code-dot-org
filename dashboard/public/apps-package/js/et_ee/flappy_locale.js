...
"playSoundHit":function(d){return "mängi kokkupõrke heli"},
...
"playSoundJingle":function(d){return "mängi tilisemis heli"},
...
"setGapHeightTooltip":function(d){return "Määrab vertikaalsed vahed takistustel"},
...
"setPlayerEaster":function(d){return "määra mängija lihavõtte jänkuks"},
"setPlayerBatman":function(d){return "määra mängija Batmaniks"},
"setPlayerSubmarine":function(d){return "määra mängija allveelaevaks"},
"setPlayerUnicorn":function(d){return "määra mängija ükssarvikuks"},
"setPlayerFairy":function(d){return "määra mängija haldjaks"},
"setPlayerSuperman":function(d){return "määra mängija Flappymaniks"},
"setPlayerTurkey":function(d){return "määra mängija kalkuniks"},
"setPlayerTooltip":function(d){return "Määrab mängija pildi"},
"setScore":function(d){return "määra skoor"},
"setScoreTooltip":function(d){return "Määrab mängija skoori"},
"setSpeed":function(d){return "määra kiirus"},
"setSpeedTooltip":function(d){return "Määrab taseme kiiruse"},
"shareFlappyTwitter":function(d){return "Tutvu Flappy mänguga mis ma tegin. Ma kirjutasin selle ise @codeorg -is"},
...
"soundHit":function(d){return "kokkupõrge"},
...
"soundJingle":function(d){return "tilisemine"},
...
"whenClick":function(d){return "kui klikkida"},
"whenClickTooltip":function(d){return "Käivitage tegevused allpool, kui klikkimis sündmus toimub."},
...
"whenCollideObstacleTooltip":function(d){return "Kui Flappy põrkub kokku takistuga, teosta järgmised toimingud."},
