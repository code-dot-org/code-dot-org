...
"ifInRepeatError":function(d){return "Sul on vaja \"if\" blokki \"korda\" bloki sisse. Kui sul on probleeme, siis proovi eelmist tasemet, et näha kuidas see käis."},
...
"ifFlowerTooltip":function(d){return "Kui selles suunas on lill/mesikärg, siis tee mõned toimingud."},
"ifOnlyFlowerTooltip":function(d){return "If there is a flower in the specified direction, then do some actions."},
"ifelseFlowerTooltip":function(d){return "Kui selles suunas on lill/mesikärg, siis tee esimene blokk toiminguid. Vastasel korral tee teine blokk toiminguid."},
"insufficientHoney":function(d){return "Sa kasutad õigeid blokke, kuid valet kogust mett."},
