...
"bitCounter":function(d){return appLocale.v(d,"x")+"/"+appLocale.v(d,"y")+" bitov"},
...
"numBitsPerPacket":function(d){return appLocale.v(d,"x")+" bitov na jeden paket"},
"numBitsPerChunk":function(d){return appLocale.v(d,"numBits")+" bitov v jednom segmente"},
