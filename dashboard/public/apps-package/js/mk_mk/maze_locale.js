...
"avoidCowAndRemove":function(d){return "одбегнија кравата и отстрани"},
"continue":function(d){return "Продолжи"},
"dig":function(d){return "отстрани 1"},
"digTooltip":function(d){return "отстрани 1 дел од нечистотијата"},
...
"fill":function(d){return "потполни 1"},
"fillN":function(d){return "потполни "+maze_locale.v(d,"shovelfuls")},
