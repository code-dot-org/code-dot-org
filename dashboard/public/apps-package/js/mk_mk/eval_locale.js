...
"rectangleBlockTitle":function(d){return "правоаголник (ширина, висина, стил, боја)"},
"reinfFeedbackMsg":function(d){return "Можете да го притиснете \"Обиди се повторно\" копчето за да го уредите вашиот цртеж."},
"rotateImageBlockTitle":function(d){return "ротираат (степени, слика)"},
"scaleImageBlockTitle":function(d){return "скала (фактор)"},
"squareBlockTitle":function(d){return "Коцка (големина, стил, боја)"},
"starBlockTitle":function(d){return "ѕвезда (радиус, стил, боја)"},
...
"stringAppendBlockTitle":function(d){return "Повлечи-додавај (прва, втора)"},
"stringLengthBlockTitle":function(d){return "Повлечи должина (Повлекувај)"},
"textBlockTitle":function(d){return "текст (повлекување, големина, боја)"},
"triangleBlockTitle":function(d){return "триаголник (големина, стил, боја)"},
