...
"flapVerySmall":function(d){return "đập cánh rất nhẹ"},
...
"flapTooltip":function(d){return "Bay Flappy lên."},
...
"playSoundDie":function(d){return "phát âm thanh buồn"},
"playSoundHit":function(d){return "phát âm thanh va đập"},
...
"playSoundJet":function(d){return "phát tiếng máy bay phản lực"},
...
"setBackgroundFlappy":function(d){return "chọn nền Thành phố (ban ngày)"},
"setBackgroundNight":function(d){return "chọn nền Thành phố (ban đêm)"},
