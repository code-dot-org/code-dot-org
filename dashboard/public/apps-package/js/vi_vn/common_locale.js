...
"dropletBlock_comment_description":function(d){return "Viết mô tả của một số mã"},
...
"dropletBlock_randomNumber_description":function(d){return "Trả về một số ngẫy nhiên trong phạm vi từ min đến max."},
...
"nestedForSameVariable":function(d){return "Bạn đang sử dụng cùng một biến trong hai hoặc nhiều vòng lồng nhau. Sử dụng tên biến duy nhất để tránh vòng lặp vô hạn."},
