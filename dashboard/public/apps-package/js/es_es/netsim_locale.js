...
"numBitsPerChunk":function(d){return appLocale.v(d,"numBits")+" bits por trozo"},
...
"routerX":function(d){return "Enrutador "+appLocale.v(d,"x")},
...
"setWireToValue":function(d){return "establecer cable a "+appLocale.v(d,"value")},
...
"waitingForNodeToConnect":function(d){return "Esperando un "+appLocale.v(d,"node")+" para conectar..."},
"workspaceHeader":function(d){return "Simulador de internet"},
"xOfYPackets":function(d){return appLocale.v(d,"x")+" de "+appLocale.v(d,"y")},
"xSecondPerPulse":function(d){return appLocale.v(d,"x")+" segundos por pulso"},
...
"x_Kbps":function(d){return appLocale.v(d,"x")+"Kilobit por segundo"},
...
"x_KBytes":function(d){return appLocale.v(d,"x")+"KiloByte"},
