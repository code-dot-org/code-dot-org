...
"reinfFeedbackMsg":function(d){return "Usted puede presionar el botón \"Seguir jugando\" para volver a jugar su historia."},
...
"saySpriteChoices_1":function(d){return "Hola todo el mundo."},
...
"saySpriteChoices_12":function(d){return "¡Bien!"},
"saySpriteChoices_13":function(d){return "Todo bien."},
"saySpriteChoices_14":function(d){return "Regular."},
...
"saySpriteChoices_23":function(d){return "¡Nos vemos mañana!"},
"saySpriteChoices_24":function(d){return "¡Hasta luego!"},
"saySpriteChoices_25":function(d){return "¡Cuídate!"},
"saySpriteChoices_26":function(d){return "¡Pásalo bien!"},
...
"saySpriteChoices_33":function(d){return "¡Genial!"},
...
"setBackgroundLeafy":function(d){return "establecer fondo de hojas"},
"setBackgroundGrassy":function(d){return "establecer fondo de hierba"},
"setBackgroundFlower":function(d){return "establecer fondo de flores"},
"setBackgroundTile":function(d){return "establecer fondo de azulejos"},
"setBackgroundIcy":function(d){return "establecer fondo de hielo"},
"setBackgroundSnowy":function(d){return "establecer fondo nevado"},
...
"setSpriteEmotionAngry":function(d){return "a un estado de ánimo enojado"},
...
"setSpriteAnna":function(d){return "a una imagen de Anna"},
"setSpriteElsa":function(d){return "a una imagen de Elsa"},
...
"startSetValue":function(d){return "start (función)"},
