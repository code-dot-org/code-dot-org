...
"exampleErrorMessage":function(d){return "La función "+common_locale.v(d,"functionName")+" tiene uno o más ejemplos que necesitan ajuste. Asegúrese de que coincide con su definición y responde a la pregunta."},
"examplesFailedOnClose":function(d){return "Uno o más de tus ejemplos no coinciden con su definición. Compruebe sus ejemplos antes del cierre"},
...
"unnamedFunction":function(d){return "Tiene una variable o función sin nombre. No olvide dar un nombre descriptivo a todo."},
