...
"badColorStringError":function(d){return "Utilizaste una cadena de color no válida: "+eval_locale.v(d,"val")},
"badStyleStringError":function(d){return "Utilizaste una cadena de estilo no válida: "+eval_locale.v(d,"val")},
...
"reinfFeedbackMsg":function(d){return "Puedes presionar el botón \"Seguir jugando\" para editar tu programa."},
...
"triangleBlockTitle":function(d){return "triángulo (tamaño, estilo, color)"},
...
"stringMismatchError":function(d){return "Tienes una cadena con letras mayúsculas y minúsculas errónea."},
"userCodeException":function(d){return "Ocurrió un error mientras se ejecutaba tu código."},
"wrongBooleanError":function(d){return "Tus bloques evalúan al valor booleano equivocado."}};