...
"completedWithoutRecommendedBlock":function(d){return "Apsveicu! Tu izpildiji mīklu nr. "+common_locale.v(d,"puzzleNumber")+".(Bet tu varēji izmantot savādāku bloku, lai stiprāks ir kods.)"},
...
"dropletBlock_randomNumber_param0_description":function(d){return "Minimālais skaitlis ir atgriezies"},
"dropletBlock_randomNumber_param1":function(d){return "maksimālais"},
"dropletBlock_randomNumber_param1_description":function(d){return "Maksimālais skaitlis kas atgriezās"},
...
"hintSelectInstructions":function(d){return "Instrukcijas un veci padomi"},
...
"missingRecommendedBlocksErrorMsg":function(d){return "Ne gluži. Pameiģini izmantot citu bloku kuru tu vel neizmanto."},
"missingRequiredBlocksErrorMsg":function(d){return "Ne gluži. Tev jaizmanto bloks kuru tu vel neesi izmantojis."},
...
"nextPuzzle":function(d){return "Nākamā mīkla"},
...
"readonlyWorkspaceHeader":function(d){return "Skatīt tikai: "},
...
"unsubmitYourProjectConfirm":function(d){return "Neiesniedzot savu projektu, mainīsies iesniegšanas datums, vai tiešām neiesniegt?"},
