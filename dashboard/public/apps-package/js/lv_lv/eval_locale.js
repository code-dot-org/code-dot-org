...
"displayBlockTitle":function(d){return "izpildīt"},
...
"rectangleBlockTitle":function(d){return "četrstūris (platums, augstums, stils, krāsa)"},
"reinfFeedbackMsg":function(d){return "Nospiediet pogu \"Mēģināt vēlreiz\", lai labotu savu zīmējumu."},
"rotateImageBlockTitle":function(d){return "pagriezt (grādi, attēls)"},
"scaleImageBlockTitle":function(d){return "mērogs (koeficients)"},
"squareBlockTitle":function(d){return "kvadrāts (izmērs, stils, krāsa)"},
"starBlockTitle":function(d){return "zvaignze (rādius, stils, krāsa)"},
"radialStarBlockTitle":function(d){return "radiāla zvaigzne (punkti, iekšējā, ārējā, stils, krāsa)"},
"polygonBlockTitle":function(d){return "polygon (sides, length, style, color)"},
"stringAppendBlockTitle":function(d){return "apvienot-virkni(pirmā, otrā)"},
"stringLengthBlockTitle":function(d){return "virknes-garums(virkne)"},
"textBlockTitle":function(d){return "teksts(virkne, izmērs, krāsa)"},
"triangleBlockTitle":function(d){return "trīsstūris(izmērs, stils, krāsa)"},
