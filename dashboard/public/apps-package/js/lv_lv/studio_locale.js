...
"moveSpriteN":function(d){return "pārvietot aktieri "+appLocale.v(d,"spriteIndex")},
...
"setSpriteN":function(d){return "uzstādi aktieri "+appLocale.v(d,"spriteIndex")},
...
"throwSpriteN":function(d){return "aktieris "+appLocale.v(d,"spriteIndex")+" met"},
"throwTooltip":function(d){return "Norādītais aktieris izmet šāviņu."},
"vanish":function(d){return "pazūd"},
"vanishActorN":function(d){return "aktieris pazūd "+appLocale.v(d,"spriteIndex")},
...
"whenSpriteClickedN":function(d){return "kad aktieris "+appLocale.v(d,"spriteIndex")+" noklikšķināja"},
"whenSpriteClickedTooltip":function(d){return "Izpildi zemāk minētās darbības, kad aktieris ir noklikšķinājis."},
"whenSpriteCollidedN":function(d){return "kad aktieris "+appLocale.v(d,"spriteIndex")},
...
"whenSpriteCollidedWithN":function(d){return "pieskaras aktierim "+appLocale.v(d,"spriteIndex")},
