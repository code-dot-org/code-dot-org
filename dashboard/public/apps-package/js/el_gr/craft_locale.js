...
"level6FailureMessage":function(d){return "Βάλε μπλοκ στον περίγυρο του σπιτιού για να ολοκληρώσεις αυτό το παζλ."},
...
"level9FailureMessage":function(d){return "Μην ξεχάσεις να βάλεις τουλάχιστον δύο δαυλούς για να φωτίσεις το μονοπάτι σου ΚΑΙ να εξορύξεις τουλάχιστον δύο κάρβουνα."},
