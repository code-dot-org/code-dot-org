...
"createHtmlBlock":function(d){return "Δημιουργία μπλοκ html"},
"createHtmlBlockTooltip":function(d){return "Δημιουργεί ένα μπλοκ HTML στην εφαρμογή."},
...
"pause":function(d){return "Διάλειμμα"},
...
"shareWebappTwitter":function(d){return "Δες την εφαρμογή που έφτιαξα. Την έγραψα μόνος μου με το @codeorg"},
"shareGame":function(d){return "Μοιράσου την εφαρμογή σου:"},
"stepIn":function(d){return "Βήμα εντός"},
"stepOver":function(d){return "Βήμα"},
"stepOut":function(d){return "Βήμα εκτός"},
"turnBlack":function(d){return "μαυρίζει"},
"turnBlackTooltip":function(d){return "Μαυρίζει την οθόνη."},
