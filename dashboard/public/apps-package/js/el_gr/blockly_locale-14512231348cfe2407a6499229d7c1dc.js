...
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_WARNING = "Προσοχή: Αυτό το μπλοκ μπορεί να χρησιμοποιηθεί μόνο μέσα σε μια επανάληψη.";
...
Blockly.Msg.CONTROLS_IF_ELSEIF_TOOLTIP = "Πρόσθεσε συνθήκη σε ένα μπλοκ αν.";
Blockly.Msg.CONTROLS_IF_ELSE_TOOLTIP = "Πρόσθεσε μια τελική συνθήκη για όλες τις υπόλοιπες περιπτώσεις στον μπλοκ αν.";
...
Blockly.Msg.CONTROLS_REPEAT_HELPURL = "http://en.wikipedia.org/wiki/For βρόγχος";
...
Blockly.Msg.FUNCTION_DESCRIPTION_LABEL = "Τι υποτίθεται ότι κάνει η συνάρτησή σου;";
...
Blockly.Msg.LISTS_CREATE_WITH_CONTAINER_TOOLTIP = "Πρόσθεσε, αφαίρεσε ή αναδιάταξε ενότητες για να αναπροσαρμόσεις αυτή τη λίστα πλακιδίων.";
Blockly.Msg.LISTS_CREATE_WITH_INPUT_WITH = "δημιουργία λίστας με";
Blockly.Msg.LISTS_CREATE_WITH_ITEM_TOOLTIP = "Πρόσθεσε ένα αντικείμενο - στοιχείο στη λίστα.";
...
Blockly.Msg.LISTS_IS_EMPTY_TITLE = "η %1 είναι κενή";
...
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_EQ = "Επιστρέφει αληθές αν οι δύο είσοδοι είναι ίσες μεταξύ τους.";
...
Blockly.Msg.LOGIC_OPERATION_TOOLTIP_AND = "Επιστρέφει αληθές αν και οι δύο είσοδοι είναι αληθείς.";
...
Blockly.Msg.MATH_IS_TOOLTIP = "Έλεγξε εάν ένας αριθμός είναι μονός, ζυγός, πρώτος, ακέραιος, φυσικός, θετικός, αρνητικός, ή αν διαιρείται από κάποιον αριθμό.  Επιστρέφει αληθές ή ψευδές.";
...
Blockly.Msg.MATH_SINGLE_HELPURL = "http://en.wikipedia.org/wiki/Square_root Τετραγωνική Ρίζα";
...
Blockly.Msg.MATH_SINGLE_TOOLTIP_LOG10 = "Επιστρέφει τον κοινό λογάριθμο ενός αριθμού.";
...
Blockly.Msg.TEXT_APPEND_TOOLTIP = "Πρόσθεσε κείμενο στη μεταβλητή '%1'.";
...
Blockly.Msg.TEXT_CHANGECASE_TOOLTIP = "Επίστρεψε ένα αντίγραφο του κειμένου αντιστρέφοντας την μορφή των πεζών ή των κεφαλαίων.";
...
Blockly.Msg.TEXT_GET_SUBSTRING_START_FROM_END = "πάρε μέρος κειμένου ξεκινώντας από το #ο γράμμα από το τέλος";
...
Blockly.Msg.TEXT_TRIM_TOOLTIP = "Επίστρεψε ένα αντίγραφο του κειμένου, αφαιρώντας τα κενά από το ένα ή και από τα δύο άκρα.";
