...
"a_and_b":function(d){return "Α / Β"},
"addPacket":function(d){return "Προσθέστε πακέτο"},
"addRouter":function(d){return "Προσθέστε το Router"},
...
"binary":function(d){return "Δυαδικό"},
...
"buttonCancel":function(d){return "Άκυρο"},
"buttonJoin":function(d){return "Join"},
"clear":function(d){return "Clear"},
"collapse":function(d){return "Collapse"},
"connect":function(d){return "Συνδεθείτε"},
"connected":function(d){return "Συνδεδεμένος"},
...
"disconnected":function(d){return "Αποσυνδεδεμένος"},
"dns":function(d){return "DNS"},
"dnsMode":function(d){return "DNS Mode"},
"dnsMode_AUTOMATIC":function(d){return "Αυτόματος"},
"dnsMode_MANUAL":function(d){return "Χειροκίνητος"},
"dnsMode_NONE":function(d){return "Κανένας"},
"dropdownPickOne":function(d){return "--ΕΠΙΛΈΞΤΕ ΈΝΑ--"},
"encoding":function(d){return "Encoding"},
"expand":function(d){return "Expand"},
"from":function(d){return "Από"},
"hex":function(d){return "Hex"},
"hexadecimal":function(d){return "Δεκαεξαδικός"},
"incomingConnectionRequests":function(d){return "Αιτήσεις εισερχόμενης σύνδεσης"},
"infinity":function(d){return "Άπειρο"},
"instructions":function(d){return "Οδηγίες"},
"joinSection":function(d){return "Join Section"},
"lobby":function(d){return "Λόμπι"},
...
"lobbyIsEmpty":function(d){return "Κανείς δεν είναι εδώ ακόμη."},
...
"logStatus_success":function(d){return "Επιτυχία"},
"markAsRead":function(d){return "Σήμανση ως αναγνωσμένου"},
"message":function(d){return "Μήνυμα"},
"myDevice":function(d){return "Συσκευή μου"},
"myName":function(d){return "Το όνομά μου"},
"myPrivateNetwork":function(d){return "Το ιδιωτικό μου δίκτυο"},
"mySection":function(d){return "My Section"},
"number":function(d){return "Αριθμός"},
...
"pickASection":function(d){return "Επιλέξτε μια ενότητα"},
...
"routerTab_bandwidth":function(d){return "Εύρος ζώνης"},
"routerTab_memory":function(d){return "Μνήμη"},
"routerTab_stats":function(d){return "Στατιστικά"},
...
"workspaceHeader":function(d){return "Προσομοιωτής Διαδικτύου"},
