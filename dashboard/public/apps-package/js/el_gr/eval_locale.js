...
"badColorStringError":function(d){return "Χρησιμοποιήσατε ένα μη-έγκυρο χρώμα συμβολοσειράς: "+eval_locale.v(d,"val")},
"badStyleStringError":function(d){return "Χρησιμοποιήσατε ένα μη-έγκυρο στυλ συμβολοσειράς: "+eval_locale.v(d,"val")},
