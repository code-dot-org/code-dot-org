...
"dropletBlock_appendItem_description":function(d){return "Πρόσθεσε το αντικείμενο στο τέλος του πίνακα"},
"dropletBlock_appendItem_param0":function(d){return "λίστα"},
"dropletBlock_appendItem_param0_description":function(d){return "Ο πίνακας που θα τροποποιηθεί."},
"dropletBlock_appendItem_param1":function(d){return "αντικείμενο"},
"dropletBlock_appendItem_param1_description":function(d){return "Το αντικείμενο που θα προστεθεί στο τέλος του πίνακα."},
...
"dropletBlock_arcLeft_param0_description":function(d){return "Η γωνία μετακίνησης κατά μήκος του κύκλου."},
"dropletBlock_arcLeft_param1":function(d){return "ακτίνα"},
"dropletBlock_arcLeft_param1_description":function(d){return "Η ακτίνα του κύκλου που τοποθετείται αριστερά της χελώνας. Πρέπει να είναι >=0."},
...
"dropletBlock_arcRight_param0_description":function(d){return "Η γωνία μετακίνησης κατά μήκος του κύκλου."},
"dropletBlock_arcRight_param1":function(d){return "ακτίνα"},
"dropletBlock_arcRight_param1_description":function(d){return "Η ακτίνα του κύκλου που τοποθετείται δεξιά της χελώνας. Πρέπει να είναι >=0."},
...
"dropletBlock_button_param0_description":function(d){return "Ένα μοναδικό αναγνωριστικό για το πλήκτρο. Το αναγνωριστικό χρησιμοποιείται για την αναφορά στο πλήκτρο που δημιουργήθηκε. Για παράδειγμα, για να γίνει αντιστοίχιση χειρισμού συμβάντων."},
"dropletBlock_button_param1":function(d){return "κείμενο"},
"dropletBlock_button_param1_description":function(d){return "Το κείμενο που θα εμφανίζεται μέσα στο πλήκτρο."},
...
"dropletBlock_circle_param0_description":function(d){return "Η θέση x σε πίξελ του κέντρου του κύκλου."},
"dropletBlock_circle_param1":function(d){return "κέντροY"},
"dropletBlock_circle_param1_description":function(d){return "Η θέση y σε πίξελ του κέντρου του κύκλου."},
"dropletBlock_circle_param2":function(d){return "ακτίνα"},
"dropletBlock_circle_param2_description":function(d){return "Η ακτίνα του κύκλου, σε πίξελ."},
...
"dropletBlock_clearInterval_param0_description":function(d){return "Η επιστρεφόμενη τιμή της συνάρτησης setInterval που θα καθαρίσει."},
...
"dropletBlock_clearTimeout_param0_description":function(d){return "Η επιστρεφόμενη τιμή της συνάρτησης setInterval που θα ακυρωθεί."},
...
"dropletBlock_console.log_param0_description":function(d){return "Το μήνυμα που θα εμφανιστεί στην κονσόλα."},
...
"dropletBlock_createCanvas_param0_description":function(d){return "Το αναγνωριστικό του νέου στοιχείου καμβά."},
"dropletBlock_createCanvas_param1":function(d){return "πλάτος"},
"dropletBlock_createCanvas_param1_description":function(d){return "Το οριζόντιο πλάτος σε πίξελ του ορθογωνίου."},
"dropletBlock_createCanvas_param2":function(d){return "ύψος"},
"dropletBlock_createCanvas_param2_description":function(d){return "Το κάθετο ύψος σε πίξελ του ορθογωνίου."},
...
"dropletBlock_createRecord_param0_description":function(d){return "Το όνομα του πίνακα στον οποίο πρέπει να προστεθεί η εγγραφή. Ο `όνομαΠίνακα` θα δημιουργηθεί αν δεν υπάρχει."},
...
"dropletBlock_declareAssign_list_abde_description":function(d){return "Όρισε μία μεταβλητή και ανάθεσε έναν πίνακα σε αυτήν με τις δεδομένες αρχικές τιμές"},
"dropletBlock_declareAssign_list_abde_signatureOverride":function(d){return "Όρισε και ανάθεσε έναν πίνακα σε μία μεταβλητή"},
"dropletBlock_declareAssign_str_hello_world_description":function(d){return "Όρισε μία μεταβλητή και ανάθεσε μία συμβολοσειρά σε αυτήν"},
...
"dropletBlock_insertItem_param0":function(d){return "λίστα"},
"dropletBlock_insertItem_param0_description":function(d){return "Ο πίνακας που θα τροποποιηθεί."},
...
"dropletBlock_insertItem_param2":function(d){return "αντικείμενο"},
...
"dropletBlock_penRGB_param0":function(d){return "κόκκινο"},
...
"dropletBlock_penRGB_param1":function(d){return "πράσινο"},
...
"dropletBlock_penRGB_param2":function(d){return "μπλε"},
...
"dropletBlock_rect_param2_description":function(d){return "Το οριζόντιο πλάτος σε πίξελ του ορθογωνίου."},
"dropletBlock_rect_param3":function(d){return "ύψος"},
"dropletBlock_rect_param3_description":function(d){return "Το κάθετο ύψος σε πίξελ του ορθογωνίου."},
"dropletBlock_removeItem_description":function(d){return "Remove the item at the specified position from the array"},
"dropletBlock_removeItem_param0":function(d){return "λίστα"},
"dropletBlock_removeItem_param0_description":function(d){return "Ο πίνακας που θα τροποποιηθεί."},
...
"dropletBlock_substring_param1":function(d){return "τέλος"},
