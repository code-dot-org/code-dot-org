...
"addItems1":function(d){return "Πρόσθεσε 1 στοιχείο του τύπου"},
"addItems2":function(d){return "Πρόσθεσε 2 στοιχεία του τύπου"},
"addItems3":function(d){return "Πρόσθεσε 3 στοιχεία του τύπου"},
"addItems5":function(d){return "Πρόσθεσε 5 στοιχεία του τύπου"},
"addItems10":function(d){return "Πρόσθεσε 10 στοιχεία του τύπου"},
"addItemsRandom":function(d){return "Πρόσθεσε τυχαίο αριθμό στοιχείων του τύπου"},
"addItemsTooltip":function(d){return "Προσθέστε αντικείμενα στη σκηνή."},
...
"dropletBlock_setItemSpeed_param1":function(d){return "ταχύτητα"},
...
"dropletBlock_setCharacterSpeed_param0":function(d){return "ταχύτητα"},
