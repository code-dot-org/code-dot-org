...
"blockIfLavaAhead":function(d){return "אם לבה מלפנים"},
"blockMoveForward":function(d){return "לזוז קדימה"},
"blockPlaceTorch":function(d){return "שים מנורה"},
...
"blockPlantCrop":function(d){return "קצור יבול"},
"blockShear":function(d){return "הטה"},
...
"blockTypeBedrock":function(d){return "סלע"},
...
"blockTypeCobblestone":function(d){return "אבן ריצוף"},
"blockTypeDirt":function(d){return "עפר"},
"blockTypeDirtCoarse":function(d){return "עפר גס"},
"blockTypeEmpty":function(d){return "ריק"},
"blockTypeFarmlandWet":function(d){return "אדמות חקלאיות"},
...
"generatedCodeDescription":function(d){return "על-ידי גרירה והצבת אבני פאזל זה, יצרת אוסף של הוראות בשפת מחשב - קוד - הנקראת ג'אווהסקריפט (Javascript). קוד זה אומר למחשב מה להציג על המסך. כל מה שאתה רואה ועושה במינקראפט גם מתחיל עם שורות של קוד מחשב כאלו."},
