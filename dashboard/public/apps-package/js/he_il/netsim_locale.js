...
"bitCounter":function(d){return "ביטים "+netsim_locale.v(d,"x")+"/"+netsim_locale.v(d,"y")},
...
"numBitsPerPacket":function(d){return netsim_locale.v(d,"x")+" ביטים למנה"},
"numBitsPerChunk":function(d){return netsim_locale.v(d,"numBits")+" ביטים למנה"},
...
"routerX":function(d){return "נתב "+netsim_locale.v(d,"x")},
...
"setWireToValue":function(d){return "קבע חוט ל"+netsim_locale.v(d,"value")},
...
"waitingForNodeToConnect":function(d){return "ממתין ש "+netsim_locale.v(d,"node")+" יתחבר..."},
"workspaceHeader":function(d){return "Internet Simulator"},
"xOfYPackets":function(d){return netsim_locale.v(d,"x")+" מתוך "+netsim_locale.v(d,"y")},
"xSecondPerPulse":function(d){return netsim_locale.v(d,"x")+" שניה לפעימה"},
"xSecondsPerPulse":function(d){return netsim_locale.v(d,"x")+" שניות לפעימה"},
