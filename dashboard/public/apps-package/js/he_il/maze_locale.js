...
"moveEastTooltip":function(d){return "תזיז אותי חתיכה אחת מזרחה."},
"moveForward":function(d){return "לזוז קדימה"},
"moveForwardTooltip":function(d){return "הזז אותי צעד אחד קדימה."},
"moveNorthTooltip":function(d){return "תזיז אותי חתיכה אחת צפונה."},
"moveSouthTooltip":function(d){return "תזיז אותי חתיכה אחת דרומה."},
"moveTooltip":function(d){return "תזיז אותי מקום אחד קדימה/אחורה"},
"moveWestTooltip":function(d){return "תזיז אותי חתיכה אחת מערבה."},
...
"repeatCarefullyError":function(d){return "כדי לפתור זאת, חשוב היטב על התבנית של שתי תזוזות וסיבוב אחד שייכנסו לבלוק \"חזר שוב\".  . זה בסדר שיש לך על פנייה נוספת בסוף."},
