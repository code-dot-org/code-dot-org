...
"saySpriteN":function(d){return "שחקן "+appLocale.v(d,"spriteIndex")+" אומר"},
...
"setSpriteN":function(d){return "הגדר שחקן "+appLocale.v(d,"spriteIndex")},
...
"stopSpriteN":function(d){return "עצור שחקן "+appLocale.v(d,"spriteIndex")},
"stopTooltip":function(d){return "עוצר את תנועת השחקן."},
"throwSprite":function(d){return "זרוק"},
"throwSpriteN":function(d){return "שחקן "+appLocale.v(d,"spriteIndex")+" זורק"},
