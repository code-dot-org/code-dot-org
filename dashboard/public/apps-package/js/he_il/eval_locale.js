...
"badColorStringError":function(d){return "השתמשת במחרוזת צבע לא חוקית : "+eval_locale.v(d,"val")},
"badStyleStringError":function(d){return "השתמשת במחרוזת סגנון לא חוקית : "+eval_locale.v(d,"val")},
...
"infiniteRecursionError":function(d){return "הפוקנציה שלך קוראת לעצמה. עצורנו אותה, אחרת זה היה ממשיך לנצח."},
...
"rectangleBlockTitle":function(d){return "מלבן (רוחב, גובה, סגנון, צבע)"},
"reinfFeedbackMsg":function(d){return "באפשרותך להקיש על הכפתור \"להמשיך לשחק\" כדי לערוך את התוכנית שלך."},
"rotateImageBlockTitle":function(d){return "סובב (מעלות, תמונה)"},
"scaleImageBlockTitle":function(d){return "שינוי קנה מידה (מקדם, תמונה)"},
"squareBlockTitle":function(d){return "ריבוע (גודל, סגנון, צבע)"},
"starBlockTitle":function(d){return "כוכב (רדיוס, סגנון, צבע)"},
"radialStarBlockTitle":function(d){return "כוכב-רדיאלי (נקודות, פנימי, חיצוני, סגנון, צבע)"},
"polygonBlockTitle":function(d){return "מצולע (פאות, אורך, סגנון, צבע)"},
"stringAppendBlockTitle":function(d){return "שרשר-מחרוזת (ראשון, שני)"},
"stringLengthBlockTitle":function(d){return "אורך-מחרוזת (מחרוזת)"},
"textBlockTitle":function(d){return "טקסט (מחרוזת, גודל, צבע)"},
"triangleBlockTitle":function(d){return "משולש (גודל, סגנון, צבע)"},
