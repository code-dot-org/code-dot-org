...
"colourTooltip":function(d){return "משנה את הצבע של העיפרון."},
"createACircle":function(d){return "צור עיגול"},
"createSnowflakeSquare":function(d){return "צור פתית שלג בצורת מרובע"},
...
"createASnowflakeBranch":function(d){return "צור ענף של פתיתי שלג"},
...
"drawStamp":function(d){return "צייר חותמת"},
...
"jumpTooltip":function(d){return "הזז את האמן בלי להשאיר סימנים."},
