...
"dropletBlock_appendItem_description":function(d){return "מצרף את הפריט לסוף של המערך"},
"dropletBlock_appendItem_param0":function(d){return "רשימה"},
"dropletBlock_appendItem_param0_description":function(d){return "המערך כדי להיות שונה."},
"dropletBlock_appendItem_param1":function(d){return "פריט"},
...
"dropletBlock_arcLeft_param1_description":function(d){return "הרדיוס של המעגל הממוקם משמאל לצב. צריך להיות >= 0."},
...
"dropletBlock_arcRight_param1_description":function(d){return "הרדיוס של המעגל הממוקם מימין לצב. צריך להיות > = 0."},
...
"dropletBlock_button_param1_description":function(d){return "המלל מוצג בתוך הכפתור."},
...
"dropletBlock_checkbox_description":function(d){return "צור תיבת סימון והקצה לה מזהה רכיב"},
"dropletBlock_checkbox_param0":function(d){return "checkboxId"},
"dropletBlock_checkbox_param1":function(d){return "סומן"},
...
"dropletBlock_circle_param2_description":function(d){return "הרדיוס של המעגל, בפיקסלים."},
...
"dropletBlock_clearInterval_param0":function(d){return "מרווח זמן"},
...
"dropletBlock_clearTimeout_param0":function(d){return "פסק זמן"},
"dropletBlock_clearTimeout_param0_description":function(d){return "The value returned by the setTimeout function to cancel."},
"dropletBlock_console.log_description":function(d){return "מציג את המחרוזת או המשתנה בתצוגת המסוף"},
"dropletBlock_console.log_param0":function(d){return "הודעה"},
...
"dropletBlock_createCanvas_param1_description":function(d){return "הרוחב האופקי בפיקסלים של המלבן."},
"dropletBlock_createCanvas_param2":function(d){return "גובה"},
"dropletBlock_createCanvas_param2_description":function(d){return "הגובה האנכי בפיקסלים של המלבן."},
...
"dropletBlock_createRecord_param1":function(d){return "שיא"},
...
"dropletBlock_deleteElement_description":function(d){return "מחק את הרכיב בעל המזהה שצויין"},
...
"dropletBlock_deleteRecord_param1":function(d){return "שיא"},
...
"dropletBlock_insertItem_param0":function(d){return "רשימה"},
"dropletBlock_insertItem_param0_description":function(d){return "המערך כדי להיות שונה."},
...
"dropletBlock_insertItem_param2":function(d){return "פריט"},
...
"dropletBlock_penRGB_param0":function(d){return "אדום"},
...
"dropletBlock_penRGB_param1":function(d){return "ירוק"},
...
"dropletBlock_penRGB_param2":function(d){return "כחול"},
...
"dropletBlock_radioButton_param1":function(d){return "סומן"},
...
"dropletBlock_rect_param2_description":function(d){return "הרוחב האופקי בפיקסלים של המלבן."},
"dropletBlock_rect_param3":function(d){return "גובה"},
"dropletBlock_rect_param3_description":function(d){return "הגובה האנכי בפיקסלים של המלבן."},
"dropletBlock_removeItem_description":function(d){return "Remove the item at the specified position from the array"},
"dropletBlock_removeItem_param0":function(d){return "רשימה"},
"dropletBlock_removeItem_param0_description":function(d){return "המערך כדי להיות שונה."},
...
"dropletBlock_setChecked_param1":function(d){return "סומן"},
...
"dropletBlock_substring_param1":function(d){return "סוף"},
...
"dropletBlock_updateRecord_param1":function(d){return "שיא"},
