...
"fillStack":function(d){return "ใส่ชั้นของ "+maze_locale.v(d,"shovelfuls")+" ลองในช่อง"},
"fillSquare":function(d){return "เติมสี่เหลี่ยม"},
...
"removeN":function(d){return "เอา "+maze_locale.v(d,"shovelfuls")+" ออก"},
"removePile":function(d){return "ตักดินออก"},
"removeStack":function(d){return "เอาชั้นของกอง "+maze_locale.v(d,"shovelfuls")+" ออก"},
"removeSquare":function(d){return "เอาสี่เหลี่ยมออก"},
"repeatCarefullyError":function(d){return "เพื่อแก้ไขปัญหานี้ ลองคิดอย่างรอบคอบเกี่ยวกับรู้แบบของการเคลื่อนย้ายทั้ง 2 และอีกหนึ่งรอบ เพื่อใส่บล็อค \"ทำซ้ำ\" ซึ่งก็ไม่เป็นที่จะเพิ่มรอบพิเศษเข้ามาในช่วงท้าย"},
...
"step":function(d){return "ขั้นตอน"},
