...
"catLists":function(d){return "รายการ"},
...
"completedWithoutRecommendedBlock":function(d){return "ยินดีด้วย คุณทำปัญหา"+common_locale.v(d,"puzzleNumber")+" เสร็จเรียบร้อยแล้ว (แต่คุณสามารถใช้บล็อครูปแบบอื่นเพื่อโค้ดที่แกร่งขึ้น)"},
"continue":function(d){return "ดำเนินการต่อไป"},
"copy":function(d){return "คัดลอก"},
...
"dropletBlock_mathRandom_description":function(d){return "ส่งตัวเลขสุ่มที่อยู่ในช่วง 0 (รวมตัวเลขนี้ด้วย) ไปถึง 1 (ไม่นับรวม 1)"},
...
"dropletBlock_randomNumber_param1_description":function(d){return "ตัวเลขที่มากที่สุดที่ส่งคืนมา"},
...
"hintReviewTitle":function(d){return "ตรวจสอบคำแนะนำของคุณ"},
"hintSelectInstructions":function(d){return "ขั้นตอนและคำแนะนำก่อนหน้า"},
"hintSelectNewHint":function(d){return "ขอคำแนะนำใหม่"},
...
"missingRecommendedBlocksErrorMsg":function(d){return "ไม่ใช่ซะทีเดียว ลองใช้บล็อคอื่นที่ยังไม่ได้ใช้ดูสิ"},
"missingRequiredBlocksErrorMsg":function(d){return "ไม่ใช่ซะทีเดียว ควรจะลองใช้บล็อคอื่นที่ยังไม่ได้ใช้ดูนะ"},
...
"sendToPhone":function(d){return "ส่งไปยังโทรศัพท์"},
...
"unsubmitYourProject":function(d){return "ยังไม่ส่งโครงงารของคุณ"},
"unsubmitYourProjectConfirm":function(d){return "โครงงารที่กำลังยกเลิกของคุณจะเริ่มวันจัดส่งใหม่ จะยกเลิกการส่งจริงๆ ใช่ไหม"},
...
"tryBlocksBelowFeedback":function(d){return "ลองใช้บล็อคด้านล่างสักอันสิ"},
