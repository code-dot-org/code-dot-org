var applab_locale = {lc:{"ar":function(n){
  ...
  return 'other';
},"sv":function(n){return n===1?"one":"other"},"ta":function(n){return n===1?"one":"other"},"th":function(n){return "other"}},
...
"pause":function(d){return "การหยุด"},
"reinfFeedbackMsg":function(d){return "คุณสามารถกดปุ่ม Try again เพื่อย้อนกลับไปให้ชุดคำสั่ง หรือ app ทำงาน."},
"repeatForever":function(d){return "ทำซำ้ไปตลอดกาล"},
"repeatDo":function(d){return "ทำ"},
"repeatForeverTooltip":function(d){return "ดำเนินการในบล็อกนี้ซ้ำ ๆ ในขณะที่ชุดคำสั่งหรือ app กำลังทำงานอยู่."},
"shareApplabTwitter":function(d){return "เอาชุดคำสั่งที่ฉันทำขึ้นออกมา ฉันเขียนมันด้วยตัวฉันเองกับ @codeorg"},
"shareGame":function(d){return "แชร์ชุดคำสั่งหรือ app ของคุณ:"},
"stepIn":function(d){return "ก้าวเข้ามา"},
"stepOver":function(d){return "ก้าวข้ามผ่านไป"},
"stepOut":function(d){return "ก้าวออกไป"},
"viewData":function(d){return "ดูข้อมูล"},
