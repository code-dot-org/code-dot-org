...
"moveSpriteN":function(d){return "การเคลื่อนย้ายตัวแสดง "+appLocale.v(d,"spriteIndex")},
...
"saySpriteN":function(d){return "นักแสดง  "+appLocale.v(d,"spriteIndex")+" พูดว่า"},
...
"setSpriteN":function(d){return "ชุดนักแสดง "+appLocale.v(d,"spriteIndex")},
...
"stopSpriteN":function(d){return "หยุดนักแสดง "+appLocale.v(d,"spriteIndex")},
"stopTooltip":function(d){return "หยุดการเคลื่อนไหวของนักแสดง."},
"throwSprite":function(d){return "โยน"},
"throwSpriteN":function(d){return "นักโยน "+appLocale.v(d,"spriteIndex")},
"throwTooltip":function(d){return "โยนแบบโค้งจากนักแสดงที่ถูกระบุ."},
"vanish":function(d){return "หายไป"},
"vanishActorN":function(d){return "นักแสดงที่หายตัวไป "+appLocale.v(d,"spriteIndex")},
...
"whenSpriteClickedN":function(d){return "เมื่อนักแสดงถูกคลิก "+appLocale.v(d,"spriteIndex")},
"whenSpriteClickedTooltip":function(d){return "ดำเนินการด้านล่างเมื่อนักแสดงถูกคลิก."},
"whenSpriteCollidedN":function(d){return "เมื่อนักแสดง "+appLocale.v(d,"spriteIndex")},
...
"whenSpriteCollidedWithN":function(d){return "สัมผัสนักแสดง "+appLocale.v(d,"spriteIndex")},
