...
"setSpriteCaveBoy":function(d){return "la poză cu un băiat din peşteră"},
"setSpriteCaveGirl":function(d){return "la poză cu o fată din peşteră"},
...
"setSpriteNinja":function(d){return "la poză cu un ninja mascat"},
"setSpriteOctopus":function(d){return "la poză cu o caracatiţă"},
"setSpritePenguin":function(d){return "la poză cu un penguin"},
"setSpritePirate":function(d){return "la poză cu un pirat"},
"setSpritePrincess":function(d){return "la poză cu o prinţesă"},
"setSpriteRandom":function(d){return "imagine aleatorie"},
"setSpriteRobot":function(d){return "la poză cu un robot"},
