...
"exampleErrorMessage":function(d){return "Funcţia "+common_locale.v(d,"functionName")+" are unul sau mai multe exemple care au nevoie de ajustare. Asigură-te că acestea se potrivesc cu definiţia ta şi răspund la întrebare."},
...
"nestedForSameVariable":function(d){return "Utilizează aceeaşi variabilă în interiorul a două sau mai multor bucle imbricate. Utilizează nume de variabilă unice pentru a evita bucle infinite."},
...
"submitYourProjectConfirm":function(d){return "Nu-ți mai poți edita proiectul după ce l-ai înregistrat, ești sigur ca vrei să-l înregistrezi?"},
