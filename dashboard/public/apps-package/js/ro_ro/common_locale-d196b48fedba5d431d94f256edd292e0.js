...
"emptyExampleBlockErrorMsg":function(d){return "Ai nevoie de cel puţin două exemple în funcţia "+common_locale.v(d,"functionName")+". Asiguraţi-vă că fiecare exemplu are un apel şi un rezultat."},
...
"emptyTopLevelBlock":function(d){return "Nu există blocuri pentru a fi rulate. Trebuie să atașezi un bloc la blocul "+common_locale.v(d,"topLevelBlockName")+"."},
...
"exampleErrorMessage":function(d){return "Funcţia "+common_locale.v(d,"functionName")+" are unul sau mai multe exemple care au nevoie de reglare. Asiguraţi-vă că acestea se potrivesc cu definiţia dumneavoastră şi răspund la întrebare."},
"examplesFailedOnClose":function(d){return "Unul sau mai multe dintre exemple dumneavoastră nu corespund definiţiei dumneavoastră. Verificați exemplele dumneavoastră înainte de a închide"},
...
"unnamedFunction":function(d){return "Aveţi o variabilă sau o funcţie care nu are nume. Nu uitaţi să daţi tuturor câte un nume descriptiv."},
