...
"scoreText":function(d){return "Puan: "+appLocale.v(d,"playerScore")+" : "+appLocale.v(d,"opponentScore")},
...
"setBallHardcourt":function(d){return "topu sert yap"},
"setBallRetro":function(d){return "topu retro yap"},
"setBallTooltip":function(d){return "Topun resmini ayarlar"},
"setBallSpeedRandom":function(d){return "Rastgele top hızı ayarla"},
"setBallSpeedVerySlow":function(d){return "çok yavaş top hızı ayarla"},
"setBallSpeedSlow":function(d){return "yavaş top hızı ayarla"},
"setBallSpeedNormal":function(d){return "normal top hızı ayarla"},
...
"shareBounceTwitter":function(d){return "Yaptığım Bounce oyununa bir göz atın. @codeorg ile bunu kendim yazdım"},
...
"whenBallInGoal":function(d){return "top gol olduğunda"},
"whenBallInGoalTooltip":function(d){return "Top gol olduğunda, aşağıdaki işlemleri yürüt."},
