...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_REMOVE_FROM_END = "Liste içinde belirtilen yerdeki nesneyi kaldırır. #1 son ögedir .";
...
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_LAST = "Nesneyi bir listenin sonuna ekle.";
...
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_SET_FROM_END = "Bir ögeyi belirtilen yere göre listeye yerleştirir . #1 son ögedir .";
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_SET_FROM_START = "Bir ögeyi belirtilen yere göre listeye yerleştirir . #1 ilk ögedir .";
...
Blockly.Msg.MATH_ONLIST_TOOLTIP_MODE = "Listede ki en yaygın öge veya ögelerinin listesini döndür.";
...
Blockly.Msg.MATH_SINGLE_TOOLTIP_NEG = "Sayıyı eksi (-) işaretli olarak döndür .";
...
Blockly.Msg.TEXT_GET_SUBSTRING_START_FROM_START = "#'nci harften alt-string alma";
