...
"addPacket":function(d){return "Paket ekle"},
...
"binary":function(d){return "İkili"},
...
"decimal":function(d){return "Ondalık"},
"disconnected":function(d){return "Çevrim Dışı"},
"dns":function(d){return "DNS"},
"dnsMode":function(d){return "DNS modu"},
"dnsMode_AUTOMATIC":function(d){return "Otomatik"},
"dnsMode_MANUAL":function(d){return "Manuel ( El ile)"},
"dnsMode_NONE":function(d){return "Hiçbiri"},
"dropdownPickOne":function(d){return "-- PICK ONE --"},
"encoding":function(d){return "Kodlama"},
"expand":function(d){return "Expand"},
"from":function(d){return "-den -dan"},
"hex":function(d){return "Hex"},
"hexadecimal":function(d){return "Onaltılık"},
...
"message":function(d){return "Mesaj"},
"myDevice":function(d){return "Benim Aygıtım"},
...
"_of_":function(d){return "arasında"},
...
"receivedMessageLog":function(d){return "Alınan mesaj kaydı"},
"removePacket":function(d){return "Paketi Sil"},
"router":function(d){return "Yönlendirici"},
...
"send":function(d){return "Gönder"},
"sendAMessage":function(d){return "Mesaj Gönder"},
"sendBits":function(d){return "Send Bits"},
"sentBitsLog":function(d){return "Sent Bits Log"},
"sentMessageLog":function(d){return "Mesaj kaydını gönder"},
...
"workspaceHeader":function(d){return "İnternet Simülatörü"},
