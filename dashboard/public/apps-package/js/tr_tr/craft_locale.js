...
"blockIfLavaAhead":function(d){return "ileride lav varsa"},
"blockMoveForward":function(d){return "ilerle"},
"blockPlaceTorch":function(d){return "meşaleyi yerleştir"},
"blockPlaceXAheadAhead":function(d){return "ileride"},
...
"blockWhileXAheadAhead":function(d){return "ileride"},
...
"level5FailureMessage":function(d){return "Bir duvar inşa etmek için toprak üzerindeki hatlar üzerine yerleştir. Pembe renkli \"tekrar et\" komutu içindeki, \"bloğu yerleştir\" ve \"ileri hareket et\" gibi komutları çalıştırır."},
"level6FailureMessage":function(d){return "Bulmacayı tamamlamak için evin dışındaki toprak üstündeki hatlar üstüne bloklar yerleştirin."},
