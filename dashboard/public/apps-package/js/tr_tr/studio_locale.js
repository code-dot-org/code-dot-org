...
"backgroundUnderwater":function(d){return "deniz altında"},
...
"setSpriteEmotionAngry":function(d){return "sinirli hal için"},
...
"setSpriteAnna":function(d){return "Anna'yı resmini görüntüle"},
"setSpriteElsa":function(d){return "Elsa resmini görüntüle"},
...
"setSpriteN":function(d){return "ayarla aktör "+appLocale.v(d,"spriteIndex")},
...
"throwSpriteN":function(d){return "aktör "+appLocale.v(d,"spriteIndex")+" fırlat"},
"throwTooltip":function(d){return "Belirlenen aktör atılacak cismi fırlatır."},
"vanish":function(d){return "kaybol"},
"vanishActorN":function(d){return "kaybol aktör "+appLocale.v(d,"spriteIndex")},
...
"whenSpriteClickedN":function(d){return "aktör "+appLocale.v(d,"spriteIndex")+" e tıkladığında"},
"whenSpriteClickedTooltip":function(d){return "Aktör tıklandığında aşağıdaki eylemleri yürüt."},
"whenSpriteCollidedN":function(d){return "Aktör "+appLocale.v(d,"spriteIndex")+" zamanında"},
...
"whenSpriteCollidedWithN":function(d){return "dokunur aktör "+appLocale.v(d,"spriteIndex")},
