...
"createSnowflakeSquare":function(d){return "napravi snježnu pahuljicu kvadratnog oblika"},
"createSnowflakeParallelogram":function(d){return "napravi snježnu pahuljicu oblika paralelograma"},
"createSnowflakeLine":function(d){return "napravi snješnu pahuljicu tipa crte"},
"createSnowflakeSpiral":function(d){return "napravi snježnu pahuljicu oblika spirale"},
"createSnowflakeFlower":function(d){return "napravi snježnu pahuljicu oblika cvijeta"},
"createSnowflakeFractal":function(d){return "napravi snježnu pahuljicu fraktalnog tipa"},
"createSnowflakeRandom":function(d){return "napravi snježnu pahuljicu nasumičnog oblika"},
"createASnowflakeBranch":function(d){return "napravi granu snježne pahuljice"},
"degrees":function(d){return "stupnjevi"},
...
"drawAHexagon":function(d){return "nacrtaj šesterokut"},
...
"drawASnowman":function(d){return "nacrtaj snjegovića"},
...
"drawATriangle":function(d){return "nacrtaj trokut"},
...
"lengthFeedback":function(d){return "Izvršeno uspješno osim dužine pomicanja."},
"lengthParameter":function(d){return "duljina"},
...
"numBlocksNeeded":function(d){return "Ovaj zadatak se može riješiti s %1 blokova. Ti si koristio/la %2."},
"penDown":function(d){return "spusti olovku"},
"penTooltip":function(d){return "Podiže ili spušta olovku da bi počeo ili prestao crtati."},
"penUp":function(d){return "podigni olovku"},
"reinfFeedbackMsg":function(d){return "Evo vašeg crteža! Nastavite raditi na njemu ili prijeđite na idući zadatak."},
...
"turnRightTooltip":function(d){return "Okreće crtača desno za zadani kut."},
"turnTooltip":function(d){return "Okreće crtača lijevo ili desno za zadani broj stupnjeva."},
"turtleVisibilityTooltip":function(d){return "Pokazuje ili skriva crtača."},
"widthTooltip":function(d){return "Mijenja širinu traga olovke."},
"wrongColour":function(d){return "Tvoja slika je pogrešne boje. U ovom zadatku treba biti boja %1."}};