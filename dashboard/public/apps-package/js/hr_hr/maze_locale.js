...
"fill":function(d){return "ispuni 1"},
"fillN":function(d){return "ispuni "+maze_locale.v(d,"shovelfuls")},
"fillStack":function(d){return "ispuni niz od "+maze_locale.v(d,"shovelfuls")+" rupa"},
"fillSquare":function(d){return "ispuni kvadrat"},
...
"didNotCollectEverything":function(d){return "Provjeri jesi li pokupio sav nektar ili med!"},
...
"ifTooltip":function(d){return "Ako staza ide u zadanom smjeru, onda napravi zadane akcije."},
"ifelseTooltip":function(d){return "Ako staza vodi u zadanom smjeru, onda napravi prvi grupu akcija, a inače napravi drugu grupu akcija."},
"ifFlowerTooltip":function(d){return "Ako u navedenom smjeru postoji cvijet ili saće, onda napravi neke akcije."},
"ifOnlyFlowerTooltip":function(d){return "Ako je cvijet u zadanom smjeru, izvrši neke radnje."},
"ifelseFlowerTooltip":function(d){return "Ako u navedenom smjeru postoji cvijet ili saće, onda napravi prvi blok akcija. Inače napravi drugi blok akcija."},
...
"make":function(d){return "napravi"},
...
"moveNorthTooltip":function(d){return "Premjesti me za jedno polje na Sjever."},
"moveSouthTooltip":function(d){return "Premjesti me za jedno polje na Jug."},
"moveTooltip":function(d){return "Premjesti me naprijed ili nazad za jedno polje"},
"moveWestTooltip":function(d){return "Premjesti me za jedno polje na Zapad."},
...
"pilePresent":function(d){return "tamo je hrpa"},
...
"removePile":function(d){return "ukloni gomilu"},
"removeStack":function(d){return "ukloni hrpu od "+maze_locale.v(d,"shovelfuls")+" lopata"},
...
"turnTooltip":function(d){return "Okreće me lijevo ili desno za 90 stupnjeva."},
"uncheckedCloudError":function(d){return "Dobro provjeri sve oblake da vidiš ima li tamo cvjetova ili saća."},
...
"youSpelled":function(d){return "Napisano je"}};