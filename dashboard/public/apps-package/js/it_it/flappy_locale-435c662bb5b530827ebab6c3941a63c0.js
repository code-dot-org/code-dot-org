...
"flapTooltip":function(d){return "Fa volare Flappy verso l'alto."},
...
"setBackgroundFlappy":function(d){return "imposta una scena Città di giorno"},
"setBackgroundNight":function(d){return "imposta una scena Città di notte"},
"setBackgroundSciFi":function(d){return "imposta una scena Fantascienza"},
"setBackgroundUnderwater":function(d){return "imposta una scena Sottomarina"},
"setBackgroundCave":function(d){return "imposta una scena Grotta"},
"setBackgroundSanta":function(d){return "imposta una scena Natale"},
...
"setGravityVeryLow":function(d){return "imposta una gravità molto bassa"},
"setGravityLow":function(d){return "imposta una gravità bassa"},
"setGravityNormal":function(d){return "imposta una gravità normale"},
"setGravityHigh":function(d){return "imposta una gravità alta"},
"setGravityVeryHigh":function(d){return "imposta una gravità molto alta"},
"setGravityTooltip":function(d){return "Imposta il livello della forza di gravità"},
"setGround":function(d){return "imposta un terreno"},
"setGroundRandom":function(d){return "imposta un terreno scelto a caso"},
"setGroundFlappy":function(d){return "imposta un terreno Normale"},
"setGroundSciFi":function(d){return "imposta un terreno Fantascienza"},
"setGroundUnderwater":function(d){return "imposta un terreno Sottomarino"},
"setGroundCave":function(d){return "imposta un terreno Grotta"},
"setGroundSanta":function(d){return "imposta un terreno Natale"},
"setGroundLava":function(d){return "imposta un terreno Lava"},
"setGroundTooltip":function(d){return "Imposta l'immagine per il terreno"},
"setObstacle":function(d){return "imposta un ostacolo"},
"setObstacleRandom":function(d){return "imposta un ostacolo scelto a caso"},
"setObstacleFlappy":function(d){return "imposta un ostacolo Tubo"},
"setObstacleSciFi":function(d){return "imposta un ostacolo Fantascienza"},
"setObstacleUnderwater":function(d){return "imposta un ostacolo Pianta"},
"setObstacleCave":function(d){return "imposta un ostacolo Grotta"},
"setObstacleSanta":function(d){return "imposta un ostacolo Camino"},
"setObstacleLaser":function(d){return "imposta un ostacolo Raggio Laser"},
...
"setPlayerFlappy":function(d){return "imposta un giocatore Uccello Giallo"},
"setPlayerRedBird":function(d){return "imposta un giocatore Uccello Rosso"},
"setPlayerSciFi":function(d){return "imposta un giocatore Astronave"},
"setPlayerUnderwater":function(d){return "imposta un giocatore Pesce"},
"setPlayerCave":function(d){return "imposta un giocatore Pipistrello"},
"setPlayerSanta":function(d){return "imposta un giocatore Babbo Natale"},
"setPlayerShark":function(d){return "imposta un giocatore Squalo"},
"setPlayerEaster":function(d){return "imposta un giocatore Coniglietto"},
"setPlayerBatman":function(d){return "imposta un giocatore Batman"},
"setPlayerSubmarine":function(d){return "imposta un giocatore Sottomarino"},
"setPlayerUnicorn":function(d){return "imposta un giocatore Unicorno"},
"setPlayerFairy":function(d){return "imposta un giocatore Fatina"},
"setPlayerSuperman":function(d){return "imposta un giocatore Superman"},
"setPlayerTurkey":function(d){return "imposta un giocatore Tacchino"},
...
"whenClickTooltip":function(d){return "Esegue le azioni attaccate a questo blocco quando si verifica l'evento \"clic\"."},
"whenCollideGround":function(d){return "quando precipita a terra"},
"whenCollideGroundTooltip":function(d){return "Esegue le azioni attaccate a questo blocco quando Flappy precipita a terra."},
"whenCollideObstacle":function(d){return "quando colpisce un ostacolo"},
"whenCollideObstacleTooltip":function(d){return "Esegue le azioni attaccate a questo blocco quando Flappy colpisce un ostacolo."},
"whenEnterObstacle":function(d){return "quando supera un ostacolo"},
"whenEnterObstacleTooltip":function(d){return "Esegue le azioni attaccate a questo blocco quando Flappy incontra un ostacolo."},
"whenRunButtonClick":function(d){return "quando si clicca su \"Esegui\""},
"whenRunButtonClickTooltip":function(d){return "Esegue le azioni attaccate a questo blocco quando si clicca su \"Esegui\"."},
