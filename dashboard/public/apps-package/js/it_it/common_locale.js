...
"dropletBlock_randomNumber_description":function(d){return "Restituisce un numero casuale nell'intervallo compreso tra min e max."},
...
"levelIncompleteError":function(d){return "Stai usando tutti i tipi di blocco che servono per risolvere l'esercizio, ma non nel modo giusto."},
...
"recommendedBlockContextualHintTitle":function(d){return "Prova a utilizzare un blocco come questo per risolvere il puzzle."},
...
"tooFewBlocksMsg":function(d){return "Stai usando tutti i tipi di blocco che servono per risolvere l'esercizio, ma dovresti usare più blocchi di questi tipi oppure li dovresti usare in modo diverso."},
