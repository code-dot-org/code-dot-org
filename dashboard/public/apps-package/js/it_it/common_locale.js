...
"clearPuzzleConfirm":function(d){return "Cliccando su \"Ripristina\" l'esercizio verrà ripristinato alla situazione inziale e verranno cancellati tutti i blocchi che hai aggiunto o cambiato."},
...
"emptyBlockInFunction":function(d){return "La funzione "+common_locale.v(d,"name")+" ha un input vuoto."},
"emptyBlockInVariable":function(d){return "La variabile "+common_locale.v(d,"name")+" non ha valori assegnati."},
"emptyExampleBlockErrorMsg":function(d){return "Hai bisogno di almeno due esempi nella funzione "+common_locale.v(d,"functionName")+". Assicurati che ogni esempio abbia una chiamata/invocazione e un risultato."},
...
"nestedForSameVariable":function(d){return "Stai usando la stessa variabile all'interno di due o più cicli nidificati (nested loop). Utilizzate nomi di variabili univoci per evitare cicli infiniti."},
...
"submitYourProjectConfirm":function(d){return "Non puoi modificare il tuo progetto dopo averlo presentato, lo vuoi presentare lo stesso?"},
...
"tooFewBlocksMsg":function(d){return "Stai usando tutti i tipi di blocchi necessari, ma prova usando più blocchi di questo tipo per completare l'esercizio."},
...
"unnamedFunction":function(d){return "C'è una variabile o una funzione che non ha un nome. Non dimenticare di dare ad ogni cosa un nome descrittivo."},
