...
"createACircle":function(d){return "crea un cerchio"},
"createSnowflakeSquare":function(d){return "crea un fiocco di neve a forma di quadrato"},
"createSnowflakeParallelogram":function(d){return "crea un fiocco di neve a forma di parallelogramma"},
"createSnowflakeLine":function(d){return "crea un fiocco di neve a forma di linea"},
"createSnowflakeSpiral":function(d){return "crea un fiocco di neve a forma di spirale"},
"createSnowflakeFlower":function(d){return "crea un fiocco di neve a forma di fiore"},
"createSnowflakeFractal":function(d){return "crea un fiocco di neve a forma di frattale"},
"createSnowflakeRandom":function(d){return "crea un fiocco di neve di forma scelta a caso"},
"createASnowflakeBranch":function(d){return "crea un ramo di un fiocco di neve"},
