...
"bounceBall":function(d){return "rimbalzo della palla"},
"bounceBallTooltip":function(d){return "Rimbalza una palla lontano da un oggetto."},
...
"incrementOpponentScore":function(d){return "l'avversario ha fatto 1 punto"},
"incrementOpponentScoreTooltip":function(d){return "Aggiungi uno al punteggio attuale dell'avversario."},
...
"moveForwardTooltip":function(d){return "Vai avanti di una casella."},
...
"setBackgroundHardcourt":function(d){return "imposta una scena per polo"},
...
"setBallHardcourt":function(d){return "imposta una palla per polo"},
...
"setPaddleHardcourt":function(d){return "imposta una racchetta per polo"},
...
"whenBallMissesPaddleTooltip":function(d){return "Esegue le azioni qua sotto quando la palla manca la racchetta."},
"whenDown":function(d){return "quando si preme la freccia in basso"},
...
"whenLeft":function(d){return "quando si preme la freccia a sinistra"},
...
"whenPaddleCollidedTooltip":function(d){return "Esegue le azioni qua sotto quando la palla colpisce la racchetta."},
"whenRight":function(d){return "quando si preme la freccia a destra"},
"whenRightTooltip":function(d){return "Esegue le azioni qua sotto quando viene premuto il tasto \"freccia a destra\"."},
"whenUp":function(d){return "quando si preme la freccia in alto"},
...
"whenWallCollidedTooltip":function(d){return "Esegue le azioni qua sotto quando una palla colpisce il muro."},
"whileMsg":function(d){return "mentre"},
"whileTooltip":function(d){return "Ripeti le azioni incluse fino a che viene raggiunto il punto finale."},
