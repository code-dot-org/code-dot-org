...
"honeyTooltip":function(d){return "Produci miele dal nettare"},
...
"ifFlowerTooltip":function(d){return "Se c'è un fiore o un favo nella direzione specificata, allora fai alcune azioni."},
"ifelseFlowerTooltip":function(d){return "Se c'è un fiore o un favo nella direzione specificata, allora fai il primo blocco di azioni. Altrimenti, fai il secondo."},
...
"moveEastTooltip":function(d){return "Vai una casella verso est."},
"moveForward":function(d){return "vai avanti"},
"moveForwardTooltip":function(d){return "Vai avanti di una casella."},
"moveNorthTooltip":function(d){return "Vai una casella verso nord."},
"moveSouthTooltip":function(d){return "Vai una casella verso sud."},
"moveTooltip":function(d){return "Vai avanti o indietro di una casella"},
"moveWestTooltip":function(d){return "Vai una casella verso ovest."},
"nectar":function(d){return "prendi il nettare"},
"nectarRemaining":function(d){return "nettare"},
"nectarTooltip":function(d){return "Prendi il nettare dal fiore"},
...
"youSpelled":function(d){return "Hai digitato"}};