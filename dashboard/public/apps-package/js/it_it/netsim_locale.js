...
"addPacket":function(d){return "Aggiungi pacchetto"},
...
"buttonCancel":function(d){return "Annulla"},
"buttonJoin":function(d){return "Join"},
"clear":function(d){return "Cancella"},
"collapse":function(d){return "Collapse"},
"connect":function(d){return "Connect"},
"connected":function(d){return "Connesso"},
...
"decimal":function(d){return "Decimale"},
"defaultNodeName":function(d){return "[New Node]"},
"disconnected":function(d){return "Disconnesso"},
"dns":function(d){return "DNS"},
"dnsMode":function(d){return "Modalità DNS"},
"dnsMode_AUTOMATIC":function(d){return "Automatico"},
"dnsMode_MANUAL":function(d){return "Manuale"},
...
"hexadecimal":function(d){return "Esadecimale"},
...
"logStatus_success":function(d){return "Fatto"},
"markAsRead":function(d){return "Mark as read"},
"message":function(d){return "Messaggio"},
"myDevice":function(d){return "Il mio dispositivo"},
...
"numBitsPerPacket":function(d){return netsim_locale.v(d,"x")+" bit per pacchetto"},
...
"_of_":function(d){return " di "},
"packet":function(d){return "Pacchetto"},
"packetInfo":function(d){return "Info Pacchetto"},
...
"removePacket":function(d){return "Rimuovi Pacchetto"},
...
"routerTab_stats":function(d){return "Statistiche"},
"routerX":function(d){return "Router "+netsim_locale.v(d,"x")},
"send":function(d){return "Invia"},
"sendAMessage":function(d){return "Invia un messaggio"},
...
"status":function(d){return "Stato"},
"to":function(d){return "A"},
"unknownNode":function(d){return "Unknown Node"},
"unlimited":function(d){return "Illimitato"},
"waitingForNodeToConnect":function(d){return "Waiting for "+netsim_locale.v(d,"node")+" to connect..."},
"workspaceHeader":function(d){return "Simulatore di Internet"},
"xOfYPackets":function(d){return netsim_locale.v(d,"x")+" di "+netsim_locale.v(d,"y")},
