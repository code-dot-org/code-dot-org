...
"dropletBlock_setRGB_param3":function(d){return "vermello"},
...
"finalStageTrophies":function(d){return "Congratulations! You have completed the final stage and won "+locale.p(d,"numTrophies",0,"gl",{"one":"a trophy","other":locale.n(d,"numTrophies")+" trophies"})+"."},
...
"nextLevelTrophies":function(d){return "Congratulations! You completed Puzzle "+locale.v(d,"puzzleNumber")+" and won "+locale.p(d,"numTrophies",0,"gl",{"one":"a trophy","other":locale.n(d,"numTrophies")+" trophies"})+"."},
"nextPuzzle":function(d){return "Next Puzzle"},
"nextStage":function(d){return "Congratulations! You completed "+locale.v(d,"stageName")+"."},
"nextStageTrophies":function(d){return "Congratulations! You completed "+locale.v(d,"stageName")+" and won "+locale.p(d,"numTrophies",0,"gl",{"one":"a trophy","other":locale.n(d,"numTrophies")+" trophies"})+"."},
"numBlocksNeeded":function(d){return "Congratulations! You completed Puzzle "+locale.v(d,"puzzleNumber")+". (However, you could have used only "+locale.p(d,"numBlocks",0,"gl",{"one":"1 block","other":locale.n(d,"numBlocks")+" blocks"})+".)"},
"numLinesOfCodeWritten":function(d){return "You just wrote "+locale.p(d,"numLines",0,"gl",{"one":"1 line","other":locale.n(d,"numLines")+" lines"})+" of code!"},
...
"totalNumLinesOfCodeWritten":function(d){return "All-time total: "+locale.p(d,"numLines",0,"gl",{"one":"1 line","other":locale.n(d,"numLines")+" lines"})+" of code."},
