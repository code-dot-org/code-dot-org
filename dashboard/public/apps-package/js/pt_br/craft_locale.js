...
"blockTypeLogSpruce":function(d){return "tronco de pinheiro"},
"blockTypeOreCoal":function(d){return "carvão"},
...
"level11FailureMessage":function(d){return "Certifique-se de ter colocado pedregulho adiante se houver lava. Isto lhe permitirá minerar seguramente esta linha de recursos."},
"level12FailureMessage":function(d){return "Certifique-se de  minerar ao menos 3 blocos de redstone. Combine o que você aprendeu ao longo de construir sua casa e usando a definição \"se\" para evitar cair na lava."},
