...
"dropletBlock_andOperator_description":function(d){return "Retorna true somente quando ambas expressões são verdadeiras e, em outros casos, retorna false"},
...
"dropletBlock_callMyFunction_description":function(d){return "Usa uma função sem um argumento"},
"dropletBlock_callMyFunction_signatureOverride":function(d){return "Call a function"},
"dropletBlock_callMyFunction_n_description":function(d){return "Usa uma função com argumento"},
...
"dropletBlock_declareAssign_x_description":function(d){return "Cria uma variável pela primeira vez"},
...
"dropletBlock_deleteRecord_description":function(d){return "Usando a tabela de armazenamento de dados do Laboratório de Aplicação, exclui o registro fornecido em tableName. O registro é um objeto que deve ser identificado de forma única com seu campo id. Quando a chamada estiver completa, callbackFunction é chamada."},
...
"dropletBlock_functionParams_none_signatureOverride":function(d){return "Defina uma função"},
...
"dropletBlock_moveForward_description":function(d){return "Move a tartaruga para frente um dado número de pixels em sua direção atual"},
...
"dropletBlock_notOperator_description":function(d){return "\"NÃO\" lógico de um booleano"},
...
"dropletBlock_readRecords_description":function(d){return "Usando a tabela de armazenamento de dados do Laboratório de Aplicação, lê os registros da tableName fornecida que correspondem a searchTerms. Quando a chamada estiver completa, callbackFunction é chamada e o array de registros é passado."},
...
"dropletBlock_setRGBA_description":function(d){return "Define o valor dado"},
...
"dropletBlock_updateRecord_description":function(d){return "Usando a tabela de armazenamento de dados do Laboratório de Aplicação, atualiza o registro fornecido em tableName. O registro deve ser identificado de forma única com seu campo id. Quando a chamada estiver completa, callbackFunction é chamada"},
