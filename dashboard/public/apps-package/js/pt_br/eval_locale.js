...
"badColorStringError":function(d){return "Você usou uma cor de string inválida: "+eval_locale.v(d,"val")},
"badStyleStringError":function(d){return "Você usou um estilo de string inválido: "+eval_locale.v(d,"val")},
...
"starBlockTitle":function(d){return "pentagrama (raio, estilo, cor)"},
"radialStarBlockTitle":function(d){return "estrela radial (pontos, interno, externo, estilo, cor)"},
"polygonBlockTitle":function(d){return "polígono (lados, comprimento, estilo, cor)"},
"stringAppendBlockTitle":function(d){return "string-anexar (primeira, segunda)"},
"stringLengthBlockTitle":function(d){return "string-comprimento (string)"},
"textBlockTitle":function(d){return "texto (string, tamanho, cor)"},
"triangleBlockTitle":function(d){return "triângulo (tamanho, estilo, cor)"},
