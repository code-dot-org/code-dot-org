...
"numBitsPerPacket":function(d){return appLocale.v(d,"x")+" bits por pacote"},
"numBitsPerChunk":function(d){return appLocale.v(d,"numBits")+" bits por parte"},
...
"routerX":function(d){return "Roteador "+appLocale.v(d,"x")},
...
"setWireToValue":function(d){return "Definir fio com o valor "+appLocale.v(d,"value")},
...
"waitingForNodeToConnect":function(d){return "Esperando por "+appLocale.v(d,"node")+" para fazer a conexão..."},
"workspaceHeader":function(d){return "Simulador de internet"},
"xOfYPackets":function(d){return appLocale.v(d,"x")+" de "+appLocale.v(d,"y")},
"xSecondPerPulse":function(d){return appLocale.v(d,"x")+" segundo por pulso"},
"xSecondsPerPulse":function(d){return appLocale.v(d,"x")+" segundos por pulso"},
...
"x_KBytes":function(d){return appLocale.v(d,"x")+"MB"},
