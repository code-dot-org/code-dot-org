...
"drawASnowman":function(d){return "თოვლის კაცის დახატვა"},
...
"numBlocksNeeded":function(d){return "ამ თავსატეხის ამოხსნა შეიძლება %1 ბლოკით. თქვენ გამოიყენეთ %2."},
...
"reinfFeedbackMsg":function(d){return "ესეც თქვენი ნახატი! განაგრძეთ მასზე მუშაობა ან გადადით შემდეგ თავსატეხზე."},
"setAlpha":function(d){return "დააყენეთ ალფა"},
...
"shareDrawing":function(d){return "გააზიარეთ თქვენი ნახატი:"},
...
"tooFewColours":function(d){return "ამ თავსატეხისთვის საჭიროა მინიმუმ %1 განსხვავებული ფერის გამოყენება. თქვენ კი მხოლოდ %2 გამოიყენეთ."},
...
"wrongColour":function(d){return "თქვენი სურათი არასწორი ფერისაა. ამ თავსატეხისთვის, ის საჭიროა იყოს %1."}};