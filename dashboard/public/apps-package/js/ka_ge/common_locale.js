...
"finalStage":function(d){return "გილოცავ! თქვენ შეასრულე საბოლოო ნაბიჯი."},
"finalStageTrophies":function(d){return "გილოცავ! თქვენ შეასრულე საბოლოო ნაბიჯი და მოიგე "+common_locale.p(d,"numTrophies",0,"en",{"one":"a trophy","other":common_locale.n(d,"numTrophies")+" trophies"})+"."},
...
"saveToGallery":function(d){return "შენახვა"},
