...
"incrementOpponentScoreTooltip":function(d){return "დაუმატეთ ერთი ქულა მოწინააღმდეგის მიმდინარე ანგარიშს."},
...
"isWall":function(d){return "ეს კედელია"},
...
"launchBallTooltip":function(d){return "ბურთის გაშვება თამაშში."},
"makeYourOwn":function(d){return "შექმენით თქენი საკუთარი Bounce თამაში"},
...
"setBackgroundHardcourt":function(d){return "სცენის დაყენება მყარი ზედაპირით"},
...
"setPaddleRandom":function(d){return "შემთხვევითი პლატფორმის დაყენება"},
...
"shareBounceTwitter":function(d){return "ნახეთ ჩემი გაკეთებული Bounce თამაში. მე თვითონ დავწერე @codeorg-ზე"},
...
"whenGameStartsTooltip":function(d){return "შეასრულეთ ქვემოთ მოცემული მოქმედებები, როცა თამაში დაიწყება."},
