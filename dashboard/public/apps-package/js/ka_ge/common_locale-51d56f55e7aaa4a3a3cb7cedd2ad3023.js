...
"dropletBlock_return_signatureOverride":function(d){return "დაბრუნება"},
...
"emptyExampleBlockErrorMsg":function(d){return "ფუნქციაში "+common_locale.v(d,"functionName")+" გჭირდება ერთი მაგალითი მაინც. დარწმუნდი რომ ყველა მაგალითს აქვს გამოძახება და შედეგი."},
...
"emptyTopLevelBlock":function(d){return "გასაშვები ბლოკები არ არის. საჭიროა ბლოკი "+common_locale.v(d,"topLevelBlockName")+" ბლოკს დაუკავშირო."},
...
"errorParamInputUnattached":function(d){return "დაიმახსოვრე რომ შენს სამუშაო სივრცეში ფუნქციის ბლოკის თითოეული შემავალი მონაცემის პარამეტრს ბლოკი დაუკავშირო."},
...
"exampleErrorMessage":function(d){return "შენი ფუნქცია "+common_locale.v(d,"functionName")+" შეიცავს ერთ ან მეტ მაგალითს, რომელსაც შესწორება ესაჭიროება. დარწმუნდი რომ ისინი ემთხვევიან შენს განმარტებას და უპასუხე კითხვას."},
"examplesFailedOnClose":function(d){return "ერთი ან მეტი მაგალითი არ ემთხვევა შენს განმარტებას. შეამოწმე შენი მაგალითები დახურვამდე"},
...
"ignore":function(d){return "იგნორი"},
...
"missingBlocksErrorMsg":function(d){return "სცადე ერთი ან მეტი ქვემოთ მოცემული ბლოკი, რათა ამოხსნა თავსატეხი."},
...
"repeat":function(d){return "გაიმეორე"},
...
"showVersionsHeader":function(d){return "ვერსიის ისტორია"},
...
"unnamedFunction":function(d){return "შენს ცვლადს ან ფუნქციას სახელი არ აქვს. არ დაგავიწყდეს ყველაფრისთვის დამახასიათებელი სახელის დარქმევა."},
"wantToLearn":function(d){return "გსურთ შეისწავლოთ პროგრამირება?"},
