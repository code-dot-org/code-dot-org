...
"badColorStringError":function(d){return "Użyłeś nieprawidłowej wartości opisującej kolor: "+eval_locale.v(d,"val")},
"badStyleStringError":function(d){return "Użyłeś nieprawidłowej wartości dla stylu: "+eval_locale.v(d,"val")},
"circleBlockTitle":function(d){return "okrąg (promień, styl, kolor)"},
"displayBlockTitle":function(d){return "oblicz"},
"ellipseBlockTitle":function(d){return "elipsa (szerokość, wysokość, styl, kolor)"},
"extraTopBlocks":function(d){return "Masz niepodłączone bloki. Czy zamierzałeś dołączyć je do bloku \"wykonaj\"?"},
...
"reinfFeedbackMsg":function(d){return "Możesz nacisnąć przycisk \"Odtwarzaj Dalej\" aby edytować program."},
"rotateImageBlockTitle":function(d){return "obróć  (stopnie, obraz)"},
"scaleImageBlockTitle":function(d){return "skala (czynnik, obraz)"},
...
"triangleBlockTitle":function(d){return "trójkąt (rozmiar, styl, kolor)"},
...
"stringMismatchError":function(d){return "Masz ciąg liter z niewłaściwymi wielkimi/małymi literami."},
