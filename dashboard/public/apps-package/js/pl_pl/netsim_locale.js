...
"addPacket":function(d){return "Dodaj pakiet"},
...
"autoDnsUsageMessage":function(d){return "Automatyczny Węzeł DNS\nUżycie: GET nazwa-hosta [nazwa-hosta [nazwa-hosta...]]"},
"binary":function(d){return "Binarny"},
"bitCounter":function(d){return netsim_locale.v(d,"x")+"/"+netsim_locale.v(d,"y")+" bity"},
"bits":function(d){return "Bitów"},
"buttonAccept":function(d){return "Zaakceptuj"},
"buttonCancel":function(d){return "Anuluj"},
"buttonJoin":function(d){return "Dołącz"},
"clear":function(d){return "Wyczyść"},
"collapse":function(d){return "Zwiń"},
"connect":function(d){return "Połącz"},
"connected":function(d){return "Połączono"},
"connectedToNodeName":function(d){return "Podłączono do "+netsim_locale.v(d,"nodeName")},
"connectingToNodeName":function(d){return "Nawiązuję połączenie z "+netsim_locale.v(d,"nodeName")},
...
"decimal":function(d){return "Dziesiętny"},
"defaultNodeName":function(d){return "[New Node]"},
"disconnected":function(d){return "Rozłączono"},
"dns":function(d){return "DNS"},
"dnsMode":function(d){return "Tryb DNS"},
"dnsMode_AUTOMATIC":function(d){return "Automatycznie"},
"dnsMode_MANUAL":function(d){return "Ręcznie"},
"dnsMode_NONE":function(d){return "Brak"},
"dropdownPickOne":function(d){return "-- PICK ONE --"},
"encoding":function(d){return "Kodowanie"},
"expand":function(d){return "Expand"},
"from":function(d){return "Z"},
"hex":function(d){return "Hex"},
"hexadecimal":function(d){return "Szesnastkowy"},
...
"message":function(d){return "Wiadomość"},
"myDevice":function(d){return "Moje urządzenie"},
...
"numBitsPerPacket":function(d){return netsim_locale.v(d,"x")+" bitów na pakiet"},
...
"packet":function(d){return "Pakiet"},
"packetInfo":function(d){return "Informacja o pakiecie"},
...
"receivedMessageLog":function(d){return "Odebrane wiadomości dziennika"},
"removePacket":function(d){return "Usuń pakiet"},
...
"routerTab_bandwidth":function(d){return "Przepustowość"},
"routerTab_memory":function(d){return "Pamięć"},
"routerTab_stats":function(d){return "Stats"},
"routerX":function(d){return "Router "+netsim_locale.v(d,"x")},
"send":function(d){return "Wyślij"},
"sendAMessage":function(d){return "Wyślij wiadomość"},
"sendBits":function(d){return "Send Bits"},
"sentBitsLog":function(d){return "Sent Bits Log"},
"sentMessageLog":function(d){return "Wyślij wiadomość dziennika"},
...
"status":function(d){return "Stan"},
"to":function(d){return "Do"},
"unknownNode":function(d){return "Unknown Node"},
"unlimited":function(d){return "Nieograniczony"},
"waitingForNodeToConnect":function(d){return "Waiting for "+netsim_locale.v(d,"node")+" to connect..."},
"workspaceHeader":function(d){return "Symulator Internetowy"},
"xOfYPackets":function(d){return netsim_locale.v(d,"x")+" z "+netsim_locale.v(d,"y")},
