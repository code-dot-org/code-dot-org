...
"moveSpriteN":function(d){return "przenieś postać "+appLocale.v(d,"spriteIndex")},
...
"projectileRapunzel":function(d){return "Roszpunka (Rapunzel)"},
...
"saySpriteN":function(d){return "postać "+appLocale.v(d,"spriteIndex")+" mówi"},
...
"setSpriteN":function(d){return "ustaw postać "+appLocale.v(d,"spriteIndex")},
...
"stopSpriteN":function(d){return "zatrzymaj postać "+appLocale.v(d,"spriteIndex")},
"stopTooltip":function(d){return "Zatrzymuje ruch postaci."},
"throwSprite":function(d){return "rzuć"},
"throwSpriteN":function(d){return "rzut "+appLocale.v(d,"spriteIndex")+" postaci"},
"throwTooltip":function(d){return "Wyrzuca pocisk z określonej postaci."},
"vanish":function(d){return "znika"},
"vanishActorN":function(d){return "znika postać "+appLocale.v(d,"spriteIndex")},
...
"whenSpriteClickedN":function(d){return "gdy postać "+appLocale.v(d,"spriteIndex")+" kliknie"},
"whenSpriteClickedTooltip":function(d){return "Wykonaj czynności poniżej po kliknięciu na postaci."},
"whenSpriteCollidedN":function(d){return "kiedy postać "+appLocale.v(d,"spriteIndex")},
...
"whenSpriteCollidedWithN":function(d){return "dotyka postaci "+appLocale.v(d,"spriteIndex")},
