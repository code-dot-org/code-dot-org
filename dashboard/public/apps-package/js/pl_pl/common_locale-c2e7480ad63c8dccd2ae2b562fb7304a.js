...
"emptyExampleBlockErrorMsg":function(d){return "Potrzebujesz co najmniej jednego przykładu na w funkcję "+common_locale.v(d,"functionName")+". Upewnij się, że każdy przykład zawiera wywołanie i wynik."},
