...
"blockDestroyBlock":function(d){return "zniszczyć blok"},
...
"blockPlantCrop":function(d){return "sadzonki"},
...
"blockTypeEmpty":function(d){return "skała macierzysta"},
...
"blockTypeLogOak":function(d){return "bal dębiny"},
"blockTypeLogSpruce":function(d){return "bal świerkowy"},
...
"level7FailureMessage":function(d){return "Użyj polecenia \"zasadź\", aby posadzić uprawy na każdym kawałku ciemnej gleby."},
"level8FailureMessage":function(d){return "Jeśli dotkniesz czychacza to wybuchnie. Przemykaj dookoła nich, aby dostać się do Twojego domu."},
"level9FailureMessage":function(d){return "Nie zapomnij umieścić co najmniej 2 pochodni, aby oświetlić sobie drogę ORAZ wykop co namniej 2 bloki węgla."},
...
"playerSelectLetsGetStarted":function(d){return "Zaczynajmy!"},
"reinfFeedbackMsg":function(d){return "Możesz nacisnąć przycisk \"Graj\" (Keep Playing), by wrócić do swojej gry."},
