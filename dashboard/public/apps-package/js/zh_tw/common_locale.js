...
"clearPuzzleConfirm":function(d){return "這將會重置當前謎陣至啟始狀態，並會刪除你所加入或修改的模塊。　　"},
...
"missingRecommendedBlocksErrorMsg":function(d){return "不完全正確。請試一個你未使用過的模塊。"},
