...
"moveSpriteN":function(d){return "移動演員"+appLocale.v(d,"spriteIndex")},
...
"saySpriteChoices_1":function(d){return "嘿，你好！"},
...
"setSpriteEmotionAngry":function(d){return "設置憤怒模式"},
...
"setSpriteAnna":function(d){return "安娜形象"},
"setSpriteElsa":function(d){return "艾爾莎形象"},
...
"setSpriteN":function(d){return "選擇演員"+appLocale.v(d,"spriteIndex")},
...
"throwSpriteN":function(d){return "演員 "+appLocale.v(d,"spriteIndex")+" 發射"},
"throwTooltip":function(d){return "由指定的主角發射導彈。"},
"vanish":function(d){return "消失"},
"vanishActorN":function(d){return "讓演員 "+appLocale.v(d,"spriteIndex")+" 消失"},
...
"whenSpriteClickedN":function(d){return "當演員 "+appLocale.v(d,"spriteIndex")+" 被點擊時"},
"whenSpriteClickedTooltip":function(d){return "當演員被點擊時執行動作"},
"whenSpriteCollidedN":function(d){return "當演員 "+appLocale.v(d,"spriteIndex")},
...
"whenSpriteCollidedWithN":function(d){return "接觸演員"+appLocale.v(d,"spriteIndex")},
