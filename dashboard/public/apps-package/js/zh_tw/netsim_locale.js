...
"bitCounter":function(d){return netsim_locale.v(d,"x")+" / "+netsim_locale.v(d,"y")+" 位元"},
...
"numBitsPerPacket":function(d){return "每個封包"+netsim_locale.v(d,"x")+"位元"},
...
"routerX":function(d){return "路由器 "+netsim_locale.v(d,"x")},
...
"xOfYPackets":function(d){return netsim_locale.v(d,"y")+" 的 "+netsim_locale.v(d,"x")},
