...
"tooManyBlocksFail":function(d){return "恭喜你! 完成了謎題"+craft_locale.v(d,"puzzleNumber")+"。它也可以使用 "+craft_locale.p(d,"numBlocks",0,"zh",{"one":"1 程式積木","other":craft_locale.n(d,"numBlocks")+" 程式積木"})}};