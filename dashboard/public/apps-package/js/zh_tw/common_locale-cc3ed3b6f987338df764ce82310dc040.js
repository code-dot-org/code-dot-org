...
"emptyBlockInFunction":function(d){return "函數 "+common_locale.v(d,"name")+" 尚未被輸入。"},
...
"emptyTopLevelBlock":function(d){return "現在並沒有可運行的積木。您必須將一個積木附加到 "+common_locale.v(d,"topLevelBlockName")+" 積木。"},
...
"submitYourProjectConfirm":function(d){return "你不能在提交後再度編輯您的專案，真正提交?"},
