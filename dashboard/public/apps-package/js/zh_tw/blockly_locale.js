...
Blockly.Msg.CONTROLS_FOR_INPUT_FROM_TO_BY = "從 %1 到 %2 每次跳 %3";
...
Blockly.Msg.DEFINE_FUNCTION_FOR_EXAMPLE = "請先定義下方的函數，然後再試一次。";
Blockly.Msg.DELETE = "删除";
Blockly.Msg.DELETE_BLOCK = "刪除積木";
Blockly.Msg.DELETE_PARAMETER = "刪除參數...";
Blockly.Msg.DELETE_PARAMETER_TITLE = "這將刪除所有出現的「%1」參數。您確定嗎？";
...
Blockly.Msg.HELP = "說明";
Blockly.Msg.INLINE_INPUTS = "行內輸入";
Blockly.Msg.KEEP = "保留";
