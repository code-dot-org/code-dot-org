...
Blockly.Msg.COLOUR_BLEND_TOOLTIP = "用給定的比率 (0.0-1.0) 來混合兩種顏色。";
...
Blockly.Msg.CONFIRM_DELETE_FUNCTION_MESSAGE = "警告! 你確定你想刪除 %1?";
Blockly.Msg.CONTRACT_EDITOR_HEADER = "設計範本";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_HELPURL = "https://code.google.com/p/blockly/wiki/Loops#Loop_Termination_Blocks";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_OPERATOR_BREAK = "跳出迴圈";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_OPERATOR_CONTINUE = "繼續下一輪迴圈";
...
Blockly.Msg.CONTROLS_FOR_INPUT_FROM_TO_BY = "從 %1 到 %2 每隔 %3";
...
Blockly.Msg.DEFINE_HEADER_DEFINITION = "定義";
Blockly.Msg.DEFINE_FUNCTION_DEFINE = "定義";
Blockly.Msg.DEFINE_FUNCTION_FOR_EXAMPLE = "請先定義下方的函數，然後重試。";
Blockly.Msg.DELETE = "删除";
Blockly.Msg.DELETE_BLOCK = "刪除積木";
Blockly.Msg.DELETE_PARAMETER = "刪除參數...";
Blockly.Msg.DELETE_PARAMETER_TITLE = "這將刪除所有出現的「%1」參數。你確定嗎？";
...
Blockly.Msg.EXAMPLE_DESCRIPTION = "定義一個例子，包括預期與實際行為";
...
Blockly.Msg.FUNCTION_DESCRIPTION_LABEL = "您的函式要用來做甚麼呢？";
Blockly.Msg.FUNCTION_PARAMETERS_LABEL = "您的函式要使用哪些參數呢？";
Blockly.Msg.FUNCTION_HEADER = "函式";
Blockly.Msg.FUNCTIONAL_CREATE = "新增積木";
...
Blockly.Msg.LISTS_GET_INDEX_GET = "獲取";
...
Blockly.Msg.MATH_CHANGE_INPUT_BY = "變化量為";
...
Blockly.Msg.MATH_RANDOM_FLOAT_TITLE_RANDOM = "產生隨機分數";
...
Blockly.Msg.MATH_RANDOM_INT_TITLE = "產生一個介於 %1 與 %2 間的隨機整數";
...
Blockly.Msg.MATH_ROUND_TOOLTIP = "取數字的概數。";
...
Blockly.Msg.PROCEDURES_DEFNORETURN_TITLE = "執行";
...
Blockly.Msg.PROCEDURES_DEF_DUPLICATE_WARNING = "警告: 此函式有重複的參數。";
...
Blockly.Msg.PROCEDURES_MUTATORARG_TITLE = "輸入參數名稱:";
...
Blockly.Msg.TEXT_APPEND_APPENDTEXT = "附加文字";
Blockly.Msg.TEXT_APPEND_HELPURL = "網址  code.google.com/p/blockly/wiki/Text#Text_modification";
Blockly.Msg.TEXT_APPEND_TO = "到";
Blockly.Msg.TEXT_APPEND_TOOLTIP = "附加一些文字到變數 '%1'。";
...
Blockly.Msg.TEXT_CREATE_JOIN_TOOLTIP = "新增、 刪除或重新排列各區塊來此重新配置這個文字積木。";
...
Blockly.Msg.TEXT_GET_SUBSTRING_START_FIRST = "取得從第一個字元開始的字串";
Blockly.Msg.TEXT_GET_SUBSTRING_START_FROM_END = "取得從第 # 個字元到結尾的字串";
Blockly.Msg.TEXT_GET_SUBSTRING_START_FROM_START = "取得從第 # 個字元開始的字串";
...
Blockly.Msg.TEXT_ISEMPTY_HELPURL = "網址  code.google.com/p/blockly/wiki/Text#Checking_for_empty_text";
Blockly.Msg.TEXT_ISEMPTY_TITLE = "%1 為空";
Blockly.Msg.TEXT_ISEMPTY_TOOLTIP = "如果提供的字串為空，則傳回真。";
...
Blockly.Msg.TEXT_LENGTH_TOOLTIP = "傳回這串文字的字元數(含空格)。";
Blockly.Msg.TEXT_PRINT_HELPURL = "網址  code.google.com/p/blockly/wiki/Text#Printing_text";
Blockly.Msg.TEXT_PRINT_TITLE = "印出 %1";
Blockly.Msg.TEXT_PRINT_TOOLTIP = "印出指定的文字、 數字或其他值。";
Blockly.Msg.TEXT_PROMPT_HELPURL = "網址  code.google.com/p/blockly/wiki/Text#Getting_input_from_the_user";
...
Blockly.Msg.TEXT_TRIM_HELPURL = "網址  code.google.com/p/blockly/wiki/Text#Trimming_%28removing%29_spaces";
Blockly.Msg.TEXT_TRIM_OPERATOR_BOTH = "刪除兩邊空格";
Blockly.Msg.TEXT_TRIM_OPERATOR_LEFT = "刪除左邊空格";
Blockly.Msg.TEXT_TRIM_OPERATOR_RIGHT = " 刪除右邊空格";
