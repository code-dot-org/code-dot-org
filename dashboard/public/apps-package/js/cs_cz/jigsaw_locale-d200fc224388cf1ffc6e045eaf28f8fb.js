var jigsaw_locale = {lc:{"ar":function(n){
  if (n === 0) {
    return 'zero';
  }
  if (n == 1) {
...
"nextLevel":function(d){return "Gratulujeme! Dokončil jsi toto puzzle."},
"no":function(d){return "Ne"},
"numBlocksNeeded":function(d){return "Tato hádanka může být vyřešena s %1 blocky."},
