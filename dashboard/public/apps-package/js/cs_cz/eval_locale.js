...
"displayBlockTitle":function(d){return "vypočítat"},
...
"rectangleBlockTitle":function(d){return "obdélník (šířka, výška, styl, barva)"},
"reinfFeedbackMsg":function(d){return "Můžeš stisknout tlačítko \"Zkusit znovu\" a upravit svůj obrázek."},
"rotateImageBlockTitle":function(d){return "otočení (stupně, obrázek)"},
"scaleImageBlockTitle":function(d){return "zvětšit (kolikrát)"},
"squareBlockTitle":function(d){return "čtverec (velikost, styl, barva)"},
"starBlockTitle":function(d){return "hvězda (poloměr, styl, barva)"},
"radialStarBlockTitle":function(d){return "radial-star (body, vnitřní, vnější, styl, barva)"},
"polygonBlockTitle":function(d){return "polygon (sides, length, style, color)"},
"stringAppendBlockTitle":function(d){return "spojit řetězce (první, druhý)"},
"stringLengthBlockTitle":function(d){return "Délka řetězce (string)"},
"textBlockTitle":function(d){return "text (řetězec, velikost, barva)"},
"triangleBlockTitle":function(d){return "trojúhelník (velikost, styl, barva)"},
