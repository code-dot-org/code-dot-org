...
"incrementOpponentScore":function(d){return "přidat bod soupeři"},
"incrementOpponentScoreTooltip":function(d){return "Přičti jedničku do aktuálního skóre soupeře."},
"incrementPlayerScore":function(d){return "Bod"},
"incrementPlayerScoreTooltip":function(d){return "Přidá aktuálnímu hráči jeden bod."},
"isWall":function(d){return "je toto zeď"},
"isWallTooltip":function(d){return "Vrací hodnotu pravda, pokud je zde zeď"},
"launchBall":function(d){return "spustit nový míč"},
"launchBallTooltip":function(d){return "Dát míč do hry."},
"makeYourOwn":function(d){return "Vyrobte si vlastní hru Odrazit"},
"moveDown":function(d){return "pohyb dolů"},
"moveDownTooltip":function(d){return "Přesuňte pálku dolů."},
...
"moveLeftTooltip":function(d){return "Přesuňte pálku vlevo."},
"moveRight":function(d){return "pohnout vpravo"},
"moveRightTooltip":function(d){return "Posuňte pálku vpravo."},
"moveUp":function(d){return "pohnout nahoru"},
"moveUpTooltip":function(d){return "Posuňte pálku nahoru."},
...
"setBallTooltip":function(d){return "Nastavit obraz míče"},
...
"setPaddleTooltip":function(d){return "Nastaví se vzhled pálky"},
...
"shareBounceTwitter":function(d){return "Zkontrolujte hru Odraz, kterou jsem vytvořil. Napsal jsem ji sám s @codeorg"},
...
"whenBallInGoalTooltip":function(d){return "Spusťte níže uvedené akce, když míč spadne do brány."},
"whenBallMissesPaddle":function(d){return "když míč mine pálku"},
"whenBallMissesPaddleTooltip":function(d){return "Spusťte níže uvedené akce, když míč mine do pálku."},
...
"whenPaddleCollidedTooltip":function(d){return "Spusť níže uvedené akce, když se míč dotkne pálky."},
...
"whenWallCollidedTooltip":function(d){return "Spusťte níže uvedené akce, když se míč dotkne zdi."},
