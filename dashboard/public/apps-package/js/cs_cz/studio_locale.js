...
"moveSpriteN":function(d){return "pohnout hercem "+appLocale.v(d,"spriteIndex")},
...
"saySpriteN":function(d){return "herec "+appLocale.v(d,"spriteIndex")+" říká"},
...
"setSpriteN":function(d){return "nastavit herece "+appLocale.v(d,"spriteIndex")},
...
"stopSpriteN":function(d){return "zastavit herce "+appLocale.v(d,"spriteIndex")},
"stopTooltip":function(d){return "Zastaví pohyb herce."},
"throwSprite":function(d){return "hoď"},
"throwSpriteN":function(d){return "herec "+appLocale.v(d,"spriteIndex")+" hodí"},
"throwTooltip":function(d){return "Hodí střelu od zadaného herce."},
"vanish":function(d){return "zmiz"},
"vanishActorN":function(d){return "zmiz herec "+appLocale.v(d,"spriteIndex")},
...
"whenSpriteClickedN":function(d){return "po kliknutí na herce "+appLocale.v(d,"spriteIndex")},
"whenSpriteClickedTooltip":function(d){return "Provést uvedené akce po kliknutí na herce."},
"whenSpriteCollidedN":function(d){return "když se herec "+appLocale.v(d,"spriteIndex")},
...
"whenSpriteCollidedWithN":function(d){return "dotkne herce "+appLocale.v(d,"spriteIndex")},
