...
"exampleErrorMessage":function(d){return "Функцията "+common_locale.v(d,"functionName")+" има един или повече примери, които се нуждаят от коригиране. Уверете се, че те отговарят на вашата дефиниция и отговорят на въпроса."},
