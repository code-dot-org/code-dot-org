...
"createHtmlBlock":function(d){return "създаване на  html блок"},
"createHtmlBlockTooltip":function(d){return "Създава HTML блок в приложение."},
...
"shareWebappTwitter":function(d){return "Вижте приложението, което направих. Аз сам го написал с @codeorg"},
...
"turnBlack":function(d){return "включва черно"},
"turnBlackTooltip":function(d){return "Включва черен екран."},
