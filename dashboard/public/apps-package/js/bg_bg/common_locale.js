...
"dropletBlock_randomNumber_min_max_description":function(d){return "Връща случайно число в затворен диапазон от минимална до максимална стойност."},
...
"hintReviewTitle":function(d){return "Прегледайте вашите съвети"},
"hintSelectInstructions":function(d){return "Инструкции и предишни съвети"},
"hintSelectNewHint":function(d){return "Получете нов съвет"},
...
"saveToGallery":function(d){return "Запазване"},
