...
"dropletBlock_arcLeft_param1_description":function(d){return "Радиусът на окръжността, който е поставен отляво на костенурка. Трябва да бъде > = 0."},
...
"dropletBlock_arcRight_param1_description":function(d){return "Радиусът на окръжността, който се поставя отдясно на костенурка. Трябва да бъде > = 0."},
"dropletBlock_assign_x_description":function(d){return "Задава стойност на съществуваща променлива. За пример, x = 0;"},
"dropletBlock_assign_x_param0":function(d){return "x"},
"dropletBlock_assign_x_param0_description":function(d){return "Името на променливата, което му е асоциирано"},
...
"dropletBlock_button_param0_description":function(d){return "Уникален идентификатор за бутона. ИД се използва за разпознаване на създадения бутон. Например, за да присвояване на манипулатори."},
...
"dropletBlock_console.log_param0_description":function(d){return "Съобщение низ за показване в конзолата."},
...
"dropletBlock_declareAssign_x_prompt_param1_description":function(d){return "Низът, който потребителят ще види вбалон когато иска да се въвед стойност"},
...
"dropletBlock_getAlpha_param0_description":function(d){return "Обектът с данни от изображение, описва заснети данни от елемент на платното (използване [getImageData()](/applab/docs/getImageData))"},
"dropletBlock_getAlpha_param1":function(d){return "x"},
"dropletBlock_getAlpha_param1_description":function(d){return "X позиция в пиксели, започвайки от горния ляв ъгъл на изображението."},
"dropletBlock_getAlpha_param2":function(d){return "y"},
"dropletBlock_getAlpha_param2_description":function(d){return "Y позиция в пиксели, започвайки от горния ляв ъгъл на изображението."},
...
"dropletBlock_getBlue_param0_description":function(d){return "Обектът с данни от изображение, описва заснети данни от елемент на платното (използване [getImageData()](/applab/docs/getImageData))"},
"dropletBlock_getBlue_param1":function(d){return "x"},
"dropletBlock_getBlue_param1_description":function(d){return "X позиция в пиксели, започвайки от горния ляв ъгъл на изображението."},
"dropletBlock_getBlue_param2":function(d){return "y"},
"dropletBlock_getBlue_param2_description":function(d){return "Y позиция в пиксели, започвайки от горния ляв ъгъл на изображението."},
...
"dropletBlock_getGreen_param0_description":function(d){return "Обектът с данни от изображение, описва заснети данни от елемент на платното (използване [getImageData()](/applab/docs/getImageData))"},
"dropletBlock_getGreen_param1":function(d){return "x"},
"dropletBlock_getGreen_param1_description":function(d){return "X позиция в пиксели, започвайки от горния ляв ъгъл на изображението."},
"dropletBlock_getGreen_param2":function(d){return "y"},
"dropletBlock_getGreen_param2_description":function(d){return "Y позиция в пиксели, започвайки от горния ляв ъгъл на изображението."},
...
"dropletBlock_getRed_param0_description":function(d){return "Обектът с данни от изображение, описва заснети данни от елемент на платното (използване [getImageData()](/applab/docs/getImageData))"},
"dropletBlock_getRed_param1":function(d){return "x"},
"dropletBlock_getRed_param1_description":function(d){return "X позиция в пиксели, започвайки от горния ляв ъгъл на изображението."},
"dropletBlock_getRed_param2":function(d){return "y"},
"dropletBlock_getRed_param2_description":function(d){return "Y позиция в пиксели, започвайки от горния ляв ъгъл на изображението."},
...
"dropletBlock_moveTo_param1_description":function(d){return "На y координатата на екрана, за преместване на костенурката."},
...
"dropletBlock_move_param1_description":function(d){return "Броят на пикселите, за да преместите костенурката надолу."},
...
"dropletBlock_penRGB_description":function(d){return "Задава цвета на линия зад костенурката, докато се движи, на определени RGB стойности"},
...
"dropletBlock_putImageData_param0_description":function(d){return "Обектът с данни от изображение, описва заснети данни от елемент на платното (използване [getImageData()](/applab/docs/getImageData))"},
...
"dropletBlock_randomNumber_max_param0":function(d){return "максимално"},
"dropletBlock_randomNumber_max_param0_description":function(d){return "Максималният брой върнати"},
...
"dropletBlock_randomNumber_min_max_param0":function(d){return "минимално"},
"dropletBlock_randomNumber_min_max_param0_description":function(d){return "Минималният брой върнати"},
"dropletBlock_randomNumber_min_max_param1":function(d){return "максимално"},
"dropletBlock_randomNumber_min_max_param1_description":function(d){return "Максималният брой върнати"},
...
"dropletBlock_setAlpha_param0_description":function(d){return "Обектът с данни от изображение, описва заснети данни от елемент на платното (използване [getImageData()](/applab/docs/getImageData))"},
"dropletBlock_setAlpha_param1":function(d){return "x"},
"dropletBlock_setAlpha_param1_description":function(d){return "X позиция в пиксели, започвайки от горния ляв ъгъл на изображението."},
"dropletBlock_setAlpha_param2":function(d){return "y"},
"dropletBlock_setAlpha_param2_description":function(d){return "Y позиция в пиксели, започвайки от горния ляв ъгъл на изображението."},
"dropletBlock_setAlpha_param3":function(d){return "alphaValue"},
"dropletBlock_setAlpha_param3_description":function(d){return "Размерът на алфа (непрозрачност) (от 0 до 255) да се определят в пиксели."},
...
"dropletBlock_setBlue_param0_description":function(d){return "Обектът с данни от изображение, описва заснети данни от елемент на платното (използване [getImageData()](/applab/docs/getImageData))"},
"dropletBlock_setBlue_param1":function(d){return "x"},
"dropletBlock_setBlue_param1_description":function(d){return "X позиция в пиксели, започвайки от горния ляв ъгъл на изображението."},
"dropletBlock_setBlue_param2":function(d){return "y"},
"dropletBlock_setBlue_param2_description":function(d){return "Y позиция в пиксели, започвайки от горния ляв ъгъл на изображението."},
...
"dropletBlock_setGreen_param0_description":function(d){return "Обектът с данни от изображение, описва заснети данни от елемент на платното (използване [getImageData()](/applab/docs/getImageData))"},
"dropletBlock_setGreen_param1":function(d){return "x"},
"dropletBlock_setGreen_param1_description":function(d){return "X позиция в пиксели, започвайки от горния ляв ъгъл на изображението."},
"dropletBlock_setGreen_param2":function(d){return "y"},
"dropletBlock_setGreen_param2_description":function(d){return "Y позиция в пиксели, започвайки от горния ляв ъгъл на изображението."},
...
"dropletBlock_setRGB_param0_description":function(d){return "Обектът с данни от изображение, описва заснети данни от елемент на платното (използване [getImageData()](/applab/docs/getImageData))"},
"dropletBlock_setRGB_param1":function(d){return "x"},
"dropletBlock_setRGB_param1_description":function(d){return "X позиция в пиксели, започвайки от горния ляв ъгъл на изображението."},
"dropletBlock_setRGB_param2":function(d){return "y"},
"dropletBlock_setRGB_param2_description":function(d){return "Y позиция в пиксели, започвайки от горния ляв ъгъл на изображението."},
...
"dropletBlock_setRed_param0_description":function(d){return "Обектът с данни от изображение, описва заснети данни от елемент на платното (използване [getImageData()](/applab/docs/getImageData))"},
"dropletBlock_setRed_param1":function(d){return "x"},
"dropletBlock_setRed_param1_description":function(d){return "X позиция в пиксели, започвайки от горния ляв ъгъл на изображението."},
"dropletBlock_setRed_param2":function(d){return "y"},
"dropletBlock_setRed_param2_description":function(d){return "Y позиция в пиксели, започвайки от горния ляв ъгъл на изображението."},
...
"dropletBlock_substring_param1_description":function(d){return "Позицията (до, но без да включва) за спиране на извличането."},
