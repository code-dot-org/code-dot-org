...
"blockPlantCrop":function(d){return "растителни култури"},
...
"level10FailureMessage":function(d){return "Покрий лавата, за да прекосиш, а след това постави два железни блока от другата страна."},
"level11FailureMessage":function(d){return "Не забравяйте да поставите калдъръм ако има лава напред. Това ще ви позволи безопасно да копаете ресурси на този ред."},
...
"level5FailureMessage":function(d){return "Поставете блоковете на очертаната земна структура за да построите стена. Розовата команда \"повтори\" ще изпълни всички команди вмъкнати в блока ѝ, като \"постави блок\" и \"върви напред\"."},
"level6FailureMessage":function(d){return "Поставете блокове на очертаната земна структура за къща, за да завършите пъзела."},
...
"playerSelectChooseCharacter":function(d){return "Изберете вашия герой."},
