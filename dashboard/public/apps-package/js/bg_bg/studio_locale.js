...
"moveDistanceTooltip":function(d){return "Преместете актьорът на определена дистанция в определената посока."},
...
"moveDownTooltip":function(d){return "Премести един актьор надолу."},
"moveLeft":function(d){return "движение наляво"},
"moveLeftTooltip":function(d){return "Преместете актьор в ляво."},
...
"moveTooltip":function(d){return "Преместете актьор."},
...
"saySpriteChoices_1":function(d){return "Здравейте всички."},
...
"setBackground":function(d){return "Задайте фон"},
...
"setBackgroundGrassy":function(d){return "Задайте тревист фон"},
"setBackgroundFlower":function(d){return "Задайте фон цвете"},
"setBackgroundTile":function(d){return "задайте фасетен фон"},
"setBackgroundIcy":function(d){return "Задайте леден фон"},
...
"throwSprite":function(d){return "хвърли"},
