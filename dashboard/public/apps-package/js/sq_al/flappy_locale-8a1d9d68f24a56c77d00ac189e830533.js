...
"flapRandom":function(d){return "hidh një sasi të zakonshme"},
"flapVerySmall":function(d){return "hidh një sasi shumë të vogël"},
"flapSmall":function(d){return "hidh një sasi të vogël"},
"flapNormal":function(d){return "hidh një sasi normale"},
"flapLarge":function(d){return "hidh një sasi të madhe"},
"flapVeryLarge":function(d){return "hidh një sasi shumë të madhe"},
"flapTooltip":function(d){return "Hidhe Flappy-n përpara."},
"flappySpecificFail":function(d){return "Kodi yt duket mirë - do të fluturojë me çdo klikim. Por, duhet të klikosh disa herë për të fluturuar deri tek objektivi."},
...
"playSoundDie":function(d){return "luaj tingull të trishtë"},
"playSoundHit":function(d){return "luaj tingull thyerje"},
"playSoundPoint":function(d){return "luaj tingull pike"},
"playSoundSwoosh":function(d){return "luaj tingullin e shushuritjes"},
"playSoundWing":function(d){return "luaj tingull krahësh"},
"playSoundJet":function(d){return "luaj tingullin e motorit reaktiv"},
"playSoundCrash":function(d){return "luaj tingullin e përplasjes"},
"playSoundJingle":function(d){return "luaj tingullin e tringëllimës"},
"playSoundSplash":function(d){return "luaj tingullin e përplasjes në ujë"},
"playSoundLaser":function(d){return "luaj tingullin e lazerit"},
"playSoundTooltip":function(d){return "Vendos tingullin e zgjedhur."},
"reinfFeedbackMsg":function(d){return "Ju mund të shtypni butonin \"Provo Përsëri\" për t'u kthyer mbrapa dhe për të luajtur lojën tuaj."},
"scoreText":function(d){return "Pikë: "+flappy_locale.v(d,"playerScore")},
...
"setBackgroundNight":function(d){return "vendos skenën Qyteti (natë)"},
"setBackgroundSciFi":function(d){return "vendos skenën Fantastiko Shkencorë"},
"setBackgroundUnderwater":function(d){return "vendos skenën Nën ujë"},
"setBackgroundCave":function(d){return "vendos skenën Shpellë"},
"setBackgroundSanta":function(d){return "vendos skenën Babagjyshi"},
"setBackgroundTooltip":function(d){return "Vendos sfondin e imazhit"},
"setGapRandom":function(d){return "vendos një hapësirë të rastësishme"},
"setGapVerySmall":function(d){return "vendos një hapësirë shumë të vogël"},
"setGapSmall":function(d){return "vendos një hapësirë të vogël"},
"setGapNormal":function(d){return "vendos një hapësirë normale"},
"setGapLarge":function(d){return "vendos një hapësirë të madhe"},
"setGapVeryLarge":function(d){return "vendos një hapësirë shumë të madhe"},
"setGapHeightTooltip":function(d){return "Vendos hapësirën vertikale në një pengesë"},
...
"setObstacleRandom":function(d){return "vendose pengesën Random"},
"setObstacleFlappy":function(d){return "Vendos pengesë Tub"},
"setObstacleSciFi":function(d){return "vendos pengesën Fantastike Shkencore"},
"setObstacleUnderwater":function(d){return "vendos pengesën Bimë"},
"setObstacleCave":function(d){return "vendos pengesën Shpellë"},
"setObstacleSanta":function(d){return "vendos pengesën Oxhaku"},
"setObstacleLaser":function(d){return "vendos pengesën Lazer"},
"setObstacleTooltip":function(d){return "Vendos imazhin e pengesës"},
"setPlayer":function(d){return "vendos lojtarin"},
"setPlayerRandom":function(d){return "vendos lojtar të Rastësishëm"},
...
"setPlayerTurkey":function(d){return "vendos lojtarin Gjeli i Detit"},
"setPlayerTooltip":function(d){return "Vendos imazhin e lojtarit"},
"setScore":function(d){return "vendos rezultatin"},
"setScoreTooltip":function(d){return "Vendos pikët e lojtarit"},
...
"speedSlow":function(d){return "vendos shpejtësinë e ngadaltë"},
