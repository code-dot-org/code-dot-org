...
Blockly.Msg.COLOUR_PICKER_TOOLTIP = "Zgjidh një ngjyrë prej tyre.";
...
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_WHILE = "Përderisa një vlerë është e saktë, atëherë krijoni disa raporte.";
Blockly.Msg.DEFINE_HEADER_DEFINITION = "Përcaktimi";
Blockly.Msg.DEFINE_FUNCTION_DEFINE = "Përcakto";
Blockly.Msg.DELETE_BLOCK = "Fshini bllokun";
Blockly.Msg.DELETE_PARAMETER = "Fshini parametrin...";
Blockly.Msg.DELETE_PARAMETER_TITLE = "Kjo do të fshijë të gjithë '%1' parametrat e dukurisë. Jeni i sigurtë?";
...
Blockly.Msg.FUNCTION_DESCRIPTION_LABEL = "Çfarë duhet të bëjë funksioni yt?";
...
Blockly.Msg.FUNCTIONAL_EDIT = "redakto";
...
Blockly.Msg.FUNCTIONAL_RANGE_LABEL = "Varg";
Blockly.Msg.FUNCTIONAL_VARIABLE_CREATE = "Krijo një Vlerë";
Blockly.Msg.FUNCTIONAL_VARIABLE_HEADER = "Vlerë";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_FIRST = "Rikthen tek artikulli i parë në listë.";
...
Blockly.Msg.LISTS_TOOLTIP = "Kthehet i saktë nëse lista është e zbrazët.";
...
Blockly.Msg.LOGIC_BOOLEAN_TOOLTIP = "Kthen ose të saktë ose të pasaktë.";
...
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_EQ = "Kthe të saktë nëse të dy hyrjet janë të barabarta me njëra-tjetrën.";
...
Blockly.Msg.LOGIC_OPERATION_TOOLTIP_AND = "Kthe të saktë nëse të dy hyrjet janë të sakta.";
Blockly.Msg.LOGIC_OPERATION_TOOLTIP_OR = "Kthe të saktë nëse të paktën  njëra nga hyrjet është e saktë.";
Blockly.Msg.LOGIC_TERNARY_CONDITION = "test";
Blockly.Msg.LOGIC_TERNARY_HELPURL = "http://en.wikipedia.org/wiki/%3F:";
Blockly.Msg.LOGIC_TERNARY_IF_FALSE = "nëse e pa saktë";
...
Blockly.Msg.MATH_CHANGE_TOOLTIP = "Shto një numër në velrën '%1'.";
...
Blockly.Msg.MATH_IS_PRIME = "është primar";
...
Blockly.Msg.MATH_MODULO_TOOLTIP = "Kthe mbetësin nga pjestimi i dy numrave.";
...
Blockly.Msg.MATH_ONLIST_TOOLTIP_AVERAGE = "Kthen mesataren (kuptimi aritmetik) i vlerave numerike të listës.";
...
Blockly.Msg.MATH_SINGLE_TOOLTIP_LOG10 = "Kthe 10 logaritmet bazë të një numri.";
...
Blockly.Msg.MATH_TRIG_TOOLTIP_ASIN = "Rikthe arcsin e një numri.";
...
Blockly.Msg.MATH_TRIG_TOOLTIP_SIN = "Rikthe kosinusin e një këndi (jo në radian).";
Blockly.Msg.MATH_TRIG_TOOLTIP_TAN = "Rikthe tangentin e një këndi (jo radian).";
Blockly.Msg.NEW_VARIABLE = "Vlera të reja...";
Blockly.Msg.NEW_VARIABLE_TITLE = "Emri i vlerave të reja:";
...
Blockly.Msg.PROCEDURES_CALLRETURN_TOOLTIP = "Fillo funksionin e përcaktuar nga përdoruesi '%1' dhe përdor daljet e tij.";
...
Blockly.Msg.PROCEDURES_DEFNORETURN_PROCEDURE = "bëj diçka";
...
Blockly.Msg.PROCEDURES_HIGHLIGHT_DEF = "Thekso përcaktimin e funksionit";
Blockly.Msg.PROCEDURES_IFRETURN_TOOLTIP = "Nëse një vlerë është e saktë, atëherë kthe një vlerë të dytë.";
Blockly.Msg.PROCEDURES_IFRETURN_WARNING = "Paralajmërim: Ky bllok mund të përdoret vetëm brënda përcaktimit të funksionit.";
Blockly.Msg.PROCEDURES_MUTATORARG_TITLE = "Fut emrin:";
Blockly.Msg.PROCEDURES_MUTATORCONTAINER_TITLE = "Informacionet e futura";
Blockly.Msg.REMOVE_COMMENT = "Fshi Komentin";
Blockly.Msg.RENAME_PARAMETER = "Riemëro parametrin...";
Blockly.Msg.RENAME_PARAMETER_TITLE = "Riemëro të gjithë '%1' parametrat tek:";
Blockly.Msg.RENAME_VARIABLE = "Riemëro vlerat...";
Blockly.Msg.RENAME_VARIABLE_TITLE = "Riemëro të gjithë '%1' vlerat tek:";
Blockly.Msg.SAVE_AND_CLOSE = "Ruaj dhe Mbyll";
...
Blockly.Msg.TEXT_APPEND_TOOLTIP = "Shto tekst tek vlera '%1'.";
...
Blockly.Msg.TEXT_CHARAT_TOOLTIP = "Kthen një shkronjë nga një pozicion i caktuar.";
Blockly.Msg.TEXT_CREATE_JOIN_ITEM_TOOLTIP = "Shto diçka në tekst.";
...
Blockly.Msg.TEXT_PROMPT_TOOLTIP_TEXT = "Kërkoji përdoruesit ca tekst.";
...
Blockly.Msg.TEXT_TRIM_OPERATOR_BOTH = "rregullo hapësirat nga të dyja anët";
Blockly.Msg.TEXT_TRIM_OPERATOR_LEFT = "rregullo hapësirat nga ana e majtë";
...
Blockly.Msg.VARIABLES_SET_TOOLTIP = "Vendose këtë variabël të jetë e barabartë me të dhënat hyrëse.";
