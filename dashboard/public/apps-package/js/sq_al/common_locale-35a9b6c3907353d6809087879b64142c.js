...
"emptyBlockInVariable":function(d){return "Elementi "+common_locale.v(d,"name")+" ka nje input te paplotesuar."},
...
"emptyTopLevelBlock":function(d){return "Nuk ka blloqe per te drejtuar. Duhet te ngjisesh nje bllok tek blloku "+common_locale.v(d,"topLevelBlockName")+"."},
