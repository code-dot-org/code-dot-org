...
"copy":function(d){return "Kopje, kopjo"},
...
"dropletBlock_mathRandom_description":function(d){return "Kthen nje numer te rastësishëm nga 0 (duke e përfshirë) deri ne por pa e përfshirë 1(duke e përjashtuar)"},
...
"finalStage":function(d){return "Urime! Ju sapo përfunduat formuesen përfundimtare."},
...
"hintSelectInstructions":function(d){return "Vazhdo me instruksionet e selektuara"},
"hintSelectNewHint":function(d){return "Merrni një ndihme te re"},
...
"savedToGallery":function(d){return "E ruajtur"},
...
"unsubmitYourProject":function(d){return "Çrregjistro projektin tuaj"},
"unsubmitYourProjectConfirm":function(d){return "Çrregjistrimi i projektit tuaj do të rivendose datën e rregjistrimit, dëshironi vëretë te çrregjistroheni?"},
