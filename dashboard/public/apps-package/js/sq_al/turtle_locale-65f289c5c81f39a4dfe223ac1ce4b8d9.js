...
"moveForwardTooltip":function(d){return "Lëviz artistin përpara."},
...
"moveTooltip":function(d){return "Lëvize artistin përpara ose mbrapa në varësi të sasisë."},
"notBlackColour":function(d){return "Ju duhet të zgjidhni një ngjyrë të ndryshme nga e zeza për këtë formues."},
"numBlocksNeeded":function(d){return "Ky formues mund të zgjidhej me %1 blloqe. Ju përdorët %2."},
...
"reinfFeedbackMsg":function(d){return "Ja ku është dhe vizatimi yt! Vazhdo puno me të ose vazhdo tek formuesi tjetër."},
...
"showMe":function(d){return "Më shfaq"},
"showTurtle":function(d){return "shfaq artistin"},
"sizeParameter":function(d){return "madhësia"},
"step":function(d){return "hap"},
"tooFewColours":function(d){return "Ti duhet të përdorësh të paktën %1 ngjyra të ndryshme për këtë formues. Ti ke përdorur vetëm %2."},
"turnLeft":function(d){return "kthehu majtas me"},
"turnRight":function(d){return "kthehu djathtas me"},
"turnRightTooltip":function(d){return "Kthen artistin djathtas me këndin e përcaktuar."},
...
"wrongColour":function(d){return "Figura jote është në ngjyrën e gabuar. Për këtë formuese duhet të jetë %1."},
