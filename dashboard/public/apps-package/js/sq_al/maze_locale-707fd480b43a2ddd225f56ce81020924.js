...
"digTooltip":function(d){return "hiq 1 njësi dheu"},
...
"fillTooltip":function(d){return "vendos 1 njësi dheu"},
"finalLevel":function(d){return "Urime! Ju keni përfunduar puzzle përfundimatar."},
...
"ifInRepeatError":function(d){return "Ti ke nevojë për një bllok \"nëse\" brenda një blloku \"përsërit\". Nëse ke probleme, provo nivelin e mëparshëm përsëri, për të parë se si funksionoi atje."},
...
"ifelseTooltip":function(d){return "Nëse ka një rrugë në drejtimin e caktuar, atëherë bëj veprimet e bllokut të parë. Përndryshe, bëj veprimet e grupit të dytë."},
...
"insufficientHoney":function(d){return "Ti je duke përdorur blloqet e duhura, por duhet të bësh sasinë e duhur të mjaltit."},
"insufficientNectar":function(d){return "Ti je duke përdorur blloqet e duhura, por ti duhet të mbledhësh sainë e duhur të nektarit."},
...
"notAtHoneycombError":function(d){return "Ti mund të bësh mjaltë vetëm në një koshere."},
...
"removeAndAvoidTheCow":function(d){return "hiq 1 dhe shmang lopen"},
"removeN":function(d){return "hiq lopata"+maze_locale.v(d,"shovelfuls")},
...
"repeatCarefullyError":function(d){return "Për ta zgjidhur këtë, mendo me kujdes rreth modelit të dy lëvizjeve dhe të një kthimi për ti vendosur në bllokun \"përsërit\". Nuk ka problem nëse ke një kthesë në fund."},
