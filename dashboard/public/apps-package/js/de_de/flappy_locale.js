...
"playSoundRandom":function(d){return "zufälliger Sound wiedergeben"},
"playSoundBounce":function(d){return "Bounce Klang abspielen"},
"playSoundCrunch":function(d){return "Knirschgeräusch abspielen"},
"playSoundDie":function(d){return "trauriger Sound wiedergeben"},
"playSoundHit":function(d){return "smash sound abspielen"},
"playSoundPoint":function(d){return "Pukt Klang abspielen"},
"playSoundSwoosh":function(d){return "Swoosh Sound abspielen"},
"playSoundWing":function(d){return "Flügel sound abspielen"},
"playSoundJet":function(d){return "Jet Sound abspielen"},
"playSoundCrash":function(d){return "Absturz sound abspielen"},
"playSoundJingle":function(d){return "Jingle Klang abspielen"},
"playSoundSplash":function(d){return "platsch sound abspielen"},
"playSoundLaser":function(d){return "Laser sound abspielen"},
...
"setBackgroundRandom":function(d){return "Zufällige Szene einstellen"},
"setBackgroundFlappy":function(d){return "Szene Stadt setzen (Tag)"},
"setBackgroundNight":function(d){return "Szene Stadt (Nacht)"},
"setBackgroundSciFi":function(d){return "Szene Sci-Fi"},
"setBackgroundUnderwater":function(d){return "Szene Unterwasser setzen"},
"setBackgroundCave":function(d){return "Szene Höhle setzen"},
"setBackgroundSanta":function(d){return "Szene Santa setzen"},
...
"setGapLarge":function(d){return "Grosse Lücke setzen"},
"setGapVeryLarge":function(d){return "Sehr grosse Lücke setzen"},
...
"setSpeed":function(d){return "Setzt die Geschwindigkeit"},
"setSpeedTooltip":function(d){return "Setzt die Levelgeschwindigkeit"},
...
"speedRandom":function(d){return "Setze Geschwindigkeit auf zufällig"},
"speedVerySlow":function(d){return "Setze die Geschwindigkeit auf sehr tief"},
"speedSlow":function(d){return "Setze die Geschwindigkeit auf tief"},
"speedNormal":function(d){return "Setze die Geschwindigkeit auf normal"},
"speedFast":function(d){return "Setzt die Geschwindigkeit auf schnell"},
"speedVeryFast":function(d){return "Setzt die Geschwindigkeit auf sehr hoch"},
...
"whenCollideGround":function(d){return "Wenn der Boden berührt wird"},
