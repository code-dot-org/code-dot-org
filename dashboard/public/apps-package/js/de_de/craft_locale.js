...
"blockPlaceXAheadPlace":function(d){return "platzieren"},
"blockPlaceXPlace":function(d){return "platzieren"},
"blockPlantCrop":function(d){return "Ernte anpflanzen"},
"blockShear":function(d){return "scheren"},
"blockTillSoil":function(d){return "bis Boden"},
...
"blockTypeOreCoal":function(d){return "Kohle-Erz"},
"blockTypeOreDiamond":function(d){return "Diamant-Erz"},
"blockTypeOreEmerald":function(d){return "Smaragd-Erz"},
"blockTypeOreGold":function(d){return "Golderz"},
"blockTypeOreIron":function(d){return "Eisenerz"},
"blockTypeOreLapis":function(d){return "Lapis-Erz"},
"blockTypeOreRedstone":function(d){return "Redstone-Erz"},
"blockTypePlanksAcacia":function(d){return "Akazien Bretter"},
"blockTypePlanksBirch":function(d){return "Birken Bretter"},
"blockTypePlanksJungle":function(d){return "Dschungel Bretter"},
"blockTypePlanksOak":function(d){return "Eichen Bretter"},
"blockTypePlanksSpruce":function(d){return "Fichten Bretter"},
...
"houseSelectChooseFloorPlan":function(d){return "Wählen Sie den Grundriss für Ihr Haus."},
"houseSelectEasy":function(d){return "Leicht"},
"houseSelectHard":function(d){return "Schwer"},
"houseSelectLetsBuild":function(d){return "Lass uns ein Haus zu bauen."},
"houseSelectMedium":function(d){return "Normal"},
"keepPlayingButton":function(d){return "weiter spielen"},
"level10FailureMessage":function(d){return "Verschließe die Lava, um darüber zu gehen; dann baue zwei von den Eisenblöcken auf der anderen Seite ab."},
"level11FailureMessage":function(d){return "Platziere zur Sicherheit Pflastersteine voraus, wenn dort Lava ist. Das lässt sich sicher diese Reihe von Ressourcen abbauen."},
...
"level13FailureMessage":function(d){return "Platziere Schienen entlang des Dreckpfades von deiner Tür zum Rand der Karte."},
"level1FailureMessage":function(d){return "Du musst Befehle verwenden um zu den Schafen zu laufen."},
"level1TooFewBlocksMessage":function(d){return "Versuche mehr Befehle zu verwenden um zu dem Schaf zu laufen."},
...
"level3FailureMessage":function(d){return "Um Wolle von beiden Schafen zu sammeln musst du zu jedem dieser Schafe laufen und den \"Scheren\" Befehl verwenden. Denk daran, den \"Drehen\" Befehl zu verwenden um die Schafe zu erreichen."},
...
"level5FailureMessage":function(d){return "Platziere deine Blöcke auf der Drecklinie um eine Mauer zu errichten. Die rosane \"wiederhole\"-Anweisung führt die Befehle aus, die darin platziert sind, wie beispielsweise \"platziere Block\" oder \"gehe vorwärts\"."},
"level6FailureMessage":function(d){return "Platziere Blöcke auf dem Hausgrundriss aus Dreck um das Puzzle zu abzuschließen."},
...
"playerSelectChooseCharacter":function(d){return "Wählen Sie Ihren Charakter."},
"playerSelectChooseSelectButton":function(d){return "Bitte wählen"},
"playerSelectLetsGetStarted":function(d){return "Los geht's."},
"reinfFeedbackMsg":function(d){return "Du kannst \"Weiter spielen\" drücken, um zurück zu deinem Spiel zu kommen."},
"replayButton":function(d){return "Wiederholen"},
"selectChooseButton":function(d){return "Bitte wählen"},
