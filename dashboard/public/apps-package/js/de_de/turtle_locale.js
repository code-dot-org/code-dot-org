...
"blocksUsed":function(d){return "Benutzte Bausteine: %1"},
...
"colourTooltip":function(d){return "Ändere die Farbe des Stiftes."},
...
"drawASquare":function(d){return "Zeichnen Sie ein Quadrat"},
...
"drawASnowman":function(d){return "Zeichnen Sie einen Schneemann"},
...
"moveEastTooltip":function(d){return "Bewege den Künstler nach Osten."},
"moveForward":function(d){return "vorwärts bewegen um"},
"moveForwardTooltip":function(d){return "Bewegen Sie den Künstler vorwärts."},
"moveNorthTooltip":function(d){return "Bewege den Künstler nach Norden."},
"moveSouthTooltip":function(d){return "Bewege den Künstler nach Süden."},
"moveWestTooltip":function(d){return "Bewege den Künstler nach Westen."},
"moveTooltip":function(d){return "Bewegen Sie den Künstler um den angegebenen Betrag vor-oder rückwärts."},
"notBlackColour":function(d){return "Sie müssen eine andere Farbe als schwarz für dieses Puzzle angeben."},
"numBlocksNeeded":function(d){return "Dieses Puzzle kann mit %1 Bausteinen gelöst werden. Sie haben %2 benutzt."},
...
"reinfFeedbackMsg":function(d){return "Dein Bild ist fertig! Arbeite weiter daran oder gehe zum nächsten Level."},
...
"tooFewColours":function(d){return "Sie müssen mindestens %1 verschiedene Farben für dieses Puzzle verwenden. Sie haben nur %2 verwendet."},
...
"wrongColour":function(d){return "Ihr Bild hat die falsche Farbe. In diesem Puzzle muss es %1 sein."}};