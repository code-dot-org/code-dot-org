...
"missingRecommendedBlocksErrorMsg":function(d){return "Nicht ganz. Versuche einen Block, den du noch nicht verwendest."},
"missingRequiredBlocksErrorMsg":function(d){return "Nicht ganz. Du musst einen Block verwenden, den du noch nicht benutzt."},
...
"unsubmitYourProject":function(d){return "Mache die Einschickung des Projektes rückgängig"},
...
"syntaxErrorMsg":function(d){return "Das Programm enthält einen Tippfehler. Bitte entferne die Zeile "+common_locale.v(d,"lineNumber")+" und versuche es erneut."},
