...
"clearPuzzleConfirm":function(d){return "Diese Aktion wird das Puzzle in den Ausgangszustand versetzen und alle Blöcke, die du hinzugefügt oder verändert hast, löschen."},
...
"dropletBlock_comment_description":function(d){return "Schreiben sie eine Schilderung eines Codes"},
...
"dropletBlock_randomNumber_description":function(d){return "Gibt eine zufällige Zahl im Bereich von min bis max zurück."},
...
"emptyTopLevelBlock":function(d){return "Es gibt keine Blöcke zum Ausführen. Du musst ein Block dem "+common_locale.v(d,"topLevelBlockName")+"-Block anhängen."},
...
"generatedCodeInfo":function(d){return "Selbst Eliteuniversitäten unterrichten block-basiertes Programmieren (z.B. "+common_locale.v(d,"berkeleyLink")+", "+common_locale.v(d,"harvardLink")+"). Allerdings können die von dir zusammengefügten Blöcke auch in JavaScript, der weltweit meist verbreiteten Programmiersprache, dargestellt werden:"},
...
"hintSelectInstructions":function(d){return "Anleitungen und alte Hinweise"},
...
"levelIncompleteError":function(d){return "Du benutzt alle nötigen Blocktypen, aber noch nicht auf die richtige Weise."},
"listVariable":function(d){return "Liste"},
"makeYourOwnFlappy":function(d){return "Programmiere dein eigenes \"Flappy\"-Spiel"},
"missingRecommendedBlocksErrorMsg":function(d){return "Nicht ganz. Versuche es mit einem Block, den du bisher noch nicht verwendet hast."},
...
"numBlocksNeeded":function(d){return "Glückwunsch! Du hast Puzzle "+common_locale.v(d,"puzzleNumber")+" gelöst. (Du hättest jedoch nur "+common_locale.p(d,"numBlocks",0,"de",{"one":"1 Block","other":common_locale.n(d,"numBlocks")+" Blöcke"})+" gebraucht.)"},
...
"recommendedBlockContextualHintTitle":function(d){return "Verwenden sie einen block wie diesen um das Puzzle zu lösen."},
...
"sendToPhone":function(d){return "An ein Handy schicken"},
...
"tooFewBlocksMsg":function(d){return "Du verwendest alle nötigen Block-Typen. Versuche jedoch mehr von diesen Block-Typen zu verwenden, um diese Aufgabe abzuschließen."},
