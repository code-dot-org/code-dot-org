...
"missingVariableX":function(d){return "Bei deinem Ausdruck fehlt die Variable "+calc_locale.v(d,"var")+"."},
"reinfFeedbackMsg":function(d){return "Hier ist deine Berechnung! Arbeite weiter oder gehe zur nächsten Aufgabe!"},
