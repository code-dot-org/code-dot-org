...
"createHtmlBlock":function(d){return "HTML-Block erstellen"},
"createHtmlBlockTooltip":function(d){return "Erstellt einen HTML-Block in der App."},
...
"reinfFeedbackMsg":function(d){return "Sie können die \"Versuchs nochmal\" Taste Drücken um zurück zur laufenden App zukommen."},
"repeatForever":function(d){return "ewig wiederholen"},
"repeatDo":function(d){return "mache"},
"repeatForeverTooltip":function(d){return "Führen Sie die Aktionen in diesem Block wiederholt aus, während die Anwendung ausgeführt wird."},
"shareWebappTwitter":function(d){return "Schau Dir die App an, die ich gemacht habe. Ich habe sie selbst mit @codeorg geschrieben"},
"shareGame":function(d){return "Teilen Sie Ihre App:"},
"stepIn":function(d){return "Eintreten"},
"stepOver":function(d){return "Übertreten"},
"stepOut":function(d){return "Heraustreten"},
"turnBlack":function(d){return "schwarz machen"},
"turnBlackTooltip":function(d){return "Macht den Bildschirm schwarz."},
