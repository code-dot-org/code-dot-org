...
"emptyBlocksErrorMsg":function(d){return "\"Repeat\" හෝ \"If\" ඛාණ්ඩය හරියට ක්‍රියාත්මක වීමට​ එය​ තුල වෙනත් ඛාණ්ඩයක් තිබිය යුතුය. ඇතුලත​ ඛාණ්ඩය නියම ලෙස පිටත ඛාණ්ඩය තුල ​ ඇතුලත් වී තිබෙදැයි බලන්න."},
"emptyExampleBlockErrorMsg":function(d){return "ඔබට අවම වශයෙන් උදාහරණ 2ක් වත් අවශ්‍ය වනවා ශ්‍රිතය ගැන. සහතික වන්න නිසැකවම එක් එක් උදාහරණ සඳහා ඇමතුමක් සහ ප්‍රථිපලයක් තිබෙන බවට."},
"emptyFunctionBlocksErrorMsg":function(d){return "Function ඛාණ්ඩය හරියට ක්‍රියාත්මක වීමට එය ​තුල වෙනත් ඛාණ්ඩය​ක් තිබිය යුතුය."},
"emptyFunctionalBlock":function(d){return "ඔබ සතුව අසම්පූර්ණ ආදානයක් සහිත බ්ලොක් එකක් ඇත."},
"emptyTopLevelBlock":function(d){return "පාලනය කිරීම සඳහා කිසිදු බ්ලොක්ස් නොමැත. ඔබ විසින් බෝල්ක්ස් සම්බන්ධ කල යුතුය "+common_locale.v(d,"topLevelBlockName")+"."},
"end":function(d){return "අවසානය"},
"errorEmptyFunctionBlockModal":function(d){return "ඔබගේ ශ්‍රිතයේ අර්ත දැක්වීම තුල බ්ලොක්ස් වලින් සමන්විත වියයුතුයි. \"edit\" click කරන්න සහ බ්ලොක්ස් ඇදගෙන ඇවිත් අතහරින්න කොළපැහැති බ්ලෝක් එක තුලට."},
...
"errorQuestionMarksInNumberField":function(d){return "\"???\" අගයකින් ආදේශ කර උත්සාහ කරන්න."},
...
"hintPrompt":function(d){return "උදව්වක් අවශ්‍යද?"},
"hintRequest":function(d){return "ඉඟිය බලන්න"},
"hintReviewTitle":function(d){return "ඔබගේ ඉඟි විමර්ශනය කරන්න"},
"hintSelectInstructions":function(d){return "උපදෙස් සහ පැරණි ඉඟි"},
...
"missingRecommendedBlocksErrorMsg":function(d){return "සම්පූර්ණයෙන් නොවේ. ඔබ මෙතෙක් භාවිතා නොකරන ලඳ බ්ලොක් එකක් භාවිත කරන්න."},
"missingRequiredBlocksErrorMsg":function(d){return "සම්පූර්ණයෙන් නොවේ. මෙතෙක් භාවිතා නොකරන ලඳ බ්ලොක් එකක් භාවිත කරන්න ඔබට සිදුවනවා."},
...
"play":function(d){return "සෙල්ලම් කරන්න"},
"print":function(d){return "මුද්‍රණය කරන්න"},
"puzzleTitle":function(d){return "අදියර "+common_locale.v(d,"stage_total")+" හි ප්‍රෙහේලිකා "+common_locale.v(d,"puzzle_number")},
...
"runProgram":function(d){return "ක්‍රියාත්මක කරන්න"},
...
"sendToPhone":function(d){return "ජංගම දුරකතනයට යවන්න"},
...
"syntaxErrorMsg":function(d){return "ඔබගේ පරිඝණක වැඩසටහන දෝෂ සහිතයි. කරුණාකර අංක "+common_locale.v(d,"lineNumber")+" පේළිය ඉවත්කර නැවත උත්සාහ කරන්න."},
...
"tooMuchWork":function(d){return "ඔබ මා  හට බොහෝ වැඩ ප්‍රමාණයක් පැවරුවා! ඔබට මෙය  අඩු වාර ගණනකින් කිරීමට හැකිද?"},
"toolboxHeader":function(d){return "ආකෘති"},
