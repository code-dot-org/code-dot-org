...
"numBitsPerPacket":function(d){return netsim_locale.v(d,"x")+" bits par paquet"},
"numBitsPerChunk":function(d){return netsim_locale.v(d,"numBits")+" bits par morceau"},
...
"routerX":function(d){return "Routeur "+netsim_locale.v(d,"x")},
...
"setWireToValue":function(d){return "Définir le fil à "+netsim_locale.v(d,"value")},
...
"waitingForNodeToConnect":function(d){return "Attend la connection du noeud "+netsim_locale.v(d,"node")+"..."},
"workspaceHeader":function(d){return "Simulateur d'Internet"},
"xOfYPackets":function(d){return netsim_locale.v(d,"x")+" sur "+netsim_locale.v(d,"y")},
"xSecondPerPulse":function(d){return netsim_locale.v(d,"x")+" seconde par pulsation"},
"xSecondsPerPulse":function(d){return netsim_locale.v(d,"x")+" secondes par pulsation"},
"x_Gbps":function(d){return netsim_locale.v(d,"x")+"Gbit/s"},
"x_Mbps":function(d){return netsim_locale.v(d,"x")+"Mbit/s"},
"x_Kbps":function(d){return netsim_locale.v(d,"x")+"Kbit/s"},
"x_bps":function(d){return netsim_locale.v(d,"x")+"bit/s"},
"x_GBytes":function(d){return netsim_locale.v(d,"x")+"Go"},
"x_MBytes":function(d){return netsim_locale.v(d,"x")+"Mo"},
"x_KBytes":function(d){return netsim_locale.v(d,"x")+"Ko"},
"x_Bytes":function(d){return netsim_locale.v(d,"x")+"octets"},
"x_bits":function(d){return netsim_locale.v(d,"x")+"bits"}};