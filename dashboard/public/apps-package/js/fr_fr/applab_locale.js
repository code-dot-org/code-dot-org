...
"createHtmlBlock":function(d){return "créer le bloc html"},
"createHtmlBlockTooltip":function(d){return "Crée un bloc de code HTML dans l'application."},
...
"shareWebappTwitter":function(d){return "Découvrez l'histoire que j'ai créée. Je l'ai écrite moi-même avec @codeorg"},
"shareGame":function(d){return "Partagez votre application :"},
"stepIn":function(d){return "Entrer"},
"stepOver":function(d){return "Esquiver"},
"stepOut":function(d){return "Abandonner"},
"turnBlack":function(d){return "noircir"},
"turnBlackTooltip":function(d){return "Noircissez l'écran."},
