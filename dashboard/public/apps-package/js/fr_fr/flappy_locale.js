...
"flapRandom":function(d){return "battre des ailes d'une force aléatoire"},
...
"flapLarge":function(d){return "battre des ailes fort"},
...
"playSoundDie":function(d){return "jouer le son Défaite"},
...
"playSoundSplash":function(d){return "jouer le son Bulles"},
...
"setBackgroundNight":function(d){return "choisir l'arrière-plan Ville (soirée)"},
...
"setBackgroundSanta":function(d){return "choisir l'arrière-plan Nuit de Noël"},
...
"setGapLarge":function(d){return "choisir un grand écart"},
"setGapVeryLarge":function(d){return "choisir un très grand écart"},
"setGapHeightTooltip":function(d){return "Définit la hauteur de l'espace central dans les obstacles"},
...
"setGravityTooltip":function(d){return "Définit la force d'attraction du sol"},
...
"setObstacleTooltip":function(d){return "Définit l'image des obstacles"},
...
"setPlayerTooltip":function(d){return "Définit l'image du personnage volant"},
...
"shareFlappyTwitter":function(d){return "Regardez le jeu Flappy que j'ai fait. Je l'ai écrit moi-même avec @codeorg"},
...
"soundDie":function(d){return "défaite"},
"soundHit":function(d){return "baffe"},
"soundPoint":function(d){return "point"},
"soundSwoosh":function(d){return "tourbillon"},
"soundWing":function(d){return "battement d'ailes"},
"soundJet":function(d){return "jet"},
"soundCrash":function(d){return "accident"},
"soundJingle":function(d){return "clochettes"},
"soundSplash":function(d){return "bulles"},
"soundLaser":function(d){return "laser"},
"speedRandom":function(d){return "régler la vitesse à une cadence aléatoire"},
"speedVerySlow":function(d){return "régler la vitesse à une cadence très lente"},
"speedSlow":function(d){return "régler la vitesse à une cadence lente"},
"speedNormal":function(d){return "régler la vitesse à une cadence normale"},
"speedFast":function(d){return "régler la vitesse à une cadence rapide"},
"speedVeryFast":function(d){return "régler la vitesse à une cadence très rapide"},
...
"whenCollideGround":function(d){return "lorsque le sol est touché"},
"whenCollideGroundTooltip":function(d){return "Exécute les actions insérées lorsque Flappy touche le sol."},
"whenCollideObstacle":function(d){return "lors de la rencontre avec un obstacle"},
"whenCollideObstacleTooltip":function(d){return "Exécute les actions insérées lorsque Flappy rentre en collision avec un obstacle."},
"whenEnterObstacle":function(d){return "lors du dépassement d'un obstacle"},
