...
"bounceBall":function(d){return "Faire rebondir une balle"},
"bounceBallTooltip":function(d){return "Faites rebondir une balle sur un objet."},
...
"isWallTooltip":function(d){return "Valide vrai s'il y a un mur ici"},
"launchBall":function(d){return "lance une nouvelle balle"},
"launchBallTooltip":function(d){return "Mets une balle en jeu."},
"makeYourOwn":function(d){return "Créez votre propre jeu à Rebond"},
...
"scoreText":function(d){return "Pointage: "+appLocale.v(d,"playerScore")+" : "+appLocale.v(d,"opponentScore")},
...
"setBallSpeedRandom":function(d){return "régler la balle à une vitesse aléatoire"},
"setBallSpeedVerySlow":function(d){return "régler la balle à une cadence très lente"},
"setBallSpeedSlow":function(d){return "régler la balle à une cadence lente"},
"setBallSpeedNormal":function(d){return "régler la balle à une cadence normale"},
"setBallSpeedFast":function(d){return "régler la balle à une cadence rapide"},
"setBallSpeedVeryFast":function(d){return "régler la balle à une cadence très rapide"},
...
"setPaddleSpeedRandom":function(d){return "régler la vitesse de la raquette à une cadence aléatoire"},
"setPaddleSpeedVerySlow":function(d){return "régler la vitesse de la raquette à une cadence très lente"},
"setPaddleSpeedSlow":function(d){return "régler la vitesse de la raquette à une cadence lente"},
"setPaddleSpeedNormal":function(d){return "régler la vitesse de la raquette à une cadence normale"},
"setPaddleSpeedFast":function(d){return "régler la vitesse de la raquette à une cadence rapide"},
"setPaddleSpeedVeryFast":function(d){return "régler la vitesse de la raquette à une cadence très rapide"},
"setPaddleSpeedTooltip":function(d){return "Règle la vitesse de la raquette."},
"shareBounceTwitter":function(d){return "Regarde le jeu Flappy que j'ai fait. Je l'ai écrit moi-même avec @codeorg"},
...
"whenBallInGoal":function(d){return "quand balle dans le but"},
"whenBallInGoalTooltip":function(d){return "Exécuter les actions ci-dessous lorsqu'une balle entre dans le but."},
"whenBallMissesPaddle":function(d){return "quand balle manque la raquette"},
"whenBallMissesPaddleTooltip":function(d){return "Exécute les actions ci-dessous quand une balle manque la raquette."},
...
"whenPaddleCollided":function(d){return "quand balle touche raquette"},
...
"whenWallCollided":function(d){return "quand balle touche mur"},
