...
"scoreText":function(d){return "Pointage: "+bounce_locale.v(d,"playerScore")+" : "+bounce_locale.v(d,"opponentScore")},
...
"setBallSpeedVerySlow":function(d){return "régler la balle à une très petite vitesse"},
"setBallSpeedSlow":function(d){return "régler la balle à une petite vitesse"},
"setBallSpeedNormal":function(d){return "régler la balle à une vitesse normale"},
"setBallSpeedFast":function(d){return "régler la balle à une grande vitesse"},
"setBallSpeedVeryFast":function(d){return "régler la balle à une très grande vitesse"},
...
"setPaddleSpeedNormal":function(d){return "régler la raquette à une vitesse normale"},
