...
"errorParamInputUnattached":function(d){return "N'oubliez pas de joindre un bloc à chaque paramètre passé au bloc de fonction dans votre espace de travail."},
...
"runtimeErrorMsg":function(d){return "Ton programme n'a pas été exécuté avec succès. Supprime la ligne "+common_locale.v(d,"lineNumber")+" et réessaie."},
...
"unsubmitYourProjectConfirm":function(d){return "Annuler la soumission de ton projet va réinitialiser la date de soumission, es-tu sur de vouloir annuler la soumission ?"},
