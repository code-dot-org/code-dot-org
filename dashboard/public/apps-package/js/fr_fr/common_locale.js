...
"numBlocksNeeded":function(d){return "Félicitations !  Vous avez terminé le Puzzle "+locale.v(d,"puzzleNumber")+". (Toutefois, vous auriez pu utiliser seulement "+locale.p(d,"numBlocks",0,"fr",{"one":"1 block","other":locale.n(d,"numBlocks")+" blocks"})+".)"},
