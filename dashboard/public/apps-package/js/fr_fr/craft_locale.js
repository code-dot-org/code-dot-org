...
"reinfFeedbackMsg":function(d){return "Vous pouvez appuyer sur \"Continuer à jouer\" pour retourner à jouer à votre jeu."},
"replayButton":function(d){return "Replay"},
"selectChooseButton":function(d){return "Select"},
"tooManyBlocksFail":function(d){return "Puzzle "+craft_locale.v(d,"puzzleNumber")+" complété. Félicitations ! Il est possible de le complété avec "+craft_locale.p(d,"numBlocks",0,"fr",{"one":"1 block","other":craft_locale.n(d,"numBlocks")+" blocks"})+"."}};