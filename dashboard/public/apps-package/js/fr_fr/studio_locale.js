...
"makeProjectileDisappear":function(d){return "qui disparaît"},
...
"makeYourOwn":function(d){return "Faites votre propre application Play App"},
...
"moveDistanceRandom":function(d){return "pointilles au hasard"},
...
"projectilePurpleFireball":function(d){return "une boule de feu violette"},
"projectileRedFireball":function(d){return "une boule de feu rouge"},
...
"saySpriteChoices_3":function(d){return "C'est amusant..."},
...
"setSpriteKnight":function(d){return "une image de chevalier"},
"setSpriteMonster":function(d){return "une image de monstre"},
"setSpriteNinja":function(d){return "une image de ninja masqué"},
"setSpriteOctopus":function(d){return "une image de pieuvre"},
...
"showCoordinates":function(d){return "afficher coordonnées"},
...
"setSpriteN":function(d){return "définir pour l'acteur "+appLocale.v(d,"spriteIndex")},
...
"throwTooltip":function(d){return "L'acteur lance le projectile spécifié."},
...
"waitParamsTooltip":function(d){return "Attendez un nombre de secondes donné ou utilisez 0 pour attendre jusqu'au clic."},
"waitTooltip":function(d){return "Attendez un temps donné ou jusqu'au clic."},
...
"whenArrowTooltip":function(d){return "Exécutez les actions ci-dessous lorsque le flèche indiquée est pressée."},
...
"whenSpriteClicked":function(d){return "quand on clique sur l'acteur"},
...
"whenSpriteCollidedWithAnyActor":function(d){return "touche n'importe personnage"},
