...
"createSnowflakeSquare":function(d){return "créer un flocon de type carré"},
"createSnowflakeParallelogram":function(d){return "créer un flocon de type parallélogramme"},
"createSnowflakeLine":function(d){return "créer un flocon de type ligne"},
"createSnowflakeSpiral":function(d){return "créer un flocon de type spirale"},
"createSnowflakeFlower":function(d){return "créer un flocon de type fleur"},
"createSnowflakeFractal":function(d){return "créer un flocon de type fractal"},
"createSnowflakeRandom":function(d){return "créer un flocon de type aléatoire"},
"createASnowflakeBranch":function(d){return "créer une branche de flocon"},
