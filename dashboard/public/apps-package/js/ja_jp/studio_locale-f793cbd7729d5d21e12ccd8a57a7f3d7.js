...
"itemYellowHearts":function(d){return "きいろいハート"},
...
"saySpriteChoices_42":function(d){return "わたしをみつけた！"},
...
"saySpriteChoices_47":function(d){return "いい友だち！"},
"saySpriteChoices_48":function(d){return "気をつけて！"},
"saySpriteChoices_49":function(d){return "なんと！"},
...
"saySpriteChoices_56":function(d){return "やられた！"},
"saySpriteChoices_57":function(d){return "いいトライ！"},
...
"setBackgroundTile":function(d){return "背景(はいけい)をタイルにする"},
"setBackgroundIcy":function(d){return "背景(はいけい)を氷(こおり)の模様(もよう)にする"},
"setBackgroundSnowy":function(d){return "背景(はいけい)を雪(ゆき)の模様(もよう)にする"},
...
"whenSpriteCollidedWithAnything":function(d){return "なにかにさわる"},
