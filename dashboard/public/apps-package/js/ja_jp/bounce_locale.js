...
"playSoundLosePoint2":function(d){return "敗北ポイント2の音を再生します。"},
...
"setBackgroundRandom":function(d){return "ランダムな状況を設定"},
...
"whenBallInGoal":function(d){return "ボールがゴールにあるとき"},
"whenBallInGoalTooltip":function(d){return "ボールがゴールに入ったとき次のアクションを実行します。"},
"whenBallMissesPaddle":function(d){return "ボールがパドルを逃したらを"},
"whenBallMissesPaddleTooltip":function(d){return "ボールがパドルを逃したら下記のアクションを実行します。"},
...
"whenLeft":function(d){return "左向き矢印が押されたとき"},
"whenLeftTooltip":function(d){return "左向きの矢印キーが押されたとき以下のアクションを実行します。"},
"whenPaddleCollided":function(d){return "パドルにボールが当たったら"},
"whenPaddleCollidedTooltip":function(d){return "ボールがパドルにぶつかったら、次のアクションを実行します。"},
"whenRight":function(d){return "矢印が右のとき"},
"whenRightTooltip":function(d){return "右向きの矢印キーが押されたとき以下のアクションを実行します。"},
"whenUp":function(d){return "矢印が上のとき"},
"whenUpTooltip":function(d){return "上向きの矢印キーが押されたとき以下のアクションを実行します。"},
"whenWallCollided":function(d){return "ボールが壁にあたったとき"},
"whenWallCollidedTooltip":function(d){return "ボールが壁にぶつかったら、次のアクションを実行します。"},
