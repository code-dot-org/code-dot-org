...
"generatedCodeDescription":function(d){return "このパズルであなたはブロックを運んだり並べたりすることで、JavaScript というコンピューター言語で書かれた、ひとまとまりの指示（インストラクション）をつくり上げました。このようなプログラムによって、コンピューターは画面に何を表示すればいいのかを知らされるのです。あなたがマインクラフト内で目にすることや行うこともすべて、こうしたコンピュータープログラムからスタートしています。"},
...
"nextLevelMsg":function(d){return "パズル"+craft_locale.v(d,"puzzleNumber")+"完了。おめでとうございます!"},
