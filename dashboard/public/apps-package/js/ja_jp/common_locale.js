...
"dropletBlock_appendItem_description":function(d){return "要素を配列の最後に追加"},
"dropletBlock_appendItem_param0":function(d){return "リスト"},
"dropletBlock_appendItem_param0_description":function(d){return "変更する配列"},
"dropletBlock_appendItem_param1":function(d){return "項目"},
"dropletBlock_appendItem_param1_description":function(d){return "配列の最後に追加する要素"},
"dropletBlock_arcLeft_description":function(d){return "なめらかな円弧を描くように、左前方にカメを動かします。"},
...
"dropletBlock_button_description":function(d){return "クリック可能なボタンを作成する。ボタンは与えられたテキストを表示し、特定のidによって参照することができます。"},
...
"dropletBlock_circle_param0_description":function(d){return "ピクセル単位での、円の中心のx座標。"},
"dropletBlock_circle_param1":function(d){return "centerY"},
"dropletBlock_circle_param1_description":function(d){return "ピクセル単位での、円の中心のy座標。"},
"dropletBlock_circle_param2":function(d){return "半径"},
"dropletBlock_circle_param2_description":function(d){return "ピクセル単位での円の半径。"},
...
"dropletBlock_clearInterval_param0":function(d){return "間隔"},
"dropletBlock_clearInterval_param0_description":function(d){return "setInterval 関数が返す値で、タイマーを止める時に使います。"},
"dropletBlock_clearTimeout_description":function(d){return "setTimeout()の戻り値を渡し、既存のタイマーをクリアする"},
"dropletBlock_clearTimeout_param0":function(d){return "タイムアウト"},
"dropletBlock_clearTimeout_param0_description":function(d){return "setTimeout 関数が返す値で、タイマーを止める時に使います。"},
...
"dropletBlock_console.log_param0_description":function(d){return "コンソールに表示するメッセージの文字列。"},
...
"dropletBlock_createCanvas_param0_description":function(d){return "新しい canvas 要素の ID 。"},
"dropletBlock_createCanvas_param1":function(d){return "幅"},
"dropletBlock_createCanvas_param1_description":function(d){return "ピクセル単位での長方形の横幅。"},
"dropletBlock_createCanvas_param2":function(d){return "高さ"},
"dropletBlock_createCanvas_param2_description":function(d){return "ピクセル単位での長方形の高さ。"},
...
"dropletBlock_deleteElement_param0_description":function(d){return "削除する要素のid。"},
...
"dropletBlock_getAlpha_description":function(d){return "与えられた画像上の座標(x,y)にあるピクセルの色のアルファ 値(不透明度) (0 から 255 までの範囲) を返します"},
...
"dropletBlock_insertItem_param0":function(d){return "リスト"},
"dropletBlock_insertItem_param0_description":function(d){return "変更する配列"},
...
"dropletBlock_penRGB_param0":function(d){return "赤"},
...
"dropletBlock_penRGB_param1":function(d){return "緑"},
...
"dropletBlock_penRGB_param2":function(d){return "青"},
...
"dropletBlock_rect_param2_description":function(d){return "ピクセル単位での長方形の横幅。"},
"dropletBlock_rect_param3":function(d){return "高さ"},
"dropletBlock_rect_param3_description":function(d){return "ピクセル単位での長方形の高さ。"},
"dropletBlock_removeItem_description":function(d){return "Remove the item at the specified position from the array"},
"dropletBlock_removeItem_param0":function(d){return "リスト"},
"dropletBlock_removeItem_param0_description":function(d){return "変更する配列"},
...
"dropletBlock_substring_param1":function(d){return "終了"},
