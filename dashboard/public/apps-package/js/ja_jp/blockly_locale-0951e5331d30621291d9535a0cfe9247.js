...
Blockly.Msg.COLOUR_BLEND_COLOUR1 = "色１";
Blockly.Msg.COLOUR_BLEND_COLOUR2 = "色２";
Blockly.Msg.COLOUR_BLEND_HELPURL = "http://meyerweb.com/eric/tools/color-blend/";
Blockly.Msg.COLOUR_BLEND_RATIO = "割合";
Blockly.Msg.COLOUR_BLEND_TITLE = "ブレンド";
Blockly.Msg.COLOUR_BLEND_TOOLTIP = "2色を特定の割合で混ぜ合わせる (0.0 ～ 1.0)";
Blockly.Msg.COLOUR_PICKER_HELPURL = "http://en.wikipedia.org/wiki/Color";
Blockly.Msg.COLOUR_PICKER_TOOLTIP = "パレットから色を選択";
...
Blockly.Msg.CONTRACT_EDITOR_HEADER = "デザイン レシピ";
...
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_CONTINUE = "このループの残りの部分を飛ばして、次の繰り返しを続けます。";
...
Blockly.Msg.EXAMPLE_DESCRIPTION = "予想される挙動と実際の挙動からなる例を定義してください。";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_REMOVE_RANDOM = "リスト内にある乱数項目のアイテムを削除します。";
...
Blockly.Msg.SAVE_AND_CLOSE = "保存して閉じる";
