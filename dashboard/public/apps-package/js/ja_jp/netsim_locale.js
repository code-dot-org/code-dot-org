...
"bitCounter":function(d){return appLocale.v(d,"x")+"/"+appLocale.v(d,"y")+" ビット"},
...
"numBitsPerPacket":function(d){return "1 パケットあたり "+appLocale.v(d,"x")+" ビット"},
...
"routerX":function(d){return "ルーター "+appLocale.v(d,"x")},
...
"xOfYPackets":function(d){return appLocale.v(d,"y")+" の "+appLocale.v(d,"x")},
