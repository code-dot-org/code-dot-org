...
"flowerEmptyError":function(d){return "A flor em que estás não têm mais nectar."},
...
"honeyTooltip":function(d){return "Faz mel do nectar"},
...
"ifFlowerTooltip":function(d){return "Se existe uma flor/colmeia na direcção especificada, então realiza algumas acções."},
"ifelseFlowerTooltip":function(d){return "Se existe uma flor/colmeia na direcção especificada, então realiza o primeiro bloco de acções. Caso contrário realiza o segundo bloco."},
"insufficientHoney":function(d){return "Estás a usar todos os blocos correctos, mas precisas de fazer a quantidade certa de mel."},
"insufficientNectar":function(d){return "Estás a usar todos os blocos correctos, mas precisas de colher quantidade certa de nectar."},
"make":function(d){return "faz"},
"moveBackward":function(d){return "para trás"},
...
"nectar":function(d){return "colhe nectar"},
...
"notAtFlowerError":function(d){return "Apenas podes obter néctar de uma flor."},
"notAtHoneycombError":function(d){return "Apenas podes fazer mel na colmeia."},
...
"youSpelled":function(d){return "Tu escreves-te"}};