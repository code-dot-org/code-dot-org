...
"dropletBlock_comment_description":function(d){return "Descreva algum código"},
...
"dropletBlock_randomNumber_description":function(d){return "Entre o valor mínimo e máximo retorne um número aleatório."},
...
"hintReviewTitle":function(d){return "Reveja as suas sugestões"},
"hintSelectInstructions":function(d){return "Instruções e sugestões antigas"},
"hintSelectNewHint":function(d){return "Obtenha uma nova sugestão"},
...
"missingRecommendedBlocksErrorMsg":function(d){return "Tente utilizar um bloco que ainda não tenha usado."},
"missingRequiredBlocksErrorMsg":function(d){return "Tem de utilizar um bloco que ainda não usou."},
...
"recommendedBlockContextualHintTitle":function(d){return "Tente resolver o puzzle utilizando um bloco como este."},
...
"runtimeErrorMsg":function(d){return "O seu programa não foi executado com êxito. Por favor, remova a linha "+common_locale.v(d,"lineNumber")+" e tente novamente."},
"saveToGallery":function(d){return "Guardar"},
...
"shareWarningsAge":function(d){return "Mais abaixo, forneça a sua idade e carregue em OK para continuar."},
"shareWarningsMoreInfo":function(d){return "Mais informações"},
"shareWarningsStoreData":function(d){return "As aplicações construídas no Code Studio podem ser acedidas por qualquer pessoa, através deste endereço de partilha. Tenha cuidado ao fornecer dados pessoais."},
...
"unsubmitYourProjectConfirm":function(d){return "Ao remover o seu projeto irá alterar a data de submissão, deseja remover?"},
"subtitle":function(d){return "um ambiente de programação visual"},
"syntaxErrorMsg":function(d){return "O programa contém um erro de digitação. Por favor, remova a linha "+common_locale.v(d,"lineNumber")+" e tente novamente."},
