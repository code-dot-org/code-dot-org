...
"finalStageTrophies":function(d){return "Parabéns! Concluiu a etapa final e ganhou "+common_locale.p(d,"numTrophies",0,"pt",{"one":"a trophy","other":common_locale.n(d,"numTrophies")+" trophies"})+"."},
...
"hintReviewTitle":function(d){return "Revise suas dicas"},
"hintSelectInstructions":function(d){return "Instruções e dicas antigas"},
"hintSelectNewHint":function(d){return "Obtenha uma nova dica"},
...
"missingRecommendedBlocksErrorMsg":function(d){return "Não é bem assim. Tente usar um bloco que ainda não está utilizando."},
"missingRequiredBlocksErrorMsg":function(d){return "Não é bem assim. Tem de usar um bloco que ainda não está utilizando."},
