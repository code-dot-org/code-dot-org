...
"emptyExampleBlockErrorMsg":function(d){return "Precisa de pelo menos um exemplo na função "+common_locale.v(d,"functionName")+". Certifique-se que cada exemplo tem uma chamada e um resultado."},
...
"exampleErrorMessage":function(d){return "A função "+common_locale.v(d,"functionName")+" tem um ou mais exemplos que precisam de ajuste. Certifique-se que correspondem à sua definição e responda à pergunta."},
...
"unnamedFunction":function(d){return "Tem uma variável ou função que não tem um nome. Não se esqueça de dar a tudo um nome descritivo."},
