...
"backgroundHardcourt":function(d){return "duro"},
...
"decrementPlayerScore":function(d){return "remover um ponto"},
"defaultSayText":function(d){return "escrever aqui"},
...
"makeProjectileBounce":function(d){return "salto"},
...
"makeProjectileTooltip":function(d){return "Fazer o projétil que colidiu desaparecer ou saltar."},
"makeYourOwn":function(d){return "Faça seu próprio aplicativo de laboratório de reprodução"},
...
"moveDistanceTooltip":function(d){return "Faz o personagem mover-se uma determinada distância na direcção especificada."},
"moveSprite":function(d){return "mover"},
"moveSpriteN":function(d){return "faz o personagem mover-se "+studio_locale.v(d,"spriteIndex")},
"toXY":function(d){return "para x,y"},
"moveDown":function(d){return "mover para baixo"},
"moveDownTooltip":function(d){return "move o ator para baixo."},
"moveLeft":function(d){return "mover para a esquerda"},
"moveLeftTooltip":function(d){return "move o ator para a esquerda."},
"moveRight":function(d){return "mover para a direita"},
"moveRightTooltip":function(d){return "move o ator para a direita."},
"moveUp":function(d){return "mover para cima"},
"moveUpTooltip":function(d){return "Faz o personagem mover-se para cima."},
"moveTooltip":function(d){return "Faz o personagem mover-se."},
...
"positionOutTopLeft":function(d){return "para a posição acima à esquerda"},
"positionOutTopRight":function(d){return "para a posição acima à direita"},
"positionTopOutLeft":function(d){return "to the top outside left position"},
"positionTopLeft":function(d){return "para o topo esquerdo"},
"positionTopCenter":function(d){return "para o topo centro"},
"positionTopRight":function(d){return "para o topo direito"},
"positionTopOutRight":function(d){return "para fora do topo direito"},
"positionMiddleLeft":function(d){return "para o meio à esquerda"},
"positionMiddleCenter":function(d){return "para o meio ao centro"},
"positionMiddleRight":function(d){return "para o meio à direita"},
"positionBottomOutLeft":function(d){return "para fora do rodapé à esquerda"},
"positionBottomLeft":function(d){return "para o rodapé à esquerda"},
...
"projectileYellowHearts":function(d){return "corações amarelas"},
...
"repeatForever":function(d){return "repetir sempre"},
...
"saySprite":function(d){return "diz"},
"saySpriteN":function(d){return "actor "+studio_locale.v(d,"spriteIndex")+" diz"},
...
"saySpriteChoices_7":function(d){return "Que há de novo?"},
...
"saySpriteChoices_54":function(d){return "Opá!"},
...
"setBackground":function(d){return "definir fundo"},
"setBackgroundRandom":function(d){return "definir fundo aleatório"},
"setBackgroundBlack":function(d){return "definir plano de fundo preto"},
"setBackgroundCave":function(d){return "definir fundo de caverna"},
"setBackgroundCloudy":function(d){return "definir o fundo nublado"},
...
"setBackgroundCity":function(d){return "define o fundo da cidade"},
...
"setBackgroundWinter":function(d){return "define o fundo de inverno"},
"setBackgroundLeafy":function(d){return "define fundo folhudo"},
