...
Blockly.Msg.COLOUR_BLEND_TOOLTIP = "Mistura duas cores com uma determinada proporção (0,0 - 1,0).";
...
Blockly.Msg.COLOUR_RGB_TOOLTIP = "Cria uma cor com uma quantidade específica de vermelho, verde e azul. Todos os valores têm de estar entre 0 e 100.";
Blockly.Msg.CONFIRM_DELETE_FUNCTION_MESSAGE = "Atenção! Tens a certeza de que pretendes apagar %1?";
...
Blockly.Msg.CONTROLS_FOREACH_TOOLTIP = "Para cada elemento numa lista, definir a variável \"%1\" para o elemento e, depois, executar algumas instruções.";
Blockly.Msg.CONTROLS_FOR_HELPURL = "https://code.google.com/p/blockly/wiki/Loops#count_with";
Blockly.Msg.CONTROLS_FOR_INPUT_FROM_TO_BY = "de %1 a %2, a cada %3";
Blockly.Msg.CONTROLS_FOR_INPUT_WITH = "de";
...
Blockly.Msg.CONTROLS_REPEAT_TOOLTIP = "Executar algumas instruções várias vezes.";
...
Blockly.Msg.DEFINE_FUNCTION_FOR_EXAMPLE = "Define a seguinte função e volta a tentar.";
Blockly.Msg.DELETE = "Apagar";
Blockly.Msg.DELETE_BLOCK = "Remover Bloco";
Blockly.Msg.DELETE_PARAMETER = "Apagar parâmetro...";
Blockly.Msg.DELETE_PARAMETER_TITLE = "Todas as a ocorrências do parâmetro '%1' serão apagadas. Tens a certeza?";
...
Blockly.Msg.FUNCTION_DESCRIPTION_LABEL = "O que é que é suposto a tua função fazer?";
Blockly.Msg.FUNCTION_PARAMETERS_LABEL = "Quais são os parâmetros da tua função?";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_FIRST = "Remove e devolve o primeiro elemento de uma lista.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_FROM_END = "Remove e devolve o elemento na posição especificada de uma lista.  O n.º 1 é o último elemento.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_FROM_START = "Remove e devolve o elemento na posição especificada de uma lista.  O n.º 1 é o primeiro elemento.";
