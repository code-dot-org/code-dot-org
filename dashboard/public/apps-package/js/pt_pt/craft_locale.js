...
"blockPlantCrop":function(d){return "plantar cultura"},
"blockShear":function(d){return "tosquiar"},
"blockTillSoil":function(d){return "cultivar solo"},
...
"blockTypeCobblestone":function(d){return "calçada"},
...
"blockTypeOreLapis":function(d){return "minério de lápis"},
...
"level5FailureMessage":function(d){return "Coloque os seus blocos no contorno de terra para construir uma parede. O comando cor-de-rosa \"repetir\" vai executar comandos colocados dentro dele, como \"colocar bloco\" e \"segue em frente\"."},
"level6FailureMessage":function(d){return "Coloque blocos no contorno de terra da casa para completar o desafio."},
"level7FailureMessage":function(d){return "Use o comando \"plantar\" para colocar culturas em cada pedaço de solo cultivado escuro."},
"level8FailureMessage":function(d){return "If you touch a creeper it will explode. Sneak around them and enter your house."},
"level9FailureMessage":function(d){return "Não se esqueça de colocar pelo menos 2 tochas para iluminar o seu caminho e extrair pelo menos 2 de carvão."},
"minecraftBlock":function(d){return "block"},
"nextLevelMsg":function(d){return "Quebra-cabeça "+craft_locale.v(d,"puzzleNumber")+" concluído. Parabéns!"},
