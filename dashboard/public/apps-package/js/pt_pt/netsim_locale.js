...
"addRouter":function(d){return "Adicionar router"},
...
"connect":function(d){return "Conetar"},
"connected":function(d){return "Conetado"},
...
"connectToANode":function(d){return "Ligar a um nó"},
...
"disconnected":function(d){return "Desconetado"},
...
"dropdownPickOne":function(d){return "Selecionar um"},
...
"logStatus_success":function(d){return "Bem sucedida"},
...
"myName":function(d){return "O meu nome"},
"myPrivateNetwork":function(d){return "A minha rede privada"},
"mySection":function(d){return "A minha secção"},
...
"routerTab_stats":function(d){return "Estatística"},
...
"sentBitsLog":function(d){return "Registo de bits enviado"},
"sentMessageLog":function(d){return "Enviar registo de mensagem"},
...
"status":function(d){return "Estado"},
