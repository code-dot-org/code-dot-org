...
"changeScoreTooltip":function(d){return "Menambah atau menghapus angka untuk Skor."},
"changeScoreTooltipK1":function(d){return "Menambahkan poin untuk Skor."},
"continue":function(d){return "Lanjutkan"},
"decrementPlayerScore":function(d){return "Mengapus poin"},
"defaultSayText":function(d){return "ketik di sini"},
"emotion":function(d){return "suasana hati"},
...
"makeProjectileBlueFireball":function(d){return "membuat bola api biru\n"},
"makeProjectilePurpleFireball":function(d){return "membuat bola api ungu"},
"makeProjectileRedFireball":function(d){return "membuat bola api merah"},
"makeProjectileYellowHearts":function(d){return "membuat bola api kuning"},
"makeProjectilePurpleHearts":function(d){return "membuat hati ungu"},
"makeProjectileRedHearts":function(d){return "membuat hati merah"},
...
"moveDistanceRandom":function(d){return "acak piksel"},
"moveDistanceTooltip":function(d){return "memindahkan karakter dengan jarak dan arah yang telah ditentukan."},
"moveSprite":function(d){return "bergerak"},
"moveSpriteN":function(d){return "pindahkan karakter."},
"toXY":function(d){return "to x,y"},
"moveDown":function(d){return "Pindahkan ke bawah"},
"moveDownTooltip":function(d){return "menurunkan karakter."},
"moveLeft":function(d){return "Gerak ke kiri"},
"moveLeftTooltip":function(d){return "memindahkan karakter ke kiri."},
"moveRight":function(d){return "Gerak ke kanan"},
"moveRightTooltip":function(d){return "pindahkan karakter ke kanan."},
...
"positionTopOutLeft":function(d){return "ke atas posisi kiri luar "},
"positionTopLeft":function(d){return "ke atas posisi kiri"},
"positionTopCenter":function(d){return "ke atas posisi tengah"},
"positionTopRight":function(d){return "ke atas posisi kanan"},
"positionTopOutRight":function(d){return "ke atas posisi kanan luar"},
