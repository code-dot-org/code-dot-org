...
"emptyBlockInFunction":function(d){return "fungsi "+common_locale.v(d,"name")+" memiliki inputan yang terisi."},
"emptyBlockInVariable":function(d){return "variabel "+common_locale.v(d,"name")+" memiliki inputan yang terisi."},
...
"emptyTopLevelBlock":function(d){return "tidak ada blok untuk dijalankan. Anda harus melampirkan blok ke blok "+common_locale.v(d,"topLevelBlockName")+"."},
