...
Blockly.Msg.COLOUR_BLEND_TOOLTIP = "Mencampur dua warna dengan perbandingan yang diberikan (0,0 - 1,0).";
...
Blockly.Msg.COLOUR_RGB_TOOLTIP = "Buat warna dengan kombinasi merah, hijau, dan biru yang ditentukan. Semua nilai harus diantara 0 dan 100.";
Blockly.Msg.CONTRACT_EDITOR_HEADER = "Desain resep";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_HELPURL = "https://code.google.com/p/blockly/wiki/Loops#Loop_Termination_Blocks";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_OPERATOR_BREAK = "Keluar dari loop ";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_OPERATOR_CONTINUE = "Lanjutkan dengan langkah loop berikutnya";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_BREAK = "Keluar dari perulangan (loop) yang melingkupinya.";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_CONTINUE = "Abaikan sisa dari loop ini, dan lanjutkan dengan iterasi berikutnya.";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_WARNING = "Awas: Blok ini hanya dapat digunakan dalam loop.";
Blockly.Msg.CONTROLS_FOREACH_HELPURL = "https://code.google.com/p/blockly/wiki/Loops#for_each";
Blockly.Msg.CONTROLS_FOREACH_INPUT_INLIST = "dalam list";
...
Blockly.Msg.CONTROLS_FOR_INPUT_FROM_TO_BY = "dari %1 sampai %2 dengan step %3";
Blockly.Msg.CONTROLS_FOR_INPUT_WITH = "menghitung dengan";
...
Blockly.Msg.CONTROLS_IF_ELSEIF_TOOLTIP = "Tambahkan kondisi ke dalam blok jika (if).";
Blockly.Msg.CONTROLS_IF_ELSE_TOOLTIP = "Terakhir, tambahkan kondisi \"tangkap-semua\" kedalam blok jika (if).";
Blockly.Msg.CONTROLS_IF_HELPURL = "http://code.google.com/p/blockly/wiki/If_Then";
Blockly.Msg.CONTROLS_IF_IF_TOOLTIP = "Menambahkan, menghapus, atau menyusun kembali bagian untuk mengkonfigurasi blok jika (if) ini.";
...
Blockly.Msg.CONTROLS_IF_TOOLTIP_3 = "Jika nilai pertama adalah benar (true), maka lakukan perintah-perintah yang berada didalam blok pertama. Tetapi jika nilai kedua adalah benar (true), maka lakukan perintah-perintah yang berada didalam blok kedua.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_4 = "Jika blok pertama adalah benar (true), maka lakukan perintah-perintah yang berada  didalam blok pertama. Tetapi jika blok kedua adalah benar (true), maka lakukan perintah-perintah yang berada didalam blok kedua.";
...
Blockly.Msg.DELETE_PARAMETER_TITLE = "Ini akan menghapus semua kemunculan parameter '%1'. Anda yakin?";
...
Blockly.Msg.EXAMPLE_DESCRIPTION = "Mendefinisikan contoh dengan perilaku yang diharapkan dan aktual";
...
Blockly.Msg.FUNCTION_DESCRIPTION_LABEL = "Apa yang seharusnya dilakukan oleh fungsi Anda?";
Blockly.Msg.FUNCTION_PARAMETERS_LABEL = "Parameter apa yang diambil oleh fungsi Anda?";
...
Blockly.Msg.FUNCTIONAL_PROCEDURE_DEFINE_TOOLTIP = "Definisikan metode fungsional";
...
Blockly.Msg.LISTS_CREATE_EMPTY_TOOLTIP = "Mengembalikan list, dengan panjang 0, tidak berisi data";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_FROM_END = "Sisipkan item ke dalam posisi yang telah ditentukan didalam list. #1 adalah item yang terakhir.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_FROM_START = "Sisipkan item ke dalam posisi yang telah ditentukan didalam list. #1 adalah item pertama.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_LAST = "Kembalikan item terakhir dalam sebuah list.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_RANDOM = "Kembalikan item secara acak dari list.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_FIRST = "Menghilangkan dan mengembalikan item pertama dalam list.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_FROM_END = "Hapus item pada posisi yang ditetapkan di list dan kembalikan item tersebut. #1 adalah item terakhir.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_FROM_START = "Hapus item pada posisi yang ditetapkan di list dan kembalikan item tersebut. #1 adalah item pertama.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_LAST = "Hapus dan kembalikan item terakhir dalam list.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_RANDOM = "Hapus sebuah item pada posisi acak dari list dan kembalikan item tersebut.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_REMOVE_FIRST = "Menghapus item pertama dalam list.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_REMOVE_FROM_END = "Menghapus item dengan posisi tertentu dalam list. #1 adalah item yang terakhir.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_REMOVE_FROM_START = "Menghapus item dengan posisi tertentu dalam list. #1 adalah item yang terakhir.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_REMOVE_LAST = "Menghapus item terakhir dalam list.";
...
Blockly.Msg.LISTS_GET_SUBLIST_START_FIRST = "Dapatkan bagian dari list dari item pertama";
...
Blockly.Msg.LISTS_INDEX_OF_TOOLTIP = "Mengembalikan indeks dari kejadian pertama/terakhir item dalam list. Mengembalikan 0 jika teks tidak ditemukan.";
...
Blockly.Msg.LISTS_REPEAT_TOOLTIP = "Ciptakan list yang terdiri dari nilai yang diberikan diulang jumlah waktu yang ditentukan.";
...
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_FIRST = "Masukkan item pada awal list.";
...
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_SET_LAST = "Menetapkan nilai pada item terakhir dalam list.";
...
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GT = "Mengembalikan benar jika masukan pertama lebih besar dari masukan kedua.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GTE = "Mengembalikan nilai benar jika masukan pertama lebih besar atau sama dengan masukan kedua.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LT = "Mengembalikan nilai benar jika masukan pertama lebih kecil dari masukan kedua.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LTE = "Mengembalikan nilai benar jika masukan pertama lebih kecil atau sama dengan masukan kedua.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_NEQ = "Mengembalikan nilai benar jika kedua masukan tidak sama.";
Blockly.Msg.LOGIC_NEGATE_HELPURL = "http://code.google.com/p/blockly/wiki/Not";
Blockly.Msg.LOGIC_NEGATE_TITLE = "bukan (not) %1";
Blockly.Msg.LOGIC_NEGATE_TOOLTIP = "Mengembalikan nilai benar jika nilai yang dimasukkan adalah salah. Mengembalikan nilai salah jika yang dimasukkan adalah benar.";
...
Blockly.Msg.LOGIC_TERNARY_TOOLTIP = "Periksa kondisi pada 'test'. Jika benar, kembalikan nilai 'jika benar'; bila sebaliknya kembalikan nilai 'jika salah'.";
...
Blockly.Msg.MATH_CONSTRAIN_TITLE = "Batasi %1 pada nilai rendah %2, nilai tinggi %3";
Blockly.Msg.MATH_CONSTRAIN_TOOLTIP = "Batasi angka antara batas yang ditentukan (termasuk angka batasannya).";
...
Blockly.Msg.MATH_IS_TOOLTIP = "Periksa apakah angka adalah bilangan genap, ganjil, prima, bulat, positif, negatif, atau apakah dapat  dibagi nilai yang ditetapkan. Mengembalikan nilai benar atau salah.";
...
Blockly.Msg.MATH_ONLIST_TOOLTIP_MODE = "Kembalikan list berisi item yang paling banyak dari list.";
...
Blockly.Msg.MATH_SINGLE_TOOLTIP_ABS = "Kembalikan nilai mutlak dari sebuah angka.";
Blockly.Msg.MATH_SINGLE_TOOLTIP_EXP = "Kembalikan e (Euler) pangkat sebuah angka.";
Blockly.Msg.MATH_SINGLE_TOOLTIP_LN = "Kembalikan logaritma natural dari angka.";
Blockly.Msg.MATH_SINGLE_TOOLTIP_LOG10 = "Kembalikan logaritma basis 10 dari angka.";
Blockly.Msg.MATH_SINGLE_TOOLTIP_NEG = "Kembalikan negatif dari angka positif, juga sebaliknya.";
...
Blockly.Msg.PROCEDURES_CALLRETURN_TOOLTIP = "Jalankan fungsi '%1' yang ditetapkan pengguna dan gunakan hasilnya.";
...
Blockly.Msg.PROCEDURES_DEFNORETURN_PROCEDURE = "melakukan sesuatu";
...
Blockly.Msg.PROCEDURES_IFRETURN_TOOLTIP = "Jika nilai ini benar kembalikan nilai kedua.";
Blockly.Msg.PROCEDURES_IFRETURN_WARNING = "Awas: Blok ini dapat digunakan hanya dalam definisi fungsi.";
...
Blockly.Msg.TEXT_GET_SUBSTRING_START_FIRST = "ambil potongan teks mulai dari huruf pertama";
...
Blockly.Msg.TEXT_INDEXOF_TOOLTIP = "Kembalikan index temuan pertama/terakhir dari teks pertama pada teks kedua. Kembalikan 0 jika teks tidak ditemukan.";
...
Blockly.Msg.TEXT_PRINT_TOOLTIP = "Cetak teks, angka atau nilai lain yang ditetapkan.";
Blockly.Msg.TEXT_PROMPT_HELPURL = "https://code.google.com/p/blockly/wiki/Text#Getting_input_from_the_user";
Blockly.Msg.TEXT_PROMPT_TOOLTIP_NUMBER = "Minta pengguna untuk memberi sebuah angka.";
...
Blockly.Msg.VARIABLES_SET_TOOLTIP = "Tetapkan nilai variabel ini sama dengan nilai yang dimasukkan.";
