...
"badColorStringError":function(d){return "Anda menggunakan string warna yang tidak valid: "+eval_locale.v(d,"val")},
"badStyleStringError":function(d){return "Anda menggunakan string gaya yang tidak valid: "+eval_locale.v(d,"val")},
...
"starBlockTitle":function(d){return "bintang (jari-jari, gaya, warna)"},
"radialStarBlockTitle":function(d){return "bintang-melingkar (ujung, dalam, luar, gaya, warna)"},
"polygonBlockTitle":function(d){return "Poligon (sisi, panjang, gaya, warna)"},
"stringAppendBlockTitle":function(d){return "gabung-kata (pertama, kedua)"},
"stringLengthBlockTitle":function(d){return "panjang-kata (kata)"},
"textBlockTitle":function(d){return "teks (kata, ukuran, warna)"},
"triangleBlockTitle":function(d){return "segitiga (ukuran, gaya, warna)"},
