...
"numBitsPerPacket":function(d){return netsim_locale.v(d,"x")+" bit per paket"},
"numBitsPerChunk":function(d){return netsim_locale.v(d,"numBits")+" bit per potong"},
...
"setWireToValue":function(d){return "Tetapkan Kabel Hingga "+netsim_locale.v(d,"value")},
...
"waitingForNodeToConnect":function(d){return "Menunggu "+netsim_locale.v(d,"node")+" untuk menghubungkan..."},
"workspaceHeader":function(d){return "Simulator Internet"},
"xOfYPackets":function(d){return netsim_locale.v(d,"x")+" dari "+netsim_locale.v(d,"y")},
"xSecondPerPulse":function(d){return netsim_locale.v(d,"x")+" detik per pulsa"},
"xSecondsPerPulse":function(d){return netsim_locale.v(d,"x")+" detik per pulsa"},
