...
"finalLevel":function(d){return "آفرین! شما پازل نهایی را حل کرده اید."},
"heightParameter":function(d){return "ارتفاع"},
"ifCode":function(d){return "اگر"},
"ifPathAhead":function(d){return "اگر رو به جلو راه هست"},
"ifTooltip":function(d){return "اگر در جهت مشخص شده راهی هست، چند کار انجام بده."},
"ifelseTooltip":function(d){return "اگر در جهت مشخص شده راهی هست، اولین سری کارها را انجام بده، در غیر این صورت، دومین سری کارها را انجام بده."},
...
"moveForward":function(d){return "برو جلو"},
...
"nextLevel":function(d){return "آفرین! تو این پازل را تمام کردی."},
...
"numBlocksNeeded":function(d){return "این پازل می تواند با بلوکهای %1 حل شود."},
"pathAhead":function(d){return "راه پیش رو"},
"pathLeft":function(d){return "اگر راه به سمت چپ بود"},
"pathRight":function(d){return "اگر راه به سمت راست بود"},
"pilePresent":function(d){return "یک توده هست"},
...
"putdownTower":function(d){return "برج را پایین بکش"},
"reinfFeedbackMsg":function(d){return "شما می توانید دکمه \"دوباره امتحان کن\" را بفشارید تا به بازیتان برگردید."},
"removeSquare":function(d){return "مربع را حذف کن"},
"repeatUntil":function(d){return "تکرار کن تا زمانی که"},
"repeatUntilBlocked":function(d){return "تا زمانیکه مسیر پیش رو است "},
"repeatUntilFinish":function(d){return "تا پایان تکرار کن"},
"scoreText":function(d){return "امتیاز: "+appLocale.v(d,"playerScore")+" : "+appLocale.v(d,"opponentScore")},
...
"setBackgroundTooltip":function(d){return "تصویر پس‌زمینه را تنظیم میکند"},
...
"turnTooltip":function(d){return "من را 90 درجه به راست یا چپ میچرخاند."},
...
"whileTooltip":function(d){return "کارهای بسته شده را تکرار کن تا زمانیکه به نقطه پایان برسی."},
