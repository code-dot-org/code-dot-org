...
"createHtmlBlock":function(d){return "ایجاد بلوک های  اچ تی ام ال"},
"createHtmlBlockTooltip":function(d){return "بلوک های اچ تی ام ال را در برنامه ایجاد می کند."},
...
"reinfFeedbackMsg":function(d){return "شما می توانید  با فشار دادن دکمه \"سعی مجدد\"  به app  در حال اجرای خود بروید."},
