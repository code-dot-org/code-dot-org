...
"honeycombFullError":function(d){return "У цьому вулику більше немає місця для меду."},
"ifCode":function(d){return "якщо"},
"ifInRepeatError":function(d){return "Вам потрібний блок \"Якщо\" всередині блоку \"Повторити\". Якщо виникли неполадки, спробуйте попередній рівень знову, щоб побачити, як це працює."},
...
"ifFlowerTooltip":function(d){return "Якщо у вказаному напрямку є квітка або вулик, то виконувати певні дії."},
"ifelseFlowerTooltip":function(d){return "Якщо у вказаному напрямку є квітка або вулик, то виконувати перший блок дій. У протилежному випадку, виконувати другий блок дій."},
...
"moveEastTooltip":function(d){return "Перемістіть мене на одну позицію на схід."},
"moveForward":function(d){return "рухатись вперед"},
"moveForwardTooltip":function(d){return "Перемісти мене на одну клітинку вперед."},
"moveNorthTooltip":function(d){return "Перемістіть мене на одну позицію на північ."},
"moveSouthTooltip":function(d){return "Перемістіть мене на одну позицію на півень."},
"moveTooltip":function(d){return "Перемістіть мене вперед або назад на один крок"},
"moveWestTooltip":function(d){return "Перемістіть мене на одну позицію на захід."},
...
"notAtFlowerError":function(d){return "Ви можете отримати нектар тільки з квітки."},
"notAtHoneycombError":function(d){return "Ви можете взяти мед лише з вулика."},
...
"uncheckedCloudError":function(d){return "Обов'язково перевірте усі хмари, чи є у них квіти та вулики."},
