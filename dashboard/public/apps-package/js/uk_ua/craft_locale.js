...
"tooManyBlocksFail":function(d){return "Завдання "+craft_locale.v(d,"puzzleNumber")+" виконано. Вітаємо! Це завдання можна виконати "+craft_locale.p(d,"numBlocks",0,"uk",{"one":"1 block","other":craft_locale.n(d,"numBlocks")+" blocks"})+"."}};