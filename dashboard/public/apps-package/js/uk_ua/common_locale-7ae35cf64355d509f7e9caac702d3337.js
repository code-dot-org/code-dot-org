...
"emptyExampleBlockErrorMsg":function(d){return "Потрібен хоча б один приклад у функції "+common_locale.v(d,"functionName")+". Переконайся, що кожен приклад має виклик та результат."},
...
"exampleErrorMessage":function(d){return "У функція "+common_locale.v(d,"functionName")+" один або кілька прикладів потребують виправлення. Переконайся, що вони відповідають визначенню і дай відповідь на питання."},
...
"unnamedFunction":function(d){return "Змінна або функція без імені. Не забувай давати змістові назви."},
