...
"startSetVars":function(d){return "game_vars (назва субтитрів фону, цільової, небезпека, гравець)"},
"startSetFuncs":function(d){return "game_funcs (update цільову, небезпека оновлення, оновлення плеєр, стикаються?, на екрані?)"},
