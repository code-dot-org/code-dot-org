...
Blockly.Msg.COLOUR_BLEND_TOOLTIP = "Змішує два кольори із даним співвідношенням (0.0 - 1.0).";
...
Blockly.Msg.CONTROLS_FOR_INPUT_WITH = "порахувати з";
...
Blockly.Msg.CONTROLS_IF_ELSEIF_TOOLTIP = "Додати умову до блоку „якщо“.";
...
Blockly.Msg.CONTROLS_IF_IF_TOOLTIP = "Додати, видалити або змінити порядок груп для переналаштування блоку якщо.";
Blockly.Msg.CONTROLS_IF_MSG_ELSE = "інакше";
Blockly.Msg.CONTROLS_IF_MSG_ELSEIF = "інакше якщо";
Blockly.Msg.CONTROLS_IF_MSG_IF = "якщо";
Blockly.Msg.CONTROLS_IF_TOOLTIP_1 = "Якщо значення істинне, виконати деякі команди.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_2 = "Якщо значення істинне, то виконується перший блок команд. У протилежному випадку виконується другий блок команд.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_3 = "Якщо перше значення істинне, то виконується перший блок команд. У протилежному випадку, якщо друге значення істинне, то виконується другий блок команд.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_4 = "Якщо перше значення істинне, то виконується перший блок команд. У протилежному випадку, якщо друге значення істинне, то виконується другий блок команд. Якщо жодне із значень не є істинним, то виконується останній блок команд.";
Blockly.Msg.CONTROLS_REPEAT_HELPURL = "http://uk.wikipedia.org/wiki/Цикл_(Програмування)";
Blockly.Msg.CONTROLS_REPEAT_INPUT_DO = "робити";
...
Blockly.Msg.CONTROLS_REPEAT_TOOLTIP = "Виконати деякі команди кілька разів.";
Blockly.Msg.CONTROLS_WHILEUNTIL_HELPURL = "http://code.google.com/p/blockly/wiki/Repeat";
Blockly.Msg.CONTROLS_WHILEUNTIL_OPERATOR_UNTIL = "повторювати до";
...
Blockly.Msg.DEFINE_HEADER_DEFINITION = "Визначення";
...
Blockly.Msg.DELETE = "Видалити";
Blockly.Msg.DELETE_BLOCK = "Видалити блок";
Blockly.Msg.DELETE_PARAMETER = "Видалити параметр...";
Blockly.Msg.DELETE_PARAMETER_TITLE = "Буде видалено всі входження параметра '%1'. Ви впевнені?";
...
Blockly.Msg.FUNCTION_NAME_LABEL = "Назви функцію:";
Blockly.Msg.FUNCTION_DESCRIPTION_LABEL = "Що має робити функція?";
Blockly.Msg.FUNCTION_PARAMETERS_LABEL = "Які параметри матиме функція?";
Blockly.Msg.FUNCTION_HEADER = "Функція";
Blockly.Msg.FUNCTIONAL_CREATE = "Новий блок";
Blockly.Msg.FUNCTIONAL_EDIT = "редагувати";
Blockly.Msg.FUNCTIONAL_NAME_LABEL = "Ім’я";
Blockly.Msg.FUNCTIONAL_TYPE_LABEL = "Обрати тип...";
Blockly.Msg.FUNCTIONAL_DESCRIPTION_LABEL = "Опис";
Blockly.Msg.FUNCTIONAL_DOMAIN_LABEL = "Розділ";
Blockly.Msg.FUNCTIONAL_PROCEDURE_DEFINE_TOOLTIP = "Визначити функціональний метод";
Blockly.Msg.FUNCTIONAL_RANGE_LABEL = "Діапазон";
Blockly.Msg.FUNCTIONAL_VARIABLE_CREATE = "Створити змінну";
Blockly.Msg.FUNCTIONAL_VARIABLE_HEADER = "Змінна";
...
Blockly.Msg.LISTS_CREATE_WITH_CONTAINER_TOOLTIP = "Додати, видалити або змінити порядок груп для налаштування блоку списку.";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_FROM_END = "Повертає елемент заданої позиції у списку. #1 - це останній елемент.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_FROM_START = "Повертає елемент заданої позиції у списку. #1 - це перший елемент.";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_REMOVE_FROM_END = "Вилучає елемент у вказаній позиції списку. #1 - це останній елемент.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_REMOVE_FROM_START = "Вилучає елемент у вказаній позиції списку. #1 - це перший елемент.";
...
Blockly.Msg.LISTS_INDEX_OF_TOOLTIP = "Повертає індекс першого/останнього входження елемента у список. Повертає 0, якщо текст не знайдений.";
...
Blockly.Msg.LISTS_LENGTH_INPUT_LENGTH = "довжина";
...
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_FROM_END = "Вставка елемента у вказану позицію списку. #1 - це останній елемент.";
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_FROM_START = "Вставка елемента у вказану позицію списку.  #1 є першим елементом.";
...
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_SET_FROM_END = "Задає елемент у вказаній позиції списку. #1 - це останній елемент.";
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_SET_FROM_START = "Задає елемент у вказаній позиції списку. #1 - це перший елемент.";
...
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GT = "Повертає істину, якщо перше вхідне значення більше, ніж другий вхід.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GTE = "Повертає істину, якщо перше вхідне значення більше або дорівнює другому входу.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LT = "Повертає істину, якщо перше вхідне значення менше, ніж другий вхід.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LTE = "Повертає істину, якщо перше вхідне значення менше або дорівнює другому входу.";
...
Blockly.Msg.LOGIC_NEGATE_TOOLTIP = "Повертає істину, якщо вхідне значення хибність. Повертає хибність, якщо вхідна значення істина.";
...
Blockly.Msg.LOGIC_OPERATION_TOOLTIP_OR = "Повертає істину, якщо принаймні один з входів  істина.";
...
Blockly.Msg.PROCEDURES_CALLNORETURN_HELPURL = "http://uk.wikipedia.org/wiki/Підпрограма";
...
Blockly.Msg.PROCEDURES_DEFRETURN_PROCEDURE = "щось зробити";
...
Blockly.Msg.PROCEDURES_IFRETURN_TOOLTIP = "Якщо значення істине, то повернути друге значення.";
Blockly.Msg.PROCEDURES_IFRETURN_WARNING = "Попередження: Цей блок може використовуватися лише в межах визначення функції.";
Blockly.Msg.PROCEDURES_MUTATORARG_TITLE = "назва параметра:";
Blockly.Msg.PROCEDURES_MUTATORCONTAINER_TITLE = "вхід";
Blockly.Msg.REMOVE_COMMENT = "Видалити коментар";
Blockly.Msg.RENAME_PARAMETER = "Перейменувати параметр...";
Blockly.Msg.RENAME_PARAMETER_TITLE = "Перейменувати всі '%1'  параметрів на:";
...
Blockly.Msg.TEXT_CREATE_JOIN_TITLE_JOIN = "Приєднатися до";
Blockly.Msg.TEXT_CREATE_JOIN_TOOLTIP = "Додати, видалити або змінити порядок груп для налаштування текстового блоку.";
...
Blockly.Msg.TEXT_TRIM_OPERATOR_BOTH = "вилучати крайні пробіли з обох сторін";
