...
"containerTooltip":function(d){return "Створює контейнер поділу і задає для нього внутрішній HTML."},
...
"repeatForeverTooltip":function(d){return "Під час роботи програми, виконуйте дії з цього блоку кілька разів."},
"shareApplabTwitter":function(d){return "Перегляньте створену мною програму. Я написав її самостійно за допомогою @codeorg"},
"shareGame":function(d){return "Поділитися програмою:"},
"stepIn":function(d){return "Перейти"},
"stepOver":function(d){return "Перескочити"},
"stepOut":function(d){return "Вийти"},
"viewData":function(d){return "Перегляд даних"},
