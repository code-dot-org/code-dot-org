...
Blockly.Msg.CONTROLS_FOREACH_TOOLTIP = "Для кожного елемента в списку задайте змінну '%1', а потім запишіть деякі команди.";
...
Blockly.Msg.FUNCTION_NAME_LABEL = "Назвіть функцію:";
...
Blockly.Msg.SAVE_AND_CLOSE = "Зберегти та закрити";
