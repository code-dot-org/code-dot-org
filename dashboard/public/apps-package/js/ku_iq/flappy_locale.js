...
"endGame":function(d){return "یارییەکە تەواو بکە"},
"endGameTooltip":function(d){return "یارییەکە تەواو دەکات."},
"finalLevel":function(d){return "Congratulations! You have solved the final puzzle."},
"flap":function(d){return "بازدان"},
"flapRandom":function(d){return "بازدانی بڕێکی هەرەمەکی"},
"flapVerySmall":function(d){return "بازدانی بڕێکی زۆر کەم"},
"flapSmall":function(d){return "بازدانی بڕێکی کەم"},
"flapNormal":function(d){return "بازدانی بڕێکی ئاسایی"},
"flapLarge":function(d){return "بازدانی بڕێکی گەورە"},
"flapVeryLarge":function(d){return "بازدانی بڕێکی زۆر گەورە"},
"flapTooltip":function(d){return "فڕینی فلاپی بۆ سەرەوە."},
"flappySpecificFail":function(d){return "کۆدەکانت باش دەردەکەون - ئەوە لەگەڵ هەر کرتەیەک بازدەدات. بەڵام تۆ پێویستتە زۆر جار کرتە بکەیت بۆ ئەوەی باز بدات بۆ ئامانجەکە."},
"incrementPlayerScore":function(d){return "خاڵێک وەربگرە"},
...
"playSoundRandom":function(d){return "دەنکێکی هەرەمەکی لێبدە"},
"playSoundBounce":function(d){return "دەنگی هەڵبەزینەوە ئیش پێ بکە"},
"playSoundCrunch":function(d){return "play crunch sound"},
"playSoundDie":function(d){return "دەنگی غەمگینی بەکار بهێنە"},
"playSoundHit":function(d){return "دەنگی شکان لێبدە"},
"playSoundPoint":function(d){return "دەنگی خاڵ لێبدە"},
"playSoundSwoosh":function(d){return "دەنگی خشەخش لێبدە"},
...
"soundRandom":function(d){return "هەڕەمەکی"},
