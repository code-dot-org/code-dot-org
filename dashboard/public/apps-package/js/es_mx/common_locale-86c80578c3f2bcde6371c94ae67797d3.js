...
"clearPuzzleConfirm":function(d){return "Esto reabrirá el crucigrama a su estado original, eliminando todos los bloques que hayas agregado o cambiado."},
...
"emptyBlocksErrorMsg":function(d){return "Los bloques \"repetir\" o \"si\" deben tener contener otros bloques para funcionar. Asegúrate que los bloques queden correctamente conectados."},
"emptyBlockInFunction":function(d){return "La función "+common_locale.v(d,"name")+" tiene una entrada sin llenar."},
"emptyBlockInVariable":function(d){return "La Variable"+common_locale.v(d,"name")+" tiene entrada definida."},
...
"emptyTopLevelBlock":function(d){return "No hay bloques de ejecuciòn. Debe proveer al menos uno para el bloque "+common_locale.v(d,"topLevelBlockName")+"."},
