...
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_CONTINUE = "Salta el resto de esta iteración, y continúa con la siguiente.";
...
Blockly.Msg.CONTROLS_FOR_TOOLTIP = "La variable %1 ha tomado los valores que van desde el número inicial hasta el número final, bajo el intervalo establecido, y ejecuto los bloques especificados.";
...
Blockly.Msg.CONTROLS_IF_TOOLTIP_1 = "Si un valor es verdadero, entonces ejecuta algunos comandos.";
...
Blockly.Msg.CONTROLS_IF_TOOLTIP_3 = "Si el primer valor es verdadero, entonces ejecuta el primer bloque de instrucciones. De lo contrario, si el segundo valor es verdadero, ejecuta el segundo bloque de instrucciones.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_4 = "Si el primer valor es cierto, entonces ejecuta el primer bloque de instrucciones. De lo contrario, si el segundo valor es cierto, ejecuta el segundo bloque de instrucciones. Si ninguno de los valores son ciertos, ejecuta el último bloque de instrucciones.";
...
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_WHILE = "Mientras que un valor sea verdadero, entonces ejecuta algunas instrucciones.";
...
Blockly.Msg.DELETE_PARAMETER_TITLE = "¿Estas seguro? Esto borraria todos los parámetros '%1' existentes?";
Blockly.Msg.DELETE_X_BLOCKS = "Eliminar bloques de %1";
...
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_EQ = "Devuelve verdadero si ambas entradas son iguales entre si.";
...
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LTE = "Devuelve verdadero si la primera entrada es menor o igual a la segunda.";
...
Blockly.Msg.LOGIC_TERNARY_TOOLTIP = "Comprueba la condición en \"probar\". Si la condición es verdadera, devolvera el valor indicado en \"si es cierto\"; de lo contrario, devolver el valor indicado en \"si es falso\".";
...
Blockly.Msg.MATH_MODULO_TITLE = "el resto de dividir %1 ÷ %2";
Blockly.Msg.MATH_MODULO_TOOLTIP = "Devolver el resto de dividir dos números.";
...
Blockly.Msg.MATH_RANDOM_FLOAT_TOOLTIP = "Devuelve una fracción aleatoria entre 0.0 (incluyendolo)  y 1.0 (excluyendolo).";
...
Blockly.Msg.MATH_RANDOM_INT_TOOLTIP = "Devuelve un número entero aleatorio entre los dos límites especificados, incluyendolos.";
Blockly.Msg.MATH_ROUND_HELPURL = "http://es.wikipedia.org/wiki/Redondeo";
Blockly.Msg.MATH_ROUND_OPERATOR_ROUND = "redondear";
Blockly.Msg.MATH_ROUND_OPERATOR_ROUNDDOWN = "redondea hacia la parte entera del número";
Blockly.Msg.MATH_ROUND_OPERATOR_ROUNDUP = "redondea hacia el siguiente número entero";
...
Blockly.Msg.MATH_SINGLE_OP_ABSOLUTE = "valor absoluto de un número";
Blockly.Msg.MATH_SINGLE_OP_ROOT = "raíz cuadrada";
Blockly.Msg.MATH_SINGLE_TOOLTIP_ABS = "Devuelve el valor absoluto de un número. le quita el signo.";
...
Blockly.Msg.MATH_SINGLE_TOOLTIP_NEG = "Devuelve la negación de un número. invierte el signo del número.";
...
Blockly.Msg.TEXT_CHANGECASE_OPERATOR_UPPERCASE = "convertir a mayúsculas";
...
Blockly.Msg.TEXT_CHARAT_RANDOM = "obtener una  letra al azar de un texto";
