...
Blockly.Msg.CONFIRM_DELETE_FUNCTION_MESSAGE = "Yes?";
Blockly.Msg.CONTRACT_EDITOR_HEADER = "Diseña una receta";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_HELPURL = "https://code.google.com/p/blockly/wiki/Loops#Loop_Termination_Blocks";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_OPERATOR_BREAK = "desconecta el enlazador";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_OPERATOR_CONTINUE = "continuar con la siguiente interacción de enlace";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_BREAK = "Interrumpe el contenedor de enlazamiento.";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_CONTINUE = "Salta el resto de estas iteraciones, y continua con la siguiente.";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_WARNING = "Advertencia: Este bloque solo puede usarse con un enlazador.";
Blockly.Msg.CONTROLS_FOREACH_HELPURL = "https://code.google.com/p/blockly/wiki/Loops#for_each";
Blockly.Msg.CONTROLS_FOREACH_INPUT_INLIST = "enlistado";
Blockly.Msg.CONTROLS_FOREACH_INPUT_INLIST_TAIL = "";
Blockly.Msg.CONTROLS_FOREACH_INPUT_ITEM = "para cada elemento";
Blockly.Msg.CONTROLS_FOREACH_TOOLTIP = "Establece una variable '%1' para cada cosa en la lista, y después establece criterios.";
Blockly.Msg.CONTROLS_FOR_HELPURL = "https://code.google.com/p/blockly/wiki/Loops#count_with";
Blockly.Msg.CONTROLS_FOR_INPUT_FROM_TO_BY = "de %1 a %2 hasta %3";
Blockly.Msg.CONTROLS_FOR_INPUT_WITH = "contar con";
Blockly.Msg.CONTROLS_FOR_TOOLTIP = "Deja que la variable %1 tome los valores desde el número inicial hasta el número final, bajo el intervalo establecido, y haz los bloques especificados.";
Blockly.Msg.CONTROLS_IF_ELSEIF_TOOLTIP = "Agrega una condición al Si block.";
Blockly.Msg.CONTROLS_IF_ELSE_TOOLTIP = "Agregar una condición final generalizada al Si bloque.";
Blockly.Msg.CONTROLS_IF_HELPURL = "http://code.google.com/p/blockly/wiki/If_Then";
Blockly.Msg.CONTROLS_IF_IF_TOOLTIP = "Agregar, eliminar o reordenar las secciones para reconfigurar este Si bloquel.";
Blockly.Msg.CONTROLS_IF_MSG_ELSE = "sino";
Blockly.Msg.CONTROLS_IF_MSG_ELSEIF = "si solo si";
Blockly.Msg.CONTROLS_IF_MSG_IF = "si";
Blockly.Msg.CONTROLS_IF_TOOLTIP_1 = "Si un valor es verdadero, entonces aplica las condicionantes.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_2 = "Si un valor es verdadero, entonces ejecuta el primer bloque de condicionantes.  De lo contrario, opta por el segundo bloque condicionante.";
...
Blockly.Msg.CONTROLS_IF_TOOLTIP_4 = "Si el primer valor es cierto, ejecuta entonces el primer bloque condicional. De lo contrario, si el segundo valor es cierto, selecciona el segundo bloque condicional. Si ninguno de los valores son ciertos, aplica el último bloque condicional.";
...
Blockly.Msg.CONTROLS_REPEAT_TOOLTIP = "Ejecuta los condicionantes varias veces.";
...
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_UNTIL = "Cuando un valor sea falso, entonces ejecuta algún condicionante.";
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_WHILE = "Si un valor es verdadero, entonces ejecuta algun condicionante.";
Blockly.Msg.DEFINE_HEADER_DEFINITION = "Definición";
Blockly.Msg.DEFINE_FUNCTION_DEFINE = "Definir";
Blockly.Msg.DEFINE_FUNCTION_FOR_EXAMPLE = "Define la función de abajo e intenta de nuevo.";
Blockly.Msg.DELETE = "Borrar";
Blockly.Msg.DELETE_BLOCK = "Borrar Bloque";
Blockly.Msg.DELETE_PARAMETER = "Borrar parámetro...";
Blockly.Msg.DELETE_PARAMETER_TITLE = "Estas seguro? Esto borraria las recurrencias del parámetro '%1'?";
...
Blockly.Msg.EXAMPLE_DESCRIPTION = "Define un ejemplo con el comportamiento actual y esperado";
Blockly.Msg.EXPAND_ALL = "Expandir bloques";
Blockly.Msg.EXPAND_BLOCK = "Expandir bloque";
Blockly.Msg.EXPECTED = "resultado";
Blockly.Msg.EXTERNAL_INPUTS = "Impulsos externas";
...
Blockly.Msg.FUNCTION_PARAMETERS_LABEL = "¿Qué parámetros tendra tu función?";
...
Blockly.Msg.LISTS_CREATE_EMPTY_TOOLTIP = "Regresa a la lista, de longitud 0, sin ningún historico de datos";
...
Blockly.Msg.LISTS_INLIST = "enlistado";
...
Blockly.Msg.LISTS_LENGTH_TOOLTIP = "Regresa al tamaño de la lista.";
Blockly.Msg.LISTS_REPEAT_HELPURL = "https://code.google.com/p/blockly/wiki/Lists#create_list_with";
Blockly.Msg.LISTS_REPEAT_TITLE = "crear lista con el elemento %1 repetido %2 veces";
Blockly.Msg.LISTS_REPEAT_TOOLTIP = "Crea una lista desde un valor predeterminado y que se repite el número de veces especificado.";
...
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_RANDOM = "Inserta aleatoriamente el elemento en la lista.";
