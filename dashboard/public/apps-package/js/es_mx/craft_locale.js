...
"blockPlaceXAheadPlace":function(d){return "lugar"},
"blockPlaceXPlace":function(d){return "lugar"},
...
"blockTypeBricks":function(d){return "ladrillos (bloque)"},
"blockTypeClay":function(d){return "arcilla"},
"blockTypeClayHardened":function(d){return "Arcilla endurecida (ladrillo)"},
"blockTypeCobblestone":function(d){return "Piedra"},
"blockTypeDirt":function(d){return "Tierra"},
"blockTypeDirtCoarse":function(d){return "Tierra mas sucia"},
...
"houseSelectChooseFloorPlan":function(d){return "Elegir el modelo para su casa."},
"houseSelectEasy":function(d){return "Fácil"},
"houseSelectHard":function(d){return "Difícil"},
"houseSelectLetsBuild":function(d){return "Vamos a construir tu casa."},
"houseSelectMedium":function(d){return "En medio"},
"keepPlayingButton":function(d){return "Seguir Jugando"},
"level10FailureMessage":function(d){return "Cubre la lava para poder pasar, luego consigue dos bloques de hierro del otro lado de la mina."},
...
"level3FailureMessage":function(d){return "Para obtener la lana de los dos corderos, camina hasta cada uno de ellos y usa el comando \"cortar\". Recuerda usar el comando girar para llegar a la oveja."},
"level3TooFewBlocksMessage":function(d){return "Trata de usar más comandos para recoger lana de dos corderos. Ve a cada una y utiliza el comando de \"esquilar obejas\"."},
"level4FailureMessage":function(d){return "Debes utilizar el comando de \"destruir el bloque\" en cada uno de los tres troncos."},
...
"level8FailureMessage":function(d){return "Si toca un Creeper va a explotar. Haz la serpiente alrededor de ellos y entra a tu casa."},
"level9FailureMessage":function(d){return "No se olvide de colocar al menos 2 antorchas para iluminar su camino y el mío al menos 2 de carbón.      (traduccion por Piedri)"},
