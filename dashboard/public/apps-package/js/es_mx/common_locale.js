...
"emptyTopLevelBlock":function(d){return "No hay bloques de ejecución. Debe adjuntar uno al bloque "+common_locale.v(d,"topLevelBlockName")+"."},
"end":function(d){return "fin"},
"errorEmptyFunctionBlockModal":function(d){return "Deben haber bloques internos para definir la función. Haga clic en Editar e inserte al menos un bloque dentro del bloque verde."},
"errorIncompleteBlockInFunction":function(d){return "Haga clic en \"Editar\" para asegurarse de que no tiene faltantes de bloques en su definición de función."},
"errorParamInputUnattached":function(d){return "Recuerde anexar un bloque para cada entrada de parámetro del bloque de función en tu espacio de trabajo."},
"errorQuestionMarksInNumberField":function(d){return "Intenta reemplazar \"???\" con un valor."},
"errorRequiredParamsMissing":function(d){return "Crea cada parámetro para tu función haciendo clic en Editar y añade los parámetros necesarios. Arrastra los nuevos bloques parámetro a la definición de tu función."},
...
"errorUnusedParam":function(d){return "Añadiste un bloque parámetro pero no lo probaste en la definición. Asegúrate de usar el parámetro haciendo clic en Editar y situando el bloque parámetro dentro del bloque verde."},
"exampleErrorMessage":function(d){return "La función"+common_locale.v(d,"functionName")+" tiene uno o mas ejemplos que requiere ajuste. Usted debe asegurarse que las definiciones respondan las preguntas."},
...
"genericFeedback":function(d){return "Mira como concluyo, y trata de corregir tu programa."},
...
"missingBlocksErrorMsg":function(d){return "Utiliza ono o mas de los bloques de abajo para resolver este crucigrama."},
