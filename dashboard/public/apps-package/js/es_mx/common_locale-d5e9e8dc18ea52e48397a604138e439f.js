...
"emptyBlockInFunction":function(d){return "La función "+common_locale.v(d,"name")+" tiene una entrada vacía."},
...
"emptyTopLevelBlock":function(d){return "No hay bloques para ejecutar. Debes adjuntar uno para el bloque "+common_locale.v(d,"topLevelBlockName")+"."},
