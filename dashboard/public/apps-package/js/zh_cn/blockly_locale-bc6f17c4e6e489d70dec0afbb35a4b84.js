...
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_BREAK = "中断包含它的循环。\n提示-请参阅[https://code.google.com/p/blockly/wiki/Loops#break_out_of_loop https://code.google.com/p/blockly/wiki/Loops#break_out_of_loop].";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_CONTINUE = "跳过这个循环剩余的步骤，然后执行下一次迭代。\n提示-请参阅[https://code.google.com/p/blockly/wiki/Loops#continue_with_next_iteration https://code.google.com/p/blockly/wiki/Loops#continue_with_next_iteration].";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_WARNING = "警告：这一区域的代码只能在一个循环内有效\n警告 - 用户试图将一个块中的循环外（每个，同时，重复等） ，但这种类型的块可以仅在一个循环中被使用。请参阅[https://code.google.com/p/blockly/wiki/Loops#Loop_Termination_Blocks https://code.google.com/p/blockly/wiki/Loops#Loop_Termination_Blocks].";
...
Blockly.Msg.CONTROLS_FOREACH_INPUT_ITEM = "为每个项目\n快输入文字-标题[https://code.google.com/p/blockly/wiki/Loops#for_each for each block].";
Blockly.Msg.CONTROLS_FOREACH_TOOLTIP = "列表中的每个项目都把它设置成变量“%1”， 然后执行一些语句。\n文本块-[https://code.google.com/p/blockly/wiki/Loops#for_each for each blocks]的说明。\n\n参数：\n*％1 - 循环变量的名称。";
Blockly.Msg.CONTROLS_FOR_HELPURL = "https://code.google.com/p/blockly/wiki/Loops#count_with";
Blockly.Msg.CONTROLS_FOR_INPUT_FROM_TO_BY = "从 %1 到 %2 间隔 %3";
Blockly.Msg.CONTROLS_FOR_INPUT_WITH = "以...方式计数\n块标题-[https://code.google.com/p/blockly/wiki/Loops#count_with count with] 块的标题\n[[File:Blockly-count-with.png]]";
Blockly.Msg.CONTROLS_FOR_TOOLTIP = "让变量%1从开始的数字，以设定的间隔改变，直到结束的数字为止，在这个过程中，持续执行当前块中所包含的块。\n提示 - 请参阅[ https://code.google.com/p/blockly/wiki/Loops#count_with\nhttps://code.google.com/p/blockly/wiki/loops#count_with\n\n参数：* ％1 - 循环变量的名称。\n\n";
Blockly.Msg.CONTROLS_IF_ELSEIF_TOOLTIP = "在“假设”板块中添加一个条件";
Blockly.Msg.CONTROLS_IF_ELSE_TOOLTIP = "在“假设”板块中添加一个最终并且能捕获所有信息的条件 。";
Blockly.Msg.CONTROLS_IF_HELPURL = "http://code.google.com/p/blockly/wiki/If_Then";
Blockly.Msg.CONTROLS_IF_IF_TOOLTIP = "增加、删除或者调整板块的顺序来重新配置“假设”的板块。";
Blockly.Msg.CONTROLS_IF_MSG_ELSE = "其他";
Blockly.Msg.CONTROLS_IF_MSG_ELSEIF = "或者如果";
Blockly.Msg.CONTROLS_IF_MSG_IF = "如果";
Blockly.Msg.CONTROLS_IF_TOOLTIP_1 = "如果值是正确的，执行一些语句。";
Blockly.Msg.CONTROLS_IF_TOOLTIP_2 = "如果值正确，执行第一部分语句。否则，执行第二部分语句。";
Blockly.Msg.CONTROLS_IF_TOOLTIP_3 = "如果第一个值为真，执行第一部分的语句。否则，如果第二个值为真，执行第二部分的语句。";
Blockly.Msg.CONTROLS_IF_TOOLTIP_4 = "如果第一个值正确，执行第一部分的语句。否则，如果第二个值正确，执行第二部分的语句。如果没有一个值正确，执行最后一部分的语句。";
...
Blockly.Msg.LISTS_CREATE_WITH_CONTAINER_TOOLTIP = "添加，移除，或重新排列板块来重组这个列表块。";
...
Blockly.Msg.LISTS_GET_SUBLIST_START_FIRST = "从第一项开始得到分列表";
Blockly.Msg.LISTS_GET_SUBLIST_START_FROM_END = "从倒数第#项开始得到分列表";
Blockly.Msg.LISTS_GET_SUBLIST_START_FROM_START = "从第#项开始得到分列表";
...
Blockly.Msg.LISTS_REPEAT_TITLE = "创建一个重复项%1%2次的列表";
...
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_FROM_START = "在列表指定位置插入这一项。#1是最后一项。";
...
Blockly.Msg.LOGIC_TERNARY_TOOLTIP = "检查test中的条件。如果条件为真，将返回 '如果为真'  ；否则，返回的 '如果是假'。";
...
Blockly.Msg.MATH_RANDOM_FLOAT_TOOLTIP = "返回一个0.0 (包括)和 1.0 (不包括)之间的随机分数。";
...
Blockly.Msg.MATH_ROUND_TOOLTIP = "将一个数字向上或向下舍入。";
...
Blockly.Msg.TEXT_TRIM_OPERATOR_BOTH = "从两边削减空间";
Blockly.Msg.TEXT_TRIM_OPERATOR_LEFT = "从左边削减空间";
Blockly.Msg.TEXT_TRIM_OPERATOR_RIGHT = "从右边削减空间";
