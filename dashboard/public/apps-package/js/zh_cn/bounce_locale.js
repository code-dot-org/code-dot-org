...
"whenDown":function(d){return "当下方向键按下时"},
"whenDownTooltip":function(d){return "执行下面按向下箭头键时采取的行动。"},
"whenGameStarts":function(d){return "当游戏开始"},
"whenGameStartsTooltip":function(d){return "执行以下指令在游戏的开始时。"},
"whenLeft":function(d){return "当左方向键按下时"},
...
"whenRight":function(d){return "当右方向键按下时"},
"whenRightTooltip":function(d){return "执行下面按向右箭头键时采取的行动。"},
"whenUp":function(d){return "当上方向键按下时"},
