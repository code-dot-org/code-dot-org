...
"addItems1":function(d){return "添加1个项目类型"},
"addItems2":function(d){return "添加2个项目类型"},
"addItems3":function(d){return "添加3个项目类型"},
"addItems5":function(d){return "添加5个项目类型"},
"addItems10":function(d){return "添加10个项目类型"},
"addItemsRandom":function(d){return "添加随机项目类型"},
"addItemsTooltip":function(d){return "向场景中添加项目。"},
...
"dropletBlock_setItemSpeed_param1":function(d){return "速度"},
...
"dropletBlock_setCharacterSpeed_param0":function(d){return "速度"},
