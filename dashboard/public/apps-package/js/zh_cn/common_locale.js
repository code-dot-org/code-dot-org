...
"dropletBlock_comment_description":function(d){return "写一些代码的描述"},
"dropletBlock_comment_signatureOverride":function(d){return "注解"},
...
"dropletBlock_randomNumber_description":function(d){return "在闭值域内返回到一个随机数字"},
...
"recommendedBlockContextualHintTitle":function(d){return "试着用这样的模块来解谜"},
...
"saveToGallery":function(d){return "保存"},
