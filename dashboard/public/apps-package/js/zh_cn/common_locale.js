...
"dropletBlock_appendItem_description":function(d){return "将该项追加到数组的末尾"},
"dropletBlock_appendItem_param0":function(d){return "列表"},
"dropletBlock_appendItem_param0_description":function(d){return "要修改该数组。"},
"dropletBlock_appendItem_param1":function(d){return "项"},
"dropletBlock_appendItem_param1_description":function(d){return "要添加到数组末尾的项。"},
"dropletBlock_arcLeft_description":function(d){return "让乌龟前进并向左划出一条平滑的圆弧"},
"dropletBlock_arcLeft_param0":function(d){return "角度"},
"dropletBlock_arcLeft_param0_description":function(d){return "沿着圆圈移动角。"},
"dropletBlock_arcLeft_param1":function(d){return "半径"},
"dropletBlock_arcLeft_param1_description":function(d){return "位于乌龟左边的圆的半径，必须是 > = 0。"},
"dropletBlock_arcRight_description":function(d){return "让乌龟前进并向右划出一条平滑的圆弧"},
"dropletBlock_arcRight_param0":function(d){return "角度"},
"dropletBlock_arcRight_param0_description":function(d){return "沿着圆圈移动角。"},
"dropletBlock_arcRight_param1":function(d){return "半径"},
"dropletBlock_arcRight_param1_description":function(d){return "位于右边乌龟的圆的半径，必须是 > = 0。"},
...
"dropletBlock_button_param0_description":function(d){return "该按钮的的唯一标识符。该 id 用于引用创建的按钮。例如，若要分配事件处理程序。"},
"dropletBlock_button_param1":function(d){return "文本"},
"dropletBlock_button_param1_description":function(d){return "显示在按钮内的文本。"},
...
"dropletBlock_circle_param0_description":function(d){return "圈子的中心 x 位置 （以像素为单位）。"},
"dropletBlock_circle_param1":function(d){return "中心Y"},
"dropletBlock_circle_param1_description":function(d){return "圈子的中心 x 位置 （以像素为单位）。"},
"dropletBlock_circle_param2":function(d){return "半径"},
"dropletBlock_circle_param2_description":function(d){return "圆半径的大小，以像素为单位。"},
...
"dropletBlock_console.log_param0_description":function(d){return "要在控制台中显示的消息字符串。"},
...
"dropletBlock_createCanvas_param0_description":function(d){return "新的画布元素的 id。"},
"dropletBlock_createCanvas_param1":function(d){return "宽度"},
"dropletBlock_createCanvas_param1_description":function(d){return "水平的宽度 （以像素为单位） 的矩形。"},
"dropletBlock_createCanvas_param2":function(d){return "高度"},
"dropletBlock_createCanvas_param2_description":function(d){return "以像素为单位的矩形的垂直高度。"},
...
"dropletBlock_insertItem_param0":function(d){return "列表"},
"dropletBlock_insertItem_param0_description":function(d){return "要修改该数组。"},
...
"dropletBlock_insertItem_param2":function(d){return "项"},
...
"dropletBlock_penRGB_param0":function(d){return "红色"},
...
"dropletBlock_penRGB_param1":function(d){return "绿色"},
...
"dropletBlock_penRGB_param2":function(d){return "蓝色"},
...
"dropletBlock_rect_param2_description":function(d){return "水平的宽度 （以像素为单位） 的矩形。"},
"dropletBlock_rect_param3":function(d){return "高度"},
"dropletBlock_rect_param3_description":function(d){return "以像素为单位的矩形的垂直高度。"},
"dropletBlock_removeItem_description":function(d){return "Remove the item at the specified position from the array"},
"dropletBlock_removeItem_param0":function(d){return "列表"},
"dropletBlock_removeItem_param0_description":function(d){return "要修改该数组。"},
...
"dropletBlock_substring_param1":function(d){return "结束"},
