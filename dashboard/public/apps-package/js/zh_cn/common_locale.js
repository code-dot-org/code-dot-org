...
"dropletBlock_arcLeft_description":function(d){return "让乌龟前进并向左划出一条平滑的圆弧"},
"dropletBlock_arcLeft_param0":function(d){return "角度"},
...
"dropletBlock_arcRight_description":function(d){return "让乌龟前进并向右划出一条平滑的圆弧"},
"dropletBlock_arcRight_param0":function(d){return "角度"},
...
"dropletBlock_button_description":function(d){return "创建一个按钮。这个按钮不仅能显示所提供的文本，也可以被所指定的 id 引用。"},
"dropletBlock_button_param0":function(d){return "按钮ID"},
...
"dropletBlock_checkbox_param0":function(d){return "复选框ID"},
"dropletBlock_checkbox_param1":function(d){return "已勾选"},
...
"dropletBlock_clearInterval_param0":function(d){return "时间间隔"},
...
"dropletBlock_clearTimeout_param0":function(d){return "超时"},
...
"dropletBlock_radioButton_param1":function(d){return "已勾选"},
...
"dropletBlock_setChecked_param1":function(d){return "已勾选"},
