...
"setSpriteAnna":function(d){return "到安娜图象"},
...
"setSpriteN":function(d){return "设置演员 "+appLocale.v(d,"spriteIndex")},
...
"throwSpriteN":function(d){return "演员 "+appLocale.v(d,"spriteIndex")+" 抛出"},
"throwTooltip":function(d){return "从特定的演员抛出一个抛出物"},
"vanish":function(d){return "消失"},
"vanishActorN":function(d){return "消失的演员 "+appLocale.v(d,"spriteIndex")},
...
"whenSpriteClickedN":function(d){return "演员 "+appLocale.v(d,"spriteIndex")+" 被单击时"},
"whenSpriteClickedTooltip":function(d){return "当小人被点击时，执行下面的动作。"},
"whenSpriteCollidedN":function(d){return "演员 "+appLocale.v(d,"spriteIndex")},
...
"whenSpriteCollidedWithN":function(d){return "接近演员 "+appLocale.v(d,"spriteIndex")},
