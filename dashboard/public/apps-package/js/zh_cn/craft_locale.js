...
"blockPlaceTorch":function(d){return "放置火炬"},
"blockPlaceXAheadAhead":function(d){return "在面前"},
"blockPlaceXAheadPlace":function(d){return "摆放"},
"blockPlaceXPlace":function(d){return "摆放"},
"blockPlantCrop":function(d){return "种庄稼"},
...
"blockTypeBricks":function(d){return "砖"},
...
"blockTypeFarmlandWet":function(d){return "农田"},
"blockTypeGlass":function(d){return "玻璃"},
"blockTypeGrass":function(d){return "草地"},
"blockTypeGravel":function(d){return "砾石"},
"blockTypeLava":function(d){return "岩浆"},
"blockTypeLogAcacia":function(d){return "合欢树原木"},
"blockTypeLogBirch":function(d){return "桦树原木"},
"blockTypeLogJungle":function(d){return "热带原木"},
"blockTypeLogOak":function(d){return "橡树原木"},
"blockTypeLogSpruce":function(d){return "云杉原木"},
"blockTypeOreCoal":function(d){return "煤矿"},
"blockTypeOreDiamond":function(d){return "钻石矿"},
"blockTypeOreEmerald":function(d){return "翡翠矿"},
...
"blockTypePlanksAcacia":function(d){return "合欢木材"},
"blockTypePlanksBirch":function(d){return "白桦木板"},
"blockTypePlanksJungle":function(d){return "热带木材"},
"blockTypePlanksOak":function(d){return "橡木木板"},
"blockTypePlanksSpruce":function(d){return "云杉木材"},
...
"houseSelectMedium":function(d){return "普通"},
"keepPlayingButton":function(d){return "继续玩"},
"level10FailureMessage":function(d){return "将熔岩覆盖后走到对面，然后挖两块铁矿石。"},
"level11FailureMessage":function(d){return "如果前面有熔岩，你得在前面放上圆石，才能安全的开采资源。"},
...
"level1FailureMessage":function(d){return "你需要用程序模块来走到羊旁边。"},
"level1TooFewBlocksMessage":function(d){return "试着用更多的程序模块来走到羊旁边。"},
"level2FailureMessage":function(d){return "如果要砍倒一棵树，需要走到树干前，然后使用”摧毁方块“程序模块。"},
"level2TooFewBlocksMessage":function(d){return "试着用更多的程序模块来砍到树木。走到树干那里，然后使用”摧毁方块“程序模块。"},
"level3FailureMessage":function(d){return "走到每只羊旁边，用“修剪”模块来收集羊毛。记住使用”向左转“、”向右转“命令模块来走到羊旁边。"},
"level3TooFewBlocksMessage":function(d){return "试着用更多的命令模块来收集这两只羊的羊毛。走到每只羊旁边，然后使用”修剪“模块。"},
...
"minecraftBlock":function(d){return "模块"},
