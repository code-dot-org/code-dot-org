...
"blockDestroyBlock":function(d){return "消减方块"},
...
"blockPlantCrop":function(d){return "种植农作物"},
...
"generatedCodeDescription":function(d){return "通过拖动和块置于这个难题，您创建了一套指令在一种叫做 Javascript 的计算机语言。这段代码告诉计算机如何将一切你看和做在也始于像这些计算机代码行的Minecraft显示在屏幕上。"},
...
"nextLevelMsg":function(d){return "谜团 "+craft_locale.v(d,"puzzleNumber")+" 解出。祝贺您!"},
