...
// This build product is included in the page defined at dashboard/app/views/videos/embed.html.haml
'use strict';

window.$ = require('jquery');
require('./videos');

},{"./videos":5,"jquery":1}],4:[function(require,module,exports){
'use strict';
