...
ActiveRecord::Schema.define(version: 2025_02_14_202758) do
  ...
  create_table "aichat_messages", charset: "utf8", collation: "utf8_unicode_ci", force: :cascade do |t|
  ...
  create_table "aichat_threads", charset: "utf8", collation: "utf8_unicode_ci", force: :cascade do |t|
