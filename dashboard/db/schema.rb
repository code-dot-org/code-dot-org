...
ActiveRecord::Schema.define(version: 20170117185757) do
  ...
  create_table "coteachers", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci" do |t|
    t.integer  "user_id"
    t.integer  "section_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["section_id"], name: "index_coteachers_on_section_id", using: :btree
    t.index ["user_id"], name: "index_coteachers_on_user_id", using: :btree
  end
  ...
  create_table "followers", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci" do |t|
    ...
    t.index ["student_user_id"], name: "index_followers_on_user_id_and_student_user_id", using: :btree
  end
