...
ActiveRecord::Schema.define(version: 20200217185424) do
  ...
  create_table "forrm_forms", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci" do |t|
    t.string   "name",                     null: false
    t.integer  "version",                  null: false
    t.text     "questions",  limit: 65535, null: false
    t.datetime "created_at",               null: false
    t.datetime "updated_at",               null: false
    t.index ["name", "version"], name: "index_forrm_forms_on_name_and_version", unique: true, using: :btree
  end

  create_table "forrm_submissions", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci" do |t|
