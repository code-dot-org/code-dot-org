...
ActiveRecord::Schema.define(version: 2023_09_21_172627) do
  ...
  create_table "ap_cs_offerings", id: :integer, charset: "utf8mb3", collation: "utf8_unicode_ci", force: :cascade do |t|
  ...
  create_table "ap_school_codes", id: false, charset: "utf8mb3", collation: "utf8_unicode_ci", force: :cascade do |t|
  ...
  create_table "circuit_playground_discount_applications", id: :integer, charset: "utf8mb3", collation: "utf8_unicode_ci", force: :cascade do |t|
    t.integer "user_id", null: false
  ...
  create_table "circuit_playground_discount_codes", id: :integer, charset: "utf8mb3", collation: "utf8_unicode_ci", force: :cascade do |t|
  ...
  create_table "learning_goal_evaluations", charset: "utf8mb3", collation: "utf8_unicode_ci", force: :cascade do |t|
    t.integer "user_id"
