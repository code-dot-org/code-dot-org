...
ActiveRecord::Schema.define(version: 20171012203910) do
  ...
  create_table "school_yearly_stats", primary_key: ["school_id", "school_year"], force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci" do |t|
    ...
    t.datetime "created_at",                    null: false
    t.datetime "updated_at",                    null: false
    t.index ["school_id"], name: "index_school_yearly_stats_on_school_id", using: :btree
  end
  ...
  add_foreign_key "school_yearly_stats", "schools"
