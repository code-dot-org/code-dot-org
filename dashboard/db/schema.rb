...
ActiveRecord::Schema.define(version: 2025_03_28_153956) do
  ...
  create_table "ai_tutor_interaction_feedbacks", charset: "utf8", collation: "utf8_unicode_ci", force: :cascade do |t|
  ...
  create_table "aidiff_message_feedbacks", charset: "utf8", collation: "utf8_unicode_ci", force: :cascade do |t|
  ...
  create_table "lti_feedbacks", charset: "utf8", collation: "utf8_unicode_ci", force: :cascade do |t|
    t.integer "user_id", null: false
  ...
  create_table "user_level_evaluations", charset: "utf8", collation: "utf8_unicode_ci", force: :cascade do |t|
    t.integer "user_id", null: false
    t.integer "level_id", null: false
    t.integer "script_id", null: false
