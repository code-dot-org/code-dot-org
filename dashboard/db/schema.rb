...
ActiveRecord::Schema.define(version: 20170815203727) do
  ...
  create_table "shortened_urls", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci" do |t|
    t.integer  "owner_id"
    ...
    t.index ["url"], name: "index_shortened_urls_on_url", length: { url: 64 }, using: :btree
  end
