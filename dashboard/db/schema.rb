...
ActiveRecord::Schema.define(version: 2023_09_27_153604) do
  ...
  create_table "ap_cs_offerings", id: :integer, charset: "utf8mb3", collation: "utf8mb3_unicode_ci", force: :cascade do |t|
  ...
  create_table "ap_school_codes", id: false, charset: "utf8mb3", collation: "utf8mb3_unicode_ci", force: :cascade do |t|
  ...
  create_table "circuit_playground_discount_applications", id: :integer, charset: "utf8mb3", collation: "utf8mb3_unicode_ci", force: :cascade do |t|
    t.integer "user_id", null: false
  ...
  create_table "circuit_playground_discount_codes", id: :integer, charset: "utf8mb3", collation: "utf8mb3_unicode_ci", force: :cascade do |t|
  ...
  create_table "learning_goal_evaluations", charset: "utf8mb3", collation: "utf8mb3_unicode_ci", force: :cascade do |t|
    t.integer "user_id"
  ...
  create_table "pd_workshop_surveys", id: :integer, charset: "utf8mb3", collation: "utf8mb3_unicode_ci", force: :cascade do |t|
    t.integer "pd_enrollment_id", null: false
    t.text "form_data", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
