...
ActiveRecord::Schema.define(version: 2024_09_20_175046) do
  ...
  create_table "code_review_requests", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "user_id", null: false
    t.integer "script_id", null: false
    t.integer "level_id", null: false
  ...
  create_table "code_reviews", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "user_id", null: false
    t.integer "project_id", null: false
    t.integer "script_id", null: false
    t.integer "level_id", null: false
  ...
  create_table "data_docs", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.string "key", null: false
    t.string "name"
    t.text "content"
    t.datetime "created_at", precision: 6, null: false
  ...
  create_table "learning_goal_evidence_levels", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
  ...
  create_table "learning_goals", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.string "key", null: false
    t.integer "position"
  ...
  create_table "programming_classes", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
  ...
  create_table "programming_methods", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
  ...
  create_table "seed_info", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
