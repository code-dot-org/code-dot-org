...
ActiveRecord::Schema.define(version: 20181106201126) do
  ...
  create_table "user_levels", id: :bigint, default: nil, unsigned: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci" do |t|
    t.integer  "user_id",                      null: false
    t.integer  "level_id",                     null: false
