class CleanupAfterStandaloneUnitMigration < ActiveRecord::Migration[6.1]
  def up
    ...
    # We need to delete these unit groups
    unit_groups_to_delete = %w[sandbox-pl-cv introduction-to-programming-in-music-lab-for-elementary-2025]
    unit_groups_to_delete.each do |unit_group_name|
