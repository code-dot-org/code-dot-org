class RemoveContentRootTypeFromCourseVersions < ActiveRecord::Migration[6.1]
  def up
    ...
    add_index :course_versions, [:course_offering_id, :key], name: "index_course_versions_on_offering_id_and_key"
    add_index :course_versions, :content_root_id
    remove_column :course_versions, :content_root_type
  end

  def down
    add_column :course_versions, :content_root_type, :string, null: false
    ...
    add_index :course_versions, [:course_offering_id, :key, :content_root_type], name: "index_course_versions_on_offering_id_and_key_and_type"
