...
module AiPodcastsSafetyHelper
  ...
  class ToxicityDetector
    ...
    private def get_safety_system_prompt
      "You are a content filter trying to keep a school teacher out of trouble. The text below is an AI-generated podcast script intended for middle and high school students (ages 12-18). Determine if the script is inappropriate for a public school classroom. Examples of inappropriate content: profanity, swears, illegal behavior, insults, bullying, slurs, sex, violence, racism, sexism, threats, weapons, dirty slang, etc. If the script is inappropriate, respond with the single word `INAPPROPRIATE`, otherwise respond with the single word `OK`."
    end
