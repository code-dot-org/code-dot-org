module AichatOpenaiHelper
  def self.get_openai_assistant_response(aichat_model_customizations, stored_messages, new_message, level_id)
    ...
    instructions << (aichat_model_customizations['systemPrompt'] + " ") unless aichat_model_customizations['systemPrompt'].empty?
    instructions << aichat_model_customizations['retrievalContexts'].join(" ") if aichat_model_customizations['retrievalContexts']
  ...
  # def self.format_inputs(aichat_model_customizations, stored_messages, new_message, level_id)
  # end
end
