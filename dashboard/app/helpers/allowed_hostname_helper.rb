...
# This list was last updated 9/3/2025. There was a best effort to determine which APIs used keys and which were public.
...
module AllowedHostnameHelper
  ALLOWED_HOSTNAME_SUFFIXES = [
    ...
    'numbersapi.com',           # Number facts - Public API
    ...
    'myschoolapp.com',          # School data - API key required 🔑
