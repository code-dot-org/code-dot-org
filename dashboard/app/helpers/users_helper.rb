...
module UsersHelper
  ...
  #   3: {}
  # }
  def teacher_feedbacks_by_student_by_level(users, unit)
  ...
  def merge_unit_progress(user_data, user, unit, exclude_level_progress = false)
  ...
  def merge_user_progress_by_level(
    script:,
    user:,
  ...
  def get_bubble_choice_progress(
    level,
    user,
    user_levels_by_level,
    teacher_feedback_by_level,
