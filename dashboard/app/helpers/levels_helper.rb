...
module LevelsHelper
  ...
  def app_options
    ...
    @app_options[:verifiedTeacher] = current_user && current_user.verified_instructor? #TODO(dmcavoy): remove once launched
    @app_options[:verifiedInstructor] = current_user && current_user.verified_instructor?
