...
module DomainHelper
  def valid_top_level_domain?(host)
    host = host.upcase
    top_level_domain = host.split('.').last
    @@top_level_domains.include? top_level_domain
  end

  # Version 2016040501, Last Updated Wed Apr  6 07:07:01 2016 UTC
  # http://data.iana.org/TLD/tlds-alpha-by-domain.txt
  @@top_level_domains ||= Set.new %w(
    AAA
    AARP
    ABB
    ABBOTT
