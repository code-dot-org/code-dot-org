class AiRubricConfig
  ...
  S3_AI_RELEASE_PATH = 'teaching_assistant/releases/2024-08-22-lesson-8-release/'.freeze
  ...
  UNIT_AND_LEVEL_TO_LESSON_S3_NAME = {
    'csd3-2023' => {
      'CSD U3 Sprites assessment_2023' => 'csd3-2023-L8',
    ...
    'csd3-2024' => {
      'CSD U3 Sprites assessment_2024' => 'csd3-2023-L8',
