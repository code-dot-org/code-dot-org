class ParentMailer < ApplicationMailer
  ...
  # Email for parents of students under 13 to grant permission for their child to have a CodeAI account.
  ...
  def parent_permission_request(parent_email, permission_url)
    ...
    mail from: 'CodeAI <noreply@code.org>', to: parent_email, subject: I18n.t('parent_mailer.parent_permission_request_subject')
  end
  ...
  def parent_permission_reminder(parent_email, permission_url)
    @permission_url = permission_url
    mail from: 'CodeAI <noreply@code.org>', to: parent_email, subject: I18n.t('parent_mailer.parent_permission_reminder_subject')
  end
  ...
  def parent_permission_confirmation(parent_email)
    mail from: 'CodeAI <noreply@code.org>', to: parent_email, subject: I18n.t('parent_mailer.parent_permission_confirmation_subject')
  end
end
