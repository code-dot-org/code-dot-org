...
class Api::V1::TeacherFeedbackSerializer < ActiveModel::Serializer
  attributes :id, :teacher_name, :feedback_provider_id, :student_id, :script_id, :level_id, :script_level_id, :comment, :performance, :created_at, :student_seen_feedback, :section_id
  def teacher_name
    object.teacher.name
  end
