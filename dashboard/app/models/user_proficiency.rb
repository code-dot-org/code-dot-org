...
class UserProficiency < ApplicationRecord
  ...
  data_classification(
    ...
    sequencing_d1_count: :public,
    sequencing_d2_count: :public,
    sequencing_d3_count: :public,
    sequencing_d4_count: :public,
    sequencing_d5_count: :public,
    debugging_d1_count: :public,
    debugging_d2_count: :public,
    debugging_d3_count: :public,
    debugging_d4_count: :public,
    debugging_d5_count: :public,
    repeat_loops_d1_count: :public,
    repeat_loops_d2_count: :public,
    repeat_loops_d3_count: :public,
    repeat_loops_d4_count: :public,
    repeat_loops_d5_count: :public,
    repeat_until_while_d1_count: :public,
    repeat_until_while_d2_count: :public,
    repeat_until_while_d3_count: :public,
    repeat_until_while_d4_count: :public,
    repeat_until_while_d5_count: :public,
    for_loops_d1_count: :public,
    for_loops_d2_count: :public,
    for_loops_d3_count: :public,
    for_loops_d4_count: :public,
    for_loops_d5_count: :public,
    events_d1_count: :public,
    events_d2_count: :public,
    events_d3_count: :public,
    events_d4_count: :public,
    events_d5_count: :public,
    variables_d1_count: :public,
    variables_d2_count: :public,
    variables_d3_count: :public,
    variables_d4_count: :public,
    variables_d5_count: :public,
    functions_d1_count: :public,
    functions_d2_count: :public,
    functions_d3_count: :public,
    functions_d4_count: :public,
    functions_d5_count: :public,
    functions_with_params_d1_count: :public,
    functions_with_params_d2_count: :public,
    functions_with_params_d3_count: :public,
    functions_with_params_d4_count: :public,
    functions_with_params_d5_count: :public,
    conditionals_d1_count: :public,
    conditionals_d2_count: :public,
    conditionals_d3_count: :public,
    conditionals_d4_count: :public,
    conditionals_d5_count: :public,
