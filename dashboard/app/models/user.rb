...
class User < ApplicationRecord
  ...
  #   For instructors, this will be a hash mapping from section id to a list of hidden
  #   lesson ids for that section.
  #   For participants this will just be a list of lesson ids that are hidden for them.
  ...
  #   For participants this will just be a list of script ids that are hidden for them.
  def get_hidden_script_ids(unit_group = nil)
    return [] if !unit_group.can_be_instructor?(self) && unit_group.nil?
  ...
  def lesson_extras_enabled?(script)
    ...
    return true if script.can_be_instructor?(self)
