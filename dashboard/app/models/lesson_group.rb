...
class LessonGroup < ApplicationRecord
  ...
  def copy_to_unit(destination_script, destination_professional_learning_course, new_level_suffix = nil)
    ...
    lessons.each do |original_lesson|
      copied_lesson = original_lesson.copy_to_unit(destination_script, destination_professional_learning_course, new_level_suffix)
