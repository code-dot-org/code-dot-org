...
class Script < ApplicationRecord
  ...
  def self.merge_and_write_i18n(lessons_i18n, unit_name = '', metadata_i18n = {})
    ...
    File.open(units_yml, mode) do |file|
      # synchronize writes to this file on levelbuilder, where there could be
      # race conditions due to simultaneous edits to different scripts and
      # lessons.
      ...
      output = "# Autogenerated scripts locale file.\n" + updated_i18n.to_yaml(line_width: -1)
