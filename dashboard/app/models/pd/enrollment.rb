...
class Pd::Enrollment < ApplicationRecord
  ...
  # survey completion: CSD/CSP Summer, CSP Workshop for Returning Teachers, CSF Intro/Deep Dive.
  # We will always return [] for Academic year workshops as we want facilitators to handle those surveys.
  ...
  def self.filter_for_survey_completion(enrollments, select_completed = true)
    ...
    foorm_enrollments, _ = enrollments.partition do |enrollment|
