...
class LessonActivity < ApplicationRecord
  ...
  def summarize_for_lesson_show(can_view_teacher_markdown, current_user, unit_group_unit: nil, inline_editing_enabled: false)
    summary = summarize
    summary[:activitySections] = activity_sections.map {|as| as.summarize_for_lesson_show(can_view_teacher_markdown, current_user, unit_group_unit: unit_group_unit, inline_editing_enabled: inline_editing_enabled)}
