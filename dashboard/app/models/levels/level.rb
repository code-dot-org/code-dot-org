...
class Level < ActiveRecord::Base
  ...
  # WARNING this is a heavy SQL query (~500ms); do not use this for view operations
  def containing_levels
    Blockly.where("JSON_CONTAINS(properties, :name, '$.contained_level_names')", name: name.inspect)
  end
