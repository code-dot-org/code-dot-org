...
class Plc::EnrollmentUnitAssignment < ActiveRecord::Base
  ...
  def focus_area_positions
    plc_module_assignments.map{ |a| a.plc_learning_module.stage.position unless a.plc_learning_module.required? }.compact
  end
  ...
  def summarize_progress
    ...
    if plc_course_unit.script.peer_reviews_to_complete.try(:>, 0)
      summary << {
