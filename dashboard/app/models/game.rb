...
class Game < ApplicationRecord
  ...
  def self.buildlab
    @@game_buildlab ||= find_by_name("Buildlab")
  end
  ...
  def uses_small_footer?
    [NETSIM, APPLAB, TEXT_COMPRESSION, GAMELAB, WEBLAB, DANCE, FISH, AILAB, JAVALAB, AICHAT, PYTHONLAB, WEBLAB2, SKETCHLAB, BUILDLAB].include? app
  end
  ...
  def channel_backed?
    [APPLAB, GAMELAB, WEBLAB, PIXELATION, SPRITELAB, JAVALAB, POETRY, MUSIC, PYTHONLAB, WEBLAB2, AICHAT, SKETCHLAB, BUILDLAB].include? app
  end
