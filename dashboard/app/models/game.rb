...
class Game < ApplicationRecord
  ...
  def self.aidance
    @@game_aidance ||= find_by_name('Aidance')
  end
  ...
  def uses_small_footer?
    [NETSIM, APPLAB, TEXT_COMPRESSION, GAMELAB, WEBLAB, DANCE, FISH, AILAB, JAVALAB, AICHAT, AIDANCE].include? app
  end
