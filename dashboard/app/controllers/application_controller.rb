...
class ApplicationController < ActionController::Base
  ...
  protected def milestone_response(options)
    ...
    # We no longer set options[:activity] (see https://github.com/code-dot-org/code-dot-org/pull/63713),
    #   so response[:activity_id] will always be nil.
    # TODO: figure out whether anything depends on activity_id being set, and delete this line if not.
