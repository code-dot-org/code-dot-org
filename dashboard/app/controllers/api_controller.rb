...
class ApiController < ApplicationController
  ...
  use_writer_connection_for_route(:lockable_state)
  ...
  use_writer_connection_for_route(:section_progress)
  ...
  use_writer_connection_for_route(:section_level_progress)
  ...
  use_writer_connection_for_route(:user_progress)
  ...
  use_writer_connection_for_route(:user_app_options)
