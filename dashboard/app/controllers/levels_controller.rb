...
class LevelsController < ApplicationController
  ...
  private def handle_json_params(level_params)
    ...
    [:level_data, :aichat_settings, :validations, :panels, :predict_settings, :exemplar_settings, :ai_tutor_prompt_answer_types, :ai_tutor_answer_type_customizations].each do |key|
