...
class LevelsController < ApplicationController
  ...
  private def handle_json_params(level_params)
    ...
    [:level_data, :aichat_settings, :aichat_capabilities, :validations, :panels, :predict_settings, :product_tours, :exemplar_settings, :ai_tutor_prompt_settings, :widget2].each do |key|
