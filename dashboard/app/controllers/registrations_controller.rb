...
class RegistrationsController < Devise::RegistrationsController
  ...
  skip_before_action :verify_authenticity_token, only: [:set_user_information]
  ...
  def set_user_information
    ...
    user_information[:age] = params[:user][:age] if current_user.age.blank?
    user_information[:us_state] = params[:user][:us_state] if current_user.us_state.blank?
    user_information[:gender] = params[:user][:gender] if current_user.gender.blank?

    current_user.update(user_information) unless user_information.empty?
  end
