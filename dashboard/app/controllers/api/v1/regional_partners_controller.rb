class Api::V1::RegionalPartnersController < ApplicationController
  ...
  def index
    ...
    if params[:course] == 'unselected'
      ...
      regional_partner_mapping = school_district.regional_partners_school_districts.find_by(course: params[:course]) || school_district.regional_partners_school_districts.first
