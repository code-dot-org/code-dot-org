  ...
  def chat_completion
    ...
    if filter_result&.type == 'profanity'
      ...
      new_messages = [
        ...
        # include the errored assistant message here?
      ]

      return render(
        status: :ok,
        json: {
          status: 'profanity_model',
          error: 'Profane content generated by model',
          session_id: log_chat_session(new_messages)
        }
      )
    end
