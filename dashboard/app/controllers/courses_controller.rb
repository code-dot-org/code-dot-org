class CoursesController < ApplicationController
  ...
  def show
    ...
    @canonical_url = CDO.studio_url(UnitGroup.latest_stable_version(@unit_group.family_name)&.link) if UnitGroup.latest_stable_version(@unit_group.family_name)&.link
