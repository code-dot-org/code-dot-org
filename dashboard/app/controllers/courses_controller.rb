class CoursesController < ApplicationController
  ...
  def course_params
    cp = params.permit(:version_year, :family_name, :has_verified_resources, :has_numbered_units, :is_deeper_learning_course, :pilot_experiment, :published_state, :instruction_type, :instructor_audience, :participant_audience, :announcements).to_h
