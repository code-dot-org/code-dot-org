...
class ScriptLevelsController < ApplicationController
  ...
  def self.get_script_level(script, params)
    ...
    elsif params[:lockable_lessons_position]
      script.get_script_level_by_relative_position_and_puzzle_position(params[:lockable_lessons_position], params[:id], true)
    else
  ...
  def summary_for_lesson_plans
    ...
    lesson =
      if params[:lesson_position]
        ...
        script.lesson_by_relative_position(params[:lockable_lessons_position], true)
      end
