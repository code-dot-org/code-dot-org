class RubricsController < ApplicationController
  ...
  before_action :require_levelbuilder_apis, except: [:show, :find, :submit_evaluations, :get_ai_evaluations, :get_teacher_evaluations, :get_teacher_evaluations_for_all, :ai_evaluation_status_for_user, :ai_evaluation_status_for_all, :run_ai_evaluations_for_user, :run_ai_evaluations_for_all, :get_ai_rubrics_tour_seen, :update_ai_rubrics_tour_seen]
  ...
  def submit_evaluations
    ...
    student = User.find_by(id: permitted_params[:student_id])
