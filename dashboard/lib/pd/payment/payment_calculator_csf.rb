module Pd::Payment
  ...
  class PaymentCalculatorCSF < PaymentCalculatorBase
    ...
    private def get_payment_type(workshop)
      'CSF Facilitator'
    end
    ...
    # @return [true]
    private def qualified?(total_teacher_attendance_days)
      true
    end
    ...
    private def get_session_attendance_summaries(workshop)
    ...
    private def teacher_qualified?(enrollment)
    ...
    private def calculate_payment_amounts(workshop_summary)
      {
