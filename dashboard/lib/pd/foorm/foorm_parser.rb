...
module Pd::Foorm
  class FoormParser
    ...
    # New parsing methods that retain question categories
    ...
    # Parse form elements preserving all category information
    ...
    # Parse a single question preserving all category information
    def self.parse_question_with_categories(element)
      ...
      when 'rating'
        ...
        question_data[:rate_min] = element['rateMin'] || 1
        question_data[:rate_max] = element['rateMax'] || 5
    ...
    # Flatten choices while preserving all data
    ...
    # Get rating choices with proper labels
    def self.get_rating_choices_with_labels(element)
      choices = {}
      min_rate = element['rateMin'] || 1
      max_rate = element['rateMax'] || 5
