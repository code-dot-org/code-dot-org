module Pd::SurveyPipeline::DailySurveyDecorator
  FORM_IDS_TO_NAMES = {
    "90066184161150".to_i => {
  ...
  #
  def decorate_single_workshop_results(summaries, parsed_questions, parsed_submissions,
    current_user, errors = [])
    result = {
      course_name: nil,
      questions: {},
  ...
  def data_visible_to_user?(user, data)
  ...
  #
  def get_survey_context(workshop_id, day, facilitator_id, form_id)
  ...
  def get_form_short_name(form_id)
  ...
  #
  def index_question_by_names(questions)
    q_indexes = {}
