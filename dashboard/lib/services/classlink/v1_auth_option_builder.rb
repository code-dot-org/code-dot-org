...
#
# Returns nil if the UserId is blank, the v2 auth option doesn't exist, or a v1 auth option
# already exists — so callers can treat nil as "nothing to do".
  ...
  module Classlink
    class V1AuthOptionBuilder < Services::Base
      ...
      def call
        ...
        return nil if v1_already_exists
