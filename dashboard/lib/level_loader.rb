...
class LevelLoader
  ...
  def self.update_unplugged
    # Unplugged level data is specified in 'unplugged.en.json' file
    unplugged = JSON.parse(File.read(Rails.root.join('config/locales/unplugged.en.json')))['en']['data']['unplugged'].keys
