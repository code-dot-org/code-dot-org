...
module Clever
  class DistrictsUpdated < Event
    attr_accessor :data, :previous_attributes
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        fail ArgumentError, "The input argument (attributes) must be a hash in `Clever::DistrictsUpdated` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        unless acceptable_attribute_map.key?(k.to_sym)
          fail ArgumentError, "`#{k}` is not a valid attribute in `Clever::DistrictsUpdated`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        data == other.data &&
        previous_attributes == other.previous_attributes && super(other)
    end
