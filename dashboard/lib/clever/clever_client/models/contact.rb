...
module Clever
  class Contact < ApiModelBase
    attr_accessor :legacy_id, :phone, :phone_type, :sis_id, :student_relationships
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:student_relationships) && (value = attributes[:student_relationships]).is_a?(Array)
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        sis_id == other.sis_id &&
        student_relationships == other.student_relationships
    end
