...
module Clever
  class EventsApi
    ...
    def get_events_with_http_info(opts = {})
      ...
      query_params[:school] = opts[:school] unless opts[:school].nil?
      query_params[:record_type] = @api_client.build_collection_param(opts[:record_type], :multi) unless opts[:record_type].nil?
