...
module Clever
  class DataApi
    ...
    def get_contacts_for_user_with_http_info(id, opts = {})
      ...
      query_params[:ending_before] = opts[:ending_before] unless opts[:ending_before].nil?
    ...
    def get_courses_with_http_info(opts = {})
      ...
      query_params[:starting_after] = opts[:starting_after] unless opts[:starting_after].nil?
      query_params[:ending_before] = opts[:ending_before] unless opts[:ending_before].nil?
      query_params[:count] = opts[:count] unless opts[:count].nil?
    ...
    def get_schools_for_user_with_http_info(id, opts = {})
      ...
      # query parameters
      query_params = opts[:query_params] || {}
      query_params[:primary] = opts[:primary] unless opts[:primary].nil?
      query_params[:limit] = opts[:limit] unless opts[:limit].nil?
      query_params[:starting_after] = opts[:starting_after] unless opts[:starting_after].nil?
      query_params[:ending_before] = opts[:ending_before] unless opts[:ending_before].nil?
    ...
    def get_users_with_http_info(opts = {})
      ...
      allowable_values = %w(contact district_admin staff student teacher)
      ...
      query_params = opts[:query_params] || {}
      query_params[:limit] = opts[:limit] unless opts[:limit].nil?
      query_params[:role] = opts[:role] unless opts[:role].nil?
      query_params[:starting_after] = opts[:starting_after] unless opts[:starting_after].nil?
      query_params[:ending_before] = opts[:ending_before] unless opts[:ending_before].nil?
      query_params[:count] = opts[:count] unless opts[:count].nil?
