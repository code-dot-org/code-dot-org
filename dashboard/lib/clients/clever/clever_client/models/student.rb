...
module Clever
  class Student < ApiModelBase
    attr_accessor :created, :credentials, :disability, :dob, :ell_status, :enrollments, :ext, :frl_status, :gender, :gifted_status, :grade, :graduation_year, :hispanic_ethnicity, :home_language, :home_language_code, :iep_status, :last_modified, :legacy_id, :location, :preferred_name, :race, :school, :schools, :section_504_status, :sis_id, :state_id, :student_number, :unweighted_gpa, :weighted_gpa
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:enrollments) && (value = attributes[:enrollments]).is_a?(Array)
    ...
    def valid?
      ...
      return false if !@dob.nil? && @dob !~ /(?:[0-9]{1,2})\/([0-9]{1,2})\/([0-9]{4})/
    ...
    def home_language_code=(home_language_code)
      validator = EnumAttributeValidator.new('String', %w(bak mya cpp ikt ckb lin tgk cym yue nya dan mah jav mar tat guj nob sna slk zho ilo lug nep uzb fij aze kat hau kaz twi ces prs fao kan kur lav lit mni nso urd asm ind tel tuk bam bos hmn ita mal smo ben ewe deu hin por que sot afr eus heb kor mkd pol srp tha div dgo kar mai tsn tir cos isl mon ron yor zul other fas fra run sun tur amh aym nld hun ibo jpn bod ukr eng gle lao tam cat chk glg msa orm mlt mri lus snd yid hye knn dsb swe hsb ell otq tgl iku kin kri mlg pus rus gla tah xho ara hat sqi fry spa grn ltz yua ori uig tso khm kir vie bho ceb haw slv som swa ton bel est fin cmn sin bul hrv fil pan))
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        dob == other.dob &&
        ell_status == other.ell_status &&
        enrollments == other.enrollments &&
        ext == other.ext &&
        frl_status == other.frl_status &&
        gender == other.gender &&
        gifted_status == other.gifted_status &&
        grade == other.grade &&
        graduation_year == other.graduation_year &&
        hispanic_ethnicity == other.hispanic_ethnicity &&
        home_language == other.home_language &&
        home_language_code == other.home_language_code &&
        iep_status == other.iep_status &&
        ...
        section_504_status == other.section_504_status &&
        sis_id == other.sis_id &&
        state_id == other.state_id &&
        student_number == other.student_number &&
        unweighted_gpa == other.unweighted_gpa &&
        weighted_gpa == other.weighted_gpa
    end
