...
namespace :seed do
  ...
  def update_scripts(opts = {})
    ...
    begin
      ...
      LevelLoader.update_unplugged if File.mtime('config/locales/unplugged.en.json') > scripts_seeded_mtime
  ...
  task dsls: :environment do
    DSLDefined.transaction do
      ...
      # Rewrite autogenerated 'dsls.en.json' i18n file with new master-copy English strings
      File.write('config/locales/dsls.en.json', JSON.pretty_generate(i18n_strings.deep_sort))
    end
  end
