...
namespace :seed do
 ...
 # explicit execution of "seed:matches"
  ...
  task incremental: [:videos, :concepts, :scripts_incremental, :trophies, :prize_providers, :callouts, STANFORD_HINTS_IMPORTED, :secret_words, :secret_pictures, :clear_cache]
end
