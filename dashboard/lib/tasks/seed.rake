...
namespace :seed do
  ...
  def update_scripts(opts = {})
    ...
    begin
      ...
      custom_scripts.each do |filepath|
        Services::ScriptSeed.seed_from_json_file(filepath, require_course_version: opts.fetch(:require_course_version, false))
      rescue => exception
  ...
  timed_task_with_logging reseed_scripts_ui_tests: :environment do
    update_scripts(script_files: UI_TEST_SCRIPTS, require_course_version: true)
  end
