  ...
  constraints host: /^(?!#{CDO.codeprojects_hostname}|#{CDO.preview_codeprojects_hostname})/ do
    ...
    resources :ai_lesson_summaries, only: [:show] do
      collection do
        ...
        get :ai_lesson_summaries_transcript, controller: :ai_lesson_summaries, action: :ai_lesson_summaries_transcript # GET /ai_lesson_summaries/ai_lesson_summaries_transcript?lesson_id=2
