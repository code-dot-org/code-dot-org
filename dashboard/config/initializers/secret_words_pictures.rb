...
Dashboard::Application.config.secret_words_csv = [Rails.root.join('config/real_secret_words.csv'), Rails.root.join('config/secret_words.csv')].select{|i|File.file?(i)}.first
