...
var spriteIds = this.getSpriteIdsInUse();
var animations;
var eventLog;
var soundLog;
var eventSpriteIds;
...
//Checks if a particular sprite was moved up (y > 191) location in a level
function checkMovedSpriteUp(spriteIds) {
  var sprite = {id: spriteIds};
  var spriteY = getProp(sprite, "y");
  if(spriteY > 191) {
    return true;
  }
...
//Checks if a particular sprite was moved down (y < 191) location in a level
function checkMovedSpriteDown(spriteIds) {
  var sprite = {id: spriteIds};
  var spriteY = getProp(sprite, "y");
  if(spriteY < 191) {
    return true;
