...
| production  | email <br/>To: `dev+build@code.org` <br/>Subject: `/home/ubuntu/production/aws/build_and_mail_log websites` |                                                                                                                                      | CloudWatch (raw stdout/stderr); errors and traces in Sentry                                   | CloudWatch (raw stdout/stderr); errors and traces in Sentry                                            |
