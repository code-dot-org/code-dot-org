...
2. Click the "Merge pull request" button and watch the "Staging" room in Slack to make sure the build succeeds. If anything breaks, see the "Did it break section" below. 
