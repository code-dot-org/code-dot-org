...
1. If somebody proposes a design counter to these tenets, please direct them to [this link](ARCHITECTURE.md#architectural-tenets) to this section of this file.
...
<details>
  ...
  * Non-exceptions: if your goal is bypassing “slow tests” this tenet *probably* means you can’t unless you have no downstream consumers of your lib/service. Instead: consider optimizing our overall CI suite performance.
</details>
...
<details>
  <summary>Examples of existing violations</summary>
  * Somebody used HAML many years ago when the “Rails Way” was and is ERB, now we’re stuck on HAML. Maybe we’ll change this someday?
</details>
