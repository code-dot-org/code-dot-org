...
build_commands.execute([
  ...
  build_commands.sassCommand(SRC_PATH, BUILD_PATH, 'levelbuilder.scss', INCLUDE_PATHS, commander.min),
  build_commands.sassCommand(SRC_PATH, BUILD_PATH, 'leveltype_widget.scss', INCLUDE_PATHS, commander.min)
]);
