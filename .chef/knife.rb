...
chef_server_url          @chef_server_url = ENV['CDO_CHEF_SERVER_URL'] || "https://#{['staging', 'test', 'levelbuilder', 'production-console', 'production-daemon'].include?(`hostname`.strip) ? 'code-org.saas.chef.io' : 'api.opscode.com'}/organizations/#{@org_name}"
