...
exports.load = function(assetUrl, id) {
  ...
  var skin = {
    ...
    pattern1Menu : assetUrl('media/common_images/rainbow-menuicon.png'),
    pattern2Menu : assetUrl('media/common_images/rope-menuicon.png'),
    pattern3Menu : assetUrl('media/common_images/squiggly-menuicon.png'),
    pattern4Menu : assetUrl('media/common_images/swirlyline-menuicon.png'),
    patternDefault: assetUrl('media/common_images/defaultline-menuicon.png'),
    pattern1 : assetUrl('media/common_images/rainbow.png'),
