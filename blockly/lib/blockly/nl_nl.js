...
Blockly.Msg.COLOUR_BLEND_TOOLTIP = "Mengt twee kleuren in een bepaalde verhouding (0.0 - 1.0).";
...
Blockly.Msg.LISTS_GET_INDEX_GET_REMOVE = "neem vast en verwijder";
...
Blockly.Msg.LISTS_GET_SUBLIST_START_FROM_END = "pak sub-lijst van nummer vanaf einde";
Blockly.Msg.LISTS_GET_SUBLIST_START_FROM_START = "pak sub-lijst van nummer";
