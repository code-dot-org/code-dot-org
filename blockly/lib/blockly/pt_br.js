...
Blockly.Msg.COLOUR_RGB_TOOLTIP = "Crie uma cor com as quantidades de vermelho, verde e azul que foram determinadas. Todos os valores devem estar entre 0 e 100.";
...
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_BREAK = "Interrompe a execução do laço.";
...
Blockly.Msg.CONTROLS_FOREACH_TOOLTIP = "Para cada item em uma lista, defina a variável '%1' para o item, e então faça algumas declarações.";
...
Blockly.Msg.CONTROLS_IF_ELSE_TOOLTIP = "Acrescente uma condição final ao bloco se.";
Blockly.Msg.CONTROLS_IF_HELPURL = "http://code.google.com/p/blockly/wiki/If_Then";
Blockly.Msg.CONTROLS_IF_IF_TOOLTIP = "Acrescente, remova ou reordene seções para reconfigurar o bloco se.";
...
Blockly.Msg.CONTROLS_IF_TOOLTIP_3 = "Se o primeiro valor for verdadeiro, então realize o primeiro bloco de instruções. Senão, se o segundo valor for verdadeiro, realize o segundo bloco de instruções.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_4 = "Se o primeiro valor for verdadeiro, então realize o primeiro bloco de instruções. Senão, se o segundo valor for verdadeiro, realize o segundo bloco de instruções. Se nenhum dos blocos for verdadeiro, realize o último bloco de instruções.";
...
Blockly.Msg.CONTROLS_REPEAT_TOOLTIP = "Realize algumas instruções várias vezes.";
...
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_UNTIL = "Enquanto um valor for falso, realize algumas instruções.";
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_WHILE = "Enquanto um valor for verdadeiro, realize algumas instruções.";
...
Blockly.Msg.DELETE_PARAMETER_TITLE = "Isso excluirá todas as ocorrências de parâmetro '%1'. Tem certeza de que deseja continuar?";
...
Blockly.Msg.EXAMPLE_DESCRIPTION = "Define um exemplo com o comportamento esperado e real";
...
Blockly.Msg.FUNCTION_PARAMETERS_LABEL = "Quais são os parâmetros necessários para sua função?";
...
Blockly.Msg.FUNCTIONAL_PROCEDURE_DEFINE_TOOLTIP = "Defina um método funcional";
Blockly.Msg.FUNCTIONAL_RANGE_LABEL = "Intervalo";
Blockly.Msg.FUNCTIONAL_VARIABLE_CREATE = "Crie uma Variável";
...
Blockly.Msg.LISTS_CREATE_EMPTY_TOOLTIP = "Retorna uma lista, de tamanho 0, sem nenhum registro";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_FROM_END = "Retorna o item da posição especificada de uma lista. #1 é o último item.";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_FROM_END = "Remove and retorna o item da posição especificada em uma lista. #1 é o último item.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_FROM_START = "Remove and retorna o item da posição especificada em uma lista. #1 é o primeiro item.";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_REMOVE_FROM_END = "Remove o item da posição especificada de uma lista. #1 é o último item.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_REMOVE_FROM_START = "Remove o item da posição especificada em uma lista. #1 é o primeiro item.";
...
Blockly.Msg.LISTS_GET_SUBLIST_START_FIRST = "obtenha sublista a partir do primeiro";
Blockly.Msg.LISTS_GET_SUBLIST_START_FROM_END = "obtenha sublista de # a partir do fim";
Blockly.Msg.LISTS_GET_SUBLIST_START_FROM_START = "obtenha sublista a partir de #";
...
Blockly.Msg.LISTS_IS_EMPTY_TITLE = "%1 está vazio";
...
Blockly.Msg.LISTS_REPEAT_TOOLTIP = "Cria uma lista contendo o valor informado, repetido o número de vezes especificado.";
...
Blockly.Msg.LISTS_SET_INDEX_SET = "defina";
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_FIRST = "Insere o item no início de uma lista.";
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_FROM_END = "Insere o item na posição especificada de uma lista. #1 é o último item.";
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_FROM_START = "Insere o item na posição especificada de uma lista. #1 é o primeiro item.";
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_LAST = "Insere o item no final da lista.";
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_RANDOM = "Insere o item em uma posição aleatória da lista.";
...
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_EQ = "Retorna verdadeiro se as entradas forem iguais.";
...
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_NEQ = "Retorna verdadeiro se as entradas forem diferentes.";
...
Blockly.Msg.LOGIC_OPERATION_TOOLTIP_OR = "Retorna verdadeiro se ao menos uma das estradas for verdadeira.";
...
Blockly.Msg.LOGIC_TERNARY_TOOLTIP = "Verifica a condição em \"teste\". Se a condição for verdadeira, retorna o valor de \"se verdadeiro\", caso contrário, retorna o valor de \"se falso\".";
...
Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_MINUS = "Retorna a diferença entre dois números.";
...
Blockly.Msg.MATH_CONSTANT_TOOLTIP = "Retornar uma das constantes comuns: π (3.141…), e (2.718…), φ (1.618…), sqrt(2) (1.414…), sqrt(½) (0.707…), ou ∞ (infinito).";
...
Blockly.Msg.MATH_ONLIST_TOOLTIP_AVERAGE = "Retorna a média aritmética dos números de uma lista.";
...
Blockly.Msg.MATH_ONLIST_TOOLTIP_MODE = "Retorna a lista do(s) item(ns) mais comum(ns) na lista.";
...
Blockly.Msg.MATH_ONLIST_TOOLTIP_SUM = "Retorna a soma de todos os números de uma lista.";
...
Blockly.Msg.MATH_RANDOM_FLOAT_TOOLTIP = "Retorna uma fração aleatória entre 0,0 (incluído) e 1,0 (não incluído).";
...
Blockly.Msg.MATH_TRIG_TOOLTIP_COS = "Retorna o cosseno de um ângulo (não em radianos).";
Blockly.Msg.MATH_TRIG_TOOLTIP_SIN = "Retorna o seno de um ângulo (não em radianos).";
Blockly.Msg.MATH_TRIG_TOOLTIP_TAN = "Retorna a tangente de um ângulo (não em radianos).";
...
Blockly.Msg.PROCEDURES_DEFNORETURN_HELPURL = "http://pt.wikipedia.org/wiki/Sub-rotina";
...
Blockly.Msg.PROCEDURES_DEFRETURN_HELPURL = "http://pt.wikipedia.org/wiki/Sub-rotina";
...
Blockly.Msg.PROCEDURES_DEFRETURN_TOOLTIP = "Cria uma função que tem um valor de retorno.";
...
Blockly.Msg.PROCEDURES_IFRETURN_TOOLTIP = "Se um valor for verdadeiro, então retorna um segundo valor.";
...
Blockly.Msg.SAVE_AND_CLOSE = "Salvar e Fechar";
...
Blockly.Msg.TEXT_CHANGECASE_OPERATOR_TITLECASE = "coloque as Iniciais Maiúsculas";
Blockly.Msg.TEXT_CHANGECASE_OPERATOR_UPPERCASE = "coloque em MAIÚSCULAS";
Blockly.Msg.TEXT_CHANGECASE_TOOLTIP = "Retorne uma cópia do texto em um formato diferente.";
...
Blockly.Msg.TEXT_CREATE_JOIN_TOOLTIP = "Acrescente, remova ou reordene seções para reconfigurar esse bloco de texto.";
...
Blockly.Msg.TEXT_GET_SUBSTRING_START_FIRST = "obtenha substring a partir da primeira letra";
Blockly.Msg.TEXT_GET_SUBSTRING_START_FROM_END = "obtenha substring a partir da letra #, partindo do fim";
Blockly.Msg.TEXT_GET_SUBSTRING_START_FROM_START = "obtenha substring a partir da letra #";
Blockly.Msg.TEXT_GET_SUBSTRING_TAIL = "";
Blockly.Msg.TEXT_GET_SUBSTRING_TOOLTIP = "Retorna um trecho especificado do texto.";
...
Blockly.Msg.TEXT_TRIM_TOOLTIP = "Retorne uma cópia do texto com os espaços removidos de uma ou ambas as extremidades.";
...
Blockly.Msg.VARIABLES_SET_TOOLTIP = "Define essa variável para ser igual ao valor informado.";
