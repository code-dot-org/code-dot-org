...
Blockly.Msg.COLOUR_RGB_TOOLTIP = "以指定的紅、 綠和藍的數值來創建顏色。所有值必須都是介於 0 和 100 之間。";
...
Blockly.Msg.DELETE_BLOCK = "刪除程式積木";
...
Blockly.Msg.FUNCTION_NAME_LABEL = "命名您的函數：";
Blockly.Msg.FUNCTION_DESCRIPTION_LABEL = "您的函數用來做甚麼呢？";
Blockly.Msg.FUNCTION_PARAMETERS_LABEL = "你的函數要用哪些參數呢？";
Blockly.Msg.FUNCTION_HEADER = "函數";
Blockly.Msg.FUNCTIONAL_CREATE = "新積木";
...
Blockly.Msg.MATH_MULTIPLICATION_SYMBOL = "乘以";
...
Blockly.Msg.MATH_ONLIST_OPERATOR_MAX = "表列最大值";
Blockly.Msg.MATH_ONLIST_OPERATOR_MEDIAN = "集合中的中位數";
Blockly.Msg.MATH_ONLIST_OPERATOR_MIN = "表列最小值";
Blockly.Msg.MATH_ONLIST_OPERATOR_MODE = "列表中的眾數";
Blockly.Msg.MATH_ONLIST_OPERATOR_RANDOM = "集合中的隨機數";
Blockly.Msg.MATH_ONLIST_OPERATOR_STD_DEV = "集合的標準差";
Blockly.Msg.MATH_ONLIST_OPERATOR_SUM = "清單中的總和";
...
Blockly.Msg.MATH_RANDOM_INT_TITLE = "介於 %1 低與 %2 高間隨機取一個整數";
...
Blockly.Msg.MATH_SUBTRACTION_SYMBOL = "減去";
Blockly.Msg.MATH_TRIG_ACOS = "反餘弦";
Blockly.Msg.MATH_TRIG_ASIN = "反正弦";
Blockly.Msg.MATH_TRIG_ATAN = "反正切函數";
...
Blockly.Msg.PROCEDURES_DEFNORETURN_TITLE = "在";
...
Blockly.Msg.PROCEDURES_DEFRETURN_PROCEDURE = "流程";
Blockly.Msg.PROCEDURES_DEFRETURN_TITLE = "在";
...
Blockly.Msg.VARIABLES_SET_TAIL = "自";
Blockly.Msg.VARIABLES_SET_TITLE = "設置";
