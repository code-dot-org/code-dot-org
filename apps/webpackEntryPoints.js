...
const CODE_STUDIO_ENTRIES = {
  ...
  'lti/v1/iframe': './src/sites/modules/pages/lti/v1/iframe.js',
  'lti/v1/account_linking/landing': './src/sites/modules/pages/lti/v1/account_linking/landing.js',
  'lti/v1/dynamic_registration': './src/sites/modules/pages/lti/v1/dynamic_registration.js',
  'lti/v1/sync_course': './src/sites/modules/pages/lti/v1/sync_course.js',
  'lti/v1/upgrade_account': './src/sites/modules/pages/lti/v1/upgrade_account.js',
