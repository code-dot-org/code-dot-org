  ...
  overrides: [
    ...
    },
    {
      files: [
        ...
        'src/calc/*',
        'src/code-studio/**',
        'src/componentLibrary/button/*',
        'src/componentLibrary/checkbox/*',
        'src/componentLibrary/chips/*',
        'src/componentLibrary/common/*',
        'src/componentLibrary/dropdown/**',
        'src/componentLibrary/fontAwesomeV6Icon/*',
        'src/componentLibrary/link/*',
        'src/componentLibrary/radioButton/*',
        'src/componentLibrary/segmentedButtons/*',
        'src/componentLibrary/simpleDropdown/*',
        'src/componentLibrary/tags/*',
        'src/componentLibrary/toggle/*',
        'src/componentLibrary/typography/*',
        ...
        'src/templates/codeDocs/**',
        'src/templates/codeReviewGroups/**',
        'src/templates/courseOverview/**',
        'src/templates/courseRollupPages/**',
        'src/templates/curriculumCatalog/**',
        'src/templates/dataDocs/**',
        ...
        'src/templates/studioHomepages/**',
        'src/templates/tables/**',
        'src/templates/teacherDashboard/**',
        'src/templates/textResponses/**',
        'src/templates/utils/**',
        'src/templates/verificationPages/**',
        'src/templates/*',
        'src/third-party/*',
        'src/turtle/*',
        'src/tutorialExplorer/*',
        'src/types/*',
        ...
        'test/unit/studio/**',
        'test/unit/templates/*',
        'test/unit/templates/certificates/**',
        'test/unit/templates/codeDocs/**',
        'test/unit/templates/codeReviewGroups/**',
        'test/unit/templates/courseOverview/**',
        'test/unit/templates/courseRollupPages/**',
        'test/unit/templates/curriculumCatalog/**',
        ...
        'test/unit/templates/plugins/**',
        'test/unit/templates/policy_compliance/**',
        'test/unit/templates/progress/**',
        'test/unit/templates/projects/**',
        'test/unit/templates/referenceGuides/**',
        ...
        'test/unit/templates/teacherDashboard/**',
        'test/unit/templates/textResponses/**',
        'test/unit/templates/utils/**',
        'test/unit/turtle/**',
        'test/unit/tutorialExplorer/**',
        'test/unit/util/**',
        'test/unit/weblab/**',
        'test/util/*',
        'test/util/aichat/**',
