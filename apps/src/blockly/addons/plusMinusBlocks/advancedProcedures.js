...
export const PROCEDURES_IFRETURN = {
  ...
  init: function () {
    this.appendValueInput('CONDITION')
      .setCheck('Boolean')
      .appendField(GoogleBlockly.Msg['CONTROLS_IF_MSG_IF']);
    this.appendValueInput('VALUE').appendField(
      GoogleBlockly.Msg['PROCEDURES_DEFRETURN_RETURN']
    );
    this.setInputsInline(true);
    this.setPreviousStatement(true);
    this.setNextStatement(true);
    this.setStyle('procedure_blocks');
    this.setTooltip(GoogleBlockly.Msg['PROCEDURES_IFRETURN_TOOLTIP']);
    this.setHelpUrl(GoogleBlockly.Msg['PROCEDURES_IFRETURN_HELPURL']);
  ...
  onchange: function (e) {
    if (
      ...
      e.type !== GoogleBlockly.Events.BLOCK_MOVE
    ) {
    ...
    if (legal) {
      ...
      this.setWarningText(GoogleBlockly.Msg['PROCEDURES_IFRETURN_WARNING']);
    }
    if (!this.isInFlyout) {
      const group = GoogleBlockly.Events.getGroup();
      // Makes it so the move and the disable event get undone together.
      GoogleBlockly.Events.setGroup(e.group);
      this.setEnabled(legal);
      GoogleBlockly.Events.setGroup(group);
    }
  },
  /**
