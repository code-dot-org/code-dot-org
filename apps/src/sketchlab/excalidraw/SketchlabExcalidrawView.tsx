...
import moduleStyles from './styles/sketchlab-excalidraw-view.module.scss';
...
// blob into its SourcesContainer, keeping behaviour the same as before.
export {DEFAULT_SOURCES as EXCALIDRAW_DEFAULT_SOURCES};
