...
export const BasicExample = args => (
  <div style={{margin: '2em', maxWidth: 500}}>
    <p>
      The <code>HelpTip</code> component adds a helpful question mark icon with
      an attached tooltip inline with your text.
    ...
    <p>
      ...
      <HelpTip>
        ...
        ipsum dolor sit amet jedi lightsaber. Darth vader ewok amok landspeeder
        bird feeder cypress citrus listlessness. Lorem ipsum dolor sit amet jedi
        lightsaber. Darth vader ewok amok landspeeder bird feeder cypress citrus
        listlessness.
      </HelpTip>
    </p>
    <p>
      The tooltips also aren't given any direction about where they should
      appear, and they're fairly good at automatically positioning themselves in
      the viewport. So by default, they will appear above the question-mark
    ...
    <p>
      ...
      form field labels, to provide additional information about constraints on
      a field, or the effect of a particular option.
    </p>
