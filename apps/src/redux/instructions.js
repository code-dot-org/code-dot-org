...
const instructionsInitialState = {
  ...
  allowUserUploads: undefined,
  freeResponseProjectId: undefined,
  freeResponseLastAttempt: undefined,
  freeResponseTitle: undefined,
...
export default function reducer(state = {...instructionsInitialState}, action) {
  if (action.type === SET_CONSTANTS) {
    ...
    const {
      ...
      teacherMarkdown,
      allowUserUploads,
      freeResponseProjectId,
      freeResponseLastAttempt,
      freeResponseTitle,
