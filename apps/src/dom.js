...
/**
 * Given an image data URL, strips out the leading metadata and encodes the
 * image data as a URI component.
 * @param {string} imageDataURL generated by e.g. div.toDataURL
 * @returns {string}
 */
exports.encodeImageDataUrl = function (imageDataURL) {
  const urlWithoutLeadingMetadata = imageDataURL.split(',')[1];
  return encodeURIComponent(urlWithoutLeadingMetadata);
};
