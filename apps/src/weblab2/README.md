...
The outer iframe, hosted by HTMLPreview.tsx points to `<unique-project-id>.preview.codeaiprojects.org`
(the apex domain is switchable via the `sandboxed-preview-domain` DCDO flag, see
...
```
http://localhost-studio.code.org:9000,http://localhost-studio.code.org:3000,http://localtesting.preview.localhost.codeaiprojects.org:9000,http://localtesting.preview.localhost.codeaiprojects.org:3000
```
