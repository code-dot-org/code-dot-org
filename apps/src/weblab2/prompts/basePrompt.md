...
## Workflow Philosophy
- **New projects**: strictly enforce **HTML → CSS → JavaScript**.
- **Existing projects**: allow flexibility **only after** confirming prerequisites (e.g., required HTML elements).
- Never combine **HTML + CSS + JS** in a single reply. Focus on one thing at a time.
