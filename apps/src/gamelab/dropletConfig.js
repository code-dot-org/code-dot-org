...
module.exports.blocks = [
  ...
  {func: 'keyDown', paletteParams: ['code'], params: ['"up"'], category: 'Game Lab', type: 'value', customDocURL: "https://code-dot-org.github.io/p5.play/docs/classes/p5.play.html#method-keyDown" },
  {func: 'keyWentDown', paletteParams: ['code'], params: ['"up"'], category: 'Game Lab', type: 'value', customDocURL: "https://code-dot-org.github.io/p5.play/docs/classes/p5.play.html#method-keyWentDown" },
  {func: 'keyWentUp', paletteParams: ['code'], params: ['"up"'], category: 'Game Lab', type: 'value', customDocURL: "https://code-dot-org.github.io/p5.play/docs/classes/p5.play.html#method-keyWentUp" },
  ...
  {func: 'addAnimation', blockPrefix: spriteBlockPrefix, category: 'Sprites', paletteParams: ['label','animation'], params: ['"anim1"', "anim"], tipPrefix: spriteMethodPrefix, modeOptionName: '*.addAnimation', noAutocomplete: true, customDocURL: "https://code-dot-org.github.io/p5.play/docs/classes/Sprite.html#method-addAnimation" },
  ...
  {func: 'changeAnimation', blockPrefix: spriteBlockPrefix, category: 'Sprites', paletteParams: ['label'], params: ['"anim1"'], tipPrefix: spriteMethodPrefix, modeOptionName: '*.changeAnimation', noAutocomplete: true, customDocURL: "https://code-dot-org.github.io/p5.play/docs/classes/Sprite.html#method-changeAnimation" },
