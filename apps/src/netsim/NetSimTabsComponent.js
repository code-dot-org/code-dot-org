...
import $ from 'jquery';
import buildMarkup from './NetSimTabsComponent.html.ejs';
import NetSimRouterTab from './NetSimRouterTab';
import NetSimMyDeviceTab from './NetSimMyDeviceTab';
import NetSimDnsTab from './NetSimDnsTab';
import {NetSimTabType} from './NetSimConstants';
import {shouldShowTab} from './NetSimUtils';
 ...
 * @constructor
 */
function NetSimTabsComponent(rootDiv, runLoop, callbacks) {
  /**
   ...
   * @private
   */
  this.showInstructionsDialogCallback_ =
    callbacks.showInstructionsDialogCallback;
...
NetSimTabsComponent.prototype.setRouterCreationTime = function (
  creationTimestampMs
) {
  if (this.routerTab_) {
 ...
 */
NetSimTabsComponent.prototype.setRouterQueuedPacketCount = function (
  queuedPacketCount
) {
  if (this.routerTab_) {
...
NetSimTabsComponent.prototype.setRouterMemoryInUse = function (
  usedMemoryInBits
) {
  if (this.routerTab_) {
...
NetSimTabsComponent.prototype.setRouterDataRate = function (
  dataRateBitsPerSecond
) {
  if (this.routerTab_) {
...
export default NetSimTabsComponent;
