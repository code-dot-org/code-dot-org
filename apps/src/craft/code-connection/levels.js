...
function vecThree(x, y, z) {
  return craftBlock(
    'vecThree',
    `<value name='X'><block type="math_number"><title name='NUM'>${x}</title></block></value>
    ...
    toolbox: createToolbox(
      category(
        ...
        craftBlock('move') +
          ...
          craftBlock(
            'place',
            `<value name='SLOTNUM'><block type="math_number"><title name='NUM'>0</title></block></value>`
          ) +
          craftBlock('destroy') +
          craftBlock('till') +
          craftBlock('attack') +
          craftBlock(
            'collect',
            `<value name='ITEM'>${craftBlock('block')}</value>`
          ) +
          ...
          craftBlock(
            'transfer',
            `<value name='SRCSLOTNUM'><block type="math_number"><title name='NUM'>0</title></block></value>
        ...
        category(
          ...
          craftBlock('block') +
            ...
            craftBlock(
              'createblock',
              `<value name='BLOCKTYPE'>${craftBlock('block')}</value>
                                     <value name='BLOCKDATA'>${craftBlock(
                                       'block'
                                     )}</value>`
            )
        ) +
        category(
          ...
          craftBlock('tptotarget') +
            ...
            craftBlock(
              'timesetbynumber',
              `<value name='TIME'><block type="math_number"><title name='NUM'>1200</title></block></value>`
            ) +
            craftBlock('weather')
        ) +
        category(
