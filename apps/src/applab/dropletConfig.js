...
module.exports.blocks = [
  ...
  {func: 'getValue', parent: api, category: 'UI controls', paletteParams: ['id'], params: ['"id"'], dropdown: { 0: function () { return Applab.getIdDropdown('input[type="range"]'); } }, type: 'value' },
  {func: 'setValue', parent: api, category: 'UI controls', paletteParams: ['id','value'], params: ['"id"', '0'], dropdown: { 0: function () { return Applab.getIdDropdown('input[type="range"]'); } } },
