...
export default storybook => {
  storybook.storiesOf('ScreenListItem', module).addStoryTable([
    {
      name: 'normal screen',
      story: () => (
        <ScreenListItem
  ...
  storybook.storiesOf('ImportScreensDialog', module).addStoryTable([
    {
      name: 'Simple single screen import',
      description:
        'Importing a single screen that will replace an existing one',
      story: () => (
        <ImportScreensDialog
          hideBackdrop
