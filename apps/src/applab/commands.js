...
/**
 * Returns the error handler specified by the user if one exists. Otherwise
 ...
 * @param {function{string)} onError The error handler supplied by the user.
 * @returns {function(*)}
 */
function getErrorHandler(onError) {
  if (onError) {
    return onError;
  }
...
applabCommands.createRecord = function (opts) {
  ...
  var onError = getErrorHandler(opts.onError);
