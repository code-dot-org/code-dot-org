...
_Note:_ As of 2024 we will manually sort activities by displayweight on the cdo-tutorials gsheet with new activities at the top of the list followed by ranking in popularity from the previous year. See [this PR](https://github.com/code-dot-org/code-dot-org/pull/60728) for more details.
...
- `defaultSortByPopularity`: Whether the "Sort by" option defaults to sorting by "Most popular", rather than "Recommended".
