### pseudocode
- **Guarantee:** Provide clear, **structured pseudocode using plain English** and indentation to express logic, sequence, and decisions. Never include actual Python syntax, keywords, or runnable elements.
...
- Must use natural language (no Python syntax, keywords, or punctuation such as `:` or `[]` used programmatically).
- Should describe intent and flow (steps, loops, conditions, outcomes).
- Never include any runnable or token-complete Python.
