 ...
 */
var AbuseSharedInfoError = React.createClass({
  propTypes: {
...
module.exports = AbuseSharedInfoError;

// AbuseSharedInfoError is placed on the dashboard namespace so that it can be accessed
// by apps
window.dashboard = window.dashboard || {};
window.dashboard.AbuseSharedInfoError = AbuseSharedInfoError;
