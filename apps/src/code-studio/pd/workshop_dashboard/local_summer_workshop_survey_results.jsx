...
const rowOrder = [
  ...
  {
    text: 'Overall, how interested were you in the in-person workshop?',
    key: 'overall_how_interested',
    score_base: 5,
  },
  ...
  {
    text: 'I feel confident I can teach this course to my students this year.',
    key: 'confident_can_teach',
    score_base: 6,
  },
  {
    text: 'I look forward to continuing my training throughout the year.',
    key: 'anticipate_continuing',
    score_base: 6,
  },
  {
  ...
  {
    text: 'I believe all students should take this course',
    key: 'believe_all_students',
    score_base: 6,
  },
];
...
const freeResponseQuestions = [
  ...
  {
    text: 'What were two things your facilitator did well?',
    key: 'things_facilitator_did_well',
    facilitator_breakdown: true,
  },
  {
    text: 'What were two things your facilitator could do better?',
    key: 'things_facilitator_could_improve',
    facilitator_breakdown: true,
  },
];
...
export default class LocalSummerWorkshopSurveyResults extends React.Component {
  ...
  renderLocalSummerWorkshopSurveyResultsTable() {
    ...
    if (this.state.facilitatorBreakdown) {
      facilitatorColumnHeaders = this.state.facilitatorNames.map(
        (facilitator, i) => {
  ...
  renderRow(row, i) {
    ...
    if (
      this.state.facilitatorBreakdown &&
    ...
    return (
      <tr key={i}>
        ...
        {scoreCells}
        <td>
          {this.renderScore(row, this.state.allMyLocalWorkshops[row['key']])}
        </td>
  ...
  renderFreeResponseFeedback() {
    ...
    return <div>{freeResponseAnswers}</div>;
  }
