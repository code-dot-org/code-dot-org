...
const rowOrder = [
  ...
  {text: 'Overall, how much have you learned from your workshop about computer science?', key: 'how_much_learned', score_base: '5'},
  ...
  {text: 'When you are not in Code.org workshops how often do you talk about the ideas from the workshops?', key: 'how_often_talk_about_ideas_outside', score_base: '5'},
  {text: 'How often did you get so focused on Code.org workshop activities that you lost track of time?', key: 'how_often_lost_track_of_time'},
  {text: 'Before the workshop, how excited were you about going to your Code.org workshop?', key: 'how_excited_before', score_base: '5'},
  {text: 'Overall, how interested were you in the Code.org in-person workshop?', key: 'overall_how_interested', score_base: '5'},
  ...
  {text: 'This professional development was suitable for my level of experience with teaching CS.', key: 'suitable_for_my_experience', score_base: '6'},
  {text: 'I would recommend this professional development to others.', key: 'would_recommend', score_base: '6'},
  {text: 'I feel like I am a part of a community of teachers.', key: 'part_of_community', score_base: '6'},
];

const freeResponseQuestions = [
  {text: 'What were two things your facilitator(s) did well?', key: 'things_facilitator_did_well'},
  {text: 'What were two things your facilitator(s) could do better?', key: 'things_facilitator_could_improve'},
  {text: 'What were the two things you liked most about the activities you did in this workshop and why?', key: 'things_you_liked'},
  {text: 'What are the two things you would change about the activities you did in this workshop?', key: 'things_you_would_change'},
  {text: 'Is there anything else you’d like to tell us about your experience at this workshop?', key: 'anything_else'},
];
