...
export default class QuestionAveragesTable extends React.Component {
  ...
  renderHeaderRow() {
    ...
    if (this.props.facilitatorBreakdown) {
      facilitatorColumnHeaders = this.props.facilitatorNames.map((facilitator, i) => {
        return (
          <th key={i}>
            {facilitator}
          </th>
    ...
    return (
      <thead>
        <tr>
          ...
          <th>
            All my {this.props.workshopType}
          </th>
          <th>
            All workshops
          </th>
  ...
  renderRow(row, i) {
    ...
    if (this.props.facilitatorBreakdown && typeof thisWorkshopData === 'object') {
    ...
    return (
      <tr key={i}>
        ...
        {scoreCells}
        <td>{this.renderScore(row, this.props.allMyWorkshopsData[row['key']])}</td>
