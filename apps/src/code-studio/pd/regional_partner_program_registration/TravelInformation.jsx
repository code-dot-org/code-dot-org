    ...
    return (
      <FormGroup>
        ...
        <FormGroup>
          {/* Contact Info */}
          <ControlLabel>
            Please provide the name and phone number of someone we can contact
        ...
        <FormGroup>
          ...
          {this.buildButtonsFromOptions({
            name: 'liveFarAway',
            label: `Do you live more than 25 miles from downtown ${
          ...
          {this.buildButtonsFromOptions({
            name: 'needHotel',
            label:
              'Code.org will cover travel and hotel room costs for 1 individual from each Regional Partner. Will you need a hotel room during TeacherCon?',
            type: 'radio'
          })}
          {this.buildButtonsFromOptions({
            name: 'needAda',
