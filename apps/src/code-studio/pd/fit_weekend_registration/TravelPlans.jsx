...
export default class TravelPlans extends LabeledFormComponent {
  static labels = {
    ...
    needDisabilitySupport:
      'Do you have a disability and/or require accommodation in order to fully participate in our event? If so, please select yes, and you will be contacted by someone from our staff to discuss your specific needs.'
  };
  ...
  static getDynamicallyRequiredFields(data) {
    ...
    if (
      data.dietaryNeeds &&
      (data.dietaryNeeds.includes('Food Allergy') ||
        ...
        <FormGroup>
          ...
          {this.props.data.liveFarAway &&
            this.props.data.liveFarAway === 'Yes' && (
              <FormGroup>
                <ControlLabel>Please provide your home address</ControlLabel>
                {this.inputFor('addressStreet')}
                {this.inputFor('addressCity')}
                {this.selectFor('addressState', {
