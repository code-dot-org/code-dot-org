...
const LABELS = {
  personalLearningNeedsMet:
    'I feel that my personal learning needs were met today.',
  haveIdeasAboutFormative:
    'I have ideas about how to use the formative assessments that are built into the curriculum.',
  haveIdeasAboutSummative:
    'I have ideas about how to use the summative assessments that are built into the curriculum.',
  haveConcreteIdeas:
    'I have concrete ideas and plans for how to use the resources in the curriculum to meet my own assessment and grading needs.',
  toolsWillHelp:
    'I think the tools in this curriculum will help my students better understand the CS concepts covered in this course.',
  learnedEnoughToMoveForward:
    'I feel like I’ve learned enough to move forward teaching {course}.',
  feelConfidentUsingMaterials:
    'I feel confident using the {course} curriculum materials.',
  feelConfidentCanHelpStudents:
    'I feel confident that I will be able to help my students use the tools in the {course} curriculum.',
  havePlan:
    'I have a plan to get from TeacherCon to the start of the school year.',
  feelComfortableLeading:
    'I feel comfortable taking on the role of lead learner in my classroom.',
  haveLessAnxiety:
    'I have less anxiety about teaching {course} than I did yesterday.',
  howCouldImprove:
    'How could this PD be changed to better fit your learning needs?',
  whatHelpedMost: 'What helped you learn the most today and why?',
  whatDetracted: 'What detracted from your learning today and why?',
  otherFeedbackFridayOnly:
