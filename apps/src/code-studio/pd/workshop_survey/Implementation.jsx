...
const LABELS = {
  "hoursPerWeek": "Roughly how many hours per week do you get with each section of students to teach CS Discoveries?",
  "weeksPerYear": "How many weeks will you be spending on CS Discoveries with each section of students this year?",
  "courseStructure": "Which of the following best describes how you are teaching CS Discoveries with each section of students?",
  "unitsPlanningToTeach": "Which units in CS Discoveries do you plan to teach to your sections this year?",
  "sameStudentsMultipleYears": "Will you see the same students for multiple years?",
  "unitsInLaterYears": "Please indicate which units you will teach in the second or third year:",
  "combiningCurricula": "Are you combining CS Discoveries with other curricula you teach in the same class? If so, what else are you teaching? (check all that apply)",
  "cteCredit": "Can students get CTE credit for taking CS Discoveries in your school?",
  "csdRequired": "At your school, is your CS Discoveries course required or optional?"
};
    ...
    return (
      <FormGroup>
        ...
        {(
          ...
          this.props.data.sameStudentsMultipleYears.includes("I have the same students for multiple years.")
         ) &&
          this.buildButtonsFromOptions({
