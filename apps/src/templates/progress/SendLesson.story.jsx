      ...
      story: () => {
        ...
        return (
          <Provider store={store}>
            <SendLesson lessonUrl="https://studio.code.org/s/coursee-2020/lesson/2/puzzle/1?login_required=true" />
          </Provider>
        );
      }
    },
    {
      ...
      story: () => {
        ...
        return (
          <Provider store={store}>
            <SendLesson
              lessonUrl="https://studio.code.org/s/coursee-2020/lesson/2/puzzle/1?login_required=true"
