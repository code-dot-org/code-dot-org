  ...
  const renderExtraCertificateLinks = (language, tutorial) => {
    ...
    if (language === 'ko') {
      ...
      if (/oceans/.test(tutorial)) {
        extraLinkUrl = pegasus('/files/online-coding-party-2023-1-oceans.png');
      } else if (/dance/.test(tutorial)) {
        extraLinkUrl = pegasus('/files/online-coding-party-2023-1-dance.png');
      } else if (/frozen/.test(tutorial)) {
        extraLinkUrl = pegasus('/files/online-coding-party-2023-1-frozen.png');
      } else if (/hero/.test(tutorial)) {
        extraLinkUrl = pegasus('/files/online-coding-party-2023-1-hero.png');
      } else {
        extraLinkText = null;
      }
    }
