  ...
  return storybook
    ...
    .addStoryTable([
      ...
      },
      {
        ...
        story: () => (
          <Congrats tutorial="applab-intro" userType="student" language="en" />
        )
      },
      {
        ...
        story: () => (
          <Congrats tutorial="minecraft" userType="signedOut" language="en" />
        )
      },
      {
        ...
        description: `Congrats component if either pre-2017 Minecraft tutorial completed`,
        story: () => (
          <Congrats tutorial="minecraft" userType="student" language="en" />
        )
      },
      {
        ...
        story: () => (
          <Congrats tutorial="hero" userType="signedOut" language="en" />
        )
      },
      {
        ...
        description: `Congrats component if 2017 Minecraft tutorial completed`,
        story: () => (
          <Congrats tutorial="hero" userType="student" language="en" />
        )
      },
      {
        ...
        story: () => (
          <Congrats tutorial="hero" userType="student" language="ko" />
        )
      },
      {
        ...
        story: () => (
          <Congrats tutorial="aquatic" userType="signedOut" language="en" />
        )
      },
      {
        ...
        story: () => (
          <Congrats tutorial="other" userType="signedOut" language="en" />
        )
      },
      {
        ...
        description: `Congrats component if any other Code.org tutorial completed`,
        story: () => (
          <Congrats tutorial="other" userType="student" language="en" />
        )
      },
      {
        ...
        description: `Congrats component if any other Code.org tutorial completed`,
        story: () => (
          <Congrats tutorial="other" userType="teacher" language="en" />
        )
      }
    ]);
};
