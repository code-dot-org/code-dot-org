...
const unitDataByUnit = {
  92: {
    ...
    hasStandards: true,
    id: scriptId,
    path: '//localhost:3000/s/coursea-2019',
    title: 'Course A (2019)',
    lessons: [
      {
        script_id: 92,
        ...
        lesson_extras_level_url:
          'http://localhost:3000/s/coursea-2019/lessons/1/extras',
      },
      {
        script_id: scriptId,
        script_name: 'coursea-2019',
        ...
        lesson_extras_level_url:
          'http://localhost:3000/s/coursea-2019/lessons/2/extras',
      },
      {
        script_id: scriptId,
        script_name: 'coursea-2019',
        ...
        lesson_extras_level_url:
          'http://localhost:3000/s/coursea-2019/lessons/3/extras',
      },
    ],
  },
};
