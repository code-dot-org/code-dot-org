...
export default class CensusInaccuracyReviewDetails extends Component {
  ...
  render = () => {
    ...
    const inaccuracyReportRows = [
      {label: "Submitter name", value: this.props.toReview.submitter_name || 'No Name Submitted'},
      {label: "Submitter email address", value: this.props.toReview.submitter_email_address},
      {label: "Submitter Role", value: this.props.toReview.submitter_role},
      {label: "Comment", value: this.props.toReview.inaccuracy_comment},
      {label: "This Survey's Teaches CS Result", value: this.props.toReview.teaches_cs ? 'YES' : 'NO'},
      {label: "K8 School?", value: this.props.toReview.k8_school ? 'Yes' : 'No'},
      {label: "High School?", value: this.props.toReview.high_school ? 'Yes' : 'No'},
      {label: "How many 10 hours?", value: this.props.toReview.how_many_10_hours},
      {label: "How many 20 hours?", value: this.props.toReview.how_many_20_hours},
      {label: "Block programming", value: this.props.toReview.topic_blocks ? 'Yes' : 'No'},
      {label: "Text programming", value: this.props.toReview.topic_text ? 'Yes' : 'No'},
    ];

    const overrideText = `Create a ${this.props.toReview.teaches_cs ? 'YES' : 'NO'} override for this school.`;
    return (
      <div style={{maxWidth: 615}}>
        ...
        <div>
          <p style={{width: '75%'}}>
            ...
            that they <b>{this.props.toReview.teaches_cs ? 'DO' : 'DO NOT'}</b> offer Computer Science:
          </p>
          <br />
