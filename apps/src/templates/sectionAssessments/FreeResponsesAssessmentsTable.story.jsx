  ...
  return storybook
    ...
    .addStoryTable([
      ...
      },
      {
        ...
        description:
          'Display table if at least one student completes assessment',
        story: () => (
          <FreeResponsesAssessmentsTable freeResponses={questionTwo} />
        )
      },
      {
        ...
        story: () => (
          <FreeResponsesAssessmentsTable freeResponses={questionThree} />
        )
      }
    ]);
};
