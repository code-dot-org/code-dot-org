...
class LessonOverview extends Component {
  ...
  exportPDF = () => {
    ...
    savePDF(ReactDOM.findDOMNode(this.pdfExportContainer), pdfOptions);
  };
      ...
      <div>
        ...
        <div
          ref={pdfExportContainer =>
            (this.pdfExportContainer = pdfExportContainer)
          }
        >
          <h1>
            {i18n.lessonNumbered({
