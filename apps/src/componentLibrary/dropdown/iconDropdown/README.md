...
Or run storybook locally and go to [Design System / Checkbox Dropdown](http://localhost:9001/?path=/story/designsystem-checkbox-dropdown-component--default-checkbox-dropdown).
