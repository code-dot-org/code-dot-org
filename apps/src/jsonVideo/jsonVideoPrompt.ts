...
export const jsonVideoPrompt = showAiTutorVideos
  ? `The following videos are available for the user to watch if they are helpful (provided in format: [VIDEO-FILENAME]::[VIDEO-DESCRIPTION]) \n${videoDescriptions} \n. Please add a video using "[video](https://example.com/json-video/[VIDEO-FILENAME])" (where [VIDEO-FILENAME] is swapped out with the filename) to your response ONLY if the video's description matches what the student needs to understand currently.\n`
  : ``;
