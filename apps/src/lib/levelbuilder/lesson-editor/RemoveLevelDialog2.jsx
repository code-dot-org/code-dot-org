 ...
 */
export class UnconnectedRemoveLevelDialog2 extends Component {
  static propTypes = {
...
const RemoveLevelDialog2 = connect(
  state => ({
...
)(UnconnectedRemoveLevelDialog2);
export default RemoveLevelDialog2;
