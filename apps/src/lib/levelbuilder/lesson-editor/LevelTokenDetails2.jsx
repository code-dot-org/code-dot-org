...
import LevelNameInput2 from '@cdo/apps/lib/levelbuilder/lesson-editor/LevelNameInput2';
...
export default class LevelTokenDetails2 extends Component {
  static propTypes = {
  ...
  handleLevelSelected = (variant, levelId) => {
    console.log('handleLevelSelected');
  };

  handleAddVariant = () => {
    console.log('handleAddVariant');
  };
  ...
  handleActiveVariantChanged = id => {
    console.log('handleActiveVariantChange');
  };
