...
export const ADAFRUIT_VENDOR_ID = 0x239a;
export const CIRCUIT_PLAYGROUND_CLASSIC_PRODUCT_ID = 0x8011;
export const CIRCUIT_PLAYGROUND_EXPRESS_PRODUCT_ID = 0x8018;
export const CIRCUIT_PLAYGROUND_EXPRESS_BOOTLOADER_MODE_PID = 0x0018;
