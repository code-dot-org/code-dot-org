...
const MOUSE_MOVE_TOUCH_EVENT_NAME = dom.getTouchEventName(MOUSE_MOVE_EVENT_NAME);
...
class VisualizationResizeBar extends React.Component {
  ...
  componentDidMount() {
    this.removeMouseDownTouchEvent = dom.addMouseDownTouchEvent(
      this.domElement, this.onMouseDown);
  ...
  componentWillUnmount() {
    ...
    if (MOUSE_UP_TOUCH_EVENT_NAME) {
      document.body.removeEventListener(MOUSE_UP_TOUCH_EVENT_NAME, this.onMouseUp);
    }
  }
  ...
  onMouseDown = (event) => {
    ...
    if (MOUSE_MOVE_TOUCH_EVENT_NAME) {
      document.body.addEventListener(MOUSE_MOVE_TOUCH_EVENT_NAME, this.onMouseMove);
    }
  ...
  onMouseUp = () => {
    ...
    if (MOUSE_MOVE_TOUCH_EVENT_NAME) {
      document.body.removeEventListener(MOUSE_MOVE_TOUCH_EVENT_NAME, this.onMouseMove);
    }
