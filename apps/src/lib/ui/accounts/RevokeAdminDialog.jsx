...
export default class RevokeAdminDialog extends React.Component {
  static propTypes = {
    ...
    return (
      ...
      >
        <div style={styles.container}>
          <Header text={i18n.revokeAdminDialog_header()} />
          ...
          <Field
            label={i18n.deleteAccountDialog_verification({
              verificationString: i18n.revokeAdminDialog_verificationString(),
            })}
          >
            <input
              type="text"
