 ...
 * teacher review, constructive feedback for the student — and nothing
 * displays at submit time, so a failure here must not block the submission
 * flow. The server can also re-request evaluation later, so a lost request
 * is recoverable.
 */
