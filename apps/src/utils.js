...
export function createUuid() {
  return 'xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx'.replace(/[xy]/g, function(c) {
    // r is calculated from window.crypto.getRandomValues() which creates a new Uint8Array. The first and only value in the array is selected and divided by 2^32 - 1 to get a value between 0 - 1 like Math.random()
    var r = ((window.crypto.getRandomValues(new Uint8Array(1))[0] / (Math.pow(2,32)-1)) * 16) | 0,
      v = c === 'x' ? r : (r & 0x3) | 0x8;
