...
module.exports.blocks = [
  ...
  {func: 'setMap', parent: api, category: '', params: ['"blank"'], dropdown: { 0: [ '"blank"', '"circle"', '"horizontal"', '"grid"', '"blobs"'] } },
  ...
  {func: 'addCharacter', parent: api, category: '', params: ['"pig"'], dropdown: { 0: [ '"man"', '"pilot"', '"pig"', '"bird"', '"mouse"', '"roo"', '"spider"' ] } },
  {func: 'setToChase', parent: api, category: '', params: ['"pig"'], dropdown: { 0: [ '"man"', '"pilot"', '"pig"', '"bird"', '"mouse"', '"roo"', '"spider"' ] } },
  {func: 'setToFlee', parent: api, category: '', params: ['"pig"'], dropdown: { 0: [ '"man"', '"pilot"', '"pig"', '"bird"', '"mouse"', '"roo"', '"spider"' ] } },
  {func: 'setToRoam', parent: api, category: '', params: ['"pig"'], dropdown: { 0: [ '"man"', '"pilot"', '"pig"', '"bird"', '"mouse"', '"roo"', '"spider"' ] } },
  {func: 'setToStop', parent: api, category: '', params: ['"pig"'], dropdown: { 0: [ '"man"', '"pilot"', '"pig"', '"bird"', '"mouse"', '"roo"', '"spider"' ] } },
  {func: 'moveFast', parent: api, category: '', params: ['"pig"'], dropdown: { 0: [ '"man"', '"pilot"', '"pig"', '"bird"', '"mouse"', '"roo"', '"spider"' ] } },
  {func: 'moveNormal', parent: api, category: '', params: ['"pig"'], dropdown: { 0: [ '"man"', '"pilot"', '"pig"', '"bird"', '"mouse"', '"roo"', '"spider"' ] } },
  {func: 'moveSlow', parent: api, category: '', params: ['"pig"'], dropdown: { 0: [ '"man"', '"pilot"', '"pig"', '"bird"', '"mouse"', '"roo"', '"spider"' ] } },
