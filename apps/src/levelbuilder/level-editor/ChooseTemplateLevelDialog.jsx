...
//import LevelToken from '@cdo/apps/levelbuilder/lesson-editor/LevelToken';
import LessonEditorDialog from '@cdo/apps/levelbuilder/lesson-editor/LessonEditorDialog';
import DialogFooter from '@cdo/apps/templates/teacherDashboard/DialogFooter';
import i18n from '@cdo/locale';

export default class ChooseTemplateLevelDialog extends Component {
  static propTypes = {
