...
import LessonToken from '@cdo/apps/levelbuilder/unit-editor/LessonToken';
import RemoveLessonDialog from '@cdo/apps/levelbuilder/unit-editor/RemoveLessonDialog';
import {
  moveGroup,
  removeLesson,
  addLesson,
