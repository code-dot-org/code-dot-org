...
import FindProgrammingExpressionDialog from '@cdo/apps/levelbuilder/lesson-editor/FindProgrammingExpressionDialog';
import FindResourceDialog from '@cdo/apps/levelbuilder/lesson-editor/FindResourceDialog';
        ...
        <div style={styles.bottomControls}>
          <span>
            {(allowMajorCurriculumChanges ||
              (isLastActivity && isLastActivitySection)) && (
              <AddButton
