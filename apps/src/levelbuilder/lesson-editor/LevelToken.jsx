...
import {toggleExpand} from '@cdo/apps/levelbuilder/lesson-editor/activitiesEditorRedux';
import LevelTokenDetails from '@cdo/apps/levelbuilder/lesson-editor/LevelTokenDetails';
