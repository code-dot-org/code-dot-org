...
// Sublevel labType dropdown options. Narrower than the top-level list:
// only lab types that make sense as picker bubbles (no nested bubble
// choice, no assessments). Built once at module load; LabType values
// map to their display label via labOptions passed in by the parent.
...
const LevelCard: React.FC<LevelCardProps> = ({
  ...
  // Narrow the labOptions to the sublevel-allowed set for the nested
  // sublevel dropdowns. Reused across every sublevel card body.
...
// Uses a compact row layout (no ReorderableCard chrome) so the visual
// hierarchy stays "parent card contains sublevel rows" rather than
          ...
          {sublevels.map((sub, i) => {
            ...
            return (
              <li key={sub.key} className={moduleStyles.sublevelRow}>
                <div className={moduleStyles.sublevelRowHeader}>
                  <code>{preview}</code>
                  <div className={moduleStyles.sublevelRowActions}>
                    <button
                      type="button"
                ...
                <div className={moduleStyles.sublevelRowFields}>
                  <div className={sharedStyles.cardField}>
