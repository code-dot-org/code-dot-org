...
const DanceAiModal: React.FunctionComponent<DanceAiProps> = ({onClose}) => {
  ...
  const [transformingAppear, setTransformingAppear] = useState<boolean>(false);
  ...
  const generateBlocksFromResult = (
    ...
    const blocksSvg: [BlockSvg, BlockSvg, BlockSvg] = [
      ...
      workspace.newBlock('Dancelab_ai') as BlockSvg,
    ];
    ...
    // AI block.
    blocksSvg[2].setFieldValue(resultJson, 'VALUE');
        ...
        <div id="text-area" className={moduleStyles.textArea}>
          <StrongText>
            ...
            {mode === Mode.SELECT_INPUTS
              ...
              : mode === Mode.RESULTS_FINAL || mode === Mode.TRANSFORMING
              ...
              <AiBlockPreview
                className={
                  mode === Mode.GENERATING
                    ...
                    ? 'results'
                    : mode === Mode.TRANSFORMING && transformingAppear
                    ? 'arriving'
                    : mode === Mode.TRANSFORMING && !transformingAppear
                    ? 'leaving'
                    : ''
                }
                duration={mode === Mode.GENERATING ? 5000 : 2500}
