...
// import CdoModernTheme from '@cdo/apps/blockly/themes/cdoTheme';
...
/**
 * Wraps the Blockly workspace for Dance Lab. Provides functions to setup the
...
export default class DanceBlocklyWorkspace {
  constructor(blockInstallOptions, levelProperties, container) {
    ...
    console.log('maxVisualizationWidth', this.maxVisualizationWidth);
    console.log('minVisualizationWidth', this.minVisualizationWidth);
