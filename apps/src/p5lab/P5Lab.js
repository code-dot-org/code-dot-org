...
/**
 * Initialize Blockly and this P5Lab instance.  Called on page load.
...
/**
 * Reset P5Lab to its initial state and optionally run setup code
...
/**
 * Reset P5Lab to its initial state.
 */
  ...
  const injectGamelabGlobals = () => {
    ...
    if (this.isSpritelab) {
      for (const command in this.commands) {
        this.JSInterpreter.createGlobalProperty(
          command,
          this.commands[command].bind(this.gameLabP5.p5),
          null
        );
      }
    }
