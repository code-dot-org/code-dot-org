...
// Choosing is part of the click, not a block of its own: a gallery is the
// case this exists for, and there the click always means "this one".
const definition: BlockJson = {
  type: WHEN_IMAGE_CLICKED_BLOCK_TYPE,
  message0: 'when any sprite clicked, choose it',
  nextStatement: null,
  style: BlockStyles.EVENT,
  tooltip:
    'Runs the blocks below when a sprite with a costume is clicked (not ' +
    'a button or text). It becomes "the chosen sprite" in every scene ' +
