// Adds carousel functionality to code.org/minecraft
...
const swiperActionBlocks = document.querySelector(
  'swiper-container.minecraft-activities'
);
const swiperVideos = document.querySelector('swiper-container.inspirational');
