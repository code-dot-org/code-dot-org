...
window.SchoolInfoManager = function (existingOptions) {
  ...
  function setupSchoolDropdown(districtCode, schoolType) {
    show('#school');
    $('#school-other').prop('disabled', false);
  ...
  function clearAndShowDisabled(selector) {
    $(selector).val('');
    closestFormGroupOrItemBlock(selector).show();
    closestFormGroupOrItemBlock(selector).addClass("disabled");
    $(selector).prop('disabled', true);
  }

  function showEnabled(selector) {
    closestFormGroupOrItemBlock(selector).show();
    closestFormGroupOrItemBlock(selector).removeClass("disabled");
    $(selector).prop('disabled', false);
  }

  function enableDistrict() {
    closestFormGroupOrItemBlock('#school-district').removeClass("disabled");
    enableDistrictDropdown(true);
    districtElement.prop('disabled', false);
    $("#school-district-other").prop('disabled', false);
  }

  function clearAndShowDistrictDisabled() {
    closestFormGroupOrItemBlock('#school-district').show();
    closestFormGroupOrItemBlock('#school-district').addClass("disabled");
    enableDistrictDropdown(false);
    districtElement.prop('disabled', true);
    $("#school-district-other").prop('checked', false);
    $("#school-district-other").prop('disabled', true);
    $("#school-district-name").val("");
  }

  function clearAndShowSchoolDisabled() {
    closestFormGroupOrItemBlock('#school').show();
    closestFormGroupOrItemBlock('#school').addClass("disabled");
    enableSchoolDropdown(false);
    schoolElement.prop('disabled', true);
    $("#school-other").prop('checked', false);
    $("#school-other").prop('disabled', true);
    $("#no-schools-warning").hide();
    $("#school-name").val("");
    closestFormGroupOrItemBlock('#school-name').hide();
  }
  ...
  $('#school-country').change(function () {
    ...
    if ($(this).val() === 'US') {
      ...
      clearAndShowDisabled('#school-state');
      clearAndShowDistrictDisabled();
      clearAndShowSchoolDisabled();
    }
    $('#school-type').change();
  });
