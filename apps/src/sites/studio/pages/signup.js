...
window.SignupManager = function (options) {
  ...
  function showTeacher() {
    ...
    if (shouldUseAutocompleteDropdown()) {
      ...
      const setField = (field, event) => {
        fieldVal = event ? event.value : '';
        ReactDOM.render(
          <div>
            <div className="itemblock" id="school-country-group">
              <div className="school-info-labelblock">School Country</div>
              <select className="form-control fieldblock" id="school-country-auto" name="user[school_info_attributes][country]" type="select">
            ...
            <div className="itemblock">
              ...
              <select className="form-control fieldblock" id="school-type-auto" name="user[school_info_attributes][school_type]" type="select">
                <option disabled="" selected="" value=""></option>
  ...
  $(".signupform").submit(function () {
    ...
    if (shouldUseAutocompleteDropdown()) {
      ...
      formData.push({name: "user[school_id]", value: schoolID});
    }
