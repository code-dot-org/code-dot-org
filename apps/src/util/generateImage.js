...
export const generateStabilityAIImage = (prompt, opts = {}) => {
  return $.ajax({
    url: '/stabilityai/image_generate',
    method: 'POST',
    // TODO: Reenable profanity check
    // profanityCheckEnabled: !!opts.profanityCheckEnabled
    data: {prompt, stylePreset: opts.stylePreset},
    headers: {
      'X-CSRF-Token': appOptions.authenticityToken
    }
  });
