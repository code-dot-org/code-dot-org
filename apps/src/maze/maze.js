...
export default class Maze {
  ...
  _animateAction(action, spotlightBlocks, timePerStep) {
    ...
    switch (action.command) {
      ...
      case 'west':
        ...
        break;
      case 'look_north':
        this._animatedLook(Direction.NORTH);
        break;
      case 'look_east':
        this._animatedLook(Direction.EAST);
        break;
      case 'look_south':
        this._animatedLook(Direction.SOUTH);
        break;
      case 'look_west':
        this._animatedLook(Direction.WEST);
        break;
      case 'fail_forward':
      ...
      case 'fail_backward':
        ...
        break;
      case 'left':
        this._animatedTurn(TurnDirection.LEFT);
        break;
      case 'right':
        this._animatedTurn(TurnDirection.RIGHT);
        break;
      case 'finish':
  ...
  _animatedFail(forward) {
    ...
    if (squareType === SquareType.WALL || squareType === undefined ||
      (this.subtype.isScrat() && squareType === SquareType.OBSTACLE)) {
      // Play the sound
