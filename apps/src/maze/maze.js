...
module.exports = class Maze {
  ...
  _animateAction(action, spotlightBlocks, timePerStep) {
    ...
    switch (action.command) {
      case 'north':
        this._animatedMove(tiles.Direction.NORTH, timePerStep);
        break;
      case 'east':
        this._animatedMove(tiles.Direction.EAST, timePerStep);
        break;
      case 'south':
        this._animatedMove(tiles.Direction.SOUTH, timePerStep);
        break;
      case 'west':
        this._animatedMove(tiles.Direction.WEST, timePerStep);
        break;
      case 'look_north':
        this._animatedLook(tiles.Direction.NORTH);
        break;
      case 'look_east':
        this._animatedLook(tiles.Direction.EAST);
        break;
      case 'look_south':
        this._animatedLook(tiles.Direction.SOUTH);
        break;
      case 'look_west':
        this._animatedLook(tiles.Direction.WEST);
        break;
      case 'fail_forward':
        this._animatedFail(true);
        break;
      case 'fail_backward':
        this._animatedFail(false);
        break;
      case 'left':
        this._animatedTurn(tiles.TurnDirection.LEFT);
        break;
      case 'right':
        this._animatedTurn(tiles.TurnDirection.RIGHT);
        break;
      case 'finish':
        this._animatedFinish(timePerStep);
        break;
      case 'putdown':
        this._scheduleFill();
        break;
