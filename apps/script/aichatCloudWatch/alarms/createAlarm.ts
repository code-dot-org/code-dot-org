...
const createMetricAlarm = async () => {
  const params = {
    ...
    AlarmActions: [
      'arn:aws:sns:us-east-1:475661607190:javabuilder-low-urgency',
    ],
  ...
  try {
    ...
    console.log('Metric alarm created successfully:', response);
  } catch (error) {
    console.error('Error creating metric alarm:', error);
  }
};
