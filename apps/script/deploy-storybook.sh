...
# fetch most recent version of compiled legacy css that is generated by rails
echo "Compiling legacy stylesheets using rails asset pipeline"
pushd ../dashboard
bundle install
bundle exec rake assets:precompile
MOST_RECENT_LEGACY_STYLES_CSS=$(ls -t public/assets/legacy-styles-*.css | head -1)
cp $MOST_RECENT_LEGACY_STYLES_CSS ../apps/build/package/css/legacy-styles.css
popd
