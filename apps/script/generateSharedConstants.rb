...
def main
  ...
  generate_shared_js_file(
    generate_multiple_constants(
      %w(SECTION_HEADERS PAGE_LABELS LABEL_OVERRIDES NUMBERED_QUESTIONS TEXT_FIELDS INTERVIEW_QUESTIONS FACILITATOR_SCOREABLE_QUESTIONS FACILITATOR_VALID_SCORES),
