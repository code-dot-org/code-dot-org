...
- As previously mentioned, see `apps/` for most (but not all) of our JS/TS/JSX/TSX code
- Some new code is being added in `frontend/`, using standalone/modular JS packages
