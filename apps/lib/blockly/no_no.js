...
Blockly.Msg.COLOUR_BLEND_TOOLTIP = "Blander to farger med et gitt forhold (0.0 - 1.0).";
...
Blockly.Msg.COLOUR_RGB_TOOLTIP = "Lag en farge med spesifiserte mengder av rød, grønt og blått. Alle mengdene må være mellom 0 og 100.";
Blockly.Msg.CONFIRM_CREATE_VARIABLE = "Opprett";
Blockly.Msg.CONFIRM_DELETE_FUNCTION_MESSAGE = "Advarsel! Er du sikker på at du vil slette %1?";
...
Blockly.Msg.CONTROLS_FOR_INPUT_COUNTER = "tell %1 fra %2 til %3 øk med %4";
Blockly.Msg.CONTROLS_FOR_INPUT_FROM_TO_BY = "fra %1 til %2 øk med %3";
Blockly.Msg.CONTROLS_FOR_INPUT_WITH = "tell";
Blockly.Msg.CONTROLS_FOR_TOOLTIP = "La variabelen %1 løpe fra startverdi til sluttverdi med en angitt skrittstørrelse og gjenta klossene for hver verdi.";
Blockly.Msg.CONTROLS_IF_ELSEIF_TOOLTIP = "Legg til en betingelse i hvis-blokken.";
Blockly.Msg.CONTROLS_IF_ELSE_TOOLTIP = "Angi hva som skal skje hvis ingen av de andre betingelsene er oppfylt.";
Blockly.Msg.CONTROLS_IF_HELPURL = "http://code.google.com/p/blockly/wiki/If_Then";
Blockly.Msg.CONTROLS_IF_IF_TOOLTIP = "Legg til, fjern eller flytt deler av denne hvis-blokken.";
Blockly.Msg.CONTROLS_IF_MSG_ELSE = "ellers";
Blockly.Msg.CONTROLS_IF_MSG_ELSEIF = "ellers hvis";
Blockly.Msg.CONTROLS_IF_MSG_IF = "hvis";
Blockly.Msg.CONTROLS_IF_TOOLTIP_1 = "Hvis betingelsen er oppfylt, gjør disse blokkene.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_2 = "Hvis betingelsen er oppfylt, gjør de første blokkene. Ellers, gjør de andre blokkene.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_3 = "Hvis den første betingelsen er oppfylt, gjør de første blokkene. Ellers, hvis den andre betingelsen er oppfylt, gjør de andre blokkene.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_4 = "Hvis den første betingelsen er oppfylt, gjør de første blokkene. Ellers, hvis den andre betingelsen er oppfylt, gjør de neste blokkene. Hvis ingen av betingelsene er oppfylt, gjør de siste blokkene.";
...
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_UNTIL = "Gjenta helt til en verdi er usann, og så utfør noen blokker.";
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_WHILE = "Gjenta blokker hvis en betingelse er oppfylt.";
Blockly.Msg.DEFINE_HEADER_DEFINITION = "Definisjon";
Blockly.Msg.DEFINE_FUNCTION_DEFINE = "Definer";
Blockly.Msg.DEFINE_FUNCTION_FOR_EXAMPLE = "Definer funksjonen under og prøv på nytt.";
Blockly.Msg.DELETE = "Slett";
Blockly.Msg.DELETE_BLOCK = "Slett blokk";
Blockly.Msg.DELETE_PARAMETER = "Slett parameter...";
Blockly.Msg.DELETE_PARAMETER_TITLE = "Dette vil slette alle '%1' parametere. Er du sikker?";
...
Blockly.Msg.EXAMPLE_DESCRIPTION = "Definerer et eksempel med forventet og faktisk oppførsel";
...
Blockly.Msg.FUNCTION_PARAMETERS_LABEL = "Hvilke parametre tar din funksjon inn?";
...
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_EQ = "Returnerer sann hvis de to verdiene er like.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GT = "Betingelse som er oppfylt (sann) hvis det første tallet er større enn det andre.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GTE = "Betingelse som er oppfylt (sann) hvis det første tallet er større enn eller lik det andre.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LT = "Betingelse som er oppfylt (sann) hvis det første tallet er mindre enn det andre.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LTE = "Betingelse som er oppfylt (sann) hvis det første tallet er mindre enn eller lik det andre.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_NEQ = "Betingelse som er oppfylt (sann) hvis de to tallene er forskjellige.";
...
Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_POWER = "Returner det første tallet opphøyd i det andre tallet.";
...
Blockly.Msg.RENAME_ALL = "Gi nytt navn til alle %1";
...
Blockly.Msg.RENAME_THIS = "Gi nytt navn til denne %1";
