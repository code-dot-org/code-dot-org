...
Blockly.Msg.CONFIRM_DELETE_FUNCTION_MESSAGE = "Ostrzeżenie! Czy na pewno chcesz usunąć %1?";
...
Blockly.Msg.CONTROLS_FOREACH_TOOLTIP = "Każdemu elementowi z listy przyporządkuj zmienną '%1', a następnie wykonaj kilka instrukcji.";
Blockly.Msg.CONTROLS_FOR_HELPURL = "https://code.google.com/p/blockly/wiki/Loops#count_with";
Blockly.Msg.CONTROLS_FOR_INPUT_COUNTER = "dla %1 od %2 do %3 liczone co %4";
Blockly.Msg.CONTROLS_FOR_INPUT_FROM_TO_BY = "od %1 do %2 co %3";
Blockly.Msg.CONTROLS_FOR_INPUT_WITH = "dla";
Blockly.Msg.CONTROLS_FOR_TOOLTIP = "Niech zmienna %1 przyjmuje wartości od liczby początkowej do liczby końcowej, co pewien przedział, i wykonaj  określone bloki.";
...
Blockly.Msg.CONTROLS_IF_IF_TOOLTIP = "Dodaj, usuń lub zmień kolejność sekcji, aby zmienić ten blok jeśli.";
...
Blockly.Msg.CONTROLS_IF_TOOLTIP_1 = "Jeśli wartość jest prawdą, wykonaj kilka instrukcji.";
...
Blockly.Msg.CONTROLS_IF_TOOLTIP_4 = "Jeśli pierwsza wartość jest prawdą, to wykonaj pierwszy blok instrukcji.  W przeciwnym razie, jeśli druga wartość jest prawdą, to wykonaj drugi blok instrukcji.  Jeżeli żadna z wartości nie jest prawdą, to wykonaj ostatni blok instrukcji.";
...
Blockly.Msg.DEFINE_FUNCTION_FOR_EXAMPLE = "Zdefiniuj funkcję poniżej i spróbuj ponownie.";
Blockly.Msg.DELETE = "Usuń";
Blockly.Msg.DELETE_BLOCK = "Usuń Blok";
Blockly.Msg.DELETE_PARAMETER = "Usuń parametr...";
Blockly.Msg.DELETE_PARAMETER_TITLE = "Usuniesz wszystkie wystąpienia parametru '%1'. Czy na pewno tego chcesz?";
...
Blockly.Msg.EXAMPLE_DESCRIPTION = "Definiuje przykład z przewidywanym i rzeczywistym zachowaniem";
...
Blockly.Msg.FUNCTIONAL_PROCEDURE_DEFINE_TOOLTIP = "Zdefiniuj metodę funkcjonalną";
...
Blockly.Msg.LISTS_CREATE_WITH_CONTAINER_TOOLTIP = "Dodaj, usuń lub zmień kolejność sekcji, aby zmodyfikować blok tej listy.";
Blockly.Msg.LISTS_CREATE_WITH_INPUT_WITH = "utwórz listę z";
Blockly.Msg.LISTS_CREATE_WITH_ITEM_TOOLTIP = "Dodaj element do listy.";
Blockly.Msg.LISTS_CREATE_WITH_TOOLTIP = "Utwórz listę z dowolną liczbą elementów.";
...
Blockly.Msg.LISTS_GET_SUBLIST_START_FIRST = "pobierz podlistę od pierwszego elementu";
...
Blockly.Msg.LISTS_INDEX_OF_TOOLTIP = "Zwraca indeks pierwszego/ostatniego wystąpienia elementu na liście.  Zwraca wartość 0, jeśli tekst nie został znaleziony.";
...
Blockly.Msg.LISTS_REPEAT_TITLE = "utwórz listę złożoną z elementu %1 powtórzonego %2 razy";
Blockly.Msg.LISTS_REPEAT_TOOLTIP = "Tworzy listę składającą się z podanej wartości powtórzonej określoną liczbę razy.";
...
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_FROM_END = "Wstawia element w określonym miejscu na liście. #1 to ostatni element.";
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_FROM_START = "Wstawia element w określonym miejscu na liście. #1 to pierwszy element.";
...
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_SET_FROM_END = "Wstawia element w określonym miejscu na liście. #1 to ostatni element.";
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_SET_FROM_START = "Wstawia element w określone miejsce na liście. #1 to pierwszy element.";
...
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GT = "Zwróć prawda, jeśli pierwsza dana jest większa od drugiej.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GTE = "Zwróć prawda, jeśli pierwsza dana jest większa niż lub równa drugiej danej.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LT = "Zwróć prawda, jeśli pierwsza dana jest mniejsza od drugiej danej.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LTE = "Zwróć prawda, jeśli pierwsza dana jest mniejsza niż lub równa drugiej danej.";
...
Blockly.Msg.LOGIC_NEGATE_TOOLTIP = "Zwraca prawda, jeśli dana wejściowa jest fałszem.  Zwraca fałsz, jeśli dana wejściowa jest prawdą.";
...
Blockly.Msg.LOGIC_OPERATION_TOOLTIP_AND = "Zwróć prawda, jeśli obie dane mają wartość prawda.";
Blockly.Msg.LOGIC_OPERATION_TOOLTIP_OR = "Zwróć prawda, jeśli co najmniej jedna z danych ma wartość prawda.";
...
Blockly.Msg.LOGIC_TERNARY_TOOLTIP = "Sprawdź warunek w 'test'. Jeśli ma wartość prawda, to zwróci wartość jeśli prawda; w przeciwnym razie zwróci wartość jeśli fałsz.";
...
Blockly.Msg.MATH_CONSTANT_TOOLTIP = "Zwróć jedną ze znanych stałych: π (3.141), e (2.718...), φ (1.618...), sqrt(2) (1.414...), sqrt(½) (0.707...) lub ∞ (nieskończoność).";
...
Blockly.Msg.MATH_RANDOM_INT_TOOLTIP = "Zwróć losową liczbę całkowitą z przedziału o określonych końcach, włącznie.";
...
Blockly.Msg.MATH_SINGLE_TOOLTIP_LOG10 = "Zwróć logarytm dziesiętny z danej liczby.";
Blockly.Msg.MATH_SINGLE_TOOLTIP_NEG = "Zwróć liczbę przeciwną.";
Blockly.Msg.MATH_SINGLE_TOOLTIP_POW10 = "Zwróć 10 do danej potęgi.";
Blockly.Msg.MATH_SINGLE_TOOLTIP_ROOT = "Zwróć pierwiastek kwadratowy z danej liczby.";
...
Blockly.Msg.MATH_TRIG_TOOLTIP_COS = "Zwróć cos z argumentu w stopniach (nie w radianach).";
Blockly.Msg.MATH_TRIG_TOOLTIP_SIN = "Zwróć sin z argumentu w stopniach (nie radianach).";
Blockly.Msg.MATH_TRIG_TOOLTIP_TAN = "Zwróć tan z argumentu w stopniach (nie radianach).";
...
Blockly.Msg.PROCEDURES_IFRETURN_TOOLTIP = "Jeśli wartość jest prawdą, to zwróć drugą wartość.";
Blockly.Msg.PROCEDURES_IFRETURN_WARNING = "Ostrzeżenie: Ten blok może być użyty tylko w definicji funkcji.";
...
Blockly.Msg.RENAME_ALL = "Zmień nazwę wszystkich %1";
Blockly.Msg.RENAME_PARAMETER = "Zmień nazwę parametru...";
Blockly.Msg.RENAME_PARAMETER_TITLE = "Zmień nazwy wszystkich parametrów '%1' na:";
Blockly.Msg.RENAME_THIS = "Zmień nazwę tego %1";
...
Blockly.Msg.TEXT_CREATE_JOIN_TOOLTIP = "Dodaj, usuń lub zmień kolejność sekcji, aby zmodyfikować ten blok tekstowy.";
...
Blockly.Msg.TEXT_ISEMPTY_TOOLTIP = "Zwraca prawdę (true), jeśli podany tekst jest pusty.";
