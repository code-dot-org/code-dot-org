...
Blockly.Msg.CONFIRM_DELETE_FUNCTION_MESSAGE = "Xəbərdarlıq! %1 silinəcək. Bunu istədiyinizə əminsiniz?";
...
Blockly.Msg.CONTROLS_FOR_INPUT_COUNTER = "%1 sayğacı üçün %2 qiymətindən %3 qiymətinə qədər %4 addımı ilə say";
Blockly.Msg.CONTROLS_FOR_INPUT_FROM_TO_BY = "%1-dən, %2-ə kimi %3 qədər artır";
Blockly.Msg.CONTROLS_FOR_INPUT_WITH = "üçün";
...
Blockly.Msg.DEFINE_FUNCTION_FOR_EXAMPLE = "Aşağıdakı funksiyanı təyin edərək bir daha cəhd edin.";
...
Blockly.Msg.DELETE_PARAMETER_TITLE = "Bu, hər yerdə '%1' parametrini pozacaq. Əminsiniz?";
...
Blockly.Msg.FUNCTION_DESCRIPTION_LABEL = "Funksiyanızın nə etməsi gözlənilir?";
...
Blockly.Msg.FUNCTION_PARAMETERS_LABEL = "Funksiyanız hansı parametrləri götürür?";
...
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_EQ = "Girişlər bir birinə bərabərdirsə, \"doğru\" cavabını qaytarın.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GT = "Birinci giriş ikincidən böyükdürsə \"doğru\" cavabını qaytarın.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GTE = "Birinci giriş ikincidən böyük və ya bərarbərdirsə, \"doğru\" cavabını qaytarın.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LT = "Birinci giriş ikincidən kiçikdirsə \"doğru\" cavabını qaytarın.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LTE = "Birinci giriş ikincidən kiçik və ya bərarbərdirsə, \"doğru\" cavabını qaytarın.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_NEQ = "Daxil olunan dəyərlər bir-birlərinə bərabər deyilsə, doğru cavabını ötürün.";
Blockly.Msg.LOGIC_NEGATE_HELPURL = "http://code.google.com/p/blockly/wiki/Not";
Blockly.Msg.LOGIC_NEGATE_TITLE = "%1 deyil";
Blockly.Msg.LOGIC_NEGATE_TOOLTIP = "Giriş yanlışdırsa \"doğru\" cavabını qaytarır. Giriş doğrudursa yalan cavabını qaytarır.";
Blockly.Msg.LOGIC_NULL = " sıfır \\boş";
Blockly.Msg.LOGIC_NULL_HELPURL = "http://en.wikipedia.org/wiki/Nullable_type";
Blockly.Msg.LOGIC_NULL_TOOLTIP = "Boş cavabını qaytarır.";
...
Blockly.Msg.PROCEDURES_IFRETURN_TOOLTIP = "Əgər qiymət \"doğru\"-dursa onda ikinci dəyəri qaytar.";
Blockly.Msg.PROCEDURES_IFRETURN_WARNING = "Xəbərdarlıq: Bu blok ancaq bir funksiyanın təyinatı daxilində istifadə oluna bilər.";
...
Blockly.Msg.RENAME_ALL = "Bütün '%1' adlarını dəyişdir";
Blockly.Msg.RENAME_PARAMETER = "Parametrin adını dəyiş...";
Blockly.Msg.RENAME_PARAMETER_TITLE = "Bütün '%1' parametrlərinin adını dəyişdir:";
Blockly.Msg.RENAME_THIS = "Buradakı '%1' adını dəyişdir";
Blockly.Msg.RENAME_VARIABLE = "Dəyişənin adını dəyişdir...";
Blockly.Msg.RENAME_VARIABLE_TITLE = "Bütün '%1' dəyişənlərinin adını buna dəyişdir:";
Blockly.Msg.TEXT_APPEND_APPENDTEXT = "mətn əlavə et";
...
Blockly.Msg.TEXT_GET_SUBSTRING_START_FROM_END = "sondan # nömrəli hərfdən başlayaraq altsətri götür";
