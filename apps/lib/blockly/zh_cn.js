...
Blockly.Msg.CONTROLS_FOR_INPUT_COUNTER = "计数 %1 从 %2 到 %3 间隔数为 %4";
...
Blockly.Msg.CONTROLS_IF_ELSE_TOOLTIP = "在“如果”板块中添加一个能捕获所有其它情况的条件 。";
Blockly.Msg.CONTROLS_IF_HELPURL = "http://code.google.com/p/blockly/wiki/If_Then";
Blockly.Msg.CONTROLS_IF_IF_TOOLTIP = "增加、删除或者调整板块的顺序来重新配置“如果”板块。";
...
Blockly.Msg.LISTS_CREATE_WITH_CONTAINER_TOOLTIP = "添加、移除或重新排列板块来重新配置这个列表块。";
...
Blockly.Msg.LISTS_GET_INDEX_FROM_END = "#来自末尾";
...
Blockly.Msg.LISTS_GET_SUBLIST_END_LAST = "至末尾";
...
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_FIRST = "在列表开头插入这一项。";
...
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_RANDOM = "将项随机插入到列表中";
...
Blockly.Msg.MATH_CONSTANT_TOOLTIP = "返回常用的常量之一： π (3.141......)，e (2.718...)、 φ (1.618...)、 sqrt(2) (1.414......)、 sqrt(½) (0.707......) 或 ∞ （无穷大）。";
...
Blockly.Msg.MATH_SINGLE_TOOLTIP_EXP = "返回 e 的幂，指数为给定的数。";
...
Blockly.Msg.TEXT_CHARAT_FROM_END = "从末尾取字母*";
Blockly.Msg.TEXT_CHARAT_FROM_START = "取字母*";
...
Blockly.Msg.TEXT_CHARAT_LAST = "取末尾字母";
Blockly.Msg.TEXT_CHARAT_RANDOM = "取随机的字母";
...
Blockly.Msg.TEXT_GET_SUBSTRING_END_FROM_END = "从末尾至字母*";
Blockly.Msg.TEXT_GET_SUBSTRING_END_FROM_START = "到字母*";
Blockly.Msg.TEXT_GET_SUBSTRING_END_LAST = "至末尾字母";
...
Blockly.Msg.TEXT_GET_SUBSTRING_START_FROM_END = "获取从*到末尾的子字符串";
