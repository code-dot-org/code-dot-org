...
Blockly.Msg.CONTROLS_IF_IF_TOOLTIP = "Добавь, удали или переставь элементы для переделки блока «если».";
...
Blockly.Msg.CONTROLS_IF_TOOLTIP_3 = "Если первое значение истинно, выполняется первый блок операторов. В обратном случае, если второе значение истинно, выполняется второй блок операторов.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_4 = "Если первое значение истинно, выполняется первый блок операторов. В обратном случае, если второе значение истинно, выполняется второй блок операторов. Если ни одно из значений не истинно, выполняется последний блок операторов.";
...
Blockly.Msg.DEFINE_FUNCTION_FOR_EXAMPLE = "Определи функцию ниже и попробуй еще раз.";
...
Blockly.Msg.LOGIC_TERNARY_TOOLTIP = "Проверь условие в режиме «тест». Если условие истинно, возвращает значение «если истина», в противном случае возвращает значение «если ложь».";
