...
Blockly.Msg.CONTROLS_FOR_INPUT_COUNTER = "herhaal %1 van %2 tot %3 met stappen van %4";
...
Blockly.Msg.CONTROLS_IF_IF_TOOLTIP = "Voeg stukken toe, verwijder of verander de volgorde om dit \"als\"-blok aan te passen.";
...
Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_MINUS = "Geef het verschil van de twee getallen.";
Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_MULTIPLY = "Geef het product van de 2 getallen.";
Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_POWER = "Geef het eerste getal verheven tot de macht van het tweede getal.";
...
Blockly.Msg.MATH_RANDOM_INT_TOOLTIP = "Geef een willekeurig geheel getal tussen de 2 gegeven grenzen, inclusief.";
...
Blockly.Msg.RENAME_THIS = "Hernoem deze %1";
...
Blockly.Msg.TEXT_GET_SUBSTRING_TOOLTIP = "Geeft de opgegeven deel van de tekst.";
...
Blockly.Msg.TEXT_ISEMPTY_TOOLTIP = "Geeft waa, 'true'r als de opgegeven tekst leeg is.";
...
Blockly.Msg.TEXT_PRINT_TOOLTIP = "Print de opgegeven tekst, het getal of een andere waarde.";
...
Blockly.Msg.TEXT_TRIM_TOOLTIP = "Geef een kopie van de tekst terug waaruit spaties aan 1 of beide einden verwijderd zijn.";
Blockly.Msg.UNUSED_CODE = "Ongebruikte code";
Blockly.Msg.VARIABLE = "variabele";
