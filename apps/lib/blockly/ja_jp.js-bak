Blockly.Msg.ACTUAL = "よびだす";
Blockly.Msg.ADD = "ふやす";
Blockly.Msg.ADD_COMMENT = "コメントをかく";
Blockly.Msg.ADD_PARAMETER = "パラメーターを　いれてください";
Blockly.Msg.CANCEL = "キャンセル";
Blockly.Msg.CHANGE_VALUE_TITLE = "すうじを　かえてください：";
Blockly.Msg.CLOSE = "閉じる";
Blockly.Msg.COLLAPSE_ALL = "ブロックをおりたたむ";
Blockly.Msg.COLLAPSE_BLOCK = "ブロックをおりたたむ";
Blockly.Msg.COLOUR_BLEND_COLOUR1 = "いろ　１";
Blockly.Msg.COLOUR_BLEND_COLOUR2 = "いろ　２";
Blockly.Msg.COLOUR_BLEND_HELPURL = "http://meyerweb.com/eric/tools/color-blend/";
Blockly.Msg.COLOUR_BLEND_RATIO = "くらべる";
Blockly.Msg.COLOUR_BLEND_TITLE = "まぜる";
Blockly.Msg.COLOUR_BLEND_TOOLTIP = "ふたつの　いろを　てきどに　まぜる (0.0 ～ 1.0)";
Blockly.Msg.COLOUR_PICKER_HELPURL = "http://en.wikipedia.org/wiki/Color";
Blockly.Msg.COLOUR_PICKER_TOOLTIP = "パレットから　いろを　えらんでください";
Blockly.Msg.COLOUR_RANDOM_HELPURL = "http://randomcolour.com";
Blockly.Msg.COLOUR_RANDOM_TITLE = "てきとうに　えらんだ　いろ";
Blockly.Msg.COLOUR_RANDOM_TOOLTIP = "てきとうに　えらんだ　いろを　えらんでください。";
Blockly.Msg.COLOUR_RGB_BLUE = "あお";
Blockly.Msg.COLOUR_RGB_GREEN = "みどり";
Blockly.Msg.COLOUR_RGB_HELPURL = "http://www.december.com/html/spec/colorper.html";
Blockly.Msg.COLOUR_RGB_RED = "あか";
Blockly.Msg.COLOUR_RGB_TITLE = "いろ　といっしょに";
Blockly.Msg.COLOUR_RGB_TOOLTIP = "あか　みどり　あお　の　なかから　いろを　とって、　きめられた　いろを　つくります。いろのきめかたは、すうじの０　から　１００　のなかから　えらびます。";
Blockly.Msg.CONFIRM_CREATE_VARIABLE = "つくる";
Blockly.Msg.CONFIRM_DELETE_FUNCTION_MESSAGE = "きをつけて!　%1 を　けしてを　いいですか？";
Blockly.Msg.CONFIRM_RENAME_VARIABLE = "名前を変更";
Blockly.Msg.CONTRACT_EDITOR_HEADER = "デザインのつくりかた";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_HELPURL = "https://code.google.com/p/blockly/wiki/Loops#Loop_Termination_Blocks";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_OPERATOR_BREAK = "なんかいも　おなじことを　つづけてやること　をループといいます。　その　ループを　やめます。";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_OPERATOR_CONTINUE = "なんかいも　おなじことを　つづけてやること　をループといいます。　このループを　つづけます。";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_BREAK = "なんかいも　おなじことを　つづけてやること　をループといいます。　なかに　はいっている　ループを　やめます。。";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_CONTINUE = "なんかいも　おなじことを　つづけてやること　をループといいます。　このループの　のこっている　ところを　やめて、つぎの　ループで　くりかえしの　さぎょうを　つづけます。";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_WARNING = "ちゅうい: このブロックは、ループの　なかでしか　つかえません。\nなんかいも　おなじことを　つづけてやること　をループといいます。";
...
Blockly.Msg.CONTROLS_FOR_INPUT_WITH = "をカウントする";
Blockly.Msg.CONTROLS_FOR_TOOLTIP = "変数%1は、始めの数字から終わりの数字まで指定した間隔で値をとり、指定したブロックを実行します。";
Blockly.Msg.CONTROLS_IF_ELSEIF_TOOLTIP = "「もし」ブロックに条件を追加します。";
...
Blockly.Msg.CONTROLS_IF_IF_TOOLTIP = "セクションを追加、削除、順序変更して、もし( if )ブロックを作り直します。";
Blockly.Msg.CONTROLS_IF_MSG_ELSE = "他";
Blockly.Msg.CONTROLS_IF_MSG_ELSEIF = "他の場合";
Blockly.Msg.CONTROLS_IF_MSG_IF = "もし";
Blockly.Msg.CONTROLS_IF_TOOLTIP_1 = "値が true の場合はその後ステートメントを行をいくつかします。";
Blockly.Msg.CONTROLS_IF_TOOLTIP_2 = "値が true の場合、命令文の最初のブロックを実行します。それ以外の場合、2番目のブロックを実行します。";
Blockly.Msg.CONTROLS_IF_TOOLTIP_3 = "最初の値が true の場合、命令文の最初のブロックを実行します。それ以外の場合、もし2番目の値が true なら、2番目のブロックを実行します。";
Blockly.Msg.CONTROLS_IF_TOOLTIP_4 = "第一ブロックが真なら、構文の第一ブロックを実行。そうでなく、第二の値が真なら、構文の第二ブロックを実行。真の値がないなら、構文の最終ブロックを実行。";
Blockly.Msg.CONTROLS_REPEAT_HELPURL = "http://en.wikipedia.org/wiki/For_loop";
Blockly.Msg.CONTROLS_REPEAT_INPUT_DO = "やること";
...
Blockly.Msg.CONTROLS_WHILEUNTIL_OPERATOR_WHILE = "以下が満たされている間続行";
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_UNTIL = "値が 偽( false ) の間、構文を実行。";
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_WHILE = "値が 真(true)の間、構文を実行。";
Blockly.Msg.DEFINE_HEADER_DEFINITION = "意味を決める";
Blockly.Msg.DEFINE_FUNCTION_DEFINE = "定義";
Blockly.Msg.DEFINE_FUNCTION_FOR_EXAMPLE = "したに　かいてあることを　みなおし　してから、もういっかい　やりなおしてください。";
Blockly.Msg.DELETE = "削除";
Blockly.Msg.DELETE_BLOCK = "ブロックを削除";
Blockly.Msg.DELETE_PARAMETER = "パラメータを削除します。";
Blockly.Msg.DELETE_PARAMETER_TITLE = "全てのパラメーター'%1'を削除します。よろしいですか？";
...
Blockly.Msg.EXAMPLE = "例";
Blockly.Msg.EXAMPLE_DESCRIPTION = "予想される動作と実際の動作からなる例を定義する";
...
Blockly.Msg.FUNCTION_CREATE = "関数を作成する";
Blockly.Msg.FUNCTION_EDIT = "編集";
Blockly.Msg.FUNCTION_NAME_LABEL = "関数に名前をつける:";
Blockly.Msg.FUNCTION_DESCRIPTION_LABEL = "あなたの関数は何をするものですか？";
Blockly.Msg.FUNCTION_PARAMETERS_LABEL = "あなたの関数はどんな引数をとりますか？";
Blockly.Msg.FUNCTION_HEADER = "関数";
Blockly.Msg.FUNCTIONAL_CREATE = "新しいブロック";
Blockly.Msg.FUNCTIONAL_EDIT = "編集";
Blockly.Msg.FUNCTIONAL_NAME_LABEL = "名前";
Blockly.Msg.FUNCTIONAL_TYPE_LABEL = "タイプを選ぶ...";
Blockly.Msg.FUNCTIONAL_DESCRIPTION_LABEL = "説明";
Blockly.Msg.FUNCTIONAL_DOMAIN_LABEL = "ドメイン";
Blockly.Msg.FUNCTIONAL_PROCEDURE_DEFINE_TOOLTIP = "メソッドを定義する";
Blockly.Msg.FUNCTIONAL_RANGE_LABEL = "範囲";
Blockly.Msg.FUNCTIONAL_VARIABLE_CREATE = "変数を作成する";
Blockly.Msg.FUNCTIONAL_VARIABLE_HEADER = "変数";
Blockly.Msg.FUNCTIONAL_VARIABLE_TYPE = "タイプ";
Blockly.Msg.HELP = "ヘルプ";
Blockly.Msg.INLINE_INPUTS = "インライン入力";
Blockly.Msg.KEEP = "のこす";
...
Blockly.Msg.LISTS_CREATE_EMPTY_TOOLTIP = "長さゼロの空のリストを返します";
...
Blockly.Msg.LISTS_CREATE_WITH_TOOLTIP = "アイテム数に制限のないリストを作成します。";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_FIRST = "リストの最初のアイテムを返します。";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_RANDOM = "リストからランダムに選択されたアイテムを返します。";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_REMOVE_FROM_START = "リスト内の指定位置にある項目を削除します。＃ 1 は、最初の項目です。";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_REMOVE_LAST = "リスト内の最後の項目を削除します。";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_REMOVE_RANDOM = "リスト内にあるランダムな項目のアイテムを削除します。";
...
Blockly.Msg.LISTS_LENGTH_INPUT_LENGTH = "長さ";
...
Blockly.Msg.LOGIC_BOOLEAN_TOOLTIP = "真または偽を返します。";
...
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GTE = "もし最初の入力が二つ目の入力よりも大きい、または等しければtrueを返します。";
...
Blockly.Msg.LOGIC_OPERATION_TOOLTIP_AND = "両方の入力が同じ場合はtrue を返します。";
...
Blockly.Msg.LOGIC_TERNARY_TOOLTIP = "'テスト' 内の条件をチェックします。条件が true の場合、'if true'内 の値を返します。それ以外の場合 'if false'内 の値を返します。";
...
Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_DIVIDE = "2 つの数で割り算した結果を返します。";
Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_MINUS = "2 つの数の差を返します。";
Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_MULTIPLY = "2 つの数で掛け算した結果を返します。";
...
Blockly.Msg.MATH_CONSTANT_TOOLTIP = "いずれかの共通の定数を返す: π (3.141…), e (2.718…), φ (1.618…), sqrt(2) (1.414…), sqrt(½) (0.707…), or ∞ (無限).";
...
Blockly.Msg.MATH_CONSTRAIN_TOOLTIP = "値を、上限 x と下限 y の間に制限する（上限のxと下限のyも含む）。";
Blockly.Msg.MATH_DIVISION_SYMBOL = "÷";
Blockly.Msg.MATH_IS_DIVISIBLE_BY = "割り切れる";
Blockly.Msg.MATH_IS_EVEN = "偶数";
Blockly.Msg.MATH_IS_NEGATIVE = "負の数";
Blockly.Msg.MATH_IS_ODD = "奇数";
Blockly.Msg.MATH_IS_POSITIVE = "正の数";
Blockly.Msg.MATH_IS_PRIME = "素数";
Blockly.Msg.MATH_IS_TOOLTIP = "数が偶数、奇数、素数、整数、０より大きい数、０より小さい数であるか、またはある数で割り切れるかどうかをたしかめて、trueかfalseを返します。";
...
Blockly.Msg.MATH_ONLIST_TOOLTIP_MODE = "リストで最も多く現れる項目のリストを返します。";
Blockly.Msg.MATH_ONLIST_TOOLTIP_RANDOM = "リストからランダムな要素を返します。";
Blockly.Msg.MATH_ONLIST_TOOLTIP_STD_DEV = "リストの標準偏差を返します。";
Blockly.Msg.MATH_ONLIST_TOOLTIP_SUM = "リストの数を全て足して返します。";
Blockly.Msg.MATH_POWER_SYMBOL = "^";
Blockly.Msg.MATH_RANDOM_FLOAT_HELPURL = "http://en.wikipedia.org/wiki/Random_number_generation";
Blockly.Msg.MATH_RANDOM_FLOAT_TITLE_RANDOM = "ランダムな小数";
Blockly.Msg.MATH_RANDOM_FLOAT_TOOLTIP = "0.0 以上、1.0 未満のランダムな小数を返す";
Blockly.Msg.MATH_RANDOM_INT_HELPURL = "http://en.wikipedia.org/wiki/Random_number_generation";
Blockly.Msg.MATH_RANDOM_INT_TITLE = "%1 から %2 の間のランダムな整数";
Blockly.Msg.MATH_RANDOM_INT_TOOLTIP = "指定した上限以下、下限以上の間からランダムな整数を返します。";
Blockly.Msg.MATH_ROUND_HELPURL = "http://en.wikipedia.org/wiki/Rounding";
Blockly.Msg.MATH_ROUND_OPERATOR_ROUND = "四捨五入";
Blockly.Msg.MATH_ROUND_OPERATOR_ROUNDDOWN = "端数切り捨て";
Blockly.Msg.MATH_ROUND_OPERATOR_ROUNDUP = "端数を切り上げ";
...
Blockly.Msg.MATH_SINGLE_TOOLTIP_EXP = "eのべき乗を返します";
...
Blockly.Msg.MATH_TRIG_ACOS = "逆余弦［アークコサイン］関数";
Blockly.Msg.MATH_TRIG_ASIN = "《コ》逆正弦［アークサイン］関数";
Blockly.Msg.MATH_TRIG_ATAN = "逆正接［アークタンジェント］関数";
Blockly.Msg.MATH_TRIG_COS = "Cosine ";
Blockly.Msg.MATH_TRIG_HELPURL = "http://en.wikipedia.org/wiki/Trigonometric_functions";
Blockly.Msg.MATH_TRIG_SIN = "Sine";
Blockly.Msg.MATH_TRIG_TAN = "Tangent";
Blockly.Msg.MATH_TRIG_TOOLTIP_ACOS = "値の arccosine を返します。";
Blockly.Msg.MATH_TRIG_TOOLTIP_ASIN = "値の arcsine を返します。";
Blockly.Msg.MATH_TRIG_TOOLTIP_ATAN = "値の arctangent を返します。";
Blockly.Msg.MATH_TRIG_TOOLTIP_COS = "角度 (ラジアンではない) の cosine を返します。";
Blockly.Msg.MATH_TRIG_TOOLTIP_SIN = "角度 (ラジアンではない) の sine を返します。";
Blockly.Msg.MATH_TRIG_TOOLTIP_TAN = "角度 (ラジアンではない) の tangent を返します。";
Blockly.Msg.NEW_VARIABLE = "新しい変数...";
Blockly.Msg.NEW_VARIABLE_TITLE = "新しい変数名:";
Blockly.Msg.ORDINAL_NUMBER_SUFFIX = "";
Blockly.Msg.PROCEDURES_BEFORE_PARAMS = "と：";
...
Blockly.Msg.PROCEDURES_CREATE_DO = "%1を作成";
...
Blockly.Msg.PROCEDURES_DEFRETURN_PROCEDURE = "何かしてください";
Blockly.Msg.PROCEDURES_DEFRETURN_TITLE = "宛先";
...
Blockly.Msg.PROCEDURES_HIGHLIGHT_DEF = "関数定義を強調表示";
...
Blockly.Msg.RENAME_PARAMETER = "引数の名前を変更する...";
Blockly.Msg.RENAME_PARAMETER_TITLE = "すべての引数'%1'の名前を変更する:";
...
Blockly.Msg.TEXT_CHANGECASE_OPERATOR_TITLECASE = "大文字に";
...
Blockly.Msg.TEXT_GET_SUBSTRING_START_FROM_START = "文字列から部分文字列を取得 ＃";
...
Blockly.Msg.TEXT_INDEXOF_OPERATOR_FIRST = "はじめに　でてきた　ぶんしょうを　みつけましょう　";
Blockly.Msg.TEXT_INDEXOF_OPERATOR_LAST = "テキストの最後に見つかったものを検索します。";
Blockly.Msg.TEXT_INDEXOF_TAIL = "";
Blockly.Msg.TEXT_INDEXOF_TOOLTIP = "二番目のテキスト内の、最初のテキストの最初と最後に出現したインデックスを返します。テキストが見つからない場合は 0 を返します。";
...
Blockly.Msg.TEXT_JOIN_TOOLTIP = "任意の数の項目をくっつけてテキストの一部を作成します。";
...
Blockly.Msg.TEXT_PROMPT_TYPE_TEXT = "メッセージをプロンプトしてテキストを求める";
...
Blockly.Msg.TEXT_TRIM_OPERATOR_BOTH = "両側からのスペースをトリミングします。";
Blockly.Msg.TEXT_TRIM_OPERATOR_LEFT = "左側からスペースをトリミングします。";
Blockly.Msg.TEXT_TRIM_OPERATOR_RIGHT = "右側からスペースをトリミングします。";
Blockly.Msg.TEXT_TRIM_TOOLTIP = "スペースを 1 つまたは両方の端から削除したのち、テキストのコピーを返します。";
Blockly.Msg.UNUSED_CODE = "つかっていないコード";
Blockly.Msg.VARIABLES_DEFAULT_NAME = "項目";
Blockly.Msg.VARIABLES_GET_CREATE_SET = "「%1に代入」を作成";
...
Blockly.Msg.VARIABLES_SET_CREATE_GET = "「%1から取得」 を作成";
...
Blockly.Msg.VARIABLES_SET_TOOLTIP = "この変数を入力と等しくなるように設定します。";
