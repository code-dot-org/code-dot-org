...
Blockly.Msg.MATH_CONSTRAIN_TOOLTIP = "Restringir un número entre los límites especificados (inclusivos).";
...
Blockly.Msg.MATH_SINGLE_TOOLTIP_NEG = "Devuelve el número negativo del número introducido.";
