Blockly.Msg.ACTUAL = "అసలు";
Blockly.Msg.ADD = "కాంట్రాక్ట్ ఎడిటర్లో క్రొత్త డొమైన్ అంశం జోడించడానికి ఇది ఉపయోగించబడుతుంది. అలాగే \"చొప్పించు\" లేదా \"క్రొత్తది సృష్టించు\" అనేవాటికి కూడా . ఇది ఒక జాబితాకు వేరే దేనైనా చేర్చడానికి, కాని రెండింటి కోసం కాదు.";
Blockly.Msg.ADD_COMMENT = "సందర్భ పట్టిక - ఎంపిక చేసుకున్న విభాగంలో వివరణాత్మక వ్యాఖను రాయండి.";
Blockly.Msg.ADD_PARAMETER = "Add Parameter";
Blockly.Msg.CANCEL = "రద్దు";
...
Blockly.Msg.CONFIRM_CREATE_VARIABLE = "సృష్టించు";
...
Blockly.Msg.CONTROLS_IF_MSG_ELSE = "లేదంటే";
...
Blockly.Msg.CONTROLS_REPEAT_INPUT_DO = "చేయండి";
