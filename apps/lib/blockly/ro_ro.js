...
Blockly.Msg.CONFIRM_CREATE_VARIABLE = "Creare";
Blockly.Msg.CONFIRM_DELETE_FUNCTION_MESSAGE = "Atenţie! Eşti sigur că doreşti ştergerea %1?";
...
Blockly.Msg.CONTROLS_FOR_TOOLTIP = "Pune variabila %1 să preia valorile de la numărul de început până la numărul final, numărând prin intervalul menționat, și fă blocurile specificate.";
Blockly.Msg.CONTROLS_IF_ELSEIF_TOOLTIP = "Adaugă o condiţie blocului dacă.";
Blockly.Msg.CONTROLS_IF_ELSE_TOOLTIP = "Adaugă un final, ca și condiție cuprinde-tot la blocul dacă.";
...
Blockly.Msg.MATH_IS_TOOLTIP = "Verifică dacă un număr este un par, impar, prim, întreg, pozitiv, negativ, sau dacă este divizibil cu un anumit număr.  Returnează adevărat sau fals.";
...
Blockly.Msg.MATH_TRIG_TOOLTIP_SIN = "Returnează cosinusul unui grad (nu radian).";
...
Blockly.Msg.PROCEDURES_CALLNORETURN_TOOLTIP = "Execută funcția '%1' din categoria user-defined.";
Blockly.Msg.PROCEDURES_CALLRETURN_HELPURL = "http://en.wikipedia.org/wiki/Procedure_%28computer_science%29";
Blockly.Msg.PROCEDURES_CALLRETURN_TOOLTIP = "Execută funcția '%1' din categoria user-defined şi folosește rezultatul său.";
...
Blockly.Msg.PROCEDURES_IFRETURN_WARNING = "Avertisment: Acest bloc pot fi utilizat numai în definiţia unei funcţii.";
...
Blockly.Msg.TEXT_PROMPT_TOOLTIP_NUMBER = "Promptează utilizatorul pentru un număr.";
Blockly.Msg.TEXT_PROMPT_TOOLTIP_TEXT = "Promptează utilizatorul pentru text.";
