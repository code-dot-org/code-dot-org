...
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_BREAK = "Ieși din bucla.";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_CONTINUE = "Sari peste restul acestei bucle şi continuă cu următoarea repetare.";
...
Blockly.Msg.CONTROLS_IF_ELSE_TOOLTIP = "Adaugă o condiție finala blocului 'dacă'.";
...
Blockly.Msg.CONTROLS_IF_TOOLTIP_1 = "Dacă o valoare este adevărată, atunci fă unele declaraţii.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_2 = "Dacă o valoare este adevărată, atunci fă primul bloc de declaraţii.  Altfel, fă al doilea bloc de declaraţii.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_3 = "Dacă prima valoare este adevărată, atunci fă primul bloc de declaraţii.  Altfel, dacă a doua valoare este adevărată, fă al doilea bloc de declaraţii.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_4 = "Dacă prima valoare este adevărată, atunci fă primul bloc de declaraţii.  Altfel, dacă a doua valoare este adevărată, fă al doilea bloc de declaraţii. Dacă niciuna dintre valori nu este adevărată, fă ultimul bloc de declaraţii.";
...
Blockly.Msg.CONTROLS_REPEAT_TOOLTIP = "Fă unele afirmaţii de mai multe ori.";
...
Blockly.Msg.EXAMPLE_DESCRIPTION = "Definește un exemplu cu comportament așteptat și real";
...
Blockly.Msg.LISTS_CREATE_WITH_CONTAINER_TOOLTIP = "Adaugă, elimină sau reordonează secţiuni ca să reconfiguri aceste blocuri de listă.";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_FIRST = "Returnează primul element într-o listă.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_FROM_END = "Returnează elementul la poziţia specificată într-o listă.  #1 este ultimul element.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_FROM_START = "Returnează elementul la poziţia specificată într-o listă.  #1 este primul element.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_LAST = "Returnează ultimul element într-o listă.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_RANDOM = "Returnează un element aleatoriu într-o listă.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_FIRST = "Elimină şi returnează primul element într-o listă.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_FROM_END = "Elimină şi returnează elementul la poziţia specificată într-o listă.  #1 este ultimul element.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_FROM_START = "Elimină şi returnează elementul la poziţia specificată într-o listă.  #1 este primul element.";
...
Blockly.Msg.LISTS_REPEAT_TITLE = "creează lista cu %1 elemente repetate de %2 ori";
...
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_RANDOM = "Inserează aleatoriu elementul într-o listă.";
...
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_NEQ = "Returnează adevărat daca cele două intrări nu sunt egale una cu cealaltă.";
...
Blockly.Msg.MATH_CONSTANT_TOOLTIP = "Returnează una din constantele comune: π (3.141...), e (2.718...), φ (1,618...), sqrt(2) (1.414...), sqrt(½) (0.707...) sau ∞ (infinitate).";
...
Blockly.Msg.MATH_ONLIST_TOOLTIP_MEDIAN = "Returnează numărul median în listă.";
...
Blockly.Msg.MATH_RANDOM_FLOAT_TOOLTIP = "Returnează o fracţie aleatorie între 0.0 (inclusiv) si 1.0 (exclusiv).";
...
Blockly.Msg.NEW_VARIABLE_TITLE = "Nume nou de variabilă:";
...
Blockly.Msg.PROCEDURES_CALLNORETURN_TOOLTIP = "Execută funcția '%1' din categoria definita de utilizator.";
Blockly.Msg.PROCEDURES_CALLRETURN_HELPURL = "http://en.wikipedia.org/wiki/Procedure_%28computer_science%29";
Blockly.Msg.PROCEDURES_CALLRETURN_TOOLTIP = "Execută funcția '%1' din categoria definita de utilizator şi folosește rezultatul său.";
...
Blockly.Msg.PROCEDURES_DEFNORETURN_TITLE = "să";
Blockly.Msg.PROCEDURES_DEFNORETURN_TOOLTIP = "Creează o funcţie fără ieşire.";
...
Blockly.Msg.PROCEDURES_DEFRETURN_TITLE = "să";
...
Blockly.Msg.TEXT_CHANGECASE_OPERATOR_TITLECASE = "la Litere mari";
Blockly.Msg.TEXT_CHANGECASE_OPERATOR_UPPERCASE = "la MAJUSCULE";
Blockly.Msg.TEXT_CHANGECASE_TOOLTIP = "Returnează o copie a textului în tip diferit de litere.";
...
Blockly.Msg.TEXT_PRINT_TITLE = "tipărește %1";
...
Blockly.Msg.TEXT_PROMPT_TYPE_NUMBER = "promptează pentru număr cu mesaj";
Blockly.Msg.TEXT_PROMPT_TYPE_TEXT = "promptează pentru text cu mesaj";
...
Blockly.Msg.VARIABLES_SET_TAIL = "pentru a";
