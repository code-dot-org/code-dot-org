...
Blockly.Msg.COLOUR_BLEND_TOOLTIP = "Mélange deux couleurs avec un ratio donné (0.0 - 1.0).";
...
Blockly.Msg.COLOUR_RGB_TOOLTIP = "Créer une couleur avec une quantité spécifique de rouge, de vert et de bleu.  Toutes les valeurs doivent être comprises entre 0 et 100.";
Blockly.Msg.CONFIRM_CREATE_VARIABLE = "Créer";
Blockly.Msg.CONFIRM_DELETE_FUNCTION_MESSAGE = "Attention! Es-tu sûr de vouloir supprimer %1?";
...
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_CONTINUE = "Passer cette boucle et poursuivre avec l’itération suivante.";
...
Blockly.Msg.CONTROLS_FOR_INPUT_COUNTER = "pour %1 de %2 à %3 compte par %4";
...
Blockly.Msg.CONTROLS_IF_TOOLTIP_2 = "Si une valeur est vraie, alors exécuter le premier bloc d’instructions. Autrement, faire le deuxième bloc d'instructions.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_3 = "Si la première valeur est vraie, alors exécuter le premier bloc d’instructions. Autrement, si la deuxième valeur est vraie, faire le deuxième bloc d'instructions.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_4 = "Si la première valeur est vraie, alors exécuter le premier bloc d’instructions. Autrement, si la deuxième valeur est vraie, faire le deuxième bloc d'instructions. Si aucune des valeurs n’est vraie, alors exécuter le dernier bloc d’instructions.";
...
Blockly.Msg.DEFINE_FUNCTION_FOR_EXAMPLE = "Définir la fonction ci-dessous et réessayer.";
...
Blockly.Msg.DELETE_PARAMETER_TITLE = "Ceci supprimera toutes les occurrences de paramètre « %1 ». Es-tu certain ?";
...
Blockly.Msg.EXAMPLE_DESCRIPTION = "Définit un exemple avec un comportement prévisible et réel";
...
Blockly.Msg.FUNCTIONAL_PROCEDURE_DEFINE_TOOLTIP = "Définis une méthode fonctionnelle";
...
Blockly.Msg.LISTS_GET_INDEX_GET = "collecter";
...
Blockly.Msg.LISTS_GET_SUBLIST_START_FROM_END = "obtenir la sous-liste des derniers # éléments";
...
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_EQ = "Renvoyer si les deux entrées sont égales.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GT = "Renvoyer si la première entrée est plus grande que la seconde.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GTE = "Renvoyer  si la première entrée est plus grande ou égale à la seconde.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LT = "Renvoyer  si la première entrée est plus petite que la seconde.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LTE = "Renvoyer  si la première entrée est plus petite ou égale à la seconde.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_NEQ = "Renvoyer si les deux entrées ne sont pas égales.";
...
Blockly.Msg.LOGIC_TERNARY_TOOLTIP = "Vérifier la condition dans « test ». Si la condition est vraie, renvoie la valeur «&#160;si vrai&#160;» ; autrement renvoie la valeur «&#160;si faux&#160;».";
...
Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_DIVIDE = "Renvoyer le quotient des deux nombres.";
Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_MINUS = "Renvoyer la différence entre les deux nombres.";
Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_MULTIPLY = "Renvoyer le produit des deux nombres.";
...
Blockly.Msg.MATH_CONSTANT_TOOLTIP = "Renvoyer une des constantes courantes : π (3.141…), e (2.718…), φ (1.618…), sqrt(2) (1.414…), sqrt(½) (0.707…), ou ∞ (infini).";
...
Blockly.Msg.MATH_IS_TOOLTIP = "Vérifier si un nombre est pair, impair, premier, entier, positif, négatif, ou s’il est divisible par un certain nombre. Renvoie 'vrai' ou '60;faux'.";
...
Blockly.Msg.MATH_ROUND_TOOLTIP = "Arrondir à un nombre au-dessus ou au-dessous.";
...
Blockly.Msg.MATH_SINGLE_TOOLTIP_POW10 = "Renvoyer 10 à la puissance d’un nombre.";
...
Blockly.Msg.MATH_TRIG_TOOLTIP_COS = "Renvoyer le cosinus d’un angle en degrés (pas en radians).";
Blockly.Msg.MATH_TRIG_TOOLTIP_SIN = "Renvoyer le sinus d’un angle en degrés (pas en radians).";
Blockly.Msg.MATH_TRIG_TOOLTIP_TAN = "Renvoyer la tangente d’un angle en degrés (pas en radians).";
...
Blockly.Msg.PROCEDURES_DEFRETURN_TOOLTIP = "Crée une fonction avec un résultat.";
Blockly.Msg.PROCEDURES_DEF_DUPLICATE_WARNING = "Attention : Cette fonction détient des paramètres en double.";
...
Blockly.Msg.TEXT_INDEXOF_OPERATOR_FIRST = "trouver la première occurrence du texte";
Blockly.Msg.TEXT_INDEXOF_OPERATOR_LAST = "trouver la dernière occurrence du texte";
Blockly.Msg.TEXT_INDEXOF_TOOLTIP = "Renvoie l’index de la première/dernière occurrence du premier texte dans le second. Renvoie 0 si aucun texte n’est trouvé.";
...
Blockly.Msg.TEXT_JOIN_TOOLTIP = "Créer un morceau de texte en joignant un nombre quelconque d’éléments.";
...
Blockly.Msg.TEXT_PRINT_TOOLTIP = "Imprimer le texte, le nombre spécifié ou une autre valeur spécifiée.";
...
Blockly.Msg.TEXT_TRIM_TOOLTIP = "Renvoyer une copie du texte avec les espaces supprimés d’un côté ou des deux.";
