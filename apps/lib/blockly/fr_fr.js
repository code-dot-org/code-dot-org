...
Blockly.Msg.COLOUR_RANDOM_TOOLTIP = "Choisis une couleur au hasard.";
Blockly.Msg.COLOUR_RGB_BLUE = "bleu";
Blockly.Msg.COLOUR_RGB_GREEN = "vert";
Blockly.Msg.COLOUR_RGB_HELPURL = "http://www.december.com/html/spec/colorper.html";
Blockly.Msg.COLOUR_RGB_RED = "rouge";
Blockly.Msg.COLOUR_RGB_TITLE = "colore avec";
Blockly.Msg.COLOUR_RGB_TOOLTIP = "Crée une couleur avec la quantité spécifiée de rouge, vert et bleu.  Toutes les valeurs doivent être comprises entre 0 et 100.";
Blockly.Msg.CONFIRM_DELETE_FUNCTION_MESSAGE = "Attention ! Es-tu sûr de vouloir supprimer %1 ?";
Blockly.Msg.CONTRACT_EDITOR_HEADER = "Méthode de conception";
...
Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_MINUS = "Renvoie la différence entre les deux nombres.";
