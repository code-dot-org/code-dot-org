...
Blockly.Msg.COLOUR_RGB_TOOLTIP = "Δημιούργησε ένα χρώμα με το συγκεκριμένο ποσό κόκκινου, πράσινου και μπλε.  Όλες οι τιμές πρέπει να είναι μεταξύ 0 και 100.";
...
Blockly.Msg.CONTROLS_IF_ELSEIF_TOOLTIP = "Πρόσθεσε μια συνθήκη σε ένα μπλοκ εάν.";
Blockly.Msg.CONTROLS_IF_ELSE_TOOLTIP = "Πρόσθεσε μια τελική συνθήκη για όλες τις υπόλοιπες περιπτώσεις στον μπλοκ εάν.";
Blockly.Msg.CONTROLS_IF_HELPURL = "http://code.google.com/p/blockly/wiki/If_Then ΑΝ_ΤΟΤΕ";
Blockly.Msg.CONTROLS_IF_IF_TOOLTIP = "Πρόσθεσε, αφαίρεσε ή αναδιάταξε ενότητες για να αναπροσαρμόσεις αυτό το μπλοκ εάν.";
...
Blockly.Msg.DEFINE_FUNCTION_FOR_EXAMPLE = "Όρισε την συνάρτηση παρακάτω και προσπάθησε ξανά.";
...
Blockly.Msg.FUNCTION_DESCRIPTION_LABEL = "Τι υποτίθεται ότι πρέπει να κάνει η συνάρτησή σου;";
...
Blockly.Msg.TEXT_GET_SUBSTRING_START_FROM_END = "πάρε μέρος κειμένου ξεκινώντας από το γαράμμα # από το τέλος";
...
Blockly.Msg.TEXT_JOIN_TOOLTIP = "Δημιούργησε ένα νέο κείμενο ενώνοντας οποιοδήποτε πλήθος αντικειμένων.";
