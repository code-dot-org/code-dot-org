...
Blockly.Msg.DELETE_PARAMETER_TITLE = "Θα διαγραφούν όλες '%1' οι παράμετροι όπου κι αν εμφανίζονται. Είστε σίγουροι;";
...
Blockly.Msg.FUNCTION_DESCRIPTION_LABEL = "Τι υποτίθεται ότι πρέπει να κάνει η συνάρτηση σας;";
Blockly.Msg.FUNCTION_PARAMETERS_LABEL = "Τι παραμέτρους δέχεται η συνάρτηση σας;";
...
Blockly.Msg.FUNCTIONAL_PROCEDURE_DEFINE_TOOLTIP = "Καθορίζουν μια λειτουργική µέθοδο";
...
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_FROM_END = "Εισάγει το στοιχείο της συγκεκριμένης θέσης σε μια λίστα. Το #1 είναι το τελευταίο στοιχείο.";
...
Blockly.Msg.RENAME_PARAMETER = "Μετονομάστε την παράμετρο...";
Blockly.Msg.RENAME_PARAMETER_TITLE = "Μετονομάσετε όλες  '%1' τις παραμέτρους σε:";
Blockly.Msg.RENAME_VARIABLE = "Μετονόμασε τη μεταβλητή...";
Blockly.Msg.RENAME_VARIABLE_TITLE = "Μετονόμασε όλες τις μεταβλητές '%1' σε:";
Blockly.Msg.SAVE_AND_CLOSE = "Αποθήκευση και κλείσιμο";
