...
Blockly.Msg.DELETE_PARAMETER_TITLE = "Θα διαγραφούν όλες '%1' οι παράμετροι από όπου κι αν εμφανίζονται. Είστε σίγουροι;";
...
Blockly.Msg.MATH_ONLIST_OPERATOR_MEDIAN = "διάμεσος (μέσος) της λίστας";
...
Blockly.Msg.TEXT_TRIM_TOOLTIP = "Επίστρεψε ένα αντίγραφο του κειμένου, αφαιρώντας τα κενά από ένα ή και από τα δύο άκρα.";
