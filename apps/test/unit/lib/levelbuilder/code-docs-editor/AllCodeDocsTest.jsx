...
describe('AllCodeDocs', () => {
  ...
  it('has ProgrammingExpressionsTable and ProgrammingEnvironmentsTable on load', () => {
    ...
    expect(wrapper.find('ProgrammingEnvironmentsTable').first().props().hidden).toBe(false);
    expect(wrapper.find('ProgrammingExpressionsTable').length).toBe(1);
    expect(wrapper.find('ProgrammingExpressionsTable').first().props().hidden).toBe(true);
  });

  it('switches visible table when toggle is pressed', () => {
    const wrapper = shallow(<AllCodeDocs {...defaultProps} />);
    expect(wrapper.find('ProgrammingEnvironmentsTable').props().hidden).toBe(false);
    expect(wrapper.find('ProgrammingExpressionsTable').props().hidden).toBe(true);
    ...
    expect(wrapper.find('ProgrammingEnvironmentsTable').props().hidden).toBe(true);
    expect(wrapper.find('ProgrammingExpressionsTable').props().hidden).toBe(false);
