...
import reducer, {
  addAnnouncement, VisibilityType
...
describe('scriptAnnouncementsRedux', () => {
  it('can add a single teacher announcement', () => {
    const state = reducer(undefined, addAnnouncement('Hey you', 'Look what I have to say',
      '/very/interesting', NotificationType.information, VisibilityType.teacher));
  ...
  it('can add a single student announcement', () => {
    const state = reducer(undefined, addAnnouncement('Hey you', 'Look what I have to say',
      '/very/interesting', NotificationType.information, VisibilityType.student));
  ...
  it('can add a single teacher and student announcement', () => {
    const state = reducer(undefined, addAnnouncement('Hey you', 'Look what I have to say',
      '/very/interesting', NotificationType.information, VisibilityType.teacherAndStudent));
  ...
  it('can add two teacher announcements', () => {
    ...
    const state = reducer(state1, addAnnouncement('Announce2', 'details2',
      '/link/2', NotificationType.bullhorn, VisibilityType.teacher));
  ...
  it('can add a teacher and a student announcement', () => {
    const state1 = reducer(undefined, addAnnouncement('Hey you', 'Look what I have to say',
      '/very/interesting', NotificationType.information, VisibilityType.teacher));
    const state = reducer(state1, addAnnouncement('Announce2', 'details2',
      '/link/2', NotificationType.bullhorn, VisibilityType.student));
