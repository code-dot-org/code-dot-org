...
const fakeSublevels = [
  ...
  },
  {
    ...
    thumbnail_url: null,
    url: '/courses/course/units/1/lessons/1/levels/2/sublevel/2',
...
const DEFAULT_PROPS = {
  level: {
    ...
    previous_level_url: '/courses/course/units/1/lessons/1/levels/1',
    redirect_url: '/courses/course/units/1/lessons/1/levels/3',
    script_url: '/courses/course/units/1',
    name: 'Bubble Choice',
    type: 'BubbleChoice',
