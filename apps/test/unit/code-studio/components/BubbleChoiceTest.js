...
const fakeSublevels = [
  {
    ...
    url: '/s/script/lesson/1/puzzle/2/sublevel/1',
  ...
  },
  {
    ...
    thumbnail_url: null,
    url: '/s/script/lesson/1/puzzle/2/sublevel/2',
...
const DEFAULT_PROPS = {
  level: {
    ...
    previous_level_url: '/s/script/lesson/1/puzzle/1',
    redirect_url: '/s/script/lesson/1/puzzle/3',
    script_url: '/s/script',
    name: 'Bubble Choice',
    type: 'BubbleChoice',
