...
describe('useWorkshop', () => {
  ...
  it('should return null when workshopId is not provided', async () => {
    ...
    expect(result.current.workshop).toBeNull();
  ...
  it('should fetch workshop data when workshopId is provided', async () => {
    ...
    expect(result.current.workshop).toEqual(mockWorkshop);
  });
  ...
  it('should refetch when workshopId changes', async () => {
    ...
    expect(result.current.workshop).toEqual(secondWorkshop);
  });

  it('should set loading to true initially and false after data is fetched', async () => {
    useParams.mockReturnValue({workshopId: '1'});
  ...
  it('should clear error on subsequent successful fetches', async () => {
    useParams.mockReturnValue({workshopId: '1'});
    ...
    // error is cleared before the second fetch completes
