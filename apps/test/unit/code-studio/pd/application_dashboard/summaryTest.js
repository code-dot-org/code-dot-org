      ...
      [
        ...
        JSON.stringify({
          ...
          csd_teachers: {
            ...
            waitlisted: { locked: 0, unlocked: 0 },
            declined: { locked: 0, unlocked: 0 },
            accepted_not_notified: { locked: 0, unlocked: 0 },
            accepted_notified_by_partner: { locked: 0, unlocked: 0 },
            accepted_no_cost_registration: { locked: 0, unlocked: 0 },
            registration_sent: { locked: 0, unlocked: 0 },
            paid: { locked: 0, unlocked: 0 },
          },
          csp_teachers: {
            unreviewed: { locked: 0, unlocked: 1 },
            pending: { locked: 0, unlocked: 0 },
