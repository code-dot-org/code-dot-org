...
describe("Quick View", () => {
  ...
  it("Initially renders a spinner", () => {
    let quickView = shallow(
      <QuickView route={{'path':'csf_facilitators', 'title':'CSF Facilitators'}}/>, {context}
    );
  ...
  it("Generates 1 table after hearing from server", () => {
    ...
    server.respondWith("GET", '/api/v1/pd/applications/quick_view?role=csf_facilitators',
      [
        ...
        JSON.stringify([{"id":8,"created_at":"2017-10-25T21:26:06.000Z","applicant_name":"Clare Constantine","district_name":null,"school_name":null,"status":"unreviewed"}])
      ]
    );
