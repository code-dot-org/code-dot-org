...
describe('apps/src/assetManagement/assetPrefix.js', () => {
  describe('fixPath', () => {
    ...
    it('should route an absolute URL through the MEDIA_PROXY', () => {
      ...
      expect(result).toBe(`//${location.host}/media?u=http%3A%2F%2Fexample.com%2Ftest%2520image.png`);
    ...
    it('should replace starter:// prefix with starterAssetPathPrefix', () => {
      ...
      expect(result).toBe('/level_starter_assets/test-level/test-starter-image.png');
    });
