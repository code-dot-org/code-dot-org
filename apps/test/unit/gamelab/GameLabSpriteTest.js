...
describe('GameLabSprite', function () {
  ...
  describe('isTouching', function () {
    it('returns false if the collider and colliding sprite dont overlap', function () {
      var sprite1 = gameLabP5.p5.createSprite(0, 0, 100, 100);
      var sprite2 = gameLabP5.p5.createSprite(200, 200, 100, 100);
      var isTouching1to2 = sprite1.isTouching(sprite2);
      var isTouching2to1 = sprite2.isTouching(sprite1);
      expect(isTouching1to2).to.equal(false);
      expect(isTouching1to2).to.equal(isTouching2to1);
    });

    it('returns true if the collider and colliding sprite overlap', function () {
      var sprite3 = gameLabP5.p5.createSprite(150, 150, 100, 100);
      var sprite4 = gameLabP5.p5.createSprite(200, 200, 100, 100);
      var isTouching3to4 = sprite3.isTouching(sprite4);
      var isTouching4to3 = sprite4.isTouching(sprite3);
      expect(isTouching3to4).to.equal(true);
      expect(isTouching4to3).to.equal(isTouching3to4);

      var sprite5 = gameLabP5.p5.createSprite(101, 101, 100, 100);
      var sprite6 = gameLabP5.p5.createSprite(200, 200, 100, 100);
      var isTouching5to6 = sprite5.isTouching(sprite6);
      var isTouching6to5 = sprite6.isTouching(sprite5);
      expect(isTouching5to6).to.equal(true);
      expect(isTouching6to5).to.equal(isTouching5to6);
    });

    it('does not affect the location or velocity of the sprite', function () {
      var sprite1 = gameLabP5.p5.createSprite(170, 170, 100, 100);
      var sprite2 = gameLabP5.p5.createSprite(200, 200, 100, 100);
      var isTouching1to2 = sprite1.isTouching(sprite2);
