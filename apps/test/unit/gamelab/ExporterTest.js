...
describe('The Gamelab Exporter,', function () {
  ...
  describe("when assets can't be fetched,", function () {
    beforeEach(function () {
      server.respondWith(/\/blockly\/js\/p5play\/p5\.js\?__cb__=\d+/, [500, {}, ""]);
    });
    ...
    describe("will produce a zip file, which", function () {
      ...
      describe('the index.html file', () => {
        ...
        it("should have a #soft-buttons element", () => {
          assert.isNotNull(el.querySelector("#soft-buttons"), "no #soft-buttons element");
        });

        it("should have a #studio-dpad-container element", () => {
          assert.isNotNull(el.querySelector("#studio-dpad-container"), "no #studio-dpad-container element");
        });
      });
      ...
      it("should rewrite urls in the code to point to the correct asset files", function () {
        expect(zipFiles['my-app/code.js']).to.include('console.log("hello");\nplaySound("assets/zoo.mp3");\nplaySound("assets/default.mp3");');
      });
  ...
  describe("when exporting in expoMode,", function () {
    ...
    describe("will produce a zip file, which", function () {
      ...
      it("should contain a gamelab.css file", function () {
        ...
        assert.equal(zipFiles['my-app/assets/gamelab.css'], GAMELAB_CSS_CONTENT);
      });
      ...
      it("should rewrite urls in the code to point to the correct asset files", function () {
        expect(zipFiles['my-app/assets/code.j']).to.include('console.log("hello");\nplaySound("zoo.mp3");\nplaySound("default.mp3");');
      });
  ...
  describe("Regression tests", () => {
    ...
    it("should allow you to play a sound", (done) => {
      window.testPromise = new Promise(resolve => (window.resolveTestPromise = resolve));
      runExportedApp(
        `
