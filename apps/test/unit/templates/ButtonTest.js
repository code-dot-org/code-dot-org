...
describe('Button', () => {
  ...
  it('modifies target if provided', () => {
    const wrapper = shallow(
      <Button href="/foo/bar" text="Click me" target="_blank" />
    );
  ...
  it('renders a div when button has an onClick', () => {
    ...
    const wrapper = shallow(
      <Button onClick={onClick} text="Click me" target="_blank" />
    );
  ...
  it('doesnt respond to clicks when disabled', () => {
    ...
    const wrapper = shallow(
      <Button onClick={onClick} text="Click me" target="_blank" disabled />
    );
  ...
  it('renders bigger if we use a large size', () => {
    ...
    const large = shallow(
      <Button href="/foo/bar" text="Click me" size={Button.ButtonSize.large} />
    );
  ...
  it('renders a blue button if we set color to blue', () => {
    const wrapper = shallow(
      <Button href="/foo/bar" text="Click me" color={Button.ButtonColor.blue} />
    );
  ...
  it('renders a gray button if we set color to gray', () => {
    const wrapper = shallow(
      <Button href="/foo/bar" text="Click me" color={Button.ButtonColor.gray} />
    );
    assert.strictEqual(
  ...
  it('renders with an icon if specified', () => {
    const wrapper = shallow(
      <Button href="/foo/bar" text="Click me" icon="lock" />
    );
