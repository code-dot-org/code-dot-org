...
import stats, { setCompletedLevelCount } from '@cdo/apps/templates/teacherDashboard/statsRedux';
...
describe('statsRedux', () => {
  ...
  describe('setCompletedLevelCount', () => {
    it('sets completedLevelCountBySectionId', () => {
      const action = setCompletedLevelCount(123, completedLevelCountByStudentId);
    ...
    it('sets completedLevelCountBySectionId for multiple sections', () => {
      ...
      const firstAction = setCompletedLevelCount(123, completedLevelCountByStudentId);
      const firstState = stats(initialState, firstAction);
      const secondAction = setCompletedLevelCount(321, moreCompletedLevelCountByStudentId);
      ...
      assert.deepEqual(secondState.completedLevelCountBySectionId, expectedState);
    });
  });
});
