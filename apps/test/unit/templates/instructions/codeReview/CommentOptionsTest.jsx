...
describe('Code Review Comment Options', () => {
  it('renders resolve option if comment is not resolved and viewing as student', () => {
    ...
    expect(wrapper.text().includes(javalabMsg.markComplete())).to.be.true;
    expect(wrapper.text().includes(javalabMsg.markIncomplete())).to.be.false;
  ...
  it('renders re-open option if comment is resolved and viewing as student', () => {
    ...
    expect(wrapper.text().includes(javalabMsg.markIncomplete())).to.be.true;
    expect(wrapper.text().includes(javalabMsg.markComplete())).to.be.false;
    expect(wrapper.text().includes(msg.delete())).to.be.false;
  });
