          ...
          course_versions: [
            [
              798,
              {
                ...
                path: '/courses/aiml-2021/units/1',
                type: 'UnitGroup',
                is_stable: true,
                is_recommended: false,
                locales: ['English'],
            ...
            [
              799,
              {
                ...
                name: 'AI and Machine Learning Module',
                path: '/courses/aiml-2022/units/1',
                type: 'UnitGroup',
                is_stable: true,
                is_recommended: true,
                locales: ['English'],
          ...
          course_versions: [
            [
              1163,
              {
                ...
                path: '/courses/devices-2022/units/1',
                type: 'UnitGroup',
                is_stable: true,
                is_recommended: true,
                locales: ['English'],
        ...
        course_versions: [
          [
            986,
            {
              ...
              content_root_id: 344,
              name: 'Dance Party',
              path: '/courses/dance-2019/units/1',
              type: 'UnitGroup',
              is_stable: false,
              is_recommended: false,
              locales: ['English'],
        ...
        course_versions: [
          [
            1086,
            {
              ...
              name: 'Poem Art',
              path: '/courses/poem-art-2021/units/1',
              type: 'UnitGroup',
              is_stable: true,
              is_recommended: true,
              locales: ['English'],
        ...
        course_versions: [
          [
            1033,
            {
              ...
              path: '/courses/hello-world-animals-2021/units/1',
              type: 'UnitGroup',
              is_stable: true,
              is_recommended: true,
              locales: ['English'],
        ...
        course_versions: [
          [
            1039,
            {
              ...
              path: '/courses/hello-world-retro-2021/units/1',
              type: 'UnitGroup',
              is_stable: true,
              is_recommended: true,
              locales: ['English'],
        ...
        course_versions: [
          [
            1040,
            {
              ...
              path: '/courses/hello-world-soccer-2022/units/1',
              type: 'UnitGroup',
              is_stable: true,
              is_recommended: true,
              locales: ['English'],
        ...
        course_versions: [
          [
            1043,
            {
              ...
              path: '/courses/hoc-encryption/units/1',
              type: 'UnitGroup',
              is_stable: true,
              is_recommended: true,
              locales: ['English'],
        ...
        course_versions: [
          [
            811,
            {
              ...
              path: '/courses/applab-intro/units/1',
              type: 'UnitGroup',
              is_stable: true,
              is_recommended: true,
              locales: ['English'],
        ...
        course_versions: [
          [
            1121,
            {
              ...
              path: '/courses/starwarsblocks/units/1',
              type: 'UnitGroup',
              is_stable: true,
              is_recommended: true,
              locales: ['English'],
        ...
        course_versions: [
          [
            819,
            {
              ...
              path: '/courses/basketball/units/1',
              type: 'UnitGroup',
              is_stable: true,
              is_recommended: true,
              locales: ['English'],
        ...
        course_versions: [
          [
            1143,
            {
              ...
              path: '/courses/vpl-csd-2022/units/1',
              type: 'UnitGroup',
              is_stable: true,
              is_recommended: true,
              locales: ['English'],
        ...
        course_versions: [
          [
            1140,
            {
              ...
              path: '/courses/vpl-csa-2022/units/1',
              type: 'UnitGroup',
              is_stable: true,
              is_recommended: true,
              locales: ['English'],
            ...
            745,
            {
              ...
              units: {
                4162: {
                  ...
                  path: '/courses/self-paced-pl-csa-2022/units/1',
                  lesson_extras_available: false,
                  text_to_speech_enabled: false,
                  position: 1,
                  requires_verified_instructor: false,
                ...
                4164: {
                  ...
                  path: '/courses/self-paced-pl-csa-2022/units/3',
                  lesson_extras_available: false,
                  text_to_speech_enabled: false,
                  position: 3,
                  requires_verified_instructor: false,
              ...
              377,
              {
                ...
                units: {
                  177: {
                    ...
                    path: '/courses/csa-pilot/units/1',
                    lesson_extras_available: false,
                    text_to_speech_enabled: false,
                    position: 1,
                    requires_verified_instructor: true,
