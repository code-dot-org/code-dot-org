...
describe('convertXmlToBlockly', function() {
  ...
  // TODO: Fix/unskip this test.
  // Tracked by https://codedotorg.atlassian.net/browse/STAR-1681
  it.skip('creates a block space if it detects xml', function() {
    const container = document.createElement('div');
    const content =
  ...
  // TODO: Fix/unskip this test.
  // Tracked by https://codedotorg.atlassian.net/browse/STAR-1681
  it.skip('ignores comments in xml', function() {
