...
describe('ProgressIcon Component', () => {
    it('renders the FontAwesome icon for a specific itemType', () => {
        ...
        const iconElement = screen.getByTitle(new RegExp(`^${PROGRESS_ICON_TITLE_PREFIX}${testType[0]}$`));
    ...
    it('renders the not started box when itemType is VIEWED', () => {
    ...
    it('renders the feedback given triangle when itemType is NEEDS_FEEDBACK', () => {
