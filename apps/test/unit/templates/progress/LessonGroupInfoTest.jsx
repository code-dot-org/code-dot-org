...
describe('LessonGroupInfoDialog', () => {
  it('renders description and big questions', () => {
    ...
    expect(wrapper.find('SafeMarkdown').at(0).props().markdown).toBe('This is an awesome Lesson Group.');

    expect(wrapper.find('SafeMarkdown').at(1).props().markdown).toBe('Who? What?');
  });
});
