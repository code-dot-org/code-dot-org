...
import LtiWelcomeBanner from '@cdo/apps/simpleSignUp/lti/link/LtiLinkAccountPage/LtiWelcomeBanner';
import {LtiProvider} from '@cdo/apps/simpleSignUp/lti/link/LtiLinkAccountPage/types';
