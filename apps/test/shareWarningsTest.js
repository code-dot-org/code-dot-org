...
describe('shareWarnings', function () {
  describe('checkSharedAppWarnings function', function () {
    ...
    describe('options', () => {
      ...
      it('should call the onTooYoung callback if specified, and continue to do so', () => {
        ...
        assert.isTrue(onTooYoung.calledOnce, 'Expected onTooYoung to be called when dialog ' +
                                             'calls handleTooYoung callback');
        ...
        assert.isTrue(onTooYoung.calledTwice, 'Expected onTooYoung to be called immediately ' +
                                              'once user has been marked as too young');
      });
