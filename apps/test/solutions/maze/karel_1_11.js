  ...
  tests: [
    {
      ...
      missingBlocks: [],
      xml: '<xml><block type="when_run"><next><block type="maze_untilBlocked"><statement name="DO"><block type="maze_moveForward"><next><block type="karel_if"><title name="DIR">holePresent</title><statement name="DO"><block type="maze_fill"></block></statement><next><block type="karel_if"><title name="DIR">pilePresent</title><statement name="DO"><block type="maze_dig"></block></statement></block></next></block></next></block></statement></block></next></block></xml>'
    }
  ]
};
