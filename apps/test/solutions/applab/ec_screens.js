  ...
  tests: [
    ...
    },
    {
      ...
      xml:
        ...
        'createCanvas("my_canvas", 320, 446);' +
...

    {
      ...
      runBeforeClick: function (assert) {
        ...
        assert.equal(screenElement.style.backgroundSize, '320px 446px', 'image stretched');

        // make sure dimensions didn't change
        assert.equal(screenElement.style.width, '320px');
        assert.equal(screenElement.style.height, '446px');
