  ...
  tests: [
...

    {
      ...
      levelHtml:
        ...
        'background-image: url(http://studio.code.org.localhost:3000/v3/assets/Adks1c9Ko6WdR2PuwkA6cw/yellow.png); background-color: rgb(26, 188, 156); background-size: 120px 120px;">Button</button>' +
        '<img src="" id="image2" style="height: 100px; width: 100px; position: absolute; left: 20px; top: 20px; margin: 0px;" />' +
        '<img src="/blockly/media/1x1.gif" alt="" id="image3" data-canonical-image-url="" style="height: 100px; width: 100px; position: absolute; left: 30px; top: 155px; margin: 0px;" />' +
        '</div>' +
        '</div>',
      runBeforeClick: function (assert) {
...

    {
      ...
      levelHtml:
        ...
        'background-image: url(http://studio.code.org.localhost:3000/v3/assets/Adks1c9Ko6WdR2PuwkA6cw/phone_purple.png); background-color: rgb(26, 188, 156); background-size: 120px 130px;">Button</button>' +
        '</div>' +
        '</div>',
      runBeforeClick: function (assert) {
        var flappyUrl =
