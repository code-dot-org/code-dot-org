  ...
  tests: [
...

    {
      ...
      runBeforeClick: function(assert) {
        ...
        assert.equal(
          /randomNumber/.test($('.ace_autocomplete').text()),
          true,
          'our autocomplete options contain randomNumber'
        );
        assert.equal(
          /Math.random/.test($('.ace_autocomplete').text()),
          true,
          'our autocomplete options contain Math.random'
        );
        assert.equal(
          /createCanvas/.test($('.ace_autocomplete').text()),
          false,
...

    {
      ...
      runBeforeClick: function(assert) {
        ...
        assert.equal(
          /Math.min/.test($('.ace_autocomplete').text()),
          true,
          'our autocomplete options contain Math.min'
        );
        assert.equal(
          /Math.max/.test($('.ace_autocomplete').text()),
          true,
