 ...
 * which lives at /s/cspunit3/lesson/2/puzzle/3
 */
var levelDefinition = {
  freePlay: true,
  editCode: true,
  ...
  shortInstructions:
    'Draw a square ABOVE and to the RIGHT of the starting location. (Click to show full instructions)',
  calloutJson: '[]',
  aniGifURL:
    '/script_assets/k_1_images/instruction_gifs/csp/U3L02-rightSquare.png',
...
module.exports = {
  ...
  tests: [
    ...
    {
      description:
        "Turn right block doesn't work if executePaletteApisOnly is true",
      editCode: true,
      xml: 'turnRight()',
      delayLoadLevelDefinition: function() {
        return levelDefinition;
      ...
      customValidator: function(assert) {
        ...
        var debugOutput = document.getElementById('debug-output');
        assert(
          debugOutput.textContent.indexOf(errorText) !== -1,
          'Debug output did not contain text "' +
            errorText +
            '":\n' +
    ...
    {
      description:
        'Turn right block does work if executePaletteApisOnly is false',
      editCode: true,
      xml: 'turnRight()',
      delayLoadLevelDefinition: function() {
