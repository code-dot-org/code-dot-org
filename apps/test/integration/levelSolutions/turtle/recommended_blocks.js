...
export default {
  ...
  tests: [
    {
      description:
        'Level With Recommended Blocks: Attempted without required block',
      expected: {
    ...
    {
      description:
        'Level With Recommended Blocks: Completed without recommended block',
      expected: {
    ...
    {
      description:
        'Level With Recommended Blocks: Incomplete and missing recommended block',
      expected: {
