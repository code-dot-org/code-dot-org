...
module.exports = {
  ...
  tests: [
    ...
    },
    {
      ...
      xml:
        '<xml><block type="when_run"><next><block type="draw_move_by_constant"><title name="DIR">moveForward</title><title name="VALUE">100</title></block></next></block></xml>'
    },
    {
