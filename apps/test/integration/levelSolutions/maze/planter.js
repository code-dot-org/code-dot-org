...
var PlanterTerminationValue = require('@cdo/apps/maze/results/planter').TerminationValue;
  ...
  tests: [
    {
      ...
      customValidator: function () {
        return Maze.controller.executionInfo.terminationValue() === PlanterTerminationValue.PLANT_IN_NON_SOIL;
      },
      xml: '<xml>' +
...

    {
      ...
      customValidator: function () {
        return Maze.controller.executionInfo.terminationValue() === PlanterTerminationValue.DID_NOT_PLANT_EVERYWHERE;
      },
      xml: '<xml>' +
         ' <block type="when_run" deletable="false" movable="false">' +
         '   <next>' +
