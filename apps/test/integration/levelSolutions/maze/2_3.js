...
module.exports = {
  ...
  tests: [
    ...
    },
    {
      ...
      xml:
        '<xml><block type="when_run"><next><block type="maze_moveForward" x="70" y="70"></block></next></block></xml>'
    },
    {
      ...
      xml:
        '<xml><block type="when_run"><next><block type="maze_moveForward" x="70" y="70"><next><block type="maze_turn"><title name="DIR">turnLeft</title></block></next></block></next></block></xml>'
    }
  ]
};
