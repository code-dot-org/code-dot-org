...

    {
      ...
      runBeforeClick: function(assert) {
        ...
        tickWrapper.runOnAppTick(Applab, 10, function() {
          ...
          var move1 = testUtils.createMouseEvent(
            'mousemove',
            point1.x,
            point1.y
          );
          var mouseout = testUtils.createMouseEvent(
            'mouseout',
            point1.x,
            point1.y
          );
          var move2 = testUtils.createMouseEvent(
            'mousemove',
            point2.x,
            point2.y
          );
          var move3 = testUtils.createMouseEvent(
            'mousemove',
            point3.x,
            point3.y
          );
          var move4 = testUtils.createMouseEvent(
            'mousemove',
            point4.x,
            point4.y
          );
