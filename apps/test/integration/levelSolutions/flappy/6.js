module.exports = {
  ...
  tests: [
    ...
    },
    {
      ...
      missingBlocks: [{test: 'flap', type: 'flappy_flap_height'}],
      xml:
        '<xml><block type="flappy_whenClick" deletable="false"></block><block type="flappy_whenEnterObstacle" deletable="false"><next><block type="flappy_incrementPlayerScore"></block></next></block><block type="when_run" deletable="false"><next><block type="flappy_setSpeed"><title name="VALUE">Flappy.LevelSpeed.NORMAL</title></block></next></block></xml>'
    }
  ]
};
