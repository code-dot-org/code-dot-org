...
module.exports = {
  ...
  tests: [
    // currently only testing missing blocks
    {
      ...
      missingBlocks: [],
      xml:
        '<xml><block type="flappy_whenClick" deletable="false"><next><block type="flappy_flap"></block></next></block></xml>'
    },
    {
      ...
      missingBlocks: [{test: 'flap', type: 'flappy_flap'}],
      ...
      xml:
        '<xml><block type="flappy_whenClick" deletable="false"></block></xml>'
    }
  ]
};
