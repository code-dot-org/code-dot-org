...
function createWebpackConfig({
  ...
  // These two steps increase the rebuild time by 10x and are not required on dev builds. Exclude
  // these in dev environments, where rebuild is a very common action.
  if (!process.env.DEV) {
        ...
        vendors: {
          ...
          test(module) {
            return [
              ...
              new RegExp(`/apps/node_modules/${libName}/`).test(module.resource)
            );
          },
        },
        p5lab: {
