...
export const SpacerContentfulComponentDefinition: ComponentDefinition = {
  ...
  thumbnailUrl:
    'https://images.ctfassets.net/90t6bu6vlf76/2z5ZAhyRRPCnryQTvCaRek/3862a4b87deb0b8256f8b4a418c64393/component_spacer_thumbnail.png',
  tooltip: {
    description:
      'A simple layout tool for adding fixed space between components or sections, ensuring proper visual separation.',
    imageUrl:
      'https://images.ctfassets.net/90t6bu6vlf76/5qbYpflX1L7cQRx0fh4gRi/0f2b0f64dea3e1f4cabed4f1498e1d34/component_spacer_tooltip.png',
  },
