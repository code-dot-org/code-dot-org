  ...
  return (
    <div className={styles.unsupportedCard}>
      ...
      <Typography variant="body2">
        This activity type runs in the classic Studio runtime and isn’t
        playable in this prototype{reason ? ` (${reason})` : ''}. It keeps its
        place and identity in the lesson. Ask the AI to build an interactive
        version if you want it playable here.
      </Typography>
    </div>
  );
}
