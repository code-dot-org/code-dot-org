...
export const fishLevel = fixtureFactory(LevelPropertiesBaseSchema, {
  ...baseDefaults,
  appName: 'fish',
  type: 'Fish',
});
export const videoLevel = fixtureFactory(LevelPropertiesBaseSchema, {
  ...baseDefaults,
...
// The canonical AI-for-Oceans script structure, shared by the MSW fixture and
// unit tests so the shape is declared once. Mirrors the live
// /api/script_structure/courses/oceans/units/1 response.
export const oceansScriptStructure = {
  id: 446,
  name: 'oceans',
  title: 'AI for Oceans',
  tts: true,
