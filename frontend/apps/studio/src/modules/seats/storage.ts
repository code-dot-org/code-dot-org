...
// ---------------------------------------------------------------------------
// Notebook journey progress (stored inside seat profile journeys map)
// ---------------------------------------------------------------------------

/**
 * Reads the notebook journey progress from a seat's journeys map.
 * @param seatId Seat to read from
 * @returns NotebookProgress or null if absent
 */
...
/**
 * Writes notebook journey progress into a seat's journeys map.
 * Reads the current seat profile, merges the update, and writes back.
 * @param seatId Seat to update
 * @param progress Updated notebook progress
 */
