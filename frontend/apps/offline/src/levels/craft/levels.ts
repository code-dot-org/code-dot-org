...
export interface VerificationAPI {
  ...
  isPlayerAt: (position: Position | [number, number]) => boolean;
  isPlayerNextTo: (entityType: string) => boolean;
  solutionMapMatchesResultMap: (map: string[]) => boolean;
  getCommandExecutedCount: (command: string) => number;
  getRepeatCommandExecutedCount: (command: string) => number;
...
export interface LevelDefinition {
  ...
  timeoutResult?: ((api: VerificationAPI) => boolean) | (() => boolean);
  /** A validation that checks for failure */
  failureCheckFunction?: ((api: VerificationAPI) => boolean) | (() => boolean);
}
...
const levels: {
  ...
  aquatic01: {
    ...
    playerStartDirection: 0,
    verificationFunction: verificationAPI =>
      verificationAPI.isEntityAt('Player', [4, 5]),
  },
  aquatic02: {
    isAquaticLevel: true,
    playerName: 'SteveAquatic',
    ...
    playerStartDirection: 0,
    verificationFunction: verificationAPI =>
      verificationAPI.isEntityAt('Player', [6, 7]),
  },
  aquatic03: {
    isAquaticLevel: true,
    boat: true,
    ...
    playerStartDirection: 0,
    verificationFunction: verificationAPI =>
      verificationAPI.isEntityAt('Player', [5, 1]),
  },
  aquatic04: {
    isAquaticLevel: true,
    boat: true,
  ...
  aquatic05: {
    ...
    playerStartDirection: 1,
    verificationFunction: verificationAPI =>
      verificationAPI.isEntityAt('Player', [6, 5]),
  },
  aquatic06: {
    isAquaticLevel: true,
    boat: true,
    ...
    playerStartDirection: 0,
    verificationFunction: verificationAPI =>
      verificationAPI.isEntityAt('Player', [6, 3]),
  },
  aquatic07: {
    isAquaticLevel: true,
    ocean: 'warm',
    ...
    playerStartDirection: 0,
    verificationFunction: verificationAPI =>
      verificationAPI.isEntityAt('Player', [6, 6]) ||
      verificationAPI.isEntityAt('Player', [7, 7]),
  },
  aquatic08: {
    isAquaticLevel: true,
    ocean: 'warm',
    ...
    playerStartDirection: 0,
    verificationFunction: verificationAPI =>
      verificationAPI.isEntityAt('Player', [5, 7]),
  },
  aquatic08a: {
    isAquaticLevel: true,
    boat: true,
  ...
  aquatic09: {
    ...
    playerStartDirection: 0,
    verificationFunction: verificationAPI =>
      verificationAPI.isEntityAt('Player', [3, 7]),
  },
  aquatic10: {
    isAquaticLevel: true,
    isDaytime: false,
  ...
  designer06: {
    ...
    verificationFunction: verificationAPI => {
      ...
      for (const position of grassPositions) {
        if (verificationAPI.isEntityAt('cow', position)) {
          cowOnGrassCount++;
        }
      }
