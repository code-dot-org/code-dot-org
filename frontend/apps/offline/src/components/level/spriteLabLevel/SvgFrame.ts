...
export default class SvgFrame {
  protected element_: Blockly.BlockSvg | Blockly.WorkspaceSvg;
   ...
   */
  constructor(
    element: Blockly.BlockSvg | Blockly.WorkspaceSvg,
    ...
    this.headerColor = this.getColor() || DEFAULT_HEADER_COLOR;
