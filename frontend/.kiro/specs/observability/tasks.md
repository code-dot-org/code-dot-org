...
- [ ] 1. Scaffold `frontend/packages/observability` package
...
- [ ] 3. Implement `NoopAdapter` in `src/adapters/noop.ts`
  ...
  - [ ]* 3.1 Write property test for `NoopAdapter` (Property 7)
  ...
  - [ ]* 3.2 Write unit tests for `NoopAdapter`
    - All methods callable without error; `isConsented()` returns `false`; `shutdown()` resolves
    - _Requirements: 2.2_
    - _File: `src/__tests__/noop.test.ts`_

- [ ] 4. Implement `createObservabilityClient` factory in `src/factory.ts`
  ...
  - [ ]* 4.1 Write property test for factory — valid providers (Property 1)
  ...
  - [ ]* 4.2 Write property test for factory — unknown provider throws (Property 2)
...
- [ ] 5. Implement `SentryAdapter` in `src/adapters/sentry.ts`
  ...
  - [ ]* 5.1 Write property test for `recordError` forwarding (Property 3)
  ...
  - [ ]* 5.2 Write property test for SDK errors swallowed during `recordError` (Property 4)
  ...
  - [ ]* 5.3 Write property test for consent round-trip (Property 5)
  ...
  - [ ]* 5.4 Write property test for config pass-through to SDK (Property 6)
  ...
  - [ ]* 5.5 Write property test for init failure graceful degradation (Property 8)
  ...
  - [ ]* 5.6 Write unit tests for `SentryAdapter`
...
- [ ] 6. Checkpoint — ensure all observability package tests pass
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 7. Implement the singleton and `_initializeSingleton` in `src/index.ts`
...
- [ ] 8. Implement `observabilityPlugin` in `src/plugin.ts`
  ...
  - [ ]* 8.1 Write unit tests for `observabilityPlugin`
...
- [ ] 9. Update `@code-dot-org/core` — add `CorePlugin` interface and `initializeCore`
...
- [ ] 10. Update `SiteConfig` in `@code-dot-org/core`
...
- [ ] 11. Integrate observability into Code Studio (`frontend/apps/studio`)
...
- [ ] 12. Add `README.md` and `CONTRIBUTING.md` to `frontend/packages/observability`
