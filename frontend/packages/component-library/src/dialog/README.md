...
| body scroll lock                                                  | MUI `ModalManager`                                                                        | Also adds `padding-right` for the scrollbar width.                                                                                          |
...
| `imageUrl` (Dialog)                                               | `<img alt="Dialog">` at 16.25rem × 8.625rem above the title                               | Alt text stays the literal `Dialog`, as before.                                                                                             |
