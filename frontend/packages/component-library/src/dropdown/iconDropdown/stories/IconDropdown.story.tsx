...
export const FullWidthIconDropdown = SingleTemplate.bind({});
FullWidthIconDropdown.args = {
  name: 'full-width-icon-dropdown',
  options: [
    {
      value: 'option-1',
      label: 'Option 1',
  ...
  labelText: 'Full Width Icon Dropdown',
  onChange: () => null,
  size: 'm',
  disabled: false,
  color: dropdownColors.black,
...
export const CustomWidthIconDropdown = SingleTemplate.bind({});
CustomWidthIconDropdown.args = {
  name: 'custom-width-icon-dropdown',
  options: [
    {
      value: 'option-1',
      label: 'Option 1',
  ...
  labelText: 'Custom Width Icon Dropdown (350px)',
  onChange: () => null,
  size: 'm',
  disabled: false,
  color: dropdownColors.black,
