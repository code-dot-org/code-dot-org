// Field-keyed validation messages. Partial so indexed access is
// `string[] | undefined`; the `?.` guards at read sites are load-bearing.
export type FieldErrors = Partial<Record<string, string[]>>;

// The form's save lifecycle as its own pure reducer, testable in isolation; the
// full form reducer holds field values and delegates these transitions.
