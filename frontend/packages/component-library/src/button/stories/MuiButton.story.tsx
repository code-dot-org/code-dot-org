...
export default {
  ...
  argTypes: {
    ...
    // Custom data attributes for theme overrides
    'data-color': {
      control: 'select',
      options: ['purple', 'black', 'gray', 'white', 'destructive'],
      description: 'Custom color for theme overrides.',
      table: {
    ...
    'data-size': {
      control: 'select',
      options: ['xs', 's', 'm', 'l'],
      description: 'Custom size for theme overrides.',
      table: {
        category: 'Custom Attributes',
      },
    },
    'data-type': {
      ...
      description: 'Custom type for theme overrides (used with IconButton).',
      table: {
        category: 'Custom Attributes',
      },
    },
    'data-force-hover': {
      control: 'boolean',
      description: 'Force hover state for testing.',
      table: {
        category: 'Custom Attributes',
      },
    },
