...
const checkButtonPropsForErrors = ({
  ...
  if ((color === 'gray' && type == 'primary') || (color === 'gray' && type === 'tertiary' && !isIconOnly)) {
    throw new Error('Expect type prop to be secondary or tertiary(with isIconOnly prop set to true) when color is gray');
  }
