...
We're using React Testing Library for testing our components. We're aiming to have 100% test coverage for every
component (meaning every prop and functionality should be tested).
