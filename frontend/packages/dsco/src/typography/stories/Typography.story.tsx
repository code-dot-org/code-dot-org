...
//
const headingComponents: TypographyProps[] = [
  {
    semanticTag: 'h1',
...
const bodyTextComponents: TypographyProps[] = [
  {
    semanticTag: 'p',
...
const overlineTextComponents: TypographyProps[] = [
  {
    semanticTag: 'p',
...
const otherTextComponents: TypographyProps[] = [
  {
    semanticTag: 'em',
    visualAppearance: 'em',
