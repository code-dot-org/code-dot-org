        ...
        next: {
          block: {
            ...
            next: {
              block: {
                type: 'maze_turn',
                id: 'S~toDj^DIe!*F5ysj+p5',
                fields: {DIR: '<field name="DIR">turnLeft</field>'},
                next: {
                  block: {
                    type: 'maze_moveForward',
                    id: '77)f;+g+7uVC4#6q?41g',
                    next: {
                      block: {
                        type: 'maze_untilBlockedOrNotClear',
                        id: 'z5NK`MFxtwupxl/uf6w/',
                        fields: {
                          DIR: '<field name="DIR">holePresent</field>',
                        },
                        inputs: {
                          DO: {
                            block: {
                              type: 'maze_fill',
                              id: 'voUV%?~q7myl6)O4#gB8',
                            },
                          },
                        },
                      },
