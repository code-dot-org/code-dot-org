...
export const LEVEL_1_BOUNCE_BLOCKS = {
  blocks: {
    ...
    blocks: [
      {
        type: 'bounce_whenLeft',
        x: 20,
        y: 20,
        next: {block: {type: 'bounce_moveLeft', id: 'moveLeft'}},
      },
    ],
  },
};
...
export const LEVEL_5_BOUNCE_BLOCKS = {
  blocks: {
    ...
    blocks: [
      {
        type: 'bounce_whenPaddleCollided',
        id: 'whenPaddleCollided',
        x: 20,
        y: 20,
        next: {block: {type: 'bounce_bounceBall'}},
      },
    ],
  },
};
