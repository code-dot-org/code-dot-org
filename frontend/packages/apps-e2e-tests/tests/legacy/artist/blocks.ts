...
export const LOSING_ARTIST_BLOCKS =
  '{"blocks":{"languageVersion":0,"blocks":[{"type":"when_run","x":16,"y":16,"next":{"block":{"type":"draw_move_by_constant","fields":{"DIR":"<field name=\\"DIR\\">moveForward</field>","VALUE":"100"},"next":{"block":{"type":"draw_turn_by_constant_restricted","fields":{"DIR":"<field name=\\"DIR\\">turnRight</field>","VALUE":"<field name=\\"VALUE\\">90</field>"}}}}}}]}}';
