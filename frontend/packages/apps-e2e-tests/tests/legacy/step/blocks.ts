...
export const COMPLETE_STEP_BLOCKS =
  '{"blocks":{"languageVersion":0,"blocks":[{"type":"when_run","id":"topBlock","x":16,"y":16,"next":{"block":{"type":"maze_moveForward","id":"startBlock","next":{"block":{"type":"maze_moveForward","id":"moveForward","next":{"block":{"type":"maze_moveForward"}}}}}}}]}}';
