...
| `teacher_tools/course_overview.feature`                            | `tests/legacy/course-overview/course-overview.spec.ts`                         | C+F+W    | all 5 scenarios: signed-out/student/teacher views, student in assigned section, single-unit redirect       |
...
| `platform/header.feature`                                | `tests/legacy/header/header.spec.ts`                               | C+F+W    | 4 scenarios; English and Spanish student/teacher header links                                                           |
