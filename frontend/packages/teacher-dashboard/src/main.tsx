...
// Global style resets that the production Rails page gets from application.css
// (Bootstrap + shared/css). Without these, elements that rely on the global
// reset fall through to raw browser defaults (blue underlined links, etc.).
const styleEl = document.createElement('style');
styleEl.textContent = [
  // Bootstrap anchor reset — production's application.css rule at index 777.
  // The color #0596ce ($link_color from shared/css/color.scss) and hover
  // color #036083 are the Bootstrap overrides that all of Studio inherits.
  'a { color: #0596ce; text-decoration: none; }',
  'a:hover, a:focus { color: #036083; text-decoration: underline; }',
  // Spinner stub keyframes.
