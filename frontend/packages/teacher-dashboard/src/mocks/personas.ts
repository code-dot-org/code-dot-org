...
const DEFAULT_EXTRAS: Persona['extras'] = {
  coteacherInvites: [],
  drawerData: DEFAULT_DRAWER_DATA,
  tourState: [],
...
export const PERSONAS: Record<PersonaTag, Persona> = {
  established: {
    ...
    description:
      '2 active sections with assigned courses, word + picture login, suggested-lesson experiment',
    sections: [
      makeSection({
        id: 101,
  ...
  'rebrand-promo': {
    label: 'Rebrand + Promotions',
    description:
      '1 section, rebrand banner visible, contentful promotions loaded',
    sections: [
      makeSection({
        id: 601,
        name: 'Period 1 - CS Discoveries',
    ...
    courseOfferings: COURSE_OFFERINGS,
    availableParticipantTypes: ['student'],
    flags: {'codeai-rebrand-banner': true},
    experiments: [],
    currentUser: DEFAULT_CURRENT_USER,
    extras: {...DEFAULT_EXTRAS},
  },
  ...
  onboarding: {
    label: 'Onboarding (Demo Section)',
    description:
      'Teacher with demo-section + onboarding, 1 demo section, onboarding checklist visible',
    sections: [
      makeSection({
        id: 901,
        name: 'My CS Fundamentals Practice Class',
        login_type: 'picture',
        code: 'DEMO01',
        studentCount: 3,
        grades: ['3', '4', '5'],
        createdAt: '2026-07-20T09:00:00.000Z',
        demo_type: 'elementary',
        course_id: COURSE.csf.courseId,
        course_offering_id: COURSE.csf.offeringId,
        course_version_id: COURSE.csf.versionId,
        course_display_name: COURSE.csf.displayName,
    ...
    courseOfferings: COURSE_OFFERINGS,
    availableParticipantTypes: ['student'],
    flags: {'onboarding-enabled': true},
    experiments: ['demo-section'],
    currentUser: {
      ...DEFAULT_CURRENT_USER,
      displayName: 'Onboarding Teacher',
      gradesTeaching: ['3', '4', '5'],
    },
    extras: {
      ...DEFAULT_EXTRAS,
      teachingProfileData: {data: {matchedPersona: false}},
      demoPresets: {
        elementary: {
          demo_type: 'elementary',
          section_name: 'My CS Fundamentals Practice Class',
          login_type: 'picture',
          grades: ['K', '1', '2', '3', '4', '5'],
          participant_type: 'student',
          avatar_color: 2,
          ...
          unit_group: {
            name: 'csf-2024',
            display_name: "CS Fundamentals '24-'25",
          },
          unit: {
            name: 'Course A',
            display_name: 'Course A: Sequencing',
          },
          student_snapshot_default_tour_lesson: null,
          review_syllabus_quiz_lesson: null,
          review_syllabus_quiz_options: null,
        },
        middle: {
          demo_type: 'middle',
          section_name: 'My CS Discoveries Practice Class',
          login_type: 'word',
          grades: ['6', '7', '8'],
          participant_type: 'student',
          avatar_color: 5,
          ...
          unit_group: {
            name: 'csd-2024',
            display_name: "CS Discoveries '24-'25",
          },
          unit: {
            name: 'Problem Solving and Computing',
            display_name: 'Problem Solving and Computing',
          },
          student_snapshot_default_tour_lesson: null,
          review_syllabus_quiz_lesson: null,
          review_syllabus_quiz_options: null,
        ...
        high: {
          demo_type: 'high',
          section_name: 'My CS Principles Practice Class',
          login_type: 'email',
          grades: ['9', '10', '11', '12'],
          participant_type: 'student',
          avatar_color: 8,
          ...
          unit_group: {
            name: 'csp-2024',
            display_name: "CS Principles '24-'25",
          },
          unit: {
            name: 'Digital Information',
            display_name: 'Digital Information',
          },
          student_snapshot_default_tour_lesson: null,
          review_syllabus_quiz_lesson: null,
          review_syllabus_quiz_options: null,
  ...
  'verification-needed': {
    ...
    description:
      '1 section, AI chat disabled, essential AI dependency assigned, verification alert visible',
    sections: [
      makeSection({
        id: 701,
        name: 'Period 2 - CS Principles',
        login_type: 'email',
        code: 'VERIFY',
        studentCount: 22,
        grades: ['10'],
    ...
    extras: {
      ...DEFAULT_EXTRAS,
      essentialAiDependency: {has_assigned_essential_ai_dependency: true},
    },
  },

  'drawer-prompts': {
    label: 'Drawer Prompts',
    description:
      '1 section, school info confirmation + AFE eligible drawers triggered',
    sections: [
      makeSection({
        id: 801,
        name: 'Period 1 - CS Fundamentals',
        login_type: 'word',
        code: 'DRAWER',
        studentCount: 16,
        grades: ['3'],
    ...
    extras: {
      ...
      drawerData: {
        showSchoolInfoInterstitial: false,
        showSchoolInfoConfirmation: true,
        existingSchoolInfo: {
          country: 'US',
