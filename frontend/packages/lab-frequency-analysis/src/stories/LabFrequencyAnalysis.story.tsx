...
export const CaesarMode = SingleTemplate.bind({});
CaesarMode.args = {
  levelData: {
    subData: {
      mode: 'caesar',
...
export const CaesarMultiMessageMode = SingleTemplate.bind({});
CaesarMultiMessageMode.args = {
  levelData: {
    subData: {
      mode: 'caesar',
      messages: [
...
export const SubstitutionMode = SingleTemplate.bind({});
SubstitutionMode.args = {
  levelData: {
    subData: {
      mode: 'substitution',
      messages: [
...
export const SubstitutionMultiMessageMode = SingleTemplate.bind({});
SubstitutionMultiMessageMode.args = {
  levelData: {
    subData: {
      mode: 'substitution',
      messages: [
