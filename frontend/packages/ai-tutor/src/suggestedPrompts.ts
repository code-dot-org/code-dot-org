/**
 * Canned prompts shown as chips above the chat input. Ported verbatim from
 * `apps/src/aiTutor/suggestedPrompts.ts`. Three sets keyed to the surrounding
 * context — pick the one(s) that fit and pass them to `<AiTutorChat>`.
 */

import type {AiTutorSuggestedPrompt} from './types';
