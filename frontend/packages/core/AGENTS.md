...
- **[docs/architecture.md](./docs/architecture.md)** — Update when changing:
  ...
  - `initializeCore` boot behavior or `window.__CODE_STUDIO__` contract
...
- **[README.md](./README.md)** — Update when changing:
  ...
  - The `./api`, `./plugins/localization`, `./plugins/observability`, `./plugins/consent`, `./plugins/analytics`, or `./plugins/experiments` sub-path export surface
