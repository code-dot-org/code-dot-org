...
export const SelectedSectionSchema = z
  .object({
    ...
    script: SelectedUnitSchema,
    course: SectionCourseSchema,
    any_student_has_progress: z.boolean(),
    is_assigned_single_unit_course: z.boolean().nullable(),
    primaryInstructor: SectionPrimaryInstructorSchema,
...
export const ConciseSectionSchema = z
  .object({
    ...
    code_review_expires_at: z.string().nullable(),
    is_assigned_csa: z.boolean(),
    participant_type: z.string(),
    sectionInstructors: z.array(SectionInstructorSchema),
