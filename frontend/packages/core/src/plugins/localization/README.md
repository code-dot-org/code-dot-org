...
Available as `@code-dot-org/core/plugins/localization`. Register `localizationPlugin` at bootstrap:
...
import {localization, useLocalization} from '@code-dot-org/core/plugins/localization';
