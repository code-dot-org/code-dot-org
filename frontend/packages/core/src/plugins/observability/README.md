...
`@code-dot-org/core/plugins/observability` subpath.

## Key Exports

| Import path                                | Contents                                                                                                                                                            |
| ------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `@code-dot-org/core/plugins/observability` | `observabilityPlugin`, module-level API (`logger`, `metrics`, `recordError`, `init`, `setConsented`, `isConsented`, `shutdown`), `createObservabilityClient`, types |
...
```typescript
import {recordError} from '@code-dot-org/core/plugins/observability';
...
```typescript
import {createObservabilityClient} from '@code-dot-org/core/plugins/observability';
