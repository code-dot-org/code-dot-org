export const load: (assetUrl: (path: string) => string) => {
  [key: string]: string;
} = assetUrl => ({
  ...
  flowerPurpleMenu: assetUrl('media/common_images/flower-purple-menuicon.png'),
  flowerYellowLine: assetUrl('media/common_images/flower-yellow.png'),
  flowerYellowMenu: assetUrl('media/common_images/flower-yellow-menuicon.png'),
