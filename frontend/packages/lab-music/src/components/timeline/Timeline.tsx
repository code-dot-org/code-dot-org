...
import {predictLevelActions} from '@code-dot-org/lab-base/redux';
...
// Actions we are making on the predict level state
const {isPredictResponseSubmitted} = predictLevelActions;
