...
//
// See `../cssAssetNames` for what goes wrong without it, and why a package's
// own dev harness cannot catch it.
...
describe('stripModuleFromCssName', () => {
  it('renames an emitted CSS module to a plain stylesheet', () => {
    expect(nameFor('components/panel.module.css')).toBe('components/panel.css');
  });
