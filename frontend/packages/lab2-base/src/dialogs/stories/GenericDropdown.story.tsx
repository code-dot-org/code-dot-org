...
import {DialogControlProvider} from '@lab2-base/contexts';
import {DialogViews, GenericDropdown, GenericDropdownProps} from '@lab2-base/dialogs';

export default {
  title: 'Lab2/Base/Dialogs/GenericDropdown',
