...
import {AppProvider, useApp} from '@lab2-base/contexts';
import {StartOverDialog, StartOverDialogProps} from '@lab2-base/dialogs';

export default {
  title: 'Lab2/Base/Dialogs/StartOverDialog',
