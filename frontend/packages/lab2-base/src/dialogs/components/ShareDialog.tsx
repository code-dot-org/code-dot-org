...
import {TEACHER_FEEDBACK_LINK, STUDENT_FEEDBACK_LINK, ProjectSubmissionStatus} from '@lab2-base/constants';
import {useShare} from '@lab2-base/contexts';
import {ProjectType} from '@lab2-base/types';
