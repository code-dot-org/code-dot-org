import type {ResponseValidator, BlocklySource, MultiFileSource, ProjectSources} from '@code-dot-org/projects';
import {ValidationError} from '@code-dot-org/projects';
...
export const SourceResponseValidator: ResponseValidator<
  ProjectSources
> = response => {
  const appName = 'pythonlab'; //Lab2Registry.getInstance().getAppName();
