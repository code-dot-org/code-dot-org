...
/**
 * The ui-test-all-the-levels level backing these tests: lesson "Sketch Lab" position 54,
 * level "UI Test allthethings sketchlab 1", seeded with no start_sources so the canvas
 * is empty on load.
 */
