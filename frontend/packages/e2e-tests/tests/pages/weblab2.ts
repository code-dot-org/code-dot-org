...
/**
 * The ui-test-all-the-levels level backing these tests: lesson "Web Lab 2" position 51,
 ...
 * "UI Test Allthethings Weblab2 11.level"). hideProductTours suppresses the onboarding
