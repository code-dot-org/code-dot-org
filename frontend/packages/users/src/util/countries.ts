// Country list for the school-information modal. Mirrors the COUNTRIES table in
// apps/src/geographyConstants.js; keep the two in sync.
...
export const COUNTRIES_US_FIRST: SchoolOption[] = [
  ...
  ...OTHER_COUNTRIES.map(([value, text]) => ({value, text})),
];
