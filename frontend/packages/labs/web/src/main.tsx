...
async function enableMocks() {
  ...
  const {SIGNED_IN_STUDENT} = await import('./fixtures/signedInUser');
  ...
  // default — rather than by writing a user into redux, which nothing in
  // `frontend/` populates from the server anyway.
  registerMockFixture({
    method: 'get',
