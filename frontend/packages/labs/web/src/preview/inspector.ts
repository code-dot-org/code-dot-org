// Element inspector for the Web Lab page preview. Ported from
// apps/src/weblab2/htmlPreview/htmlPreviewInspector.ts.
//
// This runs on the PREVIEW ORIGIN, installed by previewPage against the inner
// iframe's document (same origin as the preview page, cross-origin to the lab).
// The lab only toggles it on and off, by postMessage.
//
...
import {HIGHLIGHT_STYLE, LABEL_STYLE, SR_ONLY_STYLE} from './inspectorStyles';
import {
  asElement,
