// Pure, stateless helpers and constants for the element inspector. Ported from
// apps/src/weblab2/htmlPreview/htmlPreviewInspectorUtils.ts.

// These run in the preview page's realm but operate on the inner iframe's
