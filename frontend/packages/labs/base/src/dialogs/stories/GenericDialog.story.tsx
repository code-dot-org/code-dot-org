...
import {GenericDialog, GenericDialogProps} from '@code-dot-org/lab-base/dialogs';
import Markdown from '@code-dot-org/markdown';

export default {
  title: 'Labs/Base/Dialogs/GenericDialog',
...
// TEMPLATE
//
const Template: StoryFn<WrapperProps & GenericDialogProps> = ({
  theme,
  ...args
}) => (
  <div style={{
