// Re-exported so `@code-dot-org/lab/contexts` and the host shell can name the
// level-properties map without reaching into core/api directly (upstream's
// types.ts declared it here).
