...
const SettingsPanel = ({settings, closePanel}: SettingsPanelProps) => {
  ...
  useEffect(() => {
    ...
    localization.on('change', onLocaleChange);
    ...
    return () => {
      localization.off('change', onLocaleChange);
    };
  }, [onLocaleChange]);

  const handleLanguageChange = (event: ChangeEvent<HTMLSelectElement>) => {
    sendLabAnalyticsEvent('Resource Panel Language Change', {
  ...
  const handleSettingChange = (
    ...
    sendLabAnalyticsEvent('Resource Panel Settings Change', {
