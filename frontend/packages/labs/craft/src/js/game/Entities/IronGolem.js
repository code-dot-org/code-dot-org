...
export default class IronGolem extends BaseEntity {
    ...
    prepareSprite() {
        ...
        this.sprite = this.controller.levelView.createSprite(actionGroup, 0, 0, 'ironGolem', 'Iron_Golem_Anims001.png');
        ...
        for (var i = 0; i < 4; i++) {
            ...
            this.addAnimation("hurt" + facingName, frameList, frameRate * 2 / 3, false, () => {
                this.controller.levelView.playScaledSpeed(this.sprite, "idle" + this.controller.levelView.getDirectionName(this.facing));
            });
            // die
            frameList = generateFrameNames(frameName, frameListPerDirection[i][8][0], frameListPerDirection[i][8][1], ".png", 3);
            this.addAnimation("die" + facingName, frameList, frameRate * 2 / 3, false);
            // bump
