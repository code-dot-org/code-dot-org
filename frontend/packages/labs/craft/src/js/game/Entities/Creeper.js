...
export default class Creeper extends BaseEntity {
    ...
    prepareSprite() {
        ...
        this.sprite = this.controller.levelView.createSprite(actionGroup, 0, 0, 'creeper', 'ShadowCreeper_2016_000.png');
        // for normal sheep
        ...
        for (var i = 0; i < 4; i++) {
            ...
            this.addAnimation("lookDown" + facingName, frameList, frameRate, false, () => {
                this.controller.levelView.playScaledSpeed(this.sprite, "lookDown_2" + this.controller.levelView.getDirectionName(this.facing));
            });

            frameList = generateFrameNames(frameName, frameListPerDirection[i][4][1], frameListPerDirection[i][4][0], ".png", 3);
            this.addAnimation("lookDown_2" + facingName, frameList, frameRate, false, () => {
                this.controller.levelView.playScaledSpeed(this.sprite, "idle" + this.controller.levelView.getDirectionName(this.facing));
            });
            // walk
            ...
            this.addAnimation("explode" + facingName, frameList, frameRate, false, () => {
                this.controller.levelView.playScaledSpeed(this.sprite, "idle" + this.controller.levelView.getDirectionName(this.facing));
            });
            // take damage
            ...
            // die
            frameList = generateFrameNames(frameName, frameListPerDirection[i][9][0], frameListPerDirection[i][9][1], ".png", 3);
