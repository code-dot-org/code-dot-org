 ...
 * re-runs the visual projects 5x against them, cleans tmp dir on exit.
 * VISUAL_PROVIDER=playwright registers the visual-* projects and selects
 * the native PW screenshot backend in fixtures/visual/index.ts.
 */
