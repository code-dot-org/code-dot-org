...
/** Props for the OceansActivity React component. */
export interface OceansActivityProps {
...
/**
 * OceansActivity mounts the AI for Oceans activity into two canvas elements and
 ...
 *
 * This is the raw, provider-free activity. The package's default export
 * (`OceansLab`) wraps it in the base `<Lab>` shell and sources its config from
 * level properties; the standalone dev harness uses this component directly.
 */
export default function OceansActivity({
