  ...
  render() {
    return <div><Row>
      <Col xs={12}>
        ...
        <p>
          Show a rock, and click Train to take photos, so the machine learning algorithm can “learn” how to recognize a
          rock.
        </p>
      </Col>
    </Row>
      ...
      <Col xs={12}>
        {
          this.props.trainingImages.map((image, i) => {
            return <img className="thumbnail" style={{display: 'inline-block'}} key={i} src={image} width={40} height={40}/>;
          })
        }
      </Col>
    </Row>
