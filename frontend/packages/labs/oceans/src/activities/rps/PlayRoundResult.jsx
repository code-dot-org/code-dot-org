...
module.exports = class PlayRound extends React.Component {
  ...
  render() {
    return <div>
      ...
      <Row>
        <Col sm={6}>
          <Button className="pull-right" onClick={this.props.onPlayAgain}>Play Again</Button>
        </Col>
        <Col sm={6}>
          <Button className="pull-left" onClick={this.props.onTrainMore}>Train More</Button>
        </Col>
      </Row>
