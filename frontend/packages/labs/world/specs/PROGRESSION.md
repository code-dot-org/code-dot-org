...
| `making/behavior` | A Fish and a Bird, both bobbing, and the bob written out twice.                           | Shared work without the ceremony of a rule.                                                          | `define behavior`           | `[o]` two kinds of actor run one behavior                           |
