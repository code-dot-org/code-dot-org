...
import {getDisplayNotes, integers, getNoteColorInfo} from '../../utils/Tunes';
...
const InstrumentGrid = ({
  ...
  const setInstrument = useCallback(
    ...
    [setIsLoading, setCurrentValue, currentValue],
  );
    ...
    <FocusLock>
      <div className={styles.container} data-theme="Dark">
        ...
        <EaseIntoView
          ...
          focusableChildrenRef={focusableRefs}
        >
