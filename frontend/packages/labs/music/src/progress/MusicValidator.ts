...
import type {Condition, ConditionType} from '@code-dot-org/lab-classic';
...
import type {PlayingTrigger} from '../player/interfaces/PlayingTrigger';
import type {SoundEvent} from '../player/interfaces/SoundEvent';
import {isSoundEvent} from '../player/interfaces/SoundEvent';
import MusicPlayer from '../player/MusicPlayer';
import type {ExemplarValidationMode} from '../types';
...
export default class MusicValidator extends Validator {
  ...
  constructor(
    ...
    getExemplarPlaybackEvents: () => PlaybackEvent[],
    getValidationTimeout: () => number,
    player: MusicPlayer,
    getPlayingTriggers: () => PlayingTrigger[],
    getExemplarValidationMode: () => ExemplarValidationMode,
    ...
    this.getPlaybackEvents = getPlaybackEvents;
    this.getExemplarPlaybackEvents = getExemplarPlaybackEvents;
    this.getValidationTimeout = getValidationTimeout;
    this.player = player;
    this.getPlayingTriggers = getPlayingTriggers;
    this.getExemplarValidationMode = getExemplarValidationMode;
