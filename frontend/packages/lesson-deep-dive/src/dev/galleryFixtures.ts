...
// A GET /challenge_responses list row: summarize() without include_feedback.
...
// evaluation is what EvaluateChallengeResponseJob would have written.
...
export const FIXTURE_RESPONSES: FixtureResponse[] = [
  ...
  },
  {
    ...
    // Submitted last; the evaluation job has not run on it yet.
    evaluation: null,
    evaluatedAt: null,
  },
  {
