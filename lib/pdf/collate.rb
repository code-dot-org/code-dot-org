...
module PDF
  ...
  # also was inconsistent between what machine the PDF was generated on.  This method
  # regenerates the PDF using ghostscript to fix the missing font issue. In the future
  # we should consider generating PDFs with ghostscript instead of puppeteer.
