...
class I18nSmartTranslateTest < Minitest::Test
  def test_get_valid_separator
    test_strings = I18nSmartTranslate::SEPARATORS.map do |separator|
      "some#{separator}string"
    end

    # will return a separator not in the original string
    test_strings.each do |test_string|
      separator = I18nSmartTranslate.get_valid_separator test_string
    ...
    assert_nil I18nSmartTranslate.get_valid_separator all_test_string
  end
  ...
  def test_get_smart_translate_options
    ...
    smart_options = I18nSmartTranslate.get_smart_translate_options(locale, key, scope_options)
    ...
    smart_options = I18nSmartTranslate.get_smart_translate_options(locale, key)
