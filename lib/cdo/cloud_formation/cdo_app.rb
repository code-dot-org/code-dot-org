...
module Cdo::CloudFormation
  ...
  class CdoApp < StackTemplate
    ...
    # Use Ubuntu 20 (ubuntu/images/hvm-ssd/ubuntu-focal-20.04-amd64-server-20230517) for our main build pipeline: staging, test, and production
    ...
    IMAGE_ID = ENV['IMAGE_ID'] || (rack_env?(:staging, :test, :production) ? 'ami-0261755bbcb8c4a84' : 'ami-07d0cf3af28718ef8')
