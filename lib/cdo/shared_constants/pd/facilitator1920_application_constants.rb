module Pd
  module Facilitator1920ApplicationConstants
    ...
    CSV_LABELS = {
      ...
      notes: 'Notes',
      title: PAGE_LABELS[:section_1_about_you][:title],
      first_name: PAGE_LABELS[:section_1_about_you][:first_name],
      last_name: PAGE_LABELS[:section_1_about_you][:last_name],
      account_email: PAGE_LABELS[:section_1_about_you][:account_email],
      alternate_email: PAGE_LABELS[:section_1_about_you][:alternate_email],
      phone: PAGE_LABELS[:section_1_about_you][:phone],
      address: PAGE_LABELS[:section_1_about_you][:address],
      city: PAGE_LABELS[:section_1_about_you][:city],
      state: PAGE_LABELS[:section_1_about_you][:state],
      zip_code: PAGE_LABELS[:section_1_about_you][:zip_code],
      gender_identity: PAGE_LABELS[:section_1_about_you][:gender_identity],
      race: PAGE_LABELS[:section_1_about_you][:race],
      ...
      # 'Assigned FiT Weekend',
      # 'Registered FiT Weekend?',
      ...
      csf_summit_requirement: '[CSF only] Can you commit to attending the 2019 Facilitator Summit (May 17 - 19, 2019)?',
      csf_workshop_requirement: '[CSF only] Can you commit to facilitating a minimum of 4-6 one-day workshops starting summer 2019 and continuing throughout the 2019-2020 school year?',
      csf_community_requirement: '[CSF only] Can you commit to attending monthly webinars, or watching recordings, and staying up to date through bi-weekly newsletters and online facilitator communities?',
      # 'Please indicate which workshops you are able to attend.',
      # csd_csp_partner_with_summer_workshop: - not shown to everyone!
      # csd_csp_which_summer_workshop not shown to everyone!
      csd_csp_fit_weekend_requirement: '[CSD or CSP only] Can you commit to attending one 3-day 2019 Facilitator-in-Training Event (during the week of July 22 - 26 or August 5 - 9)? ',
      csd_csp_which_fit_weekend: 'Please indicate which FiT Workshop you are able to attend.',
      csd_csp_workshop_requirement: '[CSD or CSP only] Can you commit to leading 2019-20 academic year workshops hosted by your assigned Regional Partner (generally four days across the academic year)?',
      csd_training_requirement: '[CSD only] Can you commit to attending one 2- or 3-day training in the spring of 2020 to prepare to co-lead five-day summer workshops?',
      csp_training_requirement: '[CSP only] Can you commit to attending two 2- or 3-day trainings in the spring of 2020 to prepare to co-lead five-day summer workshops?',
      csd_csp_lead_summer_workshop_requirement: '[CSD or CSP only] Can you commit to leading a 5-day summer workshop in the summer of 2020 hosted by your assigned Regional Partner?',
      csd_csp_deeper_learning_requirement: '[CSD or CSP only] Can you commit to engaging in the Deeper Learning Program, a series of written reflections and peer reviews for each unit of the curriculum throughout the year?',
      ...
      why_should_all_have_access: 'Code.org’s Professional Learning Programs are open to all teachers, regardless of their experience with CS education. Why do you think Code.org believes that all teachers should have access to the opportunity to teach CS?',
      skills_areas_to_improve: 'Please describe a workshop you’ve led (or a lesson you’ve taught, if you haven’t facilitated a workshop). Include a brief description  of the workshop/lesson topic and audience (one or two sentences). Then describe two strengths you demonstrated, as well as two facilitation skills you would like to improve.',
      inquiry_based_learning: "Code.org Professional Learning experiences incorporate inquiry-based learning into the workshops. Please briefly define  inquiry-based learning as you understand it (one or two sentences). Then, if you have led an inquiry-based activity for students, provide a concrete example of an inquiry-based lesson or activity you led. If you have not led an inquiry-based lesson, please write 'N/A.'",
