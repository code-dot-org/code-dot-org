  ...
  module FacilitatorCommonApplicationConstants
    ...
    BASE_PAGE_LABELS = {
      ...
      section_3_experience_and_commitments: {
        ...
        csd_training_requirement: 'Can you commit to attending one 5-day training in the spring of 2020 to prepare to co-lead five-day summer workshops?',
        csp_training_requirement: 'Can you commit to attending __two__ 5-day trainings in the spring of 2020 to prepare to co-lead five-day summer workshops?',
