module ActivityConstants
  ...
  PHASES = {
      ...
      4 => {id: 4, short_name: 'Phase 3A', long_name: 'Phase 3A'},
      5 => {id: 5, short_name: 'Phase 3B', long_name: 'Phase 3B'},
      6 => {id: 6, short_name: 'Phase 3C', long_name: 'Phase 3C'},
      7 => {id: 7, short_name: 'Phase 3D', long_name: 'Phase 3D'},
