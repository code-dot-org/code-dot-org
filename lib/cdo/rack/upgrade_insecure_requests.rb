      ...
      super(env).tap do |_, headers, _|
        ...
        if ssl?(env)
          ...
          policies += [
            ...
            "img-src 'self' https: data: blob: https://javabuilderbeta-output.dev-code.org",
            ...
            "media-src 'self' https: data: http://vaas.acapela-group.com https://javabuilderbeta-output.dev-code.org",
