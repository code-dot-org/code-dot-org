...
def run_tests_if_changed(project, &block)
  GitUtils.run_if_project_affected(project, 'Starting tests.', 'Skipping tests.', &block)
end
...
namespace :test do
  ...
  namespace :changed do
    ...
    task :code_studio do
      run_tests_if_changed(:code_studio) do
        TestRunUtils.run_code_studio_tests
      end
    end
    ...
    task :blockly_core do
      run_tests_if_changed(:blockly_core) do
        TestRunUtils.run_blockly_core_tests
      end
    end
    ...
    task :dashboard do
      run_tests_if_changed(:dashboard) do
        TestRunUtils.run_dashboard_tests
      end
    end
    ...
    task :pegasus do
      run_tests_if_changed(:pegasus) do
        TestRunUtils.run_pegasus_tests
      end
    end
    ...
    task :shared do
      run_tests_if_changed(:shared) do
        TestRunUtils.run_shared_tests
      end
    end
