...
def start_sauce_connect
  RakeUtils.system_stream_output 'wget https://s3.amazonaws.com/cdo-circle-utils/sc-4.4.5-linux.tar.gz'
  RakeUtils.system_stream_output 'tar -xzf sc-4.4.5-linux.tar.gz'
