  ...
  task :run_ui_tests, [:force_tests_commit_tag] do |_, args|
    ...
    if GitUtils.circle_commit_contains?(run_ui_tests_tag)
      ...
      Dir.chdir('dashboard/test/ui') do
        RakeUtils.system_stream_output 'bundle exec ./runner.rb -c ChromeLatestWin7 -p localhost.code.org:3000 -d localhost.studio.code.org:3000 --circle --parallel 50 --magic_retry --html'
      end
    else
