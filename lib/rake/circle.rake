...
def start_sauce_connect
  RakeUtils.system_stream_output 'wget https://saucelabs.com/downloads/sc-4.4.7-linux.tar.gz'
  RakeUtils.system_stream_output 'tar -xzf sc-4.4.7-linux.tar.gz'
  Dir.chdir(Dir.glob('sc-4.4.7-linux')[0]) do
