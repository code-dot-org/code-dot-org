...
def start_sauce_connect
  RakeUtils.system_stream_output 'wget https://s3.amazonaws.com/cdo-circle-utils/sc-build-3550-linux.tar.gz'
  RakeUtils.system_stream_output 'tar -xzf sc-build-3550-linux.tar.gz'
  Dir.chdir(Dir.glob('sc-build-3550')[0]) do
