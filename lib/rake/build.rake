  ...
  task dashboard: :package do
    Dir.chdir(dashboard_dir) do
        ...
        unless rack_env?(:production)
          ...
          if GitUtils.file_changed_from_git?(schema_cache_file)
            ...
            if rack_env?(:staging)
              ...
              raise 'Unexpected database schema difference between staging and test (https://docs.google.com/document/d/114KxAdupbPKdhrMTX8DAEhD42Z12Gb95iGorF8Ysp28/edit)'
            end
          end
        end
      ...
      if CDO.optimize_rails_assets
        ...
        ChatClient.log 'Clobbering <b>dashboard</b> assets...'
