...
# NOTE: Temporarily commenting this check because the dump is consistently generating
# non-matching files that are functionally equivalent.
...
if GitUtils.file_changed_from_git?(schema_cache_file) && rack_env?(:staging)
