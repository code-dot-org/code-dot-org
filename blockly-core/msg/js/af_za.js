goog.provide('Blockly.Msg.af_za');
goog.require('Blockly.Msg');
Blockly.Msg.ADD_COMMENT = "Voeg kommentaar by";
Blockly.Msg.CHANGE_VALUE_TITLE = "Verander die waarde:";
Blockly.Msg.COLLAPSE_ALL = "Verklein blokke";
...
Blockly.Msg.COLOUR_BLEND_TITLE = "meng";
Blockly.Msg.COLOUR_BLEND_TOOLTIP = "Meng twee kleure saam met die gegewe verhouding (0.0 - 1.0).";
Blockly.Msg.COLOUR_PICKER_HELPURL = "http://en.wikipedia.org/wiki/Color";
Blockly.Msg.COLOUR_PICKER_TOOLTIP = "Kies 'n kleur uit die palet.";
Blockly.Msg.COLOUR_RANDOM_HELPURL = "http://randomcolour.com";
Blockly.Msg.COLOUR_RANDOM_TITLE = "ewekansige kleur";
Blockly.Msg.COLOUR_RANDOM_TOOLTIP = "Kies 'n kleur na willekeurig.";
Blockly.Msg.COLOUR_RGB_BLUE = "blou";
Blockly.Msg.COLOUR_RGB_GREEN = "groen";
Blockly.Msg.COLOUR_RGB_HELPURL = "http://www.december.com/html/spec/colorper.html";
Blockly.Msg.COLOUR_RGB_RED = "rooi";
Blockly.Msg.COLOUR_RGB_TITLE = "verkleur met";
Blockly.Msg.COLOUR_RGB_TOOLTIP = "Skep 'n kleur met 'n spesifieke hoeveelheid rooi, groen en blou. Alle waardes moet tussen 0 en 100 wees.";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_HELPURL = "https://code.google.com/p/blockly/wiki/Loops#Loop_Termination_Blocks";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_OPERATOR_BREAK = "breek uit 'n lus";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_OPERATOR_CONTINUE = "beweeg aan na die volgende lus toe";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_BREAK = "Breek uit die bevattende (buite) lus.";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_CONTINUE = "Slaan die res van hierdie lus na, en gaan voort met die volgende iterasie.";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_WARNING = "Waarskuwing: Die blok mag net gebruik work binne in 'n lus.";
Blockly.Msg.CONTROLS_FOREACH_HELPURL = "https://code.google.com/p/blockly/wiki/Loops#for_each";
Blockly.Msg.CONTROLS_FOREACH_INPUT_INLIST = "in die lys";
Blockly.Msg.CONTROLS_FOREACH_INPUT_INLIST_TAIL = "";
Blockly.Msg.CONTROLS_FOREACH_INPUT_ITEM = "vir elke item";
Blockly.Msg.CONTROLS_FOREACH_TOOLTIP = "Vir elke item in die lys, stel die waarde van die veranderlike '%1' gelyk aan die item en voer dan 'n paar stellings uit.";
Blockly.Msg.CONTROLS_FOR_HELPURL = "https://code.google.com/p/blockly/wiki/Loops#count_with";
Blockly.Msg.CONTROLS_FOR_INPUT_FROM_TO_BY = "vanaf %1 tot %2 met %3; vanaf %1 tot %2 stap %3";
Blockly.Msg.CONTROLS_FOR_INPUT_WITH = "tel met";
Blockly.Msg.CONTROLS_FOR_TOOLTIP = "Laat die veranderlike %1 die waardes aanvat, vanaf die begin-waarde tot en met die eind-waarde. Tel dan vir elke iterasie, by die veranderlike, die spesifieke interval waarde. Doen ook die gespesifiseerde blokke vir elke iterasie.";
Blockly.Msg.CONTROLS_IF_ELSEIF_TOOLTIP = "Voeg 'n voorwaarde aan die indien blok.";
Blockly.Msg.CONTROLS_IF_ELSE_TOOLTIP = "Voeg n finaal, vang-alle kondisie aan die indien blok.";
Blockly.Msg.CONTROLS_IF_HELPURL = "http://code.google.com/p/blockly/wiki/If_Then";
Blockly.Msg.CONTROLS_IF_IF_TOOLTIP = "Voeg by, verwyder of hêr-rangskik afdelings om die indien blok te verbeter.";
Blockly.Msg.CONTROLS_IF_MSG_ELSE = "of";
Blockly.Msg.CONTROLS_IF_MSG_ELSEIF = "anders";
Blockly.Msg.CONTROLS_IF_MSG_IF = "indien";
Blockly.Msg.CONTROLS_IF_TOOLTIP_1 = "Indien a waarde waar is, doen dan die stellings.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_2 = "Indien 'n waarde waar is, doen dan die eerste blok stellings, anderste doen die tweede blok stellings.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_3 = "Indien die eerste waarde waar is, doen daan die eerste blok stellings, anderste indien die tweede waarde waar is doen dan die tweede blok stellings.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_4 = "Indien die eerste waarde waar is, doen dan die eerste blok stellings. As die tweede waarde waar is, doen dan die tweede blok stellings. Indien geen waardes waar is nie, doen dan die laaste blok stellings.";
Blockly.Msg.CONTROLS_REPEAT_HELPURL = "http://en.wikipedia.org/wiki/For_loop";
Blockly.Msg.CONTROLS_REPEAT_INPUT_DO = "doen";
Blockly.Msg.CONTROLS_REPEAT_TITLE = "herhaal %1 kere";
...
Blockly.Msg.CONTROLS_WHILEUNTIL_OPERATOR_WHILE = "herhaal terwyl";
...
Blockly.Msg.LISTS_CREATE_WITH_CONTAINER_TITLE_ADD = "lys";
...
Blockly.Msg.LISTS_GET_INDEX_REMOVE = "verwyder";
...
Blockly.Msg.LISTS_INLIST = "in die lys";
