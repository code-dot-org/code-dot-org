...
Blockly.Msg.CONTROLS_WHILEUNTIL_OPERATOR_UNTIL = "πάρε";
...
Blockly.Msg.MATH_ONLIST_OPERATOR_MAX = "μέγιστος της λίστας";
Blockly.Msg.MATH_ONLIST_OPERATOR_MEDIAN = "διάμεσος της λίστας";
Blockly.Msg.MATH_ONLIST_OPERATOR_MIN = "ελάχιστος  της λίστας";
Blockly.Msg.MATH_ONLIST_OPERATOR_MODE = "τα πιο συχνά στοιχεία λίστας";
...
Blockly.Msg.MATH_ONLIST_TOOLTIP_MODE = "Επιστρέφει μια λίστα με το πιο συχνό στοιχείο(α) στη λίστα.";
...
Blockly.Msg.PROCEDURES_CALLRETURN_TOOLTIP = "Εκτέλεσε την συνάρτηση '%1'  που έχει οριστεί από τον χρήστη και χρησιμοποίησε ό,τι αυτή εξάγει.";
