...
Blockly.Msg.CONFIRM_DELETE_FUNCTION_MESSAGE = "Attention ! Êtes-vous sûr de vouloir supprimer %1 ?";
Blockly.Msg.CONTRACT_EDITOR_HEADER = "Recette de conception";
...
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_CONTINUE = "Passer le reste de cette boucle et poursuivre avec l’itération suivante.";
...
Blockly.Msg.DEFINE_FUNCTION_FOR_EXAMPLE = "Définis la fonction ci-dessous et réessaie.";
Blockly.Msg.DELETE = "Supprimer";
Blockly.Msg.DELETE_BLOCK = "Supprimer le bloc";
Blockly.Msg.DELETE_PARAMETER = "Supprimer paramètre...";
Blockly.Msg.DELETE_PARAMETER_TITLE = "Ceci supprimera toutes les occurrences de paramètre «%1 ». Es-tu sûr?";
...
Blockly.Msg.EXAMPLE_DESCRIPTION = "Définit un exemple avec un comportement prévisible et actuel";
...
Blockly.Msg.FUNCTION_DESCRIPTION_LABEL = "Qu'est-ce que ta fonction est censée faire?";
Blockly.Msg.FUNCTION_PARAMETERS_LABEL = "Quels paramètres ta fonction prend-elle ?";
...
Blockly.Msg.FUNCTIONAL_TYPE_LABEL = "Choisis le type de...";
...
Blockly.Msg.FUNCTIONAL_VARIABLE_CREATE = "Crée une variable";
...
Blockly.Msg.LOGIC_NULL_TOOLTIP = "Retourne une valeur invalide.";
...
Blockly.Msg.MATH_SINGLE_TOOLTIP_LN = "Renvoyer le logarithme naturel d’un nombre.";
Blockly.Msg.MATH_SINGLE_TOOLTIP_LOG10 = "Renvoyer le logarithme base 10 d’un nombre.";
...
Blockly.Msg.RENAME_PARAMETER_TITLE = "Renommer tous les '%1' paramètres comme :";
...
Blockly.Msg.TEXT_TRIM_OPERATOR_BOTH = "raccourcir les espaces des deux côtés";
Blockly.Msg.TEXT_TRIM_OPERATOR_LEFT = "raccourcir les espaces du côté gauche";
Blockly.Msg.TEXT_TRIM_OPERATOR_RIGHT = "raccourcir les espaces du côté droit";
