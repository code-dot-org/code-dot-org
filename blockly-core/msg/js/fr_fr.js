...
Blockly.Msg.ACTUAL = "courante";
Blockly.Msg.ADD = "Ajouter";
Blockly.Msg.ADD_COMMENT = "Ajouter un commentaire";
Blockly.Msg.ADD_PARAMETER = "Ajouter Paramètre";
...
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_OPERATOR_CONTINUE = "continuer au tour de boucle suivant";
...
Blockly.Msg.CONTROLS_FOR_TOOLTIP = "Faire en sorte que la variable %1 prenne les valeurs successives depuis le nombre de départ au nombre final par incrément spécifié, en exécutant les instructions spécifiées.";
...
Blockly.Msg.CONTROLS_IF_TOOLTIP_4 = "Si la première valeur est vraie, alors exécuter le premier bloc d’instructions. Sinon, si la seconde valeur est vraie, exécuter le second bloc d’instructions. Si aucune des valeurs n’est vraie, exécuter le dernier bloc d’instructions.";
...
Blockly.Msg.CONTROLS_REPEAT_TOOLTIP = "Exécuter certaines instructions plusieurs fois.";
Blockly.Msg.CONTROLS_WHILEUNTIL_HELPURL = "http://fr.wikipedia.org/wiki/Boucle_while";
...
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_UNTIL = "Tant qu’une valeur est fausse, alors exécuter certaines instructions.";
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_WHILE = "Tant qu’une valeur est vraie, alors exécuter certaines instructions.";
Blockly.Msg.DEFINE_HEADER_DEFINITION = "Definition";
Blockly.Msg.DEFINE_FUNCTION_DEFINE = "Définissez";
Blockly.Msg.DELETE_BLOCK = "Supprimer le bloc";
Blockly.Msg.DELETE_PARAMETER = "Supprimer paramètre...";
Blockly.Msg.DELETE_PARAMETER_TITLE = "Cela supprimera tous les %1 cas du variable. Êtes-vous sûr?";
...
Blockly.Msg.EXAMPLE_DESCRIPTION = "Définit un exemple avec un comportement attendu et réel";
Blockly.Msg.EXPAND_ALL = "Développer les blocs";
Blockly.Msg.EXPAND_BLOCK = "Développer le Bloc";
Blockly.Msg.EXPECTED = "ATTENDU";
...
Blockly.Msg.FUNCTION_NAME_LABEL = "Nomme votre fonction :";
Blockly.Msg.FUNCTION_DESCRIPTION_LABEL = "Qu'est-ce que votre fonction est censée faire?";
Blockly.Msg.FUNCTION_PARAMETERS_LABEL = "Quels paramètres votre fonction prend-elle en entrée?";
...
Blockly.Msg.FUNCTIONAL_TYPE_LABEL = "Choisis un type de...";
Blockly.Msg.FUNCTIONAL_DESCRIPTION_LABEL = "Description ";
Blockly.Msg.FUNCTIONAL_DOMAIN_LABEL = "Domaine";
Blockly.Msg.FUNCTIONAL_PROCEDURE_DEFINE_TOOLTIP = "Définissez une méthode fonctionnelle";
Blockly.Msg.FUNCTIONAL_RANGE_LABEL = "Plage";
Blockly.Msg.FUNCTIONAL_VARIABLE_CREATE = "Créez une variable";
...
Blockly.Msg.LISTS_CREATE_EMPTY_TOOLTIP = "Renvoie une liste, de longueur 0, ne contenant aucune donnée";
...
Blockly.Msg.LISTS_CREATE_WITH_INPUT_WITH = "créer une liste contenant";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_LAST = "Renvoie le dernier élément d'une liste.";
...
Blockly.Msg.LISTS_GET_SUBLIST_END_FROM_END = "jusqu’à # de la fin";
...
Blockly.Msg.LISTS_GET_SUBLIST_START_FIRST = "obtenir une sous-liste à partir du premier élément";
Blockly.Msg.LISTS_GET_SUBLIST_START_FROM_END = "obtenir la sous-liste qui va de # à la fin";
...
Blockly.Msg.LISTS_SET_INDEX_SET = "fixer";
...
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GT = "Retourne vrai si la première entrée est strictement supérieure à la seconde.";
...
Blockly.Msg.MATH_ARITHMETIC_HELPURL = "http://fr.wikipedia.org/wiki/Arithm%C3%A9tique";
...
Blockly.Msg.MATH_MODULO_TOOLTIP = "Renvoie le reste de la division des deux nombres.";
...
Blockly.Msg.MATH_RANDOM_FLOAT_HELPURL = "http://fr.wikipedia.org/wiki/G%C3%A9n%C3%A9rateur_de_nombres_al%C3%A9atoires";
...
Blockly.Msg.MATH_RANDOM_INT_HELPURL = "http://fr.wikipedia.org/wiki/G%C3%A9n%C3%A9rateur_de_nombres_al%C3%A9atoires";
...
Blockly.Msg.MATH_ROUND_HELPURL = "http://fr.wikipedia.org/wiki/Arrondi_(math%C3%A9matiques)";
...
Blockly.Msg.MATH_TRIG_ATAN = "arc-tangeante";
...
Blockly.Msg.RENAME_PARAMETER = "Renommer variable…";
Blockly.Msg.RENAME_PARAMETER_TITLE = "Renommer toutes les '%1' variables comme:";
Blockly.Msg.RENAME_VARIABLE = "Renommer la variable…";
Blockly.Msg.RENAME_VARIABLE_TITLE = "Renommer toutes les variables '%1' en :";
Blockly.Msg.SAVE_AND_CLOSE = "Sauvegarder et fermer";
...
Blockly.Msg.TEXT_CHANGECASE_TOOLTIP = "Renvoie une copie du texte dans une autre casse.";
...
Blockly.Msg.TEXT_CREATE_JOIN_TITLE_JOIN = "S'inscrire";
