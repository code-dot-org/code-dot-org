...
Blockly.Msg.COLLAPSE_ALL = "블럭들 축소";
Blockly.Msg.COLLAPSE_BLOCK = "블럭 축소";
...
Blockly.Msg.COLOUR_BLEND_TOOLTIP = "두 색을 원하는 비율(0.0-1.0)로 섞습니다.";
Blockly.Msg.COLOUR_PICKER_HELPURL = "http://en.wikipedia.org/wiki/Color";
Blockly.Msg.COLOUR_PICKER_TOOLTIP = "색 팔레트에서 색을 선택합니다.";
Blockly.Msg.COLOUR_RANDOM_HELPURL = "http://randomcolour.com";
Blockly.Msg.COLOUR_RANDOM_TITLE = "랜덤 색";
Blockly.Msg.COLOUR_RANDOM_TOOLTIP = "랜덤으로 색을 선택합니다.";
...
Blockly.Msg.COLOUR_RGB_TOOLTIP = "빨강(R), 초록(G), 파랑(B) 값을 이용해, 새로운 색을 만듭니다. 각 RGB 값은 0 부터 100 까지.";
...
Blockly.Msg.CONTROLS_FOR_INPUT_WITH = "카운트 : ";
...
Blockly.Msg.CONTROLS_WHILEUNTIL_OPERATOR_UNTIL = "~할 때까지 반복";
...
Blockly.Msg.LISTS_GET_INDEX_RANDOM = "랜덤 번째 위치";
...
Blockly.Msg.LOGIC_NEGATE_TOOLTIP = "입력값이 참(true) 값이면 거짓(false) 값을 돌려주고, 거짓(false) 값이면 참(true) 값을 돌려줍니다.";
...
Blockly.Msg.LOGIC_OPERATION_TOOLTIP_OR = "두 값 중 하나라도 참(true) 값이면, 참 값을 돌려줍니다.";
...
Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_DIVIDE = "첫 번째 수를 두 번째 수로, 나눈 결과값을 돌려줍니다.";
Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_MINUS = "첫 번째 수에서 두 번째 수를, 뺀 결과값을 돌려줍니다.";
Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_MULTIPLY = "두 수를, 곱한 결과 값을 돌려줍니다.";
...
Blockly.Msg.MATH_SINGLE_TOOLTIP_ROOT = "어떤 수의, 제곱근(square root) 값을 돌려줍니다.";
...
Blockly.Msg.PROCEDURES_CREATE_DO = "'%1' 실행 블럭 생성";
...
Blockly.Msg.PROCEDURES_DEFRETURN_TITLE = "함수";
...
Blockly.Msg.PROCEDURES_IFRETURN_TOOLTIP = "첫 번째 값이 참(true)이면, 두 번째 값을 돌려줍니다.";
...
Blockly.Msg.TEXT_APPEND_APPENDTEXT = "에 문장 덧 붙임";
...
Blockly.Msg.TEXT_CREATE_JOIN_TITLE_JOIN = "결합 할 조각";
...
Blockly.Msg.TEXT_ISEMPTY_TITLE = "%1 이 빈 문장 인가?";
