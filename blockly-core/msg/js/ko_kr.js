...
Blockly.Msg.CONFIRM_DELETE_FUNCTION_MESSAGE = "경고! 정말로 %1을 삭제하시겠습니까?";
...
Blockly.Msg.DEFINE_FUNCTION_FOR_EXAMPLE = "아래 함수를 정의하시고 다시 시도해 주세요.";
...
Blockly.Msg.MATH_IS_TOOLTIP = "어떤 수가 짝수, 홀수, 소수, 정수, 양수, 음수, 나누어 떨어지는 수 인지 검사해 결과값을 돌려줍니다. 참(true) 또는 거짓(false) 값을 돌려줌.";
...
Blockly.Msg.MATH_SINGLE_TOOLTIP_ABS = "어떤 수의 절댓값(absolute) 을 계산한 결과를, 정수값으로 돌려줍니다.";
