...
Blockly.Msg.CONTROLS_IF_TOOLTIP_3 = "Om det första värdet är sant, utför det första blocket av kommandon. Annars, om det andra värdet är sant, utför det andra utför det andra blocket av kommandon.";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_FIRST = "Ger tillbaka det första elementet i en lista.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_FROM_END = "Ger tillbaka elementet på den efterfrågade positionen i en lista. #1 är det sista objektet.";
...
Blockly.Msg.LOGIC_NULL = "noll";
Blockly.Msg.LOGIC_NULL_HELPURL = "http://sv.wikipedia.org/wiki/Null";
Blockly.Msg.LOGIC_NULL_TOOLTIP = "Ger tillbaka noll.";
