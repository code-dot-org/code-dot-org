...
Blockly.Blocks.procedures_defnoreturn = {init:function() {
  ...
  Blockly.Procedures.mutateCallers(this.getTitleValue("NAME"), this.workspace, this.arguments_, null);
  return b
}, compose:function(a) {
  this.arguments_ = [];
  this.paramIds_ = [];
  ...
  this.updateParams_();
  Blockly.Procedures.mutateCallers(this.getTitleValue("NAME"), this.workspace, this.arguments_, this.paramIds_)
}, dispose:function() {
...
Blockly.Blocks.procedures_callnoreturn = {init:function() {
  ...
  this.setHSV(94, 0.84, 0.6);
  this.appendDummyInput().appendTitle(Blockly.Msg.PROCEDURES_CALLNORETURN_CALL).appendTitle("", "NAME");
  this.setPreviousStatement(!0);
  this.setNextStatement(!0);
  ...
  if((b = Blockly.Procedures.getDefinition(b, this.workspace)) && b.mutator && b.mutator.isVisible()) {
  ...
  var c = this.getTitleValue("NAME"), d = this.workspace;
  b.callback = function() {
...
Blockly.Blocks.variables_get = {init:function() {
  ...
  this.appendDummyInput().appendTitle(Blockly.Msg.VARIABLES_GET_TITLE).appendTitle(new Blockly.FieldVariable(Blockly.Msg.VARIABLES_GET_ITEM), "VAR").appendTitle(Blockly.Msg.VARIABLES_GET_TAIL);
  this.setOutput(!0);
...
Blockly.Blocks.variables_set = {init:function() {
  ...
  this.setHSV(312, 0.32, 0.62);
  this.appendValueInput("VALUE").appendTitle(Blockly.Msg.VARIABLES_SET_TITLE).appendTitle(new Blockly.FieldVariable(Blockly.Msg.VARIABLES_SET_ITEM), "VAR").appendTitle(Blockly.Msg.VARIABLES_SET_TAIL);
  this.setPreviousStatement(!0);
  this.setNextStatement(!0);
