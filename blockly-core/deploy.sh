...
if [[ $1 == "debug" ]]; then
  ...
  echo "Outputting to blockly_uncompressed.js, javascript_uncompressed.js and blocks_uncompressed.js"
  ...
  >> javascript_uncompressed.js
  sed -i.bak -e "s/var Blockly = {Generator:{}};//g" javascript_uncompressed.js
  rm javascript_uncompressed.js.bak

  echo -e '// Do not edit this generated file\n"use strict";\n' > blocks_uncompressed.js
  java -jar compiler.jar \
  --formatting=PRETTY_PRINT --flagfile blocks/bld_flags.txt \
  >> blocks_uncompressed.js
  sed -i.bak -e "s/var Blockly = {Blocks:{}};//g" blocks_uncompressed.js
  rm blocks_uncompressed.js.bak
  echo "Done building blockly_uncompressed.js, javascript_uncompressed.js and blocks_uncompressed.js"
