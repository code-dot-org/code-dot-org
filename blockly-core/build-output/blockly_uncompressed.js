...
Blockly.BlockSvgUnused.prototype.initChildren = function() {
  this.bindData_ = Blockly.bindEvent_(Blockly.mainBlockSpace.getCanvas(), Blockly.BlockSpace.EVENTS.RUN_BUTTON_CLICKED, this, this.unhide.bind(this));
  this.frameGroup_ = Blockly.createSvgElement("g", {"class":"blocklyUnusedFrame"});
  var clip = Blockly.createSvgElement("clipPath", {id:"frameClip" + this.block_.id}, this.frameGroup_);
  ...
  this.frameBase_ = Blockly.createSvgElement("rect", {x:-FRAME_MARGIN_SIDE, y:-(FRAME_MARGIN_TOP + FRAME_HEADER_HEIGHT), fill:"#e7e8ea", stroke:"#c6cacd", rx:15, ry:15}, this.frameGroup_);
  this.frameHeader_ = Blockly.createSvgElement("rect", {x:-FRAME_MARGIN_SIDE, y:-(FRAME_MARGIN_TOP + FRAME_HEADER_HEIGHT), fill:"#c6cacd", rx:15, ry:15, "clip-path":"url(#frameClip" + this.block_.id + ")"}, this.frameGroup_);
  this.frameText_ = Blockly.createSvgElement("text", {"class":"blocklyText", style:"font-size: 12pt", y:-(FRAME_MARGIN_TOP + FRAME_HEADER_HEIGHT / 2), "dominant-baseline":"central"}, this.frameGroup_);
  ...
  Blockly.createSvgElement("circle", {stroke:"#ffffff", fill:"#59b9dc", r:FRAME_HEADER_HEIGHT * 0.75 * 0.5}, this.frameHelp_);
  Blockly.createSvgElement("text", {"class":"blocklyText", style:"font-size: 12pt", dx:-FRAME_HEADER_HEIGHT * 0.75 * 0.5 * 0.5, dy:FRAME_HEADER_HEIGHT * 0.75 * 0.5 * 0.5}, this.frameHelp_).appendChild(document.createTextNode("?"))
};
...
Blockly.BlockSvgUnused.prototype.bindClickEvent = function() {
  ...
  Blockly.bindEvent_(this.frameHelp_, "mousedown", this, function(e) {
    ...
    this.frameHelp_.dispatchEvent(new Event(Blockly.BlockSvgUnused.UNUSED_BLOCK_HELP_EVENT, {bubbles:true}));
    e.stopPropagation();
    e.preventDefault()
  })
};
...
Blockly.BlockSvg.prototype.connectionUiEffect = function() {
  ...
  var ripple = Blockly.createSvgElement("circle", {"cx":xy.x, "cy":xy.y, "r":0, "fill":"none", "stroke":"#888", "stroke-width":10}, this.block_.blockSpace.blockSpaceEditor.svg_);
...
Blockly.BlockSvg.prototype.updateLimit = function(limit) {
  ...
  if(!this.limitGroup_) {
    this.limitGroup_ = Blockly.createSvgElement("g", {"class":"blocklyLimit", y:-3}, this.svgGroup_);
    this.limitRect_ = Blockly.createSvgElement("rect", {height:BUBBLE_SIZE, width:BUBBLE_SIZE, x:-HALF_BUBBLE_SIZE, y:-HALF_BUBBLE_SIZE, rx:HALF_BUBBLE_SIZE, ry:HALF_BUBBLE_SIZE}, this.limitGroup_);
    this.limitText_ = Blockly.createSvgElement("text", {"class":"blocklyText", "dominant-baseline":"central", "text-anchor":"middle"}, this.limitGroup_)
  }
  if(limit === 0) {
...
Blockly.BlockSvg.prototype.renderCompute_ = function(iconWidth) {
  ...
  for(i = 0;currentRow = inputRows[i];i++) {
    if(currentRow.type === INLINE_ROW) {
      inputRows.rightEdge = Math.max(inputRows.rightEdge, this.widthInlineRow(currentRow))
    }
  }
  return inputRows
};
...
Blockly.ScrollbarSvg.prototype.createDom_ = function() {
  ...
  Blockly.Scrollbar.insertAfter_(this.svgGroup_, this.blockSpace_.getBubbleCanvas())
};
...
Blockly.Trashcan.prototype.createDom = function() {
  ...
  this.svgClosedCan_ = Blockly.createSvgElement("image", {"width":Blockly.Trashcan.WIDTH_, "height":Blockly.Trashcan.HEIGHT_}, this.svgGroup_);
  this.svgClosedCan_.setAttributeNS("http://www.w3.org/1999/xlink", "xlink:href", Blockly.assetUrl(Blockly.Trashcan.CLOSED_URL_));
  this.svgOpenCan_ = Blockly.createSvgElement("image", {"width":Blockly.Trashcan.WIDTH_, "height":Blockly.Trashcan.HEIGHT_}, this.svgGroup_);
  this.svgOpenCan_.setAttribute("visibility", "hidden");
  this.svgOpenCan_.setAttributeNS("http://www.w3.org/1999/xlink", "xlink:href", Blockly.assetUrl(Blockly.Trashcan.OPEN_URL_));
  return this.svgGroup_
};
...
Blockly.PanDragHandler.prototype.bindBeginPanDragHandler = function(target, onDragTargetMouseDown) {
  this.unbindBeginPanDragHandler();
  this.target_ = target;
  this.onTargetMouseDown_ = onDragTargetMouseDown;
  this.mouseDownEventBindData_ = Blockly.bindEvent_(target, "mousedown", this, this.onPanDragTargetMouseDown_);
  this.contextMenuBlockEventBindData_ = Blockly.bindEvent_(target, "contextmenu", null, Blockly.blockContextMenu)
};
...
Blockly.PanDragHandler.prototype.bindDuringPanDragHandlers_ = function() {
  ...
  var onCapture = true;
  this.mouseMoveEventBindData_ = Blockly.bindEvent_(window, "mousemove", this, this.onPanDragMouseMove_, onCapture);
  this.mouseUpEventBindData_ = Blockly.bindEvent_(window, "mouseup", this, this.onPanDragMouseUp_, onCapture)
};
...
Blockly.PanDragHandler.prototype.onPanDragMouseMove_ = function(e) {
  ...
  var mouseDx = e.clientX - this.startMouseX_;
  var mouseDy = e.clientY - this.startMouseY_;
  var scrollDx = -mouseDx;
  var scrollDy = -mouseDy;
  this.blockSpace_.scrollTo(this.startScrollX_ + scrollDx, this.startScrollY_ + scrollDy);
  e.stopPropagation();
  e.preventDefault()
};
...
Blockly.AutoScroll = function(blockSpace, startPanVector) {
  ...
  this.animationDelay_ = new goog.async.AnimationDelay(this.handleAnimationDelay_.bind(this), window);
...
Blockly.AutoScroll.prototype.scrollTick_ = function(msPassed) {
  ...
  this.blockSpace_.scrollDeltaWithAnySelectedBlock(scrollDx, scrollDy, this.lastMouseX_, this.lastMouseY_)
};
Blockly.AutoScroll.prototype.updateProperties = function(scrollVector, mouseClientX, mouseClientY) {
...
Blockly.ScrollOnBlockDragHandler = function(blockSpace) {
  this.blockSpace_ = blockSpace;
  this.SCROLL_DIRECTION_VECTORS = {top:new goog.math.Vec2(0, -1), bottom:new goog.math.Vec2(0, 1), left:new goog.math.Vec2(-1, 0), right:new goog.math.Vec2(1, 0)}
};
...
Blockly.ScrollOnBlockDragHandler.prototype.panIfOverEdge = function(block, mouseClientX, mouseClientY) {
  ...
  if(this.blockSpace_.scrollbarPair && this.blockSpace_.scrollbarPair.canScrollHorizontally()) {
    SCROLLABLE_DIRECTIONS.push("left", "right")
  }
  if(this.blockSpace_.scrollbarPair && this.blockSpace_.scrollbarPair.canScrollVertically()) {
  ...
  SCROLLABLE_DIRECTIONS.forEach(function(direction) {
    ...
    if(Blockly.numberWithin(blockOverflow, BLOCK_START_DISTANCE, BLOCK_START_FAST_DISTANCE, false)) {
    ...
    if(Blockly.numberWithin(mouseOverflow, MOUSE_START_DISTANCE, MOUSE_START_FAST_DISTANCE, false)) {
    ...
    var greatestScrollVector = candidateScrolls.reduce(function(fastestScroll, candidateScroll) {
      if(!fastestScroll) {
        return candidateScroll
      }
      return fastestScroll.magnitude() > candidateScroll.magnitude() ? fastestScroll : candidateScroll
    }, null);
    if(greatestScrollVector) {
      overallScrollVector = goog.math.Vec2.sum(overallScrollVector, greatestScrollVector)
    }
  }, this);
  ...
  this.activeAutoScroll_ = this.activeAutoScroll_ || new Blockly.AutoScroll(this.blockSpace_, overallScrollVector);
  this.activeAutoScroll_.updateProperties(overallScrollVector, mouseClientX, mouseClientY)
};
...
Blockly.ScrollOnWheelHandler.prototype.bindTo = function(wheelTarget) {
  ...
  this.wheelEventBindData_ = Blockly.bindEvent_(wheelTarget, "wheel", this, this.onWheel_);
  this.mousewheelEventBindData_ = Blockly.bindEvent_(wheelTarget, "mousewheel", this, this.onWheel_)
};
...
Blockly.ScrollOnWheelHandler.prototype.onWheel_ = function(e) {
  ...
  if(wheelDelta) {
    this.blockSpace_.scrollWithAnySelectedBlock(this.blockSpace_.getScrollOffsetX(), this.blockSpace_.getScrollOffsetY() + wheelDelta, e.clientX, e.clientY);
    e.stopPropagation();
    e.preventDefault()
  }
};
...
Blockly.BlockSpace = function(blockSpaceEditor, getMetrics, setMetrics) {
  ...
  this.events.listen(Blockly.BlockSpace.EVENTS.EVENT_BLOCKS_IMPORTED, this.updateScrollableSize.bind(this))
};
...
Blockly.BlockSpace.prototype.findFunction = function(functionName) {
  return goog.array.find(this.getTopBlocks(), function(block) {
    return goog.array.contains(Blockly.Procedures.DEFINITION_BLOCK_TYPES, block.type) && Blockly.Names.equals(functionName, block.getTitleValue("NAME"))
  })
};
Blockly.BlockSpace.prototype.findFunctionExamples = function(functionName) {
  return goog.array.filter(this.getTopBlocks(), function(block) {
    if(Blockly.ContractEditor.EXAMPLE_BLOCK_TYPE === block.type) {
      ...
      return actualBlock && (!functionName || Blockly.Names.equals(functionName, actualBlock.getTitleValue("NAME")))
    }
    return false
  })
};
...
Blockly.BlockSpace.prototype.isDeleteArea = function(mouseX, mouseY, startDragX) {
  ...
  var mouseXY = Blockly.mouseCoordinatesToSvg(mouseX, mouseY, this.blockSpaceEditor.svg_);
...
Blockly.BlockSpace.prototype.drawTrashZone = function(x, startDragX) {
  ...
  var blockSpaceEditor = this.blockSpaceEditor.hideTrashRect_ ? Blockly.mainBlockSpaceEditor : this.blockSpaceEditor;
  ...
  if(pastThreshold) {
    if(xDifference <= 0) {
      ...
      if(xDifference >= trashZoneWidth) {
        ...
        if(trashZoneWidth < INNER_TRASH_DISTANCE) {
          normalIntensity = xDifference / trashZoneWidth
        }else {
          if(xDifference < INNER_TRASH_DISTANCE) {
            normalIntensity = xDifference / INNER_TRASH_DISTANCE * INNER_TRASH_NORMAL_INTENSITY
          }else {
            normalIntensity = INNER_TRASH_NORMAL_INTENSITY + (xDifference - INNER_TRASH_DISTANCE) / (trashZoneWidth - INNER_TRASH_DISTANCE) * INNER_TRASH_TRASHCAN_INTENSITY
          }
        }
      }
    }
...
Blockly.BlockSpace.prototype.getViewportBox = function() {
  ...
  return new goog.math.Box(this.getScrollOffsetY(), this.getScrollOffsetX() + metrics.viewWidth, this.getScrollOffsetY() + metrics.viewHeight, this.getScrollOffsetX())
};
...
Blockly.BlockSpace.prototype.scrollWithAnySelectedBlock = function(newScrollX, newScrollY, mouseX, mouseY) {
...
Blockly.BlockSpace.prototype.scrollToDelta = function(scrollDx, scrollDy) {
  this.scrollTo(this.getScrollOffsetX() + scrollDx, this.getScrollOffsetY() + scrollDy)
};
...
Blockly.BlockSpace.prototype.getMaxScrollOffsets = function() {
  ...
  return{x:blockSpaceSize.width - metrics.viewWidth, y:blockSpaceSize.height - metrics.viewHeight}
};
...
Blockly.BlockSpace.prototype.bindBeginPanDragHandler = function(target, onDragTargetMouseDown) {
...
Blockly.BlockSpace.prototype.drawDebugBox = function(key, box, color) {
  ...
  if(!this.debugRects_[key]) {
    this.debugRects_[key] = Blockly.createSvgElement("rect", {fill:"none", style:"pointer-events: none"}, this.svgDebugCanvas_)
  }
...
Blockly.BlockSpace.prototype.drawDebugCircle = function(key, coordinate, color) {
  ...
  if(!this.debugCircles_[key]) {
    this.debugCircles_[key] = Blockly.createSvgElement("circle", {cx:"50", cy:"50", r:"50", style:"pointer-events: none"}, this.svgDebugCanvas_)
  }
  this.svgDebugCanvas_.setAttribute("transform", this.svgBlockCanvas_.getAttribute("transform"));
...
Blockly.Bubble = function(blockSpace, content, shape, anchorX, anchorY, bubbleWidth, bubbleHeight) {
...
Blockly.Comment.prototype.setVisible = function(visible) {
  ...
  if(visible) {
    this.bubble_ = new Blockly.Bubble((this.block_.blockSpace), this.createEditor_(), this.block_.svg_.svgGroup_, this.iconX_, this.iconY_, this.width_, this.height_);
...
Blockly.Mutator.prototype.createEditor_ = function() {
  ...
  this.blockSpace_ = new Blockly.BlockSpace(blockSpaceEditor, function() {
...
Blockly.Mutator.prototype.resizeBubble_ = function() {
  ...
  var height = Math.max(blockSpaceSize.height + doubleBorderWidth * 3, flyoutMetrics.contentHeight + 20);
  width += doubleBorderWidth * 3;
  if(Math.abs(this.blockSpaceWidth_ - width) > doubleBorderWidth || Math.abs(this.blockSpaceHeight_ - height) > doubleBorderWidth) {
...
Blockly.Mutator.prototype.setVisible = function(visible) {
  ...
  if(visible) {
    ...
    if(this.block_.saveConnections) {
      ...
      this.sourceListener_ = Blockly.bindEvent_(this.block_.blockSpace.getCanvas(), "blocklyBlockSpaceChange", this.block_, function() {
        thisObj.block_.saveConnections(thisObj.rootBlock_)
      })
    }
    this.resizeBubble_();
    Blockly.bindEvent_(this.blockSpace_.getCanvas(), "blocklyBlockSpaceChange", this.block_, function() {
...
Blockly.Mutator.prototype.getFlyoutMetrics_ = function() {
  ...
  return{viewHeight:this.blockSpaceHeight_, viewWidth:this.blockSpaceWidth_, absoluteTop:0, absoluteLeft:left}
};
...
Blockly.Connection.singleConnection_ = function(block, orphanBlock) {
  ...
  for(var x = 0;x < block.inputList.length;x++) {
    ...
    if(thisConnection && (thisConnection.type == Blockly.INPUT_VALUE && orphanBlock.outputConnection.checkAllowedConnectionType_(thisConnection))) {
      if(connection) {
        return null
      }
...
Blockly.Warning.prototype.setVisible = function(visible) {
  ...
  if(visible) {
    ...
    this.bubble_ = new Blockly.Bubble((this.block_.blockSpace), paragraph, this.block_.svg_.svgGroup_, this.iconX_, this.iconY_, null, null);
    if(Blockly.RTL) {
      if(navigator.userAgent.indexOf("MSIE") >= 0 || navigator.userAgent.indexOf("Trident") >= 0) {
...
Blockly.Block.prototype.handleBlockLimitChanges = function() {
  if(this.blockSpace && this.blockSpace.blockSpaceEditor) {
    ...
    if(shouldShowBlockLimits) {
      this.blockSpace.blockSpaceEditor.blockLimits.events.listen("change", this.onBlockLimitChange.bind(this))
    }
  }
};
...
Blockly.Block.prototype.setRenderBlockSpace = function(blockSpace) {
  ...
  if(goog.isFunction(this.onchange)) {
    Blockly.bindEvent_(this.blockSpace.getCanvas(), "blocklyBlockSpaceChange", this, this.onchange)
  }
};
...
Blockly.Block.prototype.dispose = function(healStack, animate) {
  ...
  var updateBlockSpaceCallback = goog.bind(this.blockSpace.updateScrollableSize, this.blockSpace);
...
Blockly.Block.prototype.getRelativeToSurfaceXY = function() {
  ...
  if(this.svg_) {
    ...
    do {
      ...
      y += xy.y;
      element = element.parentNode;
      elementIsRootCanvas = element == this.blockSpace.getCanvas() || element == this.blockSpace.getDragCanvas()
...
Blockly.Block.prototype.onMouseUp_ = function(e) {
  ...
  if(Blockly.selected && Blockly.highlightedConnection_) {
    ...
    if(Blockly.selected && (Blockly.selected.areBlockAndDescendantsDeletable() && thisBlockSpace.isDeleteArea(e.clientX, e.clientY, this.startDragMouseX))) {
...
Blockly.Block.prototype.duplicate_ = function() {
  ...
  var newBlock = Blockly.Xml.domToBlock((this.blockSpace), xmlBlock);
  var xy = this.getRelativeToSurfaceXY();
  if(Blockly.RTL) {
    xy.x -= Blockly.SNAP_RADIUS
  }else {
...
Blockly.Block.prototype.showContextMenu_ = function(e) {
  ...
  if(Blockly.editBlocks) {
    ...
    var limitOption = {text:"Set limit (current: " + (getCurrentLimit() || "none") + ")", enabled:true, callback:function() {
...
Blockly.BlockLimits.prototype.setLimit = function(type, limit) {
  this.limits_[type] = {count:undefined, limit:limit};
...
Blockly.BlockLimits.prototype.updateCount = function(type, newCount) {
  ...
  if(countChanged) {
    this.events.fireListeners("change", false, {type:type, limit:limit.limit, remaining:limit.limit - limit.count})
  }
};
...
Blockly.Flyout.prototype.getMetrics_ = function() {
  ...
  return{viewHeight:viewHeight, viewWidth:viewWidth, contentHeight:optionBox.height + optionBox.y, viewTop:this.blockSpace_.getScrollOffsetY(), contentTop:0, absoluteTop:this.CORNER_RADIUS, absoluteLeft:0}
};
...
Blockly.Flyout.prototype.setMetrics_ = function(yRatio) {
  ...
  if(goog.isNumber(yRatio.y)) {
    this.blockSpace_.yOffsetFromView = -metrics.contentHeight * yRatio.y - metrics.contentTop
  }
  var y = this.blockSpace_.yOffsetFromView + metrics.absoluteTop;
  this.blockSpace_.getCanvas().setAttribute("transform", "translate(0," + y + ")");
  this.blockSpace_.getDragCanvas().setAttribute("transform", "translate(0," + y + ")")
};
Blockly.Flyout.prototype.init = function(blockSpace, withScrollbars) {
  ...
  if(withScrollbars) {
    ...
    flyout.blockSpace_.scrollbarPair = new Blockly.ScrollbarPair(flyout.blockSpace_, useHorizontalScrollbar, useVerticalScrollbar)
  }
  this.hide();
  this.onResizeWrapper_ = Blockly.bindEvent_(window, goog.events.EventType.RESIZE, this, this.position_);
  this.position_();
  this.changeWrapper_ = Blockly.bindEvent_(this.targetBlockSpace_.getCanvas(), "blocklyBlockSpaceChange", this, this.onBlockSpaceChange_)
};
Blockly.Flyout.prototype.position_ = function() {
  if(!this.isVisible()) {
    return
  }
  var metrics = this.targetBlockSpace_.customFlyoutMetrics_ ? this.targetBlockSpace_.customFlyoutMetrics_() : this.targetBlockSpace_.getMetrics();
  if(!metrics) {
    return
  }
...
Blockly.Flyout.prototype.blockMouseDown_ = function(block) {
  ...
  return function(e) {
    ...
    if(Blockly.isRightButton(e)) {
      ...
      Blockly.Flyout.onMouseUpWrapper_ = Blockly.bindEvent_(document, "mouseup", this, Blockly.BlockSpaceEditor.terminateDrag_);
...
Blockly.Toolbox.prototype.createDom = function(svg) {
  ...
  this.trashcanHolder = Blockly.createSvgElement("svg", {id:"trashcanHolder", width:70, height:90, style:"display: none; position: absolute"}, this.HtmlDiv);
  this.trashcan = new Blockly.Trashcan(this);
...
Blockly.Toolbox.TreeNode = function(toolbox, html, opt_config, opt_domHelper) {
  ...
  this.toolbox_ = toolbox;
  goog.events.listen(this.toolbox_.tree_, goog.ui.tree.BaseNode.EventType.EXPAND, resize);
...
Blockly.FieldVariable = function(varname, opt_changeHandler, opt_createHandler) {
  ...
  Blockly.FieldVariable.superClass_.constructor.call(this, opt_createHandler || Blockly.FieldVariable.dropdownCreate, changeHandler);
  if(varname) {
...
Blockly.FieldVariable.removeExtraWhitespace = function(inputString) {
  ...
  return inputString.replace(multipleWhitespaceCharactersRegex, " ").replace(leadingTrailingWhitespaceRegex, "")
};
...
Blockly.Procedures.isLegalName = function(name, blockSpace, opt_exclude) {
  var blockExistsWithName = blockSpace.getAllBlocks().filter(function(block) {
...
Blockly.Procedures.mutateCallers = function(name, blockSpace, paramNames, paramIds, opt_typeNames) {
  Blockly.Procedures.getCallers(name, blockSpace).forEach(function(caller) {
...
Blockly.HorizontalFlyout.prototype.position_ = function() {
  ...
  path.push("a", this.CORNER_RADIUS, this.CORNER_RADIUS, 0, 0, 0, this.CORNER_RADIUS, this.CORNER_RADIUS);
  path.push("h", edgeWidth);
  path.push("a", this.CORNER_RADIUS, this.CORNER_RADIUS, 0, 0, 0, this.CORNER_RADIUS, -this.CORNER_RADIUS);
  path.push("v", -edgeHeight);
  path.push("z");
  ...
  this.svgBackground_.style.pointerEvents = this.scrollbar_ ? "initial" : "none"
};
...
Blockly.HorizontalFlyout.prototype.layoutBlock_ = function(block, cursor, gap, initialX) {
  var blockHW = block.getHeightWidth();
  if(Blockly.RTL && cursor.x - blockHW.width < 0 || !Blockly.RTL && cursor.x + blockHW.width > this.width_) {
    this.flyoutRows++;
...
Blockly.BlockSpaceEditor.prototype.bumpBlocksIntoBlockSpace = function() {
  ...
  if(!Blockly.BlockSpaceEditor.BUMP_ENTIRE_BLOCK) {
    ...
    var blockSpaceInnerBottom = blockSpaceSize.height - Blockly.BlockSpaceEditor.BUMP_PADDING_BOTTOM;
    var blockSpaceInnerRight = blockSpaceSize.width - Blockly.BlockSpaceEditor.BUMP_PADDING_RIGHT;
  ...
  this.blockSpace.getTopBlocks(false, false).forEach(function(block) {
    ...
    if(!Blockly.BlockSpaceEditor.BUMP_ENTIRE_BLOCK) {
      ...
      var paddedBlockSpaceBox = this.blockSpace.getScrollableBox().expand(-Blockly.BlockSpaceEditor.ENTIRE_BUMP_PADDING_TOP, -Blockly.BlockSpaceEditor.ENTIRE_BUMP_PADDING_RIGHT, -Blockly.BlockSpaceEditor.ENTIRE_BUMP_PADDING_BOTTOM, -Blockly.BlockSpaceEditor.ENTIRE_BUMP_PADDING_LEFT);
    ...
    if(Blockly.BlockSpaceEditor.BUMP_DEBUG && Blockly.BlockSpaceEditor.BUMP_ENTIRE_BLOCK) {
      var afterBumpBlockBox = block.getBox();
      var originalBlockBoxColor = shouldBump ? "red" : "green";
      this.blockSpace.drawDebugBox("block box" + block.id, originalBlockBox, originalBlockBoxColor);
      this.blockSpace.drawDebugBox("block after" + block.id, afterBumpBlockBox, "purple");
      this.blockSpace.drawDebugBox("block space box" + block.id, paddedBlockSpaceBox, "blue")
    }
  }, this)
};
...
Blockly.BlockSpaceEditor.prototype.svgSize = function() {
  return{width:this.svg_.cachedWidth_, height:this.svg_.cachedHeight_}
};
...
Blockly.BlockSpaceEditor.prototype.getWorkspaceTopOffset = function() {
  ...
  return goog.style.getPageOffsetTop(svg) - (goog.style.getPageOffsetTop(containerDiv) + containerTopBorder)
};
...
Blockly.BlockSpaceEditor.prototype.hideChaff = function(opt_allowToolbox) {
  ...
  if(this.toolbox && (!opt_allowToolbox && (this.toolbox.flyout_ && this.toolbox.flyout_.autoClose))) {
...
Blockly.BlockSpaceEditor.prototype.getBlockSpaceMetrics_ = function() {
  ...
  return{viewHeight:viewHeight, viewWidth:viewWidth, viewTop:viewTop, viewLeft:viewLeft, contentHeight:blockBoundingRect.height, contentWidth:blockBoundingRect.width, contentTop:blockBoundingRect.top, contentLeft:blockBoundingRect.left, absoluteTop:0, absoluteLeft:absoluteLeft}
};
Blockly.BlockSpaceEditor.prototype.getCanvasBBox = function(canvas) {
  if(Blockly.isMsie() || Blockly.isTrident()) {
    canvas.style.display = "inline";
    return{x:canvas.getBBox().x, y:canvas.getBBox().y, width:canvas.scrollWidth, height:canvas.scrollHeight}
  }
...
Blockly.BlockSpaceEditor.prototype.setBlockSpaceMetrics_ = function(xyRatio) {
  ...
  var translation = "translate(" + (this.blockSpace.xOffsetFromView + metrics.absoluteLeft) + "," + (this.blockSpace.yOffsetFromView + metrics.absoluteTop) + ")";
...
Blockly.BlockSpaceEditor.prototype.addUnusedBlocksHelpListener = function(func) {
  return Blockly.bindEvent_(this.blockSpace.getCanvas(), Blockly.BlockSvgUnused.UNUSED_BLOCK_HELP_EVENT, this, func)
};
...
Blockly.FunctionEditor.prototype.changeParameterTypeInFlyoutXML = function(name, newType) {
  this.orderedParamIDsToBlocks_.forEach(function(blockXML, paramID, linkedMap) {
    if(blockXML.firstElementChild && blockXML.firstElementChild.textContent === name) {
...
Blockly.FunctionEditor.prototype.resetParamIDs_ = function() {
  ...
  paramArrays.paramIDs = null;
  this.functionDefinitionBlock.updateParamsFromArrays(paramArrays.paramNames, paramArrays.paramIDs, paramArrays.paramTypes)
};
...
Blockly.FunctionEditor.prototype.moveToModalBlockSpace = function(blockToMove) {
  ...
  newCopyOfBlock.moveTo(Blockly.RTL ? this.modalBlockSpace.getMetrics().viewWidth - Blockly.FunctionEditor.BLOCK_LAYOUT_LEFT_MARGIN : Blockly.FunctionEditor.BLOCK_LAYOUT_LEFT_MARGIN, Blockly.FunctionEditor.BLOCK_LAYOUT_TOP_MARGIN);
...
Blockly.FunctionEditor.prototype.create_ = function() {
  ...
  var clipPath = Blockly.createSvgElement("clipPath", {id:clipPathID});
  ...
  this.clipPathRect_ = Blockly.createSvgElement("rect", {x:0, y:0, width:1, height:1}, clipPath);
  this.modalBlockSpaceEditor.addChangeListener(Blockly.mainBlockSpace.fireChangeEvent);
...
Blockly.FunctionEditor.prototype.positionDeleteButton_ = function(absoluteLeft, viewWidth) {
  ...
  var closeButtonLeft = Blockly.FunctionEditor.CLOSE_BUTTON_OVERHANG - closeButtonWidth;
  var deleteButtonLeft = rightEdge + closeButtonLeft - deleteButtonWidth;
  var ltrXOffset = deleteButtonLeft - Blockly.FunctionEditor.DELETE_BUTTON_MARGIN;
  var rtlXOffset = Blockly.FunctionEditor.RTL_CLOSE_BUTTON_OFFSET + closeButtonWidth + Blockly.FunctionEditor.DELETE_BUTTON_MARGIN;
...
Blockly.FunctionEditor.prototype.positionFlyout_ = function(currentY) {
  ...
  this.flyout_.customYOffset = currentY + this.modalBlockSpace.yOffsetFromView;
...
Blockly.FunctionEditor.prototype.layOutBlockSpaceItems_ = function() {
  ...
  var currentX = Blockly.RTL ? this.modalBlockSpace.getMetrics().viewWidth - Blockly.FunctionEditor.BLOCK_LAYOUT_LEFT_MARGIN : Blockly.FunctionEditor.BLOCK_LAYOUT_LEFT_MARGIN;
...
Blockly.FunctionEditor.prototype.setupParametersToolbox_ = function() {
  ...
  this.modalBlockSpace.getClippingGroup().insertBefore(flyoutDom, this.modalBlockSpace.svgBlockCanvas_);
...
Blockly.FunctionEditor.prototype.createParameterEditor_ = function() {
  ...
  goog.dom.getElement("paramEditingArea").innerHTML = "<div>" + Blockly.Msg.FUNCTION_PARAMETERS_LABEL + "</div>" + "<div>" + '<input id="paramAddText" type="text" style="width: 200px;"/> ' + '<button id="paramAddButton" class="btn">' + Blockly.Msg.ADD_PARAMETER + "</button>" + "</div>"
};
...
Blockly.FunctionEditor.prototype.createContractDom_ = function() {
  this.contractDiv_ = goog.dom.createDom("div", "blocklyToolboxDiv paramToolbox blocklyText flyoutColorGray innerModalDiv");
  if(Blockly.RTL) {
...
Blockly.TypeDropdown.prototype.createSelect_ = function() {
  var newTypeDropdown = new goog.ui.Select(null, null, goog.ui.FlatMenuButtonRenderer.getInstance(), null, new Blockly.CustomCssClassMenuRenderer("colored-type-dropdown"));
...
Blockly.TypeDropdown.prototype.attachListeners_ = function(selectComponent) {
  this.changeListenerKey_ = goog.events.listen(selectComponent, goog.ui.Component.EventType.CHANGE, goog.bind(this.selectChanged_, this))
};
...
Blockly.SvgHeader = function(parent, opt_options) {
  var options = opt_options || {backgroundColor:"#000", headerText:"Default Header"};
  ...
  this.rectangleElement_ = Blockly.createSvgElement("rect", {"fill":options.backgroundColor, "style":extraStyle}, this.svgGroup_);
  this.separatorElement_ = Blockly.createSvgElement("rect", {"fill":"#FFF", "style":extraStyle + "opacity:.3;"}, this.svgGroup_);
  this.textElement_ = Blockly.createSvgElement("text", {"class":"contractEditorHeaderText", "style":extraStyle}, this.svgGroup_);
...
Blockly.SvgHeader.prototype.setPositionSize = function(yOffset, width, height) {
  ...
  this.rectangleElement_.setAttribute("width", width + 2);
...
goog.ui.MenuButton.prototype.handleHighlightItem = function(e) {
  ...
  if(e.target.getElement() != null) {
    goog.a11y.aria.setState(element, goog.a11y.aria.State.ACTIVEDESCENDANT, e.target.getElement().id);
    goog.a11y.aria.setState(element, goog.a11y.aria.State.OWNS, e.target.getElement().id)
  }
};
goog.ui.MenuButton.prototype.handleKeyDownEvent_ = function(e) {
  if(this.isSupportedState(goog.ui.Component.State.FOCUSED) && (this.getKeyEventTarget() && (this.menu_ && this.menu_.isVisible()))) {
    e.stopPropagation()
  }
};
...
goog.ui.Select = function(opt_caption, opt_menu, opt_renderer, opt_domHelper, opt_menuRenderer) {
  goog.ui.Select.base(this, "constructor", opt_caption, opt_menu, opt_renderer, opt_domHelper, opt_menuRenderer || new goog.ui.MenuRenderer(goog.a11y.aria.Role.LISTBOX));
...
Blockly.SvgTextButton = function(parent, text, onMouseDown) {
  var button = Blockly.createSvgElement("g", {"class":"svgTextButton", "filter":"url(#blocklyTrashcanShadowFilter)"}, parent);
  var padding = 7;
...
Blockly.SvgTextButton.prototype.renderAt = function(xOffset, yOffset) {
  this.svgGroup_.setAttribute("transform", "translate(" + xOffset + "," + yOffset + ")");
...
var DEFINITION_SECTION_NAME = "definition";
var HIGHLIGHT_CONFIG_SUFFIX = "Highlight";
var COLLAPSE_CONFIG_SUFFIX = "Collapse";
var DISABLE_EXAMPLES_CONFIG_NAME = "disableExamples";
...
Blockly.ContractEditor.prototype.create_ = function() {
  ...
  var sharedHighlightBox = new Blockly.SvgHighlightBox(canvasToDrawOn, {color:YELLOW_HEX, thickness:HIGHLIGHT_BOX_WIDTH});
  this.contractSectionView_ = new Blockly.ContractEditorSectionView(canvasToDrawOn, {sectionNumber:1, headerHeight:HEADER_HEIGHT, onCollapseCallback:goog.bind(function(isNowCollapsed) {
    this.contractDiv_.style.display = isNowCollapsed ? "none" : "block";
    this.position_()
  }, this), placeContentCallback:goog.bind(function(currentY) {
...
Blockly.ContractEditor.prototype.setBlockSubsetVisibility = function(isVisible, blockFilter, hiddenBlockArray) {
  ...
  if(isVisible) {
    ...
    this.modalBlockSpace.getTopBlocks().filter(blockFilter).forEach(function(block) {
...
Blockly.ContractEditor.prototype.isBlockInExampleArea = function(block) {
  return this.isAnExampleBlockInEditor_(block) || block !== this.functionDefinitionBlock && (this.isVisibleInEditor_(block) && block.getRelativeToSurfaceXY().y < this.getFlyoutTopPosition())
};
...
Blockly.ContractEditor.prototype.setupUIForBlock_ = function(targetFunctionDefinitionBlock) {
  ...
  this.frameText_.textContent = isEditingVariable ? Blockly.Msg.FUNCTIONAL_VARIABLE_HEADER : Blockly.Msg.CONTRACT_EDITOR_HEADER;
...
Blockly.ContractEditor.prototype.setupSectionsForContract_ = function(autoOpenConfig) {
  this.allSections_.forEach(function(sectionView, sectionName) {
    if(autoOpenConfig) {
      ...
      sectionView.setCollapsed(sectionView.isCollapsed())
    }
  }, this);
...
Blockly.ContractEditor.prototype.addParameter = function(newParameterName, opt_newParameterType) {
  ...
  this.orderedParamIDsToBlocks_.set(newParameterID, this.newParameterBlock(newParameterName, opt_newParameterType));
...
Blockly.ContractEditor.prototype.addRangeEditor_ = function() {
  this.outputTypeSelector = new Blockly.TypeDropdown({onTypeChanged:goog.bind(this.outputTypeChanged_, this), typeChoices:USER_TYPE_CHOICES, type:this.functionDefinitionBlock.getOutputType() || Blockly.ContractEditor.DEFAULT_OUTPUT_TYPE});
...
Blockly.ContractEditor.prototype.onPlaceExampleContent = function(currentY) {
  ...
  if(exampleSectionVisible) {
    ...
    newY += blockSplitMargin;
    this.topHorizontalLine.setAttribute("transform", "translate(" + 0 + "," + newY + ")");
...
Blockly.mouseCoordinatesToSvg = function(clientX, clientY, target) {
  return Blockly.convertCoordinates(clientX + window.pageXOffset, clientY + window.pageYOffset, target, true)
};
Blockly.svgCoordinatesToViewport = function(coordinates, blockSpace) {
  var blockSpaceMetrics = blockSpace.getMetrics();
  return new goog.math.Coordinate(coordinates.x - blockSpaceMetrics.absoluteLeft, coordinates.y - blockSpaceMetrics.absoluteTop)
};
Blockly.viewportCoordinateToBlockSpace = function(coordinates, blockSpace) {
  var viewportBox = blockSpace.getViewportBox();
  return new goog.math.Coordinate(coordinates.x + viewportBox.left, coordinates.y + viewportBox.top)
};
...
Blockly.getBoxOverflow = function(outerBox, innerBox) {
  return new goog.math.Box(Math.max(0, outerBox.top - innerBox.top), Math.max(0, innerBox.right - outerBox.right), Math.max(0, innerBox.bottom - outerBox.bottom), Math.max(0, outerBox.left - innerBox.left))
};
Blockly.getPointBoxOverflow = function(outerBox, innerPoint) {
  return new goog.math.Box(outerBox.top - innerPoint.y, innerPoint.x - outerBox.right, innerPoint.y - outerBox.bottom, outerBox.left - innerPoint.x)
};
...
Blockly.svgRectToRect = function(svgRect) {
  return new goog.math.Rect(svgRect.x, svgRect.y, svgRect.width, svgRect.height)
};
...
Blockly.FieldTextInput.prototype.showEditor_ = function() {
  ...
  if(this.changeHandler_ === Blockly.FieldTextInput.numberValidator) {
    ...
    if(this.changeHandler_ === Blockly.FieldTextInput.nonnegativeIntegerValidator) {
      htmlInput.setAttribute("type", "number");
  ...
  htmlInput.onKeyUpWrapper_ = Blockly.bindEvent_(htmlInput, "keydown", this, function(e) {
    e.stopPropagation()
  });
...
Blockly.Generator.blockSpaceToCode = function(name, opt_typeFilter, opt_showHidden) {
  ...
  if(opt_typeFilter) {
    ...
    blocksToGenerate = goog.array.filter(Blockly.mainBlockSpace.getTopBlocks(true), function(block) {
...
Blockly.Css.Cursor = {OPEN:"handopen", CLOSED:"handclosed"};
Blockly.Css.currentCursor_ = "";
Blockly.Css.styleSheet_ = null;
Blockly.Css.inject = function(container) {
  var text = Blockly.Css.CONTENT.join("\n");
  text = text.replace(/%CONTAINER_ID%/g, container.id).replace(/%TREE_PATH%/g, Blockly.assetUrl("media/tree.png")).replace(/%CURSOR_OPEN_PATH%/g, Blockly.assetUrl("media/handopen.cur")).replace(/%CURSOR_CLOSED_PATH%/g, Blockly.assetUrl("media/handclosed.cur"));
...
".blocklyMutatorBackground {", "  fill: #fff;", "  stroke-width: 1;", "  stroke: #ddd;", "}", ".newFunctionDiv {", "  position: absolute;", "  top: 120px;", "  left: 600px;", "}", "#modalContainer .goog-flat-menu-button-caption {", "  color: #555555;", "  margin-left: 1px;", "  margin-right: 0;", "  min-width: 55px;", "}", ".blocklyContextMenuOptions>.blocklyMenuDiv,", ".blocklyContextMenuOptions>.blocklyMenuDivDisabled,", ".blocklyDropdownMenuOptions>.blocklyMenuDiv {", "  fill: #fff;", "}", ".blocklyContextMenuOptions>.blocklyMenuDiv:hover>rect,", 
...
"  fill: #fff;", "}", ".blocklyMenuDivDisabled>.blocklyMenuText {", "  fill: #ccc;", "}", ".blocklyFlyoutBackground {", "  fill: #ddd;", "  fill-opacity: 0.8;", "}", ".blocklyToolboxBackground {", "  fill: #ddd;", "}", ".blocklyBackground {", "  fill: #666;", "}", ".blocklyScrollbarBackground {", "  fill: #fff;", "  stroke-width: 1;", "  stroke: #e4e4e4;", "}", ".blocklyScrollbarKnob {", "  fill: #ccc;", "}", ".blocklyScrollbarBackground:hover+.blocklyScrollbarKnob,", ".blocklyScrollbarKnob:hover {", 
"  fill: #bbb;", "}", ".blocklyInvalidInput {", "  background: #faa;", "}", ".blocklyAngleCircle {", "  stroke: #444;", "  stroke-width: 1;", "  fill: #ddd;", "  fill-opacity: 0.8;", "}", ".blocklyAngleMarks {", "  stroke: #444;", "  stroke-width: 1;", "}", ".blocklyAngleGuage {", "  fill: #d00;", "  fill-opacity: 0.8;  ", "}", ".blocklyContextMenu {", "  border-radius: 4px;", "}", ".blocklyDropdownMenu {", "  padding: 0 !important;", "  position: relative !important;", "}", ".blocklyRectangularDropdownMenu .goog-menuitem {", 
"  height: 100%;", "  padding: 0 !important;", "  border-radius: 5px;", "  margin-bottom: 4px !important;", "}", ".fieldRectangularDropdownBackdrop {", "  fill: #fff;", "  fill-opacity: 0.6;", "}", ".blocklyRectangularDropdownArrow {", "  fill: #7965a1;", "  font-size: 20px !important;", "}", ".blocklyRectangularDropdownMenu .goog-menuitem-highlight, .goog-menuitem-hover {", "  border-color: #7965a1 !important;", "  border-style: dotted !important;", "  border-width: 0px !important;", "  margin: -4px -4px 0 !important;", 
"  border-width: 4px !important;", "  border-style: solid !important;", "  padding-bottom: 0px !important;", "  padding-top: 0px !important;", "}", ".colored-type-dropdown .goog-menuitem-content {", "  color: #555555;", "  float: left;", "}", ".colored-type-dropdown > .goog-menuitem {", "  padding: 0px 40px 2px 13px;", "}", ".goog-menu {", "  box-shadow: 4px 4px 6px #bbb;", "  border-width: 2px;", "}", ".goog-menuitem {", "  height: 20px;", "  padding-top: 0;", "  padding-bottom: 0;", "}", ".goog-menuitem-highlight,", 
".goog-menuitem-hover {", "  border-width: 0;", "  background-color: #57e;", "}", ".goog-menuitem-highlight .goog-menuitem-content {", "  color: #fff;", "}", ".goog-option-selected .goog-menuitem-checkbox:before {", '  content: "\u2713";', "}", ".goog-menuitem-checkbox {", '  background: ""', "}", ".blocklyRectangularDropdownMenu img {", "  -webkit-border-radius: 5px;", "  -moz-border-radius: 5px;", "  border-radius: 5px;", "}", ".blocklyRectangularDropdownMenu {", "  border-radius: 5px;", "  box-shadow: none !important;", 
"}", ".goog-option-selected .goog-menuitem-checkbox,", ".goog-option-selected .goog-menuitem-icon {", "}", "/* Category tree in Toolbox. */", ".blocklyToolboxDiv {", "  display: none;", "  overflow-x: visible;", "  overflow-y: auto;", "  position: absolute;", "}", ".blocklyTreeRoot {", "  padding: 4px 0;", "}", ".blocklyTreeRoot:focus {", "  outline: none;", "}", ".blocklyTreeRow {", "  line-height: 22px;", "  height: 22px;", "  padding-right: 1em;", "  white-space: nowrap;", "}", '.blocklyToolboxDiv[dir="RTL"] .blocklyTreeRow {', 
...
"  padding: 0 3px;", "  vertical-align: middle;", "  -moz-user-select: none;", "  -webkit-user-select: none;", "  -ms-user-select: none;", "  user-select: none;", "}", ".blocklyTreeSelected {", "  background-color: #57e !important;", "}", ".blocklyTreeSelected .blocklyTreeLabel {", "  color: #fff;", "}", ".blocklyArrow {", "  font-size: 80%;", "}", ".paramToolbox {", "  padding: 0 0 5px 0;", "  pointer-events: auto;", "}", ".paramToolbox input, .paramToolbox textarea {", "  box-sizing: border-box;", 
"  width: 100%;", "  margin: 0;", "  resize: none;", "}", ".paramToolbox input, .paramToolbox button {", "  height: 30px;", "  margin: 0;", "}", ".paramToolbox div {", "  margin: 4px 10px;", "}", "#modalContainer {", "  position: absolute;", "  width: 100%;", "  bottom: 0;", "}", "#modalContainer > svg {", "  position: absolute;", "  top: 0;", "  left: 0;", "  background: transparent;", "  pointer-events: none;", "}", "#modalContainer > svg * {", "  pointer-events: visiblePainted;", "}", "/*", " * Copyright 2007 The Closure Library Authors. All Rights Reserved.", 
" *", " * Use of this source code is governed by the Apache License, Version 2.0.", " * See the COPYING file for details.", " */", "/* Author: pupius@google.com (Daniel Pupius) */", "/*", " Styles to make the colorpicker look like the old gmail color picker", " NOTE: without CSS scoping this will override styles defined in palette.css", "*/", ".goog-palette {", "  outline: none;", "  cursor: default;", "}", ".goog-palette-table {", "  border: 1px solid #666;", "  border-collapse: collapse;", "}", 
".goog-palette-cell {", "  height: 25px;", "  width: 25px;", "  margin: 0;", "  border: 0;", "  text-align: center;", "  vertical-align: middle;", "  border-right: 1px solid #666;", "  font-size: 1px;", "}", ".goog-palette-colorswatch {", "  position: relative;", "  height: 25px;", "  width: 25px;", "  border: 1px solid #666;", "}", ".goog-palette-cell-hover .goog-palette-colorswatch {", "  border: 1px solid #FFF;", "}", ".goog-palette-cell-selected .goog-palette-colorswatch {", "  border: 1px solid #000;", 
"  color: #fff;", "}", ".goog-menu {", "  background: #fff;", "  border-color: #ccc #666 #666 #ccc;", "  border-style: solid;", "  border-width: 1px;", "  cursor: default;", "  font: normal 13px Arial, sans-serif;", "  margin: 0;", "  outline: none;", "  padding: 4px 0;", "  position: absolute;", "  z-index: 20000;", "}", ".goog-menuitem {", "  color: #000;", "  font: normal 13px Arial, sans-serif;", "  list-style: none;", "  margin: 0;", "  padding: 4px 7em 4px 28px;", "  white-space: nowrap;", 
...
Blockly.FieldParameter = function(varname, opt_changeHandler, opt_createHandler) {
  Blockly.FieldParameter.superClass_.constructor.call(this, varname, Blockly.FieldParameter.dropdownChange, Blockly.FieldParameter.dropdownCreate)
};
goog.inherits(Blockly.FieldParameter, Blockly.FieldVariable);
Blockly.FieldParameter.dropdownCreate = function() {
  var variableList = [Blockly.Msg.RENAME_PARAMETER, Blockly.Msg.DELETE_PARAMETER];
  var options = [];
  for(var x = 0;x < variableList.length;x++) {
    options[x] = [variableList[x], variableList[x]]
  }
