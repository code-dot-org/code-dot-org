...
Blockly.Trashcan.prototype.setOpen_ = function(state) {
  ...
  this.isOpen = state;
  this.animateLid_();
  Blockly.Css.setCursor(state ? Blockly.Css.Cursor.DELETE : Blockly.Css.Cursor.CLOSED)
};
...
Blockly.Css.setCursor = function(cursor) {
  ...
  var rule = ".blocklyDraggable {\n" + " cursor: url(" + Blockly.assetUrl("media/" + cursor + ".cur") + ")" + " " + xy + ", auto;\n}\n";
  var ruleIndex = 1;
...
"  fill: #fff;", "}", ".blocklyMenuDivDisabled>.blocklyMenuText {", "  fill: #ccc;", "}", ".blocklyFlyoutBackground {", "  fill: #ddd;", "  fill-opacity: 0.8;", "}", ".blocklyBackground {", "  fill: #666;", "}", ".blocklyScrollbarBackground {", "  fill: #fff;", "  stroke-width: 1;", "  stroke: #e4e4e4;", "}", ".blocklyScrollbarKnob {", "  fill: #ccc;", "}", ".blocklyScrollbarBackground:hover+.blocklyScrollbarKnob,", ".blocklyScrollbarKnob:hover {", "  fill: #bbb;", "}", ".blocklyInvalidInput {", 
