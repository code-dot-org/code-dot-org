...
Blockly.BlockSvg.prototype.renderDraw_ = function(iconWidth, inputRows) {
  ...
  var steps = {core:[], inline:[], highlight:[], highlightInline:[]};
...
Blockly.BlockSvg.prototype.renderDrawTop_ = function(steps, connectionsXY, rightEdge) {
  if(this.squareTopLeftCorner_) {
    ...
    steps.highlight.push(Blockly.RTL ? BS.TOP_LEFT_CORNER_START_HIGHLIGHT_RTL : BS.TOP_LEFT_CORNER_START_HIGHLIGHT_LTR);
...
Blockly.BlockSvg.prototype.renderDrawRight_ = function(steps, connectionsXY, inputRows, iconWidth) {
  var cursorX;
  var cursorY = 0;
    ...
    if(this.block_.isCollapsed()) {
      ...
      if(row.type == BS.INLINE) {
        for(var x = 0, input;input = row[x];x++) {
          ...
          if(input.type == Blockly.INPUT_VALUE) {
            steps.inline.push("M", cursorX - BS.SEP_SPACE_X + "," + (cursorY + BS.INLINE_PADDING_Y));
            steps.inline.push("h", BS.TAB_WIDTH - input.renderWidth);
            steps.inline.push(BS.TAB_PATH_DOWN);
            steps.inline.push("v", input.renderHeight - BS.TAB_HEIGHT);
            steps.inline.push("h", input.renderWidth - BS.TAB_WIDTH);
            steps.inline.push("z");
            if(Blockly.RTL) {
              steps.highlightInline.push("M", cursorX - BS.SEP_SPACE_X + BS.TAB_WIDTH - input.renderWidth - 1 + "," + (cursorY + BS.INLINE_PADDING_Y + 1));
              ...
              steps.highlightInline.push("M", cursorX - BS.SEP_SPACE_X + 1 + "," + (cursorY + BS.INLINE_PADDING_Y + 1));
              steps.highlightInline.push("v", input.renderHeight);
              steps.highlightInline.push("h", BS.TAB_WIDTH - input.renderWidth);
              steps.highlightInline.push("M", cursorX - input.renderWidth - BS.SEP_SPACE_X + 3.8 + "," + (cursorY + BS.INLINE_PADDING_Y + BS.TAB_HEIGHT - 0.4));
              steps.highlightInline.push("l", BS.TAB_WIDTH * 0.42 + ",-1.8")
            }
            connectionX = connectionsXY.x + oppositeIfRTL(cursorX + BS.TAB_WIDTH - BS.SEP_SPACE_X - input.renderWidth + 1);
            connectionY = connectionsXY.y + cursorY + BS.INLINE_PADDING_Y;
        ...
        if(row.type == Blockly.INPUT_VALUE) {
          ...
          if(Blockly.RTL) {
            ...
            steps.highlight.push("M", inputRows.rightEdge - 4.2 + "," + (cursorY + BS.TAB_HEIGHT - 0.4));
          ...
          if(row.type == Blockly.DUMMY_INPUT) {
            ...
            if(row.type == Blockly.NEXT_STATEMENT) {
              ...
              if(Blockly.RTL) {
                steps.highlight.push("M", cursorX - BS.NOTCH_WIDTH + BS.DISTANCE_45_OUTSIDE + "," + (cursorY + BS.DISTANCE_45_OUTSIDE));
                ...
                steps.highlight.push("M", cursorX - BS.NOTCH_WIDTH + BS.DISTANCE_45_OUTSIDE + "," + (cursorY + row.height - BS.DISTANCE_45_OUTSIDE));
...
Blockly.BlockSvg.prototype.renderDrawBottom_ = function(steps, connectionsXY, cursorY) {
  ...
  if(this.squareBottomLeftCorner_) {
    ...
    steps.core.push("a", BS.CORNER_RADIUS + "," + BS.CORNER_RADIUS + " 0 0,1 -" + BS.CORNER_RADIUS + ",-" + BS.CORNER_RADIUS);
    if(!Blockly.RTL) {
      steps.highlight.push("M", BS.DISTANCE_45_INSIDE + "," + (cursorY - BS.DISTANCE_45_INSIDE));
      steps.highlight.push("A", BS.CORNER_RADIUS - 1 + "," + (BS.CORNER_RADIUS - 1) + " 0 0,1 " + "1," + (cursorY - BS.CORNER_RADIUS))
    }
  }
};
Blockly.BlockSvg.prototype.renderDrawLeft_ = function(steps, connectionsXY, cursorY) {
  if(this.block_.outputConnection) {
    ...
    steps.core.push("c 0,-10 -" + BS.TAB_WIDTH + ",8 -" + BS.TAB_WIDTH + ",-7.5 s " + BS.TAB_WIDTH + ",2.5 " + BS.TAB_WIDTH + ",-7.5");
    if(Blockly.RTL) {
      ...
      steps.highlight.push("m", BS.TAB_WIDTH * -0.92 + ",-1 q " + BS.TAB_WIDTH * -0.19 + ",-5.5 0,-11");
      steps.highlight.push("m", BS.TAB_WIDTH * 0.92 + ",1 V 1 H 2")
    }
  }else {
    if(!Blockly.RTL) {
      if(this.squareTopLeftCorner_) {
