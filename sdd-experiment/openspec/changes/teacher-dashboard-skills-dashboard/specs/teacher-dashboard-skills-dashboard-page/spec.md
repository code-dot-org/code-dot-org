...
The component's data requests SHALL be recorded at implementation start
(the contract is unpinned today) and consumed through typed wrappers with
MSW handlers. The move copies at a recorded legacy SHA with a divergence
