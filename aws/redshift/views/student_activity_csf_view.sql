DROP VIEW IF EXISTS analysis.student_activity_csf_view CASCADE;
...
GRANT INSERT, TRIGGER, UPDATE, REFERENCES, RULE, DELETE, SELECT ON analysis.student_activity_csf_view TO dev;
GRANT SELECT ON analysis.student_activity_csf_view TO GROUP reader_pii;
GRANT REFERENCES, TRIGGER, UPDATE, SELECT, INSERT, RULE, DELETE ON analysis.student_activity_csf_view TO GROUP admin;
