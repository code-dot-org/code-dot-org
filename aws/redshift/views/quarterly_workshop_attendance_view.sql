...
GRANT ALL PRIVILEGES ON analysis.quarterly_workshop_attendance_view TO GROUP admin;
GRANT SELECT ON analysis.quarterly_workshop_attendance_view TO GROUP reader, GROUP reader_pii;
