select top 10 * from student_activity_csp_csd_view;
...
GRANT ALL PRIVILEGES ON analysis.student_activity_csp_csd_view TO GROUP admin;
GRANT SELECT ON analysis.student_activity_csp_csd_view  TO GROUP reader, GROUP reader_pii;
