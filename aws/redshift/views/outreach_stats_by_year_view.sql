...
GRANT ALL PRIVILEGES ON analysis.outreach_stats_by_year_view TO GROUP admin;
GRANT SELECT ON analysis.outreach_stats_by_year_view TO GROUP reader, GROUP reader_pii;
