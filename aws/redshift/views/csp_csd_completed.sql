...
(
  ...
  from
  (
    select us.user_id, c.name course_name, school_year, sc.name script_name, us.stage_id, us.started_at, row_number() over(partition by us.user_id, sc.name order by us.started_at asc) stage_order
