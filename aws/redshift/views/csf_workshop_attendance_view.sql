DROP VIEW IF EXISTS analysis.csf_workshop_attendance_view CASCADE;
...
GRANT INSERT, TRIGGER, UPDATE, REFERENCES, RULE, DELETE, SELECT ON analysis.csf_workshop_attendance_view TO dev;
GRANT SELECT ON analysis.csf_workshop_attendance_view TO GROUP reader_pii;
GRANT REFERENCES, TRIGGER, UPDATE, SELECT, INSERT, RULE, DELETE ON analysis.csf_workshop_attendance_view TO GROUP admin;
