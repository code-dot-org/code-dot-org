DROP VIEW IF EXISTS analysis.teacher_most_progress_csf_view CASCADE;
...
GRANT INSERT, TRIGGER, UPDATE, REFERENCES, RULE, DELETE, SELECT ON analysis.teacher_most_progress_csf_view TO dev;
GRANT SELECT ON analysis.teacher_most_progress_csf_view TO GROUP reader_pii;
GRANT REFERENCES, TRIGGER, UPDATE, SELECT, INSERT, RULE, DELETE ON analysis.teacher_most_progress_csf_view TO GROUP admin;
