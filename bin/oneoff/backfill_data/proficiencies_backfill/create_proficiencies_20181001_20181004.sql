CREATE TABLE user_proficiencies_20181001_20181004 AS
SELECT
  user_levels.user_id,
...
WHERE user_levels.best_result = 100
  AND user_levels.script_id IN (297, 301, 307, 302, 309, 310, 303)
  AND user_levels.id > 1656800000
  AND user_levels.id < 1670000000
  AND user_levels.created_at > "2018-10-01"
  AND user_levels.created_at < "2018-10-04"
