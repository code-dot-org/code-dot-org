CREATE TABLE user_proficiencies_20181201_20181214 AS
SELECT
  user_levels.user_id,
...
WHERE user_levels.best_result = 100
  ...
  AND user_levels.id > 1797000000
  AND user_levels.id < 1844425643
  AND user_levels.created_at > "2018-12-01"
  AND user_levels.created_at < "2018-12-14"
