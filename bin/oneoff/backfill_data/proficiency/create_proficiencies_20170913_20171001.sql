...
CREATE TABLE user_proficiencies_20170913_20171001 AS
SELECT
  user_levels.user_id,
...
WHERE user_levels.best_result = 100
  ...
  AND user_levels.id > 1090000000
  AND user_levels.id < 1120000000
  AND user_levels.created_at > "2017-09-13"
  AND user_levels.created_at < "2017-10-01"
