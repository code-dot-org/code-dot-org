CREATE TABLE user_proficiencies_20190801_20190901 AS
SELECT
  user_levels.user_id,
...
WHERE user_levels.best_result = 100
  ...
  AND user_levels.id > 2199900000
  AND user_levels.id < 2225000000
  AND user_levels.created_at > "2019-08-01"
  AND user_levels.created_at < "2019-09-01"
