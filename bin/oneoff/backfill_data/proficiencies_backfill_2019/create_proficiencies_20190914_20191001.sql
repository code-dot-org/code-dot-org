CREATE TABLE user_proficiencies_20190914_20191001 AS
SELECT
  user_levels.user_id,
...
WHERE user_levels.best_result = 100
  ...
  AND user_levels.id > 2247900000
  AND user_levels.id < 2282000000
  AND user_levels.created_at > "2019-09-14"
  AND user_levels.created_at < "2019-10-01"
