...
args=(
  ...
  --alter="ADD UNIQUE index_user_scripts_on_user_script_unit_group_deleted_unique (user_id, script_id, unit_group_id, deleted_at), DROP INDEX index_user_scripts_on_user_id_and_script_id_and_deleted_at"
