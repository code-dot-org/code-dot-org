...
class I18nMetricsTest < Minitest::Test
  ...
  def test_report_runtime
    ...
    expect_metric(:Runtime, test_time.in_milliseconds.to_i, [{name: 'MethodName', value: 'method'}, {name: 'SyncComp', value: 'component'}, {name: 'Environment', value: :test}, {name: 'MachineId', value: 'local_machine'}], 'Seconds')
