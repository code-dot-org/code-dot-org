...
describe I18n::Utils::SyncUpBase do
  ...
  describe '#source_files' do
    ...
    let(:i18n_source_dir_path) {'/i18n/locales/sources/'}
    let(:expected_i18n_source_file_path) {File.join(i18n_source_dir_path, 'i18n_source_file.json')}
    let(:unexpected_i18n_source_file_path) {File.join(i18n_source_dir_path, 'i18n_source_file.yaml')}
    ...
    it 'returns existing i18n source file paths from source paths config' do
