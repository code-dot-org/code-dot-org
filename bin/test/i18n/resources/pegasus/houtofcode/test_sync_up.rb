...
require_relative '../../../../../i18n/resources/pegasus/hourofcode/sync_up'

describe I18n::Resources::Pegasus::HourOfCode::SyncUp do
  let(:described_class) {I18n::Resources::Pegasus::HourOfCode::SyncUp}
  ...
  describe '#source_files' do
    ...
    let(:expected_source_files) do
      [
        CDO.dir('i18n/locales/source/hourofcode/en.yml'),
        CDO.dir('i18n/locales/source/hourofcode/activity-guidelines.md'),
        CDO.dir('i18n/locales/source/hourofcode/promote/index.md'),
      ]
    end

    let(:unexpected_source_files) do
      [
        CDO.dir('i18n/locales/source/hourofcode/unexpected.json'),
        CDO.dir('i18n/locales/source/hourofcode/unexpected.yaml'),
        CDO.dir('i18n/locales/source/hourofcode/unexpected.yml'),
      ]
    end
