...
require_relative '../../../../../i18n/resources/dashboard/blocks/sync_up'

describe I18n::Resources::Dashboard::Blocks::SyncUp do
  let(:described_class) {I18n::Resources::Dashboard::Blocks::SyncUp}
