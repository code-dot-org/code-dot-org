...
require_relative '../../../../../i18n/resources/dashboard/devise_content/sync_up'

describe I18n::Resources::Dashboard::DeviseContent::SyncUp do
  let(:described_class) {I18n::Resources::Dashboard::DeviseContent::SyncUp}
  ...
  describe '#source_files' do
    ...
    let(:expected_source_files) do
      [
        CDO.dir('i18n/locales/source/dashboard/devise.yml'),
      ]
    end
