...
require_relative '../../../../../i18n/resources/dashboard/course_offerings/sync_up'

describe I18n::Resources::Dashboard::CourseOfferings::SyncUp do
  let(:described_class) {I18n::Resources::Dashboard::CourseOfferings::SyncUp}
