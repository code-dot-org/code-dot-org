...
require_relative '../../../../../i18n/resources/dashboard/curriculum_content/sync_up'

describe I18n::Resources::Dashboard::CurriculumContent::SyncUp do
  let(:described_class) {I18n::Resources::Dashboard::CurriculumContent::SyncUp}
  ...
  describe '#source_files' do
    ...
    let(:expected_source_files) do
      [
        CDO.dir('i18n/locales/source/curriculum_content/2017/csd/csd1-2017.json'),
      ]
    end
