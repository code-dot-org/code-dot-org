...
require_relative '../../../../../i18n/resources/dashboard/slides/sync_up'

describe I18n::Resources::Dashboard::Slides::SyncUp do
  let(:described_class) {I18n::Resources::Dashboard::Slides::SyncUp}
  ...
  describe '#source_files' do
    ...
    let(:expected_source_files) do
      [
        CDO.dir('i18n/locales/source/dashboard/slides.yml'),
      ]
    end
