...
require_relative '../../../../../i18n/resources/dashboard/standards/sync_up'

describe I18n::Resources::Dashboard::Standards::SyncUp do
  let(:described_class) {I18n::Resources::Dashboard::Standards::SyncUp}
  ...
  describe '#source_files' do
    ...
    let(:expected_source_files) do
      [
        CDO.dir('i18n/locales/source/standards/ai4k12-2021.json'),
      ]
    end
