...
require_relative '../../../../../i18n/resources/dashboard/course_content/sync_up'

describe I18n::Resources::Dashboard::CourseContent::SyncUp do
  let(:described_class) {I18n::Resources::Dashboard::CourseContent::SyncUp}
  ...
  describe '#source_files' do
    ...
    let(:expected_source_files) do
      [
        CDO.dir('i18n/locales/source/course_content/2017/coursea-2017.json'),
        CDO.dir('i18n/locales/source/course_content/projects.json'),
        CDO.dir('i18n/locales/source/dashboard/block_categories.yml'),
        CDO.dir('i18n/locales/source/dashboard/progressions.yml'),
        CDO.dir('i18n/locales/source/dashboard/parameter_names.yml'),
        CDO.dir('i18n/locales/source/dashboard/variable_names.yml'),
      ]
    end
