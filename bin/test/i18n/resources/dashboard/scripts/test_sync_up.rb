...
require_relative '../../../../../i18n/resources/dashboard/scripts/sync_up'

describe I18n::Resources::Dashboard::Scripts::SyncUp do
  let(:described_class) {I18n::Resources::Dashboard::Scripts::SyncUp}
  ...
  describe '#source_files' do
    ...
    let(:expected_source_files) do
      [
        CDO.dir('i18n/locales/source/dashboard/scripts.yml'),
      ]
    end
