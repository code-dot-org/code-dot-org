...
require_relative '../../../../../i18n/resources/dashboard/restricted_content/sync_up'

describe I18n::Resources::Dashboard::RestrictedContent::SyncUp do
  let(:described_class) {I18n::Resources::Dashboard::RestrictedContent::SyncUp}
  ...
  describe '#source_files' do
    ...
    let(:expected_source_files) do
      [
        CDO.dir('i18n/locales/source/dashboard/restricted.yml'),
      ]
    end
