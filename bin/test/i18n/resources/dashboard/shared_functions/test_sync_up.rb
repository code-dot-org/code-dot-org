...
require_relative '../../../../../i18n/resources/dashboard/shared_functions/sync_up'

describe I18n::Resources::Dashboard::SharedFunctions::SyncUp do
  let(:described_class) {I18n::Resources::Dashboard::SharedFunctions::SyncUp}
  ...
  describe '#source_files' do
    ...
    let(:expected_source_files) do
      [
        CDO.dir('i18n/locales/source/dashboard/shared_functions.yml'),
      ]
    end
