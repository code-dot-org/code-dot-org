...
require_relative '../../../../../i18n/resources/dashboard/docs/sync_up'

describe I18n::Resources::Dashboard::Docs::SyncUp do
  let(:described_class) {I18n::Resources::Dashboard::Docs::SyncUp}
  ...
  describe '#source_files' do
    ...
    let(:expected_source_files) do
      [
        CDO.dir('i18n/locales/source/docs/applab.json'),
      ]
    end
