...
require_relative '../../../../../i18n/resources/dashboard/base_content/sync_up'

describe I18n::Resources::Dashboard::BaseContent::SyncUp do
  let(:described_class) {I18n::Resources::Dashboard::BaseContent::SyncUp}
  ...
  describe '#source_files' do
    ...
    let(:expected_source_files) do
      [
        CDO.dir('i18n/locales/source/dashboard/base.yml'),
      ]
    end
