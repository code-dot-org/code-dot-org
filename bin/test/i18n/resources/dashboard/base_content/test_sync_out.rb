...
require_relative '../../../../../i18n/resources/dashboard/base_content/sync_out'

describe I18n::Resources::Dashboard::BaseContent::SyncOut do
  let(:described_class) {I18n::Resources::Dashboard::BaseContent::SyncOut}
  let(:described_instance) {described_class.new}

  let(:i18n_locale) {'expected_i18n_locale'}
  let(:language) {{locale_s: i18n_locale}}

  let(:crowdin_file_path) {CDO.dir('i18n/crowdin', i18n_locale, "dashboard/base.yml")}
  let(:i18n_file_path) {CDO.dir('i18n/locales', i18n_locale, "dashboard/base.yml")}
  let(:target_i18n_file_path) {CDO.dir('dashboard/config/locales/base', "#{i18n_locale}.yml")}
