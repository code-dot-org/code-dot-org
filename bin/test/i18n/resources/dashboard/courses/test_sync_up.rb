...
require_relative '../../../../../i18n/resources/dashboard/courses/sync_up'

describe I18n::Resources::Dashboard::Courses::SyncUp do
  let(:described_class) {I18n::Resources::Dashboard::Courses::SyncUp}
  ...
  describe '#source_files' do
    ...
    let(:expected_source_files) do
      [
        CDO.dir('i18n/locales/source/dashboard/courses.yml'),
      ]
    end
