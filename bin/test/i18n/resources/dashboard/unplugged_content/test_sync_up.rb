...
require_relative '../../../../../i18n/resources/dashboard/unplugged_content/sync_up'

describe I18n::Resources::Dashboard::UnpluggedContent::SyncUp do
  let(:described_class) {I18n::Resources::Dashboard::UnpluggedContent::SyncUp}
  ...
  describe '#source_files' do
    ...
    let(:expected_source_files) do
      [
        CDO.dir('i18n/locales/source/dashboard/unplugged.yml'),
      ]
    end
