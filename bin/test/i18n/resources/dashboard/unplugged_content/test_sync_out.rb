...
require_relative '../../../../../i18n/resources/dashboard/unplugged_content/sync_out'

describe I18n::Resources::Dashboard::UnpluggedContent::SyncOut do
  let(:described_class) {I18n::Resources::Dashboard::UnpluggedContent::SyncOut}
  ...
  let(:crowdin_file_path) {CDO.dir('i18n/locales', crowdin_locale, "dashboard/unplugged.yml")}
  let(:i18n_file_path) {CDO.dir('i18n/locales', i18n_locale, "dashboard/unplugged.yml")}
  let(:target_i18n_file_path) {CDO.dir('dashboard/config/locales', "unplugged.#{i18n_locale}.yml")}
