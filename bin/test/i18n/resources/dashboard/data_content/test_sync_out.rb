...
require_relative '../../../../../i18n/resources/dashboard/data_content/sync_out'

describe I18n::Resources::Dashboard::DataContent::SyncOut do
  let(:described_class) {I18n::Resources::Dashboard::DataContent::SyncOut}
  ...
  let(:crowdin_file_path) {CDO.dir('i18n/locales', crowdin_locale, "dashboard/data.yml")}
  let(:i18n_file_path) {CDO.dir('i18n/locales', i18n_locale, "dashboard/data.yml")}
  let(:target_i18n_file_path) {CDO.dir('dashboard/config/locales', "data.#{i18n_locale}.yml")}
