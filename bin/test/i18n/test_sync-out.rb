  ...
  describe '.perform' do
    it 'sync-out I18n resources' do
      I18n::SyncOut.stub_const(:CROWDIN_PROJECTS, 'expected_CROWDIN_PROJECTS') do
        ...
        I18nScriptUtils.expects(:run_standalone_script).with('dashboard/scripts/update_tts_i18n.rb').in_sequence(execution_sequence)
        I18nScriptUtils.expects(:run_standalone_script).with('dashboard/scripts/update_tts_i18n_static_messages.rb').in_sequence(execution_sequence)
