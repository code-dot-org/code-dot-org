        ...
        class SyncOut < I18n::Utils::SyncOutBase
          def process(language)
            ...
            unless I18nScriptUtils.source_lang?(language)
              ...
              target_i18n_file_path = File.join(ORIGIN_I18N_DIR_PATH, "unplugged.#{language[:locale_s]}.yml")
...
I18n::Resources::Dashboard::UnpluggedContent::SyncOut.perform if __FILE__ == $0
