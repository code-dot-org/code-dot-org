  ...
  module Resources
    module Apps
      module ExternalSources
        ...
        ML_ACTIVITIES_FILE_NAME = 'oceans.json'
        ML_ACTIVITIES_DIR_NAME = 'ml-activities'.freeze
        ML_ACTIVITIES_I18N_SOURCE_DIR = File.join(I18N_SOURCE_DIR_PATH, ML_ACTIVITIES_DIR_NAME).freeze
