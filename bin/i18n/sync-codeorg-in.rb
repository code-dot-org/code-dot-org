    ...
    Script.all.each do |script|
      ...
      script.levels.each do |level|
        level.contained_levels.each do |contained_level|
          i18n_strings.deep_merge! get_dsl_i18n_strings(contained_level)
        end

        i18n_strings.deep_merge! get_dsl_i18n_strings(level)
      end
    end
  end
