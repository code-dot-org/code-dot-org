...
```bash
bin/curriculum/export/export_unit_progress.rb -u unit-name -o unit-name-and-date-range
```
...
```bash
bin/curriculum/export/add_unit_source.rb -i unit-name-and-date-range
```
