...
1. Install **Git LFS**
    ...
    1. From your homedir, run: `git lfs install`
       ...
       - Note: the install command must be run from **outside** a git repo directory. If you run it from inside a git repo, it'll instead attempt to install git hooks in that repo.
