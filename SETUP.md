...
9. Install **Ruby 2.7.2**
    1. For non-M1 systems, `rbenv install 2.7.2` should be sufficient
...
1. Install Ruby 2.7.2
    ...
    1. Set the global version of Ruby: `rbenv global 2.7.2`
...
1. Install Ruby 2.7.2 with rbenv
    1. `rbenv install 2.7.2`
