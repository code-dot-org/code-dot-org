...
1. fix your database charset, collation, and timezone to match our servers
    ...
    - `ALTER DATABASE dashboard_development CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci;`
    - `ALTER DATABASE dashboard_test CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci;`
