...
2. ${
      healStatus === 'green'
        ? `Green gate — flip the spec's JSDoc "Migration status: PORTING" to "COMPLETED". ` +
          ...
          `\n     git add ${featureFile}`
        : `Fixme — leave the spec's "Migration status" as FIXME and DO NOT tag or modify the ` +
          `Cucumber feature; it stays untouched for human review and is NOT counted as migrated.`
    }
