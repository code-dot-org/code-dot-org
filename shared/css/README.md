...
3. Once you've downloaded the kit, **update the relative paths**
   for font files listed in CSS to be absolute paths to URLs storing the font files, rather than relative paths.
...
5. **[Only necessary if starting from scratch, should apply by default to new uploads] Update CORS configuration on `cdo-dsco` bucket**
