...
class StateAbbrTest < Minitest::Test
  ...
  def test_get_us_state_from_abbr_nonstate
    ...
    assert_nil get_us_state_from_abbr(:ZZ, include_dc: false)
    assert_nil get_us_state_from_abbr(:ZZ, include_dc: true)
  end

  def test_get_us_state_from_abbr_with_include_dc
    assert_equal 'Illinois', get_us_state_from_abbr(:IL, include_dc: false)
    assert_equal 'Illinois', get_us_state_from_abbr(:IL, include_dc: true)
    assert_equal 'Washington', get_us_state_from_abbr(:WA, include_dc: false)
    assert_equal 'Washington', get_us_state_from_abbr(:WA, include_dc: true)
  end
  ...
  def test_get_us_state_from_abbr_washington_dc
    ...
    assert_nil get_us_state_from_abbr(:dc, include_dc: false)
    assert_nil get_us_state_from_abbr(:DC, include_dc: false)
    assert_nil get_us_state_from_abbr('dc', include_dc: false)
    assert_nil get_us_state_from_abbr('DC', include_dc: false)
  ...
  def test_get_us_state_abbr_from_name_nonstate
    ...
    assert_nil get_us_state_abbr_from_name('Nonexistent', include_dc: false)
    assert_nil get_us_state_abbr_from_name('Nonexistent', include_dc: true)
  end

  def test_get_us_state_abbr_from_name_with_include_dc
    assert_equal 'IL', get_us_state_abbr_from_name('Illinois', include_dc: false)
    assert_equal 'IL', get_us_state_abbr_from_name('Illinois', include_dc: true)
    assert_equal 'WA', get_us_state_abbr_from_name('Washington', include_dc: false)
    assert_equal 'WA', get_us_state_abbr_from_name('Washington', include_dc: true)
  end
  ...
  def test_get_us_state_abbr_from_name_washington_dc
    ...
    assert_nil get_us_state_abbr_from_name(:washington_dc, include_dc: false)
    assert_nil get_us_state_abbr_from_name(:WASHINGTON_DC, include_dc: false)
    assert_nil get_us_state_abbr_from_name('Washington DC', include_dc: false)
    assert_nil get_us_state_abbr_from_name('WASHINGTON DC', include_dc: false)

    assert_equal 'DC', get_us_state_abbr_from_name(:washington_dc, include_dc: true)
    assert_equal 'DC', get_us_state_abbr_from_name(:WASHINGTON_DC, include_dc: true)
    assert_equal 'DC', get_us_state_abbr_from_name('Washington DC', include_dc: true)
    assert_equal 'DC', get_us_state_abbr_from_name('WASHINGTON DC', include_dc: true)
  end
  ...
  def test_get_us_state_abbr
    ...
    # With DC option
    assert_equal 'DC', get_us_state_abbr('Washington DC', include_dc: true)
    assert_equal 'DC', get_us_state_abbr('dc', include_dc: true)
    assert_nil get_us_state_abbr('Washington DC', include_dc: false)
    assert_nil get_us_state_abbr('dc', include_dc: false)
  end
