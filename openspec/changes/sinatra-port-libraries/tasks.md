...
fully quota-capable, alias pattern established). CSRF-rejection tests MUST
run inside the foundation forgery-protection helper; filename routes need
`format: false` (see prior phases).
