...
description: Use when writing Playwright tests, fixing flaky tests, debugging failures, implementing Page Object Model, configuring CI/CD (GitHub Actions), optimizing performance, mocking APIs, handling authentication, testing accessibility (axe-core), file uploads/downloads, WebSockets, geolocation, permissions, multi-tab/popup flows, error handling, multi-user collaboration, console error monitoring, global setup/teardown, test annotations (skip, fixme, slow), test tags (@smoke, @fast, @critical, filtering with --grep), project dependencies, iframes, canvas/WebGL, service workers/PWA, i18n/localization, and visual regression. Covers E2E, API, visual, and accessibility testing.
license: MIT
metadata:
  author: currents.dev
  version: "1.1"
...
**When to use**: Setting up projects, configuring CI/CD (GitHub Actions), optimizing performance
