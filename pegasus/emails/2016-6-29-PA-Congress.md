...
Computing jobs are now the #1 source of all new wages in the US. There are 19,613 computing jobs open in Pennsylvania right now, and the average salary for these jobs is over $83,000 — significantly higher than the average for all other occupations. 
