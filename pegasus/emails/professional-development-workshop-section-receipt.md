...
Code.org is offering $50 off [**Dash robots**](https://store.makewonder.com/). These hands-on learning tools reinforce CS concepts taught in Code.org's CS Fundamentals curriculum, like events and loops. [Learn more](https://store.makewonder.com/). *Valid March 1st-31st, 2016 only. Limited to first 1,000 people.*

**Redemption code for robots: CODE1389M**   
*Valid March 1-31st, 2016 only.*
