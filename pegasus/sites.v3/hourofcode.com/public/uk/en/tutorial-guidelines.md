...
# Tutorial guidelines for the Hour of Code

Code.org will host a variety of Hour of Code activities on the Code.org, Hour of Code, and CSEdWeek  website(s). The current list is at [uk.code.org/learn](http://uk.code.org/learn).
