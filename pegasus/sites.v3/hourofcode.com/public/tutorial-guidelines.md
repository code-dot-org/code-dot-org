...
Code.org will host a variety of Hour of Code activities on the Code.org, Hour of Code, and CSEdWeek  website(s). The current list is at <a href="http://<%= codeorg_url() %>/learn"><%= codeorg_url() %></a>.
