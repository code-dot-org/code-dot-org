...
Ennek a legjobb módja az e-mail. Lehetőleg legyen rövid és lényegre törő: miért érdemes odafigyelni erre az eseményre? Include contact information (including a cellphone number) for who will be on site at the event. **See a [sample pitch to media](<%= hoc_uri('/resources#sample-emails') %>):**
