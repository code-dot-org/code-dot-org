...
## Cada organizador receberá um código-prenda de agradecimento

Cada educador que apresente um Hora de Código a estudantes receberá 10Gb de espaço no Dropbox ou 10 dólares de crédito no Skype como prenda de agradecimento!

<% if @country == 'uk' %>

## As salas de aulas felizardas ganham uma video conferência com um orador convidado!
