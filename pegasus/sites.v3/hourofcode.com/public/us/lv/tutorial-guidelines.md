...
# "Programmēšanas stundas" un datoru izglītības nedēļas apmācības vadlīnijas

**Pamācības iesniegšanas laiks priekš "Programmēšanas stundas 2014" ir beidzies. Jūs vēl varat iesnieg darbu, ja būs atlicis laiks, tad mēs to iesniegsim.**

Code.org nodrošinās dažādas "Programmēšanas stundas" aktivitātes mājaslapās - code.org, programmēšanas stunda un datorzinātnes izglītības nedēļa. Attiecīgais saraksts atrodas [<%= codeorg_url() %>](http://<%= codeorg_url() %>/learn).
...
## Indekss:
  ...
  * [Vispārējās vadlīnijas, lai izveidotu "Programmēšanas stundas" aktivitātes](#guidelines)
  * [Kā iesniegt (līdz 01/10/2014)](#submit)
...
**Nodarbība tiks vērtēta augstāk, ja tā būs:**
  ...
  * ļauj mācīties visām demogrāfiskajām grupām (īpaši niepietiekami pārstāvētajām grupām)
...
**Nodarbība tiks vērtēta zemāk ja tā būt:**
  ...
  * ar specifisku nozīmi, piemēram, tematiski vērsta galvenokārt puišiem
  * kalpo kā reklāma maksas apmācības platformai

**Nodarbība netiks ieskaitīta, ja tā:**

  * pieprasa lielu skolotāju iesaisti, palīdzot gatavot materiālus (ti studentiem nav nepieciešama palīdzība)
  * nav paredzēti (aptuveni) vienas stundas nodarbībai
  * nepieciešams reģistrēties 
  * ir maksas
  * ir jāuzstāda papildus programmatūra uz datoriem
...
Galu galā, "Programmēšanas stundas" galvenais mērķis ir iesaistīt skolēnus un skolotājus datorzinātnēs, un palīdzēt tiem parādīt, ka datorzinātnes ir pieejamas visiem un tās ir "vienkāršākas nekā tu domā". Daudzejādā ziņā, šo mērķi ir vieglāk sasniegt, dodot skolēniem un skolotājiem mazākas un vieglākas izvēles, ar mērķi, lai pirmreizējam lietotajam tiktu sniegtas augstākas rezultātus iespējas. 

Ņemiet vērā to, ka 2013. gada notikušajā datorzinātnes izglītības nedēļā bija sasniegti fantastiski rezultāti. Skolēnu un skolotāju atsaucība bija ļoti liela - 20 miljoni dalībnieku, lai ka posmā no 9. līdz 23. decembrim, un 97% dalībnieku apgalvoja, ka izbaudīja šo procesu un vēlētos atkal piedalīties kampaņā. 

Rezultātā, esošie mācību materiāli ir pietiekoši labi, un galvenais iemesls paplašināt "Programmēšanas stundas" apmācības, ir nevis, lai palielinātu izvēli, bet veicinātu kvalitāti vai piedāvātu vairāk iespējas citās valodās runājošajiem skolēniem. 
...
## Vispārējās vadlīnijas, lai izveidotu "Programmēšanas stundas" aktivitātes
  ...
  * **Principi:** 
      * Datorzinātne ir ne tikai ģēnijiem. Jūsu vecums, dzimums, rase nav svarīga. Jebkurš var iemācīties!
      * Datorzinātnes ir savienotas ar daudzām jomām un interesēm. Visiem tās vajadzētu iemācīties!
  ...
  * **Format:** Self-guided tutorials or lessons, optionally facilitated by the teacher. Studentiem vajadzētu būt vairākām izvēlēm nevis tikai stundām ilgiem izaicinājumiem. Ideally, the instructions and tutorials are integrated directly into the programming platform, to avoid switching tabs or windows between the tutorial and the programming platform.

[**Atgriezties sākumā**](#top)

<a id="submit"></a>

## Kā iesniegt (līdz 01/10/2014)
...
**Kas tev būs nepieciešams:**
  ...
  * Testētu un saderīgu platformu saraksts: 
      ...
      * **Pārējās, kas nav tīmekļa balstītas:** nosaka platformu pēc atbilstošā koda (Mac, Win, iOS, Android, xBox, citi)
      * Atslēgtas
  ...
  * Recommended grade level(s) for intended users. You may refer to the [Computer Science Teachers’ Association’s K-12 Standards](http://csta.acm.org/Curriculum/sub/K12Standards.html) for grade-appropriate computer science concepts. Example grade levels include: 
      ...
      * All ages
  * Lūdzu iekļaut ieteicamās zināšanu līmeni datoru zinātnē: iesācējs, vidēja līmeņa vai augsta līmeņa. "Programmēšanas stundas" mājas lapā tiks uzsvērtas darbības iesācējiem. Ja jūs vēlētos sagatavoties vidēja līmeņa un augsta līmeņa "Programmēšanas stundu" aktivitātēm, lūdzu, iekļaujiet savas agrākās zināšanas jūsu darbības aprakstā.
  * Tehniskās prasības: 
...
Mēs visiem lūdzam, lai tie lietotajiem aizsūtītu pašizveidotas vienas stundas pamācības. Lūdzu norādiet tiem jūsu veidoto lapu "Programmēšanas stundā". Your users are much more likely to react to a mailing from you about your tutorial. Use the international Hour of Code campaign for Computer Science Education Week as an excuse to encourage users to invite others to join in, help us reach 100 million total participants.

  * Iekļauj "Programmēšanas stundu" un Datorzinātņu nedēļu savā portālā   
    Piemēram: <http://www.tynker.com/hour-of-code>
