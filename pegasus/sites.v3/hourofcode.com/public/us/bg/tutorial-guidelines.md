...
Посетете [ Часът на кодирането страница за подаване на дейност][12] и следвайте стъпките, за да подадете вашият урок.
...
**Уверете се, че вашата дейност може да се използва при [ програмиране по двойки][18].**
