...
- Encourage software engineers at your company to visit a local classroom to help lead an Hour of Code and inspire students to study computer science. მათ შეუძლიათ [დარეგისტრირდნენ](<%= resolve_url('https://code.org/volunteer/engineer') %>) და დაუკავშირდნენ კლასს.
