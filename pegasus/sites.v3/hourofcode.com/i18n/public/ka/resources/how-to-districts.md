...
# კოდის ერთი საათი ყველა სკოლაში.
...
## ყველა სკოლამ უნდა მიიღოს მონაწილეობა, ყველა მოსწავლემ - ისწავლოს!
  ...
  2. **წარუდგინეთ სკოლებს უზრუნველყოფის გეგმა.** გაუზიარეთ უზრუნველყოფის ეს გეგმა სკოლებს და გაუადვილეთ მონაწილების ორგზანიზება. კოდის ერთი საათი შეიძლება ჩატარდეს მათემატიკის გაკვეთილზე, დიდ შესვენებაზე ან კომპიუტერულ კლასში. They can submit their own plan for a chance to win $10,000 in hardware at [http://hourofcode.com/prizes](<%= resolve_url('/prizes') %>).
  ...
  6. **More [prizes](<%= resolve_url('/prizes') %>) for EVERY organizer.** Every participating educator will receive thank you gifts. და ყოველ შტატში ერთი სკოლა მოიგებს 10,000 დოლარამდე ღიღებულების კომპიუტერულ ტექნიკას!
