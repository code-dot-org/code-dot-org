...
אנו מספקים מגוון רחב של [הדרכות מהנות באורך שעה](<%= resolve_url('/learn') %>) למשתתפים בכל הגילאים, שנוצרו על ידי מגוון של שותפים. [נסו אותם!](<%= resolve_url('/learn') %>)

**כל שיעורי ההדרכה של "שעה של קוד":**

- Cele ce impun un timp minim de pregatire pentru organizatori
- בהדרכה עצמית- מאפשרים לילדים לעבוד בקצב ורמתם האישית
