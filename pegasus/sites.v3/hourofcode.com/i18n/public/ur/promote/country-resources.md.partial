...
کوڈ کا تجربہ بہترین وقت انٹرنیٹ سے منسلک کمپیوٹرز کے ساتھ ہوگا. But you don’t need a computer for every participant, and can even do the Hour of Code without a computer at all.
...
- **Have low bandwidth?** Plan to show videos at the front of the class, so each student isn't downloading their own videos. یا غیر مقفل / آف لائن سبق کی کوشش کریں.
