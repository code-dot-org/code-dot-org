...
## Bëj çdo shkollë te marrë pjesë, çdo student të mësojë!
  ...
  4. **Promote on your district’s homepage.** Add one of these [banners](<%= resolve_url('/promote#banners') %>) to your district’s website to let visitors know about your participation. Lidhe me [Orën e Kodimit](<%= resolve_url('/') %>).
