...
## Bëj çdo shkollë te marrë pjesë, çdo student të mësojë!
  ...
  1. **Rekruto shkollat vendore dhe rajonet.** Përdor [këtë email](<%= resolve_url('/promote/resources#sample-emails') %>) apo [këtë njoftim](<%= resolve_url('/promote/stats') %>) si një pikë filluese, dhe hedh një sy në këtë [ si-të](<%= resolve_url('/how-to') %>) për shkolla dhe rajone. Let them know **every** participating educator will receive a [thank you gift](<%= resolve_url('/prizes') %>) while supplies last and in **each state**, one participating school will win **$10,000 in technology**!

  2. **Mikëprit një ngjarje të Orës së Kodimit.** Shiko [ ngjarjen tonë si-të udhëzosh](<%= resolve_url('/how-to/event') %>) për një numër shfaqjesh, shpërndarjen e mjeteve mediatike dhe burimet tjera planifikuese. Organizimi i një eventi është një mënyrë e mirë për të reklamuar Orën e Kodimit dhe rritur numrin e pjesmarrësve.
  ...
  5. **Harto një editorial**. Konsideroni publikimin e një shkrimi të llojit opinion, në gazetën tuaj lokale. Shiko këtë [mostër editoriali](<%= resolve_url('/promote/op-ed') %>) duke mbështetur kompjuterin mbështetës të Javës së Edukimit të Shkencave Kompjuterike dhe qellimet e saj.
  ...
  7. **Lesho një deklaratë për shtyp.**[Përdor këtë mostër](<%= resolve_url('/promote/official-press-release') %>) si një udhëzues.
