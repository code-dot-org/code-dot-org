...
### Нека всяко училище да се включи, и всеки ученик да се научи!
  ...
  8. **Connect locally.** Visit <<%= resolve_url('https://code.org/promote') %>> to learn more about computer science education in your state. Подпишете петицията и вие ще получите актуализации от Code.org за техните местни, държавни и федерални застъпнически усилия.
