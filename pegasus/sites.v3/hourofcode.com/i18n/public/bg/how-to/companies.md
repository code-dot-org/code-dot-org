...
We’ll host a variety of [fun, hour-long tutorials](<%= resolve_url('https://code.org/learn') %>) for participants of all ages, created by a variety of partners. *Нови уроци идват за началото на часа на кода < % = campaign_date('full') % >.* [Опитайте текущите уроци.](<%= resolve_url("https://code.org/learn") %>)
...
Най-добрият Час на кодирането се провежда с Интернет свързани компютри. You **don’t** need a computer for every participant, and can even do the Hour of Code without a computer at all.
  ...
  * **Няма достатъчно устройства?** Използвайте [ програмиране по двойки](https://www.youtube.com/watch?v=vgkahOzFH2Q). Have participants partner with each other. Те ще се убедят, че компютърните науки се нуждаят от социално сътрудничество.
...
## 5) Вдъхновете участниците да започнат Вашият час на кода
...
Часът на кодирането е само първата стъпка в образователното пътуване за изучаване как технологията работи и как се създават софтуерни приложения. To continue this journey, [encourage your participants to learn online](<%= resolve_url('https://code.org/learn/beyond') %>).
