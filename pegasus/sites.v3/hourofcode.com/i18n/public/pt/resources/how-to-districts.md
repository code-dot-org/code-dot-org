...
## Faça com que todas as escolas participem e todos os alunos possam aprender!
  ...
  4. **Divulgue o evento na página da sua região.** Adicione um desses [banners](<%= resolve_url('/resources#banners') %>) no site da sua região para que os visitantes saibam da sua participação. Link it to [Hour of Code](<%= resolve_url('/') %>).
