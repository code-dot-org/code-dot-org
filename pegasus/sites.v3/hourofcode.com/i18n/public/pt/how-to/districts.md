...
## Faça com que todas as escolas participem e todos os alunos possam aprender!
  ...
  4. **Divulgue o evento na página da sua região.** Adicione um desses [banners](<%= resolve_url('/promote/resources#banners') %>) no site da sua região para que os visitantes saibam da sua participação. Faça um link para a [Hora do Código](<%= resolve_url('/') %>).
