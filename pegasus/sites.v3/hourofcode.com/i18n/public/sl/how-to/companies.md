...
Najboljša izkušnja Ure za kodo bo na računalnikih, ki so povezani v internet. You **don’t** need a computer for every participant, and can even do the Hour of Code without a computer at all.
  ...
  * **Don't have enough devices?** Use [pair programming](https://www.youtube.com/watch?v=vgkahOzFH2Q). Have participants partner with each other. Naučili se bodo, da je programiranje družabno in je pomembno sodelovanje.
...
Ura za kodo je le prvi korak, če se želimo naučiti več o delovanju tehnologije in kako narediti aplikacije. To continue this journey, [encourage your participants to learn online](<%= resolve_url('https://code.org/learn/beyond') %>).
