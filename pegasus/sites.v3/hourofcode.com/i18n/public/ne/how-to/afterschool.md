...
The best Hour of Code experience will be with Internet-connected computers. You **don’t** need a computer for every child, and can even do the Hour of Code without a computer at all.
  ...
  * **Don't have enough devices?** Use [pair programming](https://www.youtube.com/watch?v=vgkahOzFH2Q). When kids partner up, they help each other and rely less on the organizer. तिनिहरूले कम्प्युटर विज्ञान सामाजिक र सहयोगि छ भनि देख्ने छन्।
...
कसरी प्रविधिले काम गर्छ र कसरी सफ्टवेयरको एप्लिकेसनहरूको सिर्जना गर्ने भन्ने थप कुराको बारेमा सिक्न Hour of Code केबल पहिलो चरण मात्र हो। To continue this journey, [encourage your children to learn online](<%= resolve_url('https://code.org/learn/beyond') %>).
