...
1. 의류 등 각종 패션 제품에 사용되는 "Hour of Code"라는 브랜드 이름으로서 사용되서는 안되며, Hour of Code 운동에 대한 참조를 달아야 합니다.
    
    - 좋은 예시: "Hour of Code™ 에 함께 참여해보세요. ACMECorp.com". 
    - 나쁜 예시: "ACME Corp 가 만든 Hour of Code를 해보세요".
