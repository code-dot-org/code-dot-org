...
학급 내 모든 학생들에게 맞는 활동을 찾을 때, 온라인과 컴퓨터가 필요 없는 "언플러그드" 옵션 모두를 고려하세요. 언플러그드 활동은 학생들에게 컴퓨터 과학 개념을 직접 체험할 수 있게 합니다. [빅 이벤트](https://studio.code.org/s/course1/lesson/15/puzzle/1)는 교사에게 학생의 액센에 대한 통제권을 부여하여 각 학생의 능력에 맞게 내용을 맞춤형으로 구성할 좋은 기회를 허용합니다.
