...
## Bigyang-inspirasyon ang mga estudyante at magboluntaryo para sa Hour of Code
...
We host a variety of [fun, hour-long activities](<%= resolve_url('/learn') %>) for participants of all ages, created by a variety of partners. [Subukan nyo na!](<%= resolve_url('/learn') %>)
