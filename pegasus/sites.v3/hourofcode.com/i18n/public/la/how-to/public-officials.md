...
### Como conseguir la participación de cada escuela y cada estudiante aprendiendo!
  ...
  2. **Host an Hour of Code event.** See our [event how-to guide](<%= resolve_url('/how-to/how-to-event') %>) for a sample run of show, media outreach kit and other event-planning resources. Organizar un evento es una forma grandiosa de promover la Hora de Código y aumentar la participación.
