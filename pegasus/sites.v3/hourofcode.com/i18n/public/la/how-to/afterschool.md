...
Contamos con una variedad de [tutoriales divertidos de una hora](<%= resolve_url('/learn') %>) para participantes de todas las edades, creados por una variedad de socios. [!Revísalos aquí!](<%= resolve_url('/learn') %>)
