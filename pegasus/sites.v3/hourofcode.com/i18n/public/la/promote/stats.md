...
Con la tecnología cambiando todas las industrias en el planeta, conocimientos se ha convertido en parte de un conjunto de habilidades bien redondeado. Pero menos de la mitad de todas las escuelas enseñan Ciencias de la computación! La buena noticia es que estamos trabajando para cambiar esto. Si conoces la hora del código del año pasado, tu puedes saber que hizo historia. 100 millones de estudiantes ya han descubierto cómo de accesible y divertida puede ser la informática haciendo solo una hora de código.
