...
6. **Draft an op-ed**. Vurdér å skrive eit lesarbrev i lokalavisa di. See this [sample op-ed](<%= resolve_url('/promote/op-ed') %>) supporting comupter supportive of Computer Science Education Week and its goals.
