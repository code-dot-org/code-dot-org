...
## Get every school participating, every student learning!
  ...
  6. **More [prizes](<%= resolve_url('/prizes') %>) for EVERY organizer.** Every participating educator will receive thank you gifts, while supplies last. Og ein skule i kvar delstat i USA vil vinne utstyr til ein verdi av 10 000 dollar!

## Kva kjem etter Kodetimen?

Kodetimen er berre det første steget på ein reise for å lære meir om korleis teknologi fungerer og korleis programvare blir laga. To continue this journey: - The Hour of Code is just the first step on a journey to learn more about how technology works and how to create software applications. To continue this journey:
