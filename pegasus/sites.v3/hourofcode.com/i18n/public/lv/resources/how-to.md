...
Vislabākā "Programmēšanas stundas" pieredze būs ar pie interneta pieslēgtiem datoriem, bet jums nevajag datoru katram bērnam. "Programmēšanas stundā" var strādāt arī pilnībā bez datora.
...
Vairums bērnu nezin, kas ir datorzinātnes. Lūk, dažas idejas:
...
**Kad jūsu skolēni sastopas ar grūtībām**
...
**Kā, lai es printēju sertifikātus saviem skolēniem?**

Katram skolniekam tiek dota iespēja iegūt sertifikātu caur e-pastu, kad viņi pabeidz [Code.org apmācības](http://studio.code.org). Jūs variet uzspiest uz sertifikāta, lai to izprinētu. Tomēr, ja vēlaties izgatavot jaunus sertifikātus saviem skolēniem, apmeklējat mūsu [Sertifikāti](http://<%= codeorg_url() %>/certificates)lapu, lai printētu sev nepieciešamo sertifikātu daudzumu uzreiz!

**Kas nāk pēc "Programmēšanas stundas"?**

"Programmēšanas stunda" ir tikai pirmais solis ceļojumā, lai iemācītos par to kā tehnoloģijas strādā un kā veidot lietojumprogrammatūru. <% if @country == 'uk' %>"Programmēšanas stunda" ir tika pirmais solis, lai iemācītos par to kā tehnoloģijas strādā un kā veidot lietojumprogrammatūru. Lai turpinātu šo ceļojumu [iedoršinat savus bērnus mācīties tiešsaistē](http://uk.code.org/learn/beyond). <% else %> Lai turpinātu šo ceļojumu, atrodat papildus resursus pasniedzējiem[šeit](http://<%= codeorg_url() %>/educate). Vai iedrošinat jūsu bērnus mācīties [tiešsaistē](http://<%= codeorg_url() %>/learn/beyond). <% end %>