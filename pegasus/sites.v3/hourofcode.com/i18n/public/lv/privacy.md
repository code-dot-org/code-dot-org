...
Code.org® ir bezpeļņas-organizacija kas nodarbojas ar līdzdalības paplašināšanu datorzinātnēs padarot to pieejamu vairākas skolās, un palielinot līdzdalību sievietēm un nacionālās minoritātes studentiem.

Lūdzu, izlasiet šo Konfidencialitātes politiku ("**Paziņojums par konfidencialitāti**") uzmanīgi pirms piekļūstat vai izmantojat portālu.

## Code.org Konfidencialitātes principi

Mūsu konfidencialitātes paziņojumu ir veicinājusi mūsu apņemšanās pret šādiem konfidencialitātes principiem:

  1. Mēs esam dziļi apņēmusies radīt drošu un aizsargātu mācību vidi mūsu skolēniem un pasniedzējiem. Mēs ļoti nopietni pieejam pie konfidenciālas informācijas aizsargāšanas.
  2. Nav nepieciešams ievadīt nekādu konfidenciālu informāciju, lai iegūtu konsultāciju, kuras ir pieejamas bez lietotāja konta. 
  3. Vienīgais iemesls, kāpēc mēs ievācam datus no skolēniem vai skolotājiem ir, lai veiksmīgāk izdotos mūsu mērķis nodrošināt pēc iespējas labāku datorzinātņu apgūšanu jebkuram skolēnam, kurš to vēlas. 
  4. Mēs negūstam finansiālu labumu pārdodot vai izmantojot personu datus, kā arī mēs nepiedāvājam reklāmas pakalpojumus. Mēs esam bezpeļņas organizācija un mūsu ienākumi ir no ziedojumiem. Esam dibināti kā bezpeļņas organizācija, lai mūsu misija un klientu uzticēšanās stāvētu pāri peļņas gūšanas nolūkiem.
  ...
  6. Mēs cenšamies nodrošināt klientiem pieeju un kontroli tai informācijai, kuru klienti mums ir snieguši (kā norādīts zemāk), klientu informācijas aizsardzība mums ir ļoti svarīga.

## Privātuma atruna

Mēs esam nodevušies radīt drošu vidi visu vecumu skolēniem mūsu mājaslapās: <http://code.org>, <http://csedweek.org>, <http://computinginthecore.org>, <http://hourofcode.com>, kā arī citās mājaslapās, programmēšanas saskarnē ( “API”), un tiešsaistes pakalpojumos (kopā sauktos - “Mājaslapa”). Visitors and users of the Website and participants in our education programs are referred to individually as “User” and collectively as “Users”. Tā kā esam bezpeļņas organizācija, tad saņemtos datus, izmantojam tikai tik daudz, lai sekmētu savu misiju un nodrošinātu katru studentu, kurš to vēlas, ar lieliskām zināšanām datorzinātnē. Mēs dibinājām bezpeļņas organizāciju, lai peļņas gūšana nekavētu mūsu misiju - nodrošināt uzticamu izglītības resursu.

Our Privacy Notice describes what information we gather from our Users, how we use that information, and what we do to protect it. Mājaslapas izmantošana un informācija, kuru Jūs sniedzat mājaslapā, tiek pakļauta Privātuma Atrunas noteikumiem, kas ir iekļauti un ir saskaņā ar mūsu Mājaslapas lietošanas noteikumiem. Any capitalized terms used but not defined within this Privacy Notice have the meaning given to them in our [Terms of Service](http://code.org/tos). By visiting or using our Website, you expressly consent to the information handling practices described in this Privacy Notice.

Privātuma atruna laiku pa laikam tiks mainīta. Code.org paziņos Lietotājiem par jebkādam Privātuma atrunas izmaiņām, publicējot uzlaboto Privātuma atrunas versiju ar jauno pārskatīšanas datumu. Ja tiks veiktas ievērojamas izmaiņas, tad tās tiks izziņotas pēc iespējas īsākā laikā publicējot tās Mājaslapā. Ja likums pieprasa, tad mēs varam sazināties ar Lietotājiem un paziņot par veiktajām izmaiņām. We stand behind the promises we make, and will not change how we use any Personal Information we have already collected from Users in any material way without also providing notice of the change via email, through this website, or through other means, and obtaining consent to any new uses. We take the information you provide to us very seriously, and we strive to put you in control of decisions around your information.
...
| Dzimums                                                                                                                                                                                                                                         | Optional                                                                                                                                       | This information is only used in aggregate, to measure the total % of students that are male or female, to track our progress towards reducing the gender gap in computer science.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| Vecums (ne dzimšanas datums)                                                                                                                                                                                                                    | Mandatory                                                                                                                                      | To understand the developmental stage of students to offer an age-appropriate experience for each student. We use this field to ensure we don’t store email information for students with age < 13. We collect ages (eg 16), as opposed to birthdates (eg Feb 13, 1998)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| Telefona numurs                                                                                                                                                                                                                                 | Optional                                                                                                                                       | Users aged 13 or older can choose to share their app, art, or other code creations to a phone. To do this, they are asked to provide a phone number (their own or someone else’s). Code.org uses a 3rd party service ([Twilio](https://www.twilio.com/)) to send a pre-written text message to this number. Code.org does not store any record of the number, however the phone number and message will be stored by Twilio and may also be stored by the phone service provider.                                                                                                                                                                                                                                                                                                                                                                    |
...
| ------------------------------------------------------------------------------ | --------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Skolas nosaukums                                                               | Optional  | At your option and under your control, we would list your school in the Code.org map and database of schools that teach computer science courses.</br>  
...
| Skolas adrese                                                                  | Optional  | At your option and under your control, we would list your school (and relevant contact information, if you provide it) in the Code.org map and database of schools that teach computer science courses.                                                                                                                                                                                                                                                                                                             |
