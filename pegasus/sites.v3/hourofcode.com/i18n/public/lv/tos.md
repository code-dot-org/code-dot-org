...
Code.org ir 501(c)(3) bezpeļnas organizācija ("Code.org"). Mūsu mērķis ir radīt iespēju katram skolnēnam apgūt datorzinātni. Lai sasniegtu šo mērķi, Code.org uztur šādas mājas lapa: <http://code.org>, <http://csedweek.org>, <http://computinginthecore.org>, <http://hourofcode.com>, citas mājas lapas, informāciju, tekstu, mācibu, video, grafikas, attēlu, API (Application Programming Interface - programmējams lietojuma interfeiss), e-pastu apziņošana un citi materiāli, kas saistīti ar produktiem un pakalpojumiem (“**Pakalpojumi**”), tai skaitā apmācības sistēma <http://studio.code.org> (“**Programmēšanas studija**”).

Lūdzam uzmanīgi iepazīties ar šiem lietošanas nosacījumiem ("**Lietošanas nosacījumi**") pirms uzsākat izmantot mūsu pakalpojumu. Piekļūstot vai izmantojot jebkuru no pakalpojumiem, vai uzklikšķinot "Es piekrītu" vai "Reģistrēties" Jūs piekrītat ievērot šos lietošanas nosacījumus.

Šie nosacījumi ir juridiska vienošanās starp jums un Code.org par pakalpojumu izmantošanu. You may use the Services only if you can form a binding contract with Code.org and are not a person barred from receiving the Services under the laws of the United States or other applicable jurisdiction. Gadījumā ja Jūs piekrītat šiem nosacījumiem un gadījumā ja Jūs to darāt kāda uzņēmuma, organizācijas, valdības vai juridiskas personas vārdā, tad Jūs apliecinat, ka esat tiesīgs to darīt. You may use the Services only in compliance with these Terms and all applicable local, state, national, and international laws, rules and regulations.
...
Ja Jūs esat skolēns vai students, vai kā citādi piesaistīts mācībspēkam, tad Jūs piekrītat, ka Code.org ir tiesības nodot Jūsu datus piesaistītajam mācībspēkam. If you are a Educator, you agree not to share student information you receive from Code.org with anybody other than authorized agents of the classroom, school district, or other educational establishment you represent.
...
Code.org neapņemās uzraudzīt lietotāju izvietotu saturu vai citus materiālus. Jūs esat atbildīgs par visu lietotāju izvietotā satura vai cita materiāla izvērtēšanu, tostarp attiecībā uz precizitāti, pilnīgumu un uzticamību, kā arī apziāt visus riskus, kas saistīti ar šāda satura izmantošanu. Code.org nenes atbildību par jebkādiem zaudējumiem vai kaitējumiem, kas var rasties sakarā ar šāda satura izvietošanu vai izmantošanu.
...
Lietotājiem ir atļauts izvietot hipersaites uz citām mājas lapām, ja vien to saturs nav pretrunā šiem lietošanas nosacījumiem. Izmantojiet šādas hipersaites izvērtējot visus riskus. Code.org nav atbildīgs par saturu, kas izvietots citās mājas lapās, ieskaitot reklāmu, produktus vai citus materialus, kas ar to saistīti.
