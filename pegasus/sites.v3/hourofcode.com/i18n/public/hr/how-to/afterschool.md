...
The best Hour of Code experience will be with Internet-connected computers. You **don’t** need a computer for every child, and can even do the Hour of Code without a computer at all.
  ...
  * **Don't have enough devices?** Use [pair programming](https://www.youtube.com/watch?v=vgkahOzFH2Q). When kids partner up, they help each other and rely less on the organizer. Tako će uvidjeti da je informatika druževna i dobra za suradnju.
...
Sat Kodiranja je samo prvi korak na putu da bismo saznali više o načinu funkcioniranja tehnologije i kako napraviti softver aplikacije. To continue this journey, [encourage your children to learn online](<%= resolve_url('https://code.org/learn/beyond') %>).
