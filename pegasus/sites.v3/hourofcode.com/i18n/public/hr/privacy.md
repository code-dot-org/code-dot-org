...
Code.org® je neprofitna organizacija neprofitna posvećena širenju računalne znanosti tako što je čini dostupnom u sve više škola i povećanju zastupljenosti žena i učenika druge rase.

Molimo pažljivo pročitajte ovaj pravilnik o zaštiti privatnosti (“**Obavijest o privatnosti**”) prije no pregledate ili koristite naše stranice.

## Code.org-ov pravilnik o privatnosti

Naša obavijest o privatnosti osnovana je na našoj predanosti slijeđenja načela privatnosti:

  1. Duboko smo posvećeni stvaranju sigurne i zaštićene sredine za naše učenike i edukatore. Mi zaštitu ovih informacija shvaćamo vrlo ozbiljno.
  2. Mi od vas ne zahtijevamo nikakve osobne informacije da biste mogliu iskušati naše vodiče, koji su sve do jednog dostupni bez otvaranja korisničkog računa. 
  3. Jedini razlog zbog kojeg mi uopće prikupljamo podatke učenika ili učitelja je taj da bismo što uspješnije pružili informatičko obrazovanje svakom učeniku koji to poželi. 
  4. Mi ne prodajemo vaše osobne podatke niti ih iskorištavamo za financijsku dobit; mi ne prodajemo oglasni prostor. Mi smo dobrotvorna neprofitna organiyacija (51c3) i naši prihodi dolaze od donacija. Mi smo se uspostavili kao neprofitna organizacija kako ne bismo iznevjerili niti našu misiju niti vaše povjerenje konfliktom oko financija.
  5. Bilo kakvi akademski podatci bilo kog učenika prikupljeni od strane bilo koje organizacije u svrhu evaluiranja naših materijala bit će anonimni/ neidentificirani (kako to već propisuju standardi industrije). 
  6. Težimo ka tome da vam obezbijedimo pristup kao i kontrolu informacija koje nam dajete (kao što je detaljno opisano dolje) i zaštitu vaših informacija uzimamo jako ozbiljno.

## Obavijest o privatnosti

Predano radimo na stvaranju sigurnog okruženja za učenike svih dobi na našim web stranicama <http://code.org>, <http://csedweek.org>, <http://computinginthecore.org>, <http://hourofcode.com>, drugim web stranicama, sučelju za programiranje aplikacija (API) i internet usluugama (kolektivno našim "web stranicama"). Visitors and users of the Website and participants in our education programs are referred to individually as “User” and collectively as “Users”. Kao neprofitna organizacija (501 c3), mi koristimo podatke koje primamo samo ukoliko pomažu našoj misiji ka pružanju informatičkog obrazovanja svim učenicima koji to žele. Mi smo se uspostavili kao neprofitna organizacija kako ne bismo iznevjerili niti našu misiju pružanja obrazovnih resursa u koje se možete pouzdati konfliktom oko financija.

Our Privacy Notice describes what information we gather from our Users, how we use that information, and what we do to protect it. Vaša uporaba web stranica i bilo kakve informacije koje nam pružate podliježu uvjetima privatnosti koji su ugrađeni u i podliježu pod naše uvjete usluge. Bilo kakvi nedefinirani pojmovi u ovoj obavijesti imaju značenje pripisano im u našim [Uvjetima Usluge](http://code.org/tos). By visiting or using our Website, you expressly consent to the information handling practices described in this Privacy Notice.
...
| ------------------------------------------------------------------------------ | --------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Ime škole                                                                      | Optional  | At your option and under your control, we would list your school in the Code.org map and database of schools that teach computer science courses.</br>  
...
| Adresa škole                                                                   | Optional  | At your option and under your control, we would list your school (and relevant contact information, if you provide it) in the Code.org map and database of schools that teach computer science courses.                                                                                                                                                                                                                                                                                                             |
