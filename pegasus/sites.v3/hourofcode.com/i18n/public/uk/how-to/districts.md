...
## Залучіть до участі кожну школу, а кожного учня - до навчання!
  ...
  6. **More [prizes](<%= resolve_url('/prizes') %>) for EVERY organizer.** Every participating educator will receive thank you gifts. А по одній школі з кожного штату отримають $10,000 на покупку комп'ютерної техніки!
