...
### Fai partecipare ogni scuola e ogni studente!
  ...
  8. **Connect locally.** Visit [<%= resolve_url('code.org/promote') %>](<%= resolve_url('https://code.org/promote') %>) to learn more about computer science education in your state. Firma la petizione e riceverai aggiornamenti da Code.org riguardo tutti gli sforzi fatti.
