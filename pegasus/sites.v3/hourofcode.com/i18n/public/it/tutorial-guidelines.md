...
Code.org ospiterà una serie di attività di Hour of Code™ sui siti di Code.org, Hour of Code, e CSEdWeek. La lista aggiornata si trova su <https://code.org/learn>.
...
**I tutorial compariranno più in basso nell'elenco se sono:**
  ...
  * richiedono un elevato grado di coinvolgimento di un insegnante ed un sacco di preparazione (ad es. non sono autoguidati per studenti)(vedi piò oltre)
...
## Linee guida generali per la creazione di un'attività per l'Ora del Codice
  ...
  * **Requisiti tecnici**: 
      * Preferibili: Attività basate sul Web, smartphone-friendly, o da fare anche senza tecnologia, che insegnino concetti di informatica senza l'uso di un computer (Vedi <http://csunplugged.com/>).
      * Okay, ma non preferibili: esperienze da fare tramite applicazioni per cellulari, applicazioni desktop, o per console
  * **Formato Autoesplicativo**: tutorial o lezioni autoesplicative, eventualmente facilitabili dall'insegnante. Dovrebbero essere presenti delle precise indicazioni per gli studenti piuttosto che una sfida di un'ora a risposta aperta. Idealmente, le istruzioni e le esercitazioni dovrebbero essere integrati direttamente nella piattaforma di programmazione, per evitare il continuo cambio di scheda del browser o di finestra dal tutorial alla piattaforma di programmazione.
  * **Formato guidato dall'Insegnante *(NEW)***: quest'anno aggiungeremo un nuovo formato, per tutorial che seguono un piano di lezione tradizionale piuttosto che un'esperienza guidata in forma di puzzle-game. Stiamo facendo questo soprattutto perché, con decine di migliaia di educatori che hanno provato "L'Ora del Codice" più di una volta, crediamo che molti investiranno tempo nel preparare un'attività creativa, piuttosto che unidimensionale, da svolgere con i propri studenti. Anche se questi tipi di attività sono difficili senza un insegnante che le faciliti se vengono invece facilitate correttamente possono mostrare meglio la natura creativa dell'informatica. Elencheremo le attività guidate dagli insegnanti sotto quelle autoesplicative su pagine rivolte agli studenti, ma poi le dettaglieremo nei loro particolari su pagine o e-mail specifiche per gli educatori. 

[**Torna all'inizio**](#top)

<a id="submit"></a>

## Come presentare un Tutorial (scadenza 01/10/2014)
