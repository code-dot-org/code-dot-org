...
1. Qualsiasi riferimento a "Hour of Code" ("Ora del codice") deve essere fatto in modo che non suggerisca che sia un tuo marchio, ma piuttosto si riferisca all'Ora del Codice come un movimento di gente comune.
    
    - Un esempio di uso corretto: "Partecipa all'Ora del Codice sul sito di ACMECorp.com". 
    - Un esempio di uso sbagliato: "Prova l'Ora del Codice di ACME Corp".
...
With the Hour of Code, computer science has been on homepages of Google, MSN, Yahoo!, and Disney. Più di 100 partner si sono uniti per supportare questo movimento. Ogni Apple Store nel mondo ha ospitato un'Ora del Codice. Even President Obama wrote his first line of code as part of the campaign.
