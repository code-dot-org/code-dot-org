...
# Como trazer a Hora de Código para todo o distrito escolar

## Ter todas as escolas a participar, todos os alunos a aprender!

1. **Recrute escolas locais.** Partilhar [este email](<%= resolve_url('/promote/resources#sample-emails') %>) e [guia prático do professor](<%= resolve_url('/how-to') %>) ou inclua [sinopse curta](<%= resolve_url('/promote/stats') %>) em comunicações de newsletters/distritos.

2. **Provide a sample logistics plan for schools.** Share this [sample logistics plan](<%= localized_file('/files/HOC_Logistics_plan.pdf') %>) with schools to give them ideas of how to organize whole school participation. É tão fácil quanto fazê-lo em todas as aulas de matemática, período de sala de aula, ou ir variando durante a semana através do laboratório de informática.
