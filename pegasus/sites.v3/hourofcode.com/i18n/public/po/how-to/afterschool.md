...
Nós fornecemos uma variedade de [tutoriais divertidos de uma hora](<%= resolve_url('/learn') %>) para participantes de todas as idades, criados por uma variedade de parceiros. [Try them out!](<%= resolve_url('/learn') %>)

**Todos os turoriais da Hour of Code:**

- Require minimal prep-time for organizers
- São auto-orientados - permitindo às crianças trabalharem ao seu próprio ritmo e nível de capacidades
