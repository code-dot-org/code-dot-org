...
Code.org® és una organització no lucrativa dedicada a promoure la programació d'ordinadors fent-la disponible a les escoles i incrementant la participació de les dones i de totes les minories.

Si us plau llegeix aquesta política de privacitat ("**Avís de privacitat**") acuradament abans d'accedir o usar el lloc web.

## Principis de privadesa de Code.org

El nostre avís de privacitat és impulsat pel nostre compromís amb els principis de privadesa següents:

  1. Estem profundament compromesos amb la creació d'una entorn d'aprenentatge segur pels nostres alumnes i professors. Ens prenem seriosament la protecció d'aquesta informació.
  2. No es requereix que faciliteu cap informació personal per tal de provar els nostres tutorials, que són accessibles sense un compte d'usuari. 
  3. L'única raó que recollim les dades dels alumnes o dels professors és per millorar en la nostra missió d'oferir una gran educació d'informàtica per a cada alumne que ho vulgui. 
  4. Mai no venem la vostra informació Personal ni ho explotem per obtenir guanys financers; nosaltres no venem anuncis. Som una caritat 501c3 sense ànim de lucre i els nostres ingressos provenen de donacions. Ens hem establert com a una organització sense ànim de lucre, de manera que la nostra missió i la seva confiança no estaran en conflicte amb un motiu amb ànim de lucre.
  5. Qualsevol dada acadèmica dels estudiants facilitada pels socis de districte escolar a terceres parts avaluadores per tal d'avaluar com els nostres cursos compleixen la seva missió serà anònima /no-identificada (per pràctica estàndard de la indústria). 
  6. Ens esforcem per oferir-vos accés i control sobre la informació que ens faciliteu (com es detalla a continuació), i prenem molt seriosament la protecció de la vostra informació.
...
| ------------------------------------------------------------------------------ | --------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Nom de l'escola                                                                | Optional  | At your option and under your control, we would list your school in the Code.org map and database of schools that teach computer science courses.</br>  
...
| Adreça de l'escola                                                             | Optional  | At your option and under your control, we would list your school (and relevant contact information, if you provide it) in the Code.org map and database of schools that teach computer science courses.                                                                                                                                                                                                                                                                                                             |
...
[![imatge](/images/fit-200/student_privacy_pledge.png)](http://studentprivacypledge.org/)