...
Çocuğunuzu ilk kez bilgisayar bilimi ile tanıştırmak için Hour of Code'u denemek basit ve eğlencelidir. Bilgisayar biliminin tüm çalışma alanlarına temel teşkil etmesinin yanı sıra, <a href="https://medium.com/@codeorg/cs-helps-students-outperform-in-school-college-and-workplace-66dd64a69536">güncel çalışmalar şunu da gösteriyor</a>: bilgisayar bilimi çalışan çocuklar, diğer konularda da daha iyi performans gösteriyor,  üstün problem çözme becerisi sergiliyor ve <font color="00adbc">bu çocukların üniversiteye kaydolma oranı da %17 daha fazla oluyor</font>.
...
İnternet erişimi olan bir bilgisayarda çalışıyorsanız, sizin için uygun olan sayısız <a href="https://hourofcode.com/us/learn">Hour of Code aktivitesi</a> mevcut. Çocuğunuzu keyif alacağı egzersizler konusunda yönlendirmeye yardımcı olmak için seçeneklerinizden bazılarına önceden göz atmanızı öneririz.
...
- Öğrenmeyi seven çocuklar için: <a href="https://code.org/oceans">Okyanuslar için Yapay Zeka</a> veya <a href="https://scratch.mit.edu/projects/editor/?tutorial=music&utm_source=codeorg">Scratch ile Müzik Yap</a>

<h3>Düşük teknoloji mi yoksa teknolojisiz mi?</h3>
Sınırlı bir teknoloji kullanacaksanız veya teknolojiden faydalanmayacaksanız, <em>Sınıf teknolojisi</em> bölümünden "Bilgisayar veya cihaz olmasın"ı seçerek <a href="https://hourofcode.com/us/learn">Hour of Code aktivitelerini</a> filtreleyebilirsiniz.
...
Yalnızca bir cihaz kullanacaksanız veya Hour of Code aktivitenizi daha interaktif hale getirmek istiyorsanız, <a href="https://www.youtube.com/watch?v=vgkahOzFH2Q">eşli programlamayı</a> deneyin. Eşli programlama çocukları birlikte çalışmak konusunda teşvik eder. İki kişilik takımlar halinde çalıştıklarında problem çözmek için birbirlerine yardım ederler. Ayrıca bu yöntemle bilgisayar biliminin oldukça sosyal olduğunu ve işbirliği gerektirdiğini görmüş olacaklardır.
...
- <a href="https://store.code.org/">Tarz ürünler sipariş edin</a>! Tişört, sticker, hatta geçici dövmelerden seçebilirsiniz. Çocukları heyecanlandırmak için bunu hemen paylaşın veya özel bir ödül olarak Hour of Code'un sonuna saklayın.

<a href="https://store.code.org/" target="_blank"><img src="/images/fit-500/Marketing/hourofcodestore.jpg"></a>

## 3) Çocuğunuza Bilgisayar Bilimini tanıtmaya dair ipuçları

Hem siz hem de çocuğunuz bilgisayar biliminde yeniyseniz sorun değil. Hour of Code aktivitenizi tanıtmaya ve her ikinizin de Bilgisayar Bilimi hakkında düşünmesini sağlamaya dair bazı fikirler:
...
- Çocuğunuz aktivitesini tamamladığında ona vereceğiniz <a href="https://staging.code.org/certificates">Hour of Code Sertifikalarının</a> çıktısını alın
...
Bilgisayar bilimi Hour of Code ile sona ermek zorunda değil! Ebeveynlerin %90'ı çocuklarının bilgisayar bilimi öğrenmesini istiyor ancak çoğu okul hâlâ bu eğitimi vermiyor. Yardımcı olmak için, müfredatımız web tabanlıdır ve her zaman ücretsizdir. Bilgisayar Bilimini çocuğunuzun okuluna nasıl taşıyabileceğiniz hakkında <a href="https://code.org/yourschool">bilgi edinin</a>.