...
Code.org 501(c)(3)' e uygun bir kar amacı gütmeyen kuruluştur ("Code.org"). Misyonumuz, her öğrenciye bilgisayar bilimini öğrenebilmeleri için bir fırsat vermektir. Bu misyonun bir parçası olarak, Code.org <http://code.org>, <http://csedweek.org>, <http://computinginthecore.org>, <http://hourofcode.com> adreslerindeki web sitelerini, başka web sitelerini, bilgiyi, metni, müfredatı, videoları, grafikleri, fotoğrafları, uygulama programlama arayüzlerini, e-posta bildirimlerini, <http://studio.code.org> adresindeki eğitim platformunu ("**Code Studio**") ve diğer materyalleri ve ilgili ürünler ve hizmetleri (“**Hizmetler**”) yürütür ve işletir.

Lütfen Hizmetler'i kullanmadan önce Hizmet Şartları'nı (“**Şartlar**”) dikkatlice okuyunuz. Hizmetlerin herhangi bir kısmına erişerek, Hizmetleri kullanarak veya herhangi bir "Kabul ediyorum" veya "Kaydol" butonuna tıklayarak bu Şartlara uymayı kabul edersiniz.

Bu Şartlar, Hizmetler'i kullanımınıza dair siz ve Code.org arasında yapılmış yasal bir sözleşmedir. Hizmetleri sadece Code.org ile bağlayıcı bir sözleşme oluşturabiliyorsanız ve Amerika Birleşik Devletleri yasaları veya diğer ilgili yasalar tarafından Hizmetleri kullanmanız yasaklanmamışsa kullanabilirsiniz. Eğer bu Şartları bir şirket, organizasyon, devlet veya başka bir yasal varlık adına kabul ediyorsanız, bunu yapmaya yetkiniz olduğunu beyan ediyorsunuz. Hizmetleri sadece bu Şartlara ve mevcut bütün yerel ve uluslararası yasalara, kurallara ve yönetmeliklere uygun olarak kullanabilirsiniz.

Bu Şartlar değişime tabidir. Eğer Şartlar değiştikten sonra Hizmetler'i kullanmaya devam ederseniz yeni şartları kabul etmiş sayılırsınız. Lütfen Şartlar'ı değişiklikler için periyodik olarak gözden geçirin.
...
Code.org'un Kullanıcı İçeriğini veya diğer herhangi materyali izlemek veya kontrol etmek gibi bir yükümlülüğü yoktur. You are responsible for evaluating all User Content including for accuracy, completeness and reliability, and you bear all risk of using such User Content. Code.org will not be responsible for any damages that you may incur as a result of the submission or use of any User Content.
