...
Επισκεφθείτε ένα τμήμα μαθητών και εμπνεύσετε τους μαθητές να μάθουν την επιστήμη των υπολογιστών. [Εθελοντής για μια ώρα](https://code.org/volunteer/engineer).
...
- Check out the [Hour of Code Volunteer Toolkit](/files/hoc-volunteer-toolkit.pdf) which includes an overview, timeline, preparation material, and marketing material. Όλα όσα χρειάζεστε για να είστε έτοιμοι για την εθελοντική εμπειρία σας!
...
- [ Διαβάστε αυτές τις συμβουλές](https://code.org/files/CSTT_Volunteers.pdf) για το πώς να αλληλεπιδράσετε με τους μαθητές.
