...
### Φέρε κάθε σχολείο να συμμετάσχει, κάθε σπουδαστή να μάθει!
  ...
  1. **Στρατολόγησε τοπικά σχολεία και συνοικίες.** Χρησιμοποίησε [αυτή τη φανταχτερή αγγελία](<%= hoc_uri('/resources#sample-emails') %>αυτό το μήνυμα ηλεκτρονικού ταχυδρομείου</a> ή <a href=) σαν σημείο έναρξης και ρίξε μια ματιά σε αυτό τον [ευχαριστήριο δώρο](<%= hoc_uri('/resources/how-to') %>οδηγό Πως-να</a> για σχολεία και συνοικίες. Γνωστοποίησε του πως <strong>κάθε</strong> συμμετέχοντας εκπαιδευτικός θα λάβει ένα <a href=) και σε **κάθε πολιτεία**, ένα σχολείο θα κερδίσει **10.000$ σε είδη τεχνολογίας**!
