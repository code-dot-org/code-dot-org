...
## Φέρε κάθε σχολείο να συμμετάσχει, κάθε σπουδαστή να μάθει!
  ...
  6. **Περισσότερα [ βραβεία](<%= hoc_uri('/prizes') %>) για κάθε διοργανωτή.** Κάθε συμμετέχον παιδαγωγός θα λάβει ευχαριστήρια δώρα. Και σε κάθε πολιτεία, ένα σχολείο που συμμετέχει θα κερδίσει $10.000 σε υποδομές τεχνολογίας για το σχολείο του!