...
Nous nous engageons à créer un environnement sûr et sécurisé pour les apprenants de tous âges sur nos sites web situés à <http://code.org>, <http://csedweek.org>, <http://computinginthecore.org>, <http://hourofcode.com>, nos autres sites web, nos interfaces de programmation d'application (notre « API - application programming interface») et services en ligne (collectivement, notre "site"). Visitors and users of the Website and participants in our education programs are referred to individually as “User” and collectively as “Users”. À titre d'organisation à but non lucratif (US 501(c)(3)), nous utilisons les données que nous recevons seulement dans la mesure où il aide à notre mission consistant à fournir un enseignement des sciences informatiques pour chaque élève qui le souhaite. Nous avons constitué code.org en organisme à but non lucratif ainsi aucun motif à but lucratif n’interférera avec notre mission de fournir une ressource éducative de confiance.

Our Privacy Notice describes what information we gather from our Users, how we use that information, and what we do to protect it. Votre utilisation du site et toute information que vous fournissez sur le site Web sont assujetties aux modalités du présent avis de confidentialité, qui est incorporé à nos conditions d'utilisation et sous réserve de leur acceptation. Les acronymes utilisés mais non définis dans cette déclaration de confidentialité ont la même signification que dans nos [Conditions d'utilisation](http://code.org/tos). En visitant ou en utilisant notre site Web, vous consentez expressément aux pratiques de gestion d'information décrites dans la présente Déclaration de Confidentialité.

De temps à autre, notre avis de confidentialité peut changer. Code.org informera les utilisateurs de tout changement à notre avis de confidentialité en affichant l'avis de confidentialité révisée avec une mise à jour de révision sur notre site Web. Si nous apportons des changements importants à la politique, ils seront précédés d'un court préavis de révision posté sur la page d'accueil du site Web. Nous pouvons également communiquer avec les utilisateurs et leur signaler les changements si requis par la Loi. Nous nous tenons derrière les promesses que nous faisons et nous ne changerons pas notre utilisation des renseignements personnels déjà collectés de quel que façons que ce soit, auprès des utilisateurs, sans également fournir un avis du changement par courriel, par le biais de ce site Web, ou par d'autres moyens afin d'obtenir un consentement à toutes nouvelles utilisations. Nous prenons les informations que vous nous fournissez très au sérieux, et nous nous efforçons de vous maintenir en contrôle des décisions concernant vos informations.
...
| ------------------------------------------------------------------------------ | --------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Nom de l'école                                                                 | Optional  | At your option and under your control, we would list your school in the Code.org map and database of schools that teach computer science courses.</br>  
...
| Adresse de l'école                                                             | Optional  | At your option and under your control, we would list your school (and relevant contact information, if you provide it) in the Code.org map and database of schools that teach computer science courses.                                                                                                                                                                                                                                                                                                             |
...
## Comment nous partageons et transmettons les données
...
## Notre point de vue sur la sécurité des données
