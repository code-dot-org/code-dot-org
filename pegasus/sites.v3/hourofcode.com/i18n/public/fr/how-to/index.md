...
**It’s okay if both you and your students are brand new to computer science. Here are some ideas to introduce your Hour of Code activity:**
  ...
  * Avec la classe, rédigez une liste des choses qui requièrent du code dans la vie quotidienne.
...
**What to do if a student finishes early?**
  ...
  * Les étudiants peuvent regarder tous les tutoriels et essayer une autre Heure de Code sur [<%= resolve_url('code.org/learn') %>](<%= resolve_url('https://code.org/learn') %>)
...
## Autres ressources d'une Heure de Code pour les éducateurs :
  ...
  * Découvrez les [bonnes pratiques](http://www.slideshare.net/TeachCode/hour-of-code-best-practices-for-successful-educators-51273466) des organisateurs d'Une Heure de Code précédents. 
  ...
  * Visitez le [forum des enseignants d'Une Heure de Code](http://forum.code.org/c/plc/hour-of-code) pour obtenir des conseils, de l'approfondissement et du support des autres éducateurs. <% if @country == 'us' %>
