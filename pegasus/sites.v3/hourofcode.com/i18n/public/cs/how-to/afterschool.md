...
Poskytujeme mnoho [ zábavy, hodinové tutoriály ](<%= resolve_url('/learn') %>) pro participanty každého věku, které jsou vytvořeny řadou našich partnerů. [Vyzkoušej je:](<%= resolve_url('/learn') %>)
...
**Je naprosto v pořádku, pokud nemáte žádné předchozí zkuštnosti s informační technologií. Tady jsou nějaké tipy, jak představit Hodinu kódu:**
...
**Když se vaši studenti narazí na těžkosti, je dobré reagovat například takto:**
...
- Podpořte účastníky v tom, aby zkusili jinou aktivitu Hodiny kódu na [ hourofcode.com/learn](<%= resolve_url('/learn') %>)
- Nebo požádejte ty, kteří skončili dříve, aby pomohli ostatním, co mají potíže.
...
- [Vytiskněte certifikáty](<%= resolve_url('https://code.org/certificates') %>) pro Vaše studenty.
...
- Koukněte na [nejlepší příklady](http://www.slideshare.net/TeachCode/hour-of-code-best-practices-for-successful-educators-51273466) z minulých Hodin kódu. 
