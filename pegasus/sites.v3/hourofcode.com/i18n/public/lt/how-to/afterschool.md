...
Mes siūlome daug smagių, [valandos trukmės pamokų](<%= resolve_url('/learn') %>) įvairaus amžiaus mokiniams, sukurtų mūsų partnerių. [Išbandykite!](<%= resolve_url('/learn') %>)

**Visos valandos trukmės pamokos:**

- Require minimal prep-time for organizers
- Yra sukurtos taip, kad vaikai galėtų mokytis savarankiškai pagal savo žinių lygį
