...
## Hướng dẫn chung để tạo ra một hoạt động Giờ Lập Trình
  ...
  * **Self-Guided Format**: Self-guided tutorials or lessons, optionally facilitated by the teacher. There should be directions for students as opposed to an open-ended hour-long challenge. Lý tưởng nhất, các hướng dẫn và hướng dẫn được tích hợp trực tiếp vào nền tảng lập trình, để tránh chuyển tab hoặc cửa sổ giữa các hướng dẫn và lập trình nền tảng.
