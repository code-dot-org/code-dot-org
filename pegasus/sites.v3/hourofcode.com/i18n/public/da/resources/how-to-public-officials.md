...
### Få alle skoler til at deltage, alle elever skal lære!
  ...
  8. **Connect locally.** Visit <<%= resolve_url('https://code.org/promote') %>> to learn more about computer science education in your state. Tilmeld dig der og du får opdateringer fra Code.org på deres lokale og statslige indsats.
