...
我們的合作夥伴提供多種[有趣的一小時教程](<%= resolve_url('/learn') %>)，適合各個年齡層的人參與。 [來試一試吧！](<%= resolve_url('/learn') %>)

**所有的一小時玩程式教程：**

- Require minimal prep-time for organizers
- 學習自主 - 讓學生能依自己的步調和能力進行。
...
- 用男女孩都會關心的例子（談談關於拯救生命，幫助人們，串連人們的科技和應用）來解釋科技影響我們的生活的各種方式。
- 列出在日常生活中用到程式碼的事情。
...
- 鼓勵參與者在 [hourofcode.com/learn](<%= resolve_url('/learn') %>) 網站觀看並嘗試另一個「一小時玩程式」活動。
...
- 造訪[一小時玩程式的論壇](http://forum.code.org/c/plc/hour-of-code)，從其他組織獲得建議與支援。 <% if @country == 'us' %>
