...
[![รูปภาพ]({{ hoc_logo_fit_200 }})]({{ hoc_logo }})
...
Computers are everywhere, changing every industry on the planet, but only 45% of all high schools teach computer science. มีเด็กผู้หญิงและชนกลุ่มน้อยอยู่ในชั้นเรียนวิชาวิทยาการคอมพิวเตอร์และในอุตสาหกรรมด้านเทคโนโลยีน้อยอย่างมาก ข่าวดีคือ พวกเรากำลังจะเปลี่ยนแปลงสิ่งนี้
...
Hour of Code จัดโดยองค์กรไม่หวังผลกำไร Code.org และอีกกว่า 100 องค์กร เป็นการเคลื่อนไหวระดับโลกที่เชื่อว่านักเรียนในวันนี้พร้อมแล้วที่จะเรียนรู้ทักษะสำหรับความสำเร็จในศตวรรษที่ 21 โปรดร่วมกับเรา
