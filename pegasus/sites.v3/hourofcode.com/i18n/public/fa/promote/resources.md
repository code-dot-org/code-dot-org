...
رایانه ها همه جا هستند, اما مدارس کمتری نیست به ده سال پیش علوم کامپیوتر را تدریس می‌کنند. Good news is, we’re on our way to change this. If you've heard about the Hour of Code before, you might know it made history. More than 100 million students have tried an Hour of Code.
