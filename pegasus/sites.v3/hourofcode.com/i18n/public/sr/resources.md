...
наслов: Ресурси приказ: широк нав: resources_nav
...
## Разгласите помоћу ових летака

[![](<%= localized_file('/images/fit-250/one-pager.png') %>)](<%= localized_file('/files/hoc-one-pager.pdf') %>)

## Поделите ове летке наставницима у школама

[![](<%= localized_file('/images/fit-250/schools-handout.png') %>)](<%= localized_file('/files/schools-handout.pdf') %>)

<a id="videos"></a>

## Инспиришите ученике помоћу ових снимака

<div style="float:left; padding:10px">
  <iframe width="350" height="195" src="https://www.youtubeeducation.com/embed/nKIu9yen5nc?iv_load_policy=3&rel=0&autohide=1&showinfo=0" frameborder="0" allowfullscreen></iframe>  
  <p>
    <a href="https://www.youtube.com/watch?v=nKIu9yen5nc"><strong>Шта се не учи у већини школа (5 мин)</strong></a> <a href="https://dl.dropbox.com/sh/6sdjczibjih6x8s/Rjs8XgYNzr/Code-5-minute.mov?dl=1"><img src="/images/download.png" width="30px" /></a>
  </p>
</div>
...
<div style="float:left; padding:10px">
  ...
  <p>
    <a href="https://www.youtube.com/watch?FC5FbmsH4fw"><strong>Hour of Code је стигао - свако може научити</strong></a> <a href="http://s3.amazonaws.com/cdo-videos/HoC-video-15mb.mp4"><img src="/images/download.png" width="30px" /></a>
  </p>
</div>
...
<div style="float:left; padding:10px">
  ...
  <p>
    <a href="https://www.youtube.com/watch?6XvmhE1J9PY"><strong>Председник Обама о информатици</strong></a>
  </p>
</div>
...
<div style="float:left; padding:10px">
  ...
  <p>
    <a href="https://www.youtube.com/watch?qYZF6oIZtfc"><strong>Свако може научити (1 мин)</strong></a> <a href="https://dl.dropbox.com/sh/6sdjczibjih6x8s/_0RSOSY8oW/Code-1-min.mov?dl=1"><img src="/images/download.png" width="30px" /></a>
  </p>
</div>
...
## Поставите ове банере на свој сајт
