...
**Code.org提供会为公司雇员提供[联系](<%= resolve_url('https://code.org/volunteer') %>)进行编程一小时项目的当地教室来分享他们的教学成功经验以及激励学生学习计算机科学的机会。**
...
要获得编程一小时活动的最佳体验，需要有能连接互联网的电脑 但是你 **不是** 必须要有电脑才能做参与每一项活动, 甚至你没有电脑都可以参与这个编程一小时活动。
...
编程一小时只是了解科技是如何运行，软件如何创建的旅程的第一步。 要继续该旅程，[鼓励你的参与者在线学习](<%= resolve_url('https://code.org/learn/beyond') %>).
