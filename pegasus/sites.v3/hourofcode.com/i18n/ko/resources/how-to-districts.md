...
## 모든 학교들이 참여해서, 모든 학생들이 배워볼 수 있도록!
  ...
  1. **지역 학교들을 모집하세요.** 그리고 과 를 공유하거나, 요약 <a</p></li> 
      ...
      * **또한 [모든 조직/운영자들](<%= hoc_uri('/prizes') %>)을 위한 상품들도 제공됩니다.** 모든 교육자들은 감사의 의미로 소정의 상품을 받게 됩니다. 100 개의 학급들은 특별 게스트들과 비디오 채팅을 하게 됩니다. 특별 게스트들에는 빌 게이츠(Bill Gates), 셰릴 샌드버그(Sheryl Sandberg), 애쉬튼 커쳐(Ashton Kutcher) 등으로 구성됩니다. 그리고 참여하는 학교들 중, 주별로 한 학교들은 그 학교를 위해 $10,000 상당의 지원금을 받게 됩니다!</ol>