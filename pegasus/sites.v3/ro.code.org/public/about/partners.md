...
<div class="container main-content">
  <div class="row">
          <h1 class="text-align-center">Sponsori corporate</h1><div class="row"><div class="col-sm-3 col span_3">
                    <div class="logo_column text-align-center" style="display: table; height: 160px; width: 100%;">
                      <a href="http://www.intel.com" target="_blank"><img src="http://adfaber.org/wp-content/uploads/2014/11/intSFT_rgb-140x127.png" style="max-width: 140px; max-height: 140px;"></a>
                    </div>
                    ...
                    <div class="logo_column text-align-center" style="display: table; height: 160px; width: 100%;">
                      <a href="http://www.mcdonalds.ro" target="_blank"><img src="http://adfaber.org/wp-content/uploads/2014/12/McD-Logo_fundal-alb_AI9-culori-noi-alta-varianta-140x158.jpg" style="max-width: 140px; max-height: 140px;"></a>
                    </div>
                  </div><div class="col-sm-3 col span_3">
                    <div class="logo_column text-align-center" style="display: table; height: 160px; width: 100%;">
                      <img src="http://adfaber.org/wp-content/uploads/2014/12/HERO_DC_ALL_BLACK_RGB-140x118.png" style="max-width: 140px; max-height: 140px;">
                    </div>
                  </div><div class="col-sm-3 col span_3">
                    <div class="logo_column text-align-center" style="display: table; height: 160px; width: 100%;">
                    ...
                    <div class="logo_column text-align-center" style="display: table; height: 160px; width: 100%;">
                      <a href="http://lse.org.ro/" target="_blank"><img src="http://adfaber.org/wp-content/uploads/2014/12/LSE-140x140.png" style="max-width: 140px; max-height: 140px;"></a>
                    </div>
                  </div><div class="col-sm-3 col span_3">
                    <div class="logo_column text-align-center" style="display: table; height: 160px; width: 100%;">
                      <a href="http://mobilpro.lse.org.ro/" target="_blank"><img src="http://adfaber.org/wp-content/uploads/2014/12/MP_2015-140x57.png" style="max-width: 140px; max-height: 140px;"></a>
                    </div>
                  </div><div class="col-sm-3 col span_3">
                    <div class="logo_column text-align-center" style="display: table; height: 160px; width: 100%;">
                      <a href="http://www.jaromania.org" target="_blank"><img src="http://adfaber.org/wp-content/uploads/2014/11/JA-YE-ROMANIA_vf-e1416154651265-140x76.jpg" style="max-width: 140px; max-height: 140px;"></a>
                    </div>
                  </div><div class="col-sm-3 col span_3">
                    <div class="logo_column text-align-center" style="display: table; height: 160px; width: 100%;">
