## Additional ways <%= @company['display_name_s'] %> employees can help:
  - [Volunteer as a guest speaker in a classroom](https://code.org/volunteer) during the Hour of Code in your local community.
  ...
  - [Donate to Code.org](https://code.org/donate) to bring computer science to more girls and underrepresented minorities.
