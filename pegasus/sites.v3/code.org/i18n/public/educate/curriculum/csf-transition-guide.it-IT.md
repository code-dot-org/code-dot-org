...
## Panoramica
Il panorama dello studio dell'informatica è cambiato drasticamente dalla creazione dei primi corsi di Fondamenti dell'informatica. Inizialmente, i corsi 1-4 sono stati progettati come punto di partenza per acquisire le basi, indipendentemente dall'età dello studente che si avvicinava alla disciplina.  Ora che molti più paesi hanno messo in atto corsi di informatica che iniziano dalla scuola dell'infanzia, gli insegnanti richiedono più contenuti per portare gli studenti fino a agli istituti superiori.

I corsi di Fondamenti di informatica A-F sono la nostra risposta a questo problema.  La creazione di un curriculum per gradi, ci ha permesso di fare un passo indietro e ripensare il modo in cui abbiamo presentato il materiale.  It also allowed us the chance to wholeheartedly incorporate feedback from the dedicated teacher community that has supported us on this mission. Designed with the help of some of the best elementary school CS education specialists across the country, Courses A-F should feel familiar enough to run with no extra professional development, but fresh enough to present to students who have done our lessons in the past.
