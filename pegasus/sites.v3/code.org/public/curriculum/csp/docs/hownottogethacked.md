...
<img src="images/encrypt-https.PNG" style="float:left; height:260px; margin:0px 20px 0px 0px;">
...
<img src="images/security-phishing-real.PNG" width="450" style="margin:0px 0px 0px 15px;">
</div>
