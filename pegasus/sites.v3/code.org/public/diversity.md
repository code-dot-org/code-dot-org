...
The charts below show participation in the AP Computer Science exam among female students and underrepresented minorities. Not only has overall participation grown, but the representation of these traditionally underrepresented groups has been increasing. Although these charts are a barometer of Code.org's work to popularize computer science, break stereotypes, and build the K-12 pipeline, the improvements aren't the result of Code.org's work alone. Thousands of passionate computer science teachers have worked for years to improve diversity in their classrooms, and they deserve the most credit for these outcomes. While things are moving in the right direction, we have a long way to reach a balanced population in AP Computer Science, which is why Code.org focuses on the entire K-12 pathway.

<center><img src="/images/infographics/fit-800/apcs2017.png" style="max-width: 100%"/></center>

<center><img src="/images/infographics/fit-800/apcs2017percent.png" style="max-width: 100%"/></center>
<br/><br/>
