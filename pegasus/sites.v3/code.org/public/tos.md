...
4. use any de-identified User Content for any lawful purpose (such as product development, research or other purposes) subject to the [Data Privacy Addendum](https://code.org/dpa); and
5. use for other purposes permitted by the [Data Privacy Addendum](https://code.org/dpa) and the Code.org [Privacy Policy](https://code.org/privacy).
