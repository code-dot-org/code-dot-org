...
If you decide to register for a Code.org account through an Authentication Service (such as Google Accounts, Microsoft Accounts, Facebook Connect, Celver, or PowerSchool), you give Code.org the permission to store and use information already associated with your Authentication Service consistent with this Privacy Policy and the table above.
...
* Essential cookies: these ensure the Website works properly for Users. As one example, when you authenticate and login, thanks to essential cookies you aren’t prompted to re-enter your password on every single page you visit during your browsing session.
