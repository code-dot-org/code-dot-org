...
<div class="col-50" style="padding-bottom:15px">
  <div class="tutorial-tile" style="padding-right:20px">
      <div class="tutorial-info" style="background-color: var(--brand_primary_default); border: 1px solid var(--brand_primary_default); border-top: none; border: 0.5px solid var(--brand_primary_default); border-radius: 15px 15px 0 0; padding: 15px 25px 25px 25px; min-height: 0">
    ...
    <div class="tutorial-info" style="background-color: #ffffff; border: 1px solid var(--brand_primary_default); border-top: none; border-radius: 0 0 15px 15px; padding: 15px 25px 25px 25px">
