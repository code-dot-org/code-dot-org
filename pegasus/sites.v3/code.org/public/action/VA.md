...
I’m writing to urge you to implement a district-wide change to allow computer science to count as a mathematics, science or CTE graduation credit in our district, and communicate the change to all students. 
...
+ Use the above letter to send to your district superintendent or administrator. This letter is tailored to your state and outlines the Virginia State Statute and Board of Education graduation standards that explicitly state that computer science counts towards a graduation credit.  
+ Urge your school board to send a memo to all principals and guidance counselors clarifying that computer science will now count as a graduation credit in accordance with HB 1054. 
