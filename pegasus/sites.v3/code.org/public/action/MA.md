...
According to Massachusetts State Statute, each local school districts has the authority to establish its own high school <a href="http://www.doe.mass.edu/mcas/graduation.html"_blank">graduation requirements</a> to exceed the minimum expectations outlined in the state graduation guidelines. **Please consider making our district a leader in computer science education by allowing computer science courses to fulfill a district math or science graduation credit for students interested in this career pathway.**
