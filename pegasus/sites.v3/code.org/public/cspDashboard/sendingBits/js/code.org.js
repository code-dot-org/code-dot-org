...
function bitsToInts(bits, chunkSize){
  ...
  //Adding strip out everything except 0s and 1s
  bits = bits.replace(/[^01]/g,"")
 // console.debug("bits2Ints....");
 // console.debug("bit String: "+bits);
...
remoteStorage.removeItem = function(keyword){
    remoteStorage.removeItem(keyword,null);
}
remoteStorage.removeItem = function(keyWord, callback){
  Parse.initialize("IuyeuvogPwCIzHohhXwldAjHfFa7FprF2wKjPSCj", "0Tgr28yVJGg8p4AFfSRmT40DiYrPS6sPKw7C2Juo");
  var RemoteObj = Parse.Object.extend("RemoteStorage");
  var query = new Parse.Query(RemoteObj);
  ...
  query.find({
    success: function(obj){
      ...
      if(obj!=null && obj.length>0 && obj[0].get("value")!=null && obj[0].get("value")!="null"){
...
remoteStorage.updateOrCreate = function(keyWord, newValue, callback){
  ...
  query.find({
    success: function(obj){
      ...
      if(obj!=null && obj.length>0 && obj[0].get("value")!=null){
        var list = [];
        for(var i=0; i<obj.length; i++){
            list[i] = obj[i].get("value");
        }
      ...
      if(callback!=null) callback(getResult);
