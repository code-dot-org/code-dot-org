...
Code.org is selecting United States based organizations, as partners, to help spread computer science in a local, sustainable fashion. The goal of the Regional Partner program is to help each organization establish itself as the K-12 computer science hub for their region, working towards the goal that every student in every school should have the opportunity to learn computer science.

The expectation is that in the long-run each partner organization can sustain this work independently of Code.org.
