...
**Can I Host Workshops for More than 80 People?**
...
**How will Code.org reimburse me for these workshops?**
Admin/Counselor workshops will be paid the same way as K-12 workshops as outlined in the [Workshop Payments](#workshops) section above. Invoicing, rather than using the dashboard, should be reserved for special circumstances.

*Ex: Your organization's per person rate is $30pp. 25 individuals register for your workshop, 20 show up and are marked attended by you in the dashboard. Code.org will send you a check for 20 * $30 = $600.*<br/>
