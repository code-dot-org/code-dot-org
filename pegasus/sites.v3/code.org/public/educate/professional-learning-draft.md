...
* Our 1-day, no cost, workshops prepare educators (teachers, librarians, tech-ed specialists, etc.) to introduce computer science basics in a format that’s fun and accessible to the youngest learners (grades K-5)
* No previous experience teaching computer science needed
* Increase your knowledge and confidence in running an engaged computer science classroom
* Connect with other educators in your area who are working to bring computer science to their schools
* Workshops take place year-round and are facilitated by experienced computer science educators across the United States
* Facilitated by experienced computer science educators across the United States
* Covers content for [our elementary school Computer Science Fundamentals curriculum](/educate/curriculum/elementary-school)
* You will receive some supplies to help you teach the courses - all at no cost

<a href="/professional-development-workshops"><button>Find a local K-5 workshop</button>
<br/>
<br/>
</p>
