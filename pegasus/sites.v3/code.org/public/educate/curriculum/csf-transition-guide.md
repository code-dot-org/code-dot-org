...
| Question | Answer |
|---|---|
| **You are launching a new set of courses-- does that mean that Courses 1-4 are going away?**  | Yes. Courses 1-4 no longer meet modern standards. CS Fundamentals courses A-F better teach these computer science concepts. We will be removing Courses 1-4 gradually. Starting at the end of the 2022-2023 school year, we will remove references to these courses, but the links you already have will remain. Starting in July 2023, the courses will no longer be accessible on our site.  |
