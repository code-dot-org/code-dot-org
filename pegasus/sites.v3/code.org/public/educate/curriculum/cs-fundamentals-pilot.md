...
### We’re looking for “early adopters” to start teaching an updated CS Fundamentals curriculum during the winter and spring of 2017.

Teachers like you play a critical role in building our computer science curriculum for all students, and we are eager to hear your feedback before we fully release exciting new updates to Code.org’s Computer Science Fundamentals Courses 1-4 in August 2017 for the ‘17 - ‘18 school year. Help us by putting the new CS Fundamentals in your class early!

Learn more about the big updates below, and if you’d like to be an early adopter of this curriculum in your classroom, <a href="http://go.pardot.com/l/153401/2017-01-31/djn4q4" target="_blank">sign up to receive the development plans, latest updates, and new resources</a>.
...
- **There is no special training or additional experience necessary to use the updated Courses A-F!** If you are interested in being an early adopter for the updates and are comfortable with teaching the current version of CS Fundamentals, the updates will feel familiar. The courses still incorporate a blend of plugged and unplugged activities, and encourage persistence, pair programming, and computational thinking in students. There will, however, likely be more bugs and issues with the updates as there are many new puzzles. So please consider your comfort level with that as you decide whether or not you’d like to be an early adopter. 
...
In Code Studio, there are a handful of new tools that have been created that allow us to improve the way that concepts within a stage are taught and supported throughout Courses A - F. 

- **Limited number of blocks**: Many puzzles in Courses A - F now use “limited blocks” to only give students a certain number of times they can pull a block from the toolbox to use in their solution. In the example to the right, there is only 1 move forward block! That means that in order to solve the puzzle, the student must correctly utilize the repeat block to get the zombie to the sunflower.

<p align="center">
<img src="/images/csfundamentalspilot/puzzle1.png" height="250px"/>  <img src="/images/csfundamentalspilot/blocksforpuzzle.png" height="250px"/></p>
...
<p align="center"><img src="/images/csfundamentalspilot/puzzle2.png" width="250px"/>
   <img src="/images/csfundamentalspilot/puzzle3.png" width="250px"/></p><br>

- <img src="/images/csfundamentalspilot/unpluggedbridge.png" align="right" width="50%"/>**Bridging Activities from Unplugged → Plugged**: The lesson plans for plugged stages on Code Studio now contain new guidance and a paper block toolkit that can be used to practice coding with blocks with your students offline before bringing them to the online puzzles!
<br><br>
<a name="whatsthere"></a>
...
These courses are not yet listed on studio.code.org, but can be accessed directly at:
...
When you’re ready to have your students access the course, you can assign the course to a section of students from the Teacher Home Page as you have with other courses. Just scroll down to the “In-development: CS Fundamentals” area of the course selection dropdown, and pick the course that works best for your class:
...
### Monthly updates
I’ll be sending monthly updates on our progress throughout the spring and summer leading up to our August launch of the new CS Fundamentals courses. If you [sign up to participate in the pilot](http://go.pardot.com/l/153401/2017-01-31/djn4q4), you'll get the emails!
