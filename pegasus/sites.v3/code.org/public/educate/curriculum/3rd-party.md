...
| [Kodable](https://www.kodable.com/) | Free registration includes over 10 hours of easy to follow lessons that foster creativity and include gamified practice from Sequence to JavaScript. Teacher videos and resources explain new concepts before each unit. Progress tracking allows teachers to monitor CS standards and outcomes with weekly updates and reports.  School plans start at $800, Student Licenses for individual classes are $30/student. District discounts available. | One free 30-minute PD session with any School plan purchase. Additional PD offerings include online and in person options. Customized to meet needs and goals, costs start at $1,500. Bi-Annual webinars for free users and School customers. |
