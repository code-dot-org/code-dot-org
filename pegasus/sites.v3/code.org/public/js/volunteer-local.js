...
function createElement2(tag, attributes, text) {
...
function compileHTML(index, location) {
  ...
  elements.push(
    createElement2("h3", { class: "entry-detail" }, location.name_s)
  );
  ...
  if (location.experience_s) {
    elements.push(createElement2("strong", null, location.experience_s));
  }
  ...
  if (location.location_flexibility_ss) {
    ...
    elements.push(createElement2("strong", null, "How I can help:"));
    elements.push(
  ...
  if (location.description_s) {
    elements.push(createElement2("strong", null, "About me:"));
  ...
  if (location.linkedin_s) {
    ...
    elements.push(createElement2("strong", null, "LinkedIn profile:"));
  ...
  if (location.facebook_s) {
    ...
    elements.push(createElement2("strong", null, "Facebook profile:"));
    elements.push(document.createTextNode(location.facebook_s));
  }

  let html_str = "";
  elements.forEach(elem => {
    let div = createElement2("div", { class: "profile-detail entry-detail" });
    div.appendChild(elem);
    html_str += div.outerHTML;
  });
