...
- [Make School](http://make.sc/codelearn) is a new college in San Francisco offering a Bachelor's degree in Applied Computer Science. The degree is designed in partnership with top tech companies and teaches a combination of liberal arts, civics, and computer science. Tuition for the full two-year program is $70,000, with financial aid and living stipends offered to remove all upfront costs. Students only pay tuition after they get a job making over $60k/year. 
