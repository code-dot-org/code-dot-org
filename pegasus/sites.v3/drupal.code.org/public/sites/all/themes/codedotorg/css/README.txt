...
To use these stylesheets, rename the files and codedotorg with the name of your theme.
...
codedotorg-alpha-default-narrow.css  
...
codedotorg-alpha-default-normal.css
...
codedotorg-alpha-default-wide.css
