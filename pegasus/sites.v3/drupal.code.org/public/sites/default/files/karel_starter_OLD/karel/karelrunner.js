var KarelRunner = {
    ...
    loadWorld: function(world){
        ...
        $.ajax({
            ...
            dataType: 'json',
            success: function(data) {
                self.solutionWorld = new KarelWorld(data.rows, data.cols);
                self.solutionWorld.setKarelLocation(data.start.row, data.start.col);
                self.setKarelDirection(data.dir, self.solutionWorld);
                self.solutionWorld.setupBeepers(data.beepers);
            },
            error: function(data) {
                self.solutionWorld = null;
            }
        });
*/
