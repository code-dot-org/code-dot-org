...
def use_min_stylesheet?
  pages_verified = {
    ...
    'Educator Overview': '/educate',
    'Community and Support': '/educate/community',
    'Computer Science Principles': '/educate/csp',
    'CS Fundamentals for grades K-5': '/educate/curriculum/elementary-school',
    '3rd Party Educator Resources': '/educate/curriculum/3rd-party',
    'Tools and videos': '/educate/resources/videos',
    'How to help': '/help',
    'Teacher Resources-Star Wars': '/hourofcode/starwars',
    'Teacher Resources-MINECRAFT': '/hourofcode/mc',
    'Learn': '/learn',
    'Promote Computer Science': '/promote',
    'Minecraft': '/minecraft',
    'Star Wars': '/starwars',
