...
module AnalyticsConstants
  EVENTS = [
    ...
    MIDDLE_SCHOOL_CURRICULUM_PAGE_VISITED_EVENT =
      'Middle School Curriculum Page Visited'.freeze,
    HIGH_SCHOOL_CURRICULUM_PAGE_VISITED_EVENT =
      'High School Curriculum Page Visited'.freeze,
    ...
    HOC_ACTIVITY_START_BUTTON_CLICKED = 'Hour of Code Activity Start Button Clicked'.freeze,
  ].freeze
end
