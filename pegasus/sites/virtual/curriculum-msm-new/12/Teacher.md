...
<%= partial('curriculum_header', :unplugged=>false, :title=> 'Play Lab: Animation',:disclaimer=>'Basic lesson time includes activity only. Introductory and Wrap-Up suggestions can be used to delve deeper when time allows.', :time=>45) %>
