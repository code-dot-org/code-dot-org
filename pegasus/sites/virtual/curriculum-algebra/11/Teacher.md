...
In this stage you'll use the Design Recipe to create functions that solve word problems. Head to [CS in Algebra stage 11](http://studio.code.org/s/algebra/lesson/11/puzzle/1) in Code Studio to get started programming.
