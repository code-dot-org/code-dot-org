...
In this activity you'll use the new data types String and Image to compose art with Blocks of Evaluation - head to [CS in Algebra Stage 3](http://studio.code.org/s/algebra/lesson/3/puzzle/1) in Code Studio to get started programming.
