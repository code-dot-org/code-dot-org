...
- [Example Game](http://studio.code.org/s/algebra/lesson/1/puzzle/2/)
...
Let’s begin by exploring a simple video game, and then figuring out how it works. Open [this link](http://studio.code.org/s/algebra/lesson/1/puzzle/2/) to play the game, and spend a minute or two exploring it. You can use the arrow keys to move the up and down - try to catch the unicorn and avoid the dragon!
...
Visit [CS in Algebra Stage 1](http://studio.code.org/s/algebra/lesson/1/puzzle/1) in Code Studio to complete the assessments.
-->
