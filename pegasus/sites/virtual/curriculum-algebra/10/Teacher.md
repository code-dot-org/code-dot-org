...
In this stage you'll write functions that manipulate images to create animations. Head to [CS in Algebra stage 10](http://studio.code.org/s/algebra/lesson/10/puzzle/1) in Code Studio to get started programming.
