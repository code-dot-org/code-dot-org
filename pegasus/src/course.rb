...
class Course
  PRODUCTION_COURSES = %w(course1 course2 course3 msm mss)
  COURSES_WITHOUT_UNIT_NUMBERS = %w(course1 course2 course3 msm)
  COURSES_WITH_PDF_GENERATION = %w(course1 course2 course3 msm csp)
