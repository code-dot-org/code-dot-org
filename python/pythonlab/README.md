...
## Building a package
From the package folder containing `pyproject.toml`, run `uv build`. The generated `.whl` file will be in the `python/dist` folder
(the uv workspace root is `python/`).
