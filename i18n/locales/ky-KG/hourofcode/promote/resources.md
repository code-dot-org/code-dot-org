...
**Байланыш:** [АТЫҢАР], [TITLE], МОБ: (212) 555-5555
...
That’s why our entire school is joining in on the largest learning event in history: The Hour of Code, during Computer Science Education Week (<%= campaign_date('full') %>). Код саатын дүйнө жүзүндө 100 миллиондон ашык киши байкап көрүштү.

Our Hour of Code is making a statement that [SCHOOL NAME] is ready to teach these foundational 21st century skills. To continue bringing programming activities to your students, we want to make our Hour of Code event huge. I encourage you to volunteer, reach out to local media, share the news on social media channels and consider hosting additional Hour of Code events in the community.

Бул [АЙЫЛ/ШААРДЫН АТЫ] билим берүүнүн келечегин өзгөртүү мүмкүнчүлүгү.

Мындан http://hourofcode.com/<%= @country %> окуп, маалымат таратууга жардам бергиле.
