...
Code.org เป็นเจ้าภาพจัดกิจกรรม Hour of Code™ บทเรียน และวิดีโอที่หลากหลายบนเว็บไซต์ Code.org และ Hour of Code รายการปัจจุบันอยู่ที่ [houro]({{ urls/learn }})fcode.com/learn
...
*ข้อกำหนดทางเทคนิค:* เนื่องจากความหลากหลายของการตั้งค่าเทคโนโลยีในโรงเรียนและห้องเรียนกิจกรรมที่ดีที่สุดคือ Web-based หรือ Smartphone-friendly หรือ unplugd-style กิจกรรมที่สอนแนวคิดวิทยาการคอมพิวเตอร์โดยไม่ต้องใช้คอมพิวเตอร์ (ดู http://csunplugged.com/) [](http://csunplugged.com/) กิจกรรมที่ต้องใช้แอปติดตั้งแอป แอปเดสก์ท็อป หรือประสบการณ์เกมคอนโซลสามารถใช้งานได้แต่ไม่เหมาะอย่างยิ่ง เราจะไม่แสดงรายการกิจกรรมที่ต้องลงทะเบียนหรือการชำระเงิน. (กิจกรรมหุ่นยนต์อาจต้องซื้อหุ่นยนต์)
...
* กิจกรรมนี้รวมถึง AI: ใช่หรือไม่
...
* รายการภาษาโปรแกรมที่กิจกรรมของคุณสอน เช่น C/C ++, Java, JavaScript, ฯลฯ หรือ ภาษาอิสระ (สำหรับแผนการเรียนที่สามารถสอนได้หลายภาษา) เลือกภาษาศิลป์
* รายการภาษาธรรมชาติที่รองรับ หมายเหตุ: การตรวจจับภาษาเป็นความรับผิดชอบของผู้ให้บริการกิจกรรม เราจะเปลี่ยนเส้นทางผู้ใช้ทั้งหมดไปยัง URL เดียวที่ให้ไว้ หรือ ภาษาอิสระ (สำหรับแผนการเรียนที่สามารถสอนได้หลายภาษา)
* นักการศึกษาควรมีประสบการณ์ระดับใดในการใช้กิจกรรมของคุณ (เช่น ผู้เริ่มต้นหรือสะดวกสบาย)และ, สิ่งที่ระดับของประสบการณ์ที่นักเรียนควรมี?
...
* เพื่อให้สามารถติดตามการมีส่วนร่วมได้อย่างแม่นยำมากขึ้น คู่ค้าด้านการสอนของบุคคลที่สามจำเป็นต้องรวมภาพการติดตาม 1 พิกเซลไว้ในหน้าแรกของบทแนะนำชั่วโมงแห่งโค้ด ดู</a> ส่วนพิกเซล ติดตามด้านล่างสำหรับรายละเอียดเพิ่มเติม</li> 
    
    * เมื่อเสร็จสิ้นกิจกรรมของคุณผู้ใช้ควรถูกนำไปยัง [code.org/api/hour/finish](https://code.org/api/hour/finish) ที่พวกเขาจะสามารถ: 
    ...
    * (ไม่บังคับ) เราอาจติดตามผลด้วยลิงก์แบบสำรวจออนไลน์/แบบฟอร์มเพื่อขอรายงานตัวชี้วัดกิจกรรมต่อไปนี้: 
        ...
        * สำหรับกิจกรรมออฟไลน์ 
            * จำนวนการดาวน์โหลดของกิจกรรมที่เป็นกระดาษ (ถ้ามี)</ul> 
...
<a id="inclusion"></a>
    ...
    คณะกรรมการที่มีความหลากหลายของนักการศึกษาวิทยาการคอมพิวเตอร์จะจัดอันดับการส่งผลงานตามเกณฑ์เชิงคุณภาพและเชิงปริมาณ กิจกรรมทั้งหมดที่เหมาะสมกับเกณฑ์พื้นฐานจะถูกระบุไว้.
    
    สำหรับกิจกรรมการเขียนโค้ดแบบดั้งเดิม คณะกรรมการที่มีความหลากหลายของนักการศึกษาวิทยาการคอมพิวเตอร์จะจัดอันดับการส่งผลงานตามเกณฑ์เชิงคุณภาพและเชิงปริมาณ กิจกรรมทั้งหมดที่เหมาะสมกับเกณฑ์พื้นฐานจะถูกระบุไว้. ครูจะสามารถคัดกรองและจัดเรียงเพื่อค้นหากิจกรรมที่ดีที่สุดสำหรับชั้นเรียนของพวกเขา
...
<a id="design"></a>
    ...
    กิจกรรมไม่จำเป็นต้องมี AI แต่เรากำลังมองหาที่จะนำเสนอกิจกรรมที่เกี่ยวข้องกับ AI มากขึ้น
    ...
    **ส่งเสริมให้นักเรียนโพสต์ลงในโซเชียลมีเดีย (ตามความเหมาะสม) เมื่อพวกเขาเสร็จแล้ว** ยกตัวอย่างเช่น “ฉันได้ทำชั่วโมงรหัสด้วย ________ คุณ? #HourOfCode” หรือ “ฉันได้ทำ #HourOfCode เป็นส่วนหนึ่งของ #CSEdWeek. แล้วคุณล่ะ
...
<a id="pixel"></a>
    ...
    หากกวดวิชาของคุณได้รับการอนุมัติและรวมอยู่ในหน้ากวดวิชาสุดท้าย Code.org จะช่วยให้คุณมีพิกเซลติดตามที่ไม่ซ้ำกันสำหรับคุณที่จะรวมเข้ากับการกวดวิชาของคุณ ดูตัวอย่างด้านล่าง ไม่รวมในหน้าใด ๆ ระหว่างกาลของการกวดวิชาของคุณ.
