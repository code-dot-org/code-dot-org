...
See our [event how-to guide]({{ urls/how_to_events }}) for a sample run of show, [media outreach kit]({{ promote/press_kit_url }}), and other event-planning resources. การจัดกิจกรรมเป็นวิธีที่ดีในการโปรโมท Hour of Code และเพิ่มการมีส่วนร่วม
