...
เพื่อประสบการณ์ Hour of Code ที่ดีที่สุด ควรจะมีคอมพิวเตอร์ที่เชื่อมต่อกับอินเทอร์เน็ต But you **don’t** need a computer for every child, and you can even do the Hour of Code without a computer at all.

อย่าลืมทดลองการสอนในคอมพิวเตอร์หรืออุปกรณ์ของนักเรียน เพื่อให้มั่นใจว่ามันใช้งานได้อย่างปกติบนเบราว์เซอร์โดยมีเสียงและวิดีโอ **Have low bandwidth?** Plan to show videos at the front of the class, so each student isn't downloading their own videos. Or try the unplugged / offline tutorials.
...
**When someone comes across difficulties it's okay to respond:** - “I don’t know. "ให้เราช่วยกันค้นหาคำตอบด้วยกัน" -"เทคโนโลยีบางครั้งก็ไม่ได้เป็นอย่างที่เราต้องการ" -"การเรียนการเขียนโปรแกรมก็เหมือนกับการเรียนภาษาใหม่ คุณจะไม่เก่งในทันที"
