...
<a id="tm"></a>
    ...
    ** செயல்பாட்டின் முடிவில் கருத்துக்களை இணைக்கவும்.** (எ.கா. “நீங்கள் 10 நிலைகளை முடித்து சுழல்களைப் பற்றி அறிந்து கொண்டீர்கள்! பெரிய வேலை! ”) We don't want to prevent this usage, but we want to make sure the usage falls within a few limits:
