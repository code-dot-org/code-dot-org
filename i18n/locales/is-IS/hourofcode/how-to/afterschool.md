...
Við bjóðum upp á fjölbreytt [skemmtileg, klukkustundar löng kennslumyndbönd](%= resolve_url('/learn') %) fyrir þátttakendur á öllum aldri, búið til af fjölbreyttum hópi af samstarfsaðilum. [Endilega prófaðu!](%= resolve_url('/learn') %)

**Öll "Klukkutími af forritun" myndböndin:**

- Require minimal prep-time for organizers
- Eru sjálfshjálpar- þannig að krakkarnir geta unnið á eigin hraða og á mismunandi færnisviðum
...
**Þegar einhver lendir í vandræðum er í lagi að bregðast við:**
...
- Hvettu þátttakendur til að prófa aðra "Klukkustund af forritun" á [hourofcode.com/learn](%= resolve_url('/learn') %)
- Eða, biddu þá sem klára fyrst að hjálpa öðrum sem eru í vandræðum.
