...
Code.org® är en ideell organisation dedikerad till att utöka deltagande i datavetenskap genom att göra den tillgänglig i fler skolor och ökat deltagande av kvinnor och underrepresenterade elevgrupper.

Vänligen läs denna sekretesspolicy ("**Sekretesspolicy**") noggrant innan du besöker eller använder webbplatsen.

## Code.org sekretessprinciper

Our Privacy Notice is fueled by our commitment to the following Privacy Principles:

  1. Vi är djupt engagerade i att skapa en trygg och säker lärandemiljö för våra elever och lärare. Vi tar skydd av informationen på allvar.
  2. Vi kräver inte att du behöver ge någon personlig Information för att prova våra tutorials, som alla är tillgängliga utan ett användarkonto. 
  3. Den enda anledningen till att vi samlar in data från elever eller lärare är för att bättre lyckas med vårt uppdrag att tillhandahålla en bra datavetenskaplig utbildning för varje student som vill ha den. 
  4. Vi säljer inte din personliga Information eller utnyttjar den för ekonomisk vinning; Vi säljer inte annonser. Vi är en amerikansk välgörenhetsorganisation (501c 3) och våra intäkter kommer från donationer. Vi etablerat oss som en ideell organisation så vårt uppdrag och ditt förtroende inte kommer i konflikt med ett vinstdrivande motiv.
  5. Student akademiska data som tillhandahålls av skoldistrikt partner till 3: e part utvärderare för att utvärdera om våra kurser uppfylla vårt uppdrag förblir anonym / avidentifierade (per standard industripraxis). 
  6. Vi strävar efter att ge dig tillgång till och kontroll över den information du ger oss (som anges nedan), och vi tar skydd av din information på allvar.

## Sekretessmeddelande

Vi är engagerade i att skapa en trygg och säker miljö för elever i alla åldrar på våra webbplatser som ligger på <http://code.org>, <http://csedweek.org>, <http://computinginthecore.org>, <http://hourofcode.com>, andra webbplatser, program (vår "API"), och online-tjänster (tillsammans, "hemsidan"). Visitors and users of the Website and participants in our education programs are referred to individually as “User” and collectively as “Users”. Som en icke-vinstdrivande, 501(c)(3) organisation, använder vi data vi får endast i den mån det hjälper vårt uppdrag att tillhandahålla en bra datavetenskaplig utbildning för varje elev som vill ha den. Vi etablerat oss som en icke-vinstdrivande organisation så att ett vinstdrivande motiv inte kommer att störa vårt uppdrag att tillhandahålla en betrodd pedagogisk resurs.

Our Privacy Notice describes what information we gather from our Users, how we use that information, and what we do to protect it. Din användning av webbplatsen och all information du lämnar på webbplatsen omfattas av villkoren i denna Sekretessinformation, som ingår i våra användarvillkor. Alla termer med versal begynnelsebokstav somanvänds men inte definierats inom denna Sekretessinformation har den betydelse som ges till dem i våra [Användarvillkor](http://code.org/tos). Genom att besöka eller använda vår webbplats, samtycker du uttryckligen till informationen hanteringsförfaranden som beskrivs i denna sekretessinformation.

Från tid till annan kan vår sekretessinformation komma att ändras. Code.org kommer att meddela Användarna om alla ändringar i vår Sekretessinformation genom att publicera reviderade Sekretessinformation med ett uppdaterat datum på vår hemsida. Om vi gör några betydande förändringar i policyn kommer dessa att tillgängliggöras med ett kort ändringsmeddelande om uppdateringen postat på webbplats hemsida. Vi kan också kontakta Användarna och underrätta dem om förändringarna om det krävs enligt lag. Vi står bakom de löften som vi gör, och inte kommer att ändra hur vi använder Personlig Information som vi redan samlat från användare på något väsentligt sätt utan också att ge meddelande om ändringen via e-post, via denna webbplats eller på annat sätt, och får samtycke till alla nya användningsområden. Vi tar den information som du lämnar till oss på största allvar, och vi strävar efter att sätta dig i kontroll av beslut kring din information.

## Insamling och användning av din information

Avsnitten nedan beskriver hur Code.org samlar in och använder namn, e-postadress, skolans namn och adress eller annan personligt identifierbar information från användare ("**Personuppgifter**"), samt några av de icke-personlig information och teknisk information (beskrivs nedan) som vi samlar in.

**Kodtimmen**: Code.org samlar inte in någon Personlig Information från studenter som deltar i Kodtimmen. För att använda Kodtimmens handledningar behöver man inte logga in.

**Kodstudio**: I följande tabell beskrivs de data som Code.org samlar in från registrerade användare av Kodstudions handledningsplattform. Du kan också prova alla handledningar i Kodstudion utan att skapa ett konto, men ditt lärande framsteg kommer inte att sparas.

| Data som sparas av Code.org om du skapar ett elevkonto i Kodstudion                                                                                                                                                                           | Obligatorisk?                                                                                                                                  | Hur dessa data används                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Visningsnamn (t.ex. "Cool Coder" eller "JohnS")                                                                                                                                                                                               | Obligatoriska                                                                                                                                  | För att ge eleverna ett välkomnande vid inloggning, för att identifiera eleverna i lärarens översikt av elevers framsteg, och för att visa upp elevernas kod-skapelser.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| Framsteg i kursen</br>   
1-datum/tid varje steg är försökt   
2-antal försök för att lösa ett pussel, och huruvida det löstes framgångsrikt eller optimalt   
3-den kod som eleven skickat in. (Detta omfattar konst och spel som de skapar) | Obligatoriskt (automatisk)                                                                                                                     | Denna information visas för elever och deras lärare för att se deras framsteg i en kurs, för att se den kod som de har skapat, och för att identifiera ämnen de behöver hjälp med. Det låter även elever fortsätta där de slutade om de loggat ut och loggar in senare. See [example progress report](http://code.org/files/student-progress.pdf), and see section below on [“technical information”](#techinfo) for additional details.</br>  
...
| Kön                                                                                                                                                                                                                                           | Optional                                                                                                                                       | This information is only used in aggregate, to measure the total % of students that are male or female, to track our progress towards reducing the gender gap in computer science.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| Age (*Not* birthdate)                                                                                                                                                                                                                         | Obligatoriska                                                                                                                                  | To understand the developmental stage of students to offer an age-appropriate experience for each student. We use this field to ensure we don’t store email information for students with age < 13. We collect ages (eg 16), as opposed to birthdates (eg Feb 13, 1998)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
...
| Additional data stored by Code.org if you create a Code Studio teacher account | Obligatorisk? | Hur dessa data används                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| ------------------------------------------------------------------------------ | ------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Skolans namn                                                                   | Optional      | At your option and under your control, we would list your school in the Code.org map and database of schools that teach computer science courses.</br>  
...
| Skolans adress                                                                 | Optional      | At your option and under your control, we would list your school (and relevant contact information, if you provide it) in the Code.org map and database of schools that teach computer science courses.                                                                                                                                                                                                                                                                                                             |
