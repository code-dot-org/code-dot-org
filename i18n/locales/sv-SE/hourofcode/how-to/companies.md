...
Kolla in stegen nedan för att komma igång, och se vår [guide för företagspartners](/files/hoc-corporate-toolkit.pdf) för mer om hur du får ditt företag upphetsat över Hour of Code.

- [Anslut till en lokal skola](#connect-with-a-school)
- [Uppmuntra anställda att arbeta som volontär med ett klassrum](#encourage-employees)
...
## Anslut till en lokal skola

Det är alltid bäst att börja lokalt, med skolor som du eller dina anställda har en stark koppling till, som en alma mater, en barns skola eller en lokal organisation eller skola som är inriktad på att betjäna en befolkning som historiskt har varit underrepresenterad inom datavetenskap.

[![](/images/fit-600/Marketing/2018_HoC-392.jpg)]({{ urls/learn }})

Därifrån kan du besöka skolans webbplats för att hitta lämpliga kontakter att nå ut till, som en rektor, vice rektor, teknik- eller datavetenskapsinstruktörer, eller till och med skolans PTSA. Du kan också samarbeta med organisationer som Boys & Girls Clubs of America, en YMCA-filial, och mer för att vara värd för ett evenemang.

Om du inte kan få kontakt med en skola, vänligen [kontakta oss](https://support.code.org/hc/en-us/requests/new) så kopplar vi dig till en av våra lokala partners om möjligt.

* * *

<a id="encourage-employees"></a>

## Uppmuntra anställda att arbeta som volontär med ett klassrum

[![](/images/fit-600/Marketing/pexels-andrea-piacquadio-3762940.jpg)]({{ urls/learn }})

Ett av de mest tillfredsställande sätten att delta i Hour of Code är att vara volontär i ett lokalt klassrum, antingen personligen eller virtuellt. Det bästa av allt är att du inte behöver vara ingenjör för att vara volontär. Du kan fortfarande ge studenterna en meningsfull upplevelse genom att dela din egen karriärerfarenhet och hur CS eller teknik har påverkat din roll.

[<button>Anmäl dig för volontär</button>]({{ urls/volunteer }})

När en volontär registrerat sig kan en lärare granska sin profil på vår [volontärkarta](https://code.org/volunteer/local) - så profiler bör skickas in så fullständiga som möjligt. Om du passar bra för deras klassrum kommer en lärare att kontakta dig via plattformen (vi kommer aldrig att dela din e-postadress med läraren). Du kan sedan samordna detaljer direkt med läraren om [hur du bäst arbetar som volontär med deras klassrum](https://hourofcode.com/us/how-to/volunteers).

För mer vägledning om volontärarbete och exempelmeddelanden för att få ditt företag entusiastisk över Hour of Code, kolla in vår [guide för företagspartners]({{ localized_files/hoc_corporate_toolkit }}).
...
Om du vill gå den där extra milen kan ditt företag också besöka ett Hour of Code event. Det finns ingen specifik formel för att vara värd för ett evenemang så vi uppmuntrar dig att vara kreativ! Med tanke på att vår personalstorlek är liten (men mäktig!) har Code.org inget team dedikerat till att koordinera Hour of Code-evenemang. Hur som helst, här är några tips för att komma igång.
...
- Dela foton och videos från din Hour of Code på sociala medier. Använd [#HourOfCode](https://twitter.com/hashtag/hourofcode) och [@codeorg](https://twitter.com/codeorg) så att vi också kan lyfta fram din framgång!
...
<a href="https://hourofcode.com/promote/resources#posters">Hitta fler</a> affischer, videor, klistermärken och andra sätt att marknadsföra ditt evenemang till ditt samhälle.
