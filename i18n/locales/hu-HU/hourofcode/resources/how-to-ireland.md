...
<p>
  <strong>Minden Kód Órája bemutató:</strong>
</p>
...
<ul>
  <li>
    <strong>Teszteld a bemutatókat a diákok számítógépein vagy eszközein.</strong> Győződj meg róla, hogy megfelelően működnek (hanggal és videóval).
  </li>
  <li>
    <strong>Előre ellenőrizd a gratuláló oldalt</strong>, hogy lásd amit a diákok látnak ha befejezték a feladatot.
  </li>
  <li>
    <strong>Biztosíts a csoportnak fülhallgatókat</strong>, vagy kérd meg a diákokat, hogy hozzanak magukkal, ha a választott bemutató hanggal jobban használható.
  </li>
</ul>
