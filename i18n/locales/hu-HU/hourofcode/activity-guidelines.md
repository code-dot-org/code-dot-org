...
Szeretnéd elküldeni saját önálló játékodat, esetleg tanóra tervedet vagy egyéb tevékenységet, amely segít elmagyarázni a számítástechnika alapelvét? Csatlakozz ehhez a globális mozgalomhoz, és segítsd a világ résztvevőit ösztönözni arra, hogy kezdjenek neki a kódolásnak, akár egy órás vagy akár hosszabb időtartamú - több órás, napos vagy hetes - tevékenységek kipróbálásával.

** Az irányelvek elolvasása után elküldheted saját ötletedet a [ Kódolás órája™ tevékenységek benyújtásának ](http://bit.ly/29zt9ki)oldalán. Az ötleteket bármikor be lehet nyújtani, de ahhoz, hogy az adott naptári évben meg is jelenhessen, a határidő október 1. (Például a(z) {{kampány_date / év}} október 1-je után beérkezett ötletek nem kerülnek listázásra a(z) {{kampány, dátum / év}} Kódolás órája eseményen.)** Ha kérdésed merülne fel a tevékenységek benyújtásával kapcsolatban, vedd fel velünk a kapcsolatot a support@code.org címen.

Néhány tipp:

1. **Több mint egy ötlet benyújtása**: Ha különböző szintű, különböző korú vagy más kategóriákhoz tartozó tevékenységeket készítettél, akkor ezeket kérlek külön sorold fel, így minden tanár megtalálhatja az osztályához legjobban passzolót. Tehát ha korábban már létrehoztál egy weboldalt, és egyetlen URL-t küldtél meg nekünk a reklámozáshoz, akkor javasoljuk, hogy a jövőben ezt inkább kicsit máshogy csináld. Minden oktatóprogramot, ötletet külön-külön nyújts be nekünk. Tekintettel az elmúlt években beküldött nagyszámú ötletáradatra, a jövőben partnereként csak 5 tevékenység ötletet tudunk felülvizsgálni. Ezt követően mindent megteszünk annak érdekében, hogy minél többet beküldött ötletet ellenőrizzünk a Kódolás órája esemény kezdete előtt.

2. ** A kezdeti tanórákon túlmenően**: Azokon az órákon kívül, amelyek a számítástechnikával első alkalommal ismerkedni vágyó tanároknak és diákoknak szólnak, vannak olyan oktatóanyagaink is, amelyek már a programozás iránt komolyabban érdeklődőkre fókuszálnak, akik szeretnének továbblépni az első osztálytermi élményt követően! Segíts nekünk olyan tanóra-tervek benyújtásában, amelyek már az alap információkra támaszkodva a következő lépcsőfokot tűzték ki célul. A célcsoport a 9 és 99 év közötti tanulnivágyók.
...
**Önállóan feldolgozható kirakók vagy játékok ([minta](https://code.org/mc))**
...
**Tanári segítséget igénylő tananyagok ([minta)](https://csedweek.org/csteacher/computerhistory.pdf)<a href = "https://docs.google.com/document/d/1DhaLNd6uim9rRPkHrglnOvVcgzGc8YxIIJKJYJIJJJJJJJJJ8 „> template </a>)**

Most, hogy már több tízezer oktató kipróbálta a Kódolás óráját, sok osztály készen áll az újabb izgalmakra, kreatív tevékenységekre, amelyek megtanítják számukra a számítástechnika alapjait. Annak érdekében, hogy a tapasztaltabb tanárok további inspirációt meríthessenek, összegyűjtjük a tanóra-terveket és gondoskodunk arról, hogy a Kódolás órája veteránjainak is újat tudjunk mutatni.

Az egyik olyan tevékenység, amelyet a tapasztalt tanárok számára hoztunk létre, a „nyitott homokozó” projekt. Ezek a tevékenységek arra ösztönzik a diákokat, hogy készítsenek saját alkalmazást, játékot, weboldalt vagy más projektet. Megfelelő előkészítés esetén a kevésbé keretek közé szorított tevékenységek sokkal inkább megmutatják a számítástechnika kreatív oldalát.
...
Használjátok fel az alábbi [óratervet](https://docs.google.com/document/d/1DhaLNd6uim9rRPkHrglnOvVcgzGc8axKIzv8YI56JGA).
...
* Diákok által (önállóan) vezetett események: * Hagyományosan a Kódolás órája főként az önállóan vezetett gyakorlatok és órák sikerére épül, amelyeket opcionálisan egy tanár is támogathat. Bár rengeteg gyakorlat áll már rendelkezésetekre, de ha mégis újat szeretnétek létrehozni, meg van rá a lehetőség. Ezeket a tevékenységeket úgy érdemes megtervezni, hogy kevés előkészítéssel, illetve limitált előismerettel rendelkező tanári támogatással azok mind az önállóan dolgozó diákok számára, mind pedig egy osztály számára szórakoztatóak legyenek. Fontos, hogy részletes útmutatást nyújtsanak a diákok számára, szemben például egy olyan egy órás kihívással, melynek az eredménye sok mindentől függhet, és többféleképpen alakulhat. Ideális esetben az utasítások és a gyakorlatok közvetlenül a programozói platformba kerülnek integrálásra, hogy elkerülhetőek legyenek a fölösleges a felületek között.
...
- Működik-e okostelefonokon? Tableteken?
- Ajánlod-e a páros programozást? 
...
A részvétel pontosabb nyomon követése érdekében a harmadik fél partnereinek 1 kocka méretű nyomkövető képet kell alkalmaznia a Kódolás órája gyakorlataik első oldalán. A pixelképnek csak a kezdőlapon kell megjelennie. Ne tartalmazzon belinkelt oldalakat.
...
- További információért tekintsd meg erőforrás-készletünket (hamarosan).
