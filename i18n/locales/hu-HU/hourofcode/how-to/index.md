...
Trying an Hour of Code is a simple and fun way to introduce students to computer science, perhaps for the very first time. Nézd meg a [résztvevőknek szóló útmutatót, ha még kérdéseid vannak]({{ localized_files/participation_guide }}).
