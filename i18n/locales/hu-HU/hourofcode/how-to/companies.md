...
A Kódolás óráján való részvétel egyik legmegfelelőbb módja az, ha önkéntesként vállal munkát egy helyi osztályban, akár személyesen, akár virtuálisan. Az egészben az a legjobb, hogy nem kell mérnöknek lennie ahhoz, hogy önkéntesnek jelentkezhessen. Azzal is nagyszerű élményt nyújthat a diákoknak, ha megosztja velük a saját tapasztalatait, hogy a számítástechnika vagy a technológia hogyan befolyásolja a munkáját, a karrierjét.

[<button>Jelentkezzen önkéntesnek</button>]({{ urls/volunteer }})

Miután önkéntesként regisztrált, a tanár megtekinti a profilját a [önkéntes térképünkön](https://code.org/volunteer/local) - ezért arra kérjük, hogy a profilját nagyon gondosan készítse el. Ha a profilja jól illeszkedik az osztály munkájához, a tanár felveszi Önnel a kapcsolatot a platformon keresztül (az e-mail-címét sohasem osztjuk meg a tanárral). A részleteket ezután közvetlenül a tanárral kell megbeszélni [önnkéntesként mi legyen a szerepe az osztályteremben](https://hourofcode.com/us/how-to/volunteers).

Ha további útmutatásra van szüksége az önkéntes munkáról, és szeretne mintát küldeni a vállalatának a Kódolás órájáról, tekintse meg [a vállalati partnerek számára készült útmutatónkat]({{ localized_files/hoc_corporate_toolkit }}}).
...
Nem kell feltétlenül az önkéntes térképünket használnia ahhoz, hogy kapcsolatot teremtsen egy osztályteremmel vagy az iskolával. Gyakran azt javasoljuk, hogy kezdje helyben. Gondolja át, vannak-e olyan iskolák, amelyekhez Ön vagy az alkalmazottai erősen kötődnek, például a régi iskolája, a gyermeke iskolája, egy olyan szervezet vagy iskola, ahol olyan emberek tanulnak, akik történelmileg alulreprezentáltak az informatikában.

[![](/images/fit-600/Marketing/2018_HoC-392.jpg)]({{ urls/learn }})

Ekkor felkeresheti az iskola weboldalát, ahol megtalálja a megfelelő kapcsolatokat, például az igazgatót vagy az igazgatóhelyettest, a műszaki vagy az informatikai oktatókat, vagy akár az iskola diák-, szülő- vagy tanárszervezeteit. Együtműködhet más szervezetekkel is, ezek közé tartozhat a Boys & Girls Clubs of America, egy YMCA-szervezet, és így tovább, akikkel közösen rendezhetnek eseményeket.

Ha nem tud kapcsolatba lépni egyetlen iskolával sem, kérjük, [lépjen kapcsolatba velünk](https://support.code.org/hc/en-us/requests/new), és ha tudjuk, összekötjük Önt valamelyik helyi partnerünkkel.
...
Ha ennél többet szeretne tenni, a munkahelye rendezhet egy Kódolás órája eseményt. Nincs konkrét előírás arra, hogy hogyan kell egy eseményt megrendezni, ezért arra bátorítjuk, hogy legyen kreatív! Tekintettel arra, hogy kevés (de kiváló!) munkatársakkal dolgozunk, a Code.org-nál, nincs senki, aki a Kódolás órája rendezvények koordinálásával foglalkozna. Itt van azonban néhány tipp a kezdéshez.
...
Amikor a saját Kódolás órája eseményét regisztrálja, hasznos üzeneteket fog kapni e-mailben, híreket és ötleteket a Kódolás órája sikeres megrendezéséhez. Így a helyi iskolákat és szülőket is lehet értesíteni a közelben rendezendő eseményről.
