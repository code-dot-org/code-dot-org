...
Si no puedes contactar con una escuela, por favor [contáctanos](https://support.code.org/hc/en-us/requests/new) y te pondremos en contacto con uno de nuestros colaboradores si es posible.
...
- Comparte fotos y videos de la Hora del Código en las redes sociales. ¡Usa el hagstag #HoraDelCódigo y @codeorg para que podamos destacar tu éxito!
...
- ¿Sabías que solo el 45 % de las escuelas de EE. UU. enseñan ciencias de la computación? Dale la oportunidad a cada estudiante de aprender una #HoraDelCódigo https://hourofcode.com/ 
