...
- Write the tutorial link on a whiteboard. Encuentra el enlace listado en [ información para tu tutorial elegido]({{ urls/learn }}) bajo el numero de participantes.
...
- Visite el [Foro de Maestros de Hora de Código](http://forum.code.org/c/plc/hour-of-code) para obtener consejos, comprensión y apoyo de otros educadores.
