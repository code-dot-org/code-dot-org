...
## ¡Consigue la participación de cada escuela y que cada estudiante aprenda!
  ...
  4. **Promocione en la página web de su distrito.** Permita que los visitantes sepan sobre su participación y eventos de la Hora del Código. Referencía la [Hora del Código](%= resolve_url('/') %) en tu sitio.
