...
ჩვენ მოგაწოდებთ მრავალგვარ [სახალისო, ერთსაათიან ტუტორიალებს](%= resolve_url('/learn') %), რომლებიც განკუთვნილია ნებისმიერი ასაკის მონაწილისთვის და შექმნილია სხვადასხვა პარტნიორის მიერ. [მოსინჯეთ!](%= resolve_url('/learn') %)
