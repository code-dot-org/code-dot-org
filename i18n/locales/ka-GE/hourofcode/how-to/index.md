...
ჩვენ გთავაზობთ მრავალ მხიარულ, როგორც [მოსწავლეებისთვის](%= resolve_url('/learn') %),[ასევე მასწავლებლებისთვის განკუთვნილ ტუტორიალებს](%= resolve_url('https://code.org/educate/teacher-led') %)სხვადასხვა პარტნიორის მიერ შექმნილი ტუტორიალები ყველა ასაკის მონაწილეებისთვის.
