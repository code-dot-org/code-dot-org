...
* Leibhéal/leibhéil ghráid mholta d'úsáideoirí atá beartaithe. Is féidir leat a tharchur chuig an \[Múinteoirí Eolaíochta Ríomhaireachta 'Caighdeáin K-12 Association\] (https://k12cs.org/framework-statements-by-grade-band/) do coincheapa eolaíocht ríomhaireachta grád-oiriúnach. I measc na leibhéil ghrád Sampla: 
    ...
    * Gráid 9+ (aois 14+)
* Tá liosta de na réimsí ábhair a chlúdaíonn do ghníomhaíocht (chomh maith leis an Ríomheolaíocht). Mar shampla, más féidir le múinteoir matamaitice do ghníomhaíocht a úsáid chun múineadh faoi uillinneacha nó parabolas, liostaigh mar mhatamaitic. Má tá gníomhaíocht leabharlanna dÚsachtach agat a mhúineann briathair/ainmfhoill/srl. roghnaigh na healaíona teanga.
* Tá liosta de theangacha cláir Múineann do ghníomhaíocht. Ie C/C ++, Java, JavaScript, srl. nó teanga neamhspleách (do phleananna ceachta is féidir a mhúineadh i dteangacha éagsúla)
* Liosta de theangacha nádúrtha tacaithe. Nóta: Is é an soláthraí gníomhaíochta atá freagrach as braiteadh teanga; déanfaimid gach úsáideoir a atreorú chuig an URL aonair a chuirtear ar fáil.
...
Déanfaidh coiste éagsúil oideachasóirí ríomheolaíochta aighneachtaí a rangú bunaithe ar chritéir cháilíochtúla agus chainníochtúla. Liostófar na gníomhaíochtaí go léir a d'oirfeadh do na critéir bhunúsacha. Beidh múinteoirí in ann scagadh agus sórtáil a dhéanamh chun na gníomhaíochtaí is fearr dá seomra ranga a aimsiú.

Féachfaidh an rúibric chun gníomhaíochtaí agus pleananna ceachta a mheas na critéir seo a leanas maidir le gach gníomhaíocht agus déanfar iad a rangú dá réir:
...
Is féidir leat lógó [Uair an Chóid](https://hourofcode.com/us/promote/resources#logo) a áireamh i do rang teagaisc, ach níl sé seo ag teastáil. Má úsáideann tú lógó Uair an Chóid, féach na treoirlínte trádmhairc thíos. <u>Ní féidir lógó agus ainm Code.org a úsáid in imthosca ar bith.</u> Tá an dá trádmharc, agus ní féidir iad a chomh-mheascadh le hainm branda 3ú páirtí gan cead sainráite i scríbhinn.

**Bí cinnte gur féidir leis an mac léinn meán a chríochnú go compordach i uair an chloig.** Smaoinigh ar ghníomhaíocht oscailte a chur leis ag an deireadh do mhic léinn a bhogann níos gasta tríd an gceacht. Cuimhnigh go mbeidh an chuid is mó páistí a thosaitheoirí iomlán chun eolaíocht ríomhaireachta agus códaithe.
...
D'fhonn an rannpháirtíocht a rianú níos cruinne iarraimid ar gach comhpháirtí teagaisc íomhá rianaithe 1-picteilín a áireamh ar an gcéad leathanach dá ranganna teagaisc Uair an Chóid. Ní mór an picteilín-íomhá a bheith ar an leathanach tosaigh amháin. Ná cuir san áireamh ar aon leathanaigh eatramhacha de do rang teagaisc.
