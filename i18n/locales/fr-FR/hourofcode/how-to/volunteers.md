---
title: Guide pratique de l'Heure de Code pour les bénévoles
---

# Comment faire du bénévolat dans une école ou une salle de classe ?

### Des milliers d'enseignants sont à la recherche de bénévoles pour inspirer leurs élèves. Faites une différence aujourd'hui !

[<button>Inscrivez-vous en tant que bénévole</button>]({{ urls/volunteer }})

* * *

La pensée computationnelle contribue à développer les compétences de résolution de problèmes, la logique et la créativité. Et la technologie transforme toutes les industries de la planète. Les étudiants d'aujourd'hui doivent apprendre à créer la technologie, et pas seulement à l'utiliser.

L'Heure de Code est une initiation d'une heure à l'informatique, conçue pour démystifier le « code », montrer que tout le monde peut apprendre les bases, et accroître la participation dans le domaine de l'informatique. Vous pouvez aider à sensibiliser le public à l'informatique et devenir un bénévole afin d'encourager plus d'étudiants à essayer l'informatique, notamment les jeunes femmes et les étudiants de groupes raciaux et ethniques historiquement marginalisés.

- [Qui peut devenir bénévole ?](#who-can-volunteer)
- [Pourquoi devenir bénévole ?](#why-volunteer)
- [Comment les bénévoles sont-ils sélectionnés ?](#selection)
- [Que faire pour devenir bénévole dans une école déterminée ?](#choose-a-school)
...
Toute personne passionnée par l'enseignement de l'informatique et la diversité croissante en technologie peut devenir bénévole ! Nous aimerions voir participer des bénévoles de tous horizons. L'Heure de Code propose une grande variété d'activités pour tous les âges et niveaux de compétence, de sorte que vous n'avez pas besoin d'être un expert en programmation pour devenir bénévole !

Vous pouvez être un conférencier dans une salle de classe, ou aider un enseignant à diriger l'activité. [Inscrivez-vous aujourd'hui](https://code.org/volunteer) pour encourager les étudiants à continuer leur apprentissage de l' informatique.
...
L'informatique est le domaine déterminant du 21ème siècle, mais la plupart des écoles ne l'enseignent toujours pas. Une Heure de Code est, peut-être, ce que ces étudiants reçoivent, au mieux, au cours d'une année. En devenant bénévole, vous permettez aux enseignants d'amener encore plus facilement l'informatique dans leur salle de classe.

[![](/images/fit-600/Marketing/HoC-2015-ACE-HS--42.jpg)]({{ urls/learn }})

Lisez quelques témoignages d'anciens bénévoles :

- « Le meilleur aspect de mon expérience était que toute la classe était composée de femmes et de personnes de couleur. C'est de bonne augure, pour l'avenir de notre industrie, d'avoir la chance de rencontrer et de stimuler l'intérêt de ces enfants. » 
...
## Comment les bénévoles sont-ils sélectionnés ?

Les enseignants peuvent rechercher des bénévoles sur notre [carte des bénévoles](http://code.org/volunteer/local). Si vous êtes situé près de leur salle de classe, les enseignants examineront votre profil sur la carte. Fournissez donc autant d'informations que possible pour augmenter les chances qu'un enseignant vous contacte.

[![](/images/fit-600/Marketing/2018_HoC-489-resized.jpg)]({{ urls/learn }})

Une fois sélectionné, un enseignant vous contactera via la plateforme de bénévolat (nous ne partagerons jamais votre adresse électronique avec l'enseignant). Travaillez avec l'enseignant pour déterminer la meilleure manière de contribuer à leur événement, et établir si vous vous rendrez sur place, en personne, ou ferez du bénévolat virtuellement.

Si vous recevez trop de demandes d'enseignants, vous pouvez toujours mettre à jour vos préférences, ou vous désabonner, en cliquant sur le lien fourni au bas de toute demande envoyée par courriel par un enseignant.

* * *

<a id="choose-a-school"></a>

## Que faire pour devenir bénévole dans une école déterminée ?

Vous n'avez pas besoin d'utiliser notre carte des bénévoles pour faire devenir bénévole ! En fait, nous vous recommandons de contacter directement les enseignants et les administrateurs s'il y a une salle de classe avec laquelle vous souhaitez faire du bénévolat.

Pour commencer : - si vous êtes un parent ou un tuteur, envoyez [ce courriel](https://hourofcode.com/us/promote/resources#help-schools) à l'enseignant de votre enfant, en proposant de l'aider à animer une Heure de Code. - Si vous avez une autre école à l'esprit, visitez son site Web pour trouver les coordonnées des personnes à contacter, comme un directeur ou sous-directeur, les instructeurs en technologie ou en informatique, ou même l'association des parents d'élèves de l'école. Vous pouvez également vous associer à des organisations tels que les Boys & Girls Clubs of America, une branche de la YMCA, ou d'autres encore, pour co-organiser un événement. - Si vous ne parvenez pas à trouver une école qui organise une Heure de Code, vous pouvez vous porter volontaire pour aider à organiser votre propre événement, avec votre entreprise. Consultez notre [Guide Pratique pour les entreprises](https://hourofcode.com/us/how-to/companies) pour en savoir plus et trouver de l'inspiration.
...
Que vous assistiez à un événement Heure de Code, à distance ou en personne, votre expérience s'avèrera beaucoup plus fluide si vous vous préparez à l'avance.

[![](/images/fit-600/Marketing/4Q9A5575.jpg)]({{ urls/learn }})

### Rencontrez l'organisateur

Si vous faites du bénévolat dans une salle de classe, discutez de cette logistique avec l'enseignant au préalable :

- Votre rôle lors de l'événement. Si vous travaillez dans la technologie, vous pourriez être invité à partager vos expériences personnelles ou votre histoire : comment avez-vous débuté votre carrière dans la technologie ? Pourquoi l'informatique est-elle importante pour vous ? Que faites-vous, dans le cadre de votre travail, et quelles activités vous lient à la technologie ? 
- Si vous faites votre bénévolat en personne, assurez-vous de bien comprendre à la fois les directives locales et scolaires en matière de santé et de sécurité. Selon leurs procédures, vous devrez peut-être arriver un peu tôt. 
- Le fait que vous exerciez votre bénévolat virtuellement ou en personne peut déterminer le moment auquel vous devez être présent et à quel titre. 
- Si vous faites votre bénévolat virtuellement, travaillez avec l'enseignant pour déterminer la meilleure plateforme de visioconférence à utiliser et essayez de faire un test, préalablement à l'événement, ensemble. 
- Si l'enseignant a prédéterminé des activités de l'Heure de Code pour l'événement, renseignez-vous afin de pouvoir [les explorer](https://hourofcode.com/us/learn) à l'avance. 

### Pensez à vos participants

- Réfléchissez aux étudiants à qui vous parlerez, et à ce qui pourrait les faire vibrer. En tant que bénévole, vous pouvez les aider à réaliser que l'informatique est présente partout et que eux, aussi, peuvent devenir informaticiens. Prenez en considération les âges, les origines et les identités de genre, et venez, préparé, avec des sujets qui pourront susciter leurs intérêts. Voici des conseils supplémentaires sur la façon d'encourager de [jeunes femmes](http://code.org/girls) à participer. 
- Stimulez l'intérêt des étudiants ! Travaillez avec l'enseignant pour choisir une [vidéo qui inspire](https://hourofcode.com/us/promote/resources#videos) qui peut aider la classe à se concentrer et la stimuler à faire une Heure de Code. 
- Si vous êtes un bénévole virtuel, envisagez d'inclure quelques diapositives, dans le cadre de votre présentation, pour vous aider à maintenir l'intérêt des élèves.

Besoin de plus de ressources ? [Consultez ces autres conseils](https://code.org/files/CSTT_Volunteers.pdf).
...
Si vous êtes l'organisateur d'un événement avec une salle de classe, utilisez l'exemple d'ordre du jour pour vous guider. Confirmez l'horaire convenu pour la journée et abordez, au préalable, tout point de discussion avec l'enseignant. Si vous rencontrez, en personne, la classe, assurez-vous de vous enregistrer auprès de l'école et de saluer l'enseignant, le jour de votre événement.

Si vous envisagez d'organiser l'Heure de Code à la maison ou dans la communauté, nous vous recommandons de jeter un oeil à certains de nos guides pratiques détaillés pour [les parents](https://hourofcode.com/us/how-to/parents) et <a href= "https://hourofcode.com/us/how-to/companies">les organisations ou entreprises</a>.
...
- Si des membres de votre personnel doivent animer votre événement ou faire du bénévolat avec une école locale, pensez à commander des [t-shirts personnalisés](http://blog.code.org/post/132608499493/hour-of-code-shirts-and-more) pour vos employés.
...
- [Partagez les certificats]({{ urls/certificates }}) avec les participants et les étudiants.
...
## Faites passez le mot à propos de l'Heure de Code
...
Une visite en classe, en personne, dure habituellement de 60 à 90 minutes, tandis qu'une visite en classe virtuelle dure habituellement de 20 à 30 minutes.  


### Pour quel groupe d'âge l'activité de l'Heure de Code est-elle appropriée ?

Code.org et nos partenaires conçoivent toutes les activités de l'Heure de Code pour susciter l'intérêt des étudiants de tous les niveaux scolaires (de la maternelle à la terminale), de tous les milieux. Tout le monde - même les adultes - peut prendre plaisir à jouer !   


### Comment puis-je être sélectionné en tant que bénévole technique ou conférencier ?

Les enseignants recherchent des bénévoles sur notre [carte des bénévoles](http://code.org/volunteer/local). Essayez de soumettre un profil aussi complet que possible pour augmenter les chances qu'un enseignant vous sélectionne. Si vous avez une préférence sur la façon dont vous souhaitez faire du bénévolat, en tant que conférencier, par exemple, ou que support technique, veuillez l'indiquer dans la description de votre profil.   


Une fois sélectionné, un enseignant vous contactera par le biais de la plateforme de bénévolat (votre adresse électronique ne sera jamais partagée avec l'enseignant). Si vous recevez trop de demandes d'enseignants, vous pouvez toujours mettre à jour vos préférences, ou vous désabonner, en cliquant sur le lien fourni au bas de toute demande envoyée par courriel par un enseignant.   
