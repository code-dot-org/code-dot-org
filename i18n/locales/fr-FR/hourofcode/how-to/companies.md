...
Lorsque vous vous [inscrivez à votre événement Heure de code](/events), vous recevrez des e-mails utiles contenant des nouvelles et des conseils pour organiser une heure de code avec succès. C'est aussi de cette manière que vous pourrez faire savoir aux écoles des environs ou aux parents que vous organisez un événement près de chez eux.
