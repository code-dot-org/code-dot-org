...
Lorsque vous vous [inscrivez à votre événement Heure de code](/events), vous recevrez des e-mails utiles contenant des nouvelles et des conseils pour organiser une heure de code avec succès. C’est aussi de cette manière que vous informerez vos volontaires locaux que votre école y participe. Les volontaires sont une excellente ressource, et peuvent venir parler à votre classe d'informatique ou simplement aider vos élèves avec les activités de l'Heure de Code. 
