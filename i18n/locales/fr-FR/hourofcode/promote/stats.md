...
L'Heure de Code est une introduction d'une heure à l'informatique, conçue pour démystifier la programmation et montrer que n'importe qui peut en apprendre les rudiments. Apprenez-en plus sur <http://HourofCode.com>, essayez une heure vous même, ou bien organisez une Heure de Code pour présenter à d'autres le monde de l'informatique!
