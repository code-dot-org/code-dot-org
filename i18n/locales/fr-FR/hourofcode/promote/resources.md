...
Computers are everywhere, changing every industry on the planet, but only 35% of all high schools teach computer science. Filles et minorités sont gravement sous-représentées dans les classes d'informatique et dans l’industrie de pointe. La bonne nouvelle, c'est que nous sommes en train de changer cela.
