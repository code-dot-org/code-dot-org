...
Code.org est une association 501 c 3 à but non lucratif ("Code.org"). Notre mission est de donner à chaque élève la possibilité d'apprendre l'informatique. Dans le cadre de cette mission, Code.org gère les sites web suivants <http://code.org>, <http://csedweek.org>, <http://computinginthecore.org>, <http://hourofcode.com>, d'autres sites Web, informations, textes, programmes, vidéos, graphiques, photos, API, notifications par courrier électronique et autres matériaux et produits connexes et services (les "**Services**"), y compris la plate-forme tutoriel à <http://studio.code.org> ("**Code Studio**").

Veuillez lire attentivement ces Modalités de Service ("**Conditions**") avant d'accéder ou d'utiliser les Services. En accédant ou en utilisant toute partie des Services ou en cliquant sur « J'accepte » ou le bouton « Sign Up » (inscription) qui peut être mis à votre disposition, signifie que vous acceptez d'être lié par ces termes sans modification.

Ces termes sont un contrat légal entre vous et Code.org au sujet de votre utilisation des Services proposés. You may use the Services only if you can form a binding contract with Code.org and are not a person barred from receiving the Services under the laws of the United States or other applicable jurisdiction. Si vous acceptez ces conditions et utilisez les Services au nom d'une société, organisation, gouvernement ou autre personne morale, vous déclarez et garantissez que vous êtes autorisé à le faire. Vous pouvez utiliser les Services uniquement dans le respect de ces termes et toutes les exigences locales, Étatique, lois nationales et internationales, règles et règlementations.

Ces termes sont sujets à modifications. Vous acceptez d'être lié par ces modifications si vous continuez à utiliser les services après le changement de ces conditions, donc s'il vous plait vérifier ces modifications de conditions périodiquement.

## Conditions supplémentaires

Certains Services peuvent être soumis à des directives supplémentaires, des règles ou des conditions générales d'utilisation (« **Conditions supplémentaires** ») et votre utilisation de ces Services sera conditionnée sur votre accord aux conditions additionnelles. Si il y a un conflit entre ces termes et conditions supplémentaires, les conditions supplémentaires régiront ce Service, à moins que les conditions additionnelles stipulent expressément que ces modalités prévaudront.

### Enfants de moins de 13 ans

Nous prenons des mesures pour réduire au minimum la collecte de données à caractère personnel pour les utilisateurs de 13 ans ou moins la comme expliqué la [politique de confidentialité](http://code.org/privacy)de Code.org . Si vous êtes âgé de 13 ans ou moins, nous vous encourageons à obtenir l'approbation d'un parent ou d'un tuteur légal avant de créer un compte sur Code.org. Code.org permet à certains représentants d'academie scolaires et les écoles, comme les enseignants, administrateurs, conseillers et autres éducateurs (un « **éducateur** ») de se connecter avec des étudiants à travers les Services afin de fournir le tutoriel, des services éducatifs et services similaires. Si vous êtes un éducateur, vous pouvez créer des comptes sur les Services pour un ou plusieurs de vos élèves.

Si vous êtes un éducateur et vous créez un compte pour un étudiant qui est âgée de moins de 13 (un « **enfant** »), vous déclarez et garantissez que vous ou l'organisation éducative, pour laquelle vous travaillez a les autorisations appropriées pour inscrire l'enfant à des services éducatifs, tels que Code.org, qui recueillent des renseignements personnels de l'enfant pour l'utilisation et le bénéfice de l'école et sans aucun but commercial. En outre, vous acceptez d'être lié par ces termes, au nom de l'organisation éducative, pour laquelle vous travaillez pour.

### Vos informations personnelles

Si vous créez un compte pour les Services, vous êtes responsable de la sécurité de votre compte et vous assurez la sécurité de votre propre mot de passe. Si vous utilisez un compte qui vous est assigné par un éducateur, votre éducateur peut être en mesure d'accéder et de désactiver votre compte.

Code.org vous permet d'enregistrer un compte pour les Services par le biais de certains services de réseautage social tiers, comme Facebook Connect et Google (« **Authentication Service** »). En vous inscrivant sur les Services à l'aide d'un Service d'authentification, vous acceptez que Code.org accède à vos informations de compte du Service d'authentification, et vous acceptez toutes les conditions d'utilisation du Service d'authentification concernant votre utilisation des Services par l'intermédiaire du Service d'authentification. Vous êtes seul responsable de vos interactions avec le Service d'authentification.

### Vie Privée

Votre confidentialité est importante pour nous. Des code.org [Politique de confidentialité](http://code.org/privacy) explique comment nous traitons vos données personnelles et est ajouté dans les présentes conditions générales. Veuillez lire la politique de confidentialité attentivement pour plus d'informations relatives à la collecte, utilisation et divulgation de vos renseignements personnels par Code.org.

Si vous êtes un étudiant qui utilise un compte enregistré pour vous par un éducateur ou autrement relié à un éducateur, vous acceptez que Code.org puisse divulguer vos renseignements aux éducateurs associés à votre compte. Si vous êtes éducateur, vous acceptez de ne pas partager les information d'étudiant que vous recevez de Code.org avec des autres que les agents autorisés de la salle de classe, le district scolaire ou autre établissement d'enseignement que vous représentez.

### User Generated Content - Management ; Concession de licence ; Représentations et garanties

Code.org peut maintenant ou à l'avenir vous permettre, ainsi que d'autres utilisateurs d'afficher le code informatique (y compris le code source et objet), information, texte, graphiques, notes, questions, commentaires, notes, commentaires, images et vidéos ou autres communications (collectivement, « **contenu utilisateur** ») aux Services. Vous comprenez que si de tel contenu sont publié ou non, Code.org ne garantit pas la confidentialité à l'égard de toute soumission.

Code.org n'a aucune obligation de surveiller le contenu utilisateur ou autres matériaux. Vous êtes chargé d'évaluer tout contenu d'utilisateur y compris leur exactitude, leur exhaustivité et leur fiabilité, et vous supporter tous les risques de l'utilisation de tel contenu des utilisateur. Code.org ne sera pas responsable des dommages que vous pourriez subir suite à la présentation ou l'utilisation de tout contenu utilisateur.

Code.org peut, mais n'est pas obligé, de surveiller ou d'examiner tous les Services où les utilisateurs communiquent uniquement entre eux, y compris mais sans s'y limiter aux salons de chat, chats direct, babillards électroniques ou autres forums d'utilisateurs et le contenu de ces communications. Vous assumez le risque de telles communications, et Code.org n'a aucune responsabilité concernant le contenu ou l'utilisation de ces communications.

Les utilisateurs peuvent inclure des liens vers des sites tiers dans le contenu de l'utilisateur tant que le contenu de ces sites n'est pas contraire à ces conditions. Cliquez sur ces liens est à vos risques et périls. Code.org n'est pas responsable de la disponibilité ou du contenu des sites liés, y compris la publicité, les produits ou les autres éléments.
...
De plus, en soumettant ou distribuant le contenu de l'utilisateur via les Services, vous accordez à chaque utilisateur des Services une licence non exclusive pour accéder et utiliser votre contenu utilisateur.

### Garanties et représentations des contenus utilisateur

Vous êtes seul responsable des contenus utilisateur que vous postez sur les Services et les conséquences de leur publication. En téléchargeant, soumettant, en créant ou en publiant votre contenu utilisateur ou par l'intermédiaire des Services, vous déclarez et garantissez que: (1) vous êtes le créateur et le propriétaire de votre contenu utilisateur et que vous avez l'autorisation d'utiliser ou davez les accords nécessaires, droits, consentements et autorisations pour publier le contenu de l'utilisateur que vous soumettez ; (2) votre contenu d'utilisateur n'est pas et ne doit pas: (a) enfreindre, violer ou détourner les droits de toute tierce partie, y compris tout droit d'auteur, marque, brevet, secret commercial, droit moral, droit de la vie privée, droit de publicité, ou la propriété intellectuelle ou droit de propriété toute autre (b) calomnie, diffamer, diffamation ou envahir le droit de la vie privée, publicité ou autres droits de propriété de toute autre personne ; (3) votre contenu d'utilisateur ne contient-elle pas de virus, adware, spyware, vers ou autres codes malveillants.
