...
### Cari semua sumber yang anda perlukan untuk membawa perhatian kepada acara Jam Kod anda. Tidak pasti di mana hendak bermula? Mulakan dengan [panduan cara untuk menganjurkan acara Jam Kod]({{ how_to_url }}) kami!
...
## Gunakan logo Jam Kod untuk menyebarkan berita
...
1. Mana-mana rujukan kepada "Hour of Code" atau "Hora del Código" sepatutnya digunakan di dalam fesyen yang tidak menunjukkan ia merupakan nama jenama anda, tetapi lebih merujuk kepada Jam Kod sebagai pergerakan akar umbi.

<ul style="margin-top: 0px">
  <li>
    <strong>Contoh yang baik</strong>: "Menyertai Hour of Code™ (Jam Kod) di YOUR-COMPANY.com."
  </li>
  <li>
    <strong>Contoh tidak baik</strong>: "Cuba Jam Kod oleh YOUR-COMPANY."
  </li>
</ul>

1. Gunakan superskrip "TM" di tempat paling utama anda menyebut "Hour of Code" (Jam Kod) dan superskrip "Ⓡ" di tempat paling utama anda menyebut "Hora del Código", kedua-duanya pada laman web anda dan huraian di dalam aplikasi.
...
## Jemput individu di dalam komuniti anda ke acara Jam Kod dan promosikan acara anda melalui e-mel

### Cari [lebih banyak maklumat dan bahasa yang boleh anda gunakan]({{ promote/stats_url }}) apabila bercakap tentang Jam Kod.
...
Tahun ini, mari kita lakukan secara besar-besaran. Saya meminta anda menyertai Jam Kod {{ campaign_date/year }}. Sila libatkan diri dengan acara Jam Kod semasa Minggu Pendidikan Sains Komputer, {{ campaign_date/full }}.
...
#### [Cari lebih banyak sumber dan maklumat tentang sukarelawan di sekolah di sini]({{ how_to_volunteers_url }}).

**Tajuk subjek:** Bolehkah kami membantu anda menganjurkan Jam Kod?

Antara {{ campaign_date/short }}, sepuluh peratus daripada pelajar di seluruh dunia akan menyambut Minggu Pendidikan Sains Komputer dengan melakukan Jam Kod di sekolah mereka. Ini ialah peluang untuk setiap kanak-kanak mengetahui cara teknologi di sekitar kita berfungsi.

[Our organization/My name] ingin membantu [school name] menjalankan acara Jam Kod. Kami boleh membantu guru menganjurkan Jam Kod di dalam kelas mereka (malah kami tidak memerlukan komputer!) atau sekiranya anda ingin menganjurkan perhimpunan sekolah, kami boleh menguruskan penceramah untuk bercakap tentang cara teknologi berfungsi dan perasaan menjadi jurutera perisian.
...
**Tajuk subjek:** Pelajar kita sedang mengubah masa depan dengan Jam Kod
...
#### [Lihat kumpulan risalah akhbar untuk maklumat lebih lanjut mengenai menjemput pihak media ke acara anda.]({{ promote/press_kit_url }})

**Tajuk subjek**: Sekolah tempatan menyertai misi memperkenalkan pelajar kepada sains komputer

Computers are everywhere, changing every industry on the planet, but only 51% of all high schools teach computer science. Wanita muda dan pelajar daripada kumpulan kaum dan etnik terpinggir terlalu dipencilkan di dalam kelas sains komputer dan industri teknologi. Berita baiknya ialah, kami sedang dalam proses mengubahnya.
...
**Tajuk subjek**: Sertai sekolah kami kerana kami mengubah masa depan dengan Jam Kod

[Mayor/Governor/Representative/Senator LAST NAME] yang dihormati:
...
Saya menulis untuk menjemput anda menyertai acara Jam Kod dan berucap semasa perhimpunan pelancaran kami. Acara ini akan berlangsung pada [DATE, TIME, PLACE] dan akan membuat pernyataan yang kukuh bahawa [State or City name] sudah bersedia mengajar pelajar kita kemahiran abad ke-21 yang kritikal. Kita mahu memastikan bahawa pelajar kita berada di barisan hadapan dalam mencipta teknologi masa depan—bukan sekadar menggunakannya.

Sila hubungi saya di [PHONE NUMBER OR EMAIL ADDRESS]. Saya menantikan jawapan daripada anda.
