...
## Usar este planfleto para espalhar a notícia

[![](<%= localized_file('/images/fit-250/one-pager.png') %>)](<%= localized_file('/files/hoc-one-pager.pdf') %>)

## Entregar este panfleto a professores e escolas

[![](<%= localized_file('/images/fit-250/schools-handout.png') %>)](<%= localized_file('/files/schools-handout.pdf') %>)

<a id="videos"></a>

## Mostrar estes vídeos para cativar os alunos

<div style="float:left; padding:10px">
  <iframe width="350" height="195" src="https://www.youtubeeducation.com/embed/nKIu9yen5nc?iv_load_policy=3&rel=0&autohide=1&showinfo=0" frameborder="0" allowfullscreen></iframe>  
  <p>
    <a href="https://www.youtube.com/watch?v=nKIu9yen5nc"><strong>O que a maioria das escolas não ensinam (5 min)</strong></a> <a href="https://dl.dropbox.com/sh/6sdjczibjih6x8s/Rjs8XgYNzr/Code-5-minute.mov?dl=1"><img src="/images/download.png" width="30px" /></a>
  </p>
</div>
...
<div style="float:left; padding:10px">
  ...
  <p>
    <a href="https://www.youtube.com/watch?FC5FbmsH4fw"><strong>A Hora de Código chegou - Todos Podem Aprender</strong></a> <a href="http://s3.amazonaws.com/cdo-videos/HoC-video-15mb.mp4"><img src="/images/download.png" width="30px" /></a>
  </p>
</div>
...
<div style="float:left; padding:10px">
  ...
  <p>
    <a href="https://www.youtube.com/watch?6XvmhE1J9PY"><strong>Presidente Obama fala acerca das ciências da computação</strong></a>
  </p>
</div>
...
<div style="float:left; padding:10px">
  ...
  <p>
    <a href="https://www.youtube.com/watch?qYZF6oIZtfc"><strong>Qualquer pessoa pode aprender (1 min)</strong></a> <a href="https://dl.dropbox.com/sh/6sdjczibjih6x8s/_0RSOSY8oW/Code-1-min.mov?dl=1"><img src="/images/download.png" width="30px" /></a>
  </p>
</div>
...
## Faz destaque destes anúncios no teu website
