...
참고: 설치 가능형 앱 (iOS/안드로이드 앱 또는 데스크톱 설치 앱)에는 별로 중요하지 않습니다.<!-- Adding in specific year for 2022 per Eric for later fix on line 18 as site was not auto-udpating to correct year -->