...
자원봉사를 가상 또는 대면으로 또는 회사와 함께 하든, 여러분의 모든 노력은 학생이 컴퓨터 과학과 그들 자신의 잠재력을 바라보는 방식에 엄청난 영향을 미칠 수 있습니다. Take a look at our [volunteer toolkit if you still have questions]({{ localized_files/hoc_volunteer_toolkit }}).
...
교사는 우리의 [자원봉사자 맵](http://code.org/volunteer/local)에서 자원봉사자를 검색할 수 있습니다. 귀하가 클래스룸에 가까이 있다면, 교사가 맵에서 신청인의 프로필을 검토하므로, 신청인은 교사가 연락을 해올 확률을 높이기 위해 가능한 자세한 내용을 기재해야 합니다.
...
Hour of Code를 원격으로 참석하든 직접 참석하든, 이러한 준비를 미리 한다면 훨씬 매끄러운 경험을 할 수 있습니다.
...
- 이벤트에서의 역할 기술부문에서 일하고 있으면 가령 어떻게 기술부문에서 일을 하게 되었는지 등 개인적인 경험 또는 이야기를 해달라는 요청을 받을 수 있습니다. 컴퓨터 과학이 왜 나에게 중요한지? 업무의 일부로서 어떤 일을 하고 있으며 그것이 기술과 어떻게 관련이 있는지? 
