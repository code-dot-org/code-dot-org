...
**방과후 수업을 위한 아워오브코드 레슨 계획 필요하세요?**이 [템플릿](/files/AfterschoolEducatorLessonPlanOutline.docx)을 확인해 보세요!
...
튜토리얼들이 되는지 확실히 확인하시고 학생들 컴퓨터와 디바이스들에서도 제대로 소리나는 브라우저나 비디오에서 되는지 확인하세요 **인터넷 접속속도가 느립니까? ** 교실 앞에서 비디오를 보여주는 방법을 계획하여 각 학생이 비디오를 다운로드할 필요가 없게 합니다. Or try the unplugged / offline tutorials.
...
**컴퓨터 공학에 생소하더라도 괜찮습니다. 여러분의 아워오브코드 활동을 소개할 몇가지 아이디어가 여기에 있습니다.**
...
**참가자 활동 지침** - 화이트보드에 튜토리얼 링크를 적으세요. Find the link listed on the [information for your selected tutorial]({{ urls/learn }}) under the number of participants.
