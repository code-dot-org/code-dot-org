...
People around the world join in the Hour of Code celebration during CS Education Week (December 5-11) when the latest tutorials and activities are released. 하지만 연중 아무 때나 아워오브코드를 할 수 있습니다!
...
When you [sign up your Hour of Code event](/#join), you’ll receive helpful email communications with news and tips for hosting a successful Hour of Code. 또한 학교가 참여할 것임을 지역 자원봉사자에게 알릴 수 있는 방법입니다. 자원봉사자는 훌륭한 자원이며 학급에 와서 컴퓨터 과학에 대해 강연을 하거나 또는 간단히 학생의 아워오브코드 활동을 도울 수 있습니다.

### 학생들이 재미있어 하게 만드세요.

다양한 사람들에 의해 또한 창의적인 방식으로 컴퓨터 과학이 사용될 수 있음을 강조하는 [영감을 주는 비디오](/promote/resources)를 공유함으로써 이벤트를 시작합니다 . Or print inspirational posters for your classroom! 학생들은 그들과 같아 보이는 사람이 그들을 격려해 줄 때 더 흥미롭게 과목에 관심을 갖게 됩니다. 
...
- 화이트보드에 튜토리얼 링크를 적으세요. 참가자 수 아래[i선택한 튜토리얼에 대한 정보]({{ urls/learn }})에서 링크를 찾으세요.
...
아워오브코드가 끝났다고 해서 컴퓨터 과학도 같이 끝날 필요는 없습니다! 우리의 커리큘럼은 웹 기반이며 영원히 무료로 사용할 수 있습니다. CS를 학교와 학생들에게 선사해주는 [방법을 배워보세요](/beyond) .
