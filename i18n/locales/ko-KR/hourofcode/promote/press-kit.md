...
우리는 학생들이 배우고자하는 열정과 관심을 일으켜 공부를 계속하기를 희망합니다. Research also shows that kids can pick up programming concepts before they know how to read and write. 사실, 컴퓨터 (프로그래밍)언어들은 다른 외국어처럼 어린 나이일 수록 더 쉽게 받아들일 수 있습니다.
...
"The Hour of Code is designed to demystify code and show that computer science is not rocket science—anybody can learn the basics," said Hadi Partovi, founder and CEO of Code.org. 전세계 1억명 이상의 학생들이 이미 Hour of Code 를 경험해 보았습니다. 21세기와 관련된 컴퓨터과학(정보과학) 교육 요구는 모든 장벽을 넘고, 어떤 경계도 없습니다.
