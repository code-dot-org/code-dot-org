...
Code.org®是一个公益组织，它致力于为更多的学校，妇女和有色人种提供学习计算机技术的机会。

请在访问或使用本网站前仔细阅读隐私政策(“**隐私条例**”) .

## Code.org隐私保护原则

我们的隐私保护条例出自于我们对下列隐私原则的承诺:

  1. 我们郑重承诺为我们的学生和老师创建一个安全和保密的学习环境。
  2. 访问和使用我们的教程，以及其它所有不需要用户帐号的内容，均无需提供您的个人信息。 
  3. 之所以搜集学生和老师的数据，是为了向每一位有需要的学生提供更好的计算机教育。 
  4. 我们不会出售或者利用您的个人信息获利，我们也不通过广告盈利。 我们是501c3非营利性慈善组织，我们的收入均来自捐赠。 我们之所以定位为非营利组织，是为了确保我们的任务和您的信任不会因为商业动机而相互冲突。
  5. 任何由学校社区合作伙伴提供的学生数据,交由第三方评估机构都是为了评估我们的课程是否符合我们的目标，这些数据都将被匿名或者去身份(根据标准工业实践). 
  6. 我们力争让您对您提供给我们的信息有访问和控制权(详情如下),我们将很严肃的保护您的信息。

## 隐私保护条例

我们致力于为访问我们网站包括<http://code.org>、<http://csedweek.org>、 <http://computinginthecore.org>、 <http://hourofcode.com>、 其他网站、 应用程序编程接口(我们"API")和在线服务(统称我们的"网站")的各个年龄层次的学习者创造一个安全和保密的环境。 Visitors and users of the Website and participants in our education programs are referred to individually as “User” and collectively as “Users”. 作为非营利性501(c)(3) 组织，我们收集的数据将只用于帮助我们为每个学生提供更好的计算机教育。 我们将自己定义为一个非盈利组织，这样就不会因营利动机干扰我们作为一个提供可信教育资源的目标。

Our Privacy Notice describes what information we gather from our Users, how we use that information, and what we do to protect it. 您对本网站的使用或任何提供给本网站的信息都适用于本隐私保护条例，同时也适用于我们的服务条款。 任何在本隐私保护条例中未定义的特殊条款，都已经在我们的 [服务条款](http://code.org/tos) 中做了详细定义。 在访问或使用我们的网站时，您应明确同意本隐私保护条例中所述的对信息的处理方法。

有时我们会变更我们的隐私保护条例。 对于隐私保护条例的任何更改,Code.org将在本网站上发布变更通知，并注明该变更的更新日期。 对于任何重大的政策变更，我们将在网站首页上发布变更通知。 如果法律要求，我们也将联系用户，并通知他们所做的更改。 我们将谨守承诺，不会改变我们对任何渠道收集的用户信息的处理方式，除非通过电子邮件、本网站或通过其他手段告知用户相关变更并获得同意。 我们采取非常认真的态度处理您向我们提供的信息，我们努力把您的信息置于您的控制之下。

## 收集和使用您的信息

以下各节描述 Code.org如何从用户收集和使用姓名、 电子邮件地址、 学校名称和地址、以及其他个人身份信息("**个人信息**")，还包括我们收集的一些非个人信息和技术信息(如下所述)。

**编程一小时**：Code.org不收集任何参与编程一小时学习的学生的个人信息。编程一小时教程可以直接使用，不需要登录。

**编程工作室**： 下表描述了 Code.org 从编程工作室教学平台的注册用户那里收集的数据。 您也可以尝试所有编程工作室教程，无需创建一个帐户，但您的学习进度将不会被保存。

| 如果您创建一个编程工作室学生帐户，这些数据将由 Code.org 保存                                                             | 必填？                                                                                                                                            | 如何使用此数据                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| ----------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 显示名(如"酷程序员"或"张三")                                                                               | 强制必填                                                                                                                                           | 用于创建登录欢迎页面，展示学生创作的程序作品，以及让老师标识该学生和他的进度。                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| 在学习课程时自动完成</br>  
1-尝试每个阶段谜题使用的日期和时间  
2- 尝试完成母体的次数，以及成功地解决了或最优化方法  
3- 学生提交的代码。 (包括他们创造的艺术和游戏) | 强制必填(系统自动完成)                                                                                                                                   | 此信息被提供给学生和他们的老师，用于查看他们的课程进度，已经创建的程序，和找出他们需要帮助的问题。 它还可以让学生在登录时，回到他们上次注销时所学习的地方。 See [example progress report](http://code.org/files/student-progress.pdf), and see section below on [“technical information”](#techinfo) for additional details.</br>  
...
| Gender                                                                                          | 选填                                                                                                                                             | This information is only used in aggregate, to measure the total % of students that are male or female, to track our progress towards reducing the gender gap in computer science.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| Age (*Not* birthdate)                                                                           | 强制必填                                                                                                                                           | To understand the developmental stage of students to offer an age-appropriate experience for each student. We use this field to ensure we don’t store email information for students with age < 13. We collect ages (eg 16), as opposed to birthdates (eg Feb 13, 1998)                                                                                                                                                                                                                                                                                                                                                                                             |
| Any phone number                                                                                | 选填                                                                                                                                             | Users aged 13 or older can choose to share their app, art, or other code creations to a phone. To do this, they are asked to provide a phone number (their own or someone else’s). Code.org uses a 3rd party service ([Twilio](https://www.twilio.com/)) to send a pre-written text message to this number. Code.org does not store any record of the number, however the phone number and message will be stored by Twilio and may also be stored by the phone service provider.                                                                                                                                                                                   |
| Custom photos, sounds, and/or videos                                                            | 选填                                                                                                                                             | Users aged 13 or older can choose to upload custom photos, sounds, and videos to the Code Studio platform to use within applications that they create. These files are not used by Code.org for any purpose other than within the applications created by such users.                                                                                                                                                                                                                                                                                                                                                                                               |
| Messages sent within the “Internet Simulator”                                                   | 选填                                                                                                                                             | The [“Internet Simulator”](/internetsimulator) is a tool developed by Code.org for use in High School classrooms to model how the Internet functions. With this tool, students can send text-based messages to other students and the teacher in their specific classroom section only. Contents of messages sent by students using the tool can be accessed by the recipient, and are not accessed or used by Code.org for any purpose other than in this educational tool.                                                                                                                                                                                        |
| Written comments in response to curricular/educational prompts within the Code Studio platform  | 选填                                                                                                                                             | Within some of our courses, students in a classroom are prompted to answer a question. Their answers are shared with any teacher with whom the student is affiliated on Code Studio, and are not used by Code.org for any other purpose.                                                                                                                                                                                                                                                                                                                                                                                                                            |

  


| Additional data stored by Code.org if you create a Code Studio teacher account | 必填？      | 如何使用此数据                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| ------------------------------------------------------------------------------ | -------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 学校名称                                                                           | 选填       | At your option and under your control, we would list your school in the Code.org map and database of schools that teach computer science courses.</br>  
...
| 学校地址                                                                           | 选填       | At your option and under your control, we would list your school (and relevant contact information, if you provide it) in the Code.org map and database of schools that teach computer science courses.                                                                                                                                                                                                                                                                                                             |
...
[![图片](/images/fit-300/privacy-wide.jpg)](http://studentprivacypledge.org/)