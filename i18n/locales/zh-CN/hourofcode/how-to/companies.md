...
通过与互联网相连的电脑能提供最好的编程一小时体验。 You **don’t** need a computer for every participant, and can even do the Hour of Code without a computer at all.
  ...
  * **Don't have enough devices?** Use [pair programming](https://www.youtube.com/watch?v=vgkahOzFH2Q). Have participants partner with each other. 他们也将明白计算机科学是一种社交和协作。
...
代码小时是只是一段旅途，了解更多有关技术的工作原理以及如何创建软件应用程序的第一步。 To continue this journey, [encourage your participants to learn online](%= resolve_url('https://code.org/learn/beyond') %).
