...
我们为各年龄段的参与者提供了由多个合作伙伴编写的多种[有趣好玩的一小时教程](%= resolve_url('/learn') %) [点击这里试一试！](%= resolve_url('/learn') %)
...
<div class="col-66" style="padding-right: 20px;">
  最好的编程一小时体验需要连接互联网的计算机。 但是你**不**需要为每个孩子准备电脑,，甚至你可以完全不用计算机进行编程一小时活动。
</div>
...
- 鼓励参与者尝试参加 [hourofcode.com/learn](%= resolve_url('/learn') %) 的另一个编程一小时活动。
...
- 观看我们关于 [教育工作者进行编程一小时网络研讨会的指导](https://youtu.be/EJeMeSW2-Mw)的录像.
