...
title: "Artist: For Loops" view: page_curriculum theme: none
...
Students use the Artist environment to write programs with for loops, similar to what they did in the previous Bee level.
...
### **Activity: Artist: For Loops**

[Artist: For Loops](#Activity)
...
### Students will:
  ...
  * Determine start and stop values for multiple for loop examples
...
### <a name="Activity"></a> [Artist: For Loops](http://learn.code.org/s/course4/lesson/10/puzzle/1)
