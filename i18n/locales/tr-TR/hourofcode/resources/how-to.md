...
Farklı çözüm ortaklarımız tarafından oluşturulmuş bir saat süren bütün yaş gruplarını uygun eğlenceli aktivitelere ev sahipliği yapacağız. Kodlama saati yeni öğreticilerle 8-14 Aralık'tan önce geliyor.

**Tüm Kodlama Zamanı öğreticileri:**

  * Öğretmenler için çok az hazırlık zamanı gerektirir
  * kendi yönergelerine sahiptir ve öğrencilerin kendi hızlarına uygun hareket etmelerine izin verir

[![image](http://code.org/images/tutorials.png)](http://code.org/learn)

## 2) plan donanım gereksinimleriniz - bilgisayar isteğe bağlı

En iyi saat kodu deneyimi, Internet'e bağlı olan bilgisayarları ile olacaktır. Ama her çocuk için bilgisayara gerek yok ve hatta Kodlama Zamanını bilgisayar olmadan da uygulayabilirsiniz.
