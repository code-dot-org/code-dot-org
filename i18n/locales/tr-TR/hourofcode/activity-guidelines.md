...
* Aktivitenin uzunluğu 
    * Sadece 1 saat
    * 1 saat ve devamı olarak yapılacak ders
    * 2-6 saat (birden fazla ders olabilir)
* Aktivitenizde varsa erişilebilirlik düzenlemelerinin listesi. Bunlar arasında ekran okuyucu uyumluluğu, metinden-konuşma yetenekleri, yüksek kontrastlı renklerin kullanımı veya engelli öğrenciler için yapılan diğer düzenlemeler bulunur.
...
** Aktivitenin sonuna geri bildirimi dahil edin.** (Ör. "10 seviyeyi bitirdiniz ve döngüleri öğrendiniz! Harikasın!") Bu kullanıma engel olmak istemiyoruz ancak bazı kısıtlamalara uyulmasını istiyoruz:
