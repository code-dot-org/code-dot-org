...
- “పిల్లలు ఎంతగా ఆనందించారో చూసి నేను చాలా ఇష్టపడ్డాను. One amazing thing was that the teachers noticed that some of the students who didn’t do as well academically were excelling at thinking like a developer and helping others learn - giving them a place to feel confident.”
...
| 5-10 minutes  | Introduce yourself and learn more about the students: </ul><li>What do you work, what do you do, and what do you love most about your job?</li><li>ఏది లేదా ఎవరు మీకు స్ఫూర్తి కలిగించారు?</li><li>కంప్యూటర్ సైన్స్ లో మీకు ఆసక్తి ఎలా ఏర్పడింది?</li><li>మీకు ఒక హితబోధకులు ఉండినారా?</li><li>Share a story about how tech affects everyone.</li><br>విద్యార్థుల్ని ప్రశ్నలు అడగండి మరియు ప్రశ్నలు&జవాబులకు వారికి సమయం ఇవ్వండి.</br> <li> What jobs are they interested in, what are their favorite tech gadgets or apps, and how do they think they are built? </li><li> Do the students have any questions for you?</ul> |
...
- మా [వాలంటీర్ మ్యాప్](http://code.org/volunteer/local) పైన టీచర్లు వాలంటీర్ల కొరకు శోధన చేస్తూ ఉంటారు.
- ఒక టీచర్ మిమ్మల్ని ఎంపిక చేసుకునే అవకాశాన్ని పెంచుకోవడానికి గాను మీ ప్రొఫైలును సాధ్యమైనంత పూర్తిగా తయారు చేయడానికి ప్రయత్నించండి.
