...
<%= partial('curriculum_header', :unittitle=>'Curso 2', :lesson=>6, :title=> 'Labirinto: Laços', :unplugged=>false, :time=>30) %>
...
Revisar a atividade de laços com os alunos:
...
### <a name="Activity"></a> [Laços do labirinto](http://learn.code.org/s/course2/lesson/6/puzzle/1)
