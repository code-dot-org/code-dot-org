...
<div class="row">
  <h1 class="col-sm-12">
    Recursos (em breve, recursos de 2015)
  </h1>
</div>
...
É por isso que todos os [X number] alunos da [SCHOOL NAME] estão participando do maior evento de aprendizado da história: a Hora do Código, de 7 a 13 de dezembro.
...
É por isso que nossa escola inteira participará do maior evento de aprendizagem da história: a Hora do Código. Esse evento ocorrerá durante a Semana da Educação em Ciência da Computação (8-14 de 7-13). Mais de 100 milhões de alunos por todo mundo já experimentaram uma Hora do Código.
