...
### Junte-se ao movimento e apresente para um grupo de estudantes a sua primeira hora de Ciência da Computação com estes passos. É fácil realizar uma Hora do Código, mesmo para principiantes! If you'd like an extra set of hands to help out, you can find a [local volunteer]({{ urls/volunteer_local }}) to help run an Hour of Code in your class.
