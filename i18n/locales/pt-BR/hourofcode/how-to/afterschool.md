...
**Precisa de um plano de aula para sua Hora do Código depois da escola?** Confira esse novo [estilo](/files/AfterschoolEducatorLessonPlanOutline.docx)!
...
**Não tem problema se você é não têm experiência com ciência da computação. Aqui estão algumas ideias para começar sua atividade da Hora do Código:**
...
**Precisa de mais orientação?** Faça o download deste [modelo de plano de aula](/files/AfterschoolEducatorLessonPlanOutline.docx).
