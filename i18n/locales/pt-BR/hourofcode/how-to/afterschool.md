...
<div class="col-66" style="padding-right: 20px;">
  A melhor experiência da Hora do Código inclui computadores conectados à Internet. Mas você **não** precisa de um computador para cada criança, e você pode até fazer a Hora do Código sem um computador.
</div>
...
- O vídeo de lançamento original da Hora do Código, protagonizados por Bill Gates, Mark Zuckerberg, and NBA star Chris Bosh - Tem essas versões disponíveis: [1 minuto](https://www.youtube.com/watch?v=qYZF6oIZtfc), [5 minutos](https://www.youtube.com/watch?v=nKIu9yen5nc), and [9 minutos](https://www.youtube.com/watch?v=dU1xS07N-FA).
...
**Quando alguém tiver dificuldades, tudo bem responder:**
...
- Assista a gravação do nosso webinar: [Guia do educador para o webinar da Hora do Código](https://youtu.be/EJeMeSW2-Mw).
