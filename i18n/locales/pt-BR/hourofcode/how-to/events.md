...
**Evento:** Assembleia de abertura da semana de educação em ciência da computação em toda a escola

**Data:** {{ campaign_date/start_short }} (início de Semana da educação em ciência da computação)

**Horário:** Durante o dia letivo. Eventos preferencialmente no meio da manhã. Cerca de 1 hora.

**Local:** Auditório da escola (p. ex. teatro, ginásio, cantina)
