...
- [Incentive os colaboradores a se voluntariar em uma turma](#encourage-employees)
- [Vincule sua empresa a uma escola](#connect-with-a-school)
...
## Incentive os colaboradores a se voluntariar em uma turma

[![](/images/fit-600/Marketing/pexels-andrea-piacquadio-3762940.jpg)]({{ urls/learn }})

Uma das maneiras mais satisfatórias de participar da Hora do Código é se voluntariar em uma turma da sua região, presencial ou virtualmente. E o melhor: você não precisar ser um engenheiro para se voluntariar. Você ainda pode proporcionar um momento inesquecível aos alunos compartilhando sua própria experiência profissional e como a ciência da computação ou a tecnologia afetaram sua vida.
...
## Vincule sua empresa a uma escola

Não é preciso usar nosso mapa de voluntários para entrar em contato com uma turma ou escola. Muitas vezes, recomendamos começar na sua região. Reflita se há escolas com as quais você ou seus colaboradores tenham um vínculo forte, como aquela onde vocês estudaram, a de seus filhos, ou uma organização ou instituição dedicada a ajudar uma população que tenha sido sub-representada historicamente na área da ciência da computação.

[![](/images/fit-600/Marketing/2018_HoC-392.jpg)]({{ urls/learn }})

Em seguida, você poderá acessar o site da escola para encontrar as pessoas mais apropriadas para entrar em contato, como um diretor ou vice-diretor, professores de ciência da computação ou tecnologia, ou até a associação de pais e mestres da escola. Você também pode formar parcerias com organizações como clubes infantis, uma filial da Associação Cristã de Moços e muito mais para receberem um evento juntos.

Se não for possível entrar em contato com a escola, [fale conosco](https://support.code.org/hc/en-us/requests/new) e o colocaremos em contato com um dos nossos parceiros da região se possível.
...
- Se você tiver um grupo ou equipe que facilitem o evento ou se voluntariem em escola da região, pense em encomendar [camisetas personalizadas](http://blog.code.org/post/132608499493/hour-of-code-shirts-and-more) para os seus colaboradores.
...
Ao inscrever o seu evento Hora do Código, você receberá e-mails com informações úteis como notícias e dicas para receber um evento Hora do Código bem-sucedido. Desse modo, você também poderá avisar aos pais e as escolas da região que você receberá um evento perto deles.
...
- Você sabia que apenas 45% das escolas dos EUA ensinam ciência da computação? Dê a todos os estudantes a chance de aprender uma #HourOfCode https://hourofcode.com/ 
