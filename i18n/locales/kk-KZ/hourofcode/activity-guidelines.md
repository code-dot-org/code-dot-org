...
* Сіздің әрекетіңіз қамтитын пәндік салалардың тізімі (Информатикадан басқа). Мысалы, егер математика мұғалімі сіздің әрекетіңізді бұрыштар немесе параболалар туралы үйрету үшін қолдана алса, математика ретінде тізімдеңіз. Егер сізде етістіктерді/зат есімдерді/т.б. үйрететін ақылсыз libs әрекеті болса. тілдік өнерді таңдаңыз.
* Сіздің әрекетіңіз үйрететін бағдарламалау тілдерінің тізімі. Яғни C/C ++, Java, JavaScript және т.б. немесе тілге тәуелсіз (бірнеше тілде оқытылатын сабақ жоспарлары үшін)
* Қолдау көрсетілетін табиғи тілдердің тізімі. Ескерту: Тілді анықтау - бұл қызмет провайдерінің жауапкершілігі; біз барлық пайдаланушыларды берілген бір URL мекенжайына бағыттаймыз.
...
Информатика мұғалімдерінің әртүрлі комитеті сапалы және сандық критерийлерге негізделген жіберулерді бағалайды. Негізгі критерийлерге сәйкес келетін барлық іс-шаралар тізімделеді. Мұғалімдер өз сыныптары үшін ең жақсы әрекеттерді табу үшін сүзгіден өткізіп, сұрыптай алады.

Іс-шаралар мен сабақ жоспарларын бағалауға арналған рубрика барлық әрекеттер бойынша келесі критерийлерді іздейді және оларды сәйкесінше бағалайды:
...
Оқулыққа [сағаттық код логотипі](https://hourofcode.com/us/promote/resources#logo) қосуға болады, бірақ бұл міндетті емес. Егер сіз “Код сағаты” логотипін қолдансаңыз, төмендегі сауда белгісінің нұсқауларын қараңыз. <u>Ешқандай жағдайда Code.org логотипі мен атауын қолдануға болмайды.</u> Екеуі де сауда белгісі болып табылады және оларды жазбаша рұқсатсыз үшінші тарап брендінің атауымен бірге үйлестіру мүмкін емес.

**Орташа студенттің бір сағат ішінде ыңғайлы аяқтай алатынына көз жеткізіңіз.** Сабақ барысында тезірек қозғалатын студенттер үшін соңында ашық әрекетті қосуды қарастырыңыз. Есіңізде болсын, балалардың көпшілігі информатика мен кодтауға абсолютті жаңадан бастаушылар болады.
...
Қатысуға дәлірек бақылау үшін біз әрбір оқулық серіктесінен “Код сағаты” оқулықтарының бірінші бетіне 1 пиксельді бақылау кескінін қосуды сұраймыз. Пиксель-сурет тек бастапқы бетте болуы керек. Оқулықтың кез-келген аралық беттеріне қоспаңыз.
