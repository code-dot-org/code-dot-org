...
Қызығушылық білдірген әр түрлі жастағы қатысушыларға көптеген [көңілді мағлұматтар беріп, ұзақ та тартымды дәрістер](%= resolve_url('https://code.org/learn') %) ұсынамыз. [Өзіңіз кіріп көріңіз!](%= resolve_url('/learn') %)
