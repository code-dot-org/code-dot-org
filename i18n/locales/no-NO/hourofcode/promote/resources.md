...
1. En hver referanse til «Kodetimen» burde bli brukt på en slik måte at det ikke tyder på at det er ditt eget merkenavn, men heller refererer til Kodetimen som en grasrotbevegelse.
    
    - Godt eksempel: "Delta i Kodetimen™ på ACMECorp.com". 
    - Dårlig eksempel: «Prøv Kodetimen fra ACME Corp».
...
Datamaskiner er over alt og endrer alle bransjer på planeten. Men færre enn halvparten av alle skoler underviser informatikk. Good news is, we’re on our way to change this! Hvis du har hørt om Kodetimen før, vet du kanskje at den ble historisk. Over hundre millioner elever har prøvd en Kodetime.
