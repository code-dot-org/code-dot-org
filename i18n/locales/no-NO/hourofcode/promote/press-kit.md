...
Den beste måten er gjerne å sende en e-post. It should be short and should communicate "why should other people care about this event"? Legg ved kontaktinformasjon (inkludert mobilnummer) til en som kommer til å være tilstede på arrangementet. **[See a sample pitch to media]({{ promote/press-kit-emails }})**.

Finn journalistens kontaktinformasjon på nettet. If you can't find it, call the publication to ask, or email the organization's general email address and ask for your message to be directed to the correct reporter. <br />
...
Computers are everywhere, changing every industry on the planet, but fewer than half of all schools teach computer science. Young women and students from marginalized racial and ethnic groups are severely underrepresented in computer science classes, and in the tech industry. De gode nyhetene er at vi jobber for å endre dette.
