...
- "Jeg ELSKET å se hvor glade barna var. En fantastisk ting var at lærerne la merke til at noen av elevene som ikke gjorde det så bra akademisk, utmerket seg i å tenke som en utvikler og hjelpe andre - og gi dem et sted å føle seg trygge.
...
- **Har du ikke nok enheter?** Bruk parprogrammering. Når elevene jobber to og to, vil de hjelpe hverandre og være mindre avhengige av læreren. De vil også oppleve at programmering er sosialt og handler om samarbeid.
...
Lærere leter etter aktuelle frivillige på [kartet](https://code.org/volunteer/local). Prøv å fylle inn profilen din så nøyaktig og fullstendig som mulig for å øke sjansene for å bli valgt. Hvis du har en preferanse for hvordan du vil være frivillig, for eksempel å være gjestetaler eller som teknisk støtte, vennligst oppgi det i beskrivelsen av profilen din.   
