...
- Dese de [alta](%= resolve_url('https://code.org/volunteer') %) como voluntario.
...
- Encourage software engineers at your company to visit a local classroom to help lead an Hour of Code and inspire students to study computer science. Pueden [registrarse](%= resolve_url('https://code.org/volunteer/engineer') %) para ser conectados a una clase.
