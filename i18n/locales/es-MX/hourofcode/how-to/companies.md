...
Durante la campaña de la Hora del código, tu empresa puede ayudar a concienciar sobre el movimiento de la ciencia de la computación. Ya sea que te ofrezcas como voluntario o planifiques un evento para tu empresa, todos tus esfuerzos pueden tener un gran impacto en la forma en que las mujeres jóvenes y los estudiantes de grupos raciales y étnicos marginados ven la informática y su propio potencial.

- [Anima a los empleados a ofrecerse como voluntarios en una escuela.](#encourage-employees)
...
## Anima a los empleados a ofrecerse como voluntarios en una escuela.

[![](/images/fit-600/Marketing/pexels-andrea-piacquadio-3762940.jpg
)]({{ urls/learn }})

Una de las formas más satisfactorias de participar en la Hora del Código es ofrecerse como voluntario en un aula local, ya sea en persona o virtualmente. Lo mejor de todo es que no es necesario ser ingeniero para ser voluntario. Aún puedes brindar una experiencia significativa a los estudiantes compartiendo tu propia experiencia profesional y cómo las Ciencias de la Computación o la tecnología han influido tu función.

[<button>Regístrate para ser voluntario</button>]({{ urls/volunteer }})

Una vez que un voluntario se registra, un docente puede revisar su perfil en nuestro [mapa de voluntarios](https://code.org/volunteer/local), por lo que se deben enviar los perfiles tan completos como sea posible. Si tienes un buen perfil para tu aula, un docente se comunicará contigo a través de la plataforma (nunca compartiremos tu dirección de correo electrónico con el docente). Luego, puedes coordinar los detalles directamente con el docente sobre [sobre la mejor manera de ser voluntario en su aula](https://hourofcode.com/us/how-to/volunteers).
...
No es necesario que utilices nuestro mapa de voluntarios para conectarte con una aula o escuela. A menudo, recomendamos empezar a nivel local. Considera si hay escuelas con las que tú o tus empleados tengan una fuerte conexión tales como un alma mater, una escuela para niños o una organización o escuela que esté enfocada en atender a una población que históricamente ha sido insuficientemente representada en las ciencias de la computación.

[![](/images/fit-600/Marketing/2018_HoC-392.jpg)]({{ urls/learn }})

Desde ese punto, puedes visitar el sitio web de la escuela para encontrar los contactos adecuados a los que dirigirte tales como administradores como un Director o Subdirector, docente de tecnología o ciencias de la computación, o incluso la Asociación de padres y docentes de la escuela. También puedes asociarte con organizaciones como the Boys & Girls Clubs of America, una sucursal de la YMCA y más para ser coanfitriones de un evento.

Si no puedes conectarte con una escuela, [contáctanos](https://support.code.org/hc/en-us/requests/new) y te conectaremos con uno de nuestros socios locales si es posible.
