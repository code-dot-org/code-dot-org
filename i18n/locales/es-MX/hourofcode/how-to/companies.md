---
title: Guía práctica de la Hora del Código para empresas
---
...
- [Anima a los empleados a ser voluntarios en un aula de clases.](#encourage-employees)
- [Conecta tu empresa con una escuela](#connect-with-a-school)
...
## Anima a los empleados a ser voluntarios en un aula de clases.

[![](/images/fit-600/Marketing/pexels-andrea-piacquadio-3762940.jpg)]({{ urls/learn }})

Una de las formas más satisfactorias de participar en la Hora del Código es ser voluntario en un aula local, ya sea en persona o virtualmente. Lo mejor de todo es que no es necesario ser ingeniero para ser voluntario. Aún puedes brindar una experiencia significativa a los estudiantes al compartir tu propia experiencia profesional y cómo las Ciencias de la Computación o la tecnología han impactado tu función.

[<button>Regístrate para ser voluntario</button>]({{ urls/volunteer }})

Una vez que un voluntario se registra, un docente puede revisar su perfil en nuestro [mapa de voluntarios](https://code.org/volunteer/local), por lo que los perfiles deben enviarse lo más completos posible. Si tienes un buen perfil para tu aula, un docente se comunicará contigo a través de la plataforma (nunca compartiremos tu dirección de correo electrónico con el docente). Luego, puedes coordinar los detalles directamente con el docente sobre [cómo ser mejor voluntario en tu aula](https://hourofcode.com/us/how-to/volunteers).

Para obtener más orientación sobre el voluntariado y mensajes de muestra para entusiasmar a tu empresa con la Hora del Código, consulta nuestra [guía para socios corporativos](https://staging.hourofcode.com/files/hoc-corporate-toolkit.pdf).

* * *

<a id="connect-with-a-school"></a>

## Conecta tu empresa con una escuela

No es necesario que utilices nuestro mapa de voluntarios para conectarte con un aula o escuela. A menudo, recomendamos comenzar localmente. Considera si hay escuelas con las que tú o tus empleados tengan una fuerte conexión, como un alma mater, una escuela para niños o una organización o escuela que se centre en atender a una población que históricamente no ha tenido representación en las ciencias de la computación.

[![](/images/fit-600/Marketing/2018_HoC-392.jpg)]({{ urls/learn }})

Desde ese punto, puedes visitar el sitio web de la escuela para encontrar los contactos adecuados para comunicarte con administradores como un director o subdirector, instructores de tecnología o ciencias de la computación, o incluso la Asociación de padres y docentes de la escuela. También puedes asociarte con organizaciones como Boys & Girls Clubs of America, una sucursal de la YMCA y más para ser coanfitriones de un evento.

Si no puede conectarte con una escuela, [contáctanos](https://support.code.org/hc/en-us/requests/new) y te conectaremos con uno de nuestros socios locales si es posible.
...
Si deseas hacer un esfuerzo adicional, tu empresa también puede organizar un evento de la Hora del Código. No existe una fórmula específica para organizar un evento, por lo que te recomendamos que seas creativo. Dado que nuestro personal es pequeño (¡pero poderoso!), Code.org no tiene un equipo dedicado a coordinar los eventos de la Hora del Código. Sin embargo, estos son algunos consejos para comenzar.
...
- Si eres una empresa de tecnología, demuestra productos divertidos e innovadores en los que está trabajando tu empresa. Si no eres una empresa de tecnología, analiza las formas en que tu empresa utiliza la tecnología para resolver problemas y lograr objetivos.
...
- Si tienes un grupo de personal que facilitará tu evento o será voluntario en una escuela local, considera pedir [camisetas personalizadas](http://blog.code.org/post/132608499493/hour-of-code-shirts-and-more) para tus empleados.
...
- **Proporciona auriculares** a tus participantes o pídeles que traigan los suyos si van a probar tutoriales que funcionan mejor con sonidos.
...
Si tu evento va a ser virtual, deberás decidir sobre tu plataforma de conferencias (y probarla) antes de tu evento. Esto puede afectar la cantidad de estudiantes con los que te sientes cómodo participando, por lo que es mejor determinar esto antes de invitar a una clase o promocionar tu evento. Para obtener ideas sobre cómo ejecutar una Hora del Código remota, lee nuestros [consejos para un evento virtual de la Hora del Código](https://hourofcode.com/us/how-to/virtual).
...
- [Imprime stickers de "¡Hice una Hora del Código!"]({{ promote/resources_stickers }}) o busca otros premios y materiales promocionales en la [Tienda de Code.org en Amazon](https://code.org/shop). 
...
- ¿Sabías que solo el 45 % de las escuelas de EE. UU. enseñan ciencias de la computación? Dale a cada estudiante la oportunidad de aprender una #HoraDelCódigo https://hourofcode.com/ 
...
- Difunde la conciencia exhibiendo los materiales promocionales de [ Code.org ](https://store.code.org/) (todos los ingresos se destinan a ayudar a que más estudiantes obtengan acceso a la educación en las ciencias de la computación).
- Elige beneficiar a Code.org cuando compres en [AmazonSmile](https://code.org/donate/amazonsmile). 
- Pídele a tu director ejecutivo que envíe un correo electrónico a toda la empresa enfatizando la importancia de las ciencias de la computación y alentando a los empleados a correr la voz.
