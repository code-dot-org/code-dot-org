...
Para obtener más orientación sobre el voluntariado y mensajes de muestra para entusiasmar a tu empresa con la Hora del Código, consulta nuestra [guía para socios corporativos]({{ localized_files/hoc_corporate_toolkit }}).
