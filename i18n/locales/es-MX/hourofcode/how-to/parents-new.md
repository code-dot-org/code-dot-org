...
Probar una Hora de Código es una forma sencilla y divertida de presentarle a tu hijo las ciencias de la computación, quizás por primera vez. Las ciencias de la computación no solo son fundamentales para todos los campos de estudio, sino que <a href="https://medium.com/@codeorg/cs-helps-students-outperform-in-school-college-and-workplace-66dd64a69536">estudios recientes muestran que</a>: los niños que estudian ciencias de la computación se desempeñan mejor en otras materias, sobresalen en la resolución de problemas y tienen <font color="00adbc"><b> un 17% más de probabilidades para inscribirse en la universidad</b></font>.
...
- Para el niño que ama a Disney: <a href="https://code.org/starwars">Star Wars</a>, <a href="https://studio.code.org/s/frozen/lesson/1/puzzle/1">Frozen</a> o <a href="https://partners.disney.com/hour-of-code?cds&cmp=vanity%7Cnatural%7Cus%7Cmoanahoc%7C">Moana</a>
...
- Imprime <a href="https://staging.code.org/certificates">Certificados de la Hora del Código</a> que otorgas cuando tu hijo completa su actividad
- <a href="https://staging.hourofcode.com/us/promote/resources#stickers">Imprime stickers</a> en casa o <a href="https://store.code.org/">cómpralas en línea</a>, como una sorpresa adicional.
- Comparte fotos y videos de tu Hora del Código en casa en las redes sociales. ¡Usa #HourOfCode y @codeorg para que también podamos destacar tu éxito!

[<img src="/images/fit-600/Marketing/g8TUlHzF.jpeg" />]({{ urls/learn }})

<h2>¿Qué viene después de la Hora del Código?</h2>

¡Las ciencias de la computación no tienen que terminar con la Hora del Código! Si bien el 90% de los padres quieren que sus hijos aprendan ciencias de la computación, la mayoría de las escuelas todavía no las enseñan. Para ayudar, nuestro plan de estudios está basado en la web y es de uso gratuito para siempre. <a href="https://code.org/yourschool">Descubre cómo</a> llevar las Ciencias de la Computación a la escuela de tu hijo hoy.