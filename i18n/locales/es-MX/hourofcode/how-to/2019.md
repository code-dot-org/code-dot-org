...
- Escribe el enlace al tutorial en la pizarra blanca. Encuentra el enlace en la [información para el tutorial seleccionado]({{ urls/learn }}) debajo del número de participantes.
...
¡Las ciencias de la computación no tienen que terminar con la Hora del Código! Nuestro plan de estudios está en Internet y es gratuito para siempre. [Descubre cómo](/beyond) llevar las ciencias de la computación a tu escuela y a tus estudiantes.
