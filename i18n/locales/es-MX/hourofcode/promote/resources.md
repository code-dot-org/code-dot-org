...
¡Ya contamos con una nueva serie de carteles que incluyen a Malala, Stephen Curry, Shakira y más! Este año, cada serie también incluye 6 carteles y 126 etiquetas autoadhesivas de "Yo participé en la Hora del Código". Si quieres imprimir por tu cuenta, haz clic en una imagen debajo para ver y guardar una versión que puedes imprimir.
