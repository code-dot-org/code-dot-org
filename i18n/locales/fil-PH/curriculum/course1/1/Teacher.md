...
<%= partial('curriculum_header', :title=> 'Happy Maps', :lesson=>1, :unplugged=>true, :disclaimer=>'Ang basic lesson time ay may kasamang activity lamang. Ang Introductory at Wrap-Up na mga suggestion ay maaaring gamitin ng mas malalim kung meron pang oras.', :time=>20) %>
...
Ang pinaka-ugat ng lahat computer science ay tinatawag na algorithm. Ang salitang "algorithm" ay medyo komplikado pakinggan, pero sa totoo ay ito lamang ay isang listahan ng mga instruction na sinusunod upang makakuha ng resulta. Upang makapagbigay ng matatag na basehan para sa edukasyon ng iyong mga estudyante sa computer science, bibigyan nating kahalagahan kung paano gamitin ang mga algorithm.

[summary]

## Summary ng Pagtuturo
...
### **Pangkalahatan** - 5 minuto

4) [Flash Chat](#WrapUp) - Ano ang ating natutuhan?  
5) [Vocab Shmocab](#Shmocab)

### **Assessment** - 10 minuto
...
### Ang estudyante ay:
  ...
  * Maglilista ng mga hakbang upang pagalawin ang tauhan sa loob ng map
  * Ayusin ang mga direksyon upang makarating sa pangunahing goal
  * Mahulaan kung saan pupunta ang tauhan, sa pamamagitan ng mga listahan ng hakbang na ibinigay
...
## Kagamitan, Paraan at Paghahanda

### Para sa mga Estudyante

  * Mga mapa at mga arrow mula sa [Happy Maps: Single-Step Adventure](/curriculum/course1/1/Activity1-HappyMaps.pdf)
  * Mga Kagamitan sa Laro: Flurbs, Arrows, and Things 
...
Ang lesson na ito ay meron isang bago at importante na salita:  
...
**Algorithm** - Bigkasin natin: Al-go-ri-thm   
Isang listahan ng mga hakbang upang matapos ang gawain.

### <a name="GetStarted"></a> 2) Step-by-Step

  * Tanungin ang iyong mga estudyante ng mga direksyon papunta ng chalkboard. 
      * Kung sila ay magbigay ng instruction ng sabay-sabay, sabihin na maaari ka lamang sumunod sa instruction ng paisa-isa. Tawagin ng paisa-isa ang bawat estudyante kung ito ay makakatulong. 
  * Kapag narating mo na board, humingi ng mga instruction upang makaguhit ng nakangiti na mukha. 
      * Gaya ng dati, humingi ng instruction ng paisa-isa lang.
  * Ipaliwanag na maraming gawain ang kayang tapusin gamit ang ibat'-ibang lista ng mga instruction. Ito ang tinatawag na algorithm. 
  * Hamunin ang iyong mga estudyante na magkaisa at bumuo ng isang grupo upang makagawa ng mga algorithm para sa kanilang single-step at double-step na mga maze.
