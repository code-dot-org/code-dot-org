...
### Hanapin ang lahat ng mga mapagkukunan na kailangan mo upang bigyang pansin ang Hour of Code mo. Hindi sigurado kung saan magsisimula? Magsimula sa aminggabay sa paggamit para sa pagho-host ng Hour of Code!</h3> 
...
* Hinahanap ang mga poster namin sa mga nakaraang taon? [Hanapin sila dito]({{ promote/previous_posters_url }})!

<a id="social"></a>

## I-post ang mga ito sa social media

[![imahe](/images/social-media/fit-250/social-2.png)](/images/social-media/social-2.png)&nbsp;&nbsp;&nbsp;&nbsp; [![imahe](/images/social-media/fit-250/social-3.png)](/images/social-media/social-3.png)&nbsp;&nbsp;&nbsp;&nbsp;

[![imahe](/images/social-media/fit-250/malala_yousafzai.png)](/images/social-media/malala_yousafzai.png)&nbsp;&nbsp;&nbsp;&nbsp; [![imahe](/images/social-media/fit-250/chris_bosh.png)](/images/social-media/chris_bosh.png)&nbsp;&nbsp;&nbsp;&nbsp;

[![imahe](/images/social-media/fit-250/karlie_kloss.png)](/images/social-media/karlie_kloss.png)&nbsp;&nbsp;&nbsp;&nbsp; [![imahe](/images/social-media/fit-250/satya_nadella.png)](/images/social-media/satya_nadella.png)&nbsp;&nbsp;&nbsp;&nbsp; [![imahe](/images/social-media/fit-250/jeff_bezos.png)](/images/social-media/jeff_bezos.png)&nbsp;&nbsp;&nbsp;&nbsp;

<a id="logo"></a>

## Gamitin ang logo ng Hour of Code ng maikalat ang balita
...
<ul style="margin-top: 0px">
  <li>
    <strong>Magandang halimbawa</strong>: "Makilahok sa Hour of Code™ sa YOUR-COMPANY.com." 
  </li>
  <li>
    <strong>Masamang halimbawa</strong>: "Subukan ang Hour of Code ng YOUR-COMPANY." 
  </li>
</ul>

1. Gumamit ng "TM" superskripsiyon sa mga prominenteng dako na binanggit mo ang "Hour of Code" at isang "Ⓡ" superskripsiyon sa mga prominenteng dako na binanggit mo ang "Hora del Código", sa parehong web site at sa mga paglalarawan ng app mo.
2. Isama ang wika sa pahina mo (o sa footer), kasama ang mga link sa CSEdWeek at [Code.org]({{ codeorg_link }}) web sites, na sinasabi ang sumusunod:
    
    *"Buong bansang inisyatibo ng Linggo ng Edukasyon ng Computer Science ang 'Hour of Code™'/'Hora del Código®' [csedweek.org] at Code.org[code.org] upang ipakilala ang milyong estudyante sa isang oras ng computer science at computer programming."*

3. Walang paggamit ng "Hour of Code" o "Hora del Código" sa mga pangalan ng app.
...
## Mag-imbita ng mga tao sa komunidad mo sa iyong Hour of Code at i-promote ang event mo sa pamamagitan ng email

### Maghanap ng [higit pang impormasyon at wikang magagamit mo]({{ promote/stats_url }}) kapag pinag-uusapan ang Hour of Code.
...
Ngayong taon, gawin natin mas malaki ito. Hinihiling kong sumali ka sa Hour of Code {{ campaign_date/year }}. Makisali sa isang Hour of Code na event sa panahon ng Linggo ng Edukasyon ng Computer Science, {{ campaign_date/full }}.

Ipamalita ito. Mag-host ng event. Hilingin ang lokal na paaralan na mag-sign up. O subukan mo ang Hour of Code—makikinabang ang lahat mula sa pag-aaral ng mga pangunahing kaalaman.

Magsimula sa http://hourofcode.com/{{ country_language }}<br />

* * *

<a id="help-schools"></a>

### Magboluntaryo sa isang paaralan:

#### [Maghanap ng higit pang mga mapagkukunan at impormasyon tungkol sa pagboboluntaryo sa mga paaralan dito]({{ how_to_volunteers_url }}).
...
Tignan ang http://hourofcode.com/{{ country_language }} para sa mga detalye at tumulong na ikalat ang balita.<br />

* * *

<a id="media-pitch"></a>

### Imbitahin ang media na dumalo sa event mo:

#### [Tingnan ang press kit namin para sa karagdagang impormasyon sa pag-imbita ng media sa event mo.]({{ promote/press_kit_url }})
...
Batayan ang Computer Science sa kada industriya ngayon, ngunit hindi ito tinuturo sa karamihan sa mga paaralan. Sa [PANGALAN NG PAARALAN], sinusubukan naming baguhin iyan.
