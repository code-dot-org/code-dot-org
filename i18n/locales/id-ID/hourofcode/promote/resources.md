...
[![gambar]({{ hoc_logo_fit_200 }})]({{ hoc_logo }})
...
Computers are everywhere, changing every industry on the planet, but only 45% of all high schools teach computer science. Girls and minorities are severely underrepresented in computer science classes, and in the tech industry. Kabar baiknya, kita berada pada jalur yang tepat untuk merubah itu.
...
Itulah mengapa seluruhnya dari [X number] siswa di [SCHOOL NAME] bergabung dalam acara pembelajaran terbesar dalam sejarah: Jam Kode, selama Pekan Edukasi Ilmu Komputer (3-9 Desember).
