...
Code.org menyelenggarakan berbagai aktivitas, pelajaran, dan video Hour of Code™ di situs web Code.org dan Hour of Code. Daftar saat ini ada di []({{ urls/learn }})hourofcode.com/learn.
...
**Teka-teki atau permainan yang dipandu sendiri ([contoh](https://code.org/dance))**
...
**Pelajaran yang Difasilitasi Guru ([contoh](https://studio.code.org/s/course1/lessons/2/levels/1), [templat](https://docs.google.com/document/d/1DhaLNd6uim9rRPkHrglnOvVcgzGc8axKIzv8YI56JGA))**
...
*Persyaratan teknis:* Karena berbagai macam pengaturan teknologi sekolah dan kelas, kegiatan terbaik adalah berbasis Web atau ramah ponsel cerdas, atau kegiatan gaya unplugged-style yang mengajarkan konsep ilmu komputer tanpa menggunakan komputer (lihat http://csunplugged.com/). [](http://csunplugged.com/) Aktivitas yang memerlukan penginstalan aplikasi, aplikasi desktop, atau pengalaman konsol game baik-baik saja tetapi tidak ideal. Kami tidak akan mencantumkan aktivitas yang memerlukan pendaftaran atau pembayaran. (Kegiatan robotika dapat memerlukan pembelian robotika.)
...
* Setelah menyelesaikan aktivitas Anda, pengguna harus diarahkan ke [](https://code.org/api/hour/finish) code.org/api/hour/finish di mana mereka akan dapat: 
    ...
    * Untuk pengguna yang menghabiskan satu jam untuk aktivitas Anda dan tidak menyelesaikannya, harap sertakan tombol pada aktivitas Anda yang bertuliskan “Saya selesai dengan Jam Kode saya” yang menautkan kembali ke [](https://code.org/api/hour/finish) code.org/api/hour/finish juga.
