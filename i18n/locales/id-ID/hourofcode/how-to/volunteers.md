...
# Cara menjadi sukarelawan di sekolah atau di kelas
...
Hour of Code adalah pengantar ilmu komputer berdurasi satu jam, dan dirancang untuk mengungkap rahasia "kode", yang menunjukkan bahwa siapa pun dapat mempelajari dasar-dasarnya, dan untuk memperluas partisipasi dalam bidang ilmu komputer. Anda dapat membantu meningkatkan kesadaran tentang gerakan ilmu komputer dan menjadi sukarelawan untuk menginspirasi lebih banyak siswa untuk mencoba ilmu komputer, khususnya remaja putri dan siswa-siswa dari kelompok ras dan etnis yang terpinggirkan.
...
Baik menjadi sukarelawan secara virtual, secara langsung, atau dengan perusahaan Anda, upaya Anda dapat memberi dampak besar terhadap cara siswa dalam memandang ilmu komputer dan potensi mereka sendiri. Lihat [toolkit sukarelawan kami jika Anda masih memiliki pertanyaan]({{ localized_files/hoc_volunteer_toolkit }}).
...
Siapa pun yang tertarik dengan pendidikan ilmu komputer dan meningkatkan keragaman dalam teknologi dapat menjadi sukarelawan! Kami ingin melihat partisipasi relawan dari semua latar belakang. Hour of Code menghadirkan berbagai kegiatan untuk segala usia dan tingkat keahlian, jadi Anda tidak harus menjadi ahli pemrograman untuk menjadi sukarelawan!
...
Ilmu komputer adalah bidang yang menentukan di abad ke-21, namun sebagian besar sekolah masih belum mengajarkannya. One Hour of Code (Satu Jam Coding) mungkin merupakan akses paling besar ke ilmu komputer yang diterima oleh siswa ini pada tahun tertentu. Dengan menjadi sukarelawan, Anda dapat semakin mempermudah guru untuk menghadirkan Ilmu Komputer ke dalam kelas mereka.
...
- "SAYA SENANG melihat betapa senangnya anak-anak itu. Satu hal yang menarik yang dijumpai para guru adalah ada sejumlah siswa yang tidak berprestasi secara akademis namun mampu berpikir seperti seorang pengembang dan membantu orang lain - sehingga memberi mereka tempat untuk merasa percaya diri.” 
...
Guru dapat mencari sukarelawan di [peta relawan](http://code.org/volunteer/local) kami. Jika Anda berada di dekat sekolah mereka, guru akan memeriksa profil Anda di peta, jadi cobalah untuk melengkapi info Anda sebanyak mungkin agar Anda berpeluang besar untuk dihubungi oleh guru.

[![](/images/fit-600/Marketing/2018_HoC-489-resized.jpg)]({{ urls/learn }})

Jika terpilih, guru tersebut akan menghubungi Anda melalui platform sukarelawan (kami tidak akan pernah memberikan alamat email Anda dengan guru tersebut). Bekerja samalah dengan mereka untuk menentukan kontribusi terbaik yang dapat Anda berikan untuk acara mereka, dan apakah Anda akan hadir secara langsung atau menjadi sukarelawan virtual.
...
Anda tidak perlu menggunakan peta sukarelawan kami untuk menjadi sukarelawan! Kami justru menyarankan Anda untuk menghubungi guru dan administrator secara langsung jika ada kelas yang ingin Anda masuki.
...
Jika Anda menjadi sukarelawan di kelas, diskusikan persiapan ini sebelumnya dengan guru tersebut:
...
- Jika Anda akan menjadi sukarelawan secara langsung, pastikan Anda berdua memahami pedoman kesehatan dan keselamatan lokal dan sekolah. Anda mungkin harus datang lebih awal jika prosedur mereka mengharuskannya. 
- Jika Anda akan menjadi sukarelawan secara virtual atau secara langsung, karena ini dapat menentukan di jam berapa Anda harus hadir dan dalam kapasitas seperti apa. 
- Jika Anda menjadi sukarelawan secara virtual, diskusikan bersama guru untuk menentukan platform konferensi video terbaik yang akan digunakan dan lakukan uji coba acara tersebut bersama-sama. 
...
- Jika Anda seorang sukarelawan virtual, pertimbangkan untuk membuat beberapa slide presentasi agar siswa tetap aktif.

Butuh bahan lainnya? [Lihat kiat lain berikut](https://code.org/files/CSTT_Volunteers.pdf).
...
- Jika Anda memiliki beberapa staf yang akan memfasilitasi acara atau menjadi sukarelawan di sekolah lokal, pertimbangkan untuk memesan [kaos khusus](http://blog.code.org/post/132608499493/hour-of-code-shirts-and -more) untuk mereka.
...
## T&J tentang Menjadi Sukarelawan

### Saya belum dihubungi oleh seorang guru. Bagaimana cara agar saya tetap bisa menjadi sukarelawan?
