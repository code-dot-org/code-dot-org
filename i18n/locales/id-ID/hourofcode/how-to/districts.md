...
## Buat semua sekolah berpartisipasi, setiap pelajar harus mempelajarinya!
  ...
  2. **Sediakan contoh perencanaan logistik untuk sekolah.** Bagikan sampel perencanaan logistik kepada sekolah untuk memberikan mereka ide bagaimana mengorganisasikan seluruh partisipan di sekolah. Itu semudah melakukan setiap kelas matematika, periode walikelas, pertukaran giliran penggunaan lab komputer. They can submit their own plan for a chance to win $10,000 in hardware at [http://hourofcode.com/prizes](%= resolve_url('/prizes/hardware-signup') %).
