...
See our [event how-to guide]({{ urls/how_to_events }}) for a sample run of show, [media outreach kit]({{ promote/press_kit_url }}), and other event-planning resources. Menyelenggarakan acara adalah cara yang bagus untuk mempromosikan Hour of Code dan meningkatkan partisipasi.
