...
Kita akan menjadi tuan rumah dari berbagai [tutorial satu jam yang menyenangkan](%= resolve_url('https://code.org/learn') %) bagi siswa dari segala usia, dibuat oleh berbagai mitra. *Tutorial baru datang untuk memulai Hour of Code sebelum < % = campaign_date('full') % >.* [Coba tutorial yang ada saat ini.](%= resolve_url("https://code.org/learn") %)
...
**Tidak masalah jika Anda dan murid Anda masih baru untuk ilmu komputer. Berikut beberapa ide untuk mengenalkan aktifitas Hour of Code:**
  ...
  * Lihat tips untuk mendapatkan gadis tertarik dalam ilmu komputer [ di sini](<%= resolve_url('https://code.org/girls') %>).
