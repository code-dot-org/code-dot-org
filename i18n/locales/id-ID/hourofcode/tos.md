...
Silakan baca Persyaratan Layanan ("**syarat**") dengan seksama sebelum mengakses atau menggunakan layanan. Mengakses atau menggunakan bagian apapun dari layanan atau mengklik "Saya setuju" atau "Sign Up" tombol yang dapat dibuat tersedia untuk Anda berarti bahwa Anda setuju untuk terikat oleh syarat tanpa perubahan.

Syarat ini adalah kontrak yang sah antara Anda dan Code.org tentang penggunaan Layanan. Anda dapat menggunakan Layanan hanya jika Anda dapat membentuk perjanjian yang mengikat dengan Code.org dan bukan orang yang dilarang menerima layanan berdasarkan undang-undang Amerika Serikat atau yurisdiksi lain yang berlaku. Jika Anda menerima Syarat dan menggunakan Layanan atas nama perusahaan, organisasi, pemerintah, atau kesatuan legal lainnya, Anda mewakili dan menjamin bahwa Anda memiliki kuasa untuk melakukannya. Anda dapat menggunakan layanan hanya sesuai dengan persyaratan dan semua peraturan daerah, negara, nasional dan hukum internasional.

Syarat-syarat ini dapat berubah. Anda setuju untuk terikat oleh perubahan jika Anda terus menggunakan Layanan setelah perubahan persyaratan ini, jadi silakan periksa persyaratan untuk perubahan secara berkala.
