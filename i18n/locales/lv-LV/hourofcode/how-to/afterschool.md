...
Mēs piedāvājam dažādas [jautras apmācības stundas garumā](%= resolve_url('/learn') %) dalībniekiem visās vecuma grupās, ko veidojuši dažādi partneri. [Izmēģini tās!](%= resolve_url('/learn') %)

**Visas Programmēšanas stundas apmācības:**

- Require minimal prep-time for organizers
- Ļauj skolēniem strādāt pašiem savā tempā un prasmju līmenī
...
**Ja kāds saskaras ar grūtībām, ir normāli atbildēt:**
...
- Iedrošini dalībniekus izmēģināt citas Programmēšanas stundas aktivitātes [hourofcode.com/learn](%= resolve_url('/learn') %)
- Vai palūdz tiem, kuri pabeiguši ātrāk, palīdzēt citiem, kam ir problēmas.
