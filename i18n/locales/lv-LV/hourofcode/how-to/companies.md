...
Vislābākā "Programmēšanas stunda" pieredze būs ar datoriem, kuriem ir pieeja pie interneta. You **don’t** need a computer for every participant, and can even do the Hour of Code without a computer at all.
  ...
  * **Don't have enough devices?** Use [pair programming](https://www.youtube.com/watch?v=vgkahOzFH2Q). Have participants partner with each other. Viņiem arī būs iespēja ievērot, ka datorzinātne ir sociāla un raisa sadarbību.
...
"Programmēšanas stunda" ir tikai pirmais solis ceļojumā, lai iemācītos par to kā tehnoloģijas strādā un kā veidot lietojumprogrammatūru. To continue this journey, [encourage your participants to learn online](%= resolve_url('https://code.org/learn/beyond') %).
