...
title: Balvas layout: wide <% if @country == 'us' || @country == 'ca' %>nav: prizes_nav<% end %>
...
## Katrs organizators iegūs dāvanu kartes kodu {#gift_code}
...
## 100 klases laimēs programmējamo robotu komplektus {#programmable_robots}
