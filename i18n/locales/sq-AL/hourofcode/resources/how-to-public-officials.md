...
### Bëj çdo shkollë te marrë pjesë, çdo student të mësojë!
  ...
  5. **Draft an op-end**. Konsideroni duke botuar një shkrim të llojit opinion, në gazetën tuaj lokale. See this [sample op-ed](<%= resolve_url('/resources/op-ed') %>) supporting comupter supportive of Computer Science Education Week and its goals.
  ...
  8. **Connect locally.** Visit <<%= resolve_url('https://code.org/promote') %>> to learn more about computer science education in your state. Nënshkruaj peticionin atje dhe do të marrësh përditësimet nga Code.org për përpjekjet e tyre lokale, shtetërore dhe federale.
