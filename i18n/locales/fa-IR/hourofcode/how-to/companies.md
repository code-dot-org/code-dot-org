...
بهترین تجربه ی یک ساعت کدزدن با کامپیوتر های متصل به اینترنت خواهد بود. You **don’t** need a computer for every participant, and can even do the Hour of Code without a computer at all.
