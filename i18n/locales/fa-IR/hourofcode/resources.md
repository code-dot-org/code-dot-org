...
<p>
  ...
  <p>
    ...
    <p>
      رایانه ها همه جا هستند, اما مدارس کمتری نیست به ده سال پیش علوم کامپیوتر را تدریس می‌کنند. Good news is, we’re on our way to change this. If you heard about the Hour of Code last year, you might know it made history. In one week, 15 million students tried computer science!
    </p>
