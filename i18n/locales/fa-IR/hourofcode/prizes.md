...
عنوان: جوایز چیدمان: گسترده <% if @country == 'us' || @country == 'ca' %>nav: prizes_nav<% end %>
...
## یکی از کلاس‌ها برنده سفر به واشنگتن برای یک «ساعتِ کد» تاریخی و سرّی خواهد شد! {#dc}
...
## 100 کلاس یک سری از روبات های قابل برنامه ریزی را برنده خواهند شد {#programmable_robots}
