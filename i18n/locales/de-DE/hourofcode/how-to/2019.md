...
### Werden Sie Teil der Bewegung und führen Sie eine Gruppe von SchülerInnen mithilfe dieser Schritte an Ihre erste Informatik-Stunde heran. Eine "Hour of Code" ist einfach zu veranstalten - selbst für Anfänger! Wenn Sie zusätzliche Hilfe benötigen, gibt es [ Freiwillige  vor Ort]({{ urls/volunteer_local }}), die Sie gerne bei der Durchführung einer Hour of Code in Ihrer Klasse unterstützen.

### Sollten Sie noch Fragen haben, lesen Sie bitte unseren[Leitfaden für die Teilnahme]({{ localized_files/participation_guide }}).

***

## 1. Schauen Sie sich dieses hilfreiche Video an  <iframe width="500" height="255" src="//www.youtube.com/embed/SrnvvWDm73k" frameborder="0" allowfullscreen></iframe>

## 2. Erkunden Sie das Angebot an Aufgaben und Tutorials
