...
See our [event how-to guide]({{ urls/how_to_events }}) for a sample run of show, [media outreach kit]({{ promote/press_kit_url }}), and other event-planning resources. Eine solche Veranstaltung zu organisieren ist ein guter Weg um die "Hour of Code" zu bewerben und mehr Personen zur Teilnahme zu bewegen.
