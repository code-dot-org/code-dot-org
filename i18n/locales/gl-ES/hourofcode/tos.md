...
título: Termos do servizo

* * *

### A linguaxe xurídica vinculante é o inglés e puede atoparse [aquí](https://code.org/privacy). A continuación ten unha traducción.

# Termos do servizo

Última revisión: 05 de decembro de 2014

Code.org é unha organización sen fins de lucro (501(c)3 "Code.org"). A nosa misión é darlle a cada estudante a oportunidade de aprender informática. Como parte desa misión, Code.org xestiona os sitios web ubicados en <http://code.org>, <http://csedweek.org>, <http://computinginthecore.org>, <http://hourofcode.com>, outros sitios web, información, texto, currículos, vídeos, gráficos, fotos, APIs, notificacions por correo electrónico e outros materiais e productos relacionados e servizos (os "**Servizos**"), incluindo a plataforma de titoriais en <http://studio.code.org> ("**Código Studio**").

Por favor le estes Prazos de Servizo (“**Termos**”) coidadosamente antes de acceder ou utilizar os Servizos. Accedendo ou utilizando calquera parte dos Servizos ou premendo no botón "Acepto" ou "Rexistro" que pode estar dispoñíbel significa que estás de acordo a ser obligado legalmente por estas condicións sen modificacións.

Estas condicións son un contrato legal entre vostede e Code.org sobre o uso dos servizos. Podes utilizar os Servizos só se podes formar un contrato vinculativo con Code.org e non eres unha persoa excluida de recibir os Servizos baixo as leis dos Estados Unidos ou outra xurisdición aplicábel. Se estás aceptando estes Termos e utilizando os Servizos en beneficio dunha empresa, organización, goberno, ou outra entidade legal, ti declaras que estas autorizado a facelo. Podes utilizar os Servizos só en conformidade con estes Termos e tódolos aplicables a nivel local, estatal, nacional, e leis internacionais, regras e regulacións.

Estes Termos están suxeitos a cambios. Ti aceptas que estarás de acordo a ser vinculado por tales cambios se continúas a utilizar os Servizos despois deste cambio de Termos, así que por favor, comproba estes Termos por se houbese cambios periodicamente.

## Termos adiccionais

Algúns servizos poden estar suxeitos a pautas adiccionais publicadas, reglas ou condicións do servizo ("**Términos adicionais**") e o uso de tales servizos estarán condicionados a aceptación dos términos adiccionais. Se hai un conflicto entre estos términos e os términos adiccionais, os términos adicionaiss aplicarán para ese servizo, a menos que os termos adicionais constara expresamente que se aplicarían estos termos.

### Nenos menores de 13 anos de idade

Tomamos medidas para minimizar a recolección de datos persoais para usuarios menores de 13 anos como se explica no Code.org [política de privacidade](http://code.org/privacy). Si vostede é menor de 13 anos, aconsellamoslle que consiga a aprobación dun pai ou tutor legal antes de crear unha conta en Code.org. Code.org permite que certos representantes dos distritos escolares e colexios, como mestres, administradores, conselleiros e outros educadores (un "**educador**") para conectar cos estudantes a través dos servizos co fin de proporcionar titoria, servizos educativos e similares. Se eres un mestre, podes rexistrar contas nos servizos dun ou mais dos seus estudantes.

Se eres un educador e rexistras unha conta para un estudiante menor de 13 anos (un "**neno**"), vostede representa e garantiza que vostede ou a organización educativa na que traballa ten permiso para rexistrar o neno en servizos educativos, como os de Code.org, que recolle alguns dos datos persoais do neno para o uso e beneficio da escola e non con outro propósito comercial. Ademais, está de acordo en rexirse por estos termos en nome da organización educativa na que traballa.

### Su cuenta

Se creas unha conta para Servizos, es responsábel da seguranza da vosa conta mantendo o voso contrasinal seguro. Se estás utilizando unha conta atribuída a ti por un Educador, o voso Educador pode ser capaz de acceder e desactivar a vosa conta.

Code.org pode permitir que se rexistre unha conta para os servizos a través de certos servizos de terceiros de redes sociales, como Facebook Connect e Google ("**Servicio de autenticación**). Por rexistrarse nos Servizos que utilizan un Servizo de autenticación, estás de acordo en que Code.org pode acceder a vosa información de conta e ti estas de acordo en que se acepta calquera termo de uso dos servizos mediante servizo de autenticación. Vostede é responsable das suas interaccións co servizo de autenticación.

### Privacidade

A sua privacidade é importante para nosotros. Code.org [Política de privacidade](http://code.org/privacy) explica cómo tratamos os teus datos persoais e estes se incorporan a estos térmos por referencia. Por favor, lea a política de privacidade cuidadosamente para obter información relativa a recollida de Code.org, uso e divulgación da sua información personal.

Si vostede é un estudiante que utiliza unha conta rexistrada por un educador ou conectado xunto a un educador, vostede acepta que Code.org pode revelar a sua información os educadores asociados coa sua conta. Se es un Educador, estás de acordo en non compartir información que recibes de estudante dende Code.org con calquera outro axentes autorizados da aula, distrito escolar, ou outro establecemento educativo que representa.

### Contido xerado por usuarios - xestión; Concesión da licenza; Representacións e garantías

Code.org pode permitir agora ou no futuro que vostede e outros usuarios rexistren código no seu ordenador (incluindo o código fonte e o obxeto), información, texto, gráficos, notas, preguntas, comentarios, valoracións, comentarios, imáxes e vídeos ou outras comunicacions (colectivamente, "**contido do usuario**") os servizos. Entendes que tal contido ou tal usuario é publicado, Code.org non garantiza ningunha confidencialidade con respecto ós envíos.

Code.org non ten a obriga de monitorear o contido do usuario ou outros materiais. Vostede é responsable de avaliar todo o contido do usuario incluindo exactitude, exhaustividade e fiabilidade, e soportas todo o risco de uso de tal contido polo usuario. Code.org non será responsable de calquera dano que vostede poida facer como resultado do envio ou uso de calquera contido do usuario.

Code.org pode, pero non está obligado a, controlar ou revisar calquera dos servizos onde os usuarios se comunican únicamente un cara o outro, pero sin limitarse a salas de chat, chats en vivo, taboleiros de anuncios ou outros foros de usuarios e o contido de dita comunicación. Vostede asume o risco deste tipo de comunicacións, e Code.org non terá ningunha responsabilidade relacionada co contido ou uso de calquera das anteditas comunicacions.

Os usuarios poden incluir enlaces a sitios web de terceiros co contido do usuario mentras o contido de ditos sitios web non viole estos termos. Facer clic nestes enlaces é baixo a sua propia responsabilidade. Code.org non é responsable por por dispoñible o contido dos sitios enlazados, incluindo a publicidade, productos ou outros materiais ao respecto.

Presentando ou distribuindo o contido do usuario a través dos servizos oo directamente o persoal de Code.org, vostede otorga a Code.org mundial, non exclusiva, transferible, asignable, dereito totalmente pagado, libre de regalías, perpetuo, irrevocable e licencia para acoller, transferencia, mostrar, realizar, reproducir, modificar, distribuir e redistribuir, adaptar, preparar traballos derivados, utilizar, facer, feito, vender, ofrecer para a venta, importación e outras formas de explotación do contido do usuario, baixo tódolos dereitos de propiedade intelectual, na súa totalidade ou en partes, en calquera formato de medios de comunicación e a través dos canles de medios de comunicación (agora coñecidos ou desarrollados mais adiante).

Ademais, o presentar e distribuir o contido do usuario a través dos servizos, vostede otorga a cada usuario dos servizos unha licencia non exclusiva para acceder e usar o seu contido de usuario.

### Garantías e representacions do contido de usuario

Vostede é responsable de publicar contido do usuario nos servizos e as consecuencias que se deriven de publicar o publicalos. Cargando, enviando, creando oo publicando o seu contido de usuario ou a través dos servizos, vostede representa e garantiza que: (1) vostede é o creador e dono do contido de usuario e que vostede ten a autoridade para utilizar ou ter as licenzas necesarias, dereitos, consentimientos e permisos para publicar, enviar o contido do usuario; (2) o seu contido de usuario non o fai nen fará: (a) infrinxir, contravenir ou malversar ningún terceiro, incluindo ningún dereito de autor, marca rexistrada, patente, segredo comercial, dereito moral, dereito de privacidade, dereito de publicidade, ou calquera propiedade intelectual ou dereito de propiedade ou (b) calumniar, difamar, difamación ou invadir o dereito de privacidade, publicidade ou outros dereitos de propiedade de calquera outra persoa; (3) o contido do usuario non conten ningún virus, adware, spyware, gusanos ou outros códigos maliciosos.

### Restriccions sobre o contido e o uso dos servizos

Nos reservamos o dereito en todo momento (pero non tendo a obligación) para eliminar ou negarse a distribuir calquera contido do usuario no sitio web e suspender ou desactivar os usuarios, sen responsabilidade para con vostede. Tamén reservamonos o dereito de acceder, ler, preservar e revelar calquera información como razonablemente creamos que sexa necesario para (i) satisfacer calquera lei aplicable, regulación, proceso legal ou solicitude gubernamental, (ii) facer cumplir os termos, incluindo a investigación de posibles violacions do presente, (iii) detectar, prevenir, ou do contrario avisar de fraude, seguridade ou temas técnicos, (iv) responder a solicitudes de asistencia de usuario o u(v) protexelos dereitos, propiedade ou seguridade de Code.org, os seus usuarios e o público.

Non ten permiso para facer nengún das seguintes aaccións o acceder ou usar os servizos de: () acceder, manipular ou usar as áreas no-públicas dos servizos, sistemas informáticos de Code.org, ou os sistemas técnicos de entrega dos provedores de Code.org; (ii) sondear, escanear, ou probar a vulnerabilidade de calquera sistema ou rede ou incumplimento ou burlar as medidas de seguridade ou autenticación; (iii) acceso ou procura ou intento de acceso e procura dos servizos por calquera medio (automatizado ou non) que a través de disponibles, publicou as interfaces que son proporcionadas por Code.org (e só en virtude dos térmos e condicions), a menos que vostede podese específicamente facelo grazas a un acordo separado con Code.org (Nota: Arrastrar os servizos está permitido si se fai con arreglo o disposto nos arquivos robots.txt Sen embargo, quitando os servizos sen o consentimento previo de Code.org queda expresamente prohibido); (iv) forzar que calquera encabezado de paquete de TCP/IP ou calquera parte da información do encabezado en calquera correo electrónico ou publicación, ou de calquera maneira empregando os servizos para enviar de forma alterada, enganosa ou falsa información identificable; ou (v) interferir, interrumpir (ou intentar facelo), o acceso de calquera usuario, servidor ou red, incluindo, sen limitación, intimidación ou acoso, enviando un virus, sobrecarga, spam, bombardeo de correo os servizos, ou pola creación do contido en forma de secuencias de comandos en canto a interferir o crear unha carga indebida dos servizos.

### A sua licenza para o uso Code.org Videos, titoriais, datos e APIs
