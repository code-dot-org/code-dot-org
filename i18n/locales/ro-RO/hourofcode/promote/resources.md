...
Computerele sunt peste tot, schimbă fiecare industrie pe planeta. But only 47% of all high schools teach computer science. Vestea bună e că suntem pe cale să schimbăm acest lucru! Daca ati auzit şi inainte de Hour of Code, atunci stiti ca a facut istorie. Mai mult de 100 de milioane de studenţi au încercat o Ora de Programare.
...
Hai sa facem mai mult in acest an. I’m asking you to join the Hour of Code {{ campaign_date/year }}. Please get involved with an Hour of Code event during Computer Science Education Week, {{ campaign_date/full }}.
...
De aceea, fiecare dintre cei [X number] studenți de la [SCHOOL NAME] se alătură celui mai mare eveniment educativ din istorie. Ora cod, în timpul Săptămânii Educației în Informatică (3-9 decembrie).
...
That’s why our entire school is joining in on the largest learning event in history: The Hour of Code, during Computer Science Education Week ({{ campaign_date/full }}). Peste 100 milioane de elevi din toata lumea au încercat deja o Ora de Programare.
