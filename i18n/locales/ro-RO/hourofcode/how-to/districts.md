...
## Implică fiecare școală in eveniment, fiecare elev trebuie sa invete!
  ...
  4. **Promovează pe pagina principală de web a cartierului tău.** Informează vizitatorii cu privire la participarea ta și evenimentele Ora de Programare. Pune un link către [Ora de Programare](%= resolve_url('/') %).
