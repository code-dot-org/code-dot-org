---
title: '<%= hoc_s(:titlu_cum_sa_districte) %>'
layout: larg
...
- Incurajeaza studentii sa continuie la [invata online](%= rezolvare_url('https://cod.org/invat/dincolo') %).
