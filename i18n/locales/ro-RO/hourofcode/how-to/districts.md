...
## Implică fiecare școală in eveniment, fiecare elev trebuie sa invete!
  ...
  4. **Promovează pe pagina principală de web a cartierului tău.** Informează vizitatorii cu privire la participarea ta și evenimentele Ora de Cod. Pune un link către [Ora de Cod](%= resolve_url('/') %).
...
Ora de Cod este doar primul pas într-o călătorie pentru a afla mai multe despre modul în care tehnologia funcționează şi cum se creează aplicațiile software. Pentru a continua această călătorie:
