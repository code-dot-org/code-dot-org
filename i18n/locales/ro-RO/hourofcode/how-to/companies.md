---
title: Ghidul Hour of Code pentru companii
---

{{ signup_button }}

# Cum se poate implica compania ta în Hour of Code
...
- [Încurajează angajații să facă voluntariat la o clasă](#encourage-employees)
- [Pune compania ta în legătură cu o școală](#connect-with-a-school)
...
## Încurajează angajații să facă voluntariat la o clasă

[![](/images/fit-600/Marketing/pexels-andrea-piacquadio-3762940.jpg)]({{ urls/learn }})

Unul dintre cele mai satisfăcătoare moduri de a participa la Hour of Code este de a fi voluntar la o clasă, fie în persoană, fie virtual. Mai mult, nu trebuie să fii inginer pentru a te oferi voluntar. Poți oferi o experiență semnificativă studenților, împărtășind propria experiență profesională și modul în care ȘC sau tehnologia au influențat rolul pe care îl ai în companie.

[<button>Înscrie-te ca voluntar</button>]({{ urls/volunteer }})

După ce un voluntar se înregistrează, profesorul poate să examineze profilul acestuia pe [harta](https://code.org/volunteer/local) voluntarilor [](https://code.org/volunteer/local) - prin urmare profilurile trebuie să fie cât mai complete posibil. Dacă ești potrivit pentru clasa lor, profesorii te vor contacta prin intermediul platformei (nu vom comunica niciodată adresa ta de e-mail profesorului). Poți apoi să stabilești detaliile direct cu profesorul cu privire la [modul cel mai bun de a participa ca voluntar în clasa acestuia](https://hourofcode.com/us/how-to/volunteers).

Pentru mai multe sugestii privind voluntariatul și exemple de mesaje prin care poți să-ți determini compania să participe la Hour of Code, consultă [ghidul]({{ localized_files/hoc_corporate_toolkit }}) nostru [pentru partenerii corporativi]({{ localized_files/hoc_corporate_toolkit }}).

* * *

<a id="connect-with-a-school"></a>

## Pune compania ta în legătură cu o școală

Nu trebuie neapărat să folosește harta voluntarilor pentru a intra în legătură cu o clasă sau cu o școală. De multe ori recomandăm ca acest demers să înceapă la nivel local. Gândește-te la școli cu care tu sau angajații tăi aveți o legătură puternică, cum ar fi școala pe care ai absolvit-o, școala la care merge unul dintre copiii tăi sau o organizație sau școală ale cărei cursuri sunt urmate de membrii unei comunități sau grup de populație care, din punct de vedere istoric, a fost subreprezentată în domeniul științei calculatoarelor.

[![](/images/fit-600/Marketing/2018_HoC-392.jpg)]({{ urls/learn }})

Poți vizita site-ul web al școlii pentru a găsi persoanele de contact potrivite, cum ar fi directorul sau directorul adjunct, profesorii care predau materii în domeniul tehnologiei sau al științei calculatoarelor sau chiar Asociația părinților, profesorilor și elevilor din cadrul școlii. De asemenea, poți să te asociezi cu organizații precum Boys & Girls Clubs of America, o filială a YMCA și multe altele pentru a găzdui un eveniment.

Dacă nu reușești să iei legătura cu o școală, te rugăm să [ne contactezi](https://support.code.org/hc/en-us/requests/new) și te vom pune în legătură cu unul dintre partenerii noștri locali, dacă este posibil.
...
Atunci când te înscrii la evenimentul Hour of Code, vei primi comunicări utile prin email cu noutăți și sfaturi pentru organizarea unui eveniment Hour of Code de succes. Un aspect important este și modul în care poți anunța școlile din zona ta sau pe părinți că organizezi un eveniment în apropiere.

### 2. Postează pe rețelele de socializare

Popularizează mișcarea care promovează știința calculatoarelor cu ajutorul acestui model de conținut pe care îl poți publica pe rețelele de socializare și distribui angajaților tăi.
...
- Știai că doar în 45% dintre școlile din SUA se predă știința calculatoarelor? Oferă fiecărui elev șansa de a participa la #HourOfCode https://hourofcode.com/ 
...
<a href="https://hourofcode.com/promote/resources#posters">Află mai multe</a> despre postere, videoclipuri, autocolante și alte modalități de promovare a evenimentului în comunitate.
