...
Unul dintre cele mai satisfăcătoare moduri de a participa la Hour of Code este să vă oferiți voluntar într-o clasă locală, fie în persoană, fie virtual. Cel mai bun lucru de știut, nu trebuie să fiți inginer pentru a fi voluntar. Puteți oferi în continuare o experiență semnificativă elevilor, împărtășind propria experiență profesională și modul în care Informatica sau tehnologia au influențat rolul dumneavoastră.

[<button>Înscrie-te ca voluntar</button>]({{ urls/volunteer }})

Imediat după înregistrarea unui voluntar, profilul acestuia poate fi revizuit de un profesor pe hartanoastră[a voluntarilor](https://code.org/volunteer/local) - deci profilurile trebuie depuse cât mai complete posibil. Dacă sunteți potrivit pentru clasă, veți fi contactat de un profesor prin platformă (niciodată nu vom partaja adresa dv. de email cu profesorul). Apoi, puteți coordona detaliile direct cu profesorul [în legătură cu cel mai bun mod de a fi voluntar în clasă](https://hourofcode.com/us/how-to/volunteers).

Pentru mai multe îndrumări cu privire la voluntariat și exemple de mesaje pentru a vă entuziasma compania cu privire la Hour of Code, verificați ghidul [nostru pentru parteneri corporativi]({{ localized_files/hoc_corporate_toolkit }}).
...
Nu trebuie să utilizați harta noastră a voluntarilor pentru a vă conecta cu o clasă sau școală. Adeseori, recomandăm să începeți pe plan local. Luați în considerare dacă există școli cu care dumneavoastră sau angajații dumneavoastră au o legătură puternică, cum ar fi o alma mater, școala unui copil sau o organizație sau o școală care se concentrează pe deservirea unei populații care, din punct de vedere istoric, a fost subreprezentată în domeniul informaticii.

[![](/images/fit-600/Marketing/2018_HoC-392.jpg)]({{ urls/learn }})

De acolo, puteți vizita site-ul web al școlii pentru a găsi persoanele de contact adecvate cărora să vă adresați, cum ar fi administratorii, directorul sau directorul adjunct, instructorii de tehnologie sau de informatică, sau chiar asociația PTSA a școlii. De asemenea, puteți să deveniți partener cu organizații precum Cluburile de Băieți & Fete din America, o filială a YMCA, ba mai mult să fiți co-gazda unui eveniment.

Dacă nu vă puteți conecta cu o școală, vă rugăm să ne [contactați](https://support.code.org/hc/en-us/requests/new), iar noi vă vom face legătura cu unul dintre partenerii noștri locali dacă este posibil.
...
When you [sign up your Hour of Code event](/#join), you’ll receive helpful email communications with news and tips for hosting a successful Hour of Code. Un aspect important este și modul în care poți anunța școlile din zona ta sau pe părinți că organizezi un eveniment în apropiere.
