...
## Un proiect genial de 2000$ {#brilliant_project}
...
| ----------------------------- | ----------------- | ------------------------------- |
| Spencer gimnaziu              | Victoria          | Science Venture                 |
| Malcolm Tweddle School        | Edmonton          | DiscoverE                       |
| Britannia Elementary          | Vancouver         | GEERing Up                      |
| Captain John Palliser         | Calgary           | Mintea în mişcare               |
...
| Byron Northview Public School | Londra            | Descoperirea Western            |
| Stanley Public School         | Toronto           | Stiinta explorari               |
| Ottawa Catholic School Board  | Ottawa            | Virtual Ventures                |
| École Arc-en-Ciel             | Montreal          | Folie Technique                 |
| Musee Armand Frappier         | Laval             | Musee Armand Frappier           |
| Garden Creek School           | École Arc-en-Ciel | Worlds UNBound                  |
| Musee Armand Frappier         | Folie Technique   | Virtual Ventures                |
