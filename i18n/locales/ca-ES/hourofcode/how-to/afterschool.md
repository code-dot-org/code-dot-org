...
Oferim una gran varietat de [ divertits tutorials d'una hora](%= resolve_url('https://code.org/learn') %) per a participants de totes les edats. Prova'ls!
...
- Escrigui l'enllaç del tutorial a la pissarra. Trobi l'enllaç que apareix a la [ informació del tutorial ](%= resolve_url('https://code.org/learn') %) sota el nombre de participants.
...
- Animai els participants a provar una altra activitat de l'Hores del Codi a [hourofcode.com/learn](%= resolve_url('/learn') %)
