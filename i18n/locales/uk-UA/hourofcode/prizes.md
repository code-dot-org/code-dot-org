...
## Кожен організатор отримує подарунковий код {#gift_code}

Кожен вчитель, який організує захід Години коду для своїх учнів отримає 10 Гб простору на Dropbox або $10 кредиту в Skype в якості подяки!
...
## 100 класів отримають набори програмованих роботів {#programmable_robots}
