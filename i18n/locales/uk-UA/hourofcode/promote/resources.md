...
[Завантажити версії з високою роздільністю](https://images.code.org/share/hour-of-code-logo.zip)
...
Комп'ютери є скрізь, вони змінюють кожну галузь на планеті. But only 51% of all high schools teach computer science. Good news is, we’re on our way to change this! Якщо ви чули про Годину коду раніше, ви можете знати, що вона творить історію. Годину коду спробували понад 100 мільйонів учнів.
...
That’s why our entire school is joining in on the largest learning event in history: The Hour of Code, during Computer Science Education Week ({{ campaign_date/full }}). Понад 100 мільйонів учнів по всьому світу вже пробували Годину коду.
