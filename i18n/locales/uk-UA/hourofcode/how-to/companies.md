...
Найкраще Година коду проходить на підключених до Інтернету комп'ютерах. You **don’t** need a computer for every participant, and can even do the Hour of Code without a computer at all.
  ...
  * **Don't have enough devices?** Use [pair programming](https://www.youtube.com/watch?v=vgkahOzFH2Q). Have participants partner with each other. Таким чином вони дізнаються, що інформатика є соціальною та груповою діяльністю.
...
Година коду є лише першим кроком подорожі пізнання принципів роботи технологій та розробки власних програм. To continue this journey, [encourage your participants to learn online](%= resolve_url('https://code.org/learn/beyond') %).
