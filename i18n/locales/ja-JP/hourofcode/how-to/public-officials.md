...
See our [event how-to guide]({{ urls/how_to_events }}) for a sample run of show, [media outreach kit]({{ promote/press_kit_url }}), and other event-planning resources. イベントを開くのが関心を高めて、これからの参加者を増やす効果があります。
