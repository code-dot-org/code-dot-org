...
### どのようしたら、あなたや企業の従業員たちが生徒にひらめきを与えて、コンピューターサイエンスを試すようにできるか見てみましょう！

***

## 地域の教室とHour of Codeのボランティアとを繋げる
...
# 生徒たちとHour of Codeイベントを開催する方法

## 1. Promote your Hour of Code
- Promote your [Hour of Code]({{ urls/promote }}) event and encourage others to host.
- あなたの会社のソフトウェアエンジニアたちが地域の教室を訪問して、Hour of Codeイベントをリードし、生徒たちがコンピュータサイエンスを勉強する機運を高めましょう！ They can [sign up]({{ urls/volunteer_engineer }}) to be connected with a classroom.
...
**Hour of Codeのアクティビティを生徒たちに説明する際のアイデア**
...
- できればアクティビティページを先に開いておくか、お気に入りに入れておくことをお勧めします。

**参加者が困っていたら、以下のように声をかけてみてもいいかもしれません。**
...
- あなたの社員向けの[特製Tシャツを注文](http://blog.code.org/post/132608499493/hour-of-code-shirts-and-more)します。
