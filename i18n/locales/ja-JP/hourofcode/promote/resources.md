...
### Hour of Codeの活動に注目してもらうために必要なリソースをご覧ください。どこから始めたらよいのかわかりませんか？[ Hour of Codeを主催するためのハウツーガイド]({{ how_to_url }})をご覧ください！
...
マララ、スティーブン・カリー、シャキラなどを前面に出した新しいポスターセットができました！ 今年は、どのポスターセットにもポスター6枚と「私はHour of Codeを行いました」ステッカー126枚が入っています。 数量に限りがありますので、 [ポスターセットのご注文](https://smile.amazon.com/Code-Hour-Poster-Set-2018/dp/B07J6T18DH)はお早めにお願いします。 ご自身で印刷する場合は、下の画像をクリックして表示し、印刷可能な形式で保存してください。

{{ promote_new_posters }}

* 過去のポスターをお探しですか？[こちらをご覧ください]({{ promote/previous_posters_url }})！

<a id="social"></a>

## ソーシャル メディアに投稿する

[![画像](/images/social-media/fit-250/social-2.png)](/images/social-media/social-2.png)&nbsp;&nbsp;&nbsp;&nbsp; [![画像](/images/social-media/fit-250/social-3.png)](/images/social-media/social-3.png)&nbsp;&nbsp;&nbsp;&nbsp;

[![画像](/images/social-media/fit-250/malala_yousafzai.png)](/images/social-media/malala_yousafzai.png)&nbsp;&nbsp;&nbsp;&nbsp; [![画像](/images/social-media/fit-250/chris_bosh.png)](/images/social-media/chris_bosh.png)&nbsp;&nbsp;&nbsp;&nbsp;

[![画像](/images/social-media/fit-250/karlie_kloss.png)](/images/social-media/karlie_kloss.png)&nbsp;&nbsp;&nbsp;&nbsp; [![画像](/images/social-media/fit-250/satya_nadella.png)](/images/social-media/satya_nadella.png)&nbsp;&nbsp;&nbsp;&nbsp; [![画像](/images/social-media/fit-250/jeff_bezos.png)](/images/social-media/jeff_bezos.png)&nbsp;&nbsp;&nbsp;&nbsp;

<a id="logo"></a>

## Hour of Codeを広めるためにロゴを使う

[![画像]({{ hoc_logo_fit_200 }})]({{ hoc_logo }}) [![画像]({{ hdc_logo_fit_200 }})]({{ hdc_logo }})

[高解像度バージョンをダウンロード](https://images.code.org/share/hour-of-code-logo.zip)
...
<ul style="margin-top: 0px">
  <li>
    <strong>良い使用例</strong>: 「あなたの会社名.comのウェブサイトでHour of Code™に参加しましょう」
  </li>
  <li>
    <strong>良くない使用例</strong>:「あなたの会社名のHour of Codeをお試しください」
  </li>
</ul>
...
2. CSEdWeekと[Code.org]({{ codeorg_link }}) ウェブサイトへのリンクを自社ウェブサイトのページ（またはフッターとして）に貼る場合、以下の文言を記載してください。
...
### Hour of Codeを話題にする際の[情報や使える文言]({{ promote/stats_url }})をご覧ください。
...
**件名:** 私と1億人以上の生徒たちと一緒にHour of Codeに参加しませんか <br />
...
今年、皆様と一緒にこの運動をさらに盛り上げていきたいと考えています。 Hour of Code {{ campaign_date/year }}へのご参加をお願いします。 加えて、コンピューターサイエンス教育週間{{ campaign_date/full }}に当たり、Hour of Codeへご参加ください。

みんなに知らせましょう。イベントを開催しましょう。地元の学校に開催をお願いしましょう。もしくは、自分で Hour of Code を試しましょう。基礎を学ぶことでだれもが恩恵を受けられます。

http://hourofcode.com/{{ country_language }}から始めましょう。<br />
...
#### [学校でのボランティア活動の情報とリソースについてはこちらをお読みください]({{ how_to_volunteers_url }})。

**件名:** Hour of Codeを主催するあなたへの支援

{{ campaign_date/short }}の実施期間中、世界中で10％の生徒がそれぞれの学校でHour of Codeに参加してコンピューターサイエンス教育週間を祝います。 この記念週間は、すべての子どもが身の回りのテクノロジーの仕組みを知るよい機会となっています。 
...
イベントの詳細はhttp://hourofcode.comでご覧ください。また、[学校名] の参加方法について話し合うための日程は私たちにご連絡ください。<br />
...
しかしテクノロジーの**仕組み** を知っているのはごくわずかな人たちです。コンピューターサイエンスの授業を行っている高校は現状わずか51％です。

だからこそ学校全体が史上最大の学習イベントに参加しています。それがコンピューターサイエンス教育週間 ({{ campaign_date/full }})中のHour of Codeです。 既に、全世界で一億人以上の生徒がHour of Codeを試しました。 私たちHour of Codeは、[学校名]が21世紀の基本スキルを教える準備が整っていることを宣言しています。 生徒のプログラミング学習の機会提供を今後も続けていくため、私たちはHour of Codeイベントを拡大していきたいと考えています。 ボランティアや地元メディアに働きかけてソーシャルメディアチャンネルでニュースを共有したり、コミュニティでHour of Codeのイベント開催の検討をお勧めします。

これは[市町村名]の教育の未来を変える良い機会です。

詳細はhttp://hourofcode.com/{{ country_language }}をご覧ください。Hour of Codeの普及にご協力をお願いします。<br />
...
#### [メディアをイベントに招待するための詳細情報はプレスキットをご覧ください。]({{ promote/press_kit_url }})
...
#### [もっと情報が必要ですか？イベントに政治家を招待する方法をご覧ください。]({{ how_to_public_officials_url }})
...
だからこそ学校全体が史上最大の学習イベントに参加しています。それがコンピューターサイエンス教育週間 ({{ campaign_date/full }})中のHour of Codeです。 既に、全世界で一億人以上の生徒がHour of Codeを試しました。
