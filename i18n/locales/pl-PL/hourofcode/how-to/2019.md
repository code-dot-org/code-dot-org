...
### Zobacz nasz <a href="{{ localized_files/participation_guide }}"</a>przewodnik uczestnictwa, jeśli nadal masz pytania.
...
## 2. Przeglądaj Aktywności i Samouczki
...
- Nie masz wystarczają liczbę urządzeń? Wykorzystaj [programowanie w parach](https://www.youtube.com/watch?v=vgkahOzFH2Q). Gdy uczniowie dobierają się w pary, to pomagają sobie nawzajem i mniej potrzebują pomocy nauczyciela. Zobaczą także, że praca z komputerem jest działalnością zespołową i uspołeczniającą.
...
## 5. Rozpocznij swoją Godzinę Kodowania
...
W porządku, jeśli zarówno Ty, jak i Twoi uczniowie jesteście początkujący w informatyce. Kilka pomysłów na wprowadzenie aktywności związanych z Godziną Kodowania:
...
- Napisz link do samouczka na tablicy. Znajdź link wymieniony [w informacji dla wybranego przez Ciebie samouczka]({{ urls/learn }}) pod liczbą uczestników.
...
Informatyka nie musi kończyć się z Godziną Kodowania! Nasz program nauczania jest oparty na sieci i można z niego korzystać bez ograniczeń. [ Dowiedz się, jak ](/beyond) wprowadzić informatykę w Twojej szkole i przybliżyć ja uczniom.
