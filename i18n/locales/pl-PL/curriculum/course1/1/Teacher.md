...
<%= partial('curriculum_header', :title=> 'Happy Maps', :lesson=>1, :unplugged=>true, :disclaimer=>'Czas podstawowych lekcji obejmuje tylko aktywność. Propozycje wstępne i końcowe mogą zostać użyte aby sięgnąć głębiej gdy pozwoli na to czas.', :time=>20) %>
...
U podstaw wszystkich nauk informatycznych jest coś, co nazywa się algorytm. Słowo "algorytm" może się wydawać czymś skomplikowanym, ale tak naprawdę jest to po prostu lista instrukcji, które ktoś może wykonać, aby osiągnąć określony wynik. Aby zapewnić solidną podstawę dla Ciebie przy dalszej nauce informatyki, zamierzamy skupić się na budowaniu bezpiecznej relacji z algorytmami.
...
1) [Słownictwo](#Vocab)   
2) [Krok-po-Kroku](#GetStarted)

### **Aktywność: Wesołe Mapy** - 20 minut

3) [Wesołe Mapy: Jedno-Krokowa Przygoda](#Activity1)
