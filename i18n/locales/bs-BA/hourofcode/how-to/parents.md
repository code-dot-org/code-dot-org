...
# Kako kompletirati Čas Kodiranja sa Vaši dijetetom

Kompletiraj Čas Kodiranja kod kuće, ili volontiraj da ga dovedeš u učionicu svog dijeteta! Evo kako:
...
Mi pružamo raznovrsne vrste zabave, jednosatne tutorijale za učenike svi uzrasta, kreirane od strane mnogobrojni partnera[Isprobajte ih!](%= resolve_url('/learn') %)
...
The best Hour of Code experience will be with Internet-connected computers. Ali Vi **ne**trebate računar. Postoji mnogo aktivnosti koje su "isključene" i mogu se raditi bez ikakve tehnologije.

- Test tutorials on your computer or device. Make sure they work properly on browsers with sound and video.
- **Želite učiti pored svog dijeteta**Pokušajte[programiranje parova](http://www.ncwit.org/resources/pair-programming-box-power-collaborative-learning)Računarstvo je socijalno i kolaborativno.
