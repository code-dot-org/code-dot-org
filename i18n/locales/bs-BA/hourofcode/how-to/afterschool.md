...
- Potaknite učesnike da pokušaju drugu aktivnost Časa Kodiranja na [hourofcode.com/learn](%= resolve_url('/learn') %)
- Ili pitaj one koji završe ranije da pomognu onima koji imaju poteškoća.
