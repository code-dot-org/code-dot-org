...
ऑवर ऑफ़ कोड में भाग लेने के सबसे संतोषजनक तरीकों में से एक स्थानीय कक्षा के साथ वालंटियर करना है, ऐसा आप या तो व्यक्तिगत रूप से या वर्चुअल रूप से कर सकते हैं। सबसे अच्छी बात ये है कि इसमें वालंटियर बनने के लिए आपको इंजिनियर होने की जरुरत नहीं है। आप अभी भी अपने स्वयं के करियर के अनुभव और कंप्यूटर साइंस या तकनीक ने आपके रोल को कैसे प्रभावित किया है, शेयर करके छात्रों को एक सार्थक अनुभव प्रदान कर सकते हैं।

[<button>वालंटियर बनने के लिए साइन अप करें</button>]({{ urls/volunteer }})

एक बार जब एक वालंटियर रजिस्टर्ड हो जाता है, तो एक शिक्षक हमारे [वालंटियर मैप](https://code.org/volunteer/local) पर अपनी प्रोफ़ाइल की समीक्षा कर सकता है - इसलिए प्रोफ़ाइल को यथासंभव पूर्ण रूप से सबमिट किया जाना चाहिए। यदि आप उनकी कक्षा के लिए उपयुक्त हैं, तो एक शिक्षक मंच के माध्यम से आपसे संपर्क करेगा (हम शिक्षक के साथ आपका ईमेल पता कभी साझा नहीं करेंगे)। फिर आप शिक्षक के साथ सीधे [अपनी कक्षा के साथ सर्वश्रेष्ठ वालंटियर कैसे बनें](https://hourofcode.com/us/how-to/volunteers) के बारे में विवरण के बारे में चर्चा कर सकते हैं।

आपकी कंपनी को ऑवर ऑफ़ कोड के बारे में उत्साहित करने के लिए स्वैच्छिक सेवा और सैंपल मैसेज पर अधिक मार्गदर्शन के लिए, हमारी [कॉर्पोरेट भागीदारों के लिए गाइड]({{ localized_files/hoc_corporate_toolkit }}) देखें।
...
कक्षा या स्कूल से जुड़ने के लिए आपको हमारे वालंटियर मैप का इस्तेमाल करने की जरुरत नहीं है। अक्सर, हम स्थानीय रूप से शुरू करने की सलाह देते हैं। इस पर विचार करें कि क्या ऐसे स्कूल हैं जिनके साथ आपके या आपके कर्मचारियों के मजबूत संबंध हैं, जैसे कि एक अल्मा मेटर, एक बच्चे का स्कूल, या एक संगठन या स्कूल जो उस तरह के लोगों की सेवा करने पर केंद्रित है जिसे कंप्यूटर साइंस में ऐतिहासिक रूप से कम प्रतिनिधित्व दिया गया है।

[![](/images/fit-600/Marketing/2018_HoC-392.jpg)]({{ urls/learn }})

वहां से, आप प्रिंसिपल या वाईस प्रिंसिपल, तकनीक या कंप्यूटर साइंस प्रशिक्षकों, या यहां तक कि स्कूल के PTSA जैसे प्रशासकों तक पहुंचने के लिए और उपयुक्त संपर्कों को खोजने के लिए स्कूल की वेबसाइट पर भी जा सकते हैं। आप किसी कार्यक्रम को को-होस्ट करने के लिए बॉयज एंड गर्ल्स क्लब ऑफ अमेरिका जैसे संगठनों के साथ भी पार्टनरशिप कर सकते हैं, एक YMCA शाखा से, और बहुत सारे संगठनों से।

यदि आप किसी स्कूल से जुड़ने में असमर्थ हैं, तो कृपया [हमसे संपर्क करें](https://support.code.org/hc/en-us/requests/new) और यदि संभव होगा तो हम आपको हमारे स्थानीय भाईवालों से एक के साथ जोड़ देंगे। 
...
यदि आप और भी ज्यादा करना चाहते हैं, तो आपकी कंपनी ऑवर ऑफ़ कोड इवेंट की मेजबानी भी कर सकती है। किसी कार्यक्रम को होस्ट करने के लिए कोई खास फार्मूला नहीं है इसलिए हम आपको रचनात्मक होने के लिए प्रोत्साहित करते हैं! यह देखते हुए कि हमारे स्टाफ की संख्या भले ही छोटी हो (लेकिन शक्तिशाली है!), Code.org के पास ऑवर ऑफ कोड इवेंट्स के समन्वय के लिए समर्पित टीम नहीं है। हालांकि, शुरू करने के लिए यहां कुछ टिप्स दिए गए हैं।
...
<a id="promote-hour-of-code"></a>
    ...
    जब आप अपना ऑवर ऑफ़ कोड ईवेंट साइन-अप करते हैं, तो आपको एक सफल ऑवर ऑफ़ कोड को होस्ट करने के लिए समाचार और टिप्स के साथ उपयोगी ईमेल कम्युनिकेशन प्राप्त होंगे। यह भी है कि आप स्थानीय स्कूलों या छात्रों के माता-पिता को कैसे बता सकते हैं कि आप उनके आसपास एक कार्यक्रम को होस्ट कर रहे हैं।
