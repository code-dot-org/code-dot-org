...
- "मुझे यह देखकर अच्छा लगा कि बच्चे कितने उत्साहित हैं। One amazing thing was that the teachers noticed that some of the students who didn’t do as well academically were excelling at thinking like a developer and helping others learn - giving them a place to feel confident.”
...
| 5-10 minutes  | Introduce yourself and learn more about the students: </ul><li>What do you work, what do you do, and what do you love most about your job?</li><li>आपको किस चीज़ या किसने प्रेरित किया?</li><li>कंप्यूटर साइंस में आपकी रुचि कैसे हुई?</li><li>आपके पास कोई मेंटर था?</li><li>Share a story about how tech affects everyone.</li><br>छात्रों से प्रश्न पूछें और प्रश्नोत्तर के लिए समय निकालें।</br> <li> What jobs are they interested in, what are their favorite tech gadgets or apps, and how do they think they are built? </li><li> Do the students have any questions for you?</ul> |
...
- शिक्षक हमारे [वालंटियर मैप](https://code.org/volunteer/local) पर वालंटियर की खोज करेंगे।
- एक शिक्षक द्वारा आपको चुने जाने की संभावना को बढ़ाने के लिए अपनी प्रोफ़ाइल को यथासंभव पूरा करने का प्रयास करें।
...
## ऑवर ऑफ़ कोड के दौरान वालंटियर बनें - अक्सर पूछे जाने वाले प्रश्न
