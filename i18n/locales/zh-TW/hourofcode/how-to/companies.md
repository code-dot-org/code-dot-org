...
- [把你的公司和學校聯繫起來](#connect-with-a-school)
...
參與一小時玩程式最令人滿足的方式之一是在當地課堂上做志工，無論是面對面參與還是遠端參與。 最重要的是，成為志工不必是工程師。 你仍然可以通過分享你自己的職業經歷以及電腦科學或技術如何影響你的角色來為學生提供有意義的經驗。

[<button>註冊志工</button>]({{ urls/volunteer }})

一旦志工報名，老師可以在我們的[志工地圖](https://code.org/volunteer/local)上查看他們的個人資料 - 因此個人資料應該盡可能完整地提交。 如果你很適合他們的課堂，老師會通過平臺聯繫你（我們決不會將你的電子郵箱地址告訴老師）。 然後，你可以直接與老師協調細節，[如何最好地在他們的課堂上做志工](https://hourofcode.com/us/how-to/volunteers)。

想瞭解更多關於志工服務和示例消息的指導，讓你的公司對一小時玩程式感到興奮，請查看我們的[企業合作夥伴指南]({{ localized_files/hoc_corporate_toolkit }})。
...
你不必使用我們的志工地圖來聯繫課堂或學校。 通常，我們建議從本地開始。 考慮一下是否有與你或你的員工聯繫密切的學校，比如母校、孩子的學校或專注於為歷史上在電腦科學領域代表性不足的人群服務的組織或學校。

[![](/images/fit-600/Marketing/2018_HoC-392.jpg)]({{ urls/learn }})

在那裡，你可以訪問學校的網站以尋找合適的連絡人，如校長或副校長、技術或電腦科學講師，甚至學校的PTSA。 你也可以與一些組織合作來共同主辦活動，如美國男孩女孩俱樂部、基督教青年會分支等等。
...
如果你想走遠一點，你的公司也可以舉辦一小時玩程式活動。 舉辦活動沒有特定的模式，所以我們鼓勵你發揮創意！ 由於我們的員工規模小（但強大），Code.org沒有專門的團隊來協調一小時玩程式活動。 然而，這裡有一些如何開始的建議。
...
- 如果你有一群員工為你的活動提供服務或在當地學校做志願者，考慮為你的員工[定制T恤](http://blog.code.org/post/132608499493/hour-of-code-shirts-and-more)。
