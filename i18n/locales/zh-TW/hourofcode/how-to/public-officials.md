...
## 讓每個學校參予，每個學生學習！
  ...
  2. **Host an Hour of Code event.** See our [event how-to guide](%= resolve_url('/how-to/event') %) for a sample run of show, media outreach kit and other event-planning resources. 舉辦一個事件是一個偉大的方式來促進代碼小時，增加參與。
