...
### 參與活動，依下面步驟向學生們介紹第一個小時的計算機科學。 一小時玩程式活動的教程對初學者來說很容易上手！ If you'd like an extra set of hands to help out, you can find a [local volunteer]({{ urls/volunteer_local }}) to help run an Hour of Code in your class.
...
- 在黑板(白板)上寫下教案的連結網址。 Find the link listed on the [information for your selected tutorial]({{ urls/learn }}) under the number of participants.
