...
# Smernice za Uro za kodo in teden Programiranja
...
Code.org bo gostitelj večino dogodkov Ura za kodo, na straneh Code.org, Ura za kodo in CSEdWeek strani. Trenutna lista se nahaja na [<%= codeorg_url() %>](http://<%= codeorg_url() %>/learn).
