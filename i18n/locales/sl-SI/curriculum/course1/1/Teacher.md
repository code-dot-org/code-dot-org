...
title: Veseli zemljevidi view: page_curriculum theme: none

* * *

<%= partial('curriculum_header', :title=> 'Veseli zemljevidi', :lesson=>1, :unplugged=>true, :disclaimer=>'Čas za izvedbo vsebuje zgolj aktivnosti. Predloge v uvod in zaključeku lahko uporabite za poglobljene razlage, v kolikor imate čas.', :time=>20) %>
