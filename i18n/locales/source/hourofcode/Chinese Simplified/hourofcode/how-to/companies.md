...
对组织者来说，**所有的编程一小时活动**都不需要额外再做其他准备，可以让参与者依照他们自己的进度和技术水平自我学习。

[![](/images/fit-700/tutorials.png)]({{ urls/learn }})

## 4. 您所需的教学设备——电脑不是必需的

要获得编程一小时活动的最佳体验，需要一台联网的电脑。 但您**并不**需要给每一个参与者提供电脑，您甚至可以在没有电脑的情况下开展编程一小时课程活动。

**提前计划！**在您的活动开始之前，请做以下准备︰

- 在电脑或设备上进行活动测试。确保课程能够在浏览器里正常播放，这包括视频和声音两个方面。
...
- **网速不够？**可以安排在活动开始时播放视频，这样参与者就不必自行下载视频。当然，您也可以尝试不用电脑的线下教程。
