...
- Technical requirements:
	...
	- Upon finishing your activity, users should be directed to [http://code.org/api/hour/finish](http://code.org/api/hour/finish)  where they will be able to:
		- Share on social media that they completed the Hour of Code
		- Receive a certificate that they completed the Hour of Code
		- See leaderboards about which countries/cities have the highest participation rates in Hour of Code activities
		- For users who spend an hour on your activity and don’t complete it, please include a button on your activity that says “I’m finished with my Hour of Code” which links back to [http://code.org/api/hour/finish](http://code.org/api/hour/finish) as well. 
