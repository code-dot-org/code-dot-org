...
Code.org will host a variety of Hour of Code™ activities on the Code.org, Hour of Code, and CSEdWeek  website(s). The current list is at <a href="<%= resolve_url('https://code.org/learn') %>"><%= resolve_url('https://code.org/learn') %></a>.
...
- Technical requirements:
	...
	- Upon finishing your activity, users should be directed to <a href="<%= resolve_url('http://code.org/api/hour/finish') %>"></a> <%= resolve_url('http://code.org/api/hour/finish') %> where they will be able to:
		- Share on social media that they completed the Hour of Code
		- Receive a certificate that they completed the Hour of Code
		- See leaderboards about which countries/cities have the highest participation rates in Hour of Code activities
		- For users who spend an hour on your activity and don’t complete it, please include a button on your activity that says “I’m finished with my Hour of Code” which links back to <a href="<%= resolve_url('http://code.org/api/hour/finish') %>"></a> <%= resolve_url('http://code.org/api/hour/finish') %> as well. 
...
Ex: [http://www.tynker.com/hour-of-code](http://www.tynker.com/hour-of-code)
