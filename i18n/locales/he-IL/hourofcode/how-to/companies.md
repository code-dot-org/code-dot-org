...
- שתפו תמונות וסרטונים של אירוע שעת הקוד שלכם ברשתות החברתיות. Use [#HourOfCode](https://twitter.com/hashtag/hourofcode) and [@codeorg](https://twitter.com/codeorg) so we can highlight your success, too!
