...
## את כל בית הספר המשתתף, כל תלמיד לומד!
  ...
  2. **Provide a sample logistics plan for schools.** Share this [sample logistics plan](%= localized_file('/files/HOC_Logistics_plan.pdf') %) with schools to give them ideas of how to organize whole school participation. זה קל כמו שעושה את זה בכל שיעור מתמטיקה, או בכל ימות השבוע במחשב מעבדה.
