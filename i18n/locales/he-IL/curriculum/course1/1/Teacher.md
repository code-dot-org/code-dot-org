...
## סקירה כללית של השיעור

בבסיס כל תכנית במדעי המחשב נמצא ה"אלגוריתם". המילה "אלגוריתם" אולי נשמעת כמו משהו מסובך, אבל זהו בסך הכל רשימה של הוראות שמישהו יכול לבצע כדי להשיג תוצאה כלשהי. כדי לספק בסיס מוצק להמשך לימוד מדעי המחשב בקרב התלמידים, נוכל להתמקד בבניית קשר לא מאיים עם מושג האלגוריתמים.

[summary]

## תקציר השיעור

### **תחילת השיעור** - 10 דקות

1) [אוצר מילים](#Vocab)   
2) [צעד אחר צעד](#GetStarted)
