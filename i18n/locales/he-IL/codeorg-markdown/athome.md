...
* [תכנות בתחום אסטרונומיה](https://quorumlanguage.com/hourofcode/astro1.html) - למדו אסטרונומיה על ידי שימוש ב"קוורום", שפת תכנות הנגישה ללומדים עיוורים או לקויי ראייה.
...
<p>App Lab היא סביבת תכנות שבה אפשר ליצור אפליקציות פשוטות. עצבו אפליקציה, תכנתו בג'אווה סקריפט בעזרת בלוקים או טקסט, ושתפו את יצירתכם עם המשפחה והחברים.</p>
