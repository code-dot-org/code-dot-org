...
## Alle arrangører får en gave som tak

Alle undervisere som arrangerer en Hour of Code for elever modtager 10 GB Dropbox lagerplads eller $10 Skype-kredit som tak for indsatsen!

<% if @country == 'uk' %>

## Heldige klasser vinder en videochat med en gæstetaler!

20 heldige klasser vil blive inviteret til at deltage i en videochat for at fejre Hour of Code i perioden fra 8. til 14. december. Eleverne vil få mulighed for at stille spørgsmål og tale med ledere fra it-industrien. [Se sidste års videochats](http://www.youtube.com/playlist?list=PLzdnOPI1iJNckJ81gRpJe5mR7imAHDl9a) med Bill Gates, Twitter-grundlægger Jack Dorsey, Susan Wojcicki fra Google og Gabe Newell fra Valve.
...
Alle klasser (offentlige og private) fra USA eller Canada kan vinde denne præmie. Hele skolen behøver ikke at deltage.
...
## 51 heldige skoler vinder et klasesæt af bærbare computere (eller for $10.000 andet it-udstyr)

One lucky school in ***every*** U.S. state (+ Washington D.C.) will win $10,000 worth of technology. Organize the Hour of Code for every student in your school to qualify. Fill out the form below to apply.

## Hardware-præmie - ansøgningsformular:
