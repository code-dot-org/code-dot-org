...
title: Præmier layout: wide <% if @country == 'us' || @country == 'ca' %>nav: prizes_nav<% end %>
...
## En skoleklasse fra USA eller Canada vil vinde en tur til Washington og deltager i en historisk og tophemmelig Hour of Code! {#dc}

Code.org udvælger en heldig klasse til at deltage i en helt speciel Hour of Code-begivenhed i den amerikanske hovedstad - så speciel at ingen detaljer er afsløret endnu! Den vindende skoleklasse (med tilknyttede lærere) kan nyde en tur til Washington med alle udgifter betalt. Mandag d. 8. december vil eleverne hele dagen deltage i tophemmelige aktiviter.
...
<h2 id="hardware_prize" style="font-size: 18px">
  51 amerikanske skoler vinder hver et klassesæt af bærbare computere (eller for 10000$ anden teknologi).
</h2>

En heldig skole i ***alle*** amerikanske stater (+ Washington D.C.) vandt for $10.000 teknologi. [**Se alle 51 vindere**](http://codeorg.tumblr.com/post/104109522378/prize-winners)

<% end %>

<% if @country == 'uk' %>

## Heldige skoleklasser vil vinde en video-chat med en kendt gæste-taler! {#video_chat}

20 heldige klasser vil blive inviteret til at deltage i en videochat for at fejre Hour of Code i ugen fra 8.-14. december. Dine elever kan stille spørgsmål og chatte med tech-industriens ledere. **Tilmeldingsfristen er udløbet. Vinderne vil snart blive offentliggjort.**

<% end %>

<% if @country == 'us' || @country == 'ca' %>

## Tilmeldingsfristen er udløbet. Vinderne vil blive offentliggjort snart. {#video_chat}
...
### Dette års kendte videochat-deltagere:

<%= view :video_chat_speakers %>

<% end %>

## Alle arrangører får en gave som tak {#gift_code}
...
## 100 klasseværelser vil vinde et sæt af programmerbare robotter {#programmable_robots}
