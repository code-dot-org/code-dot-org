...
Երբ [գրանցվեք ձեր Hour of Code միջոցառումը](/#join), դուք կստանաք օգտակար էլփոստի հաղորդակցություն նորություններով և խորհուրդներով ՝ հաջող օրենսգրքի ժամ հյուրընկալելու համար: It’s also how you can let local schools or parents know that you’re hosting an event near them.
