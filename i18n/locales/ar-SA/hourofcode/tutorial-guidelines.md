...
*   [كيفية التقديم (آخر موعد 01/10/2014)][4]
*   [اقتراحات لتصميم النشاط الخاص بك][5]
*   [المبادئ التوجيهية للعلامة التجارية][6]
*   [تتبع البكسل][7]
*   [التعريف بانشطتك، اسبوع تعليم الحاسوب، و ساعة البرمجة][8]
*   [ملاحظة خاصة للطلاب ذوي الاحتياجات الخاصة][9]
...
قم بزيارة [صفحة "ساعة البرمجة"][11] واتبع الخطوات لتقديم النشاط الخاص بك.
...
*   إذا قمت بتقديم النشاط على إنترنت، نحن بحاجة إلى معرفة ما إذا كان هو [COPPA متوافقة مع نظام حماية الاحداث ][12] أو لا.
