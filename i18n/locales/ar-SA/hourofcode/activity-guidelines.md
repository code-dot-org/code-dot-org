...
<a id="submit"></a>
    ...
    * وصف النشاط (الحد الأقصى لعدد الحروف: 400 حرف) 
        * في الوصف، يُرجى تضمين ما إذا كان النشاط موجهًا بشكل أساسي من الطلاب أو موجهًا من قِبل المعلم. بالإضافة إلى ذلك، تهتم بعض المدارس بمعرفة ما إذا كانت أنشطة "ساعة من البرمجة" تتناول المعايير الأساسية أو معايير العلوم للجيل القادم. وإذا كان النشاط يتناول معايير محددة، فكِّر في تضمين هذه المعلومات.
    * مستوى (مستويات) الصف الموصى به للمستخدمين المستهدفين. يمكنك الرجوع إلى \[معايير رابطة معلمي علوم الحاسوب لرياض الأطفال-الصف 12\] (https://k12cs.org/framework-statements-by-grade-band/) لمعرفة مفاهيم علوم الحاسوب المناسبة للصف. تتضمن مستويات الصف: 
        * رياض الأطفال - المستوى 1 (4-6 سنوات)
        * الصفوف 2-5 (7-10 سنوات)
        * الصفوف 6-8 (11-13 سنة)
        * الصف 9 فما فوق (14 سنة وما فوق)
    * قائمة بالمجالات التي يغطيها نشاطك (بالإضافة إلى علوم الحاسوب). على سبيل المثال، إذا كان بإمكان مدرس الرياضيات استخدام نشاطك لتدريس الزوايا أو القطع المكافئ، فقم بإدراج مادة الرياضيات. إذا كان لديك نشاط عن الارتجال العفوي يعلِّم الطلاب الأفعال والأسماء وغير ذلك، اختر مادة فنون اللغة.
    ...
    * ما هو مستوى الخبرة التي يجب على المعلم استخدامها لنشاطك؟ (على سبيل المثال، مبتدئ أو لديه خلفية بسيطة). وما مستوى الخبرة التي يجب أن يتمتع بها الطلاب؟ إذا كنت ترغب في إعداد أنشطة ساعة من البرمجة™ الأكثر تقدمًا، يرجى تضمين المعلومات المسبقة المطلوبة في وصف نشاطك.
    * مدة نشاطك 
        * ساعة واحدة
        * ساعة واحدة مع دورة متابعة
        * 2 - 6 ساعات (يمكن أن تكون دروسًا متعددة)
    * قائمة بأماكن تسهيلات ذوي الاحتياجات الخاصة، إذا كان نشاطك يحتوي عليها. يتضمن ذلك التوافق مع قارئ الشاشة، وإمكانيات تحويل النص إلى كلام، واستخدام الألوان عالية التباين، أو أي تسهيلات أخرى مخصصة للمتعلمين ذوي الإعاقة.
...
<a id="inclusion"></a>
    ...
    ستقوم لجنة متنوعة من معلمي علوم الحاسوب بترتيب عمليات الإرسال بناءً على المعايير النوعية والكمية. سيتم إدراج جميع الأنشطة التي تتوافق مع المعايير الأساسية. كما سيتمكن المعلمون من التصفية والفرز للعثور على أفضل الأنشطة لفصولهم الدراسية.
    ...
    بالنسبة للأنشطة الموجهة ذاتيًا للمعلمين والطلاب الجدد، ستبحث لجنة المراجعة عما إذا كان:
...
<a id="tm"></a>
    ...
    **أدرج التعليقات والملاحظات في نهاية النشاط.** (على سبيل المثال، "لقد أنهيت 10 مستويات وتعرفت على الحلقات البرمجية! أحسنت!") لا نريد منع هذا الاستخدام، ولكننا نريد التأكد من أن الاستخدام يقع ضمن حدود قليلة:
    
    1. استخدم «ساعة البرمجة» فقط فيما يتعلق بأنشطة CS Education غير التجارية في سياق حملة «ساعة البرمجة»، وليس لأي غرض آخر.
    2. يجب استخدام أي إشارة إلى "ساعة من البرمجة" بطريقة لا توحي بأنها اسم علامتك التجارية الخاصة، ولكنها تشير بدلًا من ذلك إلى "ساعة من البرمجة" باعتبارها مبادرة مجتمعية. مثال جيد: «شارك في ساعة البرمجة® على Acmecorp.com». مثال سيئ: "جرِّب أنشطة ساعة من البرمجة المقدَّمة من شركة ACME Corp".
    3. استخدم الحرف العلوي «®» في أبرز الأماكن التي ذكرت فيها «ساعة البرمجة»، سواء على موقع الويب الخاص بك أو في أوصاف التطبيق.
    4. قم بتضمين اللغة على الصفحة (أو في التذييل)، بما في ذلك الروابط إلى مواقع الويب الخاصة بـ «ساعة البرمجة» و CSedWeek و Code.org، والتي تكشف عن كل ما يلي: أ. تُعد ساعة البرمجة® وهورا ديل كوديجو® علامتين تجاريتين مسجلتين لشركة Code.org؛ و b. “The '[Hour of Code](http://hourofcode.com/) ® is a nationwide initiative by [Code.org](http://code.org/) to introduce millions of students to one hour of computer science and computer programming.”
    5. لا تستخدم «ساعة البرمجة» في أسماء التطبيقات.
    6. لا تستخدم «ساعة البرمجة» فيما يتعلق بأي استخدام أو غرض تجاري (على سبيل المثال، وضع نشاط «ساعة البرمجة» الخاص بك خلف جدار حماية؛ الترويج لخدمة مدفوعة أخرى كجزء من نشاط «ساعة البرمجة» الخاص بك؛ بيع سلع «ساعة البرمجة»).
    7. لا تستخدم «ساعة البرمجة» فيما يتعلق بأي نشاط يتطلب تسجيل الدخول أو إنشاء حساب.
...
<a id="promote"></a>
    ...
    سيتيح لنا ذلك إحصاء المستخدمين الذين يقومون بالبرنامج التعليمي لساعة البرمجة. وسيؤدي إلى إحصاء أكثر دقة للمشاركة في البرنامج التعليمي الخاص بك. من المرجح أن يتفاعل المستخدمون مع رسالة بريدية منك بشأن نشاطك. استخدم حملة "ساعة من البرمجة" الدولية خلال الأسبوع العالمي للبرمجة وعلوم الحاسوب كوسيلة لتشجيع المستخدمين على دعوة الآخرين للانضمام، ومساعدتنا في الوصول إلى المزيد من الطلاب!
