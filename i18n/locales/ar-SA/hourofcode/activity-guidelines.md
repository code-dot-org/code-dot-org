...
<a id="submit"></a>
    ...
    * هل يشمل هذا النشاط الذكاء الاصطناعي: نعم أم لا
    ...
    * قائمة لغات البرمجة التي يعلِّمها نشاطك. مثل، C/C++، وJava، وJavaScript، وغير ذلك، أو لغة مستقلة (لخطط الدرس التي يمكن تدريسها بلغات متعددة) اختر مادة فنون اللغة.
    * قائمة اللغات الطبيعية المعتمدة. ملاحظة: تقع مسؤولية كشف اللغة على عاتق مزود النشاط، ونحن سنعيد توجيه جميع المستخدمين إلى العنوان الإلكتروني المقدَّم. أو لغة مستقلة (لخطط الدرس التي يمكن تدريسها بلغات متعددة)
...
<a id="inclusion"></a>
    ...
    بالنسبة لأنشطة الترميز التقليدية، ستقوم لجنة متنوعة من معلمي علوم الكمبيوتر بترتيب الطلبات بناءً على معايير نوعية وكمية. سيتم إدراج جميع الأنشطة التي تتوافق مع المعايير الأساسية. كما سيتمكن المعلمون من التصفية والفرز للعثور على أفضل الأنشطة لفصولهم الدراسية.
...
<a id="design"></a>
    ...
    لا يجب أن تتضمن الأنشطة الذكاء الاصطناعي، على الرغم من أننا نتطلع إلى تقديم المزيد من الأنشطة المتعلقة بالذكاء الاصطناعي.
...
<a id="tm"></a>
    ...
    تُعد «أور أوف كود» و «هورا ديل كوديس» علامتين تجاريتين مسجلتين لشركة Code.org. استخدم العديد من شركائنا في البرنامج التعليمي علاماتنا التجارية «Hour of Code» على مواقع الويب الخاصة بهم فيما يتعلق بأنشطة Hour of Code الخاصة بهم. لا نريد منع هذا الاستخدام، ولكننا نريد التأكد من أن الاستخدام يقع ضمن حدود قليلة:
    ...
    4. قم بتضمين اللغة على الصفحة (أو في التذييل)، بما في ذلك الروابط إلى مواقع الويب الخاصة بـ «ساعة البرمجة» و CSedWeek و Code.org، والتي تكشف عن كل ما يلي: أ. تُعد ساعة البرمجة® وهورا ديل كوديجو® علامتين تجاريتين مسجلتين لشركة Code.org؛ و b. «إن '[Hour of Code](http://hourofcode.com/) ® هي مبادرة وطنية من قبل [Code.org](http://code.org/) لتعريف ملايين الطلاب بساعة واحدة من علوم الكمبيوتر وبرمجة الكمبيوتر.»
...
<a id="pixel"></a>
    ...
    إذا تمت الموافقة على البرنامج التعليمي الخاص بك وتم تضمينه في صفحة البرنامج التعليمي النهائية، فستوفر لك منظمة Code.org برنامج تتبع فريد لتتمكن من الاندماج في البرنامج التعليمي الخاص بك. انظر المثال أدناه. لا تقم بتضمين أي صفحات مؤقتة من البرنامج التعليمي الخاص بك.
