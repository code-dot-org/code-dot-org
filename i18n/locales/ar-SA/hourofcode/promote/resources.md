...
أجهزة الحاسوب في كل مكان، تعمل على تغيير جميع أنواع الصناعات على كوكب الأرض. But only 47% of all high schools teach computer science. الخبر السار هو أننا في طريقنا لتغيير هذا! إذا سمعت عن "ساعة البرمجة" من قبل، فقد تعرف أنها صنعت التاريخ. لقد جرَّب أكثر من 100 مليون طالب أنشطة "ساعة البرمجة".
