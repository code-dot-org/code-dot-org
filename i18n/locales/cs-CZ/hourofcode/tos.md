...
### Závazným jazykem je angličtina a můžete ji naleznout [zde](https://code.org/tos). Níže je překlad.

# Podmínky služby

Poslední revize: 5. prosince 2014

Code.org je registrovaná nezisková organizace (dále jen "Code.org"). Naším cílem je dát každému žákovi možnost naučit se programovat. Jako část své mise provozuje Code.org web <http://code.org>, <http://csedweek.org>, <http://computinginthecore.org>, <http://hourofcode.com>, další weby, informace, text, vzdělávací programy, videa, grafiku, fotografie, API, emailová upozornění a další materiály a související produkty a služby (“**Služby**”), zahrnující vzdělávací platformu na <http://studio.code.org> (“**Code Studio**”).

Pozorně si přečtěte tyto podmínky služby ("**Podmínky**") před vstupem nebo použitím Služeb. Přistupováním nebo používáním jakékoli části Služeb nebo kliknutím na "Souhlasím" nebo "Registrovat se" souhlasíte s těmito Podmínkami bez výhrad.

Tyto podmínky jsou právní smlouvu mezi vámi a Code.org, která se týká vašeho používání služby. Služby můžete použít pouze v případě, že můžete vytvořit závaznou smlouvu s Code.org a nejste osobou, vyloučenou z poskytování Služeb podle zákonů USA nebo jiné jurisdikce. Pokud přijímáte tyto Podmínky a používáte služby jménem společnosti, organizace, vlády nebo jiné právnické osoby, prohlašujete a zaručujete, že máte oprávnění tak činit. Služby můžete používat pouze v souladu s těmito Podmínkami a všemi platnými místními, státními, národními a mezinárodními zákony, pravidly a předpisy.

Tyto podmínky se mohou změnit. Souhlasíte s tím, že jste zavázán takovými změnami, pokud budete i nadále používat služby po změně těchto Podmínek, takže je kontrolujte pro změny pravidelně.

## Další pravidla a podmínky

Některé služby mohou být předmětem dalších pokynů, pravidel nebo podmínek služby ("**Dodatečné podmínky**") a využívání těchto Služeb bude záviset na vašem souhlasu s Dodatečnými podmínkami. Pokud bude existovat konflikt mezi těmito Podmínkami a Dodatečnými podmínkami, budou pro tuto Službu sloužit Dodatečné podmínky, pokud Dodatečné podmínky výslovně neuvedou, že poslouží tyto Podmínky.

### Děti mladší 13 let

Podnikáme kroky k minimalizaci sběru osobních údajů od Uživatelů do věku 13 let, jak je vysvětleno v [zásadách ochrany osobních údajů](http://code.org/privacy) Code.org. Pokud je vám méně jak 13 let, doporučujeme získat souhlas rodiče nebo zákonného zástupce před vytvořením účtu na Code.org. Code.org umožňuje určitým zástupcům školních obvodů a škol, jako učitelům, správcům, poradcům a dalším školitelům ("**Školitel**"), propojit se se studenty prostřednictvím Služeb s cílem poskytnout lekci, vzdělávací a podobné služby. Pokud jste Školitel, můžete registrovat účty ve Službách pro jednoho a více vašich studentů.

Pokud jste Školitel a zaregistrujete účet pro studenta, který je mladší 13 let ("**Dítě**"), prohlašujete a zaručujete, že vy nebo vzdělávací organizace, pro kterou pracujete, má řádné oprávnění k registraci Dítěte pro vzdělávací služby, jako je Code.org, které shromažďuje některé osobní údaje Dítěte pro využití a prospěch školy a ne pro jiné komerční účely. Dále souhlasíte, že jste zavázán/a těmito Podmínkami prostřednictvím vzdělávací organizace, pro kterou pracujete.

### Váš účet

Pokud vytvoříte účet pro Služby, jste zodpovědní za jeho bezpečnost a za bezpečí jeho hesla. Pokud používáte účet přidělený Školitelem, váš Školitel je schopen k němu získat přístup a váš účet zakázat.

Code.org vám může povolit zaregistrovat účet pro Služby prostřednictvím určitých sociálních sítí třetích stran, jako je Facebook Connect a Google ("**Služba ověřování**"). Registrací ke Službám pomocí Služby ověřování, souhlasíte s tím, že Code.org může přistoupit k informacím o účtu, které jsou získány ze Služby ověřování a souhlasíte s veškerými podmínkami používání Služby ověřování týkající se vašeho používání Služeb prostřednictvím Služby ověřování. Nesete výhradní odpovědnost za vaše interakce se Službou ověřování.

### Soukromí

Vaše soukromí je pro nás důležité. [Zásady ochrany osobních údajů](http://code.org/privacy) Code.org vysvětlují, jak nakládáme s vašimi osobními údaji a jak jsou začleněny do těchto Podmínek pomocí odkazů. Pro informace vztahující se ke shromažďování, používaní a předávání vašich osobních údajů si prosím pečlivě přečtěte Zásady ochrany osobních údajů Code.org.

Pokud jste studentem, který využívá účet zaregistrovaný školitelem nebo jiným způsobem s ním propojený, souhlasíte, že Code.org může předat vaše informace Školitelům příslušným k vašemu účtu. Pokud jste Školitelem, souhlasíte, že nebudete sdílet informace o studentech, které obdržíte od Code.org, s kýmkoliv jiným, než autorizovanými agenty třídy, školní oblasti nebo jiného vzdělávacího zařízení, které reprezentujete.

### Obsah generovaný uživateli - management; udělení licence; prohlášení a záruky

Code.org může nyní nebo v budoucnu umožňovat vám a jiným uživatelům nahrávat do Služeb počítačový kód (včetně zdrojového i objektového kódu), informace, text, grafiku, poznámky, otázky, komentáře, hodnocení, recenze, obrázky a videa nebo jiné formy komunikace (dohromady "**Uživatelský obsah**"). Berete na vědomí, že pokud je takový Uživatelský obsah publikovaný či nikoliv, Code.org nezaručuje důvěrnost.

Code.org nemá žádnou povinnost sledovat Uživatelský obsah nebo jiné materiály. Jste zodpovědní za zhodnocení přesnosti, úplnosti a spolehlivosti veškerého Uživatelského obsahu a nesete všechna rizika vyplývající z používání takového Uživatelského obsahu. Code.org nebude zodpovědný za jakékoliv škody, které mohou vzniknout v důsledku umístění nebo použití Uživatelského obsahu.

Code.org může, ale není povinný, monitorovat nebo kontrolovat Služby, kde uživatelé komunikují výhradně mezi sebou, včetně, ale nejen, chatovacích místností, živého chatu, vývěsky nebo jiných uživatelských fór a obsahu těchto sdělení. Podstupujete riziko, které taková komunikace přináší a Code.org nemá žádnou odpovědnost vztahující se k obsahu nebo používání této komunikace.

Uživatelé mohou v Uživatelském obsahu zahrnovat odkazy na webové stránky třetích stran, pokud obsah takových webových stránek neporušuje tyto Podmínky. Kliknutím na takové odkazy je na vaše vlastní riziko. Code.org není zodpovědné za dostupnost nebo obsah odkazovaných stránek, včetně reklamy, produktů nebo jiných materiálů o nich.

Nahráním nebo šířením Uživatelského obsahu napříč Službami, nebo přímo zaměstnancům Code.org, udělujete Code.org celosvětové, nevýhradní, přenosné, přiřaditelné, plně zpoplatněné, bez poplatkové, trvalé a neodvolatelné právo a licenci hostovat, převádět, zobrazovat, ukazovat, reprodukovat, upravovat, distribuovat a znovu šířit, přizpůsobovat, připravovat odvozená díla, použít, vytvořit, importovat a jinak využívat Uživatelský obsah s veškerými právy duševního vlastnictví v celku nebo částečně, v jakémkoliv formátu a prostřednictvím jakéhokoliv mediálního kanálu (nyní známého nebo později vyvinutého).

Navíc odesláním nebo šířením Uživatelského obsahu napříč službami udělujete každému uživateli Služeb nevýhradní licenci přistupovat a používat Uživatelský obsah.

### Prohlášení o uživatelském obsahu a zárukách

Nesete výhradní odpovědnost za Uživatelský obsah, který předáváte Službě a důsledky jeho předání a zveřejnění. By uploading, submitting, creating, or publishing your User Content to or through the Services, you represent, and warrant that: (1) you are the creator and owner of your User Content and that you have the authority to use or have the necessary licenses, rights, consents, and permissions to publish the User Content you submit; (2) your User Content does not and will not: (a) infringe, violate, or misappropriate any third-party right, including any copyright, trademark, patent, trade secret, moral right, privacy right, right of publicity, or any other intellectual property or proprietary right or (b) slander, defame, libel, or invade the right of privacy, publicity or other property rights of any other person; (3) your User Content does not contain any viruses, adware, spyware, worms, or other malicious code.

### Omezení obsahu a využívání Služeb

Vyhrazujeme si právo po celou dobu (ale nebude mít povinnost) odstranit nebo odmítnout distribuovat jakýkoliv Uživatelský obsah na Stránkách a pozastavit nebo ukončit uživatele, bez odpovědnosti k vám. We also reserve the right to access, read, preserve, and disclose any information as we reasonably believe is necessary to (i) satisfy any applicable law, regulation, legal process or governmental request, (ii) enforce the Terms, including investigation of potential violations hereof, (iii) detect, prevent, or otherwise address fraud, security or technical issues, (iv) respond to user support requests, or (v) protect the rights, property or safety of Code.org, its users and the public.
...
### Vaše licence k používání Code.org videí, návodů, dat a API
...
Code.org respektuje práva duševního vlastnictví a očekává od uživatelů služeb, aby učinili totéž. Budeme reagovat na oznámení o údajném porušení autorských práv v souladu s platnými právními předpisy a která jsou nám řádně předána. If you believe that your work has been copied in a way that constitutes copyright infringement, please provide us with the following information: (i) a physical or electronic signature of the copyright owner or a person authorized to act on their behalf; (ii) identification of the copyrighted work claimed to have been infringed; (iii) identification of the material that is claimed to be infringing or to be the subject of infringing activity and that is to be removed or access to which is to be disabled, and information reasonably sufficient to permit us to locate the material; (iv) your contact information, including your address, telephone number, and an email address; (v) a statement by you that you have a good faith belief that use of the material in the manner complained of is not authorized by the copyright owner, its agent, or the law; and (vi) a statement that the information in the notification is accurate, and, under penalty of perjury, that you are authorized to act on behalf of the copyright owner.

### Digital Millennium Copyright Act

Politikou Code.org je reagovat na oznámení o údajném porušení autorských práv v souladu s Digital Millennium Copyright Act.

Vyhrazujeme si právo odstranit obsah, který je údajně porušující, bez předchozího upozornění, podle našeho uvážení a bez odpovědnosti k vám. Za vhodných okolností Code.org bude také ukončen účet uživatele, pokud je shledán opakovaným delikventem. Chcete-li nahlásit porušení autorských práv, prosím kontaktujte nás. Náš copyright agent pro oznámení o porušení autorských může být zastižen na e-mailu copyright@code.org.

### Code.org duševní vlastnictví a Vaše licence pro Používání služby

Veškeré právo, titul a zájmy vůči Službám (mimo obsahu poskytnutého uživateli) jsou a zůstanou výhradním vlastnictvím Code.org a jeho poskytovatelů licencí. Služby jsou chráněny autorským právem, ochrannými známkami, trade dress, patenty a jinými zákony Spojených států. Obsah, informace, data, vzory, kód a materiály spojené se Službami ("**Obsah**") jsou chráněny duševním vlastnictvím a dalšími zákony. Musíte činit v souladu s těmito zákony a příslušnými autorskými právy, ochrannou známkou a jinými právními upozorněními či omezeními. Tyto podmínky vám nedávají právo používat název Code.org nebo některé z ochranných známek Code.org, log, domén a jiných charakteristických prvků značky. Jakákoliv zpětná vazba, komentáře nebo návrhy, které poskytnete vůči Code.org nebo Službám, jsou čistě dobrovolné a budeme je využívat volně, jak uznáme za vhodné a bez povinnosti.

Podle těchto podmínek můžete přistupovat a využívat Služby pouze pro osobní, nekomerční využití. We reserve all other rights to the Services and Content, and otherwise you may not copy, reproduce, distribute, publish, display, perform, or create derivative works of the Services or Content without our permission, except with respect to Code.org’s library of videos, curriculum, tutorials, and API as set forth above.
...
### Code.org Store a Support Forums
...
Tyto Podmínky, práva a licence udělené podle tohoto dokumentu, nesmí být převedena nebo přidělena vámi, ale mohou být přidělena Code.org bez omezení. Any assignment attempted to be made in violation of these Terms shall be null and void.
