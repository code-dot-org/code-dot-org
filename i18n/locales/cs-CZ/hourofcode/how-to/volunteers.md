---
title: Návodný průvodce „Hodinou programování“ pro dobrovolníky
---
...
- [Kdo se může stát dobrovolníkem?](#who-can-volunteer)
- [Proč se stát dobrovolníkem?](#why-volunteer)
- [Jak jsou dobrovolníci vybíráni?](#selection)
- [Co když chci být dobrovolníkem u nějaké konkrétní školy?](#choose-a-school)
- [Jak se připravit](#how-to-prepare)
...
Můžete výt pozvaným mluvčím v učebně nebo pomáhat učiteli provozovat aktivitu. [Zaregistrujte se dnes,](https://code.org/volunteer) abyste mohli inspirovat studenty, aby se nadále učili počítačovou vědu.
...
Učitelé mohou hledat dobrovolníky na naší [mapě dobrovolníků](http://code.org/volunteer/local). Jestliže se nacházíte poblíž jeho učebny, učitel se podívá na Váš profil na mapě, takže se pokuste vyplnit o sobě co nejvíce, abyste zvýšili šanci, že Vás nějaký učitel kontaktuje.
...
- Jestliže učitel předem určil aktivity Hodiny programování pro danou akci, buďte si toho vědomi, abyste si je mohli předem [prostudovat](https://hourofcode.com/us/learn). 

### Pomyslete na své účastníky

- Uvažte studenty, ke kterým budete promlouvat, a zamyslete se nad tím, co by s nimi mohlo rezonovat. Jako dobrovolník jim můžete pomoci uvědomit si, že počítače jsou všude a že i oni se mohou stát počítačovými vědci. Uvažte jejich věky, původy, a pohlavní totožnosti a přijďte připraveni s tématy, která by mohla apelovat na jejich zájmy. Tady je další návod k tomu, jak inspirovat k účasti [mladé ženy](http://code.org/girls). 
- Vzrušte studenty! Spolupracujte s učitelem na vybrání nějakého [inspiračního videa,](https://hourofcode.com/us/promote/resources#videos) které může pomoci zaměřit pozornost třídy a vzrušit je, aby dělali Hodinu programování. 
...
Potřebujete další prostředky? [Zkuste tyto ostatní rady](https://code.org/files/CSTT_Volunteers.pdf).
...
Pracujte se školou nebo s učitelem na diskusi o tom, co dává nejlepší smysl. Viděli jsme akce, které probíhaly [virtuálně](https://hourofcode.com/us/how-to/virtual) nebo osobně, v kanceláři společnosti nebo ve společenství, a pro studenty všech věkových kategorií! Také se můžete podívat, co v minulosti udělali ostatní [firemní partneři](https://medium.com/@codeorg/amazon-microsoft-google-vista-and-more-rally-to-bring-the-hour-of-code-to-students-worldwide-4641325542cf) a [dárci.](https://medium.com/@codeorg/how-code-orgs-corporate-supporters-helped-spread-the-love-for-2019-s-hour-of-code-73a3c088f10f) Tak najdete nějaké inspirující nápady.

<br />

#### Příklad agendy:

|Čas | Položka agendy | |\---\---\---\---\---\---\---\---\---\---\---\---\---\---\---\---- | \---\---\---\---\----- | |1-5 minut | zobrazeno jako [inspirační video](https://hourofcode.com/us/promote/resources#videos)|  
...
- Jestliže máte nějakou skupinu personálu, která bude Vaši akci uskutečňovat, nebo která se zapojí do dobrovolnické práce v místní škole, uvažte objednání [speciálních triček](http://blog.code.org/post/132608499493/hour-of-code-shirts-and-more) pro Vaši skupinu.
...
Jestliže bude Vaše akce virtuální, budete si před zahájením akce muset vybrat konferenční platformu (a vyzkoušet ji). Ta může mít vliv na počet studentů, který pro Vás bude vyhovující, takže nejlepší je rozhodnout o ní před pozváním třídy a před zahájením propagace Vaší akce. Chcete-li nějaké nápady ohledně toho, jak pořádat Hodinu programování dálkově, přečtěte si naše [tipy pro virtuální akci Hodina programování](https://hourofcode.com/us/how-to/virtual).

### 4. Vyberte aktivitu

Nabízíme množství zábavných a na studenty orientovaných výukových kurzů pro všechny věkové kategorie a zkušenostní úrovně. U studentů bývá populární zkusit výukové kurzy pod vlastním vedením, ačkoli možná budete chtít začít akci [inspiračním videem,](https://hourofcode.com/us/promote/resources#videos) které by sledovali všichni společně.

<a href="https://hourofcode.com/us/learn">Podívejte se na aktivity</a> a předem se rozhodněte, zda chcete vybrat jediný výukový kurz pro všechny Vaše hosty, nebo zda necháte každé dítě, aby si vybralo svůj. **Všechny aktivity Hodiny programování** vyžadují jen minimální čas na přípravu a probíhají pod vlastním vedením - to účastníkům umožňuje pracovat vlastním tempem a na vlastní úrovni dovedností.

[![](/images/fit-700/tutorials.png)]({{ urls/learn }})

Až budete mít pro svou akci připravený pracovní plán, můžete začít zvát studenty, školu nebo širší společenství. Doporučujeme Vám začít na místní škole, ke které máte vztah, nebo si projít [naši mapu](https://hourofcode.com/us/map) událostí Hodiny programování.
...
- [Sdílejte certifikáty]({{ urls/certificates }}) pro účastníky a studenty.
- [Vytiskněte nálepky „Dělal jsem hodinu programování!“]({{ promote/resources_stickers }}) nebo najděte další ceny a pozornosti na [Obchodě Amazon Code.org](https://code.org/shop). 
...
- Jedna #HourOfCode může vést k [vyplňte svůj příběh]. https://hourofcode.com/ 
- Podporuji #HourOfCode, protože [vyplňte své myšlenky]. Přidejte se k nám https://hourofcode.com 
...
<a href="https://hourofcode.com/promote/resources#posters">Zjistěte si více</a> o plakátech, videích, nálepkách a dalších způsobech, jak propagovat Vaši akci ve Vašem společenství.
...
- Šiřte povědomí nošením [známky Code.org](https://store.code.org/) (všechny prostředky půjdou na podporu toho, aby další studenti získali přístup ke vzdělání v počítačové vědě).
- Když budete nakupovat na [AmazonSmile](https://code.org/donate/amazonsmile), rozhodněte se přispět Code.org. 
...
- Bavte se se spolupracovníky na [kampani rozdávání](https://medium.com/@codeorg/how-a-haircut-happy-hour-turned-into-a-fundraiser-for-code-org-1952b197faa2).
- [Podepište tuto petici,](https://code.org/promote) abyste zajistili, aby měli všichni studenti příležitost učit se počítačovou vědu. 
- [Dejte dar](https://code.org/donate) Code.org, abychom mohli nadále šířit své vzdělávací materiály bezplatně a zpřístupňovat je všem. 

Další nápady na to, jak podpořit Code.org a Hodinu programování, najdete na adrese [Code.org/Help](https://code.org/help)
