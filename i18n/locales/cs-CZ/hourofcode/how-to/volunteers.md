---
title: Průvodce Hodinou kódu pro dobrovolníky
---
...
- [Co když chci být dobrovolníkem v nějaké konkrétní škole?](#choose-a-school)
- [Jak se připravit](#how-to-prepare)
- [Když pořádáte událost](#hosting-an-event)
- [Šiřte povědomí o Hodině kódu](#promote-hour-of-code)
- [Další způsoby, jak podpořit Hodinu kódu](#support-hour-of-code)
- [Nejčastější dotazy k dobrovolnictví](#faq)

Ať už děláte dobrovolnickou práci virtuálně, osobně, nebo zastupujete firmu, vaše úsilí může mít obrovský vliv na to, jak studenti nahlížejí na počítačovou vědu a jak vnímají svůj vlastní potenciál. Pokud máte ještě nějaké dotazy, [podívejte se do naší sady nástrojů pro dobrovolníky]({{ localized_files/hoc_volunteer_toolkit }}).
...
Můžete být hostem v učebně jako řečník anebo pomoct učiteli se spuštěním aktivity. [Zaregistrujte se](https://code.org/volunteer) a inspirujte studenty, aby se dál učili počítačovou vědu.
...
Učitelé mohou hledat dobrovolníky na naší [mapě dobrovolníků](http://code.org/volunteer/local). Jestliže se nacházíte poblíž školy, učitel se podívá na váš profil na mapě, proto se snažte zadat co nejvíc informací o sobě, abyste zvýšili šanci, že vás nějaký učitel kontaktuje.
...
- Jestliže učitel předem určil pro danou událost aktivity Hodiny kódu, zjistěte si, které to jsou, abyste si je mohli předem [prostudovat](https://hourofcode.com/us/learn). 

### Myslete na své účastníky

- Zamyslete se nad studenty, ke kterým budete mluvit. Vymyslete, co by s nimi mohlo rezonovat. Jako dobrovolník jim můžete pomoct uvědomit si, že počítače jsou všude kolem nás a že i oni se mohou stát odborníky na počítačové vědy. Zohledněte jejich věk, sociální příslušnost a pohlaví a připravte si témata, která by se mohla potkat s jejich zájmy. Tady je další návod, jak inspirovat [mladé ženy](http://code.org/girls). 
- Vzbuďte ve studentech nadšení! Spolupracujte s učitelem na vybrání [motivačního videa,](https://hourofcode.com/us/promote/resources#videos), které může třídu vtáhnout do tématu a nadchnout ji k vyzkoušení Hodiny kódu. 
...
Potřebujete další materiály? [Vyzkoušejte taky tyto tipy](https://code.org/files/CSTT_Volunteers.pdf).
...
Pokud uvažujete o uspořádání Hodiny kódu doma nebo v komunitě, doporučujeme podívat se na některé naše podrobné průvodce pro [rodiče](https://hourofcode.com/us/how-to/parents) a [organizace nebo firmy](https://hourofcode.com/us/how-to/companies).
...
- [Připravte certifikáty]({{ urls/certificates }}) pro účastníky a studenty.
...
Když svou událost Hodiny kódu zaregistrujete, budete dostávat užitečná e-mailová sdělení s novinkami a tipy na uspořádání úspěšné Hodiny kódu. Zároveň tím dáte místním školám a rodičům vědět, že v jejich okolí pořádáte událost.
...
- Věděli jste, že jenom 45 % amerických škol vyučuje počítačovou vědu? Dejte každému studentovi šanci absolvovat událost #HourOfCode https://hourofcode.com/ 
...
<a href="https://hourofcode.com/promote/resources#posters">Zjistěte si více</a> o plakátech, videích, nálepkách a dalších způsobech, jak můžete svoji událost propagovat ve svém okolí.
...
Učitelé budou hledat dobrovolníky na naší [mapě dobrovolníků](https://code.org/volunteer/local). Snažte se vytvořit pokud možno co nejúplnější profil, aby se zvýšila šance, že vás nějaký učitel vybere. Jestliže upřednostňujete některý způsob, jak se jako dobrovolník zapojit, například chcete, aby vás škola pozvala jako řečníka nebo jako technickou podporu, uveďte to prosím v popisu svého profilu.   
