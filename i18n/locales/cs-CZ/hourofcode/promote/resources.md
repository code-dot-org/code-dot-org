...
1. Jakýkoliv odkaz na "Hodinu kódu" by se měl používat způsobem, který nenaznačuje, že je to vaše vlastní značka, ale spíše odkazuje na Hodinu kódu jako základní hnutí.
    
    - Dobrý příklad: "Účastněte se Hodiny kódu v ACMECorp.com". 
    - Špatný příklad: " Vyzkoušejte Hodina Kódu od ACME korporace".
