...
[![obrázek](/images/social-media/fit-250/bill_gates.png)](/images/social-media/bill_gates.png)&nbsp;&nbsp;&nbsp;&nbsp; [![obrázek](/images/social-media/fit-250/malala_yousafzai.png)](/images/social-media/malala_yousafzai.png)&nbsp;&nbsp;&nbsp;&nbsp; [![obrázek](/images/social-media/fit-250/chris_bosh.png)](/images/social-media/chris_bosh.png)&nbsp;&nbsp;&nbsp;&nbsp;
...
Počítače jsou všude, změnily každé odvětví na planetě. But only 47% of all high schools teach computer science. Good news is, we’re on our way to change this! Pokuď jste slyšeli o Hodině kódu dříve, mohli byste vědět, že se dostala do historie. Více než 100 miliónu studentů již vyzkoušelo Hodinu kódu.

With the Hour of Code, computer science has been on homepages of Google, MSN, Yahoo!, and Disney. Přes 100 partnerů se spojilo dohromady k podpoře tohoto hnutí. Every Apple Store in the world has hosted an Hour of Code, and leaders like President Obama and Canadian Prime Minister Justin Trudeau wrote their first lines of code as part of the campaign.
...
That’s why our entire school is joining in on the largest learning event in history: The Hour of Code, during Computer Science Education Week ({{ campaign_date/full }}). Více než 100 miliónu studentů celosvětově již vyzkoušelo Hodinu kódu. Our Hour of Code is making a statement that [SCHOOL NAME] is ready to teach these foundational 21st-century skills. Abychom mohli našim studentům přinášet další programovací aktivity, chceme z Hodiny kódu udělat obrovskou akci. Povzbuzuji vás k dobrovolnictví, kontaktujte místní média, sdílejte zprávy na sociálních médiích a zvašte hostování další Hodiny kódu ve vaší komunitě.
...
That’s why our entire school is joining in on the largest learning event in history: The Hour of Code, during Computer Science Education Week ({{ campaign_date/full }}). Více než 100 miliónu studentů celosvětově již vyzkoušelo Hodinu kódu.
