...
Název: programování s milimetrovým papírem náhled: page_curriculum téma: žádné

* * *

<%= partial('curriculum_header', :title=> 'Programování s milimetrovým papírem', :unplugged=>true,:disclaimer=>'Základní lekce zahrnuje čas aktivity. Úvodní a závěrečné návrhy lze použít k prohloubení, pokud čas to umožní.', :time=>20) %>

[obsah]

## Lekce – přehled

V "programování" jeden druhého, aby si nakreslili obrázky, studenti začnou chápat, o co v programování v jde. Třída začne tím, že studenti si vzájemně instruují k obarvení čtverečků na milimetrovém papíru ve snaze reprodukovat existující obrázek. Pokud je čas, ponaučení lze přidat k obrázkům, které studenti vytváří sami.
...
1) [slovník](#Vocab)   
2) [zavést programování s milimetrovým papírem ](#GetStarted)   
3) [trénovat společně](#Practice)

### **Činnost: programování s milimetrovým papírem ** - 20 minut

4) [čtyři se čtyxřmi](#Activity1)

### **Shrnutí** - 5 minut

5) [bleskový chat: co jsme se naučili?](#FlashChat)   
6) [slovní zásoba Shmocab](#Shmocab)

### **Vyhodnocení** - 10 minut

7), [vyhodnocení programování s milimetrovým papírem ](#Assessment)
...
Studenti budou:
  ...
  * Porozumět potížím převodu reálných problémů do programů 
  * Naučit se , že myšlenky se mohou cítit jasné, ale přesto budou špatně pochopené počítačem 
  * Praxe sdělování myšlenek prostřednictvím kódů a symbolů
...
### Pro studenta
  ...
  * [Pracovní sešit aktivity čtyři se čtyřmi](Activity1-GraphPaperProgramming.pdf)
  * [Vyhodnocení programování s milimetrovým papírem ](Assessment1-GraphPaperProgramming.pdf)
...
## <a name="Assessment"></a> Hodnocení (10 min)
