...
* [Преподаване на новите курсове](#newcourses)
* [Времеви истории (курсове за А и Б)](#circletime)
* [Струстурни уроци & предизвикателство чрез пъзели (всички възрасти)](#scaffolding)
* [Дейности за уроци без компютър (всички възрасти)](#unplugged)
* [Край - курсови проекти (курсове E & F)](#endofcourse)
...
## Общ преглед
Основите на компютърното образование са се променили изключително много от създаването на курсовете за обучение на оригиналния компютър. Първоначално курсовете 1-4 са проектирани като отправна точка за придобиване на основни знания, без значение на каква възраст е ученика.  Сега, много повече области, градове и държави използват тези курсове за компютърни науки, започвайки от детската градина, учителите се нуждаят от повече съдържание, за да обучават ученици от прогимназията.

Курсове A-F, са нашият отговор на този въпрос.  The creation of a grade-by-grade curriculum allowed us to step back and rethink the way we were presenting material.  It also allowed us the chance to wholeheartedly incorporate feedback from the dedicated teacher community that has supported us on this mission. Designed with the help of some of the best elementary school CS education specialists across the country, Courses A-F should feel familiar enough to run with no extra professional development, but fresh enough to present to students who have done our lessons in the past.
...
## Времеви истории (курсове за А и Б)
...
## Струстурни уроци & предизвикателство чрез пъзели (всички възрасти)
...
## Дейности за уроци без компютър (всички възрасти)
...
## Край - курсови проекти (курсове E & F)
