...
За да защитим вашата поверителност и сигурност, ние предприемаме разумни стъпки, за да удостоверим самоличността ви преди предоставянето ви акаунт на достъп или предоставяне на корекции на личните ви данни. Because some schools block SSL-secure websites, Code.org allows access with or without SSL protection, at the direction of those schools. Ако искате SSL криптирана връзка в или за шифроване на данните ви въведени при използването на сайта, използвайте протокола HTTPS като посетите https://code.org/.
