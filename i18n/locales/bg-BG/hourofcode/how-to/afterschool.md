...
Ние предлагаме разнообразие от [ забавни, дълги около час уроци](%= resolve_url('https://code. org/learn') %) за участници от всички възрасти, създадени от различни партньори. [ Изпробвайте ги!](%= resolve_url('/learn') %)

**Всички уроци на Hour of Code:**

- Изискват минимално време за подготовка на организаторите
- Предвиждат самостоятелна работа, което позволява на учениците да работят със собствени темпове и ниво на умения
...
- Насърчете го да опита друга Hour of Code дейност на [ hourofcode.com/learn](%= resolve_url('/learn') %)
