...
We’ll host a variety of [fun, hour-long tutorials](%= resolve_url('https://code.org/learn') %) for participants all ages, created by a variety of partners. *Нови уроци идват за началото на часа на кода < % = campaign_date('full') % >.* [Опитайте текущите уроци.](%= resolve_url("https://code.org/learn") %)
...
Най-добре е Часът на кодирането да се проведе със свързани към Интернет компютри. Но вие **не се** нуждаете от компютър за всяко дете и дори можете да проведете Часът на кодирането и без компютър.</p> 
  ...
  * **Няма достатъчно устройства?** Използвайте [ програмиране по двойки](https://www.youtube.com/watch?v=vgkahOzFH2Q). Когато децата си партнират, те помагат си помагат и разчитат по-малко на организатора. Те ще се убедят, че компютърните науки се нуждаят от социално сътрудничество.
...
**Когато някой се натъква трудности е добре да получи един от тези отговори:**
