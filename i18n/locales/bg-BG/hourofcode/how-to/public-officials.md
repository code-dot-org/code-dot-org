...
## Нека всяко училище да се включи, и всеки ученик да се научи!
  ...
  2. **Организирайте Hour of Code събитие.** Вижте нашите [ръководство, ](%= resolve_url('/how-to/how-to-event') %) примерен план на шоуто, информационен комплект за медиите и други ресурси за планиране на събития. Организирането на събитието е чудесен начин за насърчаване на интереса към програмирането.
