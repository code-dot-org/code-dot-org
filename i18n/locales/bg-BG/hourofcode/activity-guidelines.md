...
Code.org е домакин на различни Hour of Code™ дейности, уроци и видеоклипове на уебсайтовете Code.org и Hour of Code. Текущият списък е на адрес []({{ urls/learn }})hourofcode.com/learn.
...
**Улеснен урок за учители ([пример](https://studio.code.org/s/course1/lessons/2/levels/1), [шаблон](https://docs.google.com/document/d/1DhaLNd6uim9rRPkHrglnOvVcgzGc8axKIzv8YI56JGA))**
...
*Технически изисквания:* Поради голямото разнообразие от настройки на технологиите в училище и класна стая, най-добрите дейности са уеб-базирани или удобни за смартфони или по друг начин изключен стил дейности, които преподават концепции за компютърни науки без използване на компютър (вж. http://csunplugged.com/). [](http://csunplugged.com/) Дейностите, които изискват инсталиране на приложения, настолно приложение или игрови конзоли, са добре, но не са идеални. Няма да изброяваме дейности, които изискват регистрация или плащане. (Дейностите по роботика могат да изискват закупуване на роботика.)
...
* Включва ли тази дейност AI: Да или Не
...
* Списък на езиците за програмиране, които вашата дейност преподава. Т.е. C/C ++, Java, JavaScript и др. или език независим (за планове за уроци, които могат да бъдат преподавани на няколко езика) изберете езикови изкуства.
* Списък на поддържаните естествени езици. Забележка: Откриването на език е отговорност на доставчика на дейност; ние ще пренасочим всички потребители към предоставения единствен URL адрес. или език независим (за планове за уроци, които могат да бъдат преподавани на няколко езика)
* Какво ниво на опит трябва да има един преподавател, за да използва вашата дейност? (напр. Начинаещ или удобен.) И какво ниво на опит трябва да имат учениците?
...
* След приключване на дейността си, потребителите трябва да бъдат насочени към [code.org/api/hour/finish](https://code.org/api/hour/finish) , където ще могат: 
    ...
    * За потребители, които прекарват един час във вашата дейност и не я завършват, моля, включете бутон в дейността си, който казва „Приключих с моя час на кода“, който свързва също [](https://code.org/api/hour/finish) code.org/api/hour/finish.
...
Разнообразен комитет от преподаватели по компютърни науки ще класира заявленията въз основа на качествени и количествени критерии. Всички дейности, които отговарят на основните критерии, ще бъдат изброени.

За традиционните дейности по кодиране разнообразен комитет от преподаватели по компютърни науки ще класира заявленията въз основа на качествени и количествени критерии. Всички дейности, които отговарят на основните критерии, ще бъдат изброени. Учителите ще могат да филтрират и сортират, за да намерят най-добрите дейности за класната стая.
...
Дейностите не трябва да включват AI, въпреки че се стремим да предложим повече дейности, свързани с AI.
...
**Насърчете учениците да публикуват в социалните медии (при необходимост), когато са завършили дейността.** Например "Аз направих Hour of Code с ________. А ти? #HourOfCode „или „Направих #HourOfCode като част от #CSEdWeek. А ти?
...
Ако вашият урок е одобрен и включен на последната страница с уроци, Code.org ще ви предостави уникален пиксел за проследяване, който да интегрирате във вашия урок. Вижте примера по-долу. Не включвайте на междинни страници на вашия урок.
