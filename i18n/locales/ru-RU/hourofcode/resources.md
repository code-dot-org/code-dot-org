...
<p>
  ...
  <p>
    ...
    <p>
      Компьютеры везде, но сейчас меньше школ учат информатике, чем 10 лет назад. Но есть и хорошие новости: мы можем это изменить. If you heard about the Hour of Code last year, you might know it made history. В течение одной недели, 15 миллионов учащихся попробовали себя в информатике!
    </p>
    ...
    <p>
      <a style="display: block" href="<%= hoc_uri('/#join') %>"><button style="float: right;">Зарегистрируйте ваше мероприятие</button></a>
    </p>