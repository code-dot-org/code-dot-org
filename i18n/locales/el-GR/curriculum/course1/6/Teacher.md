...
<%= partial('curriculum_header', :title=> 'Real-Life Algorithms: Plant a Seed', :unplugged=>true,:disclaimer=>'Basic lesson time includes activity only. Τα Εισαγωγικά και τα Συμπεράσματα μπορούν να χρησιμοποιηθούν για εμβάθυνση εφόσον το επιτρέπει ο χρόνος', :time=>20) %>
