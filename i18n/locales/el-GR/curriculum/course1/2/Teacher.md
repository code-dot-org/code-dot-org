...
<%= partial('curriculum_header', :title=> 'Μετακίνησέ το', :lesson=>2, :unplugged=>true,:disclaimer=>'Ο βασικός χρόνος μαθήματος περιλαμβάνει μόνο τη δραστηριότητα. Τα Εισαγωγικά και τα Συμπεράσματα μπορούν να χρησιμοποιηθούν για εμβάθυνση εφόσον το επιτρέπει ο χρόνος', :time=>20) %>
...
Αυτό το μάθημα θα βοηθήσει τους μαθητές να αντιληφθούν ότι προκειμένου να δίνουν σαφείς οδηγίες χρειάζεται να χρησιμοποιούν μια κοινή γλώσσα. Οι μαθητές θα εξασκηθούν ελέγχοντας ο ένας τον άλλο χρησιμοποιώντας έναν απλό συνδυασμό από χειρονομίες. Όταν καταλάβουν τη γλώσσα, θα ξεκινήσουν να "προγραμματίζουν" ο ένας τον άλλο δίνοντας εκ των προτέρων έναν αριθμό οδηγιών.
...
1) [Επανάληψη](#Review)   
2) [Λεξιλόγιο](#Vocab)   
3) [Ας κατευθύνουμε τους εαυτούς μας](#GetStarted)

### **Δραστηριότητα: Μετακινήσου** - 20 λεπτά

4) [Μετακινήσου: Περιπέτεια πολλαπλών βημάτων](#Activity1)
...
6) [Αξιολόγηση Μετακίνησε τα Flurb 2](#Assessment)
...
### Οι μαθητές πρόκειται να:
  ...
  * Αναγνωρίζουν καταστάσεις στις οποίες μπορούν να δημιουργούν προγράμματα για να ολοκληρώσουν κάποιες εργασίες
  * Προβλέπουν τις απαραίτητες κινήσεις που απαιτούνται να μετακινήσουν τον συμπαίκτη τους από την αφετηρία στο τέλος
