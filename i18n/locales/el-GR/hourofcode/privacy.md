...
Το Σημείωμα Απορρήτου μας τροφοδοτείται από την δέσμευσή μας στις ακόλουθες Αρχές Εχεμύθειας:
  ...
  4. Δεν πουλάμε τα Προσωπικά σας Στοιχεία ούτε τα χρησιμοποιούμε για οικονομικό όφελος. Δεν πουλάμε διαφημίσεις. Είμαστε ένα φιλανθρωπικό μη κερδοσκοπικό ίδρυμα 501c3 και τα έσοδά μας προέρχονται από δωρεές. We established ourselves as a nonprofit so our mission and your trust will not be in conflict with a for-profit motive.
