...
Ναι. Πρέπει να συμμετάσχει όλο το σχολείο για να έχετε τη δυνατότητα να κερδίσετε το δώρο, αλλά χρειάζεται μόνο ένα πρόσωπο να συμπληρώσει και να στείλει την αίτηση .</p> 
...
To qualify, your entire school must register for the Hour of Code as well as complete the [Hardware Application form](<%= hoc_uri('/prizes') %>) by November 16, 2015. Ένα σχολείο σε κάθε πολιτεία των Η.Π.Α. θα λάβει ένα σετ υπολογιστών. Code.org will select and notify winners via email by December 1, 2015.
