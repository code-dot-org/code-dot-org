---
title: Οδηγός χρήσης Ώρας κώδικα για μετά το σχολείο
---
...
Η δοκιμή μιας Ώρας Κώδικα είναι ένας απλός και διασκεδαστικός τρόπος για να εισαγάγετε τους μαθητές στην επιστήμη των υπολογιστών, ίσως για πρώτη φορά. Εάν χρειαστείτε βοήθεια, μπορείτε να βρειτε  εδώ  εθελοντές που μπορούν να σας βοηθήσουν στην Ώρα του Κώδικα σε τάξεις και ομίλους εκτός σχολικού ωραρίου.</p> 
...
**Τι να κάνετε αν κάποιος τελειώσει νωρίς;** - Ενθαρρύνετε τους συμμετέχοντες να δοκιμάσουν μια άλλη δραστηριότητα Ώρας κώδικα στο [hourofcode.com/learn]({{ urls/learn }}) - Ή, ζητήστε από εκείνους που τελειώνουν νωρίς να βοηθήσουν άλλους που αντιμετωπίζουν προβλήματα.

## 7. Γιορτάστε το

- [Εκτυπώστε πιστοποιητικά]({{ urls/certificates }}) για τους μαθητές σας.
- [Εκτύπωση «Έκανα μια Ώρα Κώδικα!»]({{ promote/resources_stickers }}) αυτοκόλλητα για τους μαθητές σας.
- [Παραγγείλετε προσαρμοσμένα μπλουζάκια](https://www.amazon.com/stores/Code/page/8557B2A6-EBF2-4C9F-95C5-C3256FBA0220?ref_=ast_bln) για τους συμμετέχοντες.
...
Η Ώρα του Κώδικα είναι μόνο το πρώτο βήμα σε ένα ταξίδι μάθησης σχετικά με το πώς λειτουργεί η τεχνολογία και πώς δημιουργούνται οι εφαρμογές λογισμικού. Βοηθήστε τους μαθητές να συνεχίσουν το ταξίδι τους και ενθαρρύνετέ τους να [μάθουν περισσότερα στο διαδίκτυο](/beyond)!
