---
title: Οδηγός Κατευθύνσεων Ώρας του Προγραμματισμού
---
...
- [Προωθήστε τη δική σας Ώρα του Προγραμματισμού](#promote-your-hour)
- [Πώς να ξεκινήσετε δυναμικά τη δική σας Ώρα του Προγραμματισμού](#how-to-start)
- [Get coding](#code)
...
## 1. Παρακολουθήστε το βίντεο καθοδήγησης Ώρας του Προγραμματισμού <iframe width="500" height="255" src="//www.youtube.com/embed/SrnvvWDm73k" frameborder="0" allowfullscreen></iframe> 
...
## 5. Πώς να ξεκινήσετε δυναμικά τη δική σας Ώρα του Προγραμματισμού.
...
- Γράψτε τον σύνδεσμο του εκπαιδευτικού βίντεο σε έναν πίνακα. Βρείτε τον σύνδεσμο που αναγράφεται επιγραμματικά πάνω στις [πληροφορίες για το εκπαιδευτικό βίντεο που επιλέξατε]({{ urls/learn }}) κάτω από τον αριθμό των συμμετεχόντων.
