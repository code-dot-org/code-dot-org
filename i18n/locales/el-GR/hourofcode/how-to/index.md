...
Trying an Hour of Code is a simple and fun way to introduce students to computer science, perhaps for the very first time. Δείτε τον [οδηγό συμμετοχής αν έχετε ακόμη ερωτήσεις]({{ localized_files/participation_guide }}).
