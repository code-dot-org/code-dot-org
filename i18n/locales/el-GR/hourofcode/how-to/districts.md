...
Share this [sample logistics plan]({{ hoc_logistics_plan }}) with schools to give them ideas of how to organize whole school participation. Είναι το ίδιο εύκολο να γίνει σε κάθε τάξη των μαθηματικών, σε κάποια ελεύθερη ώρα, ή διαδοχικά στο εργαστήριο υπολογιστών κατά τη διάρκεια της εβδομάδας.
