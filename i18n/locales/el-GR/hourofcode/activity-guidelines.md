...
Το Code.org φιλοξενεί μια ποικιλία δραστηριοτήτων, μαθημάτων και βίντεο της Ώρας του Κώδικα™ στους ιστότοπους Code.org και Hour of Code. Η τρέχουσα λίστα βρίσκεται στη διεύθυνση [hourofcode.com/learn]({{ urls/learn }}).
...
*Τεχνικές απαιτήσεις:* Λόγω της μεγάλης ποικιλίας ρυθμίσεων τεχνολογίας σχολείου και τάξης, οι καλύτερες δραστηριότητες είναι βασισμένες στον Ιστό ή φιλικές προς smartphone ή με άλλο τρόπο δραστηριότητες αποσυνδεδεμένου στυλ που διδάσκουν έννοιες της επιστήμης των υπολογιστών χωρίς τη χρήση υπολογιστή (βλ. http://csunplugged.com/). [](http://csunplugged.com/) Δραστηριότητες που απαιτούν εγκατάσταση εφαρμογών, εφαρμογή για επιτραπέζιους υπολογιστές ή εμπειρίες κονσόλας παιχνιδιών είναι εντάξει αλλά δεν είναι ιδανικές. Δεν θα αναφέρουμε δραστηριότητες που απαιτούν εγγραφή ή πληρωμή. (Οι δραστηριότητες ρομποτικής μπορεί να απαιτούν αγορά ρομποτικής.)
...
* Μετά την ολοκλήρωση της δραστηριότητάς σας, οι χρήστες θα πρέπει να κατευθύνονται στο [](https://code.org/api/hour/finish) code.org/api/hour/finish όπου θα μπορούν: 
    ...
    * Για χρήστες που ξοδεύουν μια ώρα στη δραστηριότητά σας και δεν την ολοκληρώνουν, συμπεριλάβετε ένα κουμπί στη δραστηριότητά σας που λέει «Έχω τελειώσει με την Ώρα του Κώδικα μου» το οποίο συνδέεται επίσης με το [](https://code.org/api/hour/finish) code.org/api/hour/finish.
...
ΙΜΓ SRC = http://code.org/api/hour/begin_dance.png [](http://code.org/api/hour/begin_dance.png)   
