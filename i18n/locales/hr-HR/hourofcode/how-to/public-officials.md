...
See our [event how-to guide]({{ urls/how_to_events }}) for a sample run of show, [media outreach kit]({{ promote/press_kit_url }}), and other event-planning resources. Biti domaćin Sata Kodiranja je odličan način za promicanje Programiranja i povećanje interesa za sudjelovanje.
