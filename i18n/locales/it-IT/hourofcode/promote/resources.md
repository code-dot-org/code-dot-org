...
[![immagine](/images/social-media/fit-250/social-2.png)](/images/social-media/social-2.png)&nbsp;&nbsp;&nbsp;&nbsp; [![immagine](/images/social-media/fit-250/social-3.png)](/images/social-media/social-3.png)&nbsp;&nbsp;&nbsp;&nbsp;

[![immagine](/images/social-media/fit-250/malala_yousafzai.png)](/images/social-media/malala_yousafzai.png)&nbsp;&nbsp;&nbsp;&nbsp; [![immagine](/images/social-media/fit-250/chris_bosh.png)](/images/social-media/chris_bosh.png)&nbsp;&nbsp;&nbsp;&nbsp;
...
<a id="email"></a>
    ...
    <p>
      Per iniziare leggi l'introduzione all'Ora del Codice sul sito italiano http://hourofcode.com/{{ country_language }} <br />
    </p>
...
<a id="parents"></a>
    ...
    <p>
      Ma solo una piccola parte di noi sta imparando <strong>come</strong> funziona la tecnologia. Solo il 51% di tutte le scuole superiori insegna informatica (negli Stati Uniti).
    </p>
    ...
    <p>
      Visita la pagina http://hourofcode.com/{{ country_language }} per i dettagli e contribuisci a diffondere la notizia.<br />
    </p>
