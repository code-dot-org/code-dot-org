...
### Trova tutte le risorse di cui hai bisogno per attirare l'attenzione sulla tua Ora del Codice. Non sai da dove cominciare? Inizia con la nostra [guida per ospitare un'Ora di Codice]({{ how_to_url }})!
...
* Cerchi dei poster degli anni precedenti? [Li trovi qui]({{ promote/previous_posters_url }})!
...
[![immagine](/images/social-media/fit-250/bill_gates.png)](/images/social-media/bill_gates.png)&nbsp;&nbsp;&nbsp;&nbsp; [![immagine](/images/social-media/fit-250/malala_yousafzai.png)](/images/social-media/malala_yousafzai.png)&nbsp;&nbsp;&nbsp;&nbsp; [![immagine](/images/social-media/fit-250/chris_bosh.png)](/images/social-media/chris_bosh.png)&nbsp;&nbsp;&nbsp;&nbsp;

[![immagine](/images/social-media/fit-250/karlie_kloss.png)](/images/social-media/karlie_kloss.png)&nbsp;&nbsp;&nbsp;&nbsp; [![immagine](/images/social-media/fit-250/satya_nadella.png)](/images/social-media/satya_nadella.png)&nbsp;&nbsp;&nbsp;&nbsp; [![immagine](/images/social-media/fit-250/jeff_bezos.png)](/images/social-media/jeff_bezos.png)&nbsp;&nbsp;&nbsp;&nbsp;

<a id="logo"></a>

## Usa il logo dell'Ora del Codice per spargere la voce

[![immagine]({{ hoc_logo_fit_200 }})]({{ hoc_logo }}) [![immagine]({{ hdc_logo_fit_200 }})]({{ hdc_logo }})
...
<ul style="margin-top: 0px">
  <li>
    <strong>Un esempio di uso corretto: "Partecipa all'Ora del Codice™ su YOUR-COMPANY.com." </li> 
    ...
    <ol>
      <li>
        Utilizza un apice "TM" dove menzioni "Ora del Codice" e un apice "Ⓡ" nei punti più importanti dove citi "Ora del Codice", sia nel tuo sito web che nelle descrizioni delle app.
      </li>
      
      <li>
        <p>
          Includi la lingua nella tua pagina (o nel piè di pagina), inclusi i link alla CSEdWeek e al sito Web<a href="{{ codeorg_link }}">Code.org</a> , che dice quanto segue:
        </p>
        <p>
          <em>“La 'Hour of Code™'/'Ora del Codice®' è un'iniziativa nazionale della Computer Science Education Week [csedweek.org] e di Code.org [code.org] per introdurre milioni di studenti ad un'ora di informatica e programmazione."</em>
        </p>
      </li>
      
      <li>
        Non è concesso alcun uso di "Hour of Code" o "Ora del Codice" nei nomi delle app.
      </li>
    </ol>
...
<a id="stickers"></a>
    ...
    <p>
      (Gli adesivi misurano 1" di diametro, 63 per foglio) <br />
    </p>
    
    <p>
      <a href="/images/hour-of-code-stickers.pdf"><img src="/images/fit-250/hour-of-code-stickers.png" alt="immagine" /></a>
    </p>
...
<a id="sample-emails"></a>
    ...
    <h3>
      Trova <a href="{{ promote/stats_url }}">maggiori informazioni e suggerimenti sul linguaggio da utilizzare</a> per promuovere l'Ora del Codice.
    </h3>
...
<a id="email"></a>
    ...
    <p>
      <strong>Oggetto:</strong> Unisciti a me e ad oltre 100 milioni di studenti per un'Ora del Codice <br />
    </p>
    
    <p>
      I computer sono ovunque e stanno cambiando ogni industria del pianeta. But only 47% of all high schools teach computer science. La buona notizia è che intendiamo cambiare rotta! Se hai già sentito parlare dell'Ora del Codice, probabilmente sai già che ha fatto la storia. Più di 100 milioni di studenti hanno provato un'Ora del Codice.
    </p>
...
<a id="help-schools"></a>
    ...
    <h4>
      <a href="{{ how_to_volunteers_url }}">Find more resources and information about volunteering in schools here</a>.
    </h4>
    
    <p>
      <strong>Oggetto:</strong> Possiamo aiutarvi ad ospitare un'Ora del Codice?
    </p>
    ...
    <p>
      I computer sono ovunque e stanno cambiando ogni industria del pianeta. But only 47% of all high schools teach computer science. La buona notizia è che intendiamo cambiare rotta! Se avete già sentito parlare dell'Ora del Codice, forse sapete che ha fatto storia - più di 100 milioni gli studenti nel mondo hanno provato un'Ora del Codice. Anche leader come il presidente Obama e il primo ministro canadese Justin Trudeau hanno scritto le loro prime righe di codice durante questa campagna.
    </p>
    
    <p>
      Potete leggere di più sull'evento presso http://hourofcode.com/it In alternativa, fateci sapere se volete dedicare del tempo per parlare di come la scuola [nome della scuola] può partecipare. <br />
    </p>
...
<a id="parents"></a>
    ...
    <p>
      <strong>Oggetto:</strong> I nostri studenti stanno cambiando il futuro con un'Ora del Codice
    </p>
    ...
    <p>
      But only a tiny fraction of us are learning <strong>how</strong> technology works. Only 47% of all high schools teach computer science.
    </p>
...
<a id="media-pitch"></a>
    ...
    <h4>
      <a href="{{ promote/press_kit_url }}">Qui trovi maggiori informazioni per invitare la stampa al tuo evento.</a>
    </h4>
    
    <p>
      <strong>Oggetto</strong>: la scuola si unisce alla missione di avvicinare gli studenti all'informatica
    </p>
    
    <p>
      Computers are everywhere, changing every industry on the planet, but only 47% of all high schools teach computer science. Le ragazze e le minoranze sono molto poco rappresentate negli studi informatici e nelle aziende tecnologiche. La buona notizia è che intendiamo cambiare rotta.
    </p>
...
<a id="politicians"></a>
    ...
    <h4>
      <a href="{{ how_to_public_officials_url }}">Servono ulteriori informazioni? Dai un'occhiata alle nostre risorse per invitare organizzatori locali al vostro evento</a>.
    </h4>
    
    <p>
      <strong>Oggetto</strong>: Si unisca ai nostri studenti che stanno cambiando il futuro con un'Ora del Codice
    </p>
