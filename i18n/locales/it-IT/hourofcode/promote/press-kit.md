...
Ecco perché ognuno dei [NUMERO] studenti della scuola [NOME SCUOLA] sta per prendere parte al più grande evento nella storia dell'apprendimento: l'Ora del Codice, durante la Settimana Internazionale di Educazione all'Informatica (<%= campaign_date('full') %>).
