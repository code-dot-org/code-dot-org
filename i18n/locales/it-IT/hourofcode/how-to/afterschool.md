...
Ti forniamo una varietà di [esercitazioni divertenti, della durata di un'ora](%= resolve_url('/learn') %) per partecipanti di tutte le età, creati da diversi partners.  
  
**Trovi altre informazioni in italiano sul sito <a href="https://www.programmailfuturo.it/come/ora-del-codice/introduzione" target="_blank">Programma il Futuro</a>** [Provali!](%= resolve_url('/learn') %)
...
- Proponi ai partecipanti di provare una nuova Ora del Codice: [hourofcode.com/learn](%= resolve_url('/learn') %)
...
- Scopri le [buone pratiche](http://www.slideshare.net/TeachCode/hour-of-code-best-practices-for-successful-educators-51273466) consigliate dagli organizatori delle passate edizioni de L'Ora del Codice. 
