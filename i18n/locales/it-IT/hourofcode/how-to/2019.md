...
## Guarda questo video per scoprire come fare Watch this how-to video <iframe width="500" height="255" src="//www.youtube.com/embed/SrnvvWDm73k" frameborder="0" allowfullscreen mark="crwd-mark"></iframe>
...
- Il miglior modo per godersi l'Ora del Codice è avere computer connessi a Internet. Ricorda però che non hai bisogno di avere un computer per ogni bambino e che è addirittura possibile partecipare all'Ora del Codice senza neppure un computer a disposizione! For [unplugged activities](/learn), simply filter the Classroom Technology section to show options for “No computers or devices”.
