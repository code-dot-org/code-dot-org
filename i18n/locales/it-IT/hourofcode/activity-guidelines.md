...
* Un elenco di linguaggi di programmazione insegnati dalla tua attività. Ad esempio C/C++, Java, JavaScript, ecc. o indipendente dalla lingua (per programmi di lezione che possono essere insegnati in più lingue) scegli le arti del linguaggio.
* Un elenco di lingue supportate. Nota: Il rilevamento della lingua è compito di chi fornisce il corso, noi ci limiteremo a reindirizzare tutti gli utenti al singolo URL fornito. o indipendente dalla lingua (per programmi di lezione che possono essere insegnati in più lingue)
...
Per le tradizionali attività di programmazione, un comitato eterogeneo di docenti di informatica classificherà le candidature in base a criteri qualitativi e quantitativi. Verranno elencate tutte le attività che soddisfano i criteri di base. Gli insegnanti potranno filtrarle e ordinarle per trovare le migliori attività per la loro classe.
...
Le attività non devono necessariamente includere l'intelligenza artificiale, anche se stiamo cercando di offrire altre attività relative all'IA.
...
Hour of Code® e Hora del Código® sono marchi registrati di Code.org. Molti dei nostri partner per i tutorial hanno utilizzato i nostri marchi «L'Ora del Codice» sui loro siti web in relazione alle loro attività relative all'Ora del Codice. Non vogliamo impedire questo utilizzo, ma vogliamo assicurarci che l'utilizzo rientri in alcuni limiti:
...
Se il tuo corso viene approvato e incluso nell'elenco finale dei corsi, Code.org ti fornirà uno specifico pixel di tracciamento che potrai integrare nel tuo corso. Vedi l'esempio in basso. Non includerla in nessuna pagina provvisoria del tuo tutorial.
