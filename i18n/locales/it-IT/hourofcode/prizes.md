...
title: Premi layout: wide <% if @country == 'us' || @country == 'ca' %>nav: prizes_nav<% end %>
...
## Una classe vincerà un viaggio a Washington per una storica, top-secret, Hour of Code! {#dc}
...
## 100 classi vinceranno un kit di robot programmabili {#programmable_robots}
