...
De beste manier om contact op te nemen is per mail. It should be short and should communicate "why should other people care about this event"? Voorzie contactinformatie (een Gsm-nummer) voor wie er naar de eventlocatie komt. **[See a sample pitch to media]({{ promote/press-kit-emails }})**.

Kijk online of u contactinformatie kan vinden over journalisten. If you can't find it, call the publication to ask, or email the organization's general email address and ask for your message to be directed to the correct reporter. <br />
