...
### Zorg er voor dat iedere school deelneemt en elke leerling leert!
  ...
  1. **Werf lokale scholen en districten.**Gebruik[deze email](<%= hoc_uri('/resources#sample-emails') %>)of[dit stukje reclame](<%= hoc_uri('/resources/stats') %>) als startpunt en belijk deze [how-to](<%= hoc_uri('/resources/how-to') %>)gids voor scholen en districten. Let them know **every** participating educator will receive a [thank you gift](<%= hoc_uri('/resources/how-to') %>) and in **each state**, one participating school will win **$10,000 in technology**!
