...
* Omvat deze activiteit AI: Ja of Nee
...
* Een lijst met programmeertalen die je activiteit leert. Dat wil zeggen C/C++, Java, JavaScript, enz. of taalonafhankelijk (voor lesplannen die in meerdere talen kunnen worden gegeven) kies voor taalkunsten.
* Een lijst van ondersteunde natuurlijke talen. Opmerking: Taaldetectie valt onder de verantwoordelijkheid van de aanbieder van de activiteit; we zullen alle gebruikers doorverwijzen naar de enkele opgegeven URL. of taalonafhankelijk (voor lesplannen die in meerdere talen kunnen worden gegeven)
* Welk ervaringsniveau moet een opvoeder hebben om uw activiteit te gebruiken? (bijv. Beginner of Comfortabel.) En welk ervaringsniveau moeten de studenten hebben?
...
Een diverse commissie van informaticadocenten zal de inzendingen rangschikken op basis van kwalitatieve en kwantitatieve criteria. Alle activiteiten die voldoen aan de basiscriteria worden vermeld.

Voor traditionele coderingsactiviteiten zal een diverse commissie van informaticadocenten de inzendingen rangschikken op basis van kwalitatieve en kwantitatieve criteria. Alle activiteiten die voldoen aan de basiscriteria worden vermeld. Leerkrachten kunnen filteren en sorteren om de beste activiteiten voor hun klas te vinden.
...
Activiteiten hoeven geen AI te bevatten, maar we willen wel meer AI-gerelateerde activiteiten aanbieden.
...
**Moedig de leerlingen aan om te posten op sociale media (in voorkomend geval) wanneer ze klaar.** Bijvoorbeeld "Ik heb meegedaan aan een CodeUur met ________, Doe jij ook mee? #HourOfCode” of „Ik heb een #HourOfCode gedaan als onderdeel van #CSEdWeek. En jij?
...
Als je tutorial is goedgekeurd en op de uiteindelijke instructiepagina is opgenomen, zal Code.org je een unieke trackingpixel geven die je kunt integreren in je tutorial. Zie het voorbeeld hieronder. Voeg dit niet toe aan tussenliggende pagina's van je tutorial.
