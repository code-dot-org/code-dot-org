...
We’ll host a variety of [fun, hour-long tutorials](%= resolve_url('https://code.org/learn') %) for participants of all ages, created by a variety of partners. [तिनीहरूलाई प्रयास गर्नुहोस्!](%= resolve_url("https://code.org/learn") %)
