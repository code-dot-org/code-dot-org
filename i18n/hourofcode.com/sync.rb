...
# remove all metadata
Dir.glob("../../pegasus/sites.v3/hourofcode.com/public/**/*.md").each do |file|
  File.write(file, File.read(file).gsub("<a style=\"display: block\" href=\"/#join\"><button style=\"float: right;\">Sign up your event</button></a>", ""))
end
