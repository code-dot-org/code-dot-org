...
Repo: code-dot-org, branch staging. Rails dev server running at
http://localhost-studio.code.org:3000. All commands below were read from source
(STRONGLY SUPPORTED / VERIFIED-READ) or actually executed read-only (OBSERVED).
No write, migration, or user-creation command in this doc was executed.
